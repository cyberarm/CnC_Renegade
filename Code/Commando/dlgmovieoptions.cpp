...
//
////////////////////////////////////////////////////////////////
void MovieOptionsMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass* list_ctrl, int ctrl_id,
                                                     int item_index)
{
    if (IsPlaying) {
        return;
...
//
////////////////////////////////////////////////////////////////
void MovieOptionsMenuClass::On_ListCtrl_DblClk(ListCtrlClass* list_ctrl, int ctrl_id,
                                               int item_index)
{
    if (IsPlaying) {
        return;
