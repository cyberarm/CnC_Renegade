...
//	Local constants
////////////////////////////////////////////////////////////////
static enum { COL_NAME = 0, COL_CLAN, COL_LOCATION, COL_WINS, COL_DEATHS, COL_POINTS, COL_RANK };
...
//
////////////////////////////////////////////////////////////////
void MPWolBuddiesMenuClass::On_ListCtrl_Sel_Change(ListCtrlClass* list, int id, int oldsel,
                                                   int newsel)
{
...
//
////////////////////////////////////////////////////////////////
void MPWolBuddiesMenuClass::On_ListCtrl_DblClk(ListCtrlClass* list_ctrl, int ctrl_id,
                                               int item_index)
{
        ...
        if (curr_sel != -1) {
            ...
            case WWOnline::USERLOCATION_IN_CHANNEL: {
                ...
                if (mPendingJoin.IsValid()) {
                    ...
                    message.Format(TRANSLATE(IDS_MENU_JOIN_REQUEST_MESSAGE),
                                   (const WCHAR*)buddyName);
