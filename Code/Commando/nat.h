...
public:
    ...
    */
    typedef enum tFirewallBehaviorType
    {
        ...
        */
        ...
        /*
        ** This is a smarter firewall/NAT with port mangling that uses different mangled source
        *ports
        ...
        */
        ...
        /*
        ** This is a firewall that exhibits the bug as seen in the Netgear firewalls. A previously
        *good
        ...
        */
        ...
        /*
        ** This firewall has a relative offset port allocation scheme. For these firewalls, we have
        *to
        ** subtract the actual source port from the mangled source port to discover the allocation
        *scheme.
    ...
    */
    int Build_Mangler_Packet(unsigned char* buffer, unsigned short port,
                             unsigned long packet_id = 0, bool blitzme = false);
    ...
    */
    ...
    unsigned short Get_Client_Bind_Port(void)
    {
        return (ClientPort);
    }; // PlayersFirewallAddress.Get_Port());};

    /*
    ** Firewall info import and export.
    */
    void Set_Firewall_Info(unsigned long last_behavior, int last_delta, unsigned short port_pool,
                           bool send_delay, int confidence);
    void Get_Firewall_Info(unsigned long& last_behavior, int& last_delta, unsigned short& port_pool,
    ...
    */
    bool Send_To_Mangler(IPAddressClass* address, SocketHandlerClass* socket_handler,
                         unsigned long packet_id, bool blitzme = false);
    unsigned short Get_Mangler_Response(unsigned long packet_id, SocketHandlerClass* socket_handler,
                                        int time = 0, bool all_service = false);
    ...
    */
    ...
    void Set_Client_Connect_Event(HANDLE thread_event, HANDLE cancel_event, int* flag_ptr,
                                  int* queue_ptr);
...
private:
    ...
    */
    ...
    int Get_NAT_Port_Allocation_Scheme(int num_ports, unsigned short* original_ports,
    ...
    */
    ...
    /*
    ** Connection result reported by other player. Used to find out if our packet got through. See
    *enum below.
    */
    ...
    */
    ...
    /*
    ** Connections we have made so far in this game. This includes people who were in the game and
    *left.
    */
    ...
    ** Threading.
    **
    **		This class runs in it's own thread so that firewall negotiation doesn't stall the
    *server when a new client joins. *		It also means that the clients join dialog is
    *serviced while connecting, allowing him to cancel at any time.
    **
    */
    HANDLE ThreadHandle;
...
#define SERIAL_MAX 23
    ...
    */
    ...
    {
        unsigned short
            MagicNumber; // in, out = GLOBAL_MAGICNUM = 0x1236. Just preserve the incoming value.
    ...
    */
    struct GlobalHeaderType
    {
        ...
        unsigned short ProductID; // in, out = COMMAND_AND_CONQUER_RA2 = 0xaa03. Just return the
                                  // value from the received packet
    };
