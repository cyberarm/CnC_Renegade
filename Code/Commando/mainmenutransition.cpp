...
void MainMenuTransitionClass::Set_Type(TYPE type)
{
    ...
    if (type == SCREEN_IN) {
        ...
        WWAudioClass::Get_Instance()->Simple_Play_2D_Sound_Effect("interface_mainmove.wav", 1.0F,
                                                                  0.8F);
    }
    else if (type == SCREEN_OUT) {
        CurrentFrame = OUT_START_FRAME;
        TargetFrame = OUT_END_FRAME;
        WWAudioClass::Get_Instance()->Simple_Play_2D_Sound_Effect("interface_movezoom.wav", 1.0F,
                                                                  0.8F);
    }
...
void MainMenuTransitionClass::Update_Controls(void)
{
    ...
    const int ControlIDArray[ENTRIES]
        = { IDC_MENU_START_SP_GAME_BUTTON,
            ...
            IDC_MENU_START_PRACTICE_GAME_BUTTON, IDC_MENU_OPTIONS_BUTTON, IDC_MENU_QUIT_BUTTON };
