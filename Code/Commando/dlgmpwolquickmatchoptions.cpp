...
//
////////////////////////////////////////////////////////////////
void MPWolQuickMatchOptionsMenuClass::On_SliderCtrl_Pos_Changed(SliderCtrlClass* slider_ctrl,
...
bool MPWolQuickMatchOptionsMenuClass::Save_Settings(void)
{
    ...
    */
    ...
    if (sum == 0) {
        DlgMsgBox::DoDialog(TRANSLATE(IDS_MENU_INVALID_QM_SETTINGS_TITLE),
                            TRANSLATE(IDS_MENU_INVALID_QM_SETTINGS));
        return false;
    }
