...
//-----------------------------------------------------------------------------
void cPurchaseRequestEvent::Init(VendorClass::PURCHASE_TYPE type, int item_index,
                                 int alt_skin_index)
{
...
void cPurchaseRequestEvent::Act(void)
{
    ...
    if (The_Game()->Is_Gameplay_Permitted()) {
        ...
        //
        result = VendorClass::Purchase_Item(player, (VendorClass::PURCHASE_TYPE)PurchaseType,
                                            ItemIndex, AltSkinIndex, false);
    }
    else {
    ...
    if (cNetwork::I_Am_Only_Server()) {
        if (result == VendorClass::PERR_SUCCESS
            && (VendorClass::PURCHASE_TYPE)PurchaseType == VendorClass::TYPE_VEHICLE) {
