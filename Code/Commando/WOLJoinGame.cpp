...
void WOLJoinGame::JoinTheGame(const wchar_t* gameName, const wchar_t* password,
                              bool allowTeamSelect)
{
...
cGameData* WOLJoinGame::CreateGameFromChannel(const RefPtr<ChannelData>& channel)
{
    ...
    cGameData* theGame
        = cGameData::Create_Game_Of_Type((cGameData::GameTypeEnum)gameInfo.GameType());
