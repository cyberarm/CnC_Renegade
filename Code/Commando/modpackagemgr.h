...
public:
    ...
    //
    static bool Get_Mod_Map_Name_From_CRC(uint32 mod_crc, uint32 map_crc, StringClass* mod_name,
                                          StringClass* map_name);
    static bool Get_Mod_Map_Name_From_CRC_Index(uint32 mod_file_crc, int map_index,
                                                StringClass* mod_name, StringClass* map_name);
    static bool Find_Filename_From_CRC(const char* search_mask, uint32 filename_crc,
