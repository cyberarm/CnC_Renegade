...
//
float cPriority::Compute_Object_Priority(int client_id, const Vector3& client_pos,
                                         NetworkObjectClass* p_netobject, bool do_it_anyway,
                                         SoldierGameObj* client_soldier)
{
    ...
    if (p_netobject->Get_Client_Hint_Count(client_id) > 0) {
        ...
        /*
        WWDEBUG_SAY(("cPriority::Compute_Object_Priority %5.3f on object %d due to client %d
...
//-----------------------------------------------------------------------------
float cPriority::Compute_Facing_Factor(int client_id, const Vector3& client_pos,
...
float cPriority::Compute_Object_Priority_2(int client_id, const Vector3& client_pos,
                                           NetworkObjectClass* p_netobject, bool do_it_anyway,
                                           SoldierGameObj* client_soldier)
{
    WWPROFILE("ObjPri");
...
//-----------------------------------------------------------------------------
float cPriority::Compute_Facing_Factor_2(int client_id, const Vector3& client_pos,
                                         NetworkObjectClass* p_netobject,
                                         SoldierGameObj* client_soldier)
{
    WWASSERT(client_id > 0);
