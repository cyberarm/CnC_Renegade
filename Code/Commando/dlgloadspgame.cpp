    ...
    for (file_find = ::FindFirstFile(search_string, &find_info);
        ...
        if (Is_Game_Allowed(find_info.cFileName)) {
            ...
            time_string.Format(L"%d:%02d:%02d", system_time.wHour, system_time.wMinute,
                               system_time.wSecond);
            date_string.Format(L"%d/%d/%d", system_time.wMonth, system_time.wDay,
                               system_time.wYear);
            ...
            if (item_index >= 0) {
                ...
                list_ctrl->Set_Entry_Data(item_index, 2,
                                          (uint32) new StringClass(find_info.cFileName));
            }
        }
    }
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Column_Click(ListCtrlClass* list_ctrl, int ctrl_id,
                                                   int col_index)
{
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass* list_ctrl, int ctrl_id,
                                                   int item_index)
{
    if (ctrl_id == IDC_LOAD_GAME_LIST_CTRL) {
...
//
////////////////////////////////////////////////////////////////
int CALLBACK LoadSPGameMenuClass::LoadListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id,
