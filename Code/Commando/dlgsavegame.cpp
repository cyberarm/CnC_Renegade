...
static enum { COL_DATE = 0, COL_TIME, COL_NAME };
...
//
////////////////////////////////////////////////////////////////
void SaveGameMenuClass::On_ListCtrl_Column_Click(ListCtrlClass* list_ctrl, int ctrl_id,
                                                 int col_index)
{
    if (ctrl_id == IDC_LOAD_GAME_LIST_CTRL) {
        ...
        //
        ListCtrlClass::SORT_TYPE type
            = IsSortAscending ? ListCtrlClass::SORT_ASCENDING : ListCtrlClass::SORT_DESCENDING;
...
//
////////////////////////////////////////////////////////////////
void SaveGameMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass* list_ctrl, int ctrl_id,
                                                 int item_index)
{
    if (ctrl_id == IDC_LOAD_GAME_LIST_CTRL) {
...
//
////////////////////////////////////////////////////////////////
int CALLBACK SaveGameMenuClass::LoadListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
...
//
////////////////////////////////////////////////////////////////
void SaveGameMenuClass::On_ListCtrl_DblClk(ListCtrlClass* list_ctrl, int ctrl_id, int item_index)
{
    return;
}
...
//
////////////////////////////////////////////////////////////////
void SaveGameMenuClass::On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id, int old_index,
                                               int new_index)
{
    Update_Text_Field();
    Update_Button_State();
    ...
    if (item_index != -1) {
        ...
        if (list_ctrl->Get_Entry_Data(item_index, 0) != NULL) {
            ...
            if (prompt) {
                ...
                //	Display a message to the user asking if they really want to do this...
                //
                DlgMsgBox::DoDialog(TRANSLATE(IDS_MENU_DELETE_SAVE_TITLE), message,
                                    DlgMsgBox::YesNo, this, MBEVENT_DELETE_PROMPT);
            }
            else {
...
void SaveGameMenuClass::Reload_List(const char* current_filename)
{
    ...
    for (file_find = ::FindFirstFile("data\\save\\*.sav", &find_info);
        ...
        time_string.Format(L"%d:%02d:%02d", system_time.wHour, system_time.wMinute,
                           system_time.wSecond);
...
bool SaveGameMenuClass::Check_HD_Space(void)
{
    ...
    // NOTE IML: For Win'95, must query for support for GetDiskFreeSpaceEx before using it -
    // otherwise use GetDiskFreeSpace().
