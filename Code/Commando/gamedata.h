...
public:
    ...
    /*
    void				Set_Server_Is_Gameplay_Permitted(bool flag)
    {ServerIsGameplayPermitted = flag;} bool
    Get_Server_Is_Gameplay_Permitted(void)			{return ServerIsGameplayPermitted;}
    */
...
// {return true;} void				Set_Min_Game_Time_Required_Mins(int mins); int
// Get_Min_Game_Time_Required_Mins(void) {return MinGameTimeRequiredMins;} void
// Set_Full_Score_Time_Threshold_Mins(int mins); int
// Get_Full_Score_Time_Threshold_Mins(void) {return FullScoreTimeThresholdMins;} int
// MinGameTimeRequiredMins; int					FullScoreTimeThresholdMins; cBoolean
// IsBloodShed;