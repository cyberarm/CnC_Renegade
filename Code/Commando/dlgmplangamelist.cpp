...
//	Local constants
////////////////////////////////////////////////////////////////
static enum { COL_ICON = 0, COL_HOST_NAME, COL_GAME_NAME, COL_GAME_MAP, COL_PLAYERS, COL_MAX };
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass* list_ctrl, int ctrl_id,
                                                      int item_index)
{
    //
    //	Get the channel data from this entry
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_ListCtrl_DblClk(ListCtrlClass* list_ctrl, int ctrl_id,
                                                int item_index)
{
    Join_Game();
    return;
