...
void CNCPurchaseMainMenuClass::On_Init_Dialog(void)
{
    ...
    if (Team == PurchaseSettingsDefClass::TEAM_GDI) {
        ...
        ::Strip_Path_From_Filename(chars_texture,
                                   settings->Get_Purchase_NOD_MUT_Characters_Texture());
        ::Strip_Path_From_Filename(vehicles_texture,
                                   settings->Get_Purchase_NOD_MUT_Vehicles_Texture());
    }
    else {
        ::Strip_Path_From_Filename(chars_texture,
                                   settings->Get_Purchase_GDI_MUT_Characters_Texture());
        ::Strip_Path_From_Filename(vehicles_texture,
                                   settings->Get_Purchase_GDI_MUT_Vehicles_Texture());
    }
...
{
    const int CTRL_IDS[4] = { IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02,
    ...
    if (definition != nullptr) {
        ...
        if (base != nullptr) {
            ...
            if (type == PurchaseSettingsDefClass::TYPE_CLASSES
                && base->Can_Generate_Soldiers() == false) {
...
{
    const int CTRL_IDS[]
        = { IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
    ...
    for (int index = 0; index < 6; index++) {
        ...
        if (ctrl != nullptr && ctrl->Get_Purchase_Count() > 0) {
            ...
            case IDC_ENLISTED_PURCHASE_04: {
                VendorClass::Purchase_Item(COMBAT_STAR, VendorClass::TYPE_ENLISTED_CHARACTER,
                                           ctrl->Get_User_Data());
                break;
            }
...
{
    const int CTRL_IDS[] = { IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02,
                             IDC_ENLISTED_PURCHASE_03, IDC_ENLISTED_PURCHASE_04 };
