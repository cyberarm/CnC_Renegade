...
public:
    ...
    static void Show_Description(NetworkObjectClass* p_object, float height_offset,
                                 float max_distance);
    ...
    /*
    static void		Set_Verbose_Lists(bool flag) {VerboseLists = flag;} static bool
    Get_Verbose_Lists(void)							{return
    VerboseLists;} static bool		Toggle_Verbose_Lists(void)
    {VerboseLists = !VerboseLists; return VerboseLists;}
    */
    static void Set_Playerlist_Format(PlayerlistFormatEnum playerlist_format)
    {
        PlayerlistFormat = playerlist_format;
    }
