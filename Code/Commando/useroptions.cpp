...
// Class statics
//
cRegistryBool cUserOptions::ShowNamesOnSoldier(APPLICATION_SUB_KEY_NAME_NETOPTIONS,
                                               "ShowNamesOnSoldier", true);
cRegistryBool cUserOptions::SkipQuitConfirmDialog(APPLICATION_SUB_KEY_NAME_OPTIONS,
                                                  "SkipQuitConfirmDialog", false);
cRegistryBool cUserOptions::SkipIngameQuitConfirmDialog(APPLICATION_SUB_KEY_NAME_OPTIONS,
                                                        "SkipIngameQuitConfirmDialog", false);
cRegistryBool cUserOptions::CameraLockedToTurret(APPLICATION_SUB_KEY_NAME_OPTIONS,
                                                 "CameraLockedToTurret", false);
cRegistryBool cUserOptions::PermitDiagLogging(APPLICATION_SUB_KEY_NAME_OPTIONS, "PermitDiagLogging",
                                              true);

cRegistryInt cUserOptions::Sku(APPLICATION_SUB_KEY_NAME, "SKU", RENEGADE_BASE_SKU);

cRegistryInt cUserOptions::BandwidthType(APPLICATION_SUB_KEY_NAME_NETOPTIONS, "BandwidthType",
                                         BANDWIDTH_AUTO);
cRegistryInt cUserOptions::BandwidthBps(APPLICATION_SUB_KEY_NAME_NETOPTIONS, "BandwidthBps", 33600);

cRegistryInt cUserOptions::GameSpyBandwidthType(APPLICATION_SUB_KEY_NAME_GAMESPY,
                                                "GameSpyBandwidthType", BANDWIDTH_AUTO);
cRegistryInt cUserOptions::PreferredGameSpyNic(APPLICATION_SUB_KEY_NAME_GAMESPY,
                                               "PreferredGameSpyNic", 0);
cRegistryString cUserOptions::GameSpyNickname(APPLICATION_SUB_KEY_NAME_GAMESPY, "GameSpyNickname",
                                              "");
cRegistryInt cUserOptions::GameSpyQueryPort(APPLICATION_SUB_KEY_NAME_GAMESPY, "GameSpyQueryPort",
                                            25300);
cRegistryInt cUserOptions::GameSpyGamePort(APPLICATION_SUB_KEY_NAME_GAMESPY, "GameSpyGamePort",
                                           4848);
cRegistryInt cUserOptions::SplashCount(APPLICATION_SUB_KEY_NAME_GAMESPY, "SplashCount", 0);
cRegistryBool cUserOptions::DoneClientBandwidthTest(APPLICATION_SUB_KEY_NAME_GAMESPY,
                                                    "DoneClientBandwidthTest", false);

cRegistryInt cUserOptions::PreferredLanNic(APPLICATION_SUB_KEY_NAME_NETOPTIONS, "PreferredLanNic",
                                           0);
cRegistryInt cUserOptions::NetUpdateRate(APPLICATION_SUB_KEY_NAME_NETOPTIONS, "NetUpdateRate", 10);
cRegistryFloat cUserOptions::ClientHintFactor(APPLICATION_SUB_KEY_NAME_NETOPTIONS,
                                              "ClientHintFactor", 10.0f);
cRegistryFloat cUserOptions::MaxFacingPenalty(APPLICATION_SUB_KEY_NAME_NETOPTIONS,
                                              "MaxFacingPenalty", 0.3f);
cRegistryFloat cUserOptions::IrrelevancePenalty(APPLICATION_SUB_KEY_NAME_NETOPTIONS,
                                                "IrrelevancePenalty", 0.2f);

cRegistryInt cUserOptions::ResultsLogNumber(APPLICATION_SUB_KEY_NAME_NETOPTIONS, "ResultsLogNumber",
                                            1);
...
bool cUserOptions::Parse_Command_Line(LPCSTR command)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (strstr(cmd, "GAMESPYSERVER=")) {
            ...
            WWDEBUG_SAY(
                ("Set to load gamespy server settings from config file %s\n", server_config_file));
...
void cUserOptions::Reread(void)
{
    ...
    BandwidthType.Set(RegistryClass(APPLICATION_SUB_KEY_NAME_NETOPTIONS)
                          .Get_Int("BandwidthType", BandwidthType.Get()));
    BandwidthBps.Set(RegistryClass(APPLICATION_SUB_KEY_NAME_NETOPTIONS)
                         .Get_Int("BandwidthBps", BandwidthBps.Get()));
    GameSpyBandwidthType.Set(RegistryClass(APPLICATION_SUB_KEY_NAME_GAMESPY)
                                 .Get_Int("GameSpyBandwidthType", GameSpyBandwidthType.Get()));
}

/*
cRegistryInt cUserOptions::GameListFilterMaxPing(
APPLICATION_SUB_KEY_NAME_NETOPTIONS, "GameListFilterMaxPing",
9999); cRegistryInt cUserOptions::GameListFilterMinPlayersPresent(
APPLICATION_SUB_KEY_NAME_NETOPTIONS, "GameListFilterMinPlayersPresent",
...
"GameListFilterMaxPlayersPermitted",			99); cRegistryBool
cUserOptions::GameListFilterShowPrivateGames(	APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterShowPrivateGames",					true); cRegistryBool
cUserOptions::GameListFilterShowOnlyDedicatedGames(	APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterShowOnlyDedicatedGames",	false); cRegistryBool
cUserOptions::GameListFilterShowOnlyGamesIRankFor(	APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterShowOnlyGamesIRankFor",	false);
*/
