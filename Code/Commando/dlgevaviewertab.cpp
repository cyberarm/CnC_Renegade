...
//
////////////////////////////////////////////////////////////////
void EvaViewerTabClass::On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id, int old_index,
                                               int new_index)
{
...
void EvaViewerTabClass::View_Entry(int entry_index)
{
    ...
    if (entry_index >= 0) {
        ...
        //
        EvaViewerObjectClass* object
            = (EvaViewerObjectClass*)ListCtrl->Get_Entry_Data(entry_index, 0);
...
//
////////////////////////////////////////////////////////////////
int CALLBACK EvaViewerTabClass::ListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
                                                 int item_index2, uint32 user_param)
{
    //
    //	Lookup the data associated with these entries
    //
    EvaViewerObjectClass* object1
        = (EvaViewerObjectClass*)list_ctrl->Get_Entry_Data(item_index1, 0);
    EvaViewerObjectClass* object2
        = (EvaViewerObjectClass*)list_ctrl->Get_Entry_Data(item_index2, 0);
