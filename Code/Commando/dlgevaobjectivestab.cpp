...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id,
...
void EvaObjectivesTabClass::Update_Curr_Objective_Controls(void)
{
    ...
    if (curr_sel >= 0) {
        Objective* objective
            = ObjectiveManager::Get_Objective(list_ctrl->Get_Entry_Data(curr_sel, 0));
...
//
////////////////////////////////////////////////////////////////
int CALLBACK EvaObjectivesTabClass::ListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
                                                     int item_index2, uint32 user_param)
{
    int count = list_ctrl->Get_Entry_Count();

    Objective* objective1
        = ObjectiveManager::Get_Objective(list_ctrl->Get_Entry_Data(item_index1, 0));
    Objective* objective2
        = ObjectiveManager::Get_Objective(list_ctrl->Get_Entry_Data(item_index2, 0));
