...
void EvaDataTabClass::Fill_Statistics_List(void)
{
    ...
    ((ImageCtrlClass*)Get_Dlg_Item(IDC_VEHICLES_DESTROYED_IMAGE))
        ->Set_Texture("if_KillVehicles.tga");
    ((ImageCtrlClass*)Get_Dlg_Item(IDC_BUILDINGS_DESTROYED_IMAGE))
        ->Set_Texture("if_buildingsKill.tga");
