...
public:
    ...
    void Set(bool enable, char* nick, char* serial, unsigned short port, char* settings_file,
             int bandwidth, char* password);
    void Get(bool& enable, char* nick, char* serial, unsigned short& port, char* settings_file,
             int& bandwidth, char* password);
...
public:
    ...
    void Add_Slave(bool enable, char* nick, char* serial, unsigned short port, char* settings_file,
                   int bandwidth, char* password);
