...
//
////////////////////////////////////////////////////////////////
VendorClass::PURCHASE_ERROR VendorClass::Purchase_Vehicle(BaseControllerClass* base,
                                                          SoldierGameObj* player, int cost,
                                                          int vehicle_id)
{
    ...
    if (definition != nullptr) {
        ...
        if (has_funds) {
            ...
            if (building != nullptr) {
                ...
                //
                //	If we have a vehicle factory that isn't busy, then start building the
                //vehicle
                //
...
//
////////////////////////////////////////////////////////////////
VendorClass::PURCHASE_ERROR VendorClass::Purchase_Powerup(BaseControllerClass* base,
                                                          SoldierGameObj* player, int cost,
                                                          int powerup_id)
{
...
//
////////////////////////////////////////////////////////////////
VendorClass::PURCHASE_ERROR VendorClass::Purchase_Character(BaseControllerClass* base,
                                                            SoldierGameObj* player, int cost,
                                                            int definition_id)
{
    PURCHASE_ERROR retval = PERR_NO_FUNDS;
    ...
    if (has_funds) {
        ...
        if ((building != nullptr && building->Is_Destroyed() == false) || cost == 0) {
            ...
            if (definition != nullptr
                && definition->Get_Class_ID() == CLASSID_GAME_OBJECT_DEF_SOLDIER) {
...
//
////////////////////////////////////////////////////////////////
VendorClass::PURCHASE_ERROR VendorClass::Purchase_Item(SoldierGameObj* player, PURCHASE_TYPE type,
                                                       int item_index, int alt_skin_index,
                                                       bool is_from_server)
{
    PURCHASE_ERROR retval = PERR_NO_FUNDS;
    ...
    if (CombatManager::I_Am_Server() == false) {
        ...
        if (type == TYPE_CHARACTER || type == TYPE_ENLISTED_CHARACTER
            || type == TYPE_SECRET_CHARACTER) {
...
//
////////////////////////////////////////////////////////////////
void VendorClass::Get_Merchandise_Information(SoldierGameObj* player, PURCHASE_TYPE type,
                                              int item_index, int alt_skin_index, int& cost,
                                              int& definition_id)
{
    //
    ...
    if (type == TYPE_CHARACTER || type == TYPE_VEHICLE) {
        ...
        PurchaseSettingsDefClass* definition
            = PurchaseSettingsDefClass::Find_Definition(purchase_type, team);
        if (definition != nullptr) {
        ...
        if (The_Game()->IsLaddered.Is_False()) {
            ...
            //	Determine which purchase type to use
            //
            PurchaseSettingsDefClass::TYPE purchase_type
                = PurchaseSettingsDefClass::TYPE_SECRET_CLASSES;
        ...
        //
        cost = 0;
        TeamPurchaseSettingsDefClass* definition = TeamPurchaseSettingsDefClass::Get_Definition(
            (TeamPurchaseSettingsDefClass::TEAM)team);
        if (definition != nullptr) {
