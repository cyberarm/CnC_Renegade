...
void CNCBattleInfoDialogClass::Configure_Icons(void)
{
    ...
    for (index = 0; index < BUILDING_COUNT; index++) {
        ...
        if (building != NULL) {
            ...
            ((HealthBarCtrlClass*)Get_Dlg_Item(NOD_BUILDING_CTRLS[next_slot].health_ctrl_id))
                ->Set_Life(life);
            next_slot++;
        }
    }
...
//
////////////////////////////////////////////////////////////////
int CALLBACK CNCBattleInfoDialogClass::ListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
...
void CNCBattleInfoDialogClass::Build_Player_Display_Name(const cPlayer* player,
