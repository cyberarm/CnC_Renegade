...
unsigned long SlaveServerDialogClass::EnableIDs[MAX_SLAVES]
    = { IDC_SLAVE_ENABLE1, IDC_SLAVE_ENABLE2, IDC_SLAVE_ENABLE3, IDC_SLAVE_ENABLE4,
        IDC_SLAVE_ENABLE5, IDC_SLAVE_ENABLE6, IDC_SLAVE_ENABLE7 };

unsigned long SlaveServerDialogClass::NickIDs[MAX_SLAVES]
    = { IDC_NICK_EDIT1, IDC_NICK_EDIT2, IDC_NICK_EDIT3, IDC_NICK_EDIT4,
        IDC_NICK_EDIT5, IDC_NICK_EDIT6, IDC_NICK_EDIT7 };

unsigned long SlaveServerDialogClass::PassIDs[MAX_SLAVES]
    = { IDC_PASS_EDIT1, IDC_PASS_EDIT2, IDC_PASS_EDIT3, IDC_PASS_EDIT4,
        IDC_PASS_EDIT5, IDC_PASS_EDIT6, IDC_PASS_EDIT7 };
...
unsigned long SlaveServerDialogClass::SerialIDs[MAX_SLAVES]
    = { IDC_SERIAL_EDIT1, IDC_SERIAL_EDIT2, IDC_SERIAL_EDIT3, IDC_SERIAL_EDIT4,
        IDC_SERIAL_EDIT5, IDC_SERIAL_EDIT6, IDC_SERIAL_EDIT7 };

unsigned long SlaveServerDialogClass::PortIDs[MAX_SLAVES]
    = { IDC_PORT_EDIT1, IDC_PORT_EDIT2, IDC_PORT_EDIT3, IDC_PORT_EDIT4,
        IDC_PORT_EDIT5, IDC_PORT_EDIT6, IDC_PORT_EDIT7 };
...
void SlaveServerDialogClass::On_Command(int ctrl_id, int message_id, DWORD param)
{
    ...
    case IDC_MENU_BACK_BUTTON: {
        ...
        for (int i = 0; i < MAX_SLAVES; i++) {
            ...
            SlaveMaster.Add_Slave(enable, nick, serial, (unsigned short)port,
                                  ServerSettingsFileNames[i], 0xffffffff, pass);
        }
        SlaveMaster.Save();
    } break;
...
void SlaveServerDialogClass::Set_Slave_Button(int slavenum)
{
    ...
    if (file.Is_Available()) {
        ...
        if (ini) {
            ...
            if (size == 0) {
                size = ini->Get_String("Settings", "bConfigName", "", char_description,
            ...
            // int size = ini->Get_String("Settings", "ConfigName", "Custom C&C Server Settings",
            // description, sizeof(description));

            if (size) {
                Instance->Set_Dlg_Item_Text(SettingsButtons[slavenum],
                                            WideStringClass(description, true));
            }
        }
    }
}
...
//
////////////////////////////////////////////////////////////////
void SlaveServerDialogClass::On_Destroy(void)
{
