...
struct CastResultStruct
{
    ...
    uint32 SurfaceType; // surface type of polygon at collision point (see W3D_SURFACE_TYPES in
                        // w3d_file.h)

    bool ComputeContactPoint; // This signals the collision code to compute the point of collision
    Vector3
        ContactPoint; // This will be set to the point of collision if ComputeContactPoint is true
};
