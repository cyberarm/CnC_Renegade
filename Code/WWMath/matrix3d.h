...
public:
    ...
    WWINLINE explicit Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22,
    ...
    WWINLINE void Set(float m11, float m12, float m13, float m14, float m21, float m22, float m23,
    ...
    static WWINLINE void Inverse_Transform_Vector(const Matrix3D& tm, const Vector3& in,
                                                  Vector3* out);
...
WWINLINE Matrix3D::Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22,
                            float m23, float m24, float m31, float m32, float m33, float m34)
{
 ...
 *   2/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
WWINLINE void Matrix3D::Set(float m11, float m12, float m13, float m14, float m21, float m22,
                            float m23, float m24, float m31, float m32, float m33, float m34)
{
    Row[0].Set(m11, m12, m13, m14);
    Row[1].Set(m21, m22, m23, m24);
