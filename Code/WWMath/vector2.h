...
public:
    ...
    WWINLINE bool Rotate_Towards_Vector(Vector2& target, float max_s, float max_c,
                                        bool& positive_turn);
...
{
    return Rotate_Towards_Vector(target, WWMath::Sin(max_theta), WWMath::Cos(max_theta),
                                 positive_turn);
}
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE bool Vector2::Rotate_Towards_Vector(Vector2& target, float max_s, float max_c,
                                             bool& positive_turn)
{
