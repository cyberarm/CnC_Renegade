...
void AABTreeCullSystemClass::Add_Loaded_Object(AABTreeNodeClass* node, CullableClass* obj)
{
    ...
    WWASSERT_PRINT((obj->Get_Culling_System() == NULL),
                   "AABTreeCullSystemClass::Add_Loaded_Object -- Object is already in another "
                   "culling system!\n");
...
void AABTreeNodeClass::Split_Objects(const AABTreeNodeClass::SplitChoiceStruct& sc,
                                     AABTreeNodeClass* front, AABTreeNodeClass* back)
{
...
void AABTreeNodeClass::Split_Boxes(const AABTreeNodeClass::SplitChoiceStruct& sc,
                                   SimpleDynVecClass<AABoxClass>& boxes,
...
/*
  ...
  Here is the existing data in each Node:
        ...
        uint32					Index;				// Index of this
  node AABoxClass				Box;					// Bounding
  box of the node AABTreeNodeClass *	Parent;				// parent of this node
        AABTreeNodeClass *	Front;				// front node
        AABTreeNodeClass *	Back;					// back node
        CullableClass *		Object;				// objects in this node
        uint32					UserData;			// 32bit field for
  the user, initialized to 0
        ...
        uint16					Index;
        short						x,y,z,w,l,h;		// Need origin and
  scale factors for the boxes stored in tree uint16					ParentIndex;
        uint16					FrontIndex;
        uint16					BackIndex;
