...
void M00_Controller_Trigger_RMV(GameObject* obj, GameObject* target, float time_lower_bound,
                                float time_upper_bound, int custom_type, int custom_param)
{
...
DECLARE_SCRIPT(M00_Trigger_When_Killed_RMV,
               "Start_Now=1:int, Receive_Type=1:int, Receive_Param_On=1:int, "
               "Receive_Param_Off=0:int, Target_ID:int, Send_Type:int, Send_Param:int, "
               "Min_Delay=0.0:float, Max_Delay=0.0:float, Debug_Mode=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        if (script_enabled) {
            SCRIPT_DEBUG_MESSAGE(
                ("Unit killed with active M00_Trigger_When_Killed_RMV attached.\n"));
            if (target_id > 0) {
            ...
            if (target) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Killed_RMV could not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Killed_RMV received custom type %d, param %d.\n", type, param));

        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_KILLED)
...
DECLARE_SCRIPT(M00_Trigger_When_Destroyed_RMV,
               "Start_Now=1:int, Receive_Type=2:int, Receive_Param_On=1:int, "
               "Receive_Param_Off=0:int, Target_ID:int, Send_Type:int, Send_Param:int, "
               "Min_Delay=0.0:float, Max_Delay=0.0:float, Debug_Mode=0:int")
{
    bool script_enabled;
    ...
    void Destroyed(GameObject * obj)
    {
        ...
        if (script_enabled) {
            SCRIPT_DEBUG_MESSAGE(
                ("Unit destroyed with active M00_Trigger_When_Destroyed_RMV attached.\n"));
            if (target_id > 0) {
                target = Commands->Find_Object(target_id);
            }
            if (target) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Destroyed_RMV could not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Destroyed_RMV received custom type %d, param %d.\n", type, param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_DESTROYED)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
                SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Destroyed_RMV ENABLED.\n"));
                script_enabled = true;
...
DECLARE_SCRIPT(M00_Trigger_When_Created_RMV,
               "Target_ID:int, Send_Type:int, Send_Parameter:int, Min_Delay=0.0:float, "
               "Max_Delay=0.0:float, Debug_Mode=0:int")
{
    bool debug_mode;
...
DECLARE_SCRIPT(
    ...
    "Target_ID:int, Send_Type:int, Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, "
    "Trigger_Count=0:int, Triggerer=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    bool debug_mode;
    int trigger_count;
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("Zone entered with active M00_Trigger_Zone_Entered_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Zone_Entered_RMV has %d triggers remaining.\n", trigger_count));
            }
            ...
            if (target) {
                ...
                if ((allowed == COMMANDO)
                    && (enterer == Commands->Get_A_Star(Vector3(0.0f, 0.0f, 0.0f)))) {
                    SCRIPT_DEBUG_MESSAGE(("M00_Trigger_Zone_Entered_RMV triggered properly.\n"));
                    M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
                }
                else if ((allowed == NONCOMMANDO)
                         && (enterer != Commands->Get_A_Star(Vector3(0.0f, 0.0f, 0.0f)))) {
                    SCRIPT_DEBUG_MESSAGE(("M00_Trigger_Zone_Entered_RMV triggered properly.\n"));
                    M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
                }
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_Zone_Entered_RMV did not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_Zone_Entered_RMV received custom type %d, param %d.\n", type, param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ZONE_ENTERED)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
                SCRIPT_DEBUG_MESSAGE(("M00_Trigger_Zone_Entered_RMV ENABLED.\n"));
                script_enabled = true;
...
DECLARE_SCRIPT(
    ...
    "Start_Now=1:int, Receive_Type=4:int, Receive_Param_On=1:int, Receive_Param_Off=0:int, "
    "Target_ID:int, Send_Type:int, Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, "
    "Trigger_Count=0:int, Triggerer=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    ...
    void Exited(GameObject * obj, GameObject * enterer)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("Zone exited with active M00_Trigger_Zone_Exited_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Zone_Exited_RMV has %d triggers remaining.\n", trigger_count));
            }
            ...
            if (target) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_Zone_Exited_RMV could not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_Zone_Exited_RMV received custom type %d, param %d.\n", type, param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ZONE_ENTERED)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
...
DECLARE_SCRIPT(
    ...
    "Start_Now=1:int, Receive_Type=5:int, Receive_Param_On=1:int, Receive_Param_Off=0:int, "
    "Target_ID:int, Send_Type:int, Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, "
    "Trigger_Count=0:int, Triggerer=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    ...
    void Exited(GameObject * obj, GameObject * enterer)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("Zone exited with active M00_Trigger_Zone_Entered_Or_Exited_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Zone_Entered_Or_Exited_RMV has %d triggers remaining.\n",
                     trigger_count));
            }
            ...
            if (target) {
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Zone_Entered_Or_Exited_RMV found its target object.\n"));
                if ((allowed == COMMANDO)
                    && (enterer == Commands->Get_A_Star(Vector3(0.0f, 0.0f, 0.0f)))) {
                    SCRIPT_DEBUG_MESSAGE(
                        ("M00_Trigger_Zone_Entered_Or_Exited_RMV triggered properly.\n"));
                    M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
                }
                else if ((allowed == NONCOMMANDO)
                         && (enterer != Commands->Get_A_Star(Vector3(0.0f, 0.0f, 0.0f)))) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_Zone_Entered_Or_Exited_RMV did not find "
                                      "its target object, id = %d!\n",
                                      target_id));
            }
        }
    }
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE((
                    "Zone entered with active M00_Trigger_Zone_Entered_Or_Exited_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Zone_Entered_Or_Exited_RMV has %d triggers remaining.\n",
                     trigger_count));
            ...
            if (target) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_Zone_Entered_Or_Exited_RMV could not "
                                      "find its target object, id = %d!\n",
                                      target_id));
            }
        }
    }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_Zone_Entered_Or_Exited_RMV received custom type %d, param %d.\n", type,
             param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ZONE_ENTERED)
            || (type == Get_Int_Parameter("Receive_Type"))) {
...
DECLARE_SCRIPT(M00_Trigger_When_Enemy_Seen_RMV,
               "Start_Now=1:int, Receive_Type=6:int, Receive_Param_On=1:int, "
               "Receive_Param_Off=0:int, Target_ID:int, Send_Type:int, Send_Parameter:int, "
               "Min_Delay=0.0:float, Max_Delay=0.0:float, Trigger_Count=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    int trigger_count;
    bool debug_mode;
    ...
    void Enemy_Seen(GameObject * obj, GameObject * enemy)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("Enemy seen by unit with active M00_Trigger_When_Enemy_Seen_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE((
                    "M00_Trigger_When_Enemy_Seen_RMV has %d triggers remaining.\n", trigger_count));
            }
            ...
            if (target) {
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Enemy_Seen_RMV has found its target object.\n"));
                M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
            }
            else {
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Enemy_Seen_RMV could not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Enemy_Seen_RMV received custom type %d, param %d.\n", type, param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ENEMY_SEEN)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
                SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Enemy_Seen_RMV ENABLED.\n"));
                script_enabled = true;
...
DECLARE_SCRIPT(M00_Trigger_When_Damaged_RMV,
               "Start_Now=1:int, Receive_Type=7:int, Receive_Param_On=1:int, "
               "Receive_Param_Off=0:int, Target_ID:int, Send_Type:int, Send_Param:int, "
               "Min_Delay=0.0:float, Max_Delay=0.0:float, Trigger_Count=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("Unit damaged with active M00_Trigger_When_Damaged_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Damaged_RMV has %d triggers remaining.\n", trigger_count));
            }
            ...
            if (target) {
                ...
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Damaged_RMV could not find the "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Damaged_RMV received custom type %d,param %d.\n", type, param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_DAMAGED)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
                SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Damaged_RMV ENABLED.\n"));
                script_enabled = true;
...
DECLARE_SCRIPT(
    ...
    "Start_Now=1:int, Receive_Type=8:int, Receive_Param_On=1:int, Receive_Param_Off=0:int, "
    "Target_ID:int, Send_Type:int, Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, "
    "Action_ID:int, Trigger_Count=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    int trigger_count;
    bool debug_mode;
    ...
    void Action_Complete(GameObject * obj, int action_id)
    {
        if (script_enabled) {
            ...
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(("Action complete by unit with active "
                                      "M00_Trigger_When_Action_Complete_RMV attached.\n"));
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Action_Complete_RMV has %d triggers remaining.\n",
                     trigger_count));
            }
            ...
            if (target) {
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Action_Complete_RMV found its target object.\n"));
                if (action_id == Get_Int_Parameter("Action_ID")) {
                    M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
                }
            }
            else {
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Action_Complete_RMV cannot find "
                                      "its target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Action_Complete_RMV received custom type %d, param %d.\n", type,
             param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ACTION_COMPLETE)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
...
DECLARE_SCRIPT(
    ...
    "Start_Now=1:int, Receive_Type=9:int, Receive_Param_On=1:int, Receive_Param_Off=0:int, "
    "Target_ID:int, Animation_Name:string, Send_Type:int, Send_Param:int, Min_Delay=0.0:float, "
    "Max_Delay=0.0:float, Trigger_Count=0:int, Debug_Mode=0:int")
{
    bool script_enabled;
    int trigger_count;
    bool debug_mode;
    ...
    {
        if (script_enabled) {
            SCRIPT_DEBUG_MESSAGE(("Animation complete by unit with active "
                                  "M00_Trigger_When_Animation_Complete_RMV attached.\n"));
            if (trigger_count == 1) {
                script_enabled = false;
            }
            if (trigger_count > 0) {
                trigger_count--;
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Animation_Complete_RMV has %d triggers remaining.\n",
                     trigger_count));
            }
            ...
            if (target) {
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_When_Animation_Complete_RMV found its target object.\n"));
                if (stricmp(anim, name)) {
                    M00_Controller_Trigger_RMV(obj, target, time_low, time_up, type, param);
                }
            }
            else {
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_When_Animation_Complete_RMV cannot find "
                                      "its target object, id = %d!\n",
                                      target_id));
            }
        }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_When_Animation_Complete_RMV received custom type %d, param %d.\n", type,
             param));
        if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL)
            || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ANIMATION_COMPLETE)
            || (type == Get_Int_Parameter("Receive_Type"))) {
            if (param == Get_Int_Parameter("Receive_Param_On")) {
                SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Animation_Complete_RMV ENABLED.\n"));
                script_enabled = true;
    ...
    "Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, Debug_Mode=0:int")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (script_active) {
            if (trigger_count > 0) {
                SCRIPT_DEBUG_MESSAGE(
                    ("M00_Trigger_Timer_Expired_RAD has %d triggers remaining.\n", trigger_count));
                trigger_count--;
            }
            if (trigger_count) {
                ...
                if (timer_id == M00_TIMER_TRIGGER_EXPIRED) {
                    ...
                    if (target_obj) {
                        SCRIPT_DEBUG_MESSAGE(
                            ("M00_Trigger_Timer_Expired_RAD found its target object.\n"));
                    ...
                    SCRIPT_DEBUG_MESSAGE(
                        ("M00_Trigger_Timer_Expired_RAD cannot find its target object, id = %d!\n",
                         target_id));
                }
                Set_Timer(obj);
            }
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_Timer_Expired_RAD received custom type %d, param %d.\n", type, param));
...
DECLARE_SCRIPT(
    ...
    "Start_Now=0:int, Receive_Type:int, Num_States=2:int, Loop_States=0:int, Send_Type:int, "
    "Target_ID:int, Min_Delay=0.0:float, Max_Delay=0.0:float, Debug_Mode=0:int")
{
    int state_num;
    bool debug_mode;
    ...
    {
        SCRIPT_DEBUG_MESSAGE(
            ("M00_Trigger_State_Sequence_RAD received custom type %d, param %d.\n", type, param));
    ...
    void Send_Custom(GameObject * obj)
    {
        ...
        if (state_num) {
            ...
            if (target_obj) {
                ...
                Commands->Send_Custom_Event(obj, target_obj, Get_Int_Parameter("Send_Type"),
                                            state_num, delay_value);
            }
            else {
                SCRIPT_DEBUG_MESSAGE(("ERROR - M00_Trigger_State_Sequence_RAD could not find its "
                                      "target object, id = %d!\n",
                                      target_id));
            }
        }
