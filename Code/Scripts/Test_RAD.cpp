...
DECLARE_SCRIPT(MX0_A02_Controller, "")
{
    ...
    void Attach_Unit_Script(GameObject * unit, int count)
    {
        if (unit) {
            ...
            Commands->Send_Custom_Event(unit, unit, MX0_A02_CUSTOM_TYPE_REGISTER_ACTOR_ID, count,
                                        0.1f);
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case (MX0_A02_CUSTOM_TYPE_MAIN_ENDING): {
            ...
            while (count < MX0_A02_ACTOR_HEADCOUNT) {
                ...
                if (actor) {
                    Commands->Send_Custom_Event(obj, actor, MX0_A02_CUSTOM_TYPE_MAIN_ENDING,
        ...
        case (MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_01_ID): {
            if (sender) {
                Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_KILL_SNIPER_01,
                                            MX0_A01_NOD_SNIPER_01);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_02_ID): {
            if (sender) {
                Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_KILL_SNIPER_02,
                                            MX0_A01_NOD_SNIPER_02);
            }
            break;
        }
        ...
        case (MX0_A02_CUSTOM_TYPE_MAIN_STARTUP): {
            if (!ran_startup) {
                ...
                if (spawnloc) {
                    unit = Commands->Create_Object("MX0_GDI_MiniGunner_0_B",
                                                   Commands->Get_Position(spawnloc));
                ...
                GameObject* humm_vee = Commands->Create_Object("MX0_GDI_Humm-Vee_destroyed",
                                                               Vector3(-84.582f, -60.035f, 1.050f));
                if (humm_vee) {
                ...
                GameObject* med_tank = Commands->Create_Object("MX0_GDI_Medium_Tank_Dec",
                                                               Vector3(-90.183f, -51.691f, 1.216f));
                if (med_tank) {
                ...
                GameObject* gdi_apc
                    = Commands->Create_Object("MX0_GDI_APC", Vector3(-101.576f, -54.945f, 1.050f));
                if (gdi_apc) {
                ...
                GameObject* debris = Commands->Create_Object("Simple_Level_x0_A02_Blockage",
                                                             Vector3(-71.233f, -41.517f, 0.181f));
                if (debris) {
                ...
                if (a01_controller) {
                    Commands->Send_Custom_Event(obj, a01_controller,
            ...
            if (sender) {
                if (param < MX0_A02_ACTOR_NOD_START) {
                    Commands->Send_Custom_Event(
                        ...
                        MX0_A02_UNIT_ID[Get_Int_Random(MX0_A02_ACTOR_NOD_START,
                                                       (MX0_A02_ACTOR_HEADCOUNT - 1))]);
                }
                else {
                    Commands->Send_Custom_Event(
                        obj, sender, MX0_A02_CUSTOM_TYPE_REQUEST_TARGET,
                        MX0_A02_UNIT_ID[Get_Int_Random(1, (MX0_A02_ACTOR_NOD_START - 1))]);
                }
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_STARTUP): {
            ...
            if (!player_retreat) {
                ...
                if (sniper) {
                    ...
                    if (soldier) {
                        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_KILL_SNIPER_01,
                                                    MX0_A01_NOD_SNIPER_01);
                    }
                }
                else {
                    ...
                    if (sniper) {
                        GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[3]);
                        if (soldier) {
                            Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_KILL_SNIPER_02,
                                                        MX0_A01_NOD_SNIPER_02);
                        }
                    }
                }
                ...
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_01,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT);
                }
                ...
                if (apc) {
                    Commands->Send_Custom_Event(obj, apc, MX0_A02_CUSTOM_TYPE_STARTUP,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT);
                }
            }
        }
        ...
        case (MX0_A02_CUSTOM_TYPE_CONTINUE): {
            ...
            while (nod_count < MX0_A02_ACTOR_HEADCOUNT) {
                ...
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_DAMAGE_ON,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT);
                }
                nod_count++;
            }
        ...
        case (MX0_A02_CUSTOM_TYPE_START_GDI_02): {
            ...
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_02,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_START_GDI_03): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_03,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_START_GDI_04): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_04,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_START_GDI_05): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[3]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_05,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_PLAYER_KILLED_NOD): {
            ...
            if (soldier) {
                ...
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_PLAYER_CONGRATS,
                                            congrats_loop);
                congrats_loop++;
            }
            break;
        ...
        case (MX0_A02_CUSTOM_TYPE_SOLDIER_KILLED_NOD): {
            ...
            if (soldier) {
                ...
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SOLDIER_CONGRATS,
        ...
        case (MX0_A02_CUSTOM_TYPE_NOD_SOLDIER_KILLED): {
            ...
            if (!retreat_sequence) {
                ...
                if (!prevent_spawns) {
                    ...
                    if (!sequence_active) {
                        // If the amount of unit space is adequate, increment the sequence and spawn
                        // the units. Tell them what they are to do.

                        if (space_available) {
                            switch (nod_spawn_sequence) {
                            case (0): // Nod Guy falls off ledge after getting shot.
                            {
                                GameObject* soldier = Commands->Create_Object(
                                    "MX0_Nod_Minigunner_0", Vector3(-78.442f, -78.044f, 6.404f));
                                if (soldier) {
                                    space_available--;
                                    sequence_active = true;
                            ...
                            {
                                GameObject* soldier = Commands->Create_Object(
                                    "MX0_Nod_Minigunner_0", Vector3(-102.985f, -73.331f, 4.415f));
                                if (soldier) {
                                    space_available--;
                                    sequence_active = true;
                            ...
                            case (2): {
                                GameObject* soldier = Commands->Create_Object(
                                    "Nod_RocketSoldier_0", Vector3(-78.442f, -78.044f, 6.404f));
                                if (soldier) {
                                    space_available--;
                                    sequence_active = true;
                            ...
                            case (3): // Nod Chopper drops 2 minigunners, not tracked.
                            {
                                GameObject* chinook_obj1 = Commands->Create_Object(
                                    "Invisible_Object", Vector3(-71.497f, -47.387f, 9.0f));
                                if (chinook_obj1) {
                                    sequence_active = true;
                                    Commands->Set_Facing(chinook_obj1, -100.0f);
                                    Commands->Attach_Script(chinook_obj1, "MX0_A02_HELICOPTER",
                                                            "0");
                                    Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                                            "X0I_Drop02_A02_E01.txt");
                                    Commands->Start_Timer(obj, this, 20.0f,
                                                          MX0_A02_TIMER_AFTER_HELI_01);
                                }
                                GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                                if (soldier) {
                                    Commands->Send_Custom_Event(
                                        obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_HELI_01,
                            ...
                            case (4): // Next chopper arrives with FlameThrower infantry.
                            {
                                ...
                                GameObject* chinook_obj1 = Commands->Create_Object(
                                    "Invisible_Object", Vector3(-83.454f, -70.323f, 9.60f));
                                if (chinook_obj1) {
                                    sequence_active = true;
                                    ...
                                    Commands->Attach_Script(chinook_obj1, "MX0_A02_HELICOPTER",
                                                            "1");
                                    Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                                            "X0I_Drop02_A02_E02.txt");
                                }
                                GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                                if (soldier) {
                                    Commands->Send_Custom_Event(
                                        obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_HELI_02,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 10.0f);
                                }
                                break;
                            }
                        ...
                        while (count < MX0_A02_ACTOR_HEADCOUNT) {
                            if (!MX0_A02_UNIT_ID[count]) {
                                ...
                                if (spawnloc) {
                                    ...
                                    Commands->Send_Custom_Event(obj, spawnloc,
        ...
        case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01): {
            ...
            if (soldier) {
                ...
                if (target) {
                    Commands->Send_Custom_Event(obj, soldier,
            ...
            if (soldier) {
                ...
                if (target) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01,
                                                MX0_A02_UNIT_ID[current_nod_target]);
                }
            }
        ...
        case (MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01): {
            ...
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        ...
        case (MX0_A02_CUSTOM_TYPE_APC_BLOWITUP): {
            GameObject* apc = Commands->Find_Object(MX0_A02_GDI_APC_ID);
            if (apc) {
                Commands->Send_Custom_Event(obj, apc, MX0_A02_CUSTOM_TYPE_DESTROY_APC,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT, 2.0f);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_GET_APC_ID): {
            ...
            if (apc) {
                if (sender) {
                    Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_GET_APC_ID,
                                                MX0_A02_GDI_APC_ID);
                }
            }
            else {
        ...
        case (MX0_A02_CUSTOM_TYPE_HELI_DESTROYED): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[3]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        ...
        case (MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02): {
            if (!call_heli_destroy_once) {
                ...
                GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT, 0.5f);
                }
                soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT, 1.5f);
                }
        ...
        case (MX0_A02_CUSTOM_TYPE_ENDING_02): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[4]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_02,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_ENDING_03): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_03,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_ENDING_04): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_04,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_ENDING_05): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[3]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_05,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        ...
        case (MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK): {
            if (sender) {
                ...
                Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK,
                                            MX0_A02_MED_TANK_ID);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_ENGINEER_DONE): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_TANK,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
        ...
        case (MX0_A02_CUSTOM_TYPE_ENTERED_TANK): {
            ...
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MX0_A03_CUSTOM_TYPE_START_ZONE,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT, 2.0f);
            }
            GameObject* soldier = Commands->Find_Object(engineer_02_id);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_FIREHOLE,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_EXPLODE): {
            ...
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_FOLLOW_HAVOC,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
        ...
        case (MX0_A02_CUSTOM_TYPE_SAY_APC_DOWN): {
            GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[3]);
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_APC_DOWN,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
            break;
        }
        case (MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02): {
            ...
            while (count < 5) {
                GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[count]);
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT);
                }
                count++;
            }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        case (MX0_A02_TIMER_PRE_AMBIENT): {
            if (pre_ambient_on) {
                ...
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_PRE_AMBIENT,
                                                pre_ambient_count);
                }
                pre_ambient_count++;
        ...
        case (MX0_A02_TIMER_PLAYER_RETREAT): {
            if (player_retreat) {
                ...
                if (distance > MX0_A02_PLAYER_RETREAT_DISTANCE) {
                    GameObject* soldier
                        = Commands->Find_Object(MX0_A02_UNIT_ID[Get_Int_Random(1, 4)]);
                    if (soldier) {
                        Commands->Send_Custom_Event(obj, soldier,
        ...
        case (MX0_A02_TIMER_PREVENT_SPAWNS): {
            if (!retreat_sequence) {
                prevent_spawns = false;
                Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_NOD_SOLDIER_KILLED, 0,
                                            0.1f);
            }
            break;
        }
        case (MX0_A02_TIMER_AFTER_HELI_01): {
            Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_NEXT_SEQUENCE,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT);
            break;
        }
        case (MX0_A02_TIMER_NOD_RETREAT): {
            ...
            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(-106.497f, -37.154f, 1.093f));
            if (chinook_obj1) {
                Commands->Set_Facing(chinook_obj1, -55.0f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                        "X0I_GDI_Drop02_Engineer.txt");
            }
        ...
        case (MX0_A02_TIMER_RETREAT_DONE): {
            ...
            while (count < MX0_A02_ACTOR_NOD_START) {
                GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[count]);
                if (soldier) {
                    Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_RETREAT_DONE,
                                                MX0_A02_CUSTOM_PARAM_DEFAULT);
                    if (count == 2) {
                        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_01,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                }
                count++;
        ...
        case (MX0_A02_TIMER_ENTER_TANK): {
            if ((havoc_entered_tank < 3) && (!entered_tank)) {
                ...
                case (0): {
                    GameObject* soldier = Commands->Find_Object(engineer_02_id);
                    if (soldier) {
                        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_01,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (1): {
                    GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[1]);
                    if (soldier) {
                        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_02,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (2): {
                    GameObject* soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                    if (soldier) {
                        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_03,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
        ...
        case (MX0_A02_TIMER_RANDOM_EXPLOSIONS): {
            if (!retreat_sequence) {
                ...
                if (location) {
                    ...
                    Commands->Start_Timer(obj, this, float(Get_Int_Random(3, 6)),
        ...
        case (MX0_A02_TIMER_WRONG_WAY): {
            ...
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_WRONG_WAY,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
    ...
    void MX0_A02_Fill_Empty_Slot(GameObject * obj, bool current_target)
    {
        ...
        while (count < MX0_A02_ACTOR_HEADCOUNT) {
            if (!MX0_A02_UNIT_ID[count]) {
                ...
                Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_REGISTER_ACTOR_ID, count,
                                            0.1f);
                count = MX0_A02_ACTOR_HEADCOUNT;
            }
            count++;
...
DECLARE_SCRIPT(MX0_A02_ACTOR, "ActorID=0:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        if (!actor_id) {
            Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_DEFAULT_STATE_ON,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT);
        }
        else {
            switch (actor_id) {
            case (1): // First falling Nod guy moves into position.
            {
                ...
                params.Set_Basic(this, MX0_A02_PRIORITY_FORCED_ACTION,
            ...
            case (5): // Nod FlameThrower jumps down and fires at targets until dead.
            {
                ...
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller,
        ...
        if (active_actor) {
            ...
            if (default_state) {
                    ...
                    if (my_register_id < MX0_A02_ACTOR_NOD_START) {
                        if (damager != STAR) {
                            ...
                            if (my_type != their_type) {
                                ActionParamsStruct params;
                                params.Set_Basic(this, MX0_A02_PRIORITY_DEFAULT_SHOOT,
                                                 MX0_A02_ACTION_DEFAULT);
                ...
                if ((!death_animation) && (can_damage)) {
                    ...
                    switch (my_id) {
                    case (1): {
                        // DEBUG insert falling death animation here. Animation must kill unit at
                        // completion.
            ...
            if (controller) {
                if (killer == STAR) {
                    ...
                    if (killer) {
                        ...
                        Commands->Send_Custom_Event(
                            obj, controller, MX0_A02_CUSTOM_TYPE_SOLDIER_KILLED_NOD, killer_id);
                    }
                }
                if (my_register_id >= MX0_A02_ACTOR_NOD_START) {
                    Commands->Send_Custom_Event(obj, controller,
        ...
        if (active_actor) {
            if ((complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED)
                ...
                case (MX0_A02_SPEECH_GDI_03_STARTUP): {
                    ...
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_CONTINUE,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                ...
                case (MX0_A02_SPEECH_ENDING_01): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_02,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (MX0_A02_SPEECH_ENDING_02): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_03,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (MX0_A02_SPEECH_ENDING_03): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_04,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (MX0_A02_SPEECH_ENDING_04): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_05,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (MX0_A02_SPEECH_ENDING_05): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_06,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                case (MX0_A02_SPEECH_ENGINEER_DONE): {
                    ...
                    Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0397I1DSGN_TXT,
                ...
                case (MX0_A02_SPEECH_TANKSAY_04): {
                    ...
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_EXPLODE,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
                ...
                case (MX0_A02_ACTION_NOD_MOVETO_APC): {
                    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GET_APC_ID,
                                                    MX0_A02_CUSTOM_PARAM_DEFAULT);
                    }
                    break;
                }
        ...
        if (active_actor) {
            ...
            case (MX0_A02_TIMER_BASIC_MOVE_01): {
                if (default_state) {
                    ...
                    Commands->Start_Timer(obj, this,
                                          (MX0_A02_TIMERLENGTH_BASIC_MOVE
                                           + Get_Int_Random(0, MX0_A02_TIMERLENGTH_BASIC_MOVE)),
            ...
            case (MX0_A02_TIMER_ENGINEER_FIX_TANK): {
                ...
                if (tank) {
                    ...
                    GameObject* newtank
                        = Commands->Create_Object("GDI_Medium_Tank_Player", tank_pos);
                    if (newtank) {
    ...
    void MX0_A02_Say_Something(GameObject * obj, int speech_id, bool face_target)
    {
        if (active_actor) {
            ...
            case (MX0_A02_SPEECH_GDI_01_STARTUP): {
                conv_name = ("MX0_GDITROOPER1_066"); // DEBUG "Reinforcements? There's just one
                                                     // guy!"
                break;
            }
            case (MX0_A02_SPEECH_GDI_02_STARTUP): {
            ...
            case (MX0_A02_SPEECH_GDI_SPOTS_HELI_01): {
                conv_name
                    = ("MX0_GDITROOPER2_092"); // DEBUG "Chopper! They're dropping more troops!"
                break;
            }
            case (MX0_A02_SPEECH_GDI_SPOTS_HELI_02): {
            ...
            case (MX0_A02_SPEECH_ENDING_05): {
                conv_name = ("MX0_GDITROOPER3_109"); // DEBUG "Recon One to Eagle Base. We've taken
                                                     // casualties, but we're okay."
                break;
            }
            ...
            case (MX0_A02_SPEECH_ENGINEER_DONE): {
                conv_name = ("MX0_ENGINEER1_118"); // DEBUG "Your tank is repaired and ready to
                                                   // roll, Havoc."
                break;
            }
            case (MX0_A02_SPEECH_UNSTOPPABLE): {
                conv_name
                    = ("MX0_GDITROOPER1_119"); // DEBUG "You'll be unstoppable in that tank, sir!"
                break;
            }
            case (MX0_A02_SPEECH_TANKSAY_01): {
                conv_name = ("MX0_ENGINEER2_120"); // DEBUG "I'll clear the road once you're inside
                                                   // the tank, Havoc."
                break;
            }
            ...
            case (MX0_A02_SPEECH_TANKSAY_03): {
                conv_name
                    = ("MX0_GDITROOPER2_122"); // DEBUG "The tank's yours, Havoc! Rock and roll!"
                break;
            }
            case (MX0_A02_SPEECH_TANKSAY_04): {
...
DECLARE_SCRIPT(MX0_A02_GDI_VEHICLE,
               "") { void Created(GameObject * obj) { Commands->Set_Health(obj, 10.0f);
}
...
DECLARE_SCRIPT(MX0_A02_GDI_MEDTANK, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if ((type == CUSTOM_EVENT_VEHICLE_ENTERED) && (!entered)) {
            ...
            GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENTERED_TANK,
                                            MX0_A02_CUSTOM_PARAM_DEFAULT);
            }
        }
    }
...
DECLARE_SCRIPT(MX0_A02_ZONE_STARTUP, "") { void Entered(GameObject * obj, GameObject* enterer) {
    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
if (controller) {
    Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_STARTUP,
                                MX0_A02_CUSTOM_PARAM_DEFAULT);
    Commands->Destroy_Object(obj);
}
}
...
DECLARE_SCRIPT(MX0_A02_HELICOPTER, "ActorID=0:int") {
    void Created(GameObject * obj) { int actor_id = Get_Int_Parameter("ActorID");
if (actor_id) {
...
void Killed(GameObject* obj, GameObject* killer)
{
    ...
    if (!actor_id) {
        GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
        if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT);
        }
    }
    else {
        GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
        if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT);
        }
    }
}
...
DECLARE_SCRIPT(MX0_A02_ZONE_DEFAULT_ON, "") { void Entered(GameObject * obj, GameObject* enterer) {
    GameObject* controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
if (controller) {
    Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_MAIN_STARTUP,
                                MX0_A02_CUSTOM_PARAM_DEFAULT);
...
const Vector3 M03_A05_spawn_location[3]
    = { Vector3(-53.33f, 37.58f, 8.87f), Vector3(-111.40f, 32.27f, 9.31f),
...
DECLARE_SCRIPT(M03_A05_Evac_Zone, "")
{
    ...
    void Create_Soldier(Vector3 position)
    {
        ...
        if (soldier_obj_1) {
            Commands->Attach_Script(soldier_obj_1, "M00_Trigger_When_Destroyed_RMV",
                                    "1,2,1,0,1000004,1000,1,0.0,0.0,0");
