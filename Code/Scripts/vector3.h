...
{
    return Vector3((a.X + (b.X - a.X) * alpha), (a.Y + (b.Y - a.Y) * alpha),
                   (a.Z + (b.Z - a.Z) * alpha));
}
...
/***********************************************************************************************
 * Vector3::Cap_To_Absolute_Of -- Sets each component of the vector to no larger than the -ve or +ve
 *of*
 *                                                                                             *
 * INPUT:                                                                                      *
 *                                                                                             *
...
{
    return (unsigned(255) << 24) | (unsigned(Z * 255.0f) << 16) | (unsigned(Y * 255.0f) << 8)
        | (unsigned(X * 255.0f));
}
...
{
    return (unsigned(255) << 24) | (unsigned(X * 255.0f) << 16) | (unsigned(Y * 255.0f) << 8)
        | (unsigned(Z * 255.0f));
}
