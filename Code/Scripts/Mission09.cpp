    ...
    void Add_An_Objective(int id)
    {
        ...
        case 900: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    900, 90, "POG_M09_1_02.tga", IDS_POG_PROTECT, Commands->Get_Position(object));
            }
        } break;
        ...
        case 901: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    901, 99, "POG_M09_1_01.tga", IDS_POG_RETRIEVE, Commands->Get_Position(object));
            }
        } break;
        // New Primary Mission Objective: Escort Dr. Mobius to the Surface
        case 902: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    902, 98, "POG_M08_1_03.tga", IDS_POG_ESCORT, Commands->Get_Position(object));
            }
        } break;
        // New Primary Mission Objective: Escort Dr. Mobius to the Rendezvous Point
        case 903: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    903, 97, "POG_M09_1_03.tga", IDS_POG_ESCORT, Commands->Get_Position(object));
            }
        } break;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == BLOCK_ON) {
            if ((block1 != 0) && (block2 != 0) && (block3 != 0) && (block4 != 0)) {
                ...
                GameObject* rub1 = Commands->Create_Object("M08_Rubble_Stub",
                                                           Vector3(-108.066f, 483.917f, -191.022f));
                block1 = Commands->Get_ID(rub1);
                Commands->Set_Is_Rendered(rub1, false);
                GameObject* rub2 = Commands->Create_Object("M08_Rubble_Stub",
                                                           Vector3(-25.433f, 513.013f, -150.613f));
                block2 = Commands->Get_ID(rub2);
                Commands->Set_Is_Rendered(rub2, false);
                GameObject* rub3 = Commands->Create_Object("M08_Rubble_Stub",
                                                           Vector3(-47.948f, 535.216f, -103.284f));
                block3 = Commands->Get_ID(rub3);
                Commands->Set_Is_Rendered(rub3, false);
                Commands->Set_Facing(rub3, -90.0);
                GameObject* rub4 = Commands->Create_Object("M08_Rubble_Stub",
                                                           Vector3(39.231f, 515.105f, -78.137f));
        ...
        if (type == MOBIUS_KILLED) {
            Commands->Set_HUD_Help_Text(IDS_M09DSGN_DSGN0073I1DSGN_TXT,
...
DECLARE_SCRIPT(M09_Havoc_Script, "") {
    void Created(GameObject * obj) { /*Commands->Give_PowerUp(obj, "Shotgun Weapon 3 Clips PU");
                                     ...
                                     Commands->Give_PowerUp(obj, "Grenade Launcher Weapon
                                     PowerUps"); Commands->Give_PowerUp(obj,
                                     "GL_Weapon_1_Clip_PowerUp"); Commands->Give_PowerUp(obj, "Mine
                                     Weapons PowerUps"); Commands->Give_PowerUp(obj, "Remote Mine
                                     Weapon 1 Clip PU"); Commands->Give_PowerUp(obj, "Sniper Weapon
                                     1 Clip PU"); Commands->Give_PowerUp(obj, "Sniper Weapon 1 Clip
                                     PU"); Commands->Give_PowerUp(obj, "MG Weapon 1 Clip PowerUp");
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            if (mobius) {
                ...
                // Commands->Send_Custom_Event (obj, Commands->Find_Object(2000071), SPAWN_LOC,
                // INCREMENT, 0.0f); Commands->Send_Custom_Event (obj,
                // Commands->Find_Object(2000071), 901, 1, 0.0f);
...
DECLARE_SCRIPT(M09_Evac_Point_Objective, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        /*GameObject *mobius = Commands->Find_Object (2000010);
        float mobius_distance = Commands->Get_Distance(Commands->Get_Position (Commands->Find_Object
        (2000969)), Commands->Get_Position (mobius));
        ...
        Commands->Get_Position (chin_loc)); Commands->Set_Facing(chinook_obj, facing);
        ...
        else
        {
                ...
                params.Set_Movement( Commands->Get_Position (Commands->Find_Object (2000969)), 1.2f,
        0.8f );
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == TIMER_RESET) {
            ...
            float mobius_distance
                = Commands->Get_Distance(Commands->Get_Position(Commands->Find_Object(2000969)),
            ...
            if (mobius_distance < 15.0f) {
                ...
                GameObject* chinook_obj
                    = Commands->Create_Object("Invisible_Object", Commands->Get_Position(chin_loc));
...
DECLARE_SCRIPT(M09_Mobius_Initial_Conversation, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 903 && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000279), CONVERSATION, ENDED,
                                        0.0f);
...
DECLARE_SCRIPT(M09_Mobius_Follow, "") // Mobius (Pre-Suit): 2000010
{
    ...
    /*void Enemy_Seen(GameObject * obj, GameObject *enemy )
    {
            ...
            params.Set_Movement( Commands->Get_Position (Commands->Find_Object
    (attack_path)), 1.2f, 1.0f );
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == RESEND_GOTO) {
            ...
            params.Set_Basic(this, INNATE_PRIORITY_ENEMY_SEEN - 5, MOBIUS_GOTO);
            params.Set_Movement(Commands->Get_Position(Commands->Find_Object(attack_path)), 1.2f,
                                1.0f);
        ...
        if (timer_id == TOO_FAR) {
            if (!nofollow) {
                float distance = (Commands->Get_Distance(
...
DECLARE_SCRIPT(M09_Home_Location_10, "") { void Created(GameObject * obj) {
...
DECLARE_SCRIPT(M09_Mutant_Ambush_Zone_01, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000071), SPAWN_LOC, INCREMENT,
                                        0.0f);
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000122), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000123), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000124), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000125), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
...
DECLARE_SCRIPT(M09_Stealth_Tank_Pilot,
               "") { void Created(GameObject * obj) { Commands->Set_Facing(obj, 35.0f);
Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M09_Excavation_Tunnel_Encounter_Off,
               "") { void Entered(GameObject * obj,
                                  GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
...
{ void Custom(GameObject * obj, int type, int param, GameObject* sender) {
    if (type == ACTIVATE && param == ACTIVATE) { // nod spawners
...
DECLARE_SCRIPT(M09_Excavation_Tunnel_3, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000171), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
...
DECLARE_SCRIPT(M09_Mutant, "") {
    void Created(GameObject * obj) { Commands->Set_Player_Type(obj, SCRIPT_PLAYERTYPE_MUTANT);
}
}
;
...
DECLARE_SCRIPT(M09_Explosion_Zone_Lab01, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Vector3(-102.560f, 483.462f, -155.543f));
            Commands->Start_Timer(obj, this, 1.0f, 100);
        }
    }
    ...
    {
        if (timer_id == 100) {
            /*Commands->Create_Explosion("Ground Explosions Twiddler", Vector3 (-102.560f, 483.462f
            ,-155.543f)); GameObject *blocker; blocker = Commands->Create_Object (
            "M08_Rubble_Stub", Vector3 (-102.560f, 483.462f ,-155.543f));*/
        }
    }
};
...
DECLARE_SCRIPT(M09_Explosion_Zone_Lab02, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Vector3(-6.151f, 494.846f, -151.888f));
            GameObject* blocker1;
            blocker1
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-6.151f, 494.846f, -151.888f));
...
DECLARE_SCRIPT(M09_Explosion_Zone_Tunnel01, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Vector3(-70.356f, 475.905f, -63.233f));
            GameObject* blocker1;
            blocker1
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-74.290f, 474.747f, -64.022f));
...
DECLARE_SCRIPT(M09_Mutant_Excavation_Zone_01, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000158), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            Commands->Set_Innate_Is_Stationary(Commands->Find_Object(2000158), false);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000159), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            Commands->Set_Innate_Is_Stationary(Commands->Find_Object(2000159), false);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000160), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
            Commands->Set_Innate_Is_Stationary(Commands->Find_Object(2000160), false);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000161), CHANGE_PLAYERTYPE,
                                        MUTANT, 0.0f);
...
DECLARE_SCRIPT(M09_Flamer_Attack_Zone, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Flamer Customs
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000185), ATTACK,
                                        (Commands->Get_ID(STAR)), 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000186), ATTACK,
                                        (Commands->Get_ID(STAR)), 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000187), ATTACK,
                                        (Commands->Get_ID(STAR)), 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000188), ATTACK,
                                        (Commands->Get_ID(STAR)), 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M09_Mutant_Path_01,
               "") { void Action_Complete(GameObject * obj, int action_id,
                                          ActionCompleteReason reason) { ActionParamsStruct params;
...
DECLARE_SCRIPT(M09_Key_Grant,
               "") { void Poked(GameObject * obj, GameObject* poker) { if (poker == STAR) {

    GameObject* key1
    = Commands->Create_Object("Level_01_Keycard", Vector3(-97.303f, 520.441f, -153.080f));
...
{
        Commands->Send_Custom_Event( obj, Commands->Find_Object (2000452), KEY_COUNTER, INCREMENT,
0.0f ); Commands->Send_Custom_Event( obj, Commands->Find_Object (2000709), GOAL, DECREMENT, 0.0f );
}
}*/
}
;
        ...
        if (type == VERIFY) {
            ...
            if (param == STOP) {
                ...
                if (!opened) {
                    ...
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(2000010), WAYPATH,
                                                2000462, 0.0f);
                }
            }
        }
...
DECLARE_SCRIPT(M09_MrShuman_Zone, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == DIST_CHECK && star_in_zone) {
            float mobius_distance
                = Commands->Get_Distance(Commands->Get_Position(STAR),
                                         Commands->Get_Position(Commands->Find_Object(2000010)));
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        float mobius_distance = Commands->Get_Distance(
            Commands->Get_Position(STAR), Commands->Get_Position(Commands->Find_Object(2000010)));
    ...
    {
        if (action_id == 954) {
            /*GameObject *key2 = Commands->Create_Object ( "Level_02_Keycard", Vector3 (-76.473f,
            457.493f, -153.807f) ); Commands->Attach_Script (key2, "M09_Containment_Key_2", "");*/
...
DECLARE_SCRIPT(M09_Elevator_Movement_Zone, "Direction:int, Anim_num:int, Elev_obj_num:int") {
    void Entered(GameObject * obj, GameObject* enterer) { char * elevators[9] = {
...
DECLARE_SCRIPT(M09_Elevator_All_Zone, "Controller_num:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            ...
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(Get_Int_Parameter("Controller_num")), SET_STAR, ENTER);
        }
    }
    ...
    void Exited(GameObject * obj, GameObject * exiter)
    {
        if (exiter == STAR) {
            star_in_zone = false;
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(Get_Int_Parameter("Controller_num")), SET_STAR, EXIT);
        }
    }
};
    ...
    "Waypoint_num:int, Elev_obj_num:int, Anim_num:int, Direction = 0:int, Mobius_exit_goto:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        char* elevators[9] = {
            "l09_res_elev06.l09_res_elev06", "elev01.elev01",
            "res_elev04.res_elev04",         "l09_res_elev05.l09_res_elev05",
            "res_elev11.res_elev11",         "l09_big_elev.l09_big_elev",
            "l09_big2_elev.l09_big2_elev",   "cent_elev01.cent_elev01",
            "lab_spn_door08.lab_spn_door08",
        };
    ...
    {
        char* elevators[9] = {
            "l09_res_elev06.l09_res_elev06", "res_elev01.res_elev01",
            "res_elev04.res_elev04",         "l09_res_elev05.l09_res_elev05",
            "res_elev11.res_elev11",         "l09_big_elev.l09_big_elev",
            "l09_big2_elev.l09_big2_elev",   "cent_elev01.cent_elev01",
            "lab_spn_door08.lab_spn_door08",
            ...
            if (!param) {
                if (Get_Int_Parameter("Direction") == 0) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(2000010), ELEVATOR,
                                                (Get_Int_Parameter("Waypoint_num")));
                }
        ...
        if (type == SET_STAR) {
            if (param == ENTER) {
                ...
                if (((Commands->Get_ID(obj)) != 2000607) && ((Commands->Get_ID(obj)) != 2000599)) {
                    ...
                    if (Get_Int_Parameter("Direction") == 1) {
                        Commands->Send_Custom_Event(obj, Commands->Find_Object(2000010),
                                                    ELEVATOR_DOWN,
                                                    (Get_Int_Parameter("Waypoint_num")));
                    }
                }
            ...
            if (param == EXIT) {
                ...
                // Get_Int_Parameter("Mobius_exit_goto"));
            }
        }
        ...
        if (type == ACTIVATE) {
            if (star_in_zone && mobius_in_zone) {
                ...
                /*	Commands->Start_Timer (obj, this, 3.0f, 333);
                        ...
                        GameObject *rub1 = Commands->Create_Object ("M08_Rubble_Stub", Vector3
                   (-108.916f, 483.904f, -191.022f)); block1 = Commands->Get_ID (rub1);
                        Commands->Set_Is_Rendered( rub1, false );
                        GameObject *rub2 = Commands->Create_Object ("M08_Rubble_Stub", Vector3
                   (-25.433f, 513.013f, -150.613f)); block2 = Commands->Get_ID (rub2);
                        Commands->Set_Is_Rendered( rub2, false );
                        GameObject *rub3 = Commands->Create_Object ("M08_Rubble_Stub", Vector3
                   (-47.948f, 535.216f, -103.284f)); block3 = Commands->Get_ID (rub3);
                        Commands->Set_Is_Rendered( rub3, false );
                        Commands->Set_Facing (rub3, -90.0);
                        GameObject *rub4 = Commands->Create_Object ("M08_Rubble_Stub", Vector3
                   (39.231f, 515.105f, -78.137f)); block4 = Commands->Get_ID (rub4);
                        Commands->Set_Is_Rendered( rub4, false );
*/ Commands->Static_Anim_Phys_Goto_Frame(Get_Int_Parameter("Elev_obj_num"), 0,
                                         elevators[Get_Int_Parameter("Anim_num")]);
            }
        ...
        if (type == ACTIVATEDOWN) {
            if (star_in_zone && mobius_in_zone) {
                Commands->Static_Anim_Phys_Goto_Last_Frame(
                    Get_Int_Parameter("Elev_obj_num"), elevators[Get_Int_Parameter("Anim_num")]);
            }
        }
    }
};
...
DECLARE_SCRIPT(M09_Waypath_Run, "Waypath_num:int, Attacker_num:int, Controller_num:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("Controller_num")),
                                    MUTANT_ATTACKEE, attackee_id);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == START) {
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(Get_Int_Parameter("Controller_num")), ATTACKER_CHECK, 0);
        }
    }
};
...
DECLARE_SCRIPT(M09_Zone_Enabled_Mobius, "Waypath_id:int, Condition=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (goal <= 0) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2000010), FOLLOW,
                                        Get_Int_Parameter("Waypath_id"), 0.0f);
            goal = 1;
        }
    }
...
DECLARE_SCRIPT(M09_Flyover_Recycle, "") { void Destroyed(GameObject * obj) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(2000955), FLYOVER, 0, 0.0f);
}
}
;
...
DECLARE_SCRIPT(M09_Weather_On, "") {
    void Entered(GameObject * obj, GameObject* enterer) { Commands->Set_Fog_Enable(true);
...
DECLARE_SCRIPT(M09_Evac_Transport, "") // 2000969
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            GameObject* chinook = Commands->Create_Object_At_Bone(bone, "GDI_Transport_Helicopter",
                                                                  "XG_TransprtBone");
            GameObject* troop
                = Commands->Create_Object_At_Bone(bone, "GDI_RocketSoldier_2SF", "SPAWNER");
...
DECLARE_SCRIPT(M09_Evac_Bone, "") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "XG_TransprtBone.XG_EV2_PathA")
        == 0) { Commands->Set_Animation(obj, "XG_TransprtBone.XG_EV2_Pathloop", true);
}
}
}
;

DECLARE_SCRIPT(M09_Evac_Helicopter,
               "Gunner:int") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "v_GDI_trnspt.XG_EV2_trnsA") == 0) { int gunner_id
                                                           = Get_Int_Parameter("Gunner");
...
DECLARE_SCRIPT(M09_Mobius_Goto,
               "GotoObject:int") { void Entered(GameObject * obj, GameObject* enterer) {
    GameObject* mobius = Commands->Find_Object(2000010);
...
DECLARE_SCRIPT(M09_Innate_Enable_Zone, "SoundProjector:int, Radius=7.0:float, Total_Enemies:int")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == INNATE_RECYCLE && !all_checked_in) {
            Vector3 projector = Commands->Get_Position(
                Commands->Find_Object(Get_Int_Parameter("SoundProjector")));
...
DECLARE_SCRIPT(M09_Zone_Destroy, "") {
    void Entered(GameObject * obj, GameObject* enterer) { Commands->Destroy_Object(obj);
}
}
;
...
DECLARE_SCRIPT(M09_Ambient_Clutter, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == AMB_SOUND) {
            char* ambients[7] = {
                "Ambient_Screams_03", "Ambient_Screams_04", "Explosion_Glass_02",
                "Explosion_Glass_03", "Explosion_Large_01", "Vehicle_Explo_Med2",
                "Vehicle_Explo_Med1",
            };
        ...
        if (timer_id == AMB_EXPLOSION) {
            ...
            Commands->Create_Explosion(
                "Air Explosions Twiddler",
                Commands->Get_Position(Commands->Find_Object(exp_point[exp_num])));
...
DECLARE_SCRIPT(M09_Scientist_Cower,
               "") { void Created(GameObject * obj) { float delay = Commands->Get_Random(1, 3);
...
DECLARE_SCRIPT(M09_KeyCard_Zone, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        mobius = Commands->Find_Object(2000010);
        mobius_distance
            = Commands->Get_Distance(Commands->Get_Position(STAR), Commands->Get_Position(mobius));
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == COUNT) {
            ...
            if (param == 2) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(2000452), KEY_COUNTER,
                                            INCREMENT, 0.0f);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        /*if(action_id == 910)
        {
                Commands->Send_Custom_Event( obj, Commands->Find_Object (2000010), WAYPATH, 2000462,
        0.0f );
...
DECLARE_SCRIPT(M09_Innate_Activate,
               "Target0=0:int, Target1=0:int, Target2=0:int, Target3=0:int, Target4=0:int, "
               "Target5=0:int, Target6=0:int, Target7=0:int, Target8=0:int, Target9=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            for (int x = 0; x < 10; x++) {
                if (target[x] != 0) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(target[x]),
                                                M09_INNATE_ENABLE, 0);
                }
            }
        }
...
DECLARE_SCRIPT(M09_Camera_Activate,
               "Camera0=0:int, Camera1=0:int, Camera2=0:int, Camera3=0:int, Camera4=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered) {
            ...
            for (int x = 0; x < 10; x++) {
                if (camera[x] != 0) {
                    Commands->Attach_Script(Commands->Find_Object(camera[x]), "RMV_Camera_Behavior",
                                            "90.0, 0, 1, 0.0");
                }
            }
        }
...
DECLARE_SCRIPT(M09_Destroy_Zone, "") { void Entered(GameObject * obj, GameObject* enterer) {
