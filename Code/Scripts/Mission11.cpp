    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            ...
            else if (action_id == missionIntroConv02) // introduce rescue sydney objective here
            {
                ...
                Commands->Add_Objective(M11_FIFTH_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M11_05,
                                        nullptr, IDS_Enc_Obj_Primary_M11_05);
                ...
                if (nukeSwitch != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info(M11_FIFTH_OBJECTIVE_JDG, 94,
                                                     "POG_M11_1_04.tga", IDS_POG_SABOTAGE);
                }

                else {
                    Commands->Debug_Message(
                        "***************************M11 mission controller cannot find sydnee to "
                        "ping her on radar--add forth objective\n");
                }
            }
        } break;
        }
        ...
        if (type == CUSTOM_EVENT_SOUND_ENDED) { }
            ...
            case M11_ATTACH_HAVOCS_SCRIPT_JDG: {
                if (STAR) {
                    ...
                    missionIntroConv = Commands->Create_Conversation("M11_Level_Intro_Conversation",
                                                                     100, 1000, false);
                    Commands->Join_Conversation(nullptr, missionIntroConv, false, false);
            ...
            {
                if (STAR) {
                    missionIntroConv02 = Commands->Create_Conversation(
                        "M11_Level_Intro_Conversation02", 100, 1000, false);
                    Commands->Join_Conversation(nullptr, missionIntroConv02, false, false);
                    Commands->Join_Conversation(nullptr, missionIntroConv02, false, false);
                    ...
                    Commands->Send_Custom_Event(
                        obj, Commands->Find_Object(M11_FLOOR01_SECURITY_CONTROLLER_JDG), 0,
            ...
            case M11_ADD_FIRST_OBJECTIVE_JDG: // player's first objective is to get into lower
                                              // levels
            {
                if (player_has_reached_musuem == false) {
                    Commands->Add_Objective(
                        M11_FIRST_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                        IDS_Enc_ObjTitle_Primary_M11_02, nullptr, IDS_Enc_Obj_Primary_M11_02);
                    Vector3 musemLocation(2.072f, 16.705f, -24.531f);
                    Commands->Set_Objective_HUD_Info_Position(M11_FIRST_OBJECTIVE_JDG, 91,
                                                              "POG_M11_1_02.tga",
                                                              IDS_POG_INFILTRATE, musemLocation);
                }
            } break;

            case M11_END_FIRST_OBJECTIVE_JDG: // player has reached museum area--clear first
                                              // objective
            {
                player_has_reached_musuem = true;
                Commands->Set_Objective_Status(M11_FIRST_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
                // Commands->Send_Custom_Event ( obj, obj, 0, M11_ADD_SECOND_OBJECTIVE_JDG, 5 );

                evaPingedSydneyConv = Commands->Create_Conversation(
                    "M11_EVA_SydneyPinged_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, evaPingedSydneyConv, false, false);
                ;
            ...
            case M11_ADD_SECOND_OBJECTIVE_JDG: // player's second objective is to locate sydney
                                               // mobius
            {
                Vector3 sydenysLocation(0.000f, 96.000f, -34.250f);
                // Commands->Add_Objective( M11_SECOND_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                // OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M11_01 );
                Commands->Add_Objective(M11_SECOND_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M11_01,
                                        nullptr, IDS_Enc_Obj_Primary_M11_01);
                Commands->Set_Objective_HUD_Info_Position(M11_SECOND_OBJECTIVE_JDG, -1,
                                                          "POG_M11_1_01.tga", IDS_POG_RESCUE,
                                                          sydenysLocation);

            } break;

            case M11_ADD_SECOND_OBJECTIVE_POG_JDG: // player's second objective is to locate sydney
                                                   // mobius
            {
                ...
                if (sydney != nullptr) {
                    ...
                    // );
                    Commands->Set_Objective_HUD_Info_Position(M11_SECOND_OBJECTIVE_JDG, 90,
                                                              "POG_M11_1_01.tga", IDS_POG_RESCUE,
                                                              sydenysLocation);
                }
                    ...
                    Commands->Debug_Message(
                        "***************************M11 mission controller cannot find sydnee to "
                        "ping her on radar--add second objective\n");
                }
            } break;

            case M11_END_SECOND_OBJECTIVE_JDG: // player has reached Sydney's cell area--clear 2nd
                                               // objective
            {
                Commands->Set_Objective_Status(M11_SECOND_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
                Commands->Send_Custom_Event(obj, obj, 0, M11_ADD_FORTH_OBJECTIVE_JDG, 5);

                // nukeIntroConv = Commands->Create_Conversation(
                // "M11_EVA_Activate_Nuke_Conversation", 100, 1000, false);
                // Commands->Join_Conversation( nullptr, nukeIntroConv, false, false );
            ...
            {
                Commands->Add_Objective(M11_THIRD_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M11_03,
                                        nullptr, IDS_Enc_Obj_Primary_M11_03);
                ...
                if (entryZone != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(M11_THIRD_OBJECTIVE_JDG, 91,
                                                              "POG_M11_1_03.tga",
                                                              IDS_POG_INFILTRATE, pogLocation);
                }
            } break;

            case M11_END_THIRD_OBJECTIVE_JDG: // player has reached power core--clear 3rd objective
            {
                Commands->Set_Objective_Status(M11_THIRD_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            ...
            {
                Commands->Add_Objective(M11_FORTH_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M11_04,
                                        nullptr, IDS_Enc_Obj_Primary_M11_04);
                ...
                if (sydney != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info(M11_FORTH_OBJECTIVE_JDG, 93,
                                                     "POG_M07_1_04.tga", IDS_POG_PROTECT);
                }
            ...
            case M11_END_FORTH_OBJECTIVE_JDG: // nuke switch has been poked--end protect sydney
                                              // objective then end sabotage
            {
                Commands->Set_Objective_Status(M11_FORTH_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
                Commands->Send_Custom_Event(obj, obj, 0, M11_END_FIFTH_OBJECTIVE_JDG, 3);
            } break;

            case M11_ADD_FIFTH_OBJECTIVE_JDG: // player's fifth objective is to sabotage the nuclear
                                              // missle
            {
                evaNukeConv = Commands->Create_Conversation("M11_EVA_Activate_Nuke_Conversation",
                                                            100, 1000, false);
                Commands->Join_Conversation(nullptr, evaNukeConv, false, false);
                ;
                Commands->Start_Conversation(evaNukeConv, evaNukeConv);
                Commands->Monitor_Conversation(obj, evaNukeConv);
            } break;

            case M11_END_FIFTH_OBJECTIVE_JDG: // nuke switch has been poked--end protect sydney
                                              // objective then end sabotage
            {
                Commands->Set_Objective_Status(M11_FIFTH_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
...
DECLARE_SCRIPT(M11_Floor01_SecurityTurrets_Controller_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        else if (param == M01_YOUR_OPERATOR_IS_DEAD_JDG) // this is custom recieved when a turret
                                                         // gets destroyed
        {
            deadTurrets++;
...
DECLARE_SCRIPT(M11_Floor01_SecurityTurret_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M11_FLOOR01_SECURITY_CONTROLLER_JDG),
                                    0, M01_YOUR_OPERATOR_IS_DEAD_JDG, 0);
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_START_ACTING_JDG) {
            ...
            /*if (obj && myID == M11_FLOOR01_SECURITY_TURRET_01_JDG || myID ==
            M11_FLOOR01_SECURITY_TURRET_10_JDG)
            {
...
/***********************************************************************************************************************
Putting remaining scripts dealing with first few minutes of mision here--including C130 drop off
stuff
************************************************************************************************************************/
DECLARE_SCRIPT(M11_FirstFloor_Stuff_Controller_JDG, "") // M11_FIRSTFLOOR_STUFF_CONTROLLER_JDG
                                                        // 100593
{
    typedef enum
    {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_GOTO_IDLE_JDG) {
            if (playersPosition == FIRST_FLOOR) {
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100569), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100570), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100571), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100572), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100573), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100574), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100575), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100576), 0,
                                            M01_GOTO_IDLE_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100568), 0,
                                            M01_GOTO_IDLE_JDG, 0); // artillery controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100633), 0,
                                            M01_GOTO_IDLE_JDG, 0); // ion cannon controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(101805), 0,
                                            M01_GOTO_IDLE_JDG, 0); // obelisk explosion controller
            }
        }
            ...
            if (playersPosition == SECOND_FLOOR) {
                playersPosition = FIRST_FLOOR;
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100569), 0,
                                            M01_START_ACTING_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100570), 0,
                                            M01_START_ACTING_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100571), 0,
                                            M01_START_ACTING_JDG, 0); // sound controller
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100576), 0,
                                            M01_START_ACTING_JDG, 0); // sound controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100568), 0,
                                            M01_START_ACTING_JDG, 0); // artillery controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100633), 0,
                                            M01_START_ACTING_JDG, 0); // ion cannon controller
                Commands->Send_Custom_Event(obj, Commands->Find_Object(101805), 0,
...
DECLARE_SCRIPT(M11_Turn_Off_FirstFloor_Stuff_JDG,
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M11_FIRSTFLOOR_STUFF_CONTROLLER_JDG), 0,
                                M01_GOTO_IDLE_JDG, 0);
}
}
}
...
Vector3 ionCannonlocations[10] = {
    Vector3(35.916f, -74.797f, -0.115f), Vector3(30.173f, -108.692f, 9.706f),
    Vector3(16.727f, -88.545f, 1.839f),  Vector3(9.679f, -97.887f, 4.033f),
    Vector3(2.377f, -74.329f, -0.097f),  Vector3(3.579f, -108.123f, 9.657f),
    Vector3(-6.437f, -107.906f, 9.731f), Vector3(-17.015f, -91.3109f, 3.493f),
    Vector3(-31.627f, -87.764f, 6.168f), Vector3(-22.152f, -73.552f, -0.079f),
};
    ...
    void Custom( GameObject * obj, int type, int param, GameObject * sender )
    {
            ...
            else if (param == M01_START_ATTACKING_01_JDG)
            {
                    if (commandClearance == true)
                    {
                            ...
                            Commands->Create_Sound ( "M11DSGN_DSGN0095I1EVAC_SND",
    speaker01position, obj ); Commands->Create_Sound ( "M11DSGN_DSGN0095I1EVAC_SND",
    speaker02position, obj ); Commands->Create_Sound ( "M11DSGN_DSGN0095I1EVAC_SND",
    speaker03position, obj );

                            float delayTimer = Commands->Get_Random ( 5, 10 );
                            Commands->Send_Custom_Event ( obj, obj, 0, M01_START_ATTACKING_02_JDG,
    delayTimer );
                    }
            }
            ...
            else if (param == M01_START_ATTACKING_02_JDG)
            {
                    if (commandClearance == true)
                    {
                            ...
                            GameObject *ionCannonGuy =
    Commands->Create_Object("GDI_MiniGunner_IonCannon_JDG", ionCannonlocations[random]);
                            Commands->Attach_Script(ionCannonGuy, "M11_IonCannon_Guy_JDG", "");

                            float delayTimer = Commands->Get_Random ( 60, 120 );
                            Commands->Send_Custom_Event ( obj, obj, 0, M01_START_ATTACKING_01_JDG,
    delayTimer );
                    }
            }
    }*/
...
Vector3 m11Artillerylocations[35] = {
    Vector3(3.486f, -53.794f, 3.799f),     Vector3(-20.923f, -31.001f, 26.833f),
    Vector3(-23.338f, 2.514f, 26.502f),    Vector3(-23.097f, 32.220f, 38.927f),
    Vector3(-12.618f, -21.520f, 12.796f),  Vector3(-2.253f, 5.014f, 23.738f),
    Vector3(7.692f, 7.967f, 19.242f),      Vector3(0.726f, 20.706f, 24.670f),
    Vector3(-11.148f, 50.407f, 38.031f),   Vector3(4.330f, 49.481f, 48.165f),
    Vector3(9.350f, 48.324f, 40.018f),     Vector3(20.210f, 45.413f, 32.186f),
    Vector3(21.162f, 31.207f, 26.841f),    Vector3(21.673f, 1.765f, 36.254f),
    Vector3(19.174f, -28.685f, 21.450f),   Vector3(4.334f, -16.692f, 0),
    Vector3(-3.070f, -4.271f, 0),          Vector3(-0.372f, -5.744f, -18.765f),
    Vector3(43.437f, -64.747f, 51.465f),   Vector3(54.511f, -32.046f, 59.763f),
    Vector3(48.525f, -14.851f, 50.524f),   Vector3(47.396f, 4.976f, 54.233f),
    Vector3(-47.600f, 19.498f, 48.110f),   Vector3(-51.750f, -1.745f, 54.846f),
    Vector3(-47.856f, -25.844f, 45.516f),  Vector3(4.559f, -123.847f, 28.179f),
    Vector3(11.093f, -125.641f, 37.388f),  Vector3(8.425f, -127.718f, 45.484f),
    Vector3(-11.490f, -165.685f, 42.821f), Vector3(-35.123f, -155.089f, 34.401f),
    Vector3(29.645f, -165.685f, 42.816f),  Vector3(-1.107f, -163.946f, 19.644f),
    Vector3(-21.683f, -141.336f, 19),      Vector3(42.883f, -165.685f, 26.360f),
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (obj) {
            if (param == M01_MODIFY_YOUR_ACTION_JDG && attackingPlayer == false) {
                ...
                Commands->Debug_Message("***************************m11 stealth guy 01 has "
                                        "received custom to attack player\n");
                ActionParamsStruct params;
                Commands->Set_Innate_Is_Stationary(obj, false);
                params.Set_Basic(this, 100, M01_GOING_TO_HAVOC_JDG);
                params.Set_Attack(STAR, 10, 0, true);
...
DECLARE_SCRIPT(M11_Floor01_FireGuy_JDG,
               "") { void Created(GameObject * obj) { float myHealth = Commands->Get_Health(obj);
        ...
        if (obj && active_unit_count <= 1) {
            ...
            if (dropoffcount <= dropoffMax) {
                ...
                GameObject* controller
                    = Commands->Create_Object("Invisible_Object", Vector3(0.2f, -25.5f, -10.0f));
...
DECLARE_SCRIPT(M11_C130_Dropoff_Dude_JDG,
               "") // also have M01_Hunt_The_Player_JDG script attached to these guys
{ void Animation_Complete(GameObject * obj,
                          const char* anim) { if (stricmp(anim, "S_a_Human.H_A_X5D_ParaT_1") == 0) {
...
void Killed(GameObject* obj, GameObject* killer)
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M11_C130_DROPOFF_CONTROLLER_JDG), 0,
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && okay_to_trigger == true) {
            ...
            if (stealthSoldier01 != nullptr) {
                ...
                Commands->Send_Custom_Event(obj, stealthSoldier01, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                            delayTimer01);
            }

            if (stealthSoldier02 != nullptr) {
                float delayTimer02 = Commands->Get_Random(0, 1);
                Commands->Send_Custom_Event(obj, stealthSoldier02, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                            delayTimer02);
            }
        }
    }
...
Vector3 m11WetBarSeachLocations[12] = {
    Vector3(-9.862f, -10.541f, -29.855f), Vector3(-0.757f, -12.594f, -29.855f),
    Vector3(9.187f, -12.521f, -29.855f),  Vector3(8.002f, -2.370f, -29.855f),
    Vector3(0.163f, -2.219f, -29.855f),   Vector3(-8.423f, -3.841f, -29.855f),
    Vector3(-9.398f, 5.363f, -29.855f),   Vector3(0.583f, 10.380f, -29.855f),
    Vector3(9.479f, 4.651f, -29.855f),    Vector3(12.758f, -1.367f, -24.531f),
    Vector3(-13.295f, -1.080f, -24.531f), Vector3(-2.069f, -15.477f, -24.531f),
};
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_NORMAL: {
            if (action_id == M01_WALKING_WAYPATH_01_JDG) {
                ...
                params.Set_Basic(this, INNATE_PRIORITY_BULLET_HEARD - 5,
...
DECLARE_SCRIPT(M11_GreenRoom_EntryZone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* surpriseGuy01 = Commands->Create_Object("Nod_RocketSoldier_2SF_Chaingun",
                                                        Vector3(-10.408f, 32.538f, -29.855f));
Commands->Attach_Script(surpriseGuy01, "M11_GreenRoom_SurpriseGuy_JDG", "");

GameObject* surpriseGuy02 = Commands->Create_Object("Nod_RocketSoldier_2SF_Chaingun",
                                                    Vector3(10.796f, 32.476f, -29.855f));
...
DECLARE_SCRIPT(M11_GreenRoom_SurpriseGuy_JDG,
               "") { void Created(GameObject * obj) { Commands->Grant_Key(obj, 2, true);
...
DECLARE_SCRIPT(M11_WarRoom_BattleController_JDG, "") // M11_WARROOM_SECURITY_CONTROLLER_JDG 100361
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
            ...
            if (spawnedSoldierCount < maxSpawnedSoldierCount) {
                if (active_soldier_count < 8) {
                    if (okay_to_spawn_warroom == true) // M11_WARROOM_SECURITY_SPAWNER_02_JDG
                    {
                        ...
                        spawnedSoldierCount++;
                        GameObject* newGuy
                            = Commands->Trigger_Spawner(M11_WARROOM_SECURITY_SPAWNER_JDG);
                        Commands->Attach_Script(newGuy, "M11_WarRoom_SpawnedDude_JDG", "");

                        GameObject* newGuy02
                            = Commands->Trigger_Spawner(M11_WARROOM_SECURITY_SPAWNER_02_JDG);
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_04_JDG) // player is leaving room--disable warroom
                                                         // spawn ability
        {
            okay_to_spawn_warroom = false;
...
************************************************************************************************************************/
DECLARE_SCRIPT(M11_Barracks_SpawnerController_JDG,
               "") // M11_BARRACKS_SPAWNER_CONTROLLER_JDG	100430
{
    int spawn_01_ID;
    int spawn_02_ID;
    int spawn_03_ID;
...
DECLARE_SCRIPT(M11_Barracks_LivingQuarters_T20_EntryZone_JDG,
               "") // 100414 entry to mutant reject w/volt ammo
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            ...
            Commands->Send_Custom_Event(obj,
                                        Commands->Find_Object(M11_BARRACKS_SPAWNER_CONTROLLER_JDG),
...
DECLARE_SCRIPT(M11_Barracks_Scientist_JDG, "") // M11_BARRACKS_SCIENTIST_JDG 100405
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == CUSTOM_EVENT_CONVERSATION_BEGAN
            || type == CUSTOM_EVENT_CONVERSATION_REMARK_STARTED
            || type == CUSTOM_EVENT_CONVERSATION_REMARK_ENDED) { }

        else if (param == M01_START_ACTING_JDG) {
            if (obj && STAR && deadYet == false) {
                scientist_conv01 = Commands->Create_Conversation(
                    "M11_Barracks_M19_Conversation_01_JDG", 100, 30, true);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == scientist_conv01) {
                if (obj && STAR && deadYet == false) {
                    scientist_conv02 = Commands->Create_Conversation(
                        "M11_Barracks_M19_Conversation_02_JDG", 100, 30, true);
                ...
                if (obj && STAR && deadYet == false) {
                    params.Set_Basic(this, 100,
                                     M01_DOING_ANIMATION_02_JDG); // stand up hands over head
            ...
            if (obj && STAR && deadYet == false) {
                scientist_conv03 = Commands->Create_Conversation(
                    "M11_Barracks_M19_Conversation_03_JDG", 100, 30, true);
            ...
            if (obj && STAR && deadYet == false) {
                scientist_conv04 = Commands->Create_Conversation(
                    "M11_Barracks_M19_Conversation_04_JDG", 100, 100, true);
...
DECLARE_SCRIPT(M11_Barracks_LivingQuarters_T18_EntryZone_JDG,
               "") // 100401 this is room where black hand rags on tech
{
    // THESE ARE THE DUDES YOU CONTROL
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (firstEntry == true) {
                firstEntry = false;
                GameObject* blackhand
                    = Commands->Find_Object(M11_BARRACKS_RAGSESSION_BLACKHAND_JDG);
...
DECLARE_SCRIPT(M11_Barracks_TechnicianConversation_Blackhand_JDG,
               "") // M11_BARRACKS_RAGSESSION_BLACKHAND_JDG 100403
{
    int rag_conv;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_START_ACTING_JDG) {
            ...
            GameObject* tech = Commands->Find_Object(M11_BARRACKS_RAGSESSION_TECH_JDG);
            if (tech != nullptr) {
                rag_conv = Commands->Create_Conversation("M11_Barracks_M18_Conversation_JDG", 100,
                                                         50, true);
...
DECLARE_SCRIPT(M11_Barracks_TechnicianConversation_Tech_JDG,
               "") // M11_BARRACKS_RAGSESSION_TECH_JDG 100402
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M11_Barracks_ShowerStealthSoldier_JDG, "") // M11_BARRACKS_STEALTHSOLDIER_JDG 100400
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_START_ACTING_JDG) {
            ...
            int showerConv
                = Commands->Create_Conversation("M11_Shower_StealthGuy_Conversation", 90, 30, true);
...
DECLARE_SCRIPT(M11_Barracks_LivingQuarters_T17_EntryZone_JDG,
               "") // 100393 this is entrance to visceroid room
{
    bool firstEntry;
    ...
    "") // this is a bedroom on left side 100377 2 nod soldiers talking about escaped mutants
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (firstEntry == true) {
                firstEntry = false;
                GameObject* conversationGuy01
                    = Commands->Find_Object(M11_BARRACKS_MUTANTCONVERSATION_GUY01_JDG);
                GameObject* conversationGuy02
                    = Commands->Find_Object(M11_BARRACKS_MUTANTCONVERSATION_GUY02_JDG);
...
DECLARE_SCRIPT(M11_Barracks_MutantConversationGuy_01_JDG,
               "") // M11_BARRACKS_MUTANTCONVERSATION_GUY01_JDG 100378
{
    bool killedYet;
    int mutant_conv;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == CUSTOM_EVENT_CONVERSATION_BEGAN
            ...
            if (obj && conversationGuy02 != nullptr) {
                mutant_conv = Commands->Create_Conversation("M11_Barracks_M15_Conversation_JDG",
                                                            100, 30, true);
        ...
        if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == mutant_conv) {
                GameObject* conversationGuy02
                    = Commands->Find_Object(M11_BARRACKS_MUTANTCONVERSATION_GUY02_JDG);
                if (conversationGuy02 != nullptr) {
                    Commands->Send_Custom_Event(obj, conversationGuy02, 0,
...
DECLARE_SCRIPT(M11_Barracks_MutantConversationGuy_02_JDG,
               "") // M11_BARRACKS_MUTANTCONVERSATION_GUY02_JDG 100379
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M11_Barracks_LivingQuarters_T13_EntryZone_JDG,
               "") // this is entry into mutant/toilet bathroom 100376
{
    // THESE ARE THE DUDES YOU CONTROL
...
DECLARE_SCRIPT(M11_Barracks_ToiletMutant01_JDG,
               "") // this guys ID is M11_BARRACKS_TOILET_MUTANT_01_JDG 100374
...
DECLARE_SCRIPT(M11_Barracks_ToiletMutant02_JDG,
               "") // this guys ID is M11_BARRACKS_TOILET_MUTANT_02_JDG 100375
{ void Created(GameObject * obj) { Commands->Set_Loiters_Allowed(obj, false);
ActionParamsStruct params;
params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
params.Set_Animation("S_A_HUMAN.H_A_A0A0_L28B", true);
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (firstEntry == true) {
                ...
                GameObject* mutant01
                    = Commands->Find_Object(M11_BARRACKS_MUTANTUPRISING_MUTANT01_JDG);
                GameObject* mutant02
                    = Commands->Find_Object(M11_BARRACKS_MUTANTUPRISING_MUTANT02_JDG);
                GameObject* blackhand
                    = Commands->Find_Object(M11_BARRACKS_MUTANTUPRISING_BLACKHAND_JDG);
...
{ void Created(GameObject * obj) { Commands->Enable_Hibernation(obj, false);
Commands->Set_Animation(obj, "X11E_Trajectory.X11E_Trajectory", false, nullptr, 0, 120);
}
...
DECLARE_SCRIPT(M11_Mutant_ShatterGlass_JDG,
               "") { void Created(GameObject * obj) { Commands->Enable_Hibernation(obj, false);
Commands->Set_Animation(obj, "X11E_Shatter.X11E_Shatter", false, nullptr, 0, 120);
}
...
void Damaged(GameObject* obj, GameObject* damager, float amount)
{
    Commands->Set_Animation(obj, "DSP_CRYOBIGD.DSP_CRYOBIGD", false, nullptr, 0, 5);
    Commands->Set_Health(obj, 0.25f);
}
}
;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            case M01_SPAWNER_SPAWN_PLEASE_JDG: // M00_Select_Empty_Hands
            {
                ...
                GameObject* mutantSpawner01_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_01_JDG);
                ...
                GameObject* mutantSpawner02_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_02_JDG);
                ...
                GameObject* mutantSpawner03_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_03_JDG);
                ...
                GameObject* mutantSpawner04_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_04_JDG);
                ...
                GameObject* mutantSpawner05_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_05_JDG);
                ...
                GameObject* mutantSpawner06_guy
                    = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_06_JDG);
            ...
            case M01_SPAWNER_IS_DEAD_JDG: {
                if (okay_to_spawn == true) {
                    ...
                    if (sender == mutantSpawner01_guy) {
                        GameObject* newMutantSpawner01_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_01_JDG);
                        Commands->Attach_Script(newMutantSpawner01_guy,
                        ...
                        GameObject* newMutantSpawner02_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_02_JDG);
                        Commands->Attach_Script(newMutantSpawner02_guy,
                                                "M11_MutantCrypt_Spawner02_Guy_JDG", "");
                        ...
                        GameObject* newMutantSpawner03_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_03_JDG);
                        Commands->Attach_Script(newMutantSpawner03_guy,
                        ...
                        GameObject* newMutantSpawner04_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_04_JDG);
                        Commands->Attach_Script(newMutantSpawner04_guy,
                        ...
                        GameObject* newMutantSpawner05_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_05_JDG);
                        Commands->Attach_Script(newMutantSpawner05_guy,
                        ...
                        GameObject* newMutantSpawner06_guy
                            = Commands->Trigger_Spawner(M11_MUTANT_CRYPT_SPAWNER_06_JDG);
                        Commands->Attach_Script(newMutantSpawner06_guy,
...
DECLARE_SCRIPT(M11_MutantCrypt_Spawner06_Guy_JDG,
               "") // this one has been fixed for wacky findpath bug
{
    typedef enum
    {
        IDLE,
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        GameObject* mutantController
            = Commands->Find_Object(M11_MUTANT_CRYPT_SPAWNER_CONTROLLER_JDG);
        if (mutantController != nullptr) {
...
DECLARE_SCRIPT(M11_End_First_Objective_Zone_JDG,
               "") // player has reached museum area--clear first objective
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
...
DECLARE_SCRIPT(M11_Start_Third_Objective_Zone_JDG,
               "") // player's third objective is to acess the power core
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && entered == false) {
            entered = true;
            addThirdObjectiveConv = Commands->Create_Conversation(
                "M11_Add_Third_Objective_Conversation", 100, 1000, false);
            Commands->Join_Conversation(nullptr, addThirdObjectiveConv, false, false);
            ;
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            ...
            {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M11_MISSION_CONTROLLER_JDG),
                                            0, M11_ADD_THIRD_OBJECTIVE_JDG, 0);
                Commands->Destroy_Object(obj); // one time only zone--cleaning up
            }
        } break;
        }
...
DECLARE_SCRIPT(M11_Start_Fifth_Objective_Zone_JDG,
               "") // player's fifth objective is to sabotage the nuke
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M11_MISSION_CONTROLLER_JDG), 0,
...
DECLARE_SCRIPT(M11_End_Mission_Switch_JDG, "") // this guys ID is M11_END_MISSION_SWITCH_JDG 100106
{
    ...
    {
        if (param == M01_START_ACTING_JDG) {
            Commands->Set_Animation(obj, "DSP_MINICONSEL.DSP_MINICONSEL", false, nullptr, 0, 13);
        }
    }
};
...
DECLARE_SCRIPT(M11_KanesRoom_SecurityTurret_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj,
                                    Commands->Find_Object(M11_KANESROOM_SECURITY_CONTROLLER_JDG), 0,
...
DECLARE_SCRIPT(M11_KanesRoom_SecurityZone_JDG,
               "") // this guys ID is M11_KANESROOM_SECURITY_CONTROLLER_JDG 100351
{
    bool entered;
    int deadTurrets;
    int deadCameras;
...
DECLARE_SCRIPT(M11_Lab_Cryochamber_Switch01_JDG, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poker == STAR && poked == false) {
            ...
            Commands->Send_Custom_Event(obj,
                                        Commands->Find_Object(M11_LABORATORY_MUTANT_CONTROLLER_JDG),
                                        0, M01_MODIFY_YOUR_ACTION_JDG, 0);
        }
    }
};
...
DECLARE_SCRIPT(M11_Laboratory_Scientist_JDG, "")
{
    ...
    {
        Commands->Send_Custom_Event(obj,
                                    Commands->Find_Object(M11_LABORATORY_MUTANT_CONTROLLER_JDG), 0,
                                    M01_SPAWNER_IS_DEAD_JDG, 0);
    }
};
...
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    int sethConv
    = Commands->Create_Conversation("M11_Kane_Regarding_Seth_Conversation", 100, 1000, false);
Commands->Join_Conversation(nullptr, sethConv, false, false);
...
DECLARE_SCRIPT(M11_CeilingRepellers_Controller_JDG,
               "") // M11_FIRSTFLOOR_REPELER_CONTROLLER_JDG 101125
{
    int spawned_units;
    int rope_A_id;
    int rope_B_id;
...
DECLARE_SCRIPT(M11_CeilingRepeller_JDG,
               "") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "S_a_Human.H_a_X11D_repel")
        == 0) { Commands->Attach_Script(obj, "M01_Hunt_The_Player_JDG", "");
}
}
...
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    int theresSydneyConversation
    = Commands->Create_Conversation("M11_Theres_Sydney_Conversation", 100, 1000, false);
               ...
               "") // this guys ID is 100012--using to stop mutant spawners and end objective 3
{
    ...
    void Entered(GameObject * obj, GameObject * enterer) //
    {
        if (enterer == STAR && entered == false) {
            ...
            int powerCoreEntry = Commands->Create_Conversation("M11_PowerCore_Entry_Conversation",
                                                               100, 1000, false);
            ...
            GameObject* mutantController
                = Commands->Find_Object(M11_MUTANT_CRYPT_SPAWNER_CONTROLLER_JDG);
            if (mutantController != nullptr) {
                Commands->Send_Custom_Event(obj, mutantController, 0, M01_QUIT_SPAWNING_PLEASE_JDG,
                                            0);
            }
    ...
    void Created(GameObject * obj)
    {
        ...
        if (hologram01 != nullptr) {
            ...
            if (commander != nullptr) {
                GameObject* kane01 = Commands->Create_Object_At_Bone(
                    hologram01, "Nod_Kane_HologramHead", "KANEBONE");
                ...
                Commands->Attach_Script(
                    kane01, "M11_BattleStationAlpha_CommanderEncounter_KaneHead_JDG", "");
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param == M01_MODIFY_YOUR_ACTION_JDG) // starting first kane-commander encounter
            {
                ...
                if (commander != nullptr) {
                    kane_conversation01 = Commands->Create_Conversation(
                        "M11_Kane_and_Blackhand_Conversation_01", 100, 1000, true);
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // havoc has entered first zone--start
                                                             // first havoc conv
            {
                if (kane_conversation01_playing == true) {
                    ...
                    GameObject* commander = Commands->Find_Object(101250);
                    if (commander != nullptr) {
                        Commands->Send_Custom_Event(obj, commander, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                    0);
                    }

                    GameObject* kane01 = Commands->Find_Object(kane01_ID);
                    if (kane01 != nullptr) {
                        kane_conversation01b = Commands->Create_Conversation(
                            "M11_Kane_and_Havoc_Conversation_01", 90, 30, true);
                        Commands->Join_Conversation(kane01, kane_conversation01b, false, true,
                                                    true);
                        Commands->Join_Conversation(STAR, kane_conversation01b, false, false,
                                                    false);
                    ...
                    GameObject* hologram01 = Commands->Find_Object(100252);
                    if (hologram01 != nullptr) {
                        GameObject* kane02 = Commands->Create_Object_At_Bone(
                            hologram01, "Nod_Kane_HologramHead", "KANEBONE");
                        ...
                        Commands->Attach_Script(
                            kane02, "M11_BattleStationAlpha_HavocEncounter_KaneHead_JDG", "");
                     ...
                     && kane_conversation02_playing
                         == false) // kane head01 is giving clearance to start havoc conv
            {
                kane_conversation02 = Commands->Create_Conversation(
                    "M11_Kane_and_Havoc_Conversation_01", 90, 30, true);
                ...
                if (sender == commander) {
                    if (kane_conversation01_playing == true) {
                        ...
                        GameObject* kane01 = Commands->Find_Object(kane01_ID);
                        if (kane01 != nullptr) {
                            Commands->Send_Custom_Event(obj, kane01, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                        0);
                        }
                    }
                }
...
{ void Created(GameObject * obj) { Commands->Set_Animation(obj, "DSP_HOLO_BIG.DSP_HOLO_BIG", true);
}
}
;
        ...
        if (enterer == STAR) {
            ...
            if (holograph != nullptr) {
                GameObject* kane = Commands->Create_Object_At_Bone(
                    holograph, "Nod_Kane_HologramHead_small", "KANEBONE");
...
DECLARE_SCRIPT(M11_KaneRoom_KaneEncounter_Kane_JDG, "") // M11_KanesRoom_Kane_Conversation
{
    ...
    {
        if (STAR) {
            kane_conversation02 = Commands->Create_Conversation("M11_KanesRoom_Kane_Conversation",
                                                                100, 1000, false);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            Commands->Debug_Message(
                "***************************delete custom received--kane should now vanish\n");
            Commands->Destroy_Object(obj);
        }
    }
};
...
{ void Created(GameObject * obj) { Commands->Set_Animation(obj, "DSP_HOLO.DSP_HOLO", true);
}
}
;
        ...
        if (type == 0) {
            if (obj && param == M01_START_ACTING_JDG) {
                ...
                char* cabalSounds[6] = {
                    ...
                    "M11DSGN_DSGN0088I1EVAC_SND", "M11DSGN_DSGN0090I1EVAC_SND",
                    "M11DSGN_DSGN0091I1EVAC_SND", "M11DSGN_DSGN0092I1EVAC_SND",
                    "M11DSGN_DSGN0094I1EVAC_SND", "M11DSGN_DSGN0096I1EVAC_SND",
                };
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) {
            ...
            case M11_PETROVA_START_ACTING_JDG: {
                ...
                Vector3 myPosition = Commands->Get_Position(obj);
                // Commands->Create_Logical_Sound (obj, M11_STEALTHS_START_ACTING_JDG, myPosition,
                // 150 );
                ...
                Commands->Debug_Message(
                    "***************************Petrova--received custom to start acting\n");
            ...
            case M11_PETROVA_ATTACK_PLAYER_JDG: {
                ...
                if (Commands->Is_Object_Visible(obj, STAR)) {
                    Commands->Send_Custom_Event(obj, obj, 0, M11_PETROVA_ATTACK_PLAYER_JDG,
                                                attackdelay);
                }
                else {
                    Commands->Send_Custom_Event(obj, obj, 0, M11_PETROVA_PICK_NEW_LOCATION_JDG,
                                                pickdelay);
                }
                break;
            }
...
DECLARE_SCRIPT(M11_Start_FirstMidtro_Zone_JDG, "") // 101449
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            else if (param == M01_START_ACTING_JDG && entered == false
                     && command_clearance == true) {
                entered = true;
                GameObject* petrova = Commands->Find_Object(M11_MUTANT_PETROVA_JDG);
                if (petrova != nullptr) {
...
if (petrova != nullptr) {
    Commands->Debug_Message(
        "***************************M11-Petrova trigger zone sending custom to petrova--jdg\n");
    Commands->Send_Custom_Event(obj, petrova, 0, M11_PETROVA_START_ACTING_JDG, 0);
    ...
    Commands->Debug_Message(
        "***************************M11-Petrova trigger zone cannot find petrova--jdg\n");
}
}
}
}
...
DECLARE_SCRIPT(M11_Barracks_MutantUprising_BlackhandGuy_JDG,
               "") // M11_BARRACKS_MUTANTUPRISING_BLACKHAND_JDG 100387
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M11_Barracks_MutantUprising_Mutant01_JDG,
               "") // M11_BARRACKS_MUTANTUPRISING_MUTANT01_JDG 100388
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M11_Barracks_MutantUprising_Mutant02_JDG,
               "") // M11_BARRACKS_MUTANTUPRISING_MUTANT02_JDG 100389
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M11_Cinematic_Havoc_Script_JDG,
               "") { void Created(GameObject * obj) { Commands->Select_Weapon(obj, nullptr);
}
}
;
...
{ void Custom(GameObject * obj, int type, int param,
              GameObject* sender) { if (type == 0) { if (param == 0) // wall goes away
                                                     { Commands->Destroy_Object(obj);
}
}
}
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    if (type == 0) {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) // play animation A
        {
            Commands->Enable_Hibernation(obj, false);
            Commands->Debug_Message(
                "**********************Sydney bone custom received....going to anim A\n");
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // play animation B
        {
            Commands->Enable_Hibernation(obj, false);
            Commands->Debug_Message(
                "**********************Sydney bone custom received....going to anim B\n");
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_03_JDG) // play animation c
        {
            Commands->Enable_Hibernation(obj, false);
            Commands->Debug_Message(
                "**********************Sydney bone custom received....going to anim C\n");
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_04_JDG) // play animation d
        {
            Commands->Enable_Hibernation(obj, false);
            Commands->Debug_Message(
                "**********************Sydney bone custom received....going to anim D\n");
        ...
        if (type == 0) {
            if (param == 0) // now do free sydney anim
            {
                ...
                if (troopbone != nullptr) {
                    Commands->Debug_Message(
                        "**********************Sydney anim D sending custom to bone\n");
                    Commands->Send_Custom_Event(obj, troopbone, 0, M01_MODIFY_YOUR_ACTION_04_JDG,
                                                0);
                    ...
                    Commands->Debug_Message(
                        "**********************Sydney anim D cannot find bone\n");
                }
            }
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_JDG) // play animation A
            {
                ...
                if (troopbone != nullptr) {
                    Commands->Debug_Message(
                        "**********************Sydney anim A sending custom to bone\n");
                    ...
                    Commands->Debug_Message(
                        "**********************Sydney anim A cannot find bone\n");
                }
            }
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // play animation B
            {
                ...
                if (troopbone != nullptr) {
                    Commands->Debug_Message(
                        "**********************Sydney anim B sending custom to bone\n");
                    Commands->Send_Custom_Event(obj, troopbone, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                0);
                    ...
                    Commands->Debug_Message(
                        "**********************Sydney anim B cannot find bone\n");
                }
            }
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_03_JDG) // play animation c
            {
                ...
                if (troopbone != nullptr) {
                    Commands->Debug_Message(
                        "**********************Sydney anim C sending custom to bone\n");
                    Commands->Send_Custom_Event(obj, troopbone, 0, M01_MODIFY_YOUR_ACTION_03_JDG,
                                                0);
                    ...
                    Commands->Debug_Message(
                        "**********************Sydney anim C cannot find bone\n");
                }
            }
...
Vector3 m11ObeliskExplosionLocs[13] = {
    Vector3(-10.432f, -96.805f, 4.504f),  Vector3(-15.732f, -106.739f, 10.572f),
    Vector3(0.665f, -105.108f, 8.224f),   Vector3(14.913f, -99.565f, 4.977f),
    Vector3(33.114f, -103.768f, 7.549f),  Vector3(34.822f, -114.184f, 12.776f),
    Vector3(24.790f, -116.226f, 13.617f), Vector3(12.581f, -111.634f, 11.247f),
    Vector3(-5.196f, -116.416f, 13.689f), Vector3(-9.931f, -136.410f, 18.047f),
    Vector3(8.336f, -122.921f, 21.475f),  Vector3(12.898f, -123.847f, 27.640f),
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_GOTO_IDLE_JDG) {
            ...
            if (commandClearance == true) {
                ...
                Commands->Create_Explosion("Ground Explosions - Harmless",
                                           m11ObeliskExplosionLocs[random], nullptr);
...
DECLARE_SCRIPT(M11_PowerupDifficulty_Manager_JDG,
               "") { void Created(GameObject * obj) { int easy = 0;
int medium = 1;
...
DECLARE_SCRIPT(M11_Petrova_Taunt_Controller_JDG, "") // 103797
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_JDG && commandClearance == true
                     && PetrovaDead == false) {
                char* taunt_sound[9] = {
                    "M00MBPT_ATOC0001I1MBPT_SND", "M00MBPT_ATOS0001I1MBPT_SND",
                    "M00MBPT_DECX0001I1MBPT_SND", "M00MBPT_TFEA0001I1MBPT_SND",
                    "M00ASQR_KILL0018I1MBPT_SND", "M00GSEN_KIOV0004I1MBPT_SND",
                    "M00GCTK_KIOV0004I1MBPT_SND", "M00GSRS_KITB0004I1MBPT_SND",
...
DECLARE_SCRIPT(M11_Lab_Cryochamber_Switch02_JDG, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poker == STAR && poked == false) {
            ...
            Commands->Send_Custom_Event(obj,
                                        Commands->Find_Object(M11_LABORATORY_MUTANT_CONTROLLER_JDG),
                                        0, M01_MODIFY_YOUR_ACTION_02_JDG, 0);
        }
    }
};

Vector3 m11cryoChamberLocs[15] = {
    Vector3(-17.385f, 34.254f, -39.486f), Vector3(-17.373f, 40.853f, -39.486f),
    Vector3(-17.362f, 50.281f, -39.486f), Vector3(-17.377f, 56.349f, -39.486f),
    Vector3(-9.668f, 59.078f, -39.486f),  Vector3(-7.215f, 54.836f, -39.486f),
    Vector3(-5.012f, 48.971f, -39.486f),  Vector3(-5.669f, 44.153f, -39.486f),
    Vector3(4.735f, 30.950f, -39.486f),   Vector3(6.117f, 43.680f, -39.486f),
    Vector3(5.037f, 49.157f, -39.486f),   Vector3(5.849f, 52.512f, -39.486f),
    Vector3(8.617f, 57.247f, -39.486f),   Vector3(17.392f, 55.537f, -39.486f),
...
DECLARE_SCRIPT(M11_Lab_Cryochamber_Controller_JDG, "") // 100910
                                                       // M11_LABORATORY_MUTANT_CONTROLLER_JDG
{
    ...
    void Created(GameObject * obj)
    {
        GameObject* cryoChamber_00
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[0]);
        ...
        GameObject* cryoChamber_01
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[1]);
        ...
        GameObject* cryoChamber_02
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[2]);
        ...
        GameObject* cryoChamber_03
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[3]);
        ...
        GameObject* cryoChamber_04
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[4]);
        ...
        GameObject* cryoChamber_05
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[5]);
        ...
        GameObject* cryoChamber_06
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[6]);
        ...
        GameObject* cryoChamber_07
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[7]);
        ...
        GameObject* cryoChamber_08
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[8]);
        ...
        GameObject* cryoChamber_09
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[9]);
        ...
        GameObject* cryoChamber_10
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[10]);
        ...
        GameObject* cryoChamber_11
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[11]);
        ...
        GameObject* cryoChamber_12
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[12]);
        ...
        GameObject* cryoChamber_13
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[13]);
        ...
        GameObject* cryoChamber_14
            = Commands->Create_Object("Simple_Large_CryoChamber", m11cryoChamberLocs[14]);
        ...
        GameObject* cryoTrajectory_00
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[0]);
        Commands->Set_Model(cryoTrajectory_00, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_00, cryoChamberFacing[0]);
        GameObject* simpleMutant_00 = Commands->Create_Object_At_Bone(
            cryoTrajectory_00, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_01
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[1]);
        Commands->Set_Model(cryoTrajectory_01, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_01, cryoChamberFacing[1]);
        GameObject* simpleMutant_01 = Commands->Create_Object_At_Bone(
            cryoTrajectory_01, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_02
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[2]);
        Commands->Set_Model(cryoTrajectory_02, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_02, cryoChamberFacing[2]);
        GameObject* simpleMutant_02 = Commands->Create_Object_At_Bone(
            cryoTrajectory_02, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_03
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[3]);
        Commands->Set_Model(cryoTrajectory_03, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_03, cryoChamberFacing[3]);
        GameObject* simpleMutant_03 = Commands->Create_Object_At_Bone(
            cryoTrajectory_03, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_04
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[4]);
        Commands->Set_Model(cryoTrajectory_04, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_04, cryoChamberFacing[4]);
        GameObject* simpleMutant_04 = Commands->Create_Object_At_Bone(
            cryoTrajectory_04, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_05
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[5]);
        Commands->Set_Model(cryoTrajectory_05, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_05, cryoChamberFacing[5]);
        GameObject* simpleMutant_05 = Commands->Create_Object_At_Bone(
            cryoTrajectory_05, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_06
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[6]);
        Commands->Set_Model(cryoTrajectory_06, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_06, cryoChamberFacing[6]);
        GameObject* simpleMutant_06 = Commands->Create_Object_At_Bone(
            cryoTrajectory_06, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_07
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[7]);
        Commands->Set_Model(cryoTrajectory_07, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_07, cryoChamberFacing[7]);
        GameObject* simpleMutant_07 = Commands->Create_Object_At_Bone(
            cryoTrajectory_07, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_08
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[8]);
        Commands->Set_Model(cryoTrajectory_08, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_08, cryoChamberFacing[8]);
        GameObject* simpleMutant_08 = Commands->Create_Object_At_Bone(
            cryoTrajectory_08, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_09
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[9]);
        Commands->Set_Model(cryoTrajectory_09, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_09, cryoChamberFacing[9]);
        GameObject* simpleMutant_09 = Commands->Create_Object_At_Bone(
            cryoTrajectory_09, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_10
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[10]);
        Commands->Set_Model(cryoTrajectory_10, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_10, cryoChamberFacing[10]);
        GameObject* simpleMutant_10 = Commands->Create_Object_At_Bone(
            cryoTrajectory_10, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_11
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[11]);
        Commands->Set_Model(cryoTrajectory_11, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_11, cryoChamberFacing[11]);
        GameObject* simpleMutant_11 = Commands->Create_Object_At_Bone(
            cryoTrajectory_11, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_12
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[12]);
        Commands->Set_Model(cryoTrajectory_12, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_12, cryoChamberFacing[12]);
        GameObject* simpleMutant_12 = Commands->Create_Object_At_Bone(
            cryoTrajectory_12, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_13
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[13]);
        Commands->Set_Model(cryoTrajectory_13, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_13, cryoChamberFacing[13]);
        GameObject* simpleMutant_13 = Commands->Create_Object_At_Bone(
            cryoTrajectory_13, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* cryoTrajectory_14
            = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[14]);
        Commands->Set_Model(cryoTrajectory_14, "X11E_Trajectory");
        Commands->Set_Facing(cryoTrajectory_14, cryoChamberFacing[14]);
        GameObject* simpleMutant_14 = Commands->Create_Object_At_Bone(
            cryoTrajectory_14, "Mutant_2SF_Templar", "BN_Trajectory");
        ...
        GameObject* destroyedCryoChamber_01 = Commands->Create_Object(
            "Simple_Large_CryoChamber_Destroyed", destroyedCryoChamberLocs[0]);
        ...
        GameObject* destroyedCryoChamber_02 = Commands->Create_Object(
            "Simple_Large_CryoChamber_Destroyed", destroyedCryoChamberLocs[1]);
        ...
        GameObject* destroyedCryoChamber_03 = Commands->Create_Object(
            "Simple_Large_CryoChamber_Destroyed", destroyedCryoChamberLocs[2]);
    ...
    {
        if (type
            == M01_IVE_BEEN_KILLED_JDG) // a chamber has been destroyed--kill the hibernating mutant
        {
            if (param == 0) // cryo chamber 00 is destroyed
            {
                GameObject* cryoTrajectory_00
                    = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[0]);
                Commands->Set_Model(cryoTrajectory_00, "X11E_Trajectory");
                Commands->Attach_Script(cryoTrajectory_00, "M11_Mutant_TrajectoryBone_JDG",
                                        ""); //"Mutant_2SF_Templar"
                Commands->Set_Facing(cryoTrajectory_00, cryoChamberFacing[0]);
                if (cryoTrajectory_00 != nullptr) {
                    GameObject* simpleMutant_00 = Commands->Find_Object(simpleMutant_id[0]);
                    if (simpleMutant_00 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_00, cryoTrajectory_00,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_00, 0,
            ...
            else if (param == 1) // cryo chamber 01 is destroyed
            {
                ...
                if (cryoTrajectory_01 != nullptr) {
                    ...
                    if (simpleMutant_01 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_01, cryoTrajectory_01,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_01, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 2) // cryo chamber 02 is destroyed
            {
                ...
                if (cryoTrajectory_02 != nullptr) {
                    ...
                    if (simpleMutant_02 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_02, cryoTrajectory_02,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_02, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 3) // cryo chamber 03 is destroyed
            {
                ...
                if (cryoTrajectory_03 != nullptr) {
                    ...
                    if (simpleMutant_03 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_03, cryoTrajectory_03,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_03, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 4) // cryo chamber 04 is destroyed
            {
                ...
                if (cryoTrajectory_04 != nullptr) {
                    ...
                    if (simpleMutant_04 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_04, cryoTrajectory_04,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_04, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 5) // cryo chamber 05 is destroyed
            {
                ...
                if (cryoTrajectory_05 != nullptr) {
                    ...
                    if (simpleMutant_05 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_05, cryoTrajectory_05,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_05, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 6) // cryo chamber 06 is destroyed
            {
                ...
                if (cryoTrajectory_06 != nullptr) {
                    ...
                    if (simpleMutant_06 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_06, cryoTrajectory_06,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_06, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 7) // cryo chamber 07 is destroyed
            {
                ...
                if (cryoTrajectory_07 != nullptr) {
                    ...
                    if (simpleMutant_07 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_07, cryoTrajectory_07,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_07, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 8) // cryo chamber 08 is destroyed
            {
                ...
                if (cryoTrajectory_08 != nullptr) {
                    ...
                    if (simpleMutant_08 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_08, cryoTrajectory_08,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_08, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 9) // cryo chamber 09 is destroyed
            {
                ...
                if (cryoTrajectory_09 != nullptr) {
                    ...
                    if (simpleMutant_09 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_09, cryoTrajectory_09,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_09, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 10) // cryo chamber 10 is destroyed
            {
                ...
                if (cryoTrajectory_10 != nullptr) {
                    ...
                    if (simpleMutant_10 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_10, cryoTrajectory_10,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_10, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 11) // cryo chamber 11 is destroyed
            {
                ...
                if (cryoTrajectory_11 != nullptr) {
                    ...
                    if (simpleMutant_11 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_11, cryoTrajectory_11,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_11, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 12) // cryo chamber 12 is destroyed
            {
                ...
                if (cryoTrajectory_12 != nullptr) {
                    ...
                    if (simpleMutant_12 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_12, cryoTrajectory_12,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_12, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 13) // cryo chamber 13 is destroyed
            {
                ...
                if (cryoTrajectory_13 != nullptr) {
                    ...
                    if (simpleMutant_13 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_13, cryoTrajectory_13,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_13, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            else if (param == 14) // cryo chamber 14 is destroyed
            {
                ...
                if (cryoTrajectory_14 != nullptr) {
                    ...
                    if (simpleMutant_14 != nullptr) {
                        Commands->Attach_To_Object_Bone(simpleMutant_14, cryoTrajectory_14,
                                                        "BN_Trajectory");
                        deadMutantCount++;
                        Commands->Send_Custom_Event(obj, simpleMutant_14, 0,
                                                    M01_IVE_BEEN_KILLED_JDG, 0);
                    }
                }
            }
            ...
            if (param == M01_SPAWNER_IS_DEAD_JDG) {
                ...
                if (activeUnitCount <= 6 && deadMutantCount < 15) {
                    ...
                    if (mutant == nullptr) {
                        ...
                        Commands->Send_Custom_Event(obj, mutant, M01_SPAWNER_SPAWN_PLEASE_JDG,
                                                    random, 0);
                        Commands->Send_Custom_Event(obj, cryoChamber, 0,
                                                    M01_SPAWNER_SPAWN_PLEASE_JDG, 1);
                        activeUnitCount++;
                    }
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_JDG) // switch 01 has been pushed--kill all
                                                          // related chambers
            {
                ...
                if (cryoChamber_00 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_00, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_01 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_01, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_02 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_02, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_03 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_03, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_04 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_04, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_05 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_05, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_06 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_06, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_07 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_07, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
            }

            else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // switch 02 has been pushed--kill all
                                                             // related chambers
            {
                ...
                if (cryoChamber_08 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_08, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_09 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_09, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_10 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_10, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_11 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_11, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_12 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_12, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_13 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_13, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (cryoChamber_14 != nullptr) {
                    float delayTimer = Commands->Get_Random(1, 3);
                    Commands->Send_Custom_Event(obj, cryoChamber_14, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
            }
        }
...
DECLARE_SCRIPT(M11_Cryochamber_Simple_JDG, "chamber_number:int")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) // M01_SPAWNER_SPAWN_PLEASE_JDG
        {
            if (obj && destroyed == false) {
                ...
                Commands->Set_Animation(obj, "DSP_CRYOBIG2.DSP_CRYOBIG2", false, nullptr, 0, 15);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M11_LABORATORY_MUTANT_CONTROLLER_JDG),
                    M01_IVE_BEEN_KILLED_JDG, my_number, 0);
                Commands->Set_Health(obj, 1);

                GameObject* destroyedCryoChamber
                    = Commands->Create_Object("Simple_Large_CryoChamber_Destroyed", myPosition);
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        ...
        if (myHealthPercentage > 25 && destroyed == false) {
            Commands->Set_Animation(obj, "DSP_CRYOBIG2.DSP_CRYOBIG2", false, nullptr, 0, 9);
        }

        else if (destroyed == true) {
            Commands->Set_Animation(obj, "DSP_CRYOBIG2.DSP_CRYOBIG2", false, nullptr, 12, 15);
            Commands->Set_Health(obj, 1);
        }
...
DECLARE_SCRIPT(M11_LabMutant_Simple_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (sabotaged == false) {
            if (freed == true) {
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M11_LABORATORY_MUTANT_CONTROLLER_JDG), 0,
                    M01_SPAWNER_IS_DEAD_JDG, 0);
            }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M01_SPAWNER_SPAWN_PLEASE_JDG) // you are being requested to come out and
                                                  // play--break out
        {
            Commands->Enable_Hibernation(obj, false);
            GameObject* cryoTrajectory_00
                = Commands->Create_Object("Invisible_Object", m11cryoChamberLocs[param]);
            Commands->Set_Model(cryoTrajectory_00, "X11E_Trajectory");
            Commands->Attach_Script(cryoTrajectory_00, "M11_Mutant_TrajectoryBone_JDG",
                                    ""); //"Mutant_2SF_Templar"
            ...
            if (cryoTrajectory_00 != nullptr) {
                if (obj) {
                    ...
                    Commands->Set_Animation(obj, "S_C_Human.H_C_X11E_Escape", false, nullptr, 0, 120);
                    freed = true;
                }
            }
        }
            ...
            if (param == M01_IVE_BEEN_KILLED_JDG) // your chambers been destroyed--die please
            {
                ...
                freed = true;
                // Commands->Apply_Damage( obj, 10000, "BlamoKiller", nullptr );
                Commands->Set_Animation(obj, "S_C_Human.H_C_Tubedie", false, nullptr, 0, 22);
            }
        }
    }
...
DECLARE_SCRIPT(M11_Silo_ElevatorZone01_JDG, "") // 100699
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) {
            ...
            Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_04_JDG, 0,
                                                  "MISS_ELEV4.MISS_ELEV4");
...
DECLARE_SCRIPT(M11_Silo_ElevatorZone02_JDG, "") // 100700
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) {
            ...
            Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_03_JDG, 0,
                                                  "MISS_ELEV3.MISS_ELEV3");
            Commands->Destroy_Object(obj); // your job is over--clean up
        }
    }
};
...
DECLARE_SCRIPT(M11_Silo_ElevatorZone03_JDG, "") // 100701
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) {
            ...
            Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_02_JDG, 0,
                                                  "MISS_ELEV2.MISS_ELEV2");
            Commands->Destroy_Object(obj); // your job is over--clean up
        }
    }
};
...
DECLARE_SCRIPT(M11_Silo_ElevatorZone04_JDG, "") // 100702
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) {
            ...
            Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_01_JDG, 0,
                                                  "MISS_ELEV1.MISS_ELEV1");
            Commands->Destroy_Object(obj); // your job is over--clean up
        }
    }
};
...
{ // M11_PETROVA_STEALTHSPAWNER_01_JDG
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            {
                GameObject* initialSteatlthGuy01
                    = Commands->Trigger_Spawner(M11_PETROVA_STEALTHSPAWNER_01_JDG);
                Commands->Attach_Script(initialSteatlthGuy01,
                                        "M11_Petrova_StealthSoldier_Initial01_JDG", "");
                initialSteatlthGuy01_id = Commands->Get_ID(initialSteatlthGuy01);

                GameObject* initialSteatlthGuy02
                    = Commands->Trigger_Spawner(M11_PETROVA_STEALTHSPAWNER_02_JDG);
                Commands->Attach_Script(initialSteatlthGuy02,
                                        "M11_Petrova_StealthSoldier_Initial02_JDG", "");
                initialSteatlthGuy02_id = Commands->Get_ID(initialSteatlthGuy02);

                GameObject* initialSteatlthGuy03
                    = Commands->Trigger_Spawner(M11_PETROVA_STEALTHSPAWNER_03_JDG);
                Commands->Attach_Script(initialSteatlthGuy03,
                ...
                if (initialSteatlthGuy01 != nullptr) {
                    Commands->Send_Custom_Event(obj, initialSteatlthGuy01, 0, M01_START_ACTING_JDG,
                                                0);
                }

                GameObject* initialSteatlthGuy02 = Commands->Find_Object(initialSteatlthGuy02_id);
                if (initialSteatlthGuy02 != nullptr) {
                    Commands->Send_Custom_Event(obj, initialSteatlthGuy02, 0, M01_START_ACTING_JDG,
                                                0);
                }

                GameObject* initialSteatlthGuy03 = Commands->Find_Object(initialSteatlthGuy03_id);
                if (initialSteatlthGuy03 != nullptr) {
                    Commands->Send_Custom_Event(obj, initialSteatlthGuy03, 0, M01_START_ACTING_JDG,
                                                0);
                }
            }
            ...
            {
                GameObject* newSteatlthGuy
                    = Commands->Trigger_Spawner(M11_PETROVA_STEALTHSPAWNER_01_JDG);
                Commands->Attach_Script(newSteatlthGuy,
...
DECLARE_SCRIPT(M11_Petrova_StealthSoldier_Reinforcement01_JDG,
               "") // M11_PETROVA_STEALTHSPAWNER_01_JDG
{ void Created(GameObject * obj) { Commands->Enable_Hibernation(obj, false);
Commands->Grant_Key(obj, 3, true);
ActionParamsStruct params;
...
DECLARE_SCRIPT(M11_Petrova_StealthSoldier_Reinforcement02_JDG,
               "") // M11_PETROVA_STEALTHSPAWNER_02_JDG
{ void Created(GameObject * obj) { Commands->Enable_Hibernation(obj, false);
Commands->Grant_Key(obj, 3, true);
ActionParamsStruct params;
params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
...
DECLARE_SCRIPT(M11_Petrova_StealthSoldier_Reinforcement03_JDG,
               "") // M11_PETROVA_STEALTHSPAWNER_03_JDG
{ void Created(GameObject * obj) { Commands->Enable_Hibernation(obj, false);
Commands->Grant_Key(obj, 3, true);
ActionParamsStruct params;
params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
...
DECLARE_SCRIPT(M11_Sydney_Script_JDG, "") // M11_REAL_SYDNEY_MOBIUS_JDG 100644
{
    ...
    { // M11_Sydney_Damaged_Conversation_01
        ...
        if (obj && killedYet == false) {
            if (first_time_damaged == true) {
                ...
                sydney_damaged_conv01 = Commands->Create_Conversation(
                    "M11_Sydney_Damaged_Conversation_01", 90, 1000, true);
                ...
                Commands->Set_HUD_Help_Text(IDS_M11DSGN_DSGN1007I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                second_time_damaged = false;
                sydney_damaged_conv02 = Commands->Create_Conversation(
                    "M11_Sydney_Damaged_Conversation_02", 90, 1000, true);
                ...
                Commands->Set_HUD_Help_Text(IDS_M11DSGN_DSGN1007I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                third_time_damaged = false;
                sydney_damaged_conv03 = Commands->Create_Conversation(
                    "M11_Sydney_Damaged_Conversation_03", 90, 1000, true);
    ...
    void Killed(
        GameObject * obj,
        GameObject
            * killer) // M11_Sydney_Dead_Conversation_01 and/or M11_Sydney_Dead_Conversation_02
    {
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) // start initial conversation
            {
                if (obj && STAR) {
                    ...
                    // Commands->Innate_Enable(obj);
                    sydney_conv01 = Commands->Create_Conversation(
                        "M11_Initial_Sydney_Conversation_JDG", 100, 1000, false);
                    ...
                    GameObject* siloProtector01
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector01_spot);
                    GameObject* siloProtector02
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector02_spot);
                    GameObject* siloProtector03
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector03_spot);
                    GameObject* siloProtector05
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector05_spot);
                    GameObject* siloProtector07
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector07_spot);
                    GameObject* siloProtector08
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector08_spot);
                    GameObject* siloProtector09
                        = Commands->Create_Object("Nod_FlameThrower_2SF", siloProtector09_spot);
                ...
                Commands->Set_Innate_Is_Stationary(obj, false);
                int sydney_letsgo_conv = Commands->Create_Conversation(
                    "M11_Sydney_WatchMyBack_Conversation", 100, 1000, false);
            ...
            else if (param == M01_WALKING_WAYPATH_05_JDG) // now goto first silo elevator platform
            {
                ...
                Commands->Set_Innate_Is_Stationary(obj, false);
                Commands->Debug_Message("***************************SYDNEY has received command to "
                                        "goto first elevator lift\n");
                ...
                GameObject* elevatorController
                    = Commands->Find_Object(M11_MISSILE_LIFT_CONTROLLER_JDG);
                if (elevatorController != nullptr) {
                    Commands->Send_Custom_Event(obj, elevatorController, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                    Commands->Send_Custom_Event(obj, elevatorController, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                    Commands->Send_Custom_Event(obj, elevatorController, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                    Commands->Send_Custom_Event(obj, elevatorController, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }
            }
            ...
            else if (param == M01_WALKING_WAYPATH_07_JDG) // now goto first silo elevator platform
            {
                ...
                // Commands->Static_Anim_Phys_Goto_Frame ( M11_MISSILE_LIFT_04_JDG	, 45,
                // "MISS_ELEV4.MISS_ELEV4" ); Commands->Static_Anim_Phys_Goto_Frame (
                // M11_MISSILE_LIFT_03_JDG	, 45, "MISS_ELEV3.MISS_ELEV3" );
                // Commands->Static_Anim_Phys_Goto_Frame ( M11_MISSILE_LIFT_02_JDG	, 45,
                // "MISS_ELEV2.MISS_ELEV2" ); Commands->Static_Anim_Phys_Goto_Frame (
                // M11_MISSILE_LIFT_01_JDG	, 45, "MISS_ELEV1.MISS_ELEV1" );
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_JDG) // sydney on level 2--goto next elevator
            {
                ...
                // }
                     ...
                     == M01_MODIFY_YOUR_ACTION_02_JDG) // sydney on level 3--goto next elevator
            {
                ...
                // }
                     ...
                     == M01_MODIFY_YOUR_ACTION_03_JDG) // sydney on level 4--goto next elevator
            {
                ...
                // }
                     ...
                     == M01_MODIFY_YOUR_ACTION_04_JDG) // sydney on top level 4--goto nuke switch
            {
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_05_JDG) // sydney should now be facing nuke
                                                             // console--play anim
            {
                params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            if (action_id == sydney_conv01) {
                ...
                Commands->Debug_Message("***************************initial SYDNEY conversation is "
                                        "over--going to zone 01\n");
                ...
                if (objectiveController != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveController, 0,
                                                M11_END_SECOND_OBJECTIVE_JDG, 0);
                }
            }
        ...
        case ACTION_COMPLETE_NORMAL: {
            if (action_id == M01_WALKING_WAYPATH_01_JDG) {
                ...
                if (rallyZone01 != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "**********************SYDNEY--cannot find rally zone 01\n");
                }
            }
                ...
                if (rallyZone02 != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "**********************SYDNEY--cannot find rally zone 02\n");
                }
                ...
                if (rallyZone03 != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "**********************SYDNEY--cannot find rally zone 03a\n");
                }
            }
                ...
                if (rallyZone03 != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "**********************SYDNEY--cannot find rally zone 03b\n");
                }
            }

            else if (action_id == M01_WALKING_WAYPATH_05_JDG) // sydneys at first elevator--goto
                                                              // stationary for now
            {
                Commands->Set_Innate_Is_Stationary(obj, true);
                ...
                if (elevatorDisabler != nullptr) {
                    Commands->Send_Custom_Event(obj, elevatorDisabler, 0, M11_START_ACTING_JDG, 0);
                     ...
                     == M01_WALKING_WAYPATH_06_JDG) // sydneys at missile switch-play animation
            {
            ...
            else if (action_id == M01_DOING_ANIMATION_01_JDG) // play end mission conversation
            {
                ...
                missionEndConv = Commands->Create_Conversation("M11_End_Mission_Conversation", 100,
                                                               1000, false);
...
{ void Custom(GameObject * obj, int type, int param, GameObject* sender) {
    if (type == 0) { if (param == M11_START_ACTING_JDG) // allow switch usage
...
DECLARE_SCRIPT(M11_ForthFloor_Elevator_Switch_Script_JDG, "") // 101689 101651 101690 101691
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poker == STAR && sydney_in_motion == false) {
            ...
            if (elevatorController != nullptr) {
                Commands->Send_Custom_Event(obj, elevatorController, 0,
                                            M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
            }
        }
    }
...
DECLARE_SCRIPT(M11_Elevator_Switch_MasterControllerScript_JDG, "") // 101673
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 1) {
            if (param
                == M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG) // sydney is coming...force
                                                                    // elevator down
            {
                level4_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                ...
                level4_lift_down = true;
                     ...
                     == M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG) // sydney is coming...force
                                                                         // elevator down
            {
                level3_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                                      M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG);
                Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_03_JDG, 45,
                                                      "MISS_ELEV3.MISS_ELEV3");
                level3_lift_down = true;
            }

            else if (param
                     == M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG) // sydney is coming...force
                                                                         // elevator down
            {
                ...
                level2_lift_down = true;
                     ...
                     == M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG) // sydney is coming...force
                                                                         // elevator down
            {
                level1_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                                      M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG);
                Commands->Static_Anim_Phys_Goto_Frame(M11_MISSILE_LIFT_01_JDG, 45,
                                                      "MISS_ELEV1.MISS_ELEV1");
                level1_lift_down = true;
            }
        }
            ...
            if (param == M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG
                ...
                if (lev4switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch01, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch02, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch03, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch04, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }
            }

            else if (param == M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG
                     && level3_lift_moving == false) {
                level3_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                                      M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG);
                ...
                if (lev3switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch01, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch02, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch03, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch04, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }
            }

            else if (param == M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG
                     && level2_lift_moving == false) {
                level2_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                                      M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG);
                ...
                if (lev2switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch01, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch02, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch03, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch04, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }
            }

            else if (param == M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG
                     && level1_lift_moving == false) {
                level1_lift_moving = true;
                Commands->Start_Timer(obj, this, 3,
                                      M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG);
                ...
                if (lev1switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch01, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch02, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch03, 0,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }
            }
        }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG) {
            ...
            if (level4_lift_down == true) {
                ...
                if (lev4switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch01, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch02, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch03, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch04, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }
            }
                ...
                if (lev4switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch01, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch02, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch03, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev4switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev4switch04, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL4_ELEVATOR_SWITCH_JDG, 0);
                }
            }
        }
            ...
            if (level3_lift_down == true) {
                ...
                if (lev3switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch01, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch02, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch03, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch04, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }
            }
                ...
                if (lev3switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch01, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch02, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch03, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev3switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev3switch04, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL3_ELEVATOR_SWITCH_JDG, 0);
                }
            }
        }
            ...
            if (level2_lift_down == true) {
                ...
                if (lev2switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch01, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch02, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch03, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch04, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }
            }
                ...
                if (lev2switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch01, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch02, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch03, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev2switch04 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev2switch04, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL2_ELEVATOR_SWITCH_JDG, 0);
                }
            }
        }
            ...
            if (level1_lift_down == true) {
                ...
                if (lev1switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch01, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch02, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch03, 1,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }
            }
                ...
                if (lev1switch01 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch01, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch02 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch02, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }

                if (lev1switch03 != nullptr) {
                    Commands->Send_Custom_Event(obj, lev1switch03, 2,
                                                M11_PLAYER_HAS_POKED_LEVEL1_ELEVATOR_SWITCH_JDG, 0);
                }
            }
        }
