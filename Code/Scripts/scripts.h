...
public:
    ...
    GameObject** Get_Owner_Ptr() { return &mOwner; }
    ...
    int Get_Parameter_Count(void) { return mArgC; }
    ...
    int Get_Int_Parameter(int index) { return atoi(Get_Parameter(index)); }

    // Get a parameter as an integer
    int Get_Int_Parameter(const char* parameterName);

    // Get a parameter as a float
    float Get_Float_Parameter(int index) { return (float)atof(Get_Parameter(index)); }
    ...
    // the script.
    void SetFactory(ScriptFactory* factory) { mFactory = factory; }
...
public:                                                                                            \
    void Register_Auto_Save_Variables(void)
