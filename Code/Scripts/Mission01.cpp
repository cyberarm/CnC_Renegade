    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == CUSTOM_EVENT_SOUND_ENDED) {
            if (param == eva_comm_center_line_01) {
                eva_comm_center_line_02
                    = Commands->Create_Sound("00-N002E", Vector3(0, 0, 0), obj); // please stand by
                Commands->Monitor_Sound(obj, eva_comm_center_line_02);
            }

            else if (param == eva_comm_center_line_02) {
                eva_comm_center_line_03
                    = Commands->Create_Sound("00-N026E", Vector3(0, 0, 0), obj); // transmitting
                Commands->Monitor_Sound(obj, eva_comm_center_line_03);
            }

            else if (param == eva_comm_center_line_03) {
                eva_comm_center_line_04
                    = Commands->Create_Sound("00-N028E", Vector3(0, 0, 0), obj); // receiving
                Commands->Monitor_Sound(obj, eva_comm_center_line_04);
            }

            else if (param == eva_comm_center_line_04) {
                eva_comm_center_line_05 = Commands->Create_Sound("00-N030E", Vector3(0, 0, 0),
                                                                 obj); // data acquisition complete
            ...
            case M01_HON_HAS_BEEN_DESTROYED_JDG: // Hand of Nod has been destroyed
            {
                ...
                GameObject* honCafeteriaGuy01
                    = Commands->Find_Object(M01_HON_CAFETERIA_EATING_GUY_ID);
                if (honCafeteriaGuy01 != nullptr) {
                    Commands->Send_Custom_Event(obj, honCafeteriaGuy01, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honCafeteriaGuy02
                    = Commands->Find_Object(M01_HON_CAFETERIA_WALKING_GUY_ID);
                if (honCafeteriaGuy02 != nullptr) {
                    Commands->Send_Custom_Event(obj, honCafeteriaGuy02, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honJudoGuy01 = Commands->Find_Object(M01_HON_CAFETERIA_JUDO_GUY_ID);
                if (honJudoGuy01 != nullptr) {
                    Commands->Send_Custom_Event(obj, honJudoGuy01, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDormGuy01 = Commands->Find_Object(M01_HON_DORMROOM_MINIGUNNER_ID);
                if (honDormGuy01 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDormGuy01, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDormGuy02 = Commands->Find_Object(M01_HON_DORMROOM_ROCKET_GUY_ID);
                if (honDormGuy02 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDormGuy02, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDormGuy03 = Commands->Find_Object(M01_HON_DORMROOM_CHEM_GUY_ID);
                if (honDormGuy03 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDormGuy03, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDormGuy04 = Commands->Find_Object(M01_HON_DORMROOM_FLAME_GUY_ID);
                if (honDormGuy04 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDormGuy04, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDormGuy05 = Commands->Find_Object(M01_HON_DORMROOM_CRAPPER_ID);
                if (honDormGuy05 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDormGuy05, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDojoSensei = Commands->Find_Object(M01_HON_DOJO_SENSEI_JDG);
                if (honDojoSensei != nullptr) {
                    Commands->Send_Custom_Event(obj, honDojoSensei, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDojoCiv01 = Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG);
                if (honDojoCiv01 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDojoCiv01, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDojoCiv02 = Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG);
                if (honDojoCiv02 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDojoCiv02, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                GameObject* honDojoCiv03 = Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG);
                if (honDojoCiv03 != nullptr) {
                    Commands->Send_Custom_Event(obj, honDojoCiv03, 0,
                                                M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, 0);
                }

                if (players_location != INSIDE_HAND_OF_NOD) {
                    if (player_has_reached_grunt_level == false) {
                        GameObject* m01_hon_evacuator_guy01
                            = Commands->Trigger_Spawner(M01_HON_FRONTDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy01,
                                                "M01_HON_FrontDoor_Evacuator_JDG", "");
                        GameObject* m01_hon_evacuator_guy02
                            = Commands->Trigger_Spawner(M01_HON_FRONTDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy02,
                                                "M01_HON_FrontDoor_Evacuator_JDG", "");
                        GameObject* m01_hon_evacuator_guy03
                            = Commands->Trigger_Spawner(M01_HON_FRONTDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy03,
                                                "M01_HON_FrontDoor_Evacuator_JDG", "");

                        GameObject* m01_hon_evacuator_guy04
                            = Commands->Trigger_Spawner(M01_HON_BACKDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy04,
                                                "M01_HON_BackDoor_Evacuator_JDG", "");
                        GameObject* m01_hon_evacuator_guy05
                            = Commands->Trigger_Spawner(M01_HON_BACKDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy05,
                                                "M01_HON_BackDoor_Evacuator_JDG", "");
                        GameObject* m01_hon_evacuator_guy06
                            = Commands->Trigger_Spawner(M01_HON_BACKDOOR_DESTROYED_SPAWNER_JDG);
                        Commands->Attach_Script(m01_hon_evacuator_guy06,
                                                "M01_HON_BackDoor_Evacuator_JDG", "");
                    }
                }
            } break;
            ...
            case M01_COMM_CENTER_HAS_BEEN_DESTROYED_JDG: // Comm Center has been destroyed
            {
                if (players_location != INSIDE_COMM_CENTER) {
                    GameObject* m01_commcenter_evacuator_guy01
                        = Commands->Trigger_Spawner(M01_COMMCENTER_DESTROYED_SPAWNER_JDG);
                    Commands->Attach_Script(m01_commcenter_evacuator_guy01,
                                            "M01_CommCenter_Evacuator_JDG", "");
                    GameObject* m01_commcenter_evacuator_guy02
                        = Commands->Trigger_Spawner(M01_COMMCENTER_DESTROYED_SPAWNER_JDG);
                    Commands->Attach_Script(m01_commcenter_evacuator_guy02,
                                            "M01_CommCenter_Evacuator_JDG", "");
                    GameObject* m01_commcenter_evacuator_guy03
                        = Commands->Trigger_Spawner(M01_COMMCENTER_DESTROYED_SPAWNER_JDG);
                    Commands->Attach_Script(m01_commcenter_evacuator_guy03,
                                            "M01_CommCenter_Evacuator_JDG", "");
                    GameObject* m01_commcenter_evacuator_guy04
                        = Commands->Trigger_Spawner(M01_COMMCENTER_DESTROYED_SPAWNER_JDG);
                    Commands->Attach_Script(m01_commcenter_evacuator_guy04,
                                            "M01_CommCenter_Evacuator_JDG", "");
                    GameObject* m01_commcenter_evacuator_guy05
                        = Commands->Trigger_Spawner(M01_COMMCENTER_DESTROYED_SPAWNER_JDG);
                    Commands->Attach_Script(m01_commcenter_evacuator_guy05,
                                            "M01_CommCenter_Evacuator_JDG", "");
                }

                if (player_has_unlocked_pen == false) {
                    Commands->Send_Custom_Event(obj, obj, 0, M01_CLEAR_UNLOCK_GATE_OBJECTIVE_JDG,
                                                0);
                    player_has_unlocked_pen = true;
                }
            ...
            case M01_PLAYER_IS_INSIDE_HON_JDG: // Player is inside HON--kill rain sounds
            {
                ...
                GameObject* soundController
                    = Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG);
                if (soundController != nullptr) {
                    Commands->Send_Custom_Event(obj, soundController, 0,
                ...
                if (first_time_in_handofnod == true) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_HON_CUE_WARROOM_LEVEL_ACTORS_JDG,
                                                0);
                }
            } break;
            ...
            case M01_PLAYER_IS_OUTSIDE_HON_JDG: // Player is outside HON--restart rain sounds
            {
                ...
                Commands->Send_Custom_Event(obj,
                                            Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG),
                                            0, M01_TURN_ON_OUTSIDE_AMBIENTS_JDG, 0);
            } break;

            case M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG: // Player is inside Comm Center--kill rain
                                                       // sounds--start internal pagings
            {
                ...
                GameObject* baseCommander
                    = Commands->Find_Object(M01_COMMCENTER_BASE_COMMANDER_JDG);
                if (baseCommander != nullptr) {
                    Commands->Send_Custom_Event(obj, baseCommander, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* baseScapeGoat
                    = Commands->Find_Object(M01_COMMCENTER_BASE_SCAPEGOAT_JDG);
                if (baseScapeGoat != nullptr) {
                    Commands->Send_Custom_Event(obj, baseScapeGoat, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* upstairsTech = Commands->Find_Object(M01_COMMCENTER_UPSTAIRS_TECH_JDG);
                if (upstairsTech != nullptr) {
                    Commands->Send_Custom_Event(obj, upstairsTech, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* warroomTech01
                    = Commands->Find_Object(M01_COMMCENTER_WAROOM_TECH_01_JDG);
                if (warroomTech01 != nullptr) {
                    Commands->Send_Custom_Event(obj, warroomTech01, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* warroomTech02
                    = Commands->Find_Object(M01_COMMCENTER_WAROOM_TECH_02_JDG);
                if (warroomTech02 != nullptr) {
                    Commands->Send_Custom_Event(
                        obj, Commands->Find_Object(M01_COMMCENTER_WAROOM_TECH_02_JDG), 0,
                        M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* mainframeTech
                    = Commands->Find_Object(M01_COMMCENTER_COMPUTERROOM_TECH_JDG);
                if (mainframeTech != nullptr) {
                    Commands->Send_Custom_Event(obj, mainframeTech, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }

                GameObject* upstairsGuard
                    = Commands->Find_Object(M01_COMMCENTER_UPSTAIRS_GUARD_JDG);
                if (upstairsGuard != nullptr) {
                    Commands->Send_Custom_Event(obj, upstairsGuard, 0,
                                                M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
                }
            } break;

            case M01_PLAYER_IS_OUTSIDE_COMM_CENTER_JDG: // Player is outside Comm Center--restart
                                                        // rain sounds
            {
            ...
            case M01_PLAYER_IS_INSIDE_TUNNEL_JDG: // Player is inside TUNNEL leading to tailgun
                                                  // run--stop rain sounds
            {
                players_location = INSIDE_TUNNEL;
                Commands->Send_Custom_Event(obj,
                                            Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG),
                                            0, M01_TURN_OFF_OUTSIDE_AMBIENTS_JDG, 0);
            } break;
            ...
            case M01_PLAYER_IS_INSIDE_WATERFALL_JDG: // Player is inside WATERFALL cave--stop rain
                                                     // sounds
            {
            ...
            case M01_PLAYER_IS_OUTSIDE_WATERFALL_JDG: // Player is outside WATERFALL cave--restart
                                                      // rain sounds
            {
            ...
            case M01_PLAYER_IS_IN_HON_GRUNT_LEVEL_JDG: // Player is entering Grunt level--cue actors
            {
                ...
                if ((hand_of_nod_state != DESTROYED) && (first_time_in_hon_gruntlevel == true)) {
                    ...
                    GameObject* honCafeteriaGuy01
                        = Commands->Find_Object(M01_HON_CAFETERIA_EATING_GUY_ID);
                    if (honCafeteriaGuy01 != nullptr) {
                        Commands->Send_Custom_Event(obj, honCafeteriaGuy01, 0, M01_START_ACTING_JDG,
                                                    0);
                    }
                    ...
                    GameObject* honCafeteriaGuy02
                        = Commands->Find_Object(M01_HON_CAFETERIA_WALKING_GUY_ID);
                    if (honCafeteriaGuy02 != nullptr) {
                        Commands->Send_Custom_Event(obj, honCafeteriaGuy02, 0, M01_START_ACTING_JDG,
                                                    0);
                    }
                    ...
                    GameObject* honDormGuy01
                        = Commands->Find_Object(M01_HON_DORMROOM_MINIGUNNER_ID);
                    if (honDormGuy01 != nullptr) {
                        Commands->Send_Custom_Event(obj, honDormGuy01, 0, M01_START_ACTING_JDG, 0);
                    }

                    GameObject* honDormGuy02
                        = Commands->Find_Object(M01_HON_DORMROOM_ROCKET_GUY_ID);
                    if (honDormGuy02 != nullptr) {
            ...
            case M01_PLAYER_IS_IN_HON_DOJO_JDG: // Player is entering DOJO--cue actors
            {
                if ((hand_of_nod_state != DESTROYED) && (first_time_in_hon_dojolevel == true)) {
                    ...
                    if (Commands->Find_Object(M01_HON_DOJO_SENSEI_JDG)) {
                        Commands->Send_Custom_Event(obj,
                                                    Commands->Find_Object(M01_HON_DOJO_SENSEI_JDG),
                                                    0, M01_START_ACTING_JDG, 0);
                    }
                }
            } break;

            case M01_HON_SAMSITE_HAS_BEEN_DESTROYED_JDG: // hand of nod sam site has been
                                                         // destroyed--duh!
            {
                // Commands->Set_Objective_Status( M01_HON_SAM_OBJECTIVE_JDG,
                ...
                if (handOfNodHealth > 0) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_HON_REINFORCEMENTS_A_JDG,
                                                delayTimer_A);
                    float delayTimer_B = Commands->Get_Random(2, 4);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_HON_REINFORCEMENTS_B_JDG,
                                                delayTimer_B);
                }
            } break;

            case M01_COMMCENTER_SAMSITE_HAS_BEEN_DESTROYED_JDG: // Comm Center sam site has been
                                                                // destroyed--duh!
            {
                ...
                if (player_has_unlocked_pen == true) {
                    unlocked_gate_conv = Commands->Create_Conversation(
                        "M01_Remove_Unlock_Gate_Objective", 100, 1000, false);
                    Commands->Join_Conversation(nullptr, unlocked_gate_conv, false, false);
                ...
                Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_COMMCENTER_REINFORCEMENTS_JDG,
                                            10);
            } break;
            ...
            case M01_SEND_COMMCENTER_REINFORCEMENTS_JDG: // Starting Elie drop off animation at Comm
                                                         // Center
            {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-296.388f, 497.455f, 29.122f));
                Commands->Set_Facing(chinook_obj1, -130.00f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                        "X1I_GDI_CommCenter_TroopDrop.txt");
            } break;

            case M01_SEND_HON_REINFORCEMENTS_A_JDG: // Starting Elie drop off animation at Hand of
                                                    // Nod
            {
                GameObject* chinook_obj1
                    = Commands->Create_Object("Invisible_Object", Vector3(-147.1f, 558.8f, 4.4f));
                Commands->Set_Facing(chinook_obj1, -130.00f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                        "X1I_GDI_HON_TroopDrop01a.txt");
            } break;

            case M01_SEND_HON_REINFORCEMENTS_B_JDG: // Starting Elie drop off animation at Hand of
                                                    // Nod
            {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-154.679f, 519.009f, 4.97f));
                Commands->Set_Facing(chinook_obj1, 130.00f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                        "X1I_GDI_HON_TroopDrop01b.txt");
            } break;

            case M01_HON_CHINOOK_GUY_HAS_BEEN_KILLED_JDG: // a reinforcement guy's been
                                                          // killed--spawn more if needed
            {
            ...
            case M01_PLAYER_IS_APPROACHING_CHURCH_JDG: // cue church actors
            {
                if (m01_bridgeWeather_is_Set == false) {
                    ...
                    if (chemGuy01 != nullptr) {
                        Commands->Send_Custom_Event(obj, chemGuy01, 0, M01_START_ACTING_JDG, 5);
                    }
                }

                int church_upadate
                    = Commands->Create_Conversation("M01_Add_Church_Objective", 100, 1000, false);
                Commands->Join_Conversation(nullptr, church_upadate, false, false);
                ...
                GameObject* loveshackGuard
                    = Commands->Find_Object(M01_CHURCH_LOVESHACK_MINIGUNNER_ID);
                if (loveshackGuard != nullptr) {
                ...
                if (loveshackNun != nullptr) {
                    Commands->Send_Custom_Event(obj, loveshackNun, 0, M01_START_ACTING_JDG, 0);
                }

                GameObject* exteriorGuard
                    = Commands->Find_Object(M01_CHURCH_EXTERIOR_MINIGUNNER_ID);
                if (exteriorGuard != nullptr) {
            ...
            {
                Commands->Add_Objective(M01_CHURCH_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_05,
                                        nullptr, IDS_Enc_Obj_Secondary_M01_05);
                ...
                if (churchNun != nullptr) {
                    ...
                    Commands->Set_Obj_Radar_Blip_Color(churchNun,
                                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
                }
                ...
                if (churchPriest != nullptr) {
                    ...
                    Commands->Set_Obj_Radar_Blip_Color(churchPriest,
                                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
                }
            } break;

            case M01_CLEAR_FIRST_NOD_COMMANDER_PASS_JDG: // guard tower commander is
                                                         // destroyed--clear objective
            {
                Commands->Set_Objective_Status(M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            ...
            {
                Commands->Set_Objective_Status(M01_HON_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            } break;

            case M01_CLEAR_CHURCH_OBJECTIVE_PASS_JDG: // player has rescued clergy
            {
                Commands->Set_Objective_Status(M01_CHURCH_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            } break;
            ...
            case M01_LOVESHACK_GUARD_IS_DEAD_JDG: // Loveshack guard is dead--let nun know
            {
                ...
                if (loveshackNun != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 2);
                    Commands->Send_Custom_Event(obj, loveshackNun, 0,
                                                M01_LOVESHACK_GUARD_IS_DEAD_JDG, delayTimer);
                }

                if ((loveshack_guard_is_dead == true) && (church_guard_is_dead == true)
                    && (church_pickup_chinook_is_on_its_way == false)) {
                    GameObject* churchEvacController = Commands->Find_Object(103394);
                    if (churchEvacController != nullptr) {
                        Commands->Send_Custom_Event(
                            obj, churchEvacController, 0, M01_START_ACTING_JDG,
            ...
            case M01_CHURCH_GUARD_IS_DEAD_JDG: // inner guard is dead--let nuns & prist know
            {
                ...
                if (churchNun != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 2);
                    Commands->Send_Custom_Event(obj, churchNun, 0, M01_CHURCH_GUARD_IS_DEAD_JDG,
                                                delayTimer);
                }
                ...
                if (churchPriest != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 2);
                    Commands->Send_Custom_Event(obj, churchPriest, 0, M01_CHURCH_GUARD_IS_DEAD_JDG,
                                                delayTimer);
                }
            ...
            case M01_CHURCH_CLERGY_HAS_BOARDED_JDG: // when all clergy have boarded--tell chinook to
                                                    // take off
            {
                if (Commands->Find_Object(M01_CHURCH_LOVESHACK_NUN_ID)
                    || (Commands->Find_Object(M01_CHURCH_INTERIOR_NUN_ID))
                    || (Commands->Find_Object(m01_church_interior_nun02_ID))
                    ...
                    if ((clergy_are_boarding == false)) {
                        ...
                        Commands->Send_Custom_Event(obj, obj, 0,
                                                    M01_CLEAR_CHURCH_OBJECTIVE_PASS_JDG, 2);
                    }
                }
            } break;

            case M01_CARD_CARRIER_HAS_BEEN_KILLED_JDG: // a card carrier has been killed--drop
                                                       // necessary card
            {
                ...
                if (playerHasLevel01KeyCard == false) {
                    ...
                    GameObject* keycard01
                        = Commands->Create_Object("Level_01_Keycard", spawn_location);
            ...
            case M01_GDI_GUY_HAS_BEEN_POKED_JDG: // player has poked a GDI soldier--if player is
                                                 // alone assign escort
            {
                int poked_guys_ID = Commands->Get_ID(sender);

                if (player_has_an_escort == false) {
                    Commands->Send_Custom_Event(obj, sender, 0,
                                                M01_PLEASE_START_ESCORTING_PLAYER_JDG, 0);
                    players_escorts_ID = poked_guys_ID;
                    player_has_an_escort = true;
                }

                else if (player_has_an_escort == true) {
                    if (poked_guys_ID == players_escorts_ID) // this guy is escorting player--tell
                                                             // him to hold position
                    {
                        Commands->Send_Custom_Event(obj, sender, 0,
                                                    M01_PLEASE_STOP_ESCORTING_PLAYER_JDG, 0);
                        player_has_an_escort = false;
                    }
                }
            } break;

            case M01_PLAYERS_ESCORT_HAS_BEEN_KILLED_JDG: // player's escort has been killed--reset
                                                         // escort parameters
            {
                player_has_an_escort = false;
            } break;

            case M01_PLAYER_IS_ATTACKING_ME_JDG: // if player is being escorted--tell escort who
                                                 // havoc's target is
            {
                if (player_has_an_escort == true) {
                    havocs_targets_ID = Commands->Get_ID(sender);
                    float delayTimer = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID),
                                                M01_PLAYER_IS_ATTACKING_ME_JDG, havocs_targets_ID,
                                                delayTimer);
                }
            } break;

            case M01_PLAYER_IS_LEAVING_CHURCH_01_JDG: // if havoc has escort--tell them to go
                                                      // somewhere else
            {
                if (player_has_an_escort == true) {
            ...
            case M01_PLAYER_IS_LEAVING_CHURCH_02_JDG: // if havoc has escort--tell them to go
                                                      // somewhere else
            {
                if (player_has_an_escort == true) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
            ...
            case M01_PLAYER_IS_LEAVING_HON_01_JDG: // if havoc has escort--tell them to go somewhere
                                                   // else
            {
                if (player_has_an_escort == true) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
            ...
            case M01_PLAYER_IS_LEAVING_HON_02_JDG: // if havoc has escort--tell them to go somewhere
                                                   // else
            {
                if (player_has_an_escort == true) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
            ...
            case M01_PLAYER_IS_CROSSING_THE_BRIDGE_JDG: // havoc is crossing bridge for first
                                                        // time--cue driveby actors
            {
                if (m01_bridgeWeather_is_Set == false) {
                    m01_bridgeWeather_is_Set = true;
                    // Commands->Set_Clouds (0.75f, 0.75f, 30);
                ...
                GameObject* churchAreaCommander
                    = Commands->Find_Object(M01_CHURCHAREA_NOD_COMMANDER_JDG);
                if (churchAreaCommander != nullptr) {
                    Commands->Send_Custom_Event(obj, churchAreaCommander, 0, M01_START_ACTING_JDG,
                                                0);
                }
            } break;

            case M01_PLAYER_IS_CROSSING_THE_BRIDGE_VIA_CAVE_JDG: // havoc is crossing bridge for
                                                                 // first time--cue actors driveby
                                                                 // actors
            {
                if (m01_bridgeWeather_is_Set == false) {
                    m01_bridgeWeather_is_Set = true;
            ...
            case M01_SPAWN_TIB_CAVE_HELICOPTER_JDG: // player is in tib cave--spawn surprise
                                                    // helicopter
            {
                ...
                Commands->Attach_Script(m01_tiberium_cave_helicopter,
                                        "M01_Tiberium_Cave_Helicopter_JDG", "");
            } break;

            case M01_ANNOUNCE_HON_OBJECTIVE_JDG: // player is approaching hand of nod--give
                                                 // objective
            {
                ...
                int hand_of_nod_conv
                    = Commands->Create_Conversation("M01_Add_HON_Objective", 100, 1000, false);
                Commands->Join_Conversation(nullptr, hand_of_nod_conv, false, false);
            ...
            {
                Commands->Add_Objective(M01_HON_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_07,
                                        nullptr, IDS_Enc_Obj_Secondary_M01_07);
                Commands->Set_Objective_Radar_Blip(M01_HON_OBJECTIVE_JDG,
                                                   Vector3(-179.3f, 541.9f, 3.518f));

                GameObject* pogController = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
                                                M01_HON_OBJECTIVE_JDG, 0);
                }
            } break;
            ...
            case M01_KILL_THE_COMM_JDG: // apply damage to COMM CENTER
            {
                if (comm_center_state != DESTROYED) {
                    Commands->Apply_Damage(Commands->Find_Object(M01_COMM_CENTER_JDG), 100000000,
                                           "BlamoKiller", obj);
                }
            } break;
            ...
            case M01_KILL_THE_HON_JDG: // apply damage to HON
            {
                if (hand_of_nod_state != DESTROYED) {
                    Commands->Apply_Damage(Commands->Find_Object(M01_HAND_OF_NOD_JDG), 100000000,
                                           "BlamoKiller", obj);
                }
            } break;
            ...
            case M01_PLAYER_HAS_POKED_COMM_CENTER_PCT_JDG: {
                ...
                {
                    eva_comm_center_line_01
                        = Commands->Create_Sound("00-N000E", Vector3(0, 0, 0), obj); // accessing
                    Commands->Monitor_Sound(obj, eva_comm_center_line_01);

                    // Commands->Send_Custom_Event( obj, obj, 0,
                    // M01_CLEAR_UNLOCK_GATE_OBJECTIVE_JDG, 0 ); player_has_unlocked_pen = true;
                }
            } break;
            ...
            case M01_PLAYER_HAS_POKED_PEN_GATE_JDG: {
                if (player_has_unlocked_pen != true) {
                    if (first_time_poking_gate_lock == true) {
                        ...
                        int prisoner_conv = Commands->Create_Conversation(
                            "M01_Add_Unlock_Gate_Objective", 100, 1000, false);
                        Commands->Join_Conversation(nullptr, prisoner_conv, false, false);
                    ...
                    Commands->Set_Objective_Status(M01_OPEN_THE_GATE_JDG,
                                                   OBJECTIVE_STATUS_ACCOMPLISHED);
                    Commands->Static_Anim_Phys_Goto_Last_Frame(M01_COMMCENTER_DETENTION_GATE_JDG,
                                                               nullptr);

                    // Vector3 gatePosition = Commands->Get_Position ( Commands->Find_Object (
                    // M01_COMMCENTER_DETENTION_GATE_JDG ) ); Vector3 gatePosition =
                    // Commands->Get_Position ( STAR );
                    ...
                    if (Commands->Find_Object(M01_COMMCENTER_SAM_JDG)) {
                        Commands->Create_Logical_Sound(obj, M01_DETENTION_GATE_IS_DOWN_JDG,
                                                       Vector3(-315.383f, 572.805f, 27.623f),
                                                       50.0f);
                        Commands->Send_Custom_Event(obj, obj, 0,
                                                    M01_ANNOUNCE_COMMCENTER_SAM_OBJECTIVE_JDG, 0);
                    }
            ...
            case M01_ANNOUNCE_COMMCENTER_SAM_OBJECTIVE_JDG: {
                int comm_sam_conv
                    = Commands->Create_Conversation("M01_Add_Comm_SAM_Objective", 100, 1000, false);
                Commands->Join_Conversation(nullptr, comm_sam_conv, false, false);
            ...
            case M01_ADD_COMM_SAM_OBJECTIVE_JDG: {
                ...
                if (commSamSite != nullptr) {
                    Commands->Add_Objective(M01_COMM_SAM_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                            OBJECTIVE_STATUS_PENDING,
                                            IDS_Enc_ObjTitle_Primary_M01_04, nullptr,
                                            IDS_Enc_Obj_Primary_M01_04);
                    Commands->Set_Objective_Radar_Blip_Object(M01_COMM_SAM_OBJECTIVE_JDG,
                                                              commSamSite);

                    GameObject* pogController
                        = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
                    if (pogController != nullptr) {
                        Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
                                                    M01_COMM_SAM_OBJECTIVE_JDG, 0);
                    }
                }
            } break;

            case M01_ANNOUNCE_UNLOCK_GATE_OBJECTIVE_JDG: {
                int unlock_gate_conv = Commands->Create_Conversation(
                    "M01_Add_Unlock_Gate_Objective", 100, 1000, false);
                Commands->Join_Conversation(nullptr, unlock_gate_conv, false, false);
            ...
            case M01_ADD_UNLOCK_GATE_OBJECTIVE_JDG: {
                ...
                Commands->Add_Objective(M01_UNLOCK_GATE_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M01_02,
                                        nullptr, IDS_Enc_Obj_Primary_M01_02);
                Commands->Set_Objective_HUD_Info_Position(
                    M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga", IDS_POG_HACK, pogMarker);

                unlock_gate_objective_active = true;

                // Vector3 green (0,1,0);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Primary_M01_02,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);

                GameObject* invisibleCrate = Commands->Find_Object(107809);
                if (invisibleCrate != nullptr) {
                    Commands->Send_Custom_Event(obj, invisibleCrate, 0, M01_COMM_SAM_OBJECTIVE_JDG,
                                                0);
                }
            } break;
            ...
            case M01_PASS_UNLOCK_GATE_OBJECTIVE_JDG: {
                Commands->Set_Objective_Status(M01_UNLOCK_GATE_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            } break;
            ...
            case M01_SCRAMBLE_THE_RADAR_JDG: {
                if (players_first_time_by_commcenter == true) {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(103099), 0,
                                                M01_START_ACTING_JDG,
                                                0); // telling propaganda to start up
                    players_first_time_by_commcenter = false;

                    int radar_conv = Commands->Create_Conversation(
                        "M01_Radar_Scrambled_Conversation", 100, 1000, false);
                    Commands->Join_Conversation(nullptr, radar_conv, false, false, false);
                    Commands->Join_Conversation(nullptr, radar_conv, false, false, false);
            ...
            case M01_ANNOUNCE_PRISONER_OBJECTIVE_JDG: {
                int prisoner_conv = Commands->Create_Conversation("M01_Add_Unlock_Gate_Objective",
                                                                  100, 1000, false);
                Commands->Join_Conversation(nullptr, prisoner_conv, false, false);
                Commands->Start_Conversation(prisoner_conv, prisoner_conv);
                ...
                Commands->Set_Objective_Status(M01_PRISONER_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
            } break;
            ...
            case M01_DO_END_MISSION_CHECK_JDG: // see if any primary objectives are active
            {
                if ((commcenter_sam_objective_active != true) && (prisoners_are_freed == true)) {
                    ...
                    if (final_conv_played == false) {
                        ...
                        // if (evacController01 != nullptr)
                        //{
                        //	Commands->Send_Custom_Event( obj, evacController01, 0,
                        //M01_START_ACTING_JDG, 0 );
                        // }

                        // if (evacController02 != nullptr)
                        //{
                        //	Commands->Send_Custom_Event( obj, evacController02, 0,
                        //M01_START_ACTING_JDG, 0 );
                        // }

                        GameObject* detentionPenCiv01
                            = Commands->Find_Object(M01_DETENTION_CIVILIAN_01_JDG);
                        GameObject* detentionPenCiv02
                            = Commands->Find_Object(M01_DETENTION_CIVILIAN_02_JDG);
                        GameObject* detentionPenCiv03
                            = Commands->Find_Object(M01_DETENTION_CIVILIAN_03_JDG);
                        GameObject* detentionPenGDI01
                            = Commands->Find_Object(M01_DETENTION_GDI_GUY_01_JDG);
                        GameObject* detentionPenGDI02
                            = Commands->Find_Object(M01_DETENTION_GDI_GUY_02_JDG);
                        GameObject* detentionPenGDI03
                            = Commands->Find_Object(M01_DETENTION_GDI_GUY_03_JDG);

                        if (detentionPenCiv01 != nullptr) {
                            Commands->Destroy_Object(detentionPenCiv01);
                        }

                        if (detentionPenCiv02 != nullptr) {
                            Commands->Destroy_Object(detentionPenCiv02);
                        }

                        if (detentionPenCiv03 != nullptr) {
                            Commands->Destroy_Object(detentionPenCiv03);
                        }

                        if (detentionPenGDI01 != nullptr) {
                            Commands->Destroy_Object(detentionPenGDI01);
                        }

                        if (detentionPenGDI02 != nullptr) {
                            Commands->Destroy_Object(detentionPenGDI02);
                        }

                        if (detentionPenGDI03 != nullptr) {
                        ...
                        GameObject* controller1
                            = Commands->Create_Object("Invisible_Object", Vector3(0, 0, 0));
            ...
            case M01_END_MISSION_PASS_JDG: // see if any primary objectives are active
            {
                ...
                if (propagandaController != nullptr) {
                    Commands->Send_Custom_Event(obj, propagandaController, 0,
                                                M01_IVE_BEEN_KILLED_JDG, 0);
                }
            ...
            case M01_SPAWN_WHACK_A_MOLE_GUY_JDG: {
                GameObject* m01_whack_a_mole_guy = Commands->Create_Object(
                    "Nod_MiniGunner_1Off", Vector3(-198.088f, 525.828f, 10.035f));
            ...
            case M01_CHANGE_WHACK_A_MOLE_GUY_JDG: {
                ...
                if (whackAmole != nullptr) {
                    Commands->Send_Custom_Event(obj, whackAmole, 0, M01_CHANGE_WHACK_A_MOLE_GUY_JDG,
                                                0);
                }
            } break;
            ...
            case M01_HON_SPAWNS_MINIGUNNER_JDG: {
                if (hand_of_nod_state != DESTROYED) {
                    ...
                    if (m01_hon_total_spawners_tally <= 6) {
                        if ((m01_hon_spawned_guy_01_alive == false)
                            && (players_location != INSIDE_HAND_OF_NOD)) {
                            GameObject* m01_hon_spawned_guy_01 = Commands->Create_Object(
                                "Nod_MiniGunner_0", Vector3(-212.6f, 541.1f, 4));
                            Commands->Attach_Script(m01_hon_spawned_guy_01,
                        ...
                        else if ((m01_hon_spawned_guy_02_alive == false)
                                 && (players_location != INSIDE_HAND_OF_NOD)) {
                            GameObject* m01_hon_spawned_guy_02 = Commands->Create_Object(
                                "Nod_MiniGunner_0", Vector3(-217.2f, 540.2f, 4));
                            Commands->Attach_Script(m01_hon_spawned_guy_02,
                        ...
                        else if ((m01_hon_spawned_guy_03_alive == false)
                                 && (players_location != INSIDE_HAND_OF_NOD)) {
                            GameObject* m01_hon_spawned_guy_03 = Commands->Create_Object(
                                "Nod_FlameThrower_0", Vector3(-217.6f, 533.6f, 4));
                            Commands->Attach_Script(m01_hon_spawned_guy_03,
                    ...
                    Commands->Send_Custom_Event(
                        obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
            ...
            case M01_CUE_LOVESHACK_NUN_CONVERSATION_JDG: {
                GameObject* loveshackNun = Commands->Find_Object(M01_CHURCH_LOVESHACK_NUN_ID);
                if (loveshackNun != nullptr && (church_guard_is_dead != true)) {
                    if (loveshack_conv_playing == false) {
                        loveshack_conv_playing = true;
                        loveshack_conv = Commands->Create_Conversation(
                            "M01_Locke_ChurchReminder_Conversation", 45, 1000, true);
                        Commands->Join_Conversation(nullptr, loveshack_conv, false, false);
            ...
            case M01_CUE_PRIEST_CONVERSATION_JDG: {
                ...
                if (priest != nullptr && (loveshack_guard_is_dead != true)) {
                    if (priest_conv_playing == false) {
                        priest_conv_playing = true;
                        priest_conv = Commands->Create_Conversation(
                            "M01_PriestReminder_Conversation", 100, 1000, false);
            ...
            case M01_CUE_INTERIOR_NUN_CONVERSATION_JDG: {
                ...
                if (interiorNun != nullptr && (loveshack_guard_is_dead != true)) {
                    if (interior_nun_conv_playing == false) {
                        interior_nun_conv_playing = true;
                        interior_nun_conv = Commands->Create_Conversation(
                            "M01_Interior_Nun_Conversation", 100, 1000, false);
                        Commands->Join_Conversation(interiorNun, interior_nun_conv, false, true,
                                                    true);
            ...
            case M01_SPAWN_THE_MEDIUM_TANK_JDG: {
                if (medium_tank_spawned == false) {
                    ...
                    // GameObject *controller1 = Commands->Create_Object("Invisible_Object",
                    // Vector3(-85.808f, 125.455f, 3.927f)); Commands->Set_Facing ( controller1, 180
                    // ); Commands->Attach_Script(controller1, "Test_Cinematic",
                    // "X1I_GDI_Drop_MediumTank.txt");

                    // GameObject *controller2 = Commands->Create_Object("Invisible_Object",
                    // Vector3(0,0,0)); Commands->Attach_Script(controller2, "Test_Cinematic",
                    // "X1D_Hover_MTank.txt");
                }
            } break;
            ...
            case M01_ADD_BARN_COMMANDER_OBJECTIVE_JDG: {
                ...
                if (barnCommander != nullptr) {
                    Commands->Add_Objective(M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG,
                                            OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                            IDS_Enc_ObjTitle_Secondary_M01_01, nullptr,
                                            IDS_Enc_Obj_Secondary_M01_01);
                    Commands->Set_Obj_Radar_Blip_Shape(
                        barnCommander, RADAR_BLIP_SHAPE_OBJECTIVE); // Set to -1 to reset default
                    Commands->Set_Obj_Radar_Blip_Color(barnCommander,
                                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
                    ...
                    if (firstNodCommanderKilled == true) {
                        Commands->Send_Custom_Event(obj, obj, 0,
                                                    M01_CLEAR_FIRST_NOD_COMMANDER_PASS_JDG, 3);
                    }
                }
            } break;
            ...
            case M01_PLAYER_APPROACHING_BARN_AREA_JDG: {
                if (first_time_at_barn == true) {
                    ...
                    if (turretEngineer != nullptr) {
                        Commands->Send_Custom_Event(obj, turretEngineer, 0, M01_START_ACTING_JDG,
                                                    0);
                    }

                    Commands->Send_Custom_Event(obj, obj, 0, M01_ANNOUNCE_TURRETS_OBJECTIVE_JDG, 0);

                    GameObject* barnAreaCommander
                        = Commands->Find_Object(M01_BARNAREA_NOD_COMMANDER_02_JDG);
                    if (barnAreaCommander != nullptr) {
                        Commands->Send_Custom_Event(obj, barnAreaCommander, 0, M01_START_ACTING_JDG,
                                                    5);
                    }
            ...
            case M01_PLAYER_IS_APPROACHING_TAILGUN_ALLEY_JDG: {
                GameObject* tailgunCommander
                    = Commands->Find_Object(M01_TAILGUNAREA_NOD_COMMANDER_JDG);
                if (tailgunCommander != nullptr) {
                ...
                if (artilleryController != nullptr) {
            ...
            case M01_PLAYER_APPROACHING_GDI_BASE_AREA_JDG: {
                GameObject* artilleryController
                    = Commands->Find_Object(M01_GDIBASE_ARTILLERY_CONTROLLER_ID);
                if (artilleryController != nullptr) {
                    Commands->Send_Custom_Event(obj, artilleryController, 0, M01_START_ACTING_JDG,
                                                0);
                }
            } break;
            ...
            case M01_ANNOUNCE_TURRETS_OBJECTIVE_JDG: {
                turrets_conv
                    = Commands->Create_Conversation("M01_Add_Turrets_Objective", 100, 1000, false);
                Commands->Join_Conversation(nullptr, turrets_conv, false, false);
                Commands->Join_Conversation(nullptr, turrets_conv, false, false);
            ...
            case M01_ADD_TURRETS_OBJECTIVE_JDG: {
                Commands->Add_Objective(M01_TURRETS_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_02,
                                        nullptr, IDS_Enc_Obj_Secondary_M01_02);

                GameObject* pogController = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
                                                M01_TURRETS_OBJECTIVE_JDG, 0);
                }

                GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
                if (turret01 != nullptr) {
                    Commands->Set_Obj_Radar_Blip_Shape(turret01, RADAR_BLIP_SHAPE_OBJECTIVE);
                    Commands->Set_Obj_Radar_Blip_Color(turret01,
                                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
                }
                ...
                if (turret02 != nullptr) {
                    ...
                    Commands->Set_Obj_Radar_Blip_Color(turret02,
                                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
                }

                int c4_conv = Commands->Create_Conversation("M01_Locke_Sending_C4_Conversation",
                                                            100, 1000, false);
                Commands->Join_Conversation(nullptr, c4_conv, false, false);
                Commands->Start_Conversation(c4_conv, c4_conv);

                Vector3 airdropPosition(-82.786f, 113.665f, 2.221f);
                GameObject* controller
                    = Commands->Create_Object("Invisible_Object", airdropPosition);
            ...
            case M01_END_TURRETS_OBJECTIVE_FAIL_JDG: {
                if (turret_objective_over == false) {
                    ...
                    Commands->Set_Objective_Status(M01_TURRETS_OBJECTIVE_JDG,
            ...
            case M01_END_TURRETS_OBJECTIVE_PASS_JDG: {
                if (turret_objective_over == false) {
                    ...
                    if (gunboat != nullptr) {
                        Commands->Send_Custom_Event(obj, gunboat, 0,
                                                    M01_END_TURRETS_OBJECTIVE_PASS_JDG, 0);

                        int turrets_conv_02 = Commands->Create_Conversation(
                            "M01_Remove_Turrets_Objective", 100, 1000, false);
                        Commands->Join_Conversation(nullptr, turrets_conv_02, false, false);
                        Commands->Start_Conversation(turrets_conv_02, 0);
                        Commands->Send_Custom_Event(obj, obj, 0, M01_PASS_TURRETS_OBJECTIVE_JDG, 5);
                    }

                    else {
                        // turrets_hummVee_conv = Commands->Create_Conversation(
                        // "M01_Locke_GiveHummVee_Conversation", 100, 1000, false);
                        // Commands->Join_Conversation( nullptr, turrets_hummVee_conv, false, false );
            ...
            case M01_PASS_TURRETS_OBJECTIVE_JDG: {
                Commands->Set_Objective_Status(M01_TURRETS_OBJECTIVE_JDG,
                                               OBJECTIVE_STATUS_ACCOMPLISHED);
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_SPAWN_THE_MEDIUM_TANK_JDG, 0);
            } break;

                /*case M01_START_BARN_OBJECTIVE_JDG:
                        {
                                Commands->Send_Custom_Event( obj, obj, 0,
                M01_ANNOUNCE_BARN_OBJECTIVE_JDG, 0 );
                        }
                        break;
                ...
                case M01_ANNOUNCE_BARN_OBJECTIVE_JDG:
                        {
                                ...
                                {
                                        int barn_conv = Commands->Create_Conversation(
                "M01_Add_Barn_Objective", 100, 1000, false);

                                        Commands->Join_Conversation( nullptr, barn_conv, false, false
                ); Commands->Join_Conversation( STAR, barn_conv, false, false );
                                        Commands->Start_Conversation( barn_conv,  0 );

                                        Commands->Send_Custom_Event( obj, obj, 0,
                M01_ADD_BARN_OBJECTIVE_JDG, 6 );

                                        barn_announcement_active = true;

                                        GameObject * barnObjectiveZone = Commands->Find_Object (
                M01_BARN_OBJECTIVE_ZONE_ID ); if (barnObjectiveZone != nullptr)
                                        {
                ...
                /*case M01_ADD_BARN_OBJECTIVE_JDG:
                                {
                                        if (barn_objective_active == false)
                                        {
                                                ...
                                                Commands->Add_Objective( M01_BARN_OBJECTIVE_JDG,
                   OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                   IDS_Enc_ObjTitle_Secondary_M01_03, nullptr, IDS_Enc_Obj_Secondary_M01_03 );

                                                GameObject * pogController = Commands->Find_Object (
                   M01_MISSION_POG_CONTROLLER_JDG ); if (pogController != nullptr)
                                                {
                                                        Commands->Send_Custom_Event( obj,
                   pogController, M01_ADD_OBJECTIVE_POG_JDG, M01_BARN_OBJECTIVE_JDG, 0 );
                                                }

                                                GameObject * barnPrisoner01 = Commands->Find_Object
                   ( M01_BARN_PRISONER_01_ID ); if (barnPrisoner01 != nullptr)
                                                {
                                                        Commands->Set_Obj_Radar_Blip_Shape (
                   barnPrisoner01, RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color
                   ( barnPrisoner01, RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                                }

                                                GameObject * barnPrisoner02 = Commands->Find_Object
                   ( M01_BARN_PRISONER_02_ID ); if (barnPrisoner02 != nullptr)
                                                {
                                                        Commands->Set_Obj_Radar_Blip_Shape (
                   barnPrisoner02, RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color
                   ( barnPrisoner02, RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                                }

                                                GameObject * barnPrisoner03 = Commands->Find_Object
                   ( M01_BARN_PRISONER_03_ID ); if (barnPrisoner03 != nullptr)
                                                {
                                                        Commands->Set_Obj_Radar_Blip_Shape (
                   barnPrisoner03, RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color
                   ( barnPrisoner03, RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                                }
                                        }
                                }
                                break;*/
                ...
                /*case M01_CHANGE_BARN_OBJECTIVE_JDG:
                        {
                                ...
                                {
                                        int roundupcivs_conv = Commands->Create_Conversation(
                   "M01_Add_Barn_Roundup_Objective", 100, 1000, false); Commands->Join_Conversation(
                   nullptr, roundupcivs_conv, false, false ); Commands->Start_Conversation(
                   roundupcivs_conv,  roundupcivs_conv );

                                        Commands->Set_Objective_Status( M01_BARN_OBJECTIVE_JDG,
                   OBJECTIVE_STATUS_ACCOMPLISHED ); Commands->Add_Objective(
                   M01_BARN_ROUNDUP_OBJECTIVE_JGD, OBJECTIVE_TYPE_SECONDARY,
                   OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_04, nullptr,
                   IDS_Enc_Obj_Secondary_M01_04 );

                                        GameObject * pogController = Commands->Find_Object (
                   M01_MISSION_POG_CONTROLLER_JDG ); if (pogController != nullptr)
                                        {
                                                Commands->Send_Custom_Event( obj, pogController,
                   M01_ADD_OBJECTIVE_POG_JDG, M01_BARN_ROUNDUP_OBJECTIVE_JGD, 0 );
                                        }
                                }
                        }
                        break;*/
            ...
            case M01_END_BARN_ROUNDUP_OBJECTIVE_JDG: {
                if (barn_objective_ended == false) {
                    ...
                    {
                            Commands->Set_Objective_Status( M01_BARN_OBJECTIVE_JDG,
                    OBJECTIVE_STATUS_FAILED ); Commands->Set_Objective_Status(
                    M01_BARN_ROUNDUP_OBJECTIVE_JGD, OBJECTIVE_STATUS_FAILED );

                            barnfailed_conv = Commands->Create_Conversation(
                    "M01_Locke_3CivsDead_Conversation", 100, 1000, false);
                            Commands->Join_Conversation( nullptr, barnfailed_conv, false, false );
                    ...
                    if (barn_objective_failed != true) {
                        // Commands->Set_Objective_Status( M01_BARN_ROUNDUP_OBJECTIVE_JGD,
                        // OBJECTIVE_STATUS_ACCOMPLISHED );

                        // barnfailed_conv = Commands->Create_Conversation(
                        // "M01_AirDrop_Conversation", 100, 1000, false);
                        // Commands->Join_Conversation( nullptr, barnfailed_conv, false, false );
                        // Commands->Start_Conversation( barnfailed_conv,  barnfailed_conv );
            ...
            case M01_TURRET_BEACH_ENGINEER_IS_DEAD_JDG: {
                GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
                GameObject* turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
                if ((turret01 != nullptr) || (turret02 != nullptr)) {
                    Commands->Create_Sound("M01EVAG_DSGN0268I1EVAG_SND", Vector3(0, 0, 0),
                                           obj); // enemy aircraft detected
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-93.689f, 52.850f, -1.95f));
                    Commands->Set_Facing(chinook_obj1, 60.0f);
                    Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                            "X1I_Nod_TurretBeach_TroopDrop.txt");
                }
            } break;

            case M01_CUE_BILLYS_CONVERSATION_JDG: {
                GameObject* barnPrisoner02 = Commands->Find_Object(M01_BARN_PRISONER_02_ID);
                if (barnPrisoner02 != nullptr && barn_prisoner_02_is_dead != true) // this is billy
                {
                    billy_conv
                        = Commands->Create_Conversation("M01_Billys_Conversation", 100, 1000, true);
                    Commands->Join_Conversation(barnPrisoner02, billy_conv, true, true);
                    Commands->Join_Conversation(STAR, billy_conv, false, true, true);
                    Commands->Join_Conversation(nullptr, billy_conv, false, false);
            ...
            case M01_CUE_BABUSHKA_CONVERSATION_JDG: {
                GameObject* barnPrisoner01 = Commands->Find_Object(M01_BARN_PRISONER_01_ID);
                GameObject* barnPrisoner03 = Commands->Find_Object(M01_BARN_PRISONER_03_ID);
                if (barnPrisoner01 != nullptr && barn_prisoner_01_is_dead != true) // this is babushka
                {
                    babushka_conv = Commands->Create_Conversation("M01_Barn_Babushka_Conversation",
                                                                  100, 1000, true);
                    ...
                    Commands->Join_Conversation(nullptr, babushka_conv, false, false, false);
                    ...
                    if (barnPrisoner03 != nullptr
                        && barn_prisoner_03_is_dead != true) // this is babushka
                    {
                        Commands->Send_Custom_Event(obj, barnPrisoner03, 0,
                                                    M01_MODIFY_YOUR_ACTION_11_JDG, 0);
                    }
                }

                else if (barnPrisoner03 != nullptr
                         && barn_prisoner_03_is_dead != true) // this is babushka
                {
                    civ3_conv
                        = Commands->Create_Conversation("M01_Civ03_Conversation", 100, 1000, true);
                    ...
                    Commands->Join_Conversation(nullptr, civ3_conv, false, true, true);
            ...
            case M01_CIVILIAN_KILLED_JDG: {
                ...
                else if (sender == Commands->Find_Object ( M01_BARN_PRISONER_03_ID ))//this is
                pierre
                {
                ...
                if (dead_barn_prisoner_tally > 2)
                {
                        ...
                        Commands->Send_Custom_Event( obj, obj, 0,
                M01_END_BARN_ROUNDUP_OBJECTIVE_JDG, 0 );
                }*/
            } break;

            case M01_KILL_THE_GDI_POWER_PLANT_JDG: {
                Commands->Debug_Message(
                    "***************************Starting the GDI base encounter\n");
            ...
            case M01_DO_DAMAGE_CHECK_JDG: // a building has been damaged--take appropriate action
            {
                if (sender
                    == Commands->Find_Object(
                        M01_HAND_OF_NOD_JDG)) // hand of nod under attack--refinery okay--send
                                              // engineer
                {
                    GameObject* honEngineer = Commands->Find_Object(M01_HON_REPAIR_ENGINEER_ID);
                    if (honEngineer != nullptr) {
                        Commands->Send_Custom_Event(obj, honEngineer, 0,
                    ...
                    if (commEngineer != nullptr) {
                        Commands->Send_Custom_Event(obj, commEngineer, 0,
                                                    M01_PLAYER_IS_ATTACKING_ME_JDG, 0);
                    }
                }
            } break;

            case M01_CUE_KANE_AND_NUMBER2_CONVERSATION_JDG: // player is in comm center--cue kane
                                                            // encounter
            {
                GameObject* holograph = Commands->Find_Object(157978);
                if (holograph != nullptr) {
                    GameObject* kane = Commands->Create_Object_At_Bone(
                        holograph, "Nod_Kane_HologramHead", "KANEBONE");
                    ...
                    GameObject* commBaseCommander
                        = Commands->Find_Object(M01_COMMCENTER_BASE_COMMANDER_JDG);
                    if (commBaseCommander != nullptr) {
                        kane_and_no2_conv01_active = true;

                        kane_and_no2_conv01 = Commands->Create_Conversation(
                            "M01_Kane_and_Number02_Conversation_01", 100, 1000, true);
                        Commands->Join_Conversation(kane, kane_and_no2_conv01, false, true);
                        Commands->Join_Conversation(commBaseCommander, kane_and_no2_conv01, false,
                                                    true);
            ...
            case M01_CUE_KANE_AND_HAVOC_CONVERSATION_JDG: // player is in comm center war room--cue
                                                          // kane encounter
            {
                ...
                if (kane_and_havoc_conv_active == false) {
                    ...
                    if (kane != nullptr) {
                        ...
                        kane_and_havoc_conv = Commands->Create_Conversation(
                            "M01_Kane_and_Havoc_Conversation", 100, 1000, false);
            ...
            case M01_SEND_BARN_CHINOOK_JDG: // havoc is in barn area--send reinforcements
            {
                Commands->Create_Sound("M01EVAG_DSGN0268I1EVAG_SND", Vector3(0, 0, 0),
                                       obj); // enemy aircraft detected
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-87.561f, 114.225f, 1.874f));
            ...
            case M01_SEND_GUARD_TOWER_CHINOOK_JDG: // havoc is at GDI guard tower
            {
                ...
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(12.703f, 84.163f, 1.898f));
                Commands->Set_Facing(chinook_obj1, -130.0f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X1I_EasyNodChinook01.txt");
            } break;

            case M01_SEND_TAILGUN_CHINOOK_JDG: // havoc is in tailgun area--send
                                               // reinforcementsM01_SEND_CHURCH_CHINOOK_JDG
            {
                Commands->Create_Sound("M01EVAG_DSGN0268I1EVAG_SND", Vector3(0, 0, 0),
                                       obj); // enemy aircraft detected
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-7.831f, 292.034f, 2.665f));
                Commands->Set_Facing(chinook_obj1, 0.0f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X1I_EasyNodChinook01.txt");
            } break;
            ...
            case M01_SEND_CHURCH_CHINOOK_JDG: // havoc is in church area--send reinforcements
            {
                Commands->Create_Sound("M01EVAG_DSGN0268I1EVAG_SND", Vector3(0, 0, 0),
                                       obj); // enemy aircraft detected
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-91.898f, 424.178f, 20.761f));
                Commands->Set_Facing(chinook_obj1, 0.0f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X1I_EasyNodChinook.txt");
            } break;

            case M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG: // havoc has found one of the barn
                                                             // civs--send in the chinook
            {
                GameObject* barnEvacController
                    = Commands->Find_Object(M01_BARNAREA_EVAC_MONITOR_JDG);
                if (barnEvacController != nullptr) {
                    Commands->Send_Custom_Event(obj, barnEvacController, 0,
                                                M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG, 0);
                }
            } break;
            }
        }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            if (action_id == billy_conv) {
                Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG,
                                            0);
            }
                ...
                {
                    Commands->Send_Custom_Event(obj, barnPrisoner01, 0,
                                                M01_MODIFY_YOUR_ACTION_05_JDG, 0);
                } // int
            }
            ...
            //{
            // GameObject * chinook_obj1 = Commands->Create_Object ( "Invisible_Object",
            // Vector3(-96.744f, 138.498f, 1)); Commands->Set_Facing(chinook_obj1, 60.0f);
            // Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "XG_M01_HumveeDrop.txt");
            //}

            else if (action_id == barnfailed_conv) {
                // int honAlerted_conv = Commands->Create_Conversation(
                // "M01_HandOfNod_Alerted_Conversation", 100, 1000, false);
                // Commands->Join_Conversation( nullptr, honAlerted_conv, false, false );
                ...
                GameObject* securityCamera
                    = Commands->Find_Object(M01_COMMCENTER_CEILING_CAMERA_JDG);
                if (securityCamera != nullptr) {
                    Commands->Send_Custom_Event(obj, securityCamera, 0, M01_START_ATTACKING_01_JDG,
                                                0);
                }
            }
            ...
            else if (action_id == unlocked_gate_conv) //
            {
                ...
                Commands->Add_Objective(M01_OPEN_THE_GATE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M01_03,
                                        nullptr, IDS_Enc_Obj_Primary_M01_03);
                Commands->Set_Objective_Radar_Blip(M01_OPEN_THE_GATE_JDG, radarMarker);
                Commands->Set_Objective_HUD_Info_Position(
                    M01_OPEN_THE_GATE_JDG, 95, "POG_M01_1_03.tga", IDS_POG_OPEN, radarMarker);

                // Vector3 green (0,1,0);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Primary_M01_03,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
...
DECLARE_SCRIPT(M01_Hand_of_Nod_Building_Script_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG), 0,
                                    M01_HON_HAS_BEEN_DESTROYED_JDG, 0);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(103371), 0,
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (obj) {
            ...
            if (myEngineer != nullptr) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_DO_DAMAGE_CHECK_JDG, 0);
...
DECLARE_SCRIPT(M01_Ambient_Sound_Controller_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if ((param == M01_TURN_ON_OUTSIDE_AMBIENTS_JDG) && (outside_ambients_playing == false)) {
            ...
            if (building_ambients_playing == true /*&& building_sound != nullptr*/) {
        ...
        else if ((param == M01_TURN_OFF_OUTSIDE_AMBIENTS_JDG)
                 && (outside_ambients_playing == true)) {
            outside_ambients_playing = false;
        }
        ...
        else if ((param == M01_HON_HAS_BEEN_DESTROYED_JDG)) // Hand of Nod has been destroyed
        {
            hand_of_nod_state = DESTROYED;
                  ...
                  == M01_COMM_CENTER_HAS_BEEN_DESTROYED_JDG)) // Comm Center has been destroyed
        {
            comm_center_state = DESTROYED;
        }
            ...
            if ((comm_center_state == ACTIVE) && (building_ambients_playing != true)) {
                Commands->Debug_Message(
                    "**********************turning on active Comm Center ambient noise\n");
            ...
            if ((hand_of_nod_state == ACTIVE) && (building_ambients_playing != true)) {
                building_ambients_playing = true;
                 ...
                 && (comm_center_state != DESTROYED)) {
            char* klaxonNames[2] = { "Klaxon Warning", "Klaxon Info" };
            ...
            if (star != nullptr) {
                ...
                Commands->Send_Custom_Event(obj, obj, 0, play_commcenter_sound, 1.5);
                 ...
                 && (comm_center_state != DESTROYED)) {
            char* sounds[15] = { "01-I022E", "01-I028E", "01-I030E", "01-I032E", "01-I034E",
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (firstEntry == true) {
                ...
                GameObject* barnSpawnerController
                    = Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG);
                if (barnSpawnerController != nullptr) {
                    Commands->Send_Custom_Event(obj, barnSpawnerController, 0,
...
{ void Damaged(GameObject * obj, GameObject* damager, float amount) { if (damager == (STAR)) {
    if (obj) { Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    else if ((param == M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG)) // Your building has been
                                                                  // destroyed--evacuate
    {
        if (obj) {
            Commands->Innate_Enable(obj);
...
void Action_Complete(GameObject* obj, int action_id, ActionCompleteReason complete_reason)
{
    ...
    else if (action_id == M01_FACING_SPECIFIED_DIRECTION_01_JDG
             && complete_reason == ACTION_COMPLETE_NORMAL) {
...
DECLARE_SCRIPT(M01_Church_LoveShack_MiniGunner_JDG,
               "") // M01_CHURCH_LOVESHACK_MINIGUNNER_ID		101305
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
void Action_Complete(GameObject* obj, int action_id, ActionCompleteReason complete_reason)
{
    ...
    if (action_id == M01_WALKING_WAYPATH_01_JDG
        && complete_reason
            == ACTION_COMPLETE_NORMAL) // minigunner is at animation point--choose and do animation
    {
        ...
        Commands->Action_Play_Animation(obj, params);
             ...
             && complete_reason
                 == ACTION_COMPLETE_NORMAL) // minigunner is done with animation--keep moving
    {
        params.Set_Basic(this, 45, M01_WALKING_WAYPATH_02_JDG);
        params.Set_Movement(Vector3(0, 0, 0), WALK, .25f);
        ...
        Commands->Action_Goto(obj, params);
             ...
             && complete_reason == ACTION_COMPLETE_NORMAL) // minigunner is at animation
                                                           // point--choose and do animation
    {
        char* animationName = M01_Choose_Idle_Animation();
...
DECLARE_SCRIPT(M01_Announce_Barn_Objective_Zone,
               "") { void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { // Commands->Send_Custom_Event( obj, Commands->Find_Object (
                           // M01_MISSION_CONTROLLER_JDG ), 0, M01_START_BARN_OBJECTIVE_JDG, 0 );
                           Commands->Destroy_Object(obj); // this is a 1-time only zone--cleaning up
}
}
}
...
if (Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG),
                                0, M01_QUIT_SPAWNING_PLEASE_JDG, 0);
}
...
if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG),
                                0, M01_SPAWNER_SPAWN_PLEASE_JDG, 0);
}
...
DECLARE_SCRIPT(M01_MiniGunner_Point_Guard_JDG, "") {
    ...
    void Enemy_Seen( GameObject * obj, GameObject * enemy )
    {
            ...
            {
                    Commands->Set_Innate_Soldier_Home_Location ( obj, myPosition,
    M01_EASY_DIFFICULTY_HOMERANGE_JDG ); Commands->Set_Innate_Aggressiveness ( obj,
    M01_EASY_DIFFICULTY_AGGRESSION_JDG ); Commands->Set_Innate_Take_Cover_Probability ( obj,
    M01_EASY_DIFFICULTY_TAKECOVER_JDG );
            }

            else if (current_difficulty == medium)
            {
                    Commands->Set_Innate_Soldier_Home_Location ( obj, myPosition,
    M01_MEDIUM_DIFFICULTY_HOMERANGE_JDG ); Commands->Set_Innate_Aggressiveness ( obj,
    M01_MEDIUM_DIFFICULTY_AGGRESSION_JDG ); Commands->Set_Innate_Take_Cover_Probability ( obj,
    M01_MEDIUM_DIFFICULTY_TAKECOVER_JDG );
            }

            else if (current_difficulty == hard)
            {
                    Commands->Set_Innate_Soldier_Home_Location ( obj, myPosition,
    M01_HARD_DIFFICULTY_HOMERANGE_JDG ); Commands->Set_Innate_Aggressiveness ( obj,
    M01_HARD_DIFFICULTY_AGGRESSION_JDG ); Commands->Set_Innate_Take_Cover_Probability ( obj,
    M01_HARD_DIFFICULTY_TAKECOVER_JDG );
            }
    }*/
};
...
Commands->Send_Custom_Event(obj, Commands->Find_Object(101207), 0, M01_SPAWN_WHACK_A_MOLE_GUY_JDG,
                            0);
Commands->Destroy_Object(obj);
}
}
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { if (Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID),
                                    0, M01_PLAYER_ENTERING_LEFT_INTEROG_ROOM_JDG, 0);
}

if (Commands->Find_Object(101354)) {
    Commands->Destroy_Object(
        Commands->Find_Object(101354)); // cleaning up the 2 interogation room zones
}
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { if (Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID),
                                    0, M01_PLAYER_ENTERING_RIGHT_INTEROG_ROOM_JDG, 0);
}
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        else if ((param == M01_CUE_BILLYS_CONVERSATION_JDG)) // see if billy and havoc are present
        {
            if (playerEntered == true && okay_to_play_conversation == true) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CUE_BILLYS_CONVERSATION_JDG, 0);
                GameObject* babushkaZone = Commands->Find_Object(101662);
                GameObject* billyZone = Commands->Find_Object(101661);

                if (babushkaZone != nullptr) {
                    Commands->Destroy_Object(
                        babushkaZone); // this is one-time only zone--cleaning up
                }

                if (billyZone != nullptr) {
...
DECLARE_SCRIPT(M01_Tank_Entering_Tunnel_Zone_JDG, "") // this guys ID is
{
    ...
    {
        /*GameObject * lightTank = Commands->Find_Object ( M01_TAILGUNAREA_NOD_LIGHTTANK_JDG );
        if (lightTank != nullptr && enterer == lightTank)
        {
        ...
        if (enterer == Commands->Find_Object(gdi_medium_tank)) {
            if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_01_ID)) {
                Commands->Send_Custom_Event(obj,
                                            Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_01_ID),
                                            0, M01_MEDIUM_TANK_IS_HERE_JDG, 0);
            }

            if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_02_ID)) {
                Commands->Send_Custom_Event(obj,
                                            Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_02_ID),
                                            0, M01_MEDIUM_TANK_IS_HERE_JDG, 0);
            }

            if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_03_ID)) {
                Commands->Send_Custom_Event(obj,
                                            Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_03_ID),
                                            0, M01_MEDIUM_TANK_IS_HERE_JDG, 0);
            }
...
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    int tankWarning
    = Commands->Create_Conversation("M01_Announce_LightTank_Conversation", 100, 1000, false);
Commands->Join_Conversation(nullptr, tankWarning, false, false);
Commands->Join_Conversation(nullptr, tankWarning, false, false);
...
if (Commands->Find_Object(M01_TAILGUN_01_ID)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TAILGUN_01_ID), 0,
                                M01_START_ACTING_JDG, 0);
}

if (Commands->Find_Object(M01_TAILGUN_02_ID)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TAILGUN_02_ID), 0,
                                M01_START_ACTING_JDG, 0);
}

if (Commands->Find_Object(M01_TAILGUN_03_ID)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TAILGUN_03_ID), 0,
                                M01_START_ACTING_JDG, 0);
}
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { if (Commands->Find_Object(M01_MISSION_CONTROLLER_JDG)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_PLAYER_IS_APPROACHING_TAILGUN_ALLEY_JDG, 0);
}
...
{ void Custom(GameObject * obj, int type, int param,
              GameObject* sender) { ActionParamsStruct params;
...
if (Commands->Find_Object(M01_COMMCENTER_BASE_SCAPEGOAT_JDG)) {
    Vector3 myGotoSpot
        = Commands->Get_Position(Commands->Find_Object(M01_COMMCENTER_BASE_SCAPEGOAT_JDG));
...
DECLARE_SCRIPT(M01_Comm_Base_Commander_JDG,
               "") // this guys ID is M01_COMMCENTER_BASE_COMMANDER_JDG 101936
{
    bool enemyEngaged;
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (damager == STAR && enemyEngaged == false) {
            ...
            Commands->Enable_Hibernation(obj, true);
            // Commands->Send_Custom_Event( obj, Commands->Find_Object ( M01_MISSION_CONTROLLER_JDG
            // ), 0, M01_CUE_KANE_AND_HAVOC_CONVERSATION_JDG, 0 );
        }
    }
...
/*DECLARE_SCRIPT(M01_Comm_Base_Scapegoat_JDG, "")//this guys ID is M01_COMMCENTER_BASE_SCAPEGOAT_JDG
101938
{
        void Created( GameObject * obj )
        {
...
DECLARE_SCRIPT(M01_Comm_Ceiling_Camera_JDG, "")//this guys ID is M01_COMMCENTER_CEILING_CAMERA_JDG
101937
{
        void Created( GameObject * obj )
        {
                ...
                params.Set_Attack( Commands->Find_Object (M01_COMMCENTER_BASE_SCAPEGOAT_JDG), 0, 0,
true ); Commands->Action_Attack( obj, params );
        }
        ...
        void Custom( GameObject * obj, int type, int param, GameObject * sender )
        {
                ...
                switch (param)
                {
                        case M01_START_ATTACKING_01_JDG: //kane has told you to kill the scapegoat
                                {
                                        if (Commands->Find_Object
(M01_COMMCENTER_BASE_SCAPEGOAT_JDG))
                                        {
                                                params.Set_Basic(this, 100,
M01_START_ATTACKING_01_JDG); params.Set_Attack( Commands->Find_Object
...
DECLARE_SCRIPT(M01_Comm_ComputerRoom_Tech_JDG,
               "") // this guys ID is M01_COMMCENTER_COMPUTERROOM_TECH_JDG 101172
{
    Vector3 myLocation;
...
DECLARE_SCRIPT(M01_Comm_Upstairs_Guard_JDG,
               "") // this guys ID is M01_COMMCENTER_UPSTAIRS_GUARD_JDG 101946
{ void Created(GameObject * obj) { Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M01_GDI_Base_Spawner_Controller_JDG,
               "") // this guys ID is M01_GDIBASE_SPAWNER_CONTROLLER_JDG
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case M01_SPAWNER_IS_DEAD_JDG: {
            ...
            Commands->Debug_Message("***************************GDI Base spawner has recieved "
                                    "custom that someone is dead\n");
        } break;
        ...
        case M01_SPAWNER_SPAWN_PLEASE_JDG: {
            ...
            if (currentDifficulty == easy) {
                if (active_unit_count == 0) {
                    ...
                    active_unit_count++;
                    Commands->Debug_Message(
                        "***************************GDI Base spawner has spawned an easy guy\n");
                }
            }
                ...
                if (active_unit_count < 2) {
                    ...
                    Commands->Debug_Message(
                        "***************************GDI Base spawner has spawned a medium guy\n");
                }
            }
                ...
                if (active_unit_count < 3) {
                    ...
                    Commands->Debug_Message(
                        "***************************GDI Base spawner has spawned a hard guy\n");
                }
            }
...
DECLARE_SCRIPT(M01_GDI_Base_Spawner_Guy_JDG,
               "") { void Killed(GameObject * obj, GameObject* killer) {
    if (Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG)) { Commands->Debug_Message(
        "***************************GDI Base/barn area spawner has been killed--sending custom\n");
Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG), 0,
...
DECLARE_SCRIPT(M01_Tailgun_Run_Spawner_Controller_JDG,
               "") // this guys ID is M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG
{
    int active_unit_count;
    bool startup;
...
{ void Killed(GameObject * obj, GameObject* killer) {
    if (Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG)) { Commands->Debug_Message(
        "***************************taigun run area spawner has been killed--sending custom\n");
...
DECLARE_SCRIPT(M01_ChurchArea_Spawner_Controller_JDG,
               "") // this guys ID is M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG
{
    int active_unit_count;
    bool startup;
...
DECLARE_SCRIPT(M01_ChurchArea_Spawner_Guy_JDG,
               "") { void Killed(GameObject * obj, GameObject* killer) {
    if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)) { Commands->Debug_Message(
        "***************************church area spawner has been killed--sending custom\n");
...
DECLARE_SCRIPT(M01_Turn_on_the_Hand_of_Nod_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (
    enterer == STAR) { if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG),
                                0, M01_QUIT_SPAWNING_PLEASE_JDG, 0);
}
...
if (Commands->Find_Object(M01_MISSION_CONTROLLER_JDG)) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_HON_SPAWNS_MINIGUNNER_JDG, 0);
}
        ...
        void Damaged( GameObject * obj, GameObject * damager, float amount )
        {
                if (obj)
                {
                        if (damager == STAR && deadYet == false && firstTimeDamaged == true)
                        {
                                Vector3 myPosition = Commands->Get_Position ( obj );
                                Vector3 playerPosition = Commands->Get_Position ( STAR );
                                float playerDistance = Commands->Get_Distance ( myPosition,
playerPosition );
        ...
        void Custom( GameObject * obj, int type, int param, GameObject * sender )
        {
                if (type == 0)
                {
                        switch (param)
                        {
                                case M01_START_ACTING_JDG: //set timer--then call in next
reinforcements
                                        {
                                                Commands->Send_Custom_Event( obj, obj, 0,
M01_MODIFY_YOUR_ACTION_JDG, 0 ); Commands->Send_Custom_Event( obj, obj, 0,
M01_CALL_IN_REINFORCEMENTS_JDG, 0 );
                                        }
                                        break;

                                case M01_MODIFY_YOUR_ACTION_JDG://here comes player start calling in
reinforcements
                                        {
                                                if (obj)
                                                {
                                                        int currentDifficulty =
Commands->Get_Difficulty_Level( ); int medium = 1; int hard = 2; float delayTimer;
                                                        ...
                                                        Commands->Send_Custom_Event( obj, obj, 0,
M01_SEND_BARN_CHINOOK_JDG, delayTimer ); Commands->Send_Custom_Event( obj, obj, 0,
M01_MODIFY_YOUR_ACTION_JDG, delayTimer );
                                                }
                                        }
                                        break;

                                case M01_SEND_BARN_CHINOOK_JDG: //here comes player start calling in
reinforcements
                                        {
                                                if (obj)
                                                {
                                                        Commands->Send_Custom_Event( obj,
Commands->Find_Object ( M01_MISSION_CONTROLLER_JDG ), 0, M01_SEND_BARN_CHINOOK_JDG, 0 );
                                                }
                                        }
                                        break;

                                case M01_CALL_IN_REINFORCEMENTS_JDG: //here comes player start
calling in reinforcements
                                        {
                                                if (obj && deadYet == false)
                                                {
                                                        GameObject * nodCommanderDialogController =
Commands->Find_Object ( 103398 ); if (nodCommanderDialogController != nullptr)
                                                        {
                                                                Commands->Send_Custom_Event( obj,
nodCommanderDialogController, 0, M01_MODIFY_YOUR_ACTION_JDG, 0 );
                                                        }
                                                        float delayTimer = Commands->Get_Random (
15, 30 ); Commands->Send_Custom_Event( obj, obj, 0, M01_CALL_IN_REINFORCEMENTS_JDG, delayTimer );
                                                }
                                        }
                                        break;
                        }
...
DECLARE_SCRIPT(M01_TailgunRun_NOD_Commander_JDG,
               "") // this guys ID is M01_TAILGUNAREA_NOD_COMMANDER_JDG 102358
{
    bool deadYet;
    bool firstTimeDamaged;
    bool playerSeen;
        ...
        if (type == 0) {
            ...
            case M01_MODIFY_YOUR_ACTION_JDG: // here comes player start calling in reinforcements
            {
                if (obj) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_TAILGUN_CHINOOK_JDG,
                                                delayTimer);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
            } break;
            ...
            case M01_SEND_TAILGUN_CHINOOK_JDG: // here comes player start calling in reinforcements
            {
                if (obj) {
                    Commands->Send_Custom_Event(obj,
                                                Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                                0, M01_SEND_TAILGUN_CHINOOK_JDG, 0);
                }
            } break;

            case M01_CALL_IN_REINFORCEMENTS_JDG: // here comes player start calling in
                                                 // reinforcements
            {
                if (obj && deadYet == false) {
                    GameObject* nodCommanderDialogController = Commands->Find_Object(103398);
                    if (nodCommanderDialogController != nullptr) {
                        Commands->Send_Custom_Event(obj, nodCommanderDialogController, 0,
                                                    M01_MODIFY_YOUR_ACTION_JDG, 0);
                    }
                    float delayTimer = Commands->Get_Random(15, 30);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_CALL_IN_REINFORCEMENTS_JDG,
                                                delayTimer);
                }
            } break;
            }
...
DECLARE_SCRIPT(M01_ChurchArea_NOD_Commander_JDG,
               "") // M01_CHURCHAREA_NOD_COMMANDER_JDG		102357
{
    bool deadYet;
    bool firstTimeDamaged;
    bool playerSeen;
        ...
        if (type == 0) {
            ...
            case M01_MODIFY_YOUR_ACTION_JDG: // here comes player start calling in reinforcements
            {
                if (obj) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_CHURCH_CHINOOK_JDG,
                                                delayTimer);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
            ...
            case M01_SEND_CHURCH_CHINOOK_JDG: // here comes player start calling in reinforcements
            {
                if (obj) {
                    Commands->Send_Custom_Event(obj,
                                                Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                                0, M01_SEND_CHURCH_CHINOOK_JDG, 0);
                }
            } break;
...
DECLARE_SCRIPT(M01_GDI_Base_Artillery_Controller_JDG,
               "") // M01_GDIBASE_ARTILLERY_CONTROLLER_ID	102294
{
    Vector3 locs[35];
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case M01_PICK_A_NEW_LOCATION_JDG: {
            if (command_clearance == true) {
                ...
                bomb_sound
                    = Commands->Create_Sound("Bomb_Falling_Sound_Twiddler", sound_location, obj);
        ...
        case M01_GOTO_IDLE_JDG: {
            ...
            if (sender
                == Commands->Find_Object(
                    M01_BARNAREA_NOD_COMMANDER_JDG)) // your "commander" is dead--destroy yourself
            {
                Commands->Destroy_Object(obj);
            }
        } break;
...
DECLARE_SCRIPT(M01_Nod_GuardTower_01_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-148.379f, 342.954f, 9.656f));
Commands->Attach_Script(sniperTarget01, "M01_GuardTower_Sniper_Target_JDG",
                        "-157.390 363.504 10.695, 148.379 342.954 9.656");

GameObject* sniperTarget02
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-149.930f, 338.900f, 9.170f));
Commands->Attach_Script(sniperTarget02, "M01_GuardTower_Sniper_Target_JDG",
                        "-158.760 357.590 10.695, -149.930 338.900 9.170");

GameObject* sniperTarget03
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-146.812f, 339.745f, 9.345f));
...
DECLARE_SCRIPT(M01_Nod_GuardTower_02_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-153.944f, 602.434f, 4.226f));
Commands->Attach_Script(sniperTarget01, "M01_GuardTower_Sniper_Target_JDG",
                        "-141.665 573.039 4.409, -153.944 602.434 4.226");

GameObject* sniperTarget02
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-156.672f, 605.082f, 4.163f));
Commands->Attach_Script(sniperTarget02, "M01_GuardTower_Sniper_Target_JDG",
                        "-138.653 576.128 4.889, -156.672 605.082 4.163");

GameObject* sniperTarget03
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-160.792f, 606.559f, 4.075f));
Commands->Attach_Script(sniperTarget03, "M01_GuardTower_Sniper_Target_JDG",
...
DECLARE_SCRIPT(M01_Nod_GuardTower_03_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-254.164f, 564.968f, 30.630f));
Commands->Attach_Script(sniperTarget01, "M01_GuardTower_Sniper_Target_JDG",
                        "-221.487 556.431 25.927, -254.164 564.968 30.630");

GameObject* sniperTarget02
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-253.935f, 561.105f, 30.922f));
Commands->Attach_Script(sniperTarget02, "M01_GuardTower_Sniper_Target_JDG",
                        "-221.169 561.729 25.662, -253.935 561.105 30.922");

GameObject* sniperTarget03
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-257.185f, 562.242f, 30.540f));
Commands->Attach_Script(sniperTarget03, "M01_GuardTower_Sniper_Target_JDG",
                        "-225.770 558.924 26.635, -257.185 562.242 30.540");

GameObject* controller1
    = Commands->Create_Object("Invisible_Object", Vector3(-200.897f, 533.210f, 19.5f));
...
DECLARE_SCRIPT(M01_GuardTower_Sniper_Target_JDG, "wave_location:vector3,  delete_location:vector3")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        // GameObject *spawn_effect = Commands->Create_Object( "Spawner Created Special Effect",
        // powerupSpawnLocation );

        // if (spawn_effect)
        //{
        //	Commands->Attach_Script( spawn_effect, "M00_Create_Anim_Effect_DAY",
        //"C4_EX1A.C4_EX1A");
        // }
...
DECLARE_SCRIPT(M01_Gunboat_Spawn_Hovercraft_Zone_JDG, "") // this guys id is 102500
{
    ...
    M01_MISSION_CONTROLLER_JDG ), 0, M01_SPAWN_THE_MEDIUM_TANK_JDG, 0 );
                    }
            }
    }*/
};
...
DECLARE_SCRIPT(M01_HarvesterScript_New_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                if (deadYet == false) {
                    int lockeHarvester = Commands->Create_Conversation(
                        "M01_Add_Harvester_Objective", 100, 1000, true);
                    Commands->Join_Conversation(nullptr, lockeHarvester, false, false);
...
if (chemGuy01 != nullptr) {
    if (chemGuy02 != nullptr) {
        if (chemGuy03 != nullptr) {
            int tibFieldConv
                = Commands->Create_Conversation("M01_TiberiumField_Conversation", 80, 25, true);
...
DECLARE_SCRIPT(M01_Barn_Babushkas_Conversation_Zone_JDG, "") // this guys ID is 101662
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if ((param == M01_START_ACTING_JDG)) // babushka is in position--give okay for conversation
        {
            ...
            if (playerEntered == true && okay_to_play_conversation == true) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CUE_BABUSHKA_CONVERSATION_JDG, 0);
    ...
    if (obj) {
        if (damager == STAR) {
            ...
            if (Commands->Find_Object(101658)) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(101658), 0,
            ...
            if (damager == STAR) {
                if (obj && retreating == false) {
                    if (Commands->Get_Health(obj) > 0) {
                        ...
                        // ActionParamsStruct params;
                        // params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
                        // params.Set_Movement( Commands->Find_Object ( M01_BARN_PRISONER_01_ID ),
                        // 1, 5 ); params.Set_Attack( STAR, 50, 0, true ); Commands->Action_Attack (
                        // obj, params );
                        retreating = true;
                    }
                }
...
DECLARE_SCRIPT(M01_BarnArea_AI_ExitZone_JDG, "") // 112015 -- tunnel 112016 -- shack
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (hovercraftGuy != nullptr && enterer == hovercraftGuy) {
...
DECLARE_SCRIPT(M01_TurretBeach_GDI_Guy_01_JDG, "") //
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id == M01_HUNT_THE_PLAYER_JDG) {
            turretbeach_conv = Commands->Create_Conversation(
                "M01_TurretBeach_TurnOverTank_Conversation", 100, 50, true);
...
DECLARE_SCRIPT(M01_DetentionPen_CivDeathMonitor, "")
{
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (obj && damagedYet == false) {
            damagedYet = true;
            Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0512I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
        }
    }
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(103380), 0, M01_CIVILIAN_KILLED_JDG,
                                    0);
    }
...
DECLARE_SCRIPT(M01_DetentionPen_Evac_Controller01_JDG, "") // 103380
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_START_ACTING_JDG) // prisoner have been freed--call in air evac
        {
            ...
            if ((civGuy01 != nullptr) || (civGuy02 != nullptr) || (civGuy03 != nullptr)) {
                // Vector3 evacPosition = Commands->Get_Position ( obj );
                // GameObject *controller = Commands->Create_Object("Invisible_Object",
                // evacPosition); Commands->Attach_Script(controller, "Test_Cinematic",
                // "XG_M01_Detention_EvacAnim.txt");
            }
        }
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Waypath_JDG,
               "") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "XG_TransprtBone.XG_EV1_PathA")
        == 0) { Commands->Set_Animation(obj, "XG_TransprtBone.XG_EV1_Pathloop", true);
}
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_DO_END_MISSION_CHECK_JDG: {
        ...
        if ((GDIGuy01 != nullptr) || (GDIGuy02 != nullptr) || (GDIGuy03 != nullptr)) {
            Commands->Send_Custom_Event(obj, obj, 0, M01_DO_END_MISSION_CHECK_JDG, 2);
        }
...
{ void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "s_a_human.h_a_troopdrop") == 0) { Vector3 offset;
...
void Timer_Expired(GameObject* obj, int timer_id)
{
    if (timer_id == M01_GOTO_IDLE_JDG) {
        ...
        if (distanceFromStar >= 80) {
            ...
            if (visible != true) {
                Commands->Apply_Damage(obj, 100000, "BlamoKiller", nullptr);
            }
...
DECLARE_SCRIPT(M01_HON_Chinook_Spawned_Soldier_04_GDI_JDG, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        if (action_id == M01_WALKING_WAYPATH_01_JDG) {
            GameObject* buggyController = Commands->Find_Object(103367);
            if (buggyController != nullptr) {
                Commands->Send_Custom_Event(obj, buggyController, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                            0);
            }
        }
    }
...
DECLARE_SCRIPT(M01_BuggyNew_Controller_JDG, "") // this guys id is 103367
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_START_ACTING_JDG) {
            ...
            GameObject* buggy = Commands->Find_Object(buggy_id);
            if (buggy != nullptr) {
                Commands->Send_Custom_Event(obj, buggy, M01_MODIFY_YOUR_ACTION_02_JDG,
                                            minigunner01_id, 0);
            ...
            GameObject* buggy = Commands->Find_Object(buggy_id);
            if (buggy != nullptr) {
                Commands->Send_Custom_Event(obj, buggy, M01_MODIFY_YOUR_ACTION_03_JDG,
                                            minigunner02_id, 0);
                Commands->Send_Custom_Event(obj, sender, M01_MODIFY_YOUR_ACTION_JDG, buggy_id, 0);
            }
        }
...
DECLARE_SCRIPT(M01_Priest_Conversation_Zone_JDG,
               "") // this guys ID is 103395  M01_PriestReminder_Conversation
{
    bool okay_to_play_conversation;
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (okay_to_play_conversation == true) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CUE_PRIEST_CONVERSATION_JDG, 0);
                Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
            }
        }
    }
...
DECLARE_SCRIPT(M01_Loveshack_Nun_Conversation_Zone_JDG, "") // this guys ID is 101368
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (okay_to_play_conversation == true) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CUE_LOVESHACK_NUN_CONVERSATION_JDG, 0);
                Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
            }
        }
    }
...
DECLARE_SCRIPT(M01_Interior_Nun_Conversation_Zone_JDG, "") // this guys ID is #101370
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            if (okay_to_play_conversation == true) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CUE_INTERIOR_NUN_CONVERSATION_JDG, 0);
                Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
            }
        }
    }
...
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_CHURCH_GUARD_IS_DEAD_JDG, 0);

    GameObject* havocExitZone = Commands->Find_Object(103393);
    if (havocExitZone != nullptr) {
...
DECLARE_SCRIPT(M01_Church_Loveshack_InterrogationConv_Zone_JDG, "") // 103392
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && conversation_triggered == false) {
            ...
            if ((loveshackNun != nullptr) && (loveshackGuard != nullptr)) {
                int loveshackConv
                    = Commands->Create_Conversation("M01_Loveshack_Conversation_JDG", 90, 50, true);
...
DECLARE_SCRIPT(M01_GDI_Escort_Conversation_Controller_GDI, "") // 103396
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) // gdi escort has been poked to follow player
        {
            ...
            if (random == 0) {
                int pokeYesConv01
                    = Commands->Create_Conversation("M01_GDI_Escort_Yes01", 90, 50, true);
                ...
                int pokeYesConv01
                    = Commands->Create_Conversation("M01_GDI_Escort_Yes02", 90, 50, true);
                Commands->Join_Conversation(STAR, pokeYesConv01, false, false, false);
                Commands->Join_Conversation(sender, pokeYesConv01, false, false, false);
                Commands->Start_Conversation(pokeYesConv01, pokeYesConv01);
            }
                ...
                int pokeYesConv01
                    = Commands->Create_Conversation("M01_GDI_Escort_Yes03", 90, 50, true);
                Commands->Join_Conversation(STAR, pokeYesConv01, false, false, false);
                Commands->Join_Conversation(sender, pokeYesConv01, false, false, false);
                Commands->Start_Conversation(pokeYesConv01, pokeYesConv01);
            }
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // gdi escort has been poked to stop
                                                         // following player
        {
        }
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_03_JDG) // gdi escort has reached his escort limits
        {
            if (first_time_at_escort_limit == true) {
                ...
                int pokeLimitConv01
                    = Commands->Create_Conversation("M01_GDI_Escort_MustStayHere01", 90, 50, true);
                ...
                int pokeLimitConv01
                    = Commands->Create_Conversation("M01_GDI_Escort_MustStayHere02", 90, 50, true);
                Commands->Join_Conversation(sender, pokeLimitConv01, false, false, false);
                Commands->Join_Conversation(STAR, pokeLimitConv01, false, false, false);
                Commands->Start_Conversation(pokeLimitConv01, pokeLimitConv01);
            }
...
DECLARE_SCRIPT(M01_CHURCH_Chinook_Spawned_Soldier01_GDI, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id == M01_WALKING_WAYPATH_01_JDG) {
                if (obj && STAR) {
                    initialEscortConv = Commands->Create_Conversation(
                        "M01_FirstEscort_Conversation", 100, 50, true);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if ((param == M01_PICK_A_NEW_LOCATION_JDG) && (thisGuysState != ESCORTING)) {
            ...
            if (escortDialogController != nullptr) {
                Commands->Send_Custom_Event(obj, escortDialogController, 0,
                                            M01_MODIFY_YOUR_ACTION_JDG, 0);
            }
            ...
            if (escortDialogController != nullptr) {
                Commands->Send_Custom_Event(obj, escortDialogController, 0,
                                            M01_MODIFY_YOUR_ACTION_03_JDG, 0);
            }
            Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                        M01_PLAYERS_ESCORT_HAS_BEEN_KILLED_JDG, 0);
            thisGuysState = NOT_ESCORTING;
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        ...
        if (damager != nullptr) {
            ...
            if (attackersType != SCRIPT_PLAYERTYPE_NOD) { }
                ...
                if (thisGuysState == ESCORTING && damager != nullptr) {
                    params.Set_Basic(this, 100, M01_GOING_TO_HAVOC_JDG);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if ((param == M01_PICK_A_NEW_LOCATION_JDG) && (thisGuysState == NOT_ESCORTING)) {
            ...
            if (myTarget != nullptr) {
                ...
                Commands->Debug_Message("**********************Player's escort has received orders "
                                        "to attack havocs target\n");
            }
        }
    }
...
{ void Killed(GameObject * obj,
              GameObject* killer) { Vector3 myPosition = Commands->Get_Position(obj);
Commands->Create_Explosion("Explosion_Vehicle", myPosition, nullptr);
}
}
;
...
DECLARE_SCRIPT(M01_GDIBase_EvacMonitor_JDG, "") // M01_GDIBASE_EVAC_MONITOR_JDG
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == M01_GOING_TO_EVAC_SPOT_JDG) {
            ...
            if (unitsEvacuated == 4) {
                int airdrop_conv
                    = Commands->Create_Conversation("M01_AirDrop_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, airdrop_conv, false, false);
...
{ //
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (damager == STAR && destroyed == false) {
            destroyed = true;
            Commands->Set_Animation(obj, "DSP_PROJECTOR.DSP_PROJECTOR", false, nullptr, 0, 9);

            GameObject* propagandaController = Commands->Find_Object(103099);
            if (propagandaController != nullptr) {
                Commands->Send_Custom_Event(obj, propagandaController, 0, M01_IVE_BEEN_KILLED_JDG,
                                            0);
            }

            Vector3 myPosition = Commands->Get_Position(obj);
            Commands->Create_Explosion("Explosion_Barrel_Fuel", myPosition, nullptr);
        }
        ...
        if (type == 0) {
            ...
            //}
                ...
                char* propaganda_screen[10] = {
                    "M01_Propaganda_Screen_01", "M01_Propaganda_Screen_02",
                    "M01_Propaganda_Screen_03", "M01_Propaganda_Screen_04",
                    "M01_Propaganda_Screen_05", "M01_Propaganda_Screen_06",
                    "M01_Propaganda_Screen_07", "M01_Propaganda_Screen_08",
                    "M01_Propaganda_Screen_10", "M01_Propaganda_Screen_11",
                };

                char* propaganda_sound[10] = {
                    "M01NCXS_DSGN0270I1NCXS_SND", "M01NCXS_DSGN0271I1NCXS_SND",
                    "M01NCXS_DSGN0272I1NCXS_SND", "M01NCXS_DSGN0273I1NCXS_SND",
                    "M01NCXS_DSGN0279I1NCXS_SND", "M01NCXS_DSGN0275I1NCXS_SND",
                    "M01NCXS_DSGN0276I1NCXS_SND", "M01NCXS_DSGN0277I1NCXS_SND",
                    "M01NCXS_DSGN0278I1NCXS_SND", "M01NCXS_DSGN0274I1NCXS_SND",
                };
                ...
                GameObject* displayScreen = Commands->Create_Object(
                    propaganda_screen[propaganda_number], Vector3(0, 0, 0));
                displayScreen_ID = Commands->Get_ID(displayScreen);

                monitor_sound03 = Commands->Create_Sound(propaganda_sound[propaganda_number],
                                                         propagandaSpeaker01, obj);
                monitor_sound02 = Commands->Create_Sound(propaganda_sound[propaganda_number],
                                                         propagandaSpeaker02, obj);
                monitor_sound01 = Commands->Create_Sound(propaganda_sound[propaganda_number],
                                                         propagandaSpeaker03, obj);
                ...
                Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG, 10);
                     ...
                     == M01_IVE_BEEN_KILLED_JDG) // projector is dead--stop playing propaganda stuff
            {
                destroyed = true;
                GameObject* oldDisplayScreen = Commands->Find_Object(displayScreen_ID);
                if (oldDisplayScreen != nullptr) {
...
DECLARE_SCRIPT(M01_Comm_Repair_Engineer_JDG,
               "") // this guys ID is M01_COMM_CENTER_ENGINEER_ID 101949
{
    int healer_sound;
    bool healing;
            ...
            if (param == M01_START_ACTING_JDG && acting == false) {
                ...
                if (nodguy01_dead == false) {
                    ...
                    if (nodguy02_dead == false) {
                        float delayTimer = Commands->Get_Random(1, 2);
                        Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                    delayTimer);
                    }
                }
                ...
                if (nodguy03_dead == false) {
                    float delayTimer = Commands->Get_Random(1, 2);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG,
                                                delayTimer);
                }
                    ...
                    if (nodguy04_dead == false) {
                        float delayTimer = Commands->Get_Random(1, 2);
                        Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_04_JDG,
                                                    delayTimer);
                    }
                }
                ...
                if (nodguy05_dead == false) {
                    float delayTimer = Commands->Get_Random(1, 2);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_05_JDG,
                                                delayTimer);
                }
                    ...
                    if (nodguy06_dead == false) {
                        float delayTimer = Commands->Get_Random(1, 2);
                        Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_06_JDG,
                                                    delayTimer);
                    }
                }
            }
                ...
                GameObject* nodguy01 = Commands->Find_Object(nodguy01_id);
                if (nodguy01 != nullptr) {
                    int paintball_alert_conv = Commands->Create_Conversation(
                        "M01_Paintball_Intruder_Conversation_02", 95, 20, true);
                ...
                if (nodguy03 != nullptr) {
                    int paintball_alert_conv = Commands->Create_Conversation(
                        "M01_Paintball_Intruder_Conversation_01", 95, 20, true);
                ...
                if (nodguy05 != nullptr) {
                    int paintball_alert_conv = Commands->Create_Conversation(
                        "M01_Paintball_Intruder_Conversation_03", 95, 20, true);
...
DECLARE_SCRIPT(M01_HON_Dojo_Trainer_JDG, "") // this guys ID is M01_HON_DOJO_SENSEI_JDG 102051
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case M01_START_ACTING_JDG: // here comes the player--start your routine
        {
            ...
            dojo_conv
                = Commands->Create_Conversation("M01_Dojo_Sensei_Conversation", 100, 1000, true);
        ...
        case M01_MODIFY_YOUR_ACTION_JDG: // turn your sight and hearing back on
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            if (action_id == dojo_conv) // your initial conv is over--tell civs to do pushups
            {
                if (Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG)) {
                    float delayTimer = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG),
                                                0, M01_START_ACTING_JDG, delayTimer);
                }

                if (Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG)) {
                    float delayTimer2 = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG),
                                                0, M01_START_ACTING_JDG, delayTimer2);
                }

                if (Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG)) {
                    float delayTimer3 = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG),
                                                0, M01_START_ACTING_JDG, delayTimer3);
                }
            }
        } break;
        }
...
DECLARE_SCRIPT(M01_HON_Dojo_Civ_01_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case M01_START_ACTING_JDG: // you've been told to do pushups--DO THEM!
        {
            params.Set_Basic(
                this, 100,
                M01_DOING_ANIMATION_01_JDG); // this is animation of guy going into pushup position
        ...
        case M01_PLAYER_IS_ATTACKING_ME_JDG: // your guard is alerted to Havoc--stop whatever you
                                             // are doing
        {
            Commands->Action_Reset(obj, 100);
            Vector3 myPosition = Commands->Get_Position(obj);
        ...
        case M01_MODIFY_YOUR_ACTION_04_JDG: // play thanks conv
        {
            ...
            {
                thanks_conv = Commands->Create_Conversation("M01_Dojo_Babushka_Thanks_Conversation",
                                                            100, 1000, true);
                Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG, 0);
            }

            else if (i_am == dojo_civ_02) {
                thanks_conv = Commands->Create_Conversation("M01_Dojo_Billy_Thanks_Conversation",
                                                            100, 1000, true);
                Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG, 2);
            }

            else {
                thanks_conv = Commands->Create_Conversation(
                    "M01_Dojo_FarmerJohn_Thanks_Conversation", 100, 1000, true);
                                                       ...
                                                       // M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG
        {
            ...
            Commands->Send_Custom_Event(obj, obj, 0, M01_PICK_A_NEW_LOCATION_JDG,
                                        10); // do distance check from star
        } break;
        }
    }
        ...
        case ACTION_COMPLETE_NORMAL: {
            ...
            case M01_DOING_ANIMATION_01_JDG: {
                if (pushups_done < 2) {
                    params.Set_Basic(
                        this, 100,
                        M01_DOING_ANIMATION_01_JDG); // this is pushup animation animation
                    ...
                    params.Set_Basic(this, 100,
                                     M01_DOING_ANIMATION_02_JDG); // this is guy standing up
...
{ // target location ()
  void Entered(GameObject * obj, GameObject* enterer) {
      if (enterer == STAR) { Vector3 radarMarker(-293.163f, 499.787f, 19.959f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga",
                                          IDS_POG_ACCESS, radarMarker);
...
{ // target location ()
  void Entered(GameObject * obj, GameObject* enterer) {
      if (enterer == STAR) { Vector3 radarMarker(-292.135f, 522.740f, 16.448f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga",
                                          IDS_POG_ACCESS, radarMarker);
...
{ // target location ()
  void Entered(GameObject * obj, GameObject* enterer) {
      if (enterer == STAR) { Vector3 radarMarker(-314.578f, 517.124f, 16.447f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga",
                                          IDS_POG_ACCESS, radarMarker);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poker == STAR && poked == false) {
            if (commCenterDead == false) {
                poked = true;
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_PLAYER_HAS_POKED_COMM_CENTER_PCT_JDG, 0);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            if (action_id == missionIntro) // add first objective pog here
            {
                ...
                Commands->Add_Objective(M01_PRISONER_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M01_01,
                                        nullptr, IDS_Enc_Obj_Primary_M01_01);
                Commands->Set_Objective_Radar_Blip(M01_PRISONER_OBJECTIVE_JDG, prisonerPenLocation);

                Commands->Set_Objective_HUD_Info_Position(M01_PRISONER_OBJECTIVE_JDG, 80,
                                                          "POG_M01_1_01.tga", IDS_POG_LOCATE,
                                                          prisonerPenLocation);
                Commands->Set_HUD_Help_Text(IDS_M00DSGN_DSGN1004I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);

                escKeyConv = Commands->Create_Conversation(
                    "M01_Press_ESC_For_Objectives_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, escKeyConv, false, false);
                ...
                Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0516I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
        } break;
        }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param == M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG) {
                missionIntro = Commands->Create_Conversation("M01_Start_Mission_Conversation", 100,
                                                             1000, false);
                Commands->Join_Conversation(nullptr, missionIntro, false, false);
                // Commands->Join_Conversation( STAR, missionIntro, false, false );
                Commands->Start_Conversation(missionIntro, missionIntro);

                Commands->Monitor_Conversation(
                    obj, missionIntro); // M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG
            }
            ...
            if (param == M01_GDI_BASE_POW_OBJECTIVE_JDG) {
                ...
                Commands->Add_Objective(M01_GDI_BASE_POW_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                        OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_06,
                                        nullptr, IDS_Enc_Obj_Secondary_M01_06);
                Commands->Set_Objective_Radar_Blip(M01_GDI_BASE_POW_OBJECTIVE_JDG,
                                                   initialCaptainLocation);

                Commands->Set_Objective_HUD_Info_Position(M01_GDI_BASE_POW_OBJECTIVE_JDG, 85,
                                                          "POG_M01_2_08.tga", IDS_POG_RESCUE,
                                                          initialCaptainLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG, SECONDARY_POG_DELAY );
                ...
                if (barnCommander != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG,
                                                              86, "POG_M01_2_01.tga",
                                                              IDS_POG_ELIMINATE, commanderPosition);

                    // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                    // M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                    // Vector3 blue (0,0,1);
                    Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_01,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                }
            }
                ...
                else if (turret02 != nullptr) {
                    turretsLocation.Set(-105.024f, 113.658f, 1.872f);
                }

                Commands->Set_Objective_HUD_Info_Position(M01_TURRETS_OBJECTIVE_JDG, 91,
                                                          "POG_M01_2_02.tga", IDS_POG_DESTROY,
                                                          turretsLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_TURRETS_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                // Vector3 blue (0,0,1);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_02,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    M01_BARN_OBJECTIVE_JDG, 92, "POG_M01_2_03.tga", IDS_POG_RESCUE, barnLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_BARN_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                // Vector3 blue (0,0,1);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_03,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }

            else if (param == M01_BARN_ROUNDUP_OBJECTIVE_JGD) {
                Vector3 barnLocation(-54.786f, 213.816f, 6.453f);
                Commands->Set_Objective_HUD_Info_Position(M01_BARN_ROUNDUP_OBJECTIVE_JGD, 93,
                                                          "POG_M01_2_04.tga", IDS_POG_EVACUATE,
                                                          barnLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_BARN_ROUNDUP_OBJECTIVE_JGD, SECONDARY_POG_DELAY );

                // Vector3 blue (0,0,1);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_04,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
            ...
            else if (param == M01_CHURCH_OBJECTIVE_JDG) //
            {
                Vector3 churchLocation
                    = Commands->Get_Position(Commands->Find_Object(M01_CHURCH_PRIEST_ID));
                Commands->Set_Objective_HUD_Info_Position(M01_CHURCH_OBJECTIVE_JDG, 94,
                                                          "POG_M01_2_06.tga", IDS_POG_RESCUE,
                                                          churchLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_CHURCH_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                // Vector3 blue (0,0,1);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_05,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    M01_HON_OBJECTIVE_JDG, 95, "POG_M02_2_01.tga", IDS_POG_DESTROY, mctLocation);

                // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                // M01_HON_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                // Vector3 blue (0,0,1);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_07,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }

            else if (param == M01_COMM_SAM_OBJECTIVE_JDG) {
                Vector3 samLocation(-337.169f, 549.232f, 31.949f);
                Commands->Set_Objective_HUD_Info_Position(M01_COMM_SAM_OBJECTIVE_JDG, 96,
                                                          "POG_M01_1_04.tga", IDS_POG_DESTROY,
                                                          samLocation);

                // Vector3 green (0,1,0);
                Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Primary_M01_04,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
        }
            ...
            if (captDuncan != nullptr) {
                if (param == M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG) {
                    // Commands->Set_Objective_Status( M01_GDI_BASE_POW_OBJECTIVE_JDG,
                    // OBJECTIVE_STATUS_ACCOMPLISHED );
                    Commands->Add_Objective(M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG,
                                            OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                            IDS_Enc_ObjTitle_Secondary_M01_08, nullptr,
                                            IDS_Enc_Obj_Secondary_M01_08);
                    Vector3 realCaptainLocation(109.959f, 97.340f, 8.923f);
                    Commands->Set_Objective_HUD_Info_Position(M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG,
                                                              91, "POG_M01_2_05.tga",
                                                              IDS_POG_CONTACT, realCaptainLocation);
                    Commands->Set_Objective_Radar_Blip(M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG,
                                                       realCaptainLocation);
                    // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG,
                    // M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG, SECONDARY_POG_DELAY );

                    GameObject* triggerZone03 = Commands->Find_Object(106052);
                    if (triggerZone03 != nullptr) {
                        Commands->Send_Custom_Event(obj, triggerZone03, 0,
                                                    M01_MODIFY_YOUR_ACTION_JDG, 0);
                    }

                    // Vector3 blue (0,0,1);
                    Commands->Set_HUD_Help_Text(IDS_Enc_ObjTitle_Secondary_M01_08,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                }
            }
...
{ void Killed(GameObject * obj,
              GameObject* killer) { GameObject* gdiGuy01 = Commands->Find_Object(104685);
if (gdiGuy01 != nullptr) {
...
DECLARE_SCRIPT(M01_Church_EvacController_JDG, "") // 103394
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            protectCivsConv = Commands->Create_Conversation("M01_Protect_Clergy_Conversation", 100,
                                                            1000, false);
            Commands->Join_Conversation(nullptr, protectCivsConv, false, false);
        ...
        else if (param == M01_EVERYONES_ON_BOARD_JDG) // civs are on board--send aircraft away
        {
            ...
            if (deadCivs == 3) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CLEAR_CHURCH_OBJECTIVE_FAIL_JDG, 0);
            }
        }
        ...
        if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == protectCivsConv) {
                if (transportCalled == false) {
                    ...
                    Vector3 evacPosition = Commands->Get_Position(obj);
                    GameObject* controller
                        = Commands->Create_Object("Invisible_Object", evacPosition);
                    Commands->Attach_Script(controller, "Test_Cinematic",
                                            "XG_M01_ChurchArea_EvacAnim.txt");
                }

                GameObject* chinook_obj1
                    = Commands->Create_Object("Invisible_Object", Vector3(-140.9f, 320.2f, 8.5f));
                Commands->Set_Facing(chinook_obj1, -54.0f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                        "X1I_GDI_Church_TroopDrop.txt");
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Rope_JDG, "") { void Created(GameObject * obj) {
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_MODIFY_YOUR_ACTION_JDG: {
        Commands->Debug_Message(
            "*******************************rope has received custom to goto exit anim\n");
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_MODIFY_YOUR_ACTION_JDG: {
        Commands->Debug_Message(
            "*******************************waypath has received custom to goto exit anim\n");
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_MODIFY_YOUR_ACTION_JDG: {
        Commands->Debug_Message(
            "*******************************helicopter has received custom to goto exit anim\n");
    ...
    case M01_DO_END_MISSION_CHECK_JDG: {
        ...
        if ((loveshackNun != nullptr) || (churchNun != nullptr) || (priest != nullptr)) {
            Commands->Send_Custom_Event(obj, obj, 0, M01_DO_END_MISSION_CHECK_JDG, 2);
        }

        else {
            Commands->Debug_Message("*******************************all barn civs on board--about "
                                    "to send cutom to controller\n");
            ...
            if (controller != nullptr) {
                ...
                Commands->Debug_Message("*******************************all barn civs on "
                                        "board--sent cutom to controller\n");
            }
        }
    } break;
    }
...
DECLARE_SCRIPT(M01_Church_Priest_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Create_Sound("EVA_Civilian_Killed", Vector3(0, 0, 0), obj);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(103394), 0, M01_CIVILIAN_KILLED_JDG,
                                    0);
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        else if ((param == M01_GOING_TO_EVAC_SPOT_JDG)) // your ride is here--go get in
        {
            ...
            if (distance <= 15) {
                lucky_charms = Commands->Create_Conversation("M01_Priest_LuckyCharms_Conversation",
                                                             100, 1000, false);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id == M01_DOING_ANIMATION_01_JDG) // civ is standing up after guard is dead
            {
                ...
                Commands->Action_Play_Animation(obj, params);
                     ...
                     == M01_DOING_ANIMATION_02_JDG) // civ is standing up after guard is dead
            {
                ...
                Commands->Action_Play_Animation(obj, params);
                     ...
                     == M01_DOING_ANIMATION_03_JDG) // civ is standing up after guard is dead
            {
                ...
                Commands->Action_Goto(obj, params);
                     ...
                     == M01_WALKING_WAYPATH_02_JDG) // civ is standing up after guard is dead
            {
                Commands->Enable_Hibernation(obj, true);

                if (Commands->Find_Object(103395)) // this is your conversation zone
                {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(103395), 0,
                                                M01_START_ACTING_JDG, 0);
                }
            }

            else if (action_id
                     == M01_GOING_TO_EVAC_SPOT_JDG) // Nun is by chinook--play getting on anim
            {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_CHURCH_CLERGY_HAS_BOARDED_JDG, 1);
                ...
                GameObject* airdropController
                    = Commands->Find_Object(M01_CHURCHAREA_EVAC_MONITOR_JDG);
                if (airdropController != nullptr) {
                    Commands->Send_Custom_Event(obj, airdropController, 0,
                                                M01_GOING_TO_EVAC_SPOT_JDG, 0);
                }

                GameObject* myEvacController = Commands->Find_Object(103394);
                if (myEvacController != nullptr) // tell controller to spawn a rope
                {
                    Commands->Send_Custom_Event(obj, myEvacController, 0, M01_GIVE_ME_A_ROPE_JDG,
                                                0);
                }
            }

            else if (action_id == M01_PICK_A_NEW_LOCATION_JDG) // priest is by Havoc--cue lucky
                                                               // charms conversation
            {
                // lucky_charms = Commands->Create_Conversation(
                // "M01_Priest_LuckyCharms_Conversation", 100, 1000, false);
                ...
                // Commands->Monitor_Conversation( obj, lucky_charms );
                     ...
                     && complete_reason == ACTION_COMPLETE_NORMAL) // priest is by Havoc--cue lucky
                                                                   // charms conversation
            {
                Vector3 evacSpot = Commands->Get_Position(Commands->Find_Object(103394));
                params.Set_Basic(this, 100, M01_GOING_TO_EVAC_SPOT_JDG);
        ...
        else if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) // priest is by Havoc--cue
                                                                        // lucky charms conversation
        {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
                     ...
                     == M01_DOING_ANIMATION_03_JDG) // civ is standing up after guard is dead
            {
                ...
                Commands->Action_Goto(obj, params);
                     ...
                     == M01_WALKING_WAYPATH_02_JDG) // Nun is by chinook--play getting on anim
            {
                Commands->Enable_Hibernation(obj, true);

                if (Commands->Find_Object(101370)) // this is your conversation zone
                {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(101370), 0,
                                                M01_START_ACTING_JDG, 1);
                }
            }
...
void Action_Complete(GameObject* obj, int action_id, ActionCompleteReason complete_reason)
{
    ...
    if (complete_reason == ACTION_COMPLETE_NORMAL) {
        if (action_id == M01_GOING_TO_EVAC_SPOT_JDG) // Nun is by chinook--play getting on anim
        {
            ...
            if (airdropController != nullptr) {
                Commands->Send_Custom_Event(obj, airdropController, 0, M01_GOING_TO_EVAC_SPOT_JDG,
                                            0);
            }
        ...
        else if (action_id == M01_WALKING_WAYPATH_02_JDG) // nun is at hide spot--play
                                                          // animation--cue havoc talk zone
        {
            Commands->Enable_Hibernation(obj, true);

            if (Commands->Find_Object(101368)) // this is your conversation zone
            {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(101368), 0,
                                            M01_START_ACTING_JDG, 1);
            }
        }
    }
...
DECLARE_SCRIPT(M01_BarnArea_Air_Evac_Rope_JDG, "") { void Created(GameObject * obj) {
    Commands->Debug_Message("**********************script attached to evac rope\n");
Commands->Enable_Hibernation(obj, false);
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_DO_END_MISSION_CHECK_JDG: {
        ...
        if ((barnCiv01 != nullptr) || (barnCiv02 != nullptr) || (barnCiv03 != nullptr)) {
            ...
            if (missionController != nullptr) {
                Commands->Send_Custom_Event(obj, missionController, 0,
                                            M01_END_BARN_ROUNDUP_OBJECTIVE_JDG, 0);
            }
        }
    } break;
...
DECLARE_SCRIPT(M01_Barn_Prisoner_01_JDG,
               "") // this guys ID is M01_BARN_PRISONER_01_ID 101442--this is female
{
    bool talkingToHavoc;
    bool chinookOnWay;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_MODIFY_YOUR_ACTION_JDG) // babushka runs to hide spot
        {
            ...
            Commands->Action_Play_Animation(obj, params);
                 ...
                 == M01_MODIFY_YOUR_ACTION_04_JDG) // you are now talking to havoc in your shed
        {
            talkingToHavoc = true;
        }
        ...
        else if (param == M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG) // your ride is on the
                                                                      // way--disable hibernation
        {
            chinookOnWay = true;
            Commands->Enable_Hibernation(obj, false);
        }
            ...
            Commands->Enable_Hibernation(obj, false);
            Vector3 evacSpot
                = Commands->Get_Position(Commands->Find_Object(M01_BARNAREA_EVAC_MONITOR_JDG));
            ActionParamsStruct params;
            params.Set_Basic(this, 100, M01_GOING_TO_EVAC_SPOT_JDG);
            params.Set_Movement(evacSpot, RUN, 1);
            ...
            GameObject* babushkazone = Commands->Find_Object(101662);
            if (babushkazone != nullptr) // kill babushka talk zone
            {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id == M01_WALKING_WAYPATH_02_JDG) // civ is at hiding spot--crouch
            {
                ...
                if (Commands->Find_Object(101662)) // sending custom to babushka conversation
                                                   // zone--okay to play conversation
                {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(101662), 0,
                                                M01_START_ACTING_JDG, 0);
                }
            ...
            else if (action_id == M01_GOING_TO_EVAC_SPOT_JDG) // civ is at evac chopper--get on
            {
                ...
                // GameObject *spawn_effect = Commands->Create_Object( "Spawner Created Special
                // Effect", powerupSpawnLocation );
...
DECLARE_SCRIPT(M01_Barn_Prisoner_02_JDG,
               "") // this guys ID is M01_BARN_PRISONER_02_ID 101444--this is Billy
{
    bool chinookOnWay;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
                                                                      ...
                                                                      // way--disable hibernation
        {
            ...
            if (billyszone != nullptr) // kill billy's talk zone
            {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            ...
            {
                if (Commands->Find_Object(101661)) // sending custom to billys conversation
                                                   // zone--okay to play conversation
                {
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(101661), 0,
                                                M01_START_ACTING_JDG, 0);
                }
...
DECLARE_SCRIPT(M01_Barn_Prisoner_03_JDG,
               "") // this guys ID is M01_BARN_PRISONER_03_ID 101443--this is pierre
{
    bool chinookOnWay;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_11_JDG) // babushka is talking ot havoc--turn and
                                                         // face him
        {
            Commands->Action_Reset(obj, 100);
            // ActionParamsStruct params;
                                                                      ...
                                                                      // way--disable hibernation
        {
            ...
            Commands->Debug_Message("***************************barn civ 3 has received evac "
                                    "chopper call--should now be going to evac spot\n");
            Commands->Enable_Hibernation(obj, false);
            Commands->Set_Innate_Is_Stationary(obj, false);
...
DECLARE_SCRIPT(M01_GDIBasePOW_Air_Evac_Rope_JDG, "") { void Created(GameObject * obj) {
    Commands->Debug_Message("**********************script attached to evac rope\n");
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_GDIBaseCommander_Air_Evac_Rope_JDG, "") { void Created(GameObject * obj) {
    Commands->Debug_Message("**********************script attached to evac rope\n");
Commands->Enable_Hibernation(obj, false);
GameObject* myController = Commands->Find_Object(106694);
if (myController != nullptr) {
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { GameObject* gdiBaseCommander = Commands->Find_Object(106050);
...
if (pow01 != nullptr && pow02 != nullptr) {
...
if (gdi_minigunner_escort != nullptr) {
...
// if (gdi_grenadier_escort != nullptr)
//{
...
/*DECLARE_SCRIPT(M01_GDIBase_SecondChinookFlamethrowerGuy_JDG, "")
{
        void Created( GameObject * obj )
        {
                GameObject * powController = Commands->Find_Object (
M01_GDIBASE_POWSCENE02_MONITOR_JDG ); if (powController != nullptr)
                {
                        Commands->Send_Custom_Event( obj, powController, 0,
M01_MODIFY_YOUR_ACTION_03_JDG, 0 );
                }
        }
...
M01_GDIBASE_POWSCENE02_MONITOR_JDG ); if (powController != nullptr)
                {
                        Commands->Send_Custom_Event( obj, powController, 0, M01_IVE_BEEN_KILLED_JDG,
0 );
                }
        }
};
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { GameObject* visceroid01 = Commands->Find_Object(106908);
...
int apacheConv
    = Commands->Create_Conversation("M01_Announce_Apache_Conversation", 100, 1000, false);
Commands->Join_Conversation(nullptr, apacheConv, false, false);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (gateIsDown == true) {
            if (sam_is_destroyed == false) {
                int apacheConv = Commands->Create_Conversation(
                    "M01_Detention_GDI_Poke_Conversation01", 100, 1000, false);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id == M01_WALKING_WAYPATH_02_JDG) {
            ...
            if (obj == gdipow01) {
                Commands->Set_Innate_Is_Stationary(obj, true);
                int apacheConv = Commands->Create_Conversation(
                    "M01_Detention_GDI_Hello_Conversation01", 100, 1000, false);
                Commands->Join_Conversation(obj, apacheConv, false, true, true);
                Commands->Start_Conversation(apacheConv, apacheConv);
            }
        }
            ...
            if (obj == gdipow01) {
                int apacheConv = Commands->Create_Conversation(
                    "M01_Detention_GDI_Evac_Conversation01", 100, 1000, false);
            ...
            GameObject* missionController = Commands->Find_Object(M01_MISSION_CONTROLLER_JDG);
            if (missionController != nullptr) {
                Commands->Send_Custom_Event(obj, missionController, 0, M01_DO_END_MISSION_CHECK_JDG,
                                            5);
            }
        }
    }
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (gateIsDown == true) {
            if (sam_is_destroyed == false) {
                ...
                if (obj == babushka) {
                    int apacheConv = Commands->Create_Conversation(
                        "M01_Detention_Babushka_Poke_Conversation01", 100, 1000, false);
                    Commands->Join_Conversation(obj, apacheConv, false, true, true);
                    Commands->Start_Conversation(apacheConv, apacheConv);
                }
                    ...
                    int apacheConv = Commands->Create_Conversation(
                        "M01_Detention_Pierre_Poke_Conversation01", 100, 1000, false);
                    Commands->Join_Conversation(obj, apacheConv, false, true, true);
                    Commands->Start_Conversation(apacheConv, apacheConv);
                }
                    ...
                    int apacheConv = Commands->Create_Conversation(
                        "M01_Detention_FarmerJohn_Poke_Conversation01", 100, 1000, false);
                    Commands->Join_Conversation(obj, apacheConv, false, true, true);
                    Commands->Start_Conversation(apacheConv, apacheConv);
                }
            }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        else if (action_id == M01_WALKING_WAYPATH_03_JDG) // civ is running to gate
        {
            ...
            Commands->Action_Play_Animation(obj,
                                            params); // M01_Detention_Babushka_Evac_Conversation01

            GameObject* babushka = Commands->Find_Object(M01_DETENTION_CIVILIAN_01_JDG);

            if (obj == babushka) {
                int apacheConv = Commands->Create_Conversation(
                    "M01_Detention_Babushka_Evac_Conversation01", 100, 1000, false);
                Commands->Join_Conversation(obj, apacheConv, true, true, true);
...
if (firstFieldCommander != nullptr) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_BARNAREA_NOD_COMMANDER_JDG), 0,
                                M01_START_ACTING_JDG, 0);
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
...
DECLARE_SCRIPT(M01_GDI_GuardTower_NOD_Commander_JDG, "") // M01_BARNAREA_NOD_COMMANDER_JDG
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        if (objectiveController != nullptr) {
            Commands->Send_Custom_Event(obj, objectiveController, 0,
                                        M01_CLEAR_FIRST_NOD_COMMANDER_PASS_JDG, 5);
        }

        if (STAR) {
            int guardTowerOutro = Commands->Create_Conversation("M01_GuardTower_Outro_Conversation",
                                                                100, 1000, false);
            Commands->Join_Conversation(nullptr, guardTowerOutro, false, false);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            case M01_START_ACTING_JDG: // here comes player start calling in reinforcements
            {
                ...
                GameObject* zone02 = Commands->Find_Object(103343);
                if (sender == zone01) {
                    Commands->Debug_Message("**********************Nod gdi tower commander has "
                                            "recieved command to start acting\n");
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG, 2);
                ...
                if (STAR && deadYet == false) {
                    ...
                    guardTowerIntro = Commands->Create_Conversation(
                        "M01_GuardTower_Intro_Conversation", 95, 1000, true);
                    Commands->Join_Conversation(nullptr, guardTowerIntro, false, false);
            ...
            case M01_MODIFY_YOUR_ACTION_JDG: // set timer--then call in next reinforcements
            {
                if (obj) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_SEND_GUARD_TOWER_CHINOOK_JDG,
                                                delayTimer);
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
            ...
            case M01_SEND_GUARD_TOWER_CHINOOK_JDG: // here comes player start calling in
                                                   // reinforcements
            {
                if (obj) {
                    Commands->Send_Custom_Event(obj,
                                                Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                                0, M01_SEND_GUARD_TOWER_CHINOOK_JDG, 0);
                }
            } break;
                                                 ...
                                                 // reinforcements
            {
                if (obj && deadYet == false) {
                    GameObject* nodCommanderDialogController = Commands->Find_Object(103398);
                    if (nodCommanderDialogController != nullptr) {
                        Commands->Debug_Message("**********************Nod gdi tower commander is "
                                                "sending custom to dialog controller\n");
                        Commands->Send_Custom_Event(obj, nodCommanderDialogController, 0,
                                                    M01_MODIFY_YOUR_ACTION_JDG, 0);
                    }
                    float delayTimer = Commands->Get_Random(15, 30);
...
DECLARE_SCRIPT(M01_Nod_Commander_Conversation_Controller_GDI, "") // 103398
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            GameObject* guardTower01Commander
                = Commands->Find_Object(M01_BARNAREA_NOD_COMMANDER_JDG);
            if (sender == guardTower01Commander && first_call == true) {
                first_call = false;
                initialCommanderConv
                    = Commands->Create_Conversation("M01_Nod_Commander_Conv04", 100, 300, true);
                ...
                if (random == 0) {
                    int commanderConv
                        = Commands->Create_Conversation("M01_Nod_Commander_Conv01", 90, 200, true);
                    ...
                    int commanderConv
                        = Commands->Create_Conversation("M01_Nod_Commander_Conv02", 90, 200, true);
                    Commands->Join_Conversation(sender, commanderConv, false, false, false);
                    Commands->Start_Conversation(commanderConv, commanderConv);
                }
                    ...
                    int commanderConv
                        = Commands->Create_Conversation("M01_Nod_Commander_Conv03", 90, 200, true);
                    Commands->Join_Conversation(sender, commanderConv, false, false, false);
                    Commands->Start_Conversation(commanderConv, commanderConv);
                }
                    ...
                    int commanderConv
                        = Commands->Create_Conversation("M01_Nod_Commander_Conv04", 90, 200, true);
                    Commands->Join_Conversation(sender, commanderConv, false, false, false);
                    Commands->Start_Conversation(commanderConv, commanderConv);
                }
                    ...
                    int commanderConv
                        = Commands->Create_Conversation("M01_Nod_Commander_Conv05", 90, 200, true);
                    Commands->Join_Conversation(sender, commanderConv, false, false, false);
                    Commands->Start_Conversation(commanderConv, commanderConv);
                }
            }
...
DECLARE_SCRIPT(M01_KeyCard01_Script_JDG,
               "") { void Custom(GameObject * obj, int type, int param,
                                 GameObject* sender) { if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
    int lockeKeycard
    = Commands->Create_Conversation("M01_First_Keycard_Conversation", 100, 1000, true);
Commands->Join_Conversation(nullptr, lockeKeycard, false, false);
...
Commands->Join_Conversation(nullptr, tankReward, false, false);
...
DECLARE_SCRIPT(M01_Sinking_Gunboat_JDG, "") { void Created(GameObject * obj) {
    Commands->Set_Animation(obj, "V_GDI_GBOAT.XG_GBOAT_SINK", false, nullptr, 0, 60);
}
...
if (hovercraftController != nullptr) {
...
DECLARE_SCRIPT(M01_GDI_BaseCommander_Backside_EntryZone_JDG, "") // 113733
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && entered == false) {
            ...
            if (gdiBaseLeaderGuy != nullptr) {
                Commands->Send_Custom_Event(obj, gdiBaseLeaderGuy, 0, M01_MODIFY_YOUR_ACTION_10_JDG,
                                            0);
                Commands->Destroy_Object(obj); // one time zone--cleaning up
            }
        }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender) //
    {
        if (param == M01_CIVILIAN_KILLED_JDG) //
        {
            ...
            if (unitsEvacuated == 3 && failed == false) {
                barnAirdrop_conv
                    = Commands->Create_Conversation("M01_AirDrop_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, barnAirdrop_conv, false, false);
        ...
        else if (param == M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG) // a gdi guy is waiting for
                                                                      // evac--call in a helicopter
        {
            if (transportCalled == false) {
                transportCalled = true;
                ...
                Commands->Attach_Script(controller, "Test_Cinematic",
                                        "XG_M01_BarnArea_EvacAnim.txt");
            }
        }

        else if (param == M01_EVERYONES_ON_BOARD_JDG) // chinook is ready to go--give clearance
        {
            Commands->Debug_Message("*******************************all barn civs on board--custom "
...
void Killed(GameObject* obj, GameObject* killer)
{
    ...
    if (detentionGate != nullptr) {
        Commands->Send_Custom_Event(obj, detentionGate, 0,
                                    M01_COMMCENTER_SAMSITE_HAS_BEEN_DESTROYED_JDG, 0);
    }
}
}
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                ...
                if (playerinZone == true && commanderAlive == true
                    && commandClearance == true) // M01_MODIFY_YOUR_ACTION_JDG
                {
                    GameObject* gdiCommander = Commands->Find_Object(106050);
                    if (gdiCommander != nullptr) {
                        convStarted = true;
                        Commands->Send_Custom_Event(obj, gdiCommander, 0,
                                                    M01_MODIFY_YOUR_ACTION_JDG, 1);
                    }
                }
...
DECLARE_SCRIPT(M01_TurretBeach_Engineer_JDG,
               "") // this guys ID is M01_TURRETBEACH_ENGINEER_ID 101654
{
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        ...
        if (damager_id != nullptr) {
            Commands->Debug_Message("***************************engineers damager is ID %d\n",
                                    damager_id);
        }

        else {
            Commands->Debug_Message("***************************engineers damager is nullptr\n");
        }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_START_ACTING_JDG) {
            Commands->Debug_Message(
                "***************************original engineer custom received--start acting\n");
            Commands->Enable_Hibernation(obj, false);
        }

        else if (param == M01_GOTO_IDLE_JDG) {
            Commands->Debug_Message(
                "***************************original engineer custom received--STOP acting\n");
            Commands->Enable_Hibernation(obj, true);
        }
            ...
            if (working_here_boss == false) {
                Commands->Debug_Message(
                    "***************************engineers has received custom to go heal turret\n");
                Commands->Innate_Disable(obj);
                Commands->Action_Reset(obj, 100);
                ...
                if ((turret02_health > turret01_health) && (turret01_health > 0)) {
                    if (turret01 != nullptr && turret01_dead == false) {
                        params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
                    ...
                    if (turret02 != nullptr && turret02_dead == false) {
                        params.Set_Basic(this, 100, M01_WALKING_WAYPATH_02_JDG);
            ...
            GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
            if (turret01 != nullptr && killedYet == false && turret01_dead == false) {
            ...
            Commands->Debug_Message("***************************turret engineer has fixed turret "
                                    "one--going back to hiding spot\n");
            ...
            GameObject* turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
            if (turret02 != nullptr && killedYet == false && turret02_dead == false) {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id == M01_WALKING_WAYPATH_01_JDG
            && complete_reason == ACTION_COMPLETE_NORMAL) // engineer is at damaged turret 01--play
                                                          // fixing animation
        {
            GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
            if (turret01 != nullptr) {
                ...
                Commands->Send_Custom_Event(obj, obj, 0, M01_START_ATTACKING_01_JDG, 1.5f);
                 ...
                 && complete_reason == ACTION_COMPLETE_NORMAL) // engineer is at damaged turret
                                                               // 02--play fixing animation
        {
            GameObject* turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
            if (turret02 != nullptr) {
                ...
                Commands->Send_Custom_Event(obj, obj, 0, M01_START_ATTACKING_02_JDG, 0.5f);
                 ...
                 && complete_reason
                     == ACTION_COMPLETE_NORMAL) // engineer has been damaged look around
        {
            char* animationName = M01_Choose_Duck_Animation();
            Commands->Action_Reset(obj, 100);
...
DECLARE_SCRIPT(M01_TurretBeach_Chinook_Spawned_Soldier_NOD, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        GameObject* gunboatController = Commands->Find_Object(M01_TURRETBEACH_CONTROLLER_ID);
        if (gunboatController != nullptr) {
            Commands->Send_Custom_Event(obj, gunboatController, 0, M01_CHOPPER_IS_SENDING_ID_JDG,
                                        0);
        }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_WALKING_WAYPATH_03_JDG && atTurretsYet == false) {
            ...
            Commands->Debug_Message(
                "***************************new engineer custom received--start acting\n");
            Commands->Enable_Hibernation(obj, false);
            ...
            Commands->Debug_Message(
                "***************************new engineer custom received--STOP acting\n");
            Commands->Enable_Hibernation(obj, true);
        }
            ...
            GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
            if (turret01 != nullptr && killedYet == false) {
                Vector3 sound_position = Commands->Get_Position(turret01);
                Commands->Create_Sound("CnC_Healer_Sound", sound_position, obj);
                float turretMaxHealth = Commands->Get_Max_Health(turret01);
                Commands->Set_Health(turret01, turretMaxHealth);
            ...
            GameObject* turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
            if (turret02 != nullptr && killedYet == false) {
                Vector3 sound_position = Commands->Get_Position(turret02);
                Commands->Create_Sound("CnC_Healer_Sound", sound_position, obj);
                float turretMaxHealth = Commands->Get_Max_Health(turret02);
                Commands->Set_Health(turret02, turretMaxHealth);
...
{ // waypath 120218
  void Killed(GameObject * obj, GameObject* killer) {
      // int airdrop_conv = Commands->Create_Conversation( "M01_AirDrop_Conversation", 100, 1000,
      // false); Commands->Join_Conversation( nullptr, airdrop_conv, false, false );
      // Commands->Start_Conversation( airdrop_conv,  airdrop_conv );

  }

  void Custom(GameObject * obj, int type, int param, GameObject* sender) {
      if (type == 0) { if (param == M01_START_ACTING_JDG) { ActionParamsStruct params;
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
if (airstrikeController != nullptr) {
...
DECLARE_SCRIPT(M01_First_AutoRifle_JDG,
               "") { void Custom(GameObject * obj, int type, int param,
                                 GameObject* sender) { if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
    int pressEnterConv
    = Commands->Create_Conversation("M01_Press_Enter_Conversation", 100, 1000, true);
Commands->Join_Conversation(nullptr, pressEnterConv, false, false);
...
Commands->Join_Conversation(nullptr, pressF1Conv, false, false);
...
void Entered(GameObject* obj, GameObject* enterer) // M01_Press_F1_Conversation
{
    if (enterer == STAR) {
        GameObject* pogController = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
        if (pogController != nullptr) {
            Commands->Send_Custom_Event(obj, pogController, 0, M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG,
                                        0);
        }
...
if (c4TextController != nullptr) {
    Commands->Send_Custom_Event(obj, c4TextController, 2, 1, 0);
}

GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-53.217f, -68.049f, 13.701f));
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { Commands->Create_Sound("M01EVAG_DSGN0268I1EVAG_SND", Vector3(0, 0, 0),
                                                  obj); // enemy aircraft detected
GameObject* chinook_obj3
    = Commands->Create_Object("Invisible_Object", Vector3(-12.031f, -42.150f, -1.252f));
...
DECLARE_SCRIPT(M01_Use_Ladder_Zone_JDG, "") {
    ...
    { if (enterer == STAR) {
        int pressF1Conv
        = Commands->Create_Conversation("M01_Press_E_For_Ladders_Conversation", 100, 1000, true);
Commands->Join_Conversation(nullptr, pressF1Conv, false, false);
Commands->Start_Conversation(pressF1Conv, pressF1Conv);
...
DECLARE_SCRIPT(M01_AccessDenied_Zone_JDG, "") {
    void Entered(GameObject * obj, GameObject* enterer) // M01_Press_F1_Conversation
    { if (enterer
          == STAR) { int pressF1Conv
                     = Commands->Create_Conversation("M01_Lockdown_Conversation", 100, 1000, true);
Commands->Join_Conversation(nullptr, pressF1Conv, false, false);
Commands->Start_Conversation(pressF1Conv, pressF1Conv);
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_DO_END_MISSION_CHECK_JDG: {
        ...
        if ((gdiBaseCommander != nullptr) || (gdiBaseMinigunner != nullptr)
            || (gdiBaseGrenadier != nullptr)) {
            Commands->Send_Custom_Event(obj, obj, 0, M01_DO_END_MISSION_CHECK_JDG, 1);
        }
...
DECLARE_SCRIPT(M01_GDIBaseCommander_EvacController_JDG, "") // 106694
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) //
        {
            if (param == M01_START_ACTING_JDG) // gdi commander is done giving ion beacon--start
                                               // evac scenario
            {
                GameObject* gdiBaseCommander = Commands->Find_Object(106050);
                GameObject* gdiBaseMinigunner = Commands->Find_Object(116382);
                ...
                if (gdiBaseCommander != nullptr) {
                    Commands->Send_Custom_Event(obj, gdiBaseCommander, 0,
                                                M01_GOTO_YOUR_EVAC_SPOT_JDG, 0);
                }

                if (gdiBaseMinigunner != nullptr) {
                    Commands->Send_Custom_Event(obj, gdiBaseMinigunner, 0,
                                                M01_GOTO_YOUR_EVAC_SPOT_JDG, 0);
                }

                if (gdiBaseGrenadier != nullptr) {
                    Commands->Send_Custom_Event(obj, gdiBaseGrenadier, 0,
                                                M01_GOTO_YOUR_EVAC_SPOT_JDG, 0);
                }
            }
                     ...
                     && evacing == false) // one of your guys is at his wait spot--call in chopper
            {
                ...
                GameObject* controller = Commands->Create_Object("Invisible_Object", evacPosition);
                Commands->Attach_Script(controller, "Test_Cinematic",
                                        "XG_M01_GDIBaseCommander_EvacAnim.txt");
            }
                     ...
                     && evacing == true) // everyone is on or dead--give take off orders
            {
                ...
                if (evacChopper != nullptr) {
                    Commands->Debug_Message(
                        "**********************sending custom to chopper to leave.....%d\n",
                        evac_helicopter_id);
                    Commands->Send_Custom_Event(obj, evacChopper, 0, M01_MODIFY_YOUR_ACTION_JDG, 0);
                }
                ...
                if (evacWaypath != nullptr) {
                    Commands->Debug_Message(
                        "**********************sending custom to waypath to leave.....%d\n",
                        evac_waypath_id);
                    Commands->Send_Custom_Event(obj, evacWaypath, 0, M01_MODIFY_YOUR_ACTION_JDG, 0);
                }
                ...
                if (evacRope != nullptr) {
                    Commands->Debug_Message(
                        "**********************sending custom to rope to leave.....%d\n",
                        evac_rope_id);
                    Commands->Send_Custom_Event(obj, evacRope, 0, M01_MODIFY_YOUR_ACTION_JDG, 0);
                }
            }
...
DECLARE_SCRIPT(M01_GDIBase_POWEncounter02_Controller_JDG,
               "") // M01_GDIBASE_POWSCENE02_MONITOR_JDG 103331
{
    bool transportCalled;
    bool powGuy01isDead;
    bool powGuy02isDead;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            evac_helicopter_id = Commands->Get_ID(sender);
            // Commands->Debug_Message ( "**********************chopper id
            // received.....%d\n",evac_helicopter_id );
        }
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_JDG) // a gdi guy is waiting for evac--call in a
                                                      // helicopter
        {
            if (transportCalled == false) {
                transportCalled = true;
                ...
                GameObject* controller = Commands->Create_Object("Invisible_Object", evacPosition);
                Commands->Attach_Script(controller, "Test_Cinematic",
                                        "XG_M01_GDIBasePow_EvacAnim.txt");
            }
        }
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    case M01_DO_END_MISSION_CHECK_JDG: {
        ...
        if ((gdiGuy01 != nullptr) || (gdiGuy02 != nullptr)) {
            Commands->Send_Custom_Event(obj, obj, 0, M01_DO_END_MISSION_CHECK_JDG, 2);
        }
...
DECLARE_SCRIPT(M01_ConDropZone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* controller1
    = Commands->Create_Object("Invisible_Object", Vector3(54.835f, -3.011f, 13.105f));
...
DECLARE_SCRIPT(M01_Base_GDI_Fodder_JDG,
               "") { void Created(GameObject * obj) { Vector3 myTarget(72.223f, -24.751f, -0.296f);
ActionParamsStruct params;
Commands->Set_Innate_Is_Stationary(obj, true);
params.Set_Basic(this, 100, M01_START_ACTING_JDG);
...
{ void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { GameObject* minigunner = Commands->Find_Object(116382);
GameObject* grenadier = Commands->Find_Object(116383);

if (minigunner != nullptr) {
    Commands->Send_Custom_Event(obj, minigunner, 0, M01_START_ATTACKING_01_JDG,
                                0); // tell minigunner to greet havoc
}

if (grenadier != nullptr) {
    Commands->Send_Custom_Event(obj, grenadier, 0, M01_START_ATTACKING_01_JDG,
...
DECLARE_SCRIPT(M01_GateSwitch_Tutorial_Zone_JDG, "") // 120844
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && command_clearance == true) {
            Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0528I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
        ...
        if (enterer == STAR && entered == false) {
            ...
            if (firstFieldCommander != nullptr) {
                Commands->Send_Custom_Event(obj,
                                            ...
                                            0, M01_START_ACTING_JDG, 0);
                Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                            0, M01_ADD_BARN_COMMANDER_OBJECTIVE_JDG, 5);
            }
        }
    }
};
...
DECLARE_SCRIPT(M01_TurretBeach_Turret_01_Script_JDG, "") // M01_TURRETBEACH_TURRET_01_ID 101434
{
    ...
    void Killed(GameObject * obj, GameObject * killer) // M01_IVE_BEEN_KILLED_JDG
    {
        ...
        if (turretEngineer != nullptr) {
            Commands->Send_Custom_Event(obj, turretEngineer, 0, M01_TURRET_HAS_BEEN_DESTROYED_JDG,
                                        0);
        }
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (obj) {
            GameObject* turretEngineer = Commands->Find_Object(engineer_id);
            if (damager != nullptr && damager == turretEngineer) {
                float myMaxHealth = Commands->Get_Max_Health(obj);
                Commands->Set_Health(obj, myMaxHealth);
            }

            else if (turretEngineer != nullptr) {
                Commands->Send_Custom_Event(obj, turretEngineer, 0, M01_PLAYER_IS_ATTACKING_ME_JDG,
                                            0);
            }
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            else if (param == M01_BUSY_TRY_AGAIN_JDG) // engineer is busy--call back in 2 seconds
            {
                GameObject* turretEngineer = Commands->Find_Object(engineer_id);
                if (turretEngineer != nullptr) {
                    Commands->Send_Custom_Event(obj, turretEngineer, 0,
                                                M01_PLAYER_IS_ATTACKING_ME_JDG, 1);
                }
            }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id
            == M01_START_ATTACKING_01_JDG) // hovercraft is dead...go back to attacking gunboat
        {
            GameObject* gunboat = Commands->Find_Object(M01_TURRETBEACH_GUNBOAT_ID);
            if (gunboat != nullptr) {
                ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_Initial_Gunboat_Script_JDG, "") // M01_TURRETBEACH_GUNBOAT_ID	101477
{
    ...
    void Killed(GameObject * obj, GameObject * killer) //
    {
        ...
        if (missionController != nullptr) {
            Commands->Send_Custom_Event(obj, missionController, 0,
                                        M01_END_TURRETS_OBJECTIVE_FAIL_JDG, 0);
        }
        ...
        if (obj) {
            ...
            if (healthPercentage <= 50) {
                if (secondHealthWarningPlayed == false) {
                    ...
                    int gunboatHealthWarning02 = Commands->Create_Conversation(
                        "M01_Gunboat_HealthWarning_02", 100, 1000, false);
                    Commands->Join_Conversation(nullptr, gunboatHealthWarning02, false, false);
                    Commands->Join_Conversation(nullptr, gunboatHealthWarning02, false, false);
                ...
                if (firstHealthWarningPlayed == false) {
                    ...
                    int gunboatHealthWarning01 = Commands->Create_Conversation(
                        "M01_Gunboat_HealthWarning_01", 100, 1000, false);
                    Commands->Join_Conversation(nullptr, gunboatHealthWarning01, false, false);
                    Commands->Join_Conversation(nullptr, gunboatHealthWarning01, false, false);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_MODIFY_YOUR_ACTION_03_JDG) {
            ...
            Commands->Debug_Message(
                "***************************gunboat custom received--start acting\n");
            Commands->Enable_Hibernation(obj, false);
            params.Set_Basic(this, 100, M01_WALKING_WAYPATH_02_JDG);
            // params.Set_Movement( Vector3(0,0,0), .2f, 6 );
            // params.WaypathID = 101497;
            ...
            Commands->Debug_Message(
                "***************************gunboat custom received--STOP acting\n");
            Commands->Enable_Hibernation(obj, true);
        }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id
            == M01_WALKING_WAYPATH_03_JDG) // gunboat is at end of final waypath--delete it
        {
            Commands->Destroy_Object(obj);
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                ...
                if ((nodGuy01 == nullptr) && (nodGuy02 == nullptr) && (nodGuy03 == nullptr)
                    && (nodGuy04 == nullptr)) {
                    GameObject* letsgozone = Commands->Find_Object(105615);
                    if (letsgozone != nullptr) {
            ...
            {
                gdi04conv01
                    = Commands->Create_Conversation("M01_GDI04_Conversation_01", 100, 1000, false);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == gdi04conv01) {
                ...
                {
                        Commands->Send_Custom_Event( obj, POW01, 0,
                M01_CAPT_DUNCAN_HAS_BEEN_FOUND_JDG, 0 );
                }

                GameObject * POW02 = Commands->Find_Object ( M01_GDIBASE_POWSCENE02_POWGUY02_JDG );
                if (POW02 != nullptr)
                {
                        Commands->Send_Custom_Event( obj, POW02, 0,
                M01_CAPT_DUNCAN_HAS_BEEN_FOUND_JDG, 0 );
                }*/
            }
            ...
            if (action_id == M01_WALKING_WAYPATH_02_JDG) { }
                ...
                gdi04conv02
                    = Commands->Create_Conversation("M01_GDI04_Conversation_02", 100, 1000, false);
                ...
                Commands->Set_Innate_Is_Stationary(obj, true);
                GameObject* myEvacController = Commands->Find_Object(106694);
                if (myEvacController != nullptr) // tell controller to call in a chopper
                {
                    Commands->Send_Custom_Event(obj, myEvacController, 0,
                                                M01_MODIFY_YOUR_ACTION_JDG, 0);
                }
            }
...
DECLARE_SCRIPT(M01_Base_GDI_Grenadier_JDG, "") // 116383
{
    ...
    void Created(GameObject * obj) // this guy starts in the guard tower firing over at the conyard
    {
        ...
        Commands->Set_Innate_Is_Stationary(obj, true);
        Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                    10); // in 2 seconds run to a new position
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) {
            ...
            else if (param == M01_START_ATTACKING_01_JDG) // player is at top of ladders...check if
                                                          // nod minigunner is still alive
            {
                GameObject* nodMinigunner = Commands->Find_Object(116384);
                if (nodMinigunner != nullptr) {
                    params.Set_Basic(this, 100, M01_START_ATTACKING_01_JDG);
            ...
            else if (param == M01_GOING_TO_EVAC_SPOT_JDG) // your ride is here--go get in
            {
                ...
                if (myEvacController != nullptr) {
                    ...
                    Commands->Action_Goto(obj, params);
                     ...
                     && ducanRescued == false) // Head down the path
            {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            ...
            else if (action_id == M01_WALKING_WAYPATH_03_JDG) // you're over by the pows now...check
                                                              // if nod guy 02 is still alive
            {
                Commands->Send_Custom_Event(obj, obj, 0, M01_WALKING_WAYPATH_04_JDG, 0);
            }

            else if (action_id == M01_WALKING_WAYPATH_04_JDG) // your target is dead...make sure you
                                                              // go over to path
            {
                Vector3 myNewSpot(53.363f, 54.018f, -0.439f);
                Commands->Set_Innate_Is_Stationary(obj, false);
                ...
                Commands->Action_Goto(obj, params);
                     ...
                     == M01_WALKING_WAYPATH_05_JDG) // you're by path entrance...goto stationary
            {
                Commands->Set_Innate_Is_Stationary(obj, true);
            }

            else if (action_id == M01_WALKING_WAYPATH_06_JDG) // you just killed a back path
                                                              // guy...continue your journey
            {
                Vector3 newGotoSpot(111.210f, 85.507f, 8.934f);
                params.Set_Basic(this, 100, M01_WALKING_WAYPATH_06_JDG);
                params.Set_Movement(newGotoSpot, RUN, 1);
        ...
        if (enterer == STAR) {
            if (commandClearance == true) {
                ...
                { }
                    ...
                    int tunnelConv = Commands->Create_Conversation(
                        "M01_TunnelTank_Reminder_Conversation", 100, 30, false);
                    Commands->Join_Conversation(nullptr, tunnelConv, false, true, true);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (player_in_tank == false) {
            ...
            if (reminders == 1) {
                ...
                if (mediumTank != nullptr) {
                    reminderConv = Commands->Create_Conversation("M01_GetInTheTank_01_Conversation",
                                                                 100, 30, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, true, true);
                ...
                GameObject* mediumTank = Commands->Find_Object(tank_id);
                if (mediumTank != nullptr) {
                    reminderConv = Commands->Create_Conversation("M01_GetInTheTank_02_Conversation",
                                                                 100, 30, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, true, true);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                    Commands->Monitor_Conversation(obj, reminderConv);
...
DECLARE_SCRIPT(M01_Base_POW01_JDG, "") // 116386
{
    ...
    void Custom(GameObject * obj, int type, int param,
                GameObject* sender) // M01_POW02_Conversation_01
    {
        ActionParamsStruct params;
        ...
        if (type == 0) {
            if (param == M01_IVE_BEEN_KILLED_JDG) {
                ...
                Vector3 myEvacSpot = Commands->Get_Position(
            ...
            else if (action_id == M01_DOING_ANIMATION_03_JDG) // play the Havoc conversation
            {
                ...
                if (convController != nullptr) {
                    Commands->Send_Custom_Event(obj, convController, 0, M01_START_ACTING_JDG, 0);
                     ...
                     == M01_WALKING_WAYPATH_02_JDG) // gdi guy is at evac chopper--delete him
            {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id == M01_DOING_ANIMATION_02_JDG) // pow guy is standingup
            {
                ...
                Commands->Set_Innate_Is_Stationary(obj, true);
                     ...
                     == M01_DOING_ANIMATION_03_JDG) // pow guy is standingup  -- do cheer anim
            {
                char* animationName = M01_Choose_Cheer_Animation();
            ...
            else if (action_id == M01_DOING_ANIMATION_04_JDG) // pow guy is standingup  -- play
                                                              // havoc anim if pow01 is dead
            {
                GameObject* pow01 = Commands->Find_Object(116386);
                if (pow01 == nullptr) {
                    GameObject* convController = Commands->Find_Object(121237);
                    if (convController != nullptr) {
                        Commands->Send_Custom_Event(obj, convController, 0, M01_START_ACTING_JDG,
                                                    0);
                    }
                }
            }
                ...
                GameObject* sender) // M01_POW02_Conversation_01
    {
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG && convPlayed == false) {
                ...
                if (sender == pow01 && pow01 != nullptr) {
                    pow02conv01 = Commands->Create_Conversation("M01_POW02_Conversation_01", 100,
                                                                1000, false);
                ...
                else if (sender == pow02 && pow02 != nullptr) {
                    pow02conv01 = Commands->Create_Conversation("M01_POW02_Conversation_01", 100,
                                                                1000, false);
                ...
                if (pow01 != nullptr) // M01_GOTO_INNATE_JDG
                {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == pow02conv01) {
                ...
                GameObject* evacController
                    = Commands->Find_Object(M01_GDIBASE_POWSCENE02_MONITOR_JDG);
                if (evacController != nullptr) {
                    Commands->Send_Custom_Event(obj, evacController, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                0);
                }

                GameObject* gdiMinigunner = Commands->Find_Object(116382);
                if (gdiMinigunner != nullptr) {
                    Commands->Send_Custom_Event(obj, gdiMinigunner, 0,
                                                M01_MODIFY_YOUR_ACTION_05_JDG, 2);
                    // this tells him to start the "this is the path" routine
                }

                GameObject* backPathZone = Commands->Find_Object(121433);
                if (backPathZone != nullptr) {
...
DECLARE_SCRIPT(M01_GuardTower02_Sniper_Target01_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        if (reinforceController != nullptr) {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id
                == M01_WALKING_WAYPATH_01_JDG) // youre now in middle of field--start conversation
            {
                Commands->Set_Innate_Is_Stationary(obj, true);
                GameObject* guy02 = Commands->Find_Object(guy02_id);
                if (guy02 != nullptr) {
                    sniperConv = Commands->Create_Conversation("M01_SniperTower_Conversation", 100,
                                                               80, true);
                    ...
                    Commands->Monitor_Conversation(obj, sniperConv);
                     ...
                     == M01_WALKING_WAYPATH_02_JDG) // youre now at the tailguns--allow hibernation
            {
                Commands->Enable_Hibernation(obj, true);
            }

            else if (action_id == M01_DOING_ANIMATION_01_JDG) // youre looked around--now set curent
                                                              // position as home spot
            {
                Commands->Set_Innate_Is_Stationary(obj, false);
                Vector3 myPosition = Commands->Get_Position(obj);
                Commands->Set_Innate_Soldier_Home_Location(obj, myPosition, 5);
...
DECLARE_SCRIPT(M01_GuardTower02_Sniper_TowerZone_JDG, "") // 123645
{
    ...
    {
        if (type == 0) {
            if (param == M01_IVE_BEEN_KILLED_JDG) // a sniper targets been killed--check player
                                                  // position and spawn new target if needed
            {
                if (player_in_zone == true) {
                    ...
                    if (targets_killed == 1) {
                        ...
                        GameObject* new_sniperTarget
                            = Commands->Create_Object("Nod_MiniGunner_0", spawnLocation02);
                        Commands->Attach_Script(new_sniperTarget,
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                ...
                Commands->Action_Goto(obj, params);
                     ...
                     == M01_IVE_BEEN_KILLED_JDG) // your buddy's been capped--do look around anim
            {
                Commands->Action_Reset(obj, 100);
                params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
                params.Set_Animation("H_A_A0A0_L21", false);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (obj && type == 0) {
            if (param == M01_WALKING_WAYPATH_01_JDG && player_in_warroom == false) {
                float handOfNodHealth
                    = Commands->Get_Health(Commands->Find_Object(M01_HAND_OF_NOD_JDG));
            ...
            else if (param == M01_GOTO_INNATE_JDG) // escort scenario is over--go to top of HON and
                                                   // goto innate
            {
                escorting = false;
                Commands->Set_Innate_Is_Stationary(obj, false);
                ...
                Commands->Send_Custom_Event(obj, obj, 0, M01_GOTO_INNATE_JDG, 5);
                     ...
                     && escorting == true) // pick a sound to play
            {
                /*Vector3 myPosition = Commands->Get_Position ( obj );
                Vector3 playerPosition = Commands->Get_Position ( STAR );
                ...
                if (distance <= 8)
                {
                        ...
                        {
                                Commands->Create_Sound ( "MX1DSGN_DSGN0024I1DSGN_SND", myPosition,
                obj );//follow us inside
                        }

                        else if (dialogs_said_to_havoc == 1)
                        {
                                Commands->Create_Sound ( "MX1DSGN_DSGN0027I1DSGN_SND", myPosition,
                obj );//this way sir
                        }
                ...
                else
                {
                        if (dialogs_said == 0)
                        {
                                Commands->Create_Sound ( "MX1DSGN_DSGN0025I1DSGN_SND", myPosition,
                obj );//lets do it
                        }

                        else if (dialogs_said == 1)
                        {
                                Commands->Create_Sound ( "MX1DSGN_DSGN0026I1DSGN_SND", myPosition,
                obj );
                        }

                        else if (dialogs_said == 2)
                        {
                                Commands->Create_Sound ( "MX1DSGN_DSGN0028I1DSGN_SND", myPosition,
                obj );
                        }
        ...
        if (obj && type == 0) {
            if (param == M01_ROPE_IS_SENDING_ID_JDG) // gdi guy 01 is actually sending his id
            {
                gdiGuy01_id = Commands->Get_ID(sender);
                     ...
                     == M01_WAYPATH_IS_SENDING_ID_JDG) // gdi guy 02 is actually sending his id
            {
                ...
                if (commandClearance == true && player_in_warroom == true) {
                    ...
                    if (gdiGuy01 != nullptr && convPlaying == false) {
                        convPlaying = true;
                        hon_gdi_guy_conv1
                            = Commands->Create_Conversation("M01_GDI_HON_MCT", 100, 1000, false);
                    ...
                    else if (gdiGuy02 != nullptr && convPlaying == false) {
                        convPlaying = true;
                        hon_gdi_guy_conv1
                            = Commands->Create_Conversation("M01_GDI_HON_MCT", 100, 1000, false);
        ...
        if (obj && type == 0) {
            ...
            else if (param == M01_PLAYER_IS_OUTSIDE_REFINERY_JDG) // player just left the warroom
            {
                ...
                if (dead_soldier_tally == 2) {
                    ...
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-147.1f, 558.8f, 4.4f));
                    Commands->Set_Facing(chinook_obj1, -130.00f);
                    Commands->Attach_Script(chinook_obj1, "Test_Cinematic",
                                            "X1I_GDI_HON_TroopDrop01a.txt");
                }
...
DECLARE_SCRIPT(M01_Medium_Tank01_JDG, "") { void Created(GameObject * obj) {
    GameObject* hovercraftExplosionController = Commands->Find_Object(121839);
if (hovercraftExplosionController != nullptr) {
    Commands->Send_Custom_Event(obj, hovercraftExplosionController, 0, M01_MEDIUM_TANK_IS_HERE_JDG,
                                0);
}
}
}
...
DECLARE_SCRIPT(M01_CantBring_MediumTank_ThroughHereZone_JDG, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (enterer == tank) {
            ...
            {
                int hoofit_conv = Commands->Create_Conversation("M01_Must_Leave_Tank_Conversation",
                                                                100, 100, true);
                Commands->Join_Conversation(nullptr, hoofit_conv, true, true);
...
DECLARE_SCRIPT(M01_Medium_Tank_JDG, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        if (tunnelZone != nullptr) {
            Commands->Send_Custom_Event(obj, tunnelZone, M01_MEDIUM_TANK_IS_HERE_JDG,
                                        m01_medium_tank_ID, 0);
        }

        GameObject* honSamSite = Commands->Find_Object(M01_HON_SAM_SITE_JDG);
        if (honSamSite != nullptr) {
            Commands->Send_Custom_Event(obj, honSamSite, M00_CUSTOM_SAM_SITE_IGNORE,
                                        m01_medium_tank_ID, 0);
        }

        GameObject* fodderHovercraftController = Commands->Find_Object(121630);
        if (fodderHovercraftController != nullptr) {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender) //
    {
        if (type == CUSTOM_EVENT_VEHICLE_ENTERED) {
            if (firstTimeEntered == true) {
                ...
                GameObject* tunnelGuy01
                    = Commands->Create_Object("Nod_Minigunner_0", guy01Position);
                GameObject* tunnelGuy02
                    = Commands->Create_Object("Nod_Minigunner_0", guy02Position);
                GameObject* tunnelGuy03
                    = Commands->Create_Object("Nod_Minigunner_0", guy03Position);
            ...
            GameObject* tankReminderZone = Commands->Find_Object(122848);
            if (tankReminderZone != nullptr) {
                Commands->Send_Custom_Event(obj, tankReminderZone, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                            0);
            }
            ...
            GameObject* tankReminderZone = Commands->Find_Object(122848);
            if (tankReminderZone != nullptr) {
                Commands->Send_Custom_Event(obj, tankReminderZone, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                            0);
            }

            GameObject* tankBarrierZone = Commands->Find_Object(125661);
            if (tankBarrierZone != nullptr) {
                Commands->Send_Custom_Event(obj, tankBarrierZone, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                            0);
            }
        }
    }
...
DECLARE_SCRIPT(M01_TurretBeach_FodderHovercraft_Controller_JDG, "") // 121630  M01_START_ACTING_JDG
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param == M01_START_ACTING_JDG
                && hovercraftAlive
                    == false) // turret objective has been added--start bringing in hovercraft
            {
                GameObject* oldHovercraft = Commands->Find_Object(hovercraft_ID);
                if (oldHovercraft == nullptr) {
                    hovercraftAlive = true;
                    GameObject* hovercraft
                        = Commands->Create_Object("Invisible_Object", Vector3(0, 0, 0));
                    Commands->Attach_Script(hovercraft, "Test_Cinematic",
                                            "X1D_FodderHover_MTank.txt");
                }
            ...
            else if (param == 0) // hovercraft is sending you its ID
            {
                ...
                GameObject* turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
                if (turret01 != nullptr) {
                    Commands->Send_Custom_Event(obj, turret01, M01_FODDER_HOVERCRAFT_IS_HERE,
                                                hovercraft_ID, 1);
                }

                GameObject* turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
                if (turret02 != nullptr) {
                    Commands->Send_Custom_Event(obj, turret02, M01_FODDER_HOVERCRAFT_IS_HERE,
                                                hovercraft_ID, 1);
                }
...
DECLARE_SCRIPT(M01_Hovercraft_Explosion_Controller_JDG, "") // 121839
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            else if (param == M01_IVE_BEEN_KILLED_JDG) // hovercraft has been destroyed--delete tank
                                                       // and play explosion
            {
                GameObject* mediumTank = Commands->Find_Object(tank_id);
                if (mediumTank != nullptr) {
                    // Commands->Destroy_Object ( mediumTank );
                    Commands->Apply_Damage(mediumTank, 100000, "Steel", nullptr);
                }
            }
        }
    }
...
DECLARE_SCRIPT(M01_FodderHovercraft_Script_JDG, "") { void Created(GameObject * obj) {
    GameObject* fodderHovercraftController = Commands->Find_Object(121630);
if (fodderHovercraftController != nullptr) {
...
// if (hovercraftExplosionController != nullptr)
//{
//	Commands->Send_Custom_Event( obj, hovercraftExplosionController, 0,
//M01_CHOPPER_IS_SENDING_ID_JDG, 0 );
// }
...
{
    // Vector3 myPosition = Commands->Get_Position ( obj );
    // Commands->Create_Explosion ( "Ground Explosions Twiddler", myPosition, nullptr );
    ...
    GameObject* hovercraftExplosionController = Commands->Find_Object(121839);
    if (hovercraftExplosionController != nullptr) {
        Commands->Send_Custom_Event(obj, hovercraftExplosionController, 0, M01_IVE_BEEN_KILLED_JDG,
                                    0);
    }
}
...
DECLARE_SCRIPT(M01_DataDisc_TextController_JDG, "") // 117188
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            {
                playingText = true;
                int pressEnterConv = Commands->Create_Conversation(
                    "M01_Press_ESC_for_Map_Conversation", 100, 1000, true);
                Commands->Join_Conversation(nullptr, pressEnterConv, false, false);
                Commands->Start_Conversation(pressEnterConv, pressEnterConv);

                Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0517I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            if (param == 1
                && playingText == false) // player has picked up a C4 -- start text routine
            {
                int pressF1Conv = Commands->Create_Conversation("M01_C4_Tutorial_Conversation", 100,
                                                                1000, true);
                Commands->Join_Conversation(nullptr, pressF1Conv, false, false);
                Commands->Start_Conversation(pressF1Conv, pressF1Conv);
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0519I1DSGN_TXT,
                ...
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0523I1DSGN_TXT,
                ...
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0524I1DSGN_TXT,
        ...
        else if (type == 2) // player has picked up sniper rifle
        {
            if (param == 1
                && playingText == false) // player has picked up a C4 -- start text routine
            {
                int pressF1Conv = Commands->Create_Conversation("M01_Sniper_Tutorial_Conversation",
                                                                100, 1000, true);
                Commands->Join_Conversation(nullptr, pressF1Conv, false, false);
                Commands->Start_Conversation(pressF1Conv, pressF1Conv);
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0518I1DSGN_TXT,
                ...
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0521I1DSGN_TXT,
                ...
                Commands->Set_HUD_Help_Text(
                    IDS_M01DSGN_DSGN0522I1DSGN_TXT,
...
DECLARE_SCRIPT(M01_Duncan_Assailer_JDG, "") { void Killed(GameObject * obj, GameObject* killer) {
    GameObject* convController = Commands->Find_Object(125857);
if (convController != nullptr) {
    Commands->Send_Custom_Event(obj, convController, 0, M01_IVE_BEEN_KILLED_JDG, 0);
}
            ...
            if (param == M01_IVE_BEEN_KILLED_JDG) {
                ...
                if (deadNodGuys >= 4) {
                    Commands->Send_Custom_Event(obj, obj, 0, M01_START_ACTING_JDG, 2);
                     ...
                     && duncanDiscovered == false) // start playing "in here" conversation
            {
                GameObject* captDuncan = Commands->Find_Object(106050);
                if (captDuncan) {
                    int inhere_conv = Commands->Create_Conversation("M01_DuncanInHere_Conversation",
                                                                    100, 20, false);
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    if (type == 0) {
        if (param == M01_MODIFY_YOUR_ACTION_JDG) {
            GameObject* gdiMinigunner = Commands->Find_Object(116382);
            if (gdiMinigunner != nullptr) {
                Commands->Send_Custom_Event(obj, gdiMinigunner, 0, M01_MODIFY_YOUR_ACTION_06_JDG,
                                            0);
                // this tells him to start the "this is the path" routine
...
DECLARE_SCRIPT(M01_Base_GDI_Minigunner_JDG, "") // 116382
{
    ...
    void Created(GameObject * obj) // this guy starts in the guard tower firing over at the conyard
    {
        ...
        Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                    2); // in 2 seconds run to a new position
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) {
            if (param == M01_MODIFY_YOUR_ACTION_JDG) // leave the guard tower and take up second
                                                     // position outside guard tower
            {
                ...
                GameObject* controller1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-74.184f, -28.372f, 3.157f));
                Commands->Set_Facing(controller1, 90);
                Commands->Attach_Script(controller1, "Test_Cinematic", "X01D_C130Troopdrop.txt");
            }

            else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // leave outside guard tower and take
                                                             // up third position beside the ladder
            {
            ...
            {
                GameObject* controller1
                    = Commands->Create_Object("Invisible_Object", Vector3(34.165f, 41.909f, -10));
                ...
                if (nodMinigunner != nullptr) {
                    ...
                    Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG,
                     ...
                     == M01_MODIFY_YOUR_ACTION_03_JDG) // greet havoc M01_GDI01_Conversation_01
            {
                Vector3 playersPosition = Commands->Get_Position(STAR);
                ActionParamsStruct params;
                params.Set_Basic(this, 100, M01_START_ACTING_JDG);
                ...
                gdi01conv01
                    = Commands->Create_Conversation("M01_GDI01_Conversation_01", 100, 1000, false);
                ...
                GameObject* grenadier = Commands->Find_Object(116383);
                if (grenadier != nullptr) {
                    Commands->Send_Custom_Event(obj, grenadier, 0, M01_START_ACTING_JDG,
                                                0); // tell grenadier to greet havoc
                }
            }
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_04_JDG) // now add the pow objective
            {
                ...
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
                                                M01_GDI_BASE_POW_OBJECTIVE_JDG, 0);
                }
            }
                     ...
                     && headingDownBackPath == false) // POW conversation is over---wave at havoc
            {
                if (havocDownPath == false) {
                    ...
                    gdi01conv03 = Commands->Create_Conversation("M01_GDI01_Conversation_05", 100,
                                                                1000, false);
                    ...
                    Commands->Monitor_Conversation(obj,
                                                   gdi01conv03); // M01_MODIFY_YOUR_ACTION_06_JDG
                }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            ...
            else if (action_id == M01_GOING_TO_EVAC_SPOT_JDG) // start load animation here
            {
                ...
                if (myEvacController != nullptr) // tell controller to spawn a rope
                {
                    Commands->Send_Custom_Event(obj, myEvacController, 0, M01_GIVE_ME_A_ROPE_JDG,
                     ...
                     == M01_WALKING_WAYPATH_03_JDG) // you are by pows now...run to path entrance
                                                    // and attack nod guy 01 if still alive
            {
                Commands->Send_Custom_Event(obj, obj, 0, M01_WALKING_WAYPATH_04_JDG, 0);
            }

            else if (action_id == M01_WALKING_WAYPATH_04_JDG) // Youre target is dead....make sure
                                                              // you goto path entrance.
            {
                Vector3 myNewSpot(58.784f, 55.223f, -0.551f);
            ...
            else if (action_id == M01_WALKING_WAYPATH_05_JDG) // Youre at the back path entrance
                                                              // now....goto stationary
            {
                Commands->Set_Innate_Is_Stationary(obj, true);
            }
            ...
            if (action_id == gdi01conv01) {
                gdi01conv02
                    = Commands->Create_Conversation("M01_GDI01_Conversation_02", 100, 1000, false);
                ...
                // invincible = false;
                Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0506I1GCP1_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
