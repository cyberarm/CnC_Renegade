...
// Jani: MSVC doesn't necessarily inline code with inline keyword. Using __forceinline results
// better inlining and also prints out a warning if inlining wasn't possible. __forceinline is MSVC
// specific.
#if defined(_MSC_VER)
