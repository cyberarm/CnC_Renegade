...
DECLARE_SCRIPT(MDD_Objective_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        // DEMO Commands->Add_Objective(201, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
        // IDS_M02_OBJECTIVE_01); DEMO Commands->Add_Objective(222, OBJECTIVE_TYPE_TERTIARY,
        // OBJECTIVE_STATUS_HIDDEN, IDS_M02_OBJECTIVE_22); DEMO Commands->Add_Objective(223,
        // OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, IDS_M02_OBJECTIVE_23);
    }
...
DECLARE_SCRIPT(MDD_Respawn_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        // DEMO GameObject * chinook_obj1 = Commands->Create_Object("Invisible_Object",
        // Vector3(0,0,0));
        /*if (chinook_obj1)
        {
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        // DEMO
            ...
            GameObject* buggy
                = Commands->Create_Object("GDI_Orca", Vector3(506.590f, 470.752f, -40.590f));
            if (buggy) {
            ...
            GameObject* buggy
                = Commands->Create_Object("Nod_Apache", Vector3(587.296f, 504.567f, -44.034f));
            if (buggy) {
...
DECLARE_SCRIPT(MDD_Stationary_Vehicle, "Area_ID:int") {
    void Created(GameObject * obj) { // DEMO
...
DECLARE_SCRIPT(MDD_Nod_Stealth, "")
{
    ...
    {
        GameObject* nodtank
            = Commands->Create_Object("Nod_Stealth_Tank", Vector3(598.777f, 479.691f, -55.824f));
        if (nodtank) {
...
DECLARE_SCRIPT(MDD_Commando,
               "") { void Created(GameObject * obj) { Commands->Control_Enable(obj, false);
Commands->Set_Shield_Type(obj, "Blamo");
}
}
;
