...
DECLARE_SCRIPT(M03_Objective_Controller, "") // 1100004
{
    ...
    void Created(GameObject * obj)
    {
        ...
        rain = true;
        //	Commands->Add_Objective(1006, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
        //1008, IDS_Enc_ObjTitle_Hidden_M03_02, nullptr, IDS_Enc_Obj_Hidden_M03_02);
        //	Commands->Add_Objective(1007, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_HIDDEN,
        //1009); 	Commands->Add_Objective(1008, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
        //1010); 	Commands->Add_Objective(1009, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
        //1011,IDS_Enc_ObjTitle_Hidden_M03_02, nullptr, IDS_Enc_Obj_Hidden_M03_02);
        //	Commands->Add_Objective(1010, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
        //1019); 	Commands->Add_Objective(1011, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
        //1020, IDS_Enc_ObjTitle_Hidden_M03_02, nullptr, IDS_Enc_Obj_Hidden_M03_02);
        //	Commands->Add_Objective(1012, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
        //1021, IDS_Enc_ObjTitle_Hidden_M03_02, nullptr, IDS_Enc_Obj_Hidden_M03_02);
        ...
        if (reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == 1) {
                Commands->Add_Objective(1002, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Secondary_M03_02, nullptr,
                                        IDS_Enc_Obj_Secondary_M03_02);
                object = Commands->Find_Object(300056);
                if (object) {
                    Commands->Set_Objective_Radar_Blip_Object(1002, object);
                    Commands->Set_Objective_HUD_Info(
                        1002, 94, "POG_M03_2_02.tga",
            ...
            if (action_id == 2) {
                Commands->Add_Objective(1004, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Secondary_M03_03, nullptr,
                                        IDS_Enc_Obj_Secondary_M03_03);
                object = Commands->Find_Object(1205777);
                if (object) {
                    Commands->Set_Objective_Radar_Blip_Object(1004, Commands->Find_Object(1205777));
                    Commands->Set_Objective_HUD_Info(
                        1004, 97, "POG_M03_2_02.tga",
                        IDS_POG_DESTROY /*, Commands->Get_Position (object)*/);
                    Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1004,
                                                SECONDARY_POG_DELAY);
                }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 100063) {
            Commands->Send_Custom_Event(Commands->Find_Object(1100004),
                                        Commands->Find_Object(1100012), 999, 0, 0);
        }
    }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == 1004) {
            // Commands->Create_Object("Level_3_Objective_Powerup_Temp",
            // Vector3(48.3f, 79.2f, 21.0f));

            GameObject* chinook_obj
                = Commands->Create_Object("Invisible_Object", Vector3(47.70f, 78.07f, 20.26f));
    ...
    void Add_Mission_Objective(int id)
    {
        ...
        case 1000: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M03_01, nullptr,
                                    IDS_Enc_Obj_Primary_M03_01);
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    1000, 96, "POG_M03_1_01.tga", IDS_POG_LOCATE, Commands->Get_Position(object));
            }
        ...
        case 1001: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M03_01, nullptr,
                                    IDS_Enc_Obj_Secondary_M03_01);
            object = Commands->Find_Object(1212283);
            if (object) {
                Commands->Debug_Message("object found");
                Commands->Set_Objective_Radar_Blip_Object(id, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1001, 99, "POG_M03_2_01.tga", IDS_POG_DEFEAT, Commands->Get_Position(object));
                Commands->Send_Custom_Event(controller, controller, REMOVE_SECONDARY_POG, id,
                                            SECONDARY_POG_DELAY);
            }
        ...
        case 1002: {
            ...
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1002, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1002, 98, "POG_M03_2_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(controller, controller, REMOVE_SECONDARY_POG, id,
                                            SECONDARY_POG_DELAY);
            }
        ...
        case 1004:
            ...
            break;
        case 1006: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Hidden_M03_01, nullptr,
                                    IDS_Enc_Obj_Hidden_M03_01);
            Commands->Start_Timer(controller, this, 4.0f, 912);
        } break;
        case 1007: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M03_02, nullptr,
                                    IDS_Enc_Obj_Primary_M03_02);
            object = Commands->Find_Object(1215546);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1007, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1007, 95, "POG_M03_1_02.tga", IDS_POG_LOCATE, Commands->Get_Position(object));
            }
        ...
        case 1008: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M03_03, nullptr,
                                    IDS_Enc_Obj_Primary_M03_03);
            object = Commands->Find_Object(1100009);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1008, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1008, 94, "POG_M03_1_03.tga", IDS_POG_ACCESS, Commands->Get_Position(object));
            }
        ...
        case 1009:
            Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Hidden_M03_02, nullptr,
                                    IDS_Enc_Obj_Hidden_M03_02);
            break;
        case 1010: {
            Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M03_04, nullptr,
                                    IDS_Enc_Obj_Primary_M03_04);
            object = Commands->Find_Object(1213908);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1010, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1010, 93, "POG_M03_1_04.tga", IDS_POG_ESCAPE, Commands->Get_Position(object));
            }
        ...
        case 1011:
            Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Hidden_M03_03, nullptr,
                                    IDS_Enc_Obj_Hidden_M03_03);
            break;
        case 1012:
            Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Hidden_M03_04, nullptr,
                                    IDS_Enc_Obj_Hidden_M03_04);
            break;
        }
    }
    ...
    void Complete_Mission_Objective(int id)
    {
        ...
        if (id == 1002) {
            ...
            if (sam_count_1 >= 2) {
                ...
                // Commands->Create_Object("Level_3_Objective_Powerup_Temp", Vector3(73.624f,
                // -78.110f, 0.7f));

                GameObject* chinook_obj
                    = Commands->Create_Object("Invisible_Object", Vector3(73.0f, -80.04f, 0.2f));
                Commands->Set_Facing(chinook_obj, 0.0f);
                Commands->Attach_Script(chinook_obj, "Test_Cinematic", "X3I_GDI_Drop_PowerUp.txt");
        ...
        if (id == 1001) {
            // Commands->Create_Object("Level_3_Objective_Powerup_Temp", Vector3(-94.945f,
            // -66.073f, 2.0f));

            GameObject* chinook_obj
                = Commands->Create_Object("Invisible_Object", Vector3(-96.2f, -75.8f, 1.4f));
            Commands->Set_Facing(chinook_obj, 0.0f);
            Commands->Attach_Script(chinook_obj, "Test_Cinematic", "X3I_GDI_Drop_PowerUp.txt");
...
DECLARE_SCRIPT(RMV_Test_Big_Gun_Turning, "")
{
    ...
    void Sound_Heard(GameObject * obj, const CombatSound& sound)
    {
        if (sound.Type == SOUND_TYPE_DESIGNER04) {
            ...
            // Commands->Apply_Damage ( Commands->Find_Object(1100003), 20.0f, "EXPLOSIVE",
            // Commands->Find_Object(1100002));
            if (!gunboat_warned) {
...
DECLARE_SCRIPT(M03_Gunboat_Controller_RMV,
               ...
               "Beach_Destination:vector3, Village_Start:vector3, Village_Destination:vector3, "
               "Cannon_Start:vector3, Cannon_Destination:Vector3, Receive_Param_Destroy:int")
{
    typedef enum
    {
        STATE_AT_BEACH,
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if ((type == Get_Int_Parameter("Receive_Type"))
            && (param == Get_Int_Parameter("Receive_Param_Destroy"))) {
            Commands->Destroy_Object(obj);
            return;
        }
        if ((type == Get_Int_Parameter("Receive_Type"))
            ...
            /*	// Turn off beach bunkers
                    if (Commands->Find_Object(1000001)) {
                            Commands->Send_Custom_Event(obj, Commands->Find_Object(1000001), 3000,
               3000);
                    }
                    if (Commands->Find_Object(1000002)) {
                            Commands->Send_Custom_Event(obj, Commands->Find_Object(1000002), 3000,
               3000);
                    }
                    if (Commands->Find_Object(1000003)) {
                            Commands->Send_Custom_Event(obj, Commands->Find_Object(1000003), 3000,
               3000);
                    } */
        ...
        if ((type == Get_Int_Parameter("Receive_Type"))
            && (param == Get_Int_Parameter("Receive_Param_For_Cannon"))) {
...
01-I024E	"Secondary power grid has been taken offline. Tertiary grid surplus being
redirected." 01-I026E	"Power core radiation levels vacillating." 01-I050E	"Do you know someone
who would make a positive addition to the Brotherhood? Now they can enlist online at 'WWW dot
BrotherhoodRecruitment dot Nod' " 01-I062E	"Immediately report the presence of visceroids to
your supervisor." 01-I066E	"Workers found loitering in this area will be terminated." 01-I076E
"Hazmat suits are required for your safety." 01-I078E	"Please do not inhale decontamination
agents."
...
DECLARE_SCRIPT(M03_Announce_PowerPlant_Controller_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == stop_announcements) { }
            ...
            char* sounds[19] = { "01-i000e", "01-i002e", "01-i004e", "01-i006e", "01-i008e",
                                 "01-i010e", "01-i012e", "01-i014e", "01-i016e", "01-i018e",
                                 "01-i020e", "01-i024e", "01-i026e", "01-i050e", "01-i062e",
                                 "01-i066e", "01-i076e", "01-i078e", "01-i022e" };
            char* soundName;
            ...
            if ((lineNumber >= 0.5) && (lineNumber < 1.5)) {
                ...
                // soundName = "01-i012e";
                sound = 6;
                // 01-I012E	"Tertiary coolant system malfunctioning.  Dispatch technician
                // immediately."
                ...
                // soundName = "01-i014e";
                sound = 7;
                // 01-I014E	"Comm Center power demands have fallen.  Diverting power to
                // secondary grid."
                ...
                // soundName = "01-i018e";
                sound = 9;
                // 01-I018E	"Critical failure potential increasing. Reallocate available
                // engineers."
...
01-i052E	"The yellow zone is for harvester unloading only. There is no parking in the yellow
zone." 01-i054E	"Harvester approaching. Please clear docking bay at once."  Only plays when
harvester is approaching. 01-i056E	"Harvester now unloading" 01-i058E	"Smoking is not
permitted within the refinery." 01-i060E	"Leaking barrels are a health hazard. Report any
faulty containment vessels to your supervisor immediately." 01-i062E	"Immediately report the
presence of visceroids to your supervisor." 01-i064E	"Do not discharge weapons near containment
barrels." 01-i066E	"Workers found loitering in this area will be terminated." 01-i068E	"For
your safety, avoid all moving parts." 01-i070E	"Supply trucks have the right of way." 01-i072E
"Tiberium field omega has decreased in size. Changing harvester target to facilitate growth."
...
01-i094E	"Polarized safety goggles are mandatory while working under the Ultra Violet
lights." 01-i096E	"Distiller fumes are toxic. Avoid inhaling any gasses in this area."
...
DECLARE_SCRIPT(M03_Announce_Refinery_Controller_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == stop_announcements) { }
            ...
            char* sounds[28]
                = { "01-i010E", "01-i022E", "01-i032E", "01-i034E", "01-i052E", "01-i054E",
                    "01-i056E", "01-i058E", "01-i060E", "01-i062E", "01-i064E", "01-i066E",
                    "01-i068E", "01-i070E", "01-i072E", "01-i074E", "01-i076E", "01-i078E",
                    "01-i080E", "01-i082E", "01-i084E", "01-i086E", "01-i088E", "01-i090E",
                    "01-i092E", "01-i094E", "01-i096E", "01-i098E" };
            ...
            if ((lineNumber >= 0.5) && (lineNumber < 1.5)) {
                ...
                // soundName = "01-i032e";
                sound = 1;
                // 01-i032E	"A visceroid has been spotted in Tiberium Field iota. Containment
                // team en route."
                ...
                // soundName = "01-i054e";
                sound = 4;
                // 01-i054E	"Harvester approaching. Please clear docking bay at once."  Only
                // plays when harvester is approaching.
                ...
                // soundName = "01-i072e";
                sound = 13;
                // 01-i072E	"Tiberium field omega has decreased in size. Changing harvester
                // target to facilitate growth."
                ...
                // soundName = "01-i074e";
                sound = 14;
                // 01-i074E	"Additional tests are required for current Tiberium batch. Highest
                // priority."
                ...
                // soundName = "01-i080e";
                sound = 17;
                // 01-i080E	"Quarternary gas vacuum has malfunctioned. Backup compressors are
                // now on line."
...
01-I032E	"A visceroid has been spotted in Tiberium Field iota. Containment team en route."
01-I034E	"Tiberium value is increasing Worldwide."
01-I036E	"Project 'Ezekiel's Cape' has passed initial tests.  Prototypes are now in
production." 01-I038E	"Colonel Shepard's personal aide has been located in Washington D.C.
Aquisition team en route." 01-I040E	"Anamolous EVA signal detected.  Reconnaissance force is
being dispatched." 01-I042E	"World wide public opinion of the Brotherhood is on the rise."
...
01-I048E	"Incoming transmission for Captain Jones.  Captain Jones please report to a secured
terminal." 01-I050E	"Do you know someone who would make a positive addition to the Brotherhood?
Now they can enlist online at 'WWW dot BrotherhoodRecruitment dot Nod' " 01-I062E	"Immediately
report the presence of visceroids to your supervisor." 01-I066E	"Workers found loitering in this
area will be terminated."
*/
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == stop_announcements) { }
            ...
            if ((lineNumber >= 0.5) && (lineNumber < 1.5)) {
                ...
                // soundName = "01-i036e";
                sound = 5;
                // 01-I036E	"Project 'Ezekiel's Cape' has passed initial tests.  Prototypes are
                // now in production."
                ...
                // soundName = "01-i038e";
                sound = 6;
                // 01-I038E	"Colonel Shepard's personal aide has been located in Washington D.C.
                // Aquisition team en route."
                ...
                // soundName = "01-i040e";
                sound = 7;
                // 01-I040E	"Anamolous EVA signal detected.  Reconnaissance force is being
                // dispatched."
                ...
                // soundName = "01-i044e";
                sound = 9;
                // 01-I044E	"Refinery technicians have failed to report in.  Investigation team
                // en route."
                ...
                // soundName = "01-i046e";
                sound = 10;
                // 01-I046E	"Possible EVA intrusion in message squirt Alpha. Switching to Beta
                // channels."
                ...
                // soundName = "01-i048e";
                sound = 11;
                // 01-I048E	"Incoming transmission for Captain Jones.  Captain Jones please
                // report to a secured terminal."
...
DECLARE_SCRIPT(M03_Inlet_Soldier_GDI, "Number:int") {
    void Created(GameObject * obj) { int num = Get_Int_Parameter("Number");
switch (num) {
case 0:
        ...
        if (type == 2000) {
            ...
            if ((current[param] >= count) && (active[param]) && Commands->Find_Object(1100003)) {
                ...
                case 0: { /*const char *beach;
                                 ...
                                 con = Commands->Create_Object(beach, Vector3(-84.609f,
                             -91.188f, 1.0f)); Commands->Set_Facing(con, 100.0f);*/

                    GameObject* new_obj = Commands->Create_Object(
                        "Invisible_Object", Vector3(-84.609f, -91.188f, 1.0f));
...
DECLARE_SCRIPT(M03_Chinook_Spawned_Soldier_GDI,
               "Area:int, Send_Type_When_Killed:int, Target_ID:int")
{
    int area, send_type, target_id, nullptr_count;
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (nullptr_count < 3) {
            // target = Commands->Find_Closest_Soldier(Commands->Get_Position(obj), 0.0f, 50.0f,
            // true);
        }
        if ((target == nullptr) && (nullptr_count < 3)) {
            nullptr_count++;
        }
        if (!in_place) {
            en_route = false;
        }
        if ((nullptr_count < 3) && (target) && (!in_place)) {
            ActionParamsStruct params;
...
DECLARE_SCRIPT(M03_Flyover_Controller, "")
{
    ...
    {
        char* flyovers[17]
            = { "A-10_1.txt", "A-10_2.txt", "A-10_3.txt", "A-10_4.txt", "A-10_5.txt", "A-10_6.txt",
...
DECLARE_SCRIPT(M03_Chinook_Fodder_Creator,
               "") { void Custom(GameObject * obj, int type, int param, GameObject* sender) {
    if (Commands->Find_Object(1100003) == nullptr) { return;
}
...
void Timer_Expired(GameObject* obj, int timer_id)
{
    if (timer_id == 9998) {
        ...
        // Commands->Attach_Script(obj, "M03_Chinook_Troop_Drop", "ChinookTest.txt, 78.08
        // -36.88 1.20, 130.00");
    }
}
...
DECLARE_SCRIPT(M03_Tailgun,
               "Controller_ID:int") { void Killed(GameObject * obj, GameObject* killer) {
    GameObject* con = Commands->Find_Object(Get_Int_Parameter("Controller_ID"));
if (con) {
...
DECLARE_SCRIPT(M03_Tailgun_Fodder,
               "") { void Created(GameObject * obj) { Commands->Action_Reset(obj, 99);
GameObject* star = Commands->Get_A_Star(Commands->Get_Position(obj));
if (star) {
    ActionParamsStruct params;
    params.Set_Basic(this, 99, 0);
...
DECLARE_SCRIPT(M03_Tiberium_Cave_Stay_Put, "") { void Created(GameObject * obj) {
    Commands->Set_Innate_Soldier_Home_Location(obj, Commands->Get_Position(obj), 10.0f);
}
}
;

DECLARE_SCRIPT(M03_Big_Gun_Explosion, "") { void Created(GameObject * obj) {
...
DECLARE_SCRIPT(M03_Base_Patrol,
               "WaypathID:int") { void Created(GameObject * obj) { ActionParamsStruct params;
    ...
    "Tiberium_Loc:vector3, Dock_Location:vector3, Dock_Entrance:vector3, Sakura_Dest:vector3")
{
    ...
    void Animation_Complete(GameObject * obj, const char* anim)
    {
        ...
        if (harvest_count >= 4) {
            ...
            params.Dock_Vehicle(Get_Vector3_Parameter("Dock_Location"),
                                Get_Vector3_Parameter("Dock_Entrance"));
...
#define BEACH_FACING -180.0f
    ...
    /*void Reinforce(void)
    {
            ...
            /*if (inlet_active)
            {
                    ...
                    {
                            Commands->Start_Timer(Commands->Find_Object (1144444), this, 3.0f,
    INLET_REINFORCE);
                    }
            }*/
    ...
    /*else if (base_active)
    {
            ...
            GameObject * con = Commands->Create_Object("Invisible_Object", (switcher) ?
    BASE_POSITION1 : BASE_POSITION2); Commands->Set_Facing(con, (switcher) ? BASE_FACING1 :
    BASE_FACING2); Commands->Attach_Script(con, "M03_Chinook_ParaDrop", "M03_Paratrooper"); if
    (!forced)
            {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 6000 && param == 6000) {
            if ((beach_active && target_killed[0] != 1000)
                || (inlet_active && target_killed[1] != 1000)
        ...
        if (type == 1000 && param == 1000 && (inlet_active || base_active || beach_active)) {
            count++;
            if ((beach_active && count >= target_killed[0])
                || (inlet_active && count >= target_killed[1])
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == INLET_REINFORCE) {
            ...
            GameObject* con = Commands->Create_Object(
                "Invisible_Object", (switcher) ? INLET_POSITION1 : INLET_POSITION2);
...
DECLARE_SCRIPT(M03_Officer_With_Key_Card, "") {
    void Killed(GameObject * obj, GameObject* killer) { if (!Commands->Has_Key(killer, 1)) {
...
DECLARE_SCRIPT(M03_Officer_With_Key_Card2, "") {
    void Killed(GameObject * obj, GameObject* killer) { if (!Commands->Has_Key(killer, 2)) {
        Vector3 pos = Commands->Get_Position(obj) + Vector3(0, 0, 0.5);
...
DECLARE_SCRIPT(M03_No_More_Parachute, "") { void Destroyed(GameObject * obj) {
...
DECLARE_SCRIPT(M03_Staged_Conversation_1, "Soldier_1_ID:int, Soldier_2_ID:int") {
    void Custom(GameObject * obj, int type, int param,
                GameObject* sender) { if (type == 1000 && param == 1000) {
...
if (soldier1 && soldier2) {
    /*int id = Commands->Create_Conversation("Volcano", INNATE_PRIORITY_ENEMY_SEEN - 1, 20.0f,
    true); Commands->Join_Conversation(soldier1, id); Commands->Join_Conversation(soldier2, id);
    Commands->Start_Conversation(id);
    Commands->Monitor_Conversation(obj, id);*/
}
}
...
DECLARE_SCRIPT(M03_Beach_Turret,
               "") { void Created(GameObject * obj) { Commands->Start_Timer(obj, this, 1.0f, 0);
}
...
/*DECLARE_SCRIPT(M03_Evacuator, "Building:int")
{
        ...
        int Get_Waypath(int building)
        {
                int waypaths[3][4] = {{1144741, 1144741, 1144767, 1144767},
                                                                {1144800, 1144785, 1144816,
1144835}, {1144920, 1144851, 1144898, 1144873}}; return waypaths[building][Get_Int_Random(0, 3)];
        }
...
/*DECLARE_SCRIPT(M03_Dock_Evacuation_Controller, "")
{
        ...
        {
                int building = Get_Int_Random(0, 2);
                GameObject * runner = Commands->Create_Object("M03_Evacuator",
Get_Spawn_Loc(building)); if (runner)
                {
                        char params[20];
                        sprintf(params, "%d", building);
...
DECLARE_SCRIPT(M03_Beach_Radio, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (conv_count > 2 || conv_active) {
            ...
            Commands->Join_Conversation(nullptr, conv_id);
...
DECLARE_SCRIPT(M03_Power_Plant, "") { void Killed(GameObject * obj, GameObject* killer) {
...
DECLARE_SCRIPT(M03_Zone_Enabled_Spawner, "Spawner_num:int, Control_num:int") {
    void Entered(GameObject * obj,
                 GameObject* enterer) { int control = Get_Int_Parameter("Control_num");
...
DECLARE_SCRIPT(M03_Killed_Disabled_Spawner,
               "Spawner_num:int") { void Killed(GameObject * obj, GameObject* killer) {
...
DECLARE_SCRIPT(M03_Goto_Star, "") {
    void Created(GameObject * obj) { Commands->Start_Timer(obj, this, 3.5f, GOTO_STAR);
}
...
DECLARE_SCRIPT(M03_CommCenter_Warning, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!mct_accessed && !already_entered) {
            ...
            Commands->Set_HUD_Help_Text(IDS_M03DSGN_DSGN0207I1DSGN_TXT,
...
DECLARE_SCRIPT(M03_PowerPlant_Warning, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!mct_accessed && !already_entered) {
            ...
            Commands->Set_HUD_Help_Text(IDS_M03DSGN_DSGN0205I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
        }
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == COMM_KILLED) {
            ...
            if (!mct_accessed) {
                ...
                Commands->Set_HUD_Help_Text(IDS_M03DSGN_DSGN0208I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
        ...
        if (type == POWER_KILLED) {
            ...
            if (!mct_accessed) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(1100004), 308, 2);
                Commands->Set_HUD_Help_Text(IDS_M03DSGN_DSGN0206I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
...
DECLARE_SCRIPT(M03_Conversation_Zone, "Conv_Num:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (Get_Int_Parameter("Conv_Num") == 4 && already_entered && !Commands->Has_Key(STAR, 1)
            && !first_conv_played) {
        ...
        if (param == 8000) {
            ...
            if (holograph) {
                GameObject* kane = Commands->Create_Object_At_Bone(
                    holograph, "Nod_Kane_HologramHead", "O_ARROW");
...
DECLARE_SCRIPT(M03_Killed_Sound, "Officer=0:int, Location=0:int") {
    void Killed(GameObject * obj, GameObject* killer) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2018061), LOCATION,
                                    Get_Int_Parameter("Location"));
Commands->Send_Custom_Event(obj, Commands->Find_Object(2018061), TROOP_KILLED,
                            Get_Int_Parameter("Officer"));
}
}
;
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == HEALTH_CHECK) {
            ...
            if (current == full_health) {
                Commands->Create_Logical_Sound(obj, STOP_REPAIR, Commands->Get_Position(obj),
                                               150.0f);
            }
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR) {
            ...
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(Get_Int_Parameter("Controller_num")), ACTIVATE, 0);
        }
    }
};
...
DECLARE_SCRIPT(M10_Elevator_All_Controller, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == ACTIVATE) {
            ...
            GameObject* rub1
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-117.320f, 83.098f, 0.656f));
            block1 = Commands->Get_ID(rub1);
            Commands->Set_Facing(rub1, 90.0);
            Commands->Set_Is_Rendered(rub1, false);
            GameObject* rub2
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-113.706f, 78.884f, 0.656f));
            block2 = Commands->Get_ID(rub2);
            Commands->Set_Is_Rendered(rub2, false);
            GameObject* rub3
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-117.624f, 73.787f, 0.656f));
            block3 = Commands->Get_ID(rub3);
            Commands->Set_Is_Rendered(rub3, false);
            Commands->Set_Facing(rub3, -90.0);
            GameObject* rub4
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-122.458f, 78.303f, 0.656f));
            block4 = Commands->Get_ID(rub4);
            Commands->Set_Is_Rendered(rub4, false);
            GameObject* rub5
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-117.320f, 83.098f, 3.906f));
            block5 = Commands->Get_ID(rub5);
            Commands->Set_Facing(rub5, 90.0);
            Commands->Set_Is_Rendered(rub5, false);
            GameObject* rub6
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-113.706f, 78.884f, 3.906f));
            block6 = Commands->Get_ID(rub6);
            Commands->Set_Is_Rendered(rub6, false);
            GameObject* rub7
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-117.624f, 73.787f, 3.906f));
            block7 = Commands->Get_ID(rub7);
            Commands->Set_Is_Rendered(rub7, false);
            Commands->Set_Facing(rub7, -90.0);
            GameObject* rub8
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(-122.458f, 78.303f, 3.906f));
...
DECLARE_SCRIPT(M03_AggAndCover, "") {
    void Created(GameObject * obj) { Commands->Set_Innate_Aggressiveness(obj, 50.0f);
Commands->Set_Innate_Take_Cover_Probability(obj, 100.0f);
}
}
;
...
DECLARE_SCRIPT(M03_Cine_Explosion, "") {
    void Custom(GameObject * obj, int type, int param, GameObject* sender) { if (type == 600) {
