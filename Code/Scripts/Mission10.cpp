...
DECLARE_SCRIPT(M10_Objective_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Add_Objective(1020, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
                                IDS_Enc_ObjTitle_Hidden_M10_01, nullptr, IDS_Enc_Obj_Hidden_M10_01);
        Commands->Add_Objective(1021, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
                                IDS_Enc_ObjTitle_Hidden_M10_02, nullptr, IDS_Enc_Obj_Hidden_M10_02);
    }
    ...
    void Add_An_Objective(int id)
    {
        ...
        switch (id) {
        case 1001: {
            Commands->Add_Objective(1001, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_05, nullptr,
                                    IDS_Enc_Obj_Primary_M10_05);
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    1001, 75, "POG_M10_1_05.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
            }
        } break;
        case 1002: {
            Commands->Add_Objective(1002, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_02, nullptr,
                                    IDS_Enc_Obj_Primary_M10_02);
            object = Commands->Find_Object(2007445);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1002, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1002, 78, "POG_M10_1_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
            }
        } break;
        case 1003: {
            Commands->Add_Objective(1003, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_07, nullptr,
                                    IDS_Enc_Obj_Primary_M10_07);
            object = Commands->Find_Object(2007446);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1003, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1003, 73, "POG_M10_1_07.tga", IDS_POG_SABOTAGE, Commands->Get_Position(object));
            }
        } break;
        case 1004: {
            Commands->Add_Objective(1004, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_04, nullptr,
                                    IDS_Enc_Obj_Primary_M10_04);
            object = Commands->Find_Object(2007447);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1004, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1004, 76, "POG_M10_1_04.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
            }
        } break;
        case 1005: {
            Commands->Add_Objective(1005, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_01, nullptr,
                                    IDS_Enc_Obj_Primary_M10_01);
            object = Commands->Find_Object(1100166);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1005, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1005, 80, "POG_M10_1_01.tga", IDS_POG_OPEN, Commands->Get_Position(object));
            }
        } break;
        case 1006: {
            Commands->Add_Objective(1006, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_06, nullptr,
                                    IDS_Enc_Obj_Primary_M10_06);
            object = Commands->Find_Object(2017706);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1006, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1006, 74, "POG_M10_1_01.tga", IDS_POG_OPEN, Commands->Get_Position(object));
            }
        } break;
        case 1007: {
            Commands->Add_Objective(1007, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_03, nullptr,
                                    IDS_Enc_Obj_Primary_M10_03);
            object = Commands->Find_Object(1100169);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1007, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1007, 77, "POG_M10_1_01.tga", IDS_POG_OPEN, Commands->Get_Position(object));
            }
        } break;
        case 1008: {
            Commands->Add_Objective(1008, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_01, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_01);
            object = Commands->Find_Object(2007448);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1008, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1008, 51, "POG_M10_2_01.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1008,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1009: {
            Commands->Add_Objective(1009, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_04, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_04);
            object = Commands->Find_Object(2007449);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1009, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1009, 50, "POG_M10_2_03.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1009,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1010: {
            Commands->Add_Objective(1010, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_06, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_06);
            object = Commands->Find_Object(2007450);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1010, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1010, 59, "POG_M10_2_05.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1010,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1011: {
            Commands->Add_Objective(1011, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_08, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_08);
            object = Commands->Find_Object(2005260);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1011, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1011, 58, "POG_M10_2_07.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1011,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1012: {
            Commands->Add_Objective(1012, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M10_08, nullptr,
                                    IDS_Enc_Obj_Primary_M10_08);

            object = Commands->Find_Object(2000890);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1012, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1012, 79, "POG_M10_1_08.tga", IDS_POG_ACQUIRE, Commands->Get_Position(object));
            }

        } break;
        case 1013: {
            Commands->Add_Objective(1013, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_10, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_10);
            object = Commands->Find_Object(1154083);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1013, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1013, 57, "POG_M10_2_06.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1013,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1014: {
            Commands->Add_Objective(1014, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_07, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_07);
            object = Commands->Find_Object(1154084);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1014, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1014, 56, "POG_M10_2_06.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1014,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1015: {
            Commands->Add_Objective(1015, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_03, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_03);
            object = Commands->Find_Object(1100007);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1015, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1015, 55, "POG_M10_2_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1015,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1016: {
            Commands->Add_Objective(1016, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_11, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_11);
            object = Commands->Find_Object(1100010);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(1016, object);
                Commands->Set_Objective_HUD_Info_Position(
                    1016, 54, "POG_M10_2_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1016,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1017: {
            Commands->Add_Objective(1017, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_09, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_09);
            ...
            if (object && object2) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    1017, 53, "POG_M10_2_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
                Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1017,
                                            SECONDARY_POG_DELAY);
            }
        } break;
        case 1018: {
            Commands->Add_Objective(1018, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_05, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_05);
            ...
            if (object || object2) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    1018, 52, "POG_M10_2_02.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
            }
        } break;
        case 1019: {
            Commands->Add_Objective(1019, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M10_12, nullptr,
                                    IDS_Enc_Obj_Secondary_M10_12);
            ...
            if (object || object2) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    1019, 51, "POG_M10_2_11.tga", IDS_POG_DESTROY, Commands->Get_Position(object));
            }
        } break;
        }
    }
                ...
                if (type == 1011) {
                    ...
                    if (++turret_count == 2) {
                        Commands->Add_Objective(
                            1019, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                            IDS_Enc_ObjTitle_Secondary_M10_12, nullptr, IDS_Enc_Obj_Secondary_M10_12);
                        Commands->Set_Objective_Status(1019, OBJECTIVE_STATUS_ACCOMPLISHED);
                    ...
                    if (++e_sam_count >= 1) {
                        ...
                        if (e_sam_count == 2) {
                            Commands->Add_Objective(1018, OBJECTIVE_TYPE_SECONDARY,
                    ...
                    if (type < 1008 || type == 1012) {
                        if (++primary_count >= 7) {
                            if (primary_count == 7) {
                                int id
                                    = Commands->Create_Conversation("M10CON019", 99, 2000, false);
                                Commands->Join_Conversation(STAR, id);
                                Commands->Join_Conversation(nullptr, id);
                                ...
                                GameObject* chinook_obj = Commands->Create_Object(
                                    "Invisible_Object", Vector3(146.59f, 67.52f, -5.25f));
                                Commands->Set_Facing(chinook_obj, 0.0f);
                                Commands->Attach_Script(chinook_obj, "Test_Cinematic",
                                                        "X10I_GDI_Drop_PowerUp.txt");
                            }
...
DECLARE_SCRIPT(M10_Silo, "") { void Killed(GameObject * obj, GameObject* killer) {
...
DECLARE_SCRIPT(M10_Destroy_Self,
               "") { void Custom(GameObject * obj, int type, int param,
                                 GameObject* sender) { Commands->Destroy_Object(obj);
}
}
;
...
DECLARE_SCRIPT(M10_Apache_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        apache_id[1] = Commands->Get_ID(
            Commands->Create_Object("Nod_Apache_No_Idle", Vector3(-171.980f, 51.905f, 8.959f)));
        GameObject* apache = Commands->Find_Object(apache_id[1]);
        Commands->Attach_Script(apache, "M10_Apache", "1");
        apache_id[2] = Commands->Get_ID(
            Commands->Create_Object("Nod_Apache_No_Idle", Vector3(8.548f, 226.140f, 1.697f)));
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (!pad_destroyed) {
            if (timer_id == 0) {
                ...
                pos.Z = WWMath::Max(pos.Z + 12.0f,
                                    Commands->Get_Safe_Flight_Height(pos.X, pos.Y) + 6.0f);
...
DECLARE_SCRIPT(M10_Reinforcement_Controller, "")
{
    ...
    void Reinforce_Area(void)
    {
        ...
        if (Commands->Get_Random_Int(0, 2) == 1) {
            ...
            Reinforce_By_Rope(reinforce[current_area][num].Pos,
                              reinforce[current_area][num].Facing);
        }
        else {
            int num = Commands->Get_Random_Int(0, 4);
            Reinforce_By_Parachute(reinforce[current_area][num].Pos,
                                   reinforce[current_area][num].Facing);
        }
    }
...
DECLARE_SCRIPT(M10_No_More_Parachute, "") { void Destroyed(GameObject * obj) {
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!already_entered && Commands->Get_Health(Commands->Find_Object(1154061)) > 0.0f) {
            ...
            GameObject* stealth_tank
                = Commands->Create_Object("Nod_Stealth_Tank", Vector3(0, 0, 0));
            if (stealth_tank) {
                Commands->Send_Custom_Event(obj, new_object, M00_CUSTOM_CINEMATIC_SET_SLOT + 3,
                                            Commands->Get_ID(stealth_tank));
...
DECLARE_SCRIPT(M10_Ion_Cannon_Detector,
               "") { void Created(GameObject * obj) { Commands->Set_Is_Rendered(obj, false);
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M10_Stealth,
               "") { void Created(GameObject * obj) { Commands->Enable_Stealth(obj, true);
}
}
;
...
DECLARE_SCRIPT(M10_Home_Point, "Radius=5.0:float") { void Created(GameObject * obj) {
    Commands->Set_Innate_Soldier_Home_Location(obj, Commands->Get_Position(obj),
                                               Get_Float_Parameter("Radius"));
}
}
;

DECLARE_SCRIPT(M10_HON_Spawn_Zones,
               "Zone_Number:int") { void Entered(GameObject * obj, GameObject* enterer) {
...
DECLARE_SCRIPT(M10_Refinery_Spawn_Zones,
               "Zone_Number:int") { void Entered(GameObject * obj, GameObject* enterer) {
...
DECLARE_SCRIPT(M10_PowerPlant_Spawn_Zones,
               "Zone_Number:int") { void Entered(GameObject * obj, GameObject* enterer) {
...
DECLARE_SCRIPT(M10_ComCenter_Spawn_Zones,
               "Zone_Number:int") { void Entered(GameObject * obj, GameObject* enterer) {
...
DECLARE_SCRIPT(M10_Gate_Test, "") { void Poked(GameObject * obj, GameObject* poker) {
...
DECLARE_SCRIPT(M10_Mammoth_Target_Destruction,
               "Target_Number:int") { void Destroyed(GameObject * obj) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(2000787), TARGET,
                                Get_Int_Parameter("Target_Number"), 0.0f);
}
}
;
...
DECLARE_SCRIPT(M10_Refinery_Key_Grant, "") { void Killed(GameObject * obj, GameObject* killer) {
...
DECLARE_SCRIPT(M10_ConYard_Key_Grant, "") { void Killed(GameObject * obj, GameObject* killer) {
    Vector3 create_position = Commands->Get_Position(obj);
create_position.Z += 1.0f;
...
DECLARE_SCRIPT(M10_Spacecraft_Check, "") { void Poked(GameObject * obj, GameObject* poker) {
    if (Commands->Has_Key(STAR, 3)) { Commands->Static_Anim_Phys_Goto_Last_Frame(2058171, nullptr);
}
}
}
;
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == FAKE_TIMER && stealth_counter < 4) {
            if (!stealthtank_alive && reinforce_chance >= 4) {
                ...
                float stealth_face
                    = Commands->Get_Facing(Commands->Find_Object(drop_area[random_loc]));
                Vector3 drop_loc
                    = Commands->Get_Position(Commands->Find_Object(drop_area[random_loc]));
...
DECLARE_SCRIPT(M10_Obelisk_MCT, "")
{
    ...
    {
        if (alive) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(2010415),
                                        M10_PLAYERTYPE_CHANGE_OBELISK, 0);
        }
    }
...
DECLARE_SCRIPT(M10_Sam_Killed, "SamNumber:int") {
    ...
    void Killed(GameObject * obj,
                GameObject* killer) { GameObject* obj_con = Commands->Find_Object(1100154);
...
DECLARE_SCRIPT(M10_Turret_Killed, "") { void Killed(GameObject * obj, GameObject* killer) {
    GameObject* obj_con = Commands->Find_Object(1100154);
...
DECLARE_SCRIPT(M10_Mrls_Grant, "")
{
        ...
        if (!already_poked) {
            if (Commands->Has_Key(STAR, 1)) {
                ...
                Commands->Create_Logical_Sound(
                    obj, CLEAR1, Commands->Get_Position(Commands->Find_Object(drop_loc1)), 10.0f);
                Commands->Create_Logical_Sound(
                    obj, CLEAR2, Commands->Get_Position(Commands->Find_Object(drop_loc2)), 10.0f);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == GRANT_MRLS) {
            if (!occupied1 && grant) {
                GameObject* mrls = Commands->Create_Object(
                    "GDI_MRLS_Player", Commands->Get_Position(Commands->Find_Object(drop_loc1)));
                Commands->Attach_Script(mrls, "M10_Mrls_Waypath", "");
            }

            else if (!occupied2 && grant) {
                GameObject* mrls2 = Commands->Create_Object(
                    "GDI_MRLS_Player", Commands->Get_Position(Commands->Find_Object(drop_loc2)));
...
DECLARE_SCRIPT(M10_Mrls_Waypath, "") { void Created(GameObject * obj) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(1100007), M00_CUSTOM_SAM_SITE_IGNORE,
                                Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100008), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100009), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100010), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100011), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100012), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
...
DECLARE_SCRIPT(M10_Humm_SAMIgnore, "") { void Created(GameObject * obj) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(1100007), M00_CUSTOM_SAM_SITE_IGNORE,
                                Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100008), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
...
DECLARE_SCRIPT(M10_Occupied, "") { void Created(GameObject * obj) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(1100007), M00_CUSTOM_SAM_SITE_IGNORE,
                                Commands->Get_ID(obj));
Commands->Send_Custom_Event(obj, Commands->Find_Object(1100008), M00_CUSTOM_SAM_SITE_IGNORE,
                            Commands->Get_ID(obj));
...
DECLARE_SCRIPT(M10_HON_KillPrevention, "") { void Killed(GameObject * obj, GameObject* killer) {
    if (killer != STAR) { Commands->Set_Health(obj, 1.0f);
}
}
}
;
...
DECLARE_SCRIPT(M10_Lv2_KeyCarrier, "") { void Killed(GameObject * obj, GameObject* killer) {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == 8000) {
            ...
            if (holograph) {
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(1209308), KANE_CONV,
...
DECLARE_SCRIPT(M10_KaneHead_DME, "") // 2017221
{
    ...
    "***************************kane conversation 02 is over--sending delete custom\n" );
...
{ void Created(GameObject * obj) {
    if (STAR) { int id = Commands->Create_Conversation("M10CON057", 99, 100, true);
