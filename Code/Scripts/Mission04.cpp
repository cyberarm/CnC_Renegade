...
DECLARE_SCRIPT(M04_Objective_Controller_JDG,
               "") // this guys ID number is M04_OBJECTIVE_CONTROLLER_JDG 100424
{
    ...
    {
        /**********************************************************************************************************
        The following are the custom parameter number values used to control objectives in mission
        04
        ***********************************************************************************************************/
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: //
        {
            if (action_id == missionIntroConv) // rescue prisoners here
            {
                Commands->Debug_Message(
                    "**********************mission start conversation over--sending custom\n");
                Commands->Send_Custom_Event(obj, obj, 0, 1, 0);

                Commands->Add_Objective(100, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_01, nullptr,
                                        IDS_Enc_Obj_Primary_M04_01);
                Commands->Add_Radar_Marker(
                    101, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_01_JDG)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Add_Radar_Marker(
                    102, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_02_JDG)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Add_Radar_Marker(
                    103, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_03_JDG)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);

                Vector3 prisoner01_position
                    = Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_01_JDG));
                Commands->Set_Objective_HUD_Info_Position(100, 90, "POG_M04_1_01.tga",
                                                          IDS_POG_RESCUE, prisoner01_position);
            }

            else if (action_id == missileConv) // sabotage missile racks
                                               // M04_Add_MissileRoom_Objective_Conversation_02
            {
                // Commands->Send_Custom_Event( obj, obj, 0, 1, 2 );

                // Commands->Create_Sound ( "00-n040e", Vector3 (0,0,0), obj);
                Commands->Add_Objective(300, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_03, nullptr,
                                        IDS_Enc_Obj_Primary_M04_03);
                ...
                /*int missileConv02 = Commands->Create_Conversation(
                "M04_Add_MissileRoom_Objective_Conversation_02", 100, 1000, false);
                Commands->Join_Conversation( nullptr, missileConv02, false, false );
                ...
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG, 300,
                                                0);
                }
            }
            ...
            else if (action_id == engineIntroConv) // destroy engine terminals
            {
                ...
                Commands->Add_Objective(200, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Secondary_M04_02, nullptr,
                                        IDS_Enc_Obj_Secondary_M04_02);

                GameObject* pogController = Commands->Find_Object(104693);
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG, 200,
                                                0);
                }
            ...
            {
                Commands->Add_Objective(110, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_02, nullptr,
                                        IDS_Enc_Obj_Primary_M04_02);

                medlab_conv = Commands->Create_Conversation("M04_Eva_Tells_Where_Guard_Is", 100,
                                                            100, false);
                Commands->Join_Conversation(nullptr, medlab_conv, false, true);
            ...
            else if (action_id == medlab_conv) // get prison key from guard
            {
                ...
                if (warden != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(110, 92, "POG_M04_1_02.tga",
                                                              IDS_POG_ACQUIRE, wardenLocation);
                } //
            }
            ...
            {
                Commands->Create_Sound("00-n040e", Vector3(0, 0, 0), obj);
                Commands->Add_Objective(600, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_07, nullptr,
                                        IDS_Enc_Obj_Primary_M04_07);
                Commands->Add_Radar_Marker(
                    601, Commands->Get_Position(Commands->Find_Object(M04_SHIPS_FIRST_MATE_JDG)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Send_Custom_Event(obj, obj, 0, 1,
                                            2); // this sets a small delay before havoc responds
                ...
                if (firstmate != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(600, 93, "POG_M04_1_07.tga",
                                                              IDS_POG_ACQUIRE, firstmateLocation);
                }
            }

            else if (action_id == protectPOWsConv) // give protect prisoner objective
            {
                Commands->Add_Objective(800, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_06, nullptr,
                                        IDS_Enc_Obj_Primary_M04_06);
                Commands->Add_Radar_Marker(801, Vector3(2.55f, -5.29f, -16.96f),
                                           RADAR_BLIP_SHAPE_OBJECTIVE,
                                           RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);

                Vector3 subLocation(-0.401f, 3.878f, -8.850f);
                Commands->Set_Objective_HUD_Info_Position(800, 99, "POG_M04_1_06.tga",
                                                          IDS_POG_PROTECT, subLocation);
            }
        } break;
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        ***********************************************************************************************************/
        ...
        if (type == 0) {
            ...
            {
                Commands->Debug_Message("**********************controller should be playing havoc "
                                        "affirmative twiddler now\n");
            ...
            {
                // Commands->Create_Sound ( "Havoc Finished Objective Twiddler", Vector3 (0,0,0),
                // obj);
            }

            else if (param == announce_prisoner_objective) {
                Commands->Debug_Message(
                    "**********************starting mission start conversation\n");
                missionIntroConv = Commands->Create_Conversation("M04_Mission_Start_Conversation",
                                                                 100, 1000, false);
                ...
                // Commands->Send_Custom_Event( obj, obj, 0, 1, 2 );//this sets a small delay before
                // havoc responds
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder, M01_ADD_OBJECTIVE_POG_JDG,
                                                0, 0);
                }
            }

            else if (param == announce_prison_guard_objective) {
                prisonKeyIntroConv = Commands->Create_Conversation("M04_Add_PrisonKey_Objective",
                                                                   100, 1000, false);
                Commands->Join_Conversation(nullptr, prisonKeyIntroConv, false, false);
            ...
            /*else if (param == attach_havocs_script)
            {
                ...
                engineIntroConv = Commands->Create_Conversation(
                    "M04_Add_EngineRoom_Objective_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, engineIntroConv, false, false);
            ...
            {
                missileConv = Commands->Create_Conversation(
                    "M04_Add_MissileRoom_Objective_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, missileConv, false, false);
                ...
                // Commands->Create_Sound ( "00-n040e", Vector3 (0,0,0), obj);
                Commands->Add_Objective(400, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_04, nullptr,
                                        IDS_Enc_Obj_Primary_M04_04);
                Commands->Add_Radar_Marker(
                    401, Commands->Get_Position(Commands->Find_Object(100409)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Add_Radar_Marker(
                    402, Commands->Get_Position(Commands->Find_Object(100410)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Send_Custom_Event(obj, obj, 0, 1,
                                            2); // this sets a small delay before havoc responds
                ...
                Commands->Add_Objective(500, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Secondary_M04_03, nullptr,
                     ...
                     && first_mate_primary_triggered == false) //
            {
                ...
                firstmateConv = Commands->Create_Conversation("M04_Add_FirstMate_Objective_JDG",
                                                              100, 1000, false);
                Commands->Join_Conversation(nullptr, firstmateConv, false, false);
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder, M01_ADD_OBJECTIVE_POG_JDG,
                     ...
                     == announce_captain_objective) // M04_Add_Captains_Key_Objective_Conversation
            {
                int captainConv = Commands->Create_Conversation(
                    "M04_Add_Captains_Key_Objective_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, captainConv, false, false);
                Commands->Start_Conversation(captainConv, captainConv);

                captain_primary_active = true;
                // Commands->Create_Sound ( "00-n040e", Vector3 (0,0,0), obj);
                Commands->Add_Objective(700, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                        IDS_Enc_ObjTitle_Primary_M04_05, nullptr,
                                        IDS_Enc_Obj_Primary_M04_05);
                Commands->Add_Radar_Marker(
                    701, Commands->Get_Position(Commands->Find_Object(M04_SHIPS_CAPTAIN_JDG)),
                    RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Send_Custom_Event(obj, obj, 0, 1,
                                            4); // this sets a small delay before havoc responds

                GameObject* captain = Commands->Find_Object(M04_SHIPS_CAPTAIN_JDG);
                if (captain != nullptr) {
                    Vector3 captainLocation = Commands->Get_Position(captain);
                    Commands->Set_Objective_HUD_Info_Position(700, 94, "POG_M04_1_05.tga",
                                                              IDS_POG_ACQUIRE, captainLocation);
                }
            ...
            {
                protectPOWsConv = Commands->Create_Conversation(
                    "M04_Protect_The_Prisoners_Conversation", 100, 1000, false);
                Commands->Join_Conversation(nullptr, protectPOWsConv, false, false);
            ...
            ***********************************************************************************************************/
                ...
                Commands->Send_Custom_Event(obj, obj, 0, 2,
                                            2); // this sets a small delay before havoc responds

                GameObject* objectiveReminder = Commands->Find_Object(105760);
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 0, 0);
                }
            }
                ...
                int cargo_conv1 = Commands->Create_Conversation(
                    "M04_NowGoFreeThePrisoners_Conversation", 100, 1000, false);
                // Commands->Join_Conversation( nullptr, cargo_conv1, false, false, false);
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 2, 0);
                }
            }
                ...
                Commands->Create_Object("POW_GrenadeLauncher_Player",
                                        Vector3(0.020f, -89.237f, -14.999f));
                Commands->Create_Object("POW_GrenadeLauncher_Player",
                                        Vector3(0.050f, -92.541f, -14.999f));
                Commands->Create_Object("POW_GrenadeLauncher_Player",
                                        Vector3(0.023f, -95.280f, -14.999f));
            }
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 1, 0);
                }
            }
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 5, 0);
                }
            }
                ...
                // Commands->Send_Custom_Event( obj, obj, 0, 2, 2 );//this sets a small delay before
                // havoc responds
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 3, 0);
                }
            }
                ...
                if (objectiveReminder != nullptr) {
                    Commands->Send_Custom_Event(obj, objectiveReminder,
                                                M01_REMOVE_OBJECTIVE_POG_JDG, 4, 0);
                }

                if (prisoner_primary_active == false) {
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Rally_Round_The_Sub_Boy_Conversation", 50, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);

                    GameObject* objectiveReminder = Commands->Find_Object(105760);
                    if (objectiveReminder != nullptr) {
                        Commands->Send_Custom_Event(obj, objectiveReminder,
                                                    M01_ADD_OBJECTIVE_POG_JDG, 6, 0);
                    }
                }

                else if (prisoner_primary_active == true) {
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Mission_Start_Conversation", 50, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }
            }
                ...
                if ((mission_started == true) && (captain_primary_active == false)
                    && (first_mate_primary_active == false) && (torpedo_primary_active == false)
                    && (missile_primary_active == false) && (prisoner_primary_active == false)) {
                    // Commands->Send_Custom_Event( obj, Commands->Find_Object (101194), 0,
                    // M01_START_ACTING_JDG, 0 );
                    Commands->Send_Custom_Event(obj, obj, 0, M01_END_MISSION_PASS_JDG, 0);
                }
            }
            /**********************************************************************************************************
            The following are params for when the individual missiles and whatnot get acted on or
            destroyed.
            ***********************************************************************************************************/
            else if (param == missile_01_sabotaged) //
            {
                ...
                if (number_missiles_sabotaged == 1) {
                    int missile_conv1 = Commands->Create_Conversation(
                        "M04_MissileRack_01_Sabotaged_Conversation", 100, 1000, true);
                    Commands->Join_Conversation(nullptr, missile_conv1, false, false, false);
                    Commands->Start_Conversation(missile_conv1, missile_conv1);
                }

                else if (number_missiles_sabotaged == 2) {
                    int missile_conv1 = Commands->Create_Conversation(
                        "M04_MissileRack_02_Sabotaged_Conversation", 100, 1000, true);
                    Commands->Join_Conversation(nullptr, missile_conv1, false, false, false);
                    Commands->Start_Conversation(missile_conv1, missile_conv1);
                }
                    ...
                    int missile_conv1 = Commands->Create_Conversation(
                        "M04_MissileRack_03_Sabotaged_Conversation", 100, 1000, true);
                    Commands->Join_Conversation(nullptr, missile_conv1, false, false, false);
                    Commands->Start_Conversation(missile_conv1, missile_conv1);
                }
                ...
                if (number_engines_sabotaged == 1) {
                    ...
                    Commands->Create_Sound("M04DSGN_DSGN0090I1EVAN_SND", Vector3(0, 0, 0),
                                           obj); // intruder detected
                }

                else if (number_engines_sabotaged == 3) {
                    Commands->Create_Sound("M04DSGN_DSGN0094I1EVAN_SND", Vector3(0, 0, 0),
                                           obj); // engine failure emiment
                }

                else if (number_engines_sabotaged >= 4) {
                    Commands->Create_Sound("M04DSGN_DSGN0095I1EVAN_SND", Vector3(0, 0, 0),
                                           obj); // engine off line
                ...
                if (number_torpedos_sabotaged < 2) {
                    int missile_conv1 = Commands->Create_Conversation(
                        "M04_Torpedo_Sabotaged_Conversation", 100, 1000, true);
                    Commands->Join_Conversation(nullptr, missile_conv1, false, false, false);
                    Commands->Start_Conversation(missile_conv1, missile_conv1);
                }
...
DECLARE_SCRIPT(M04_MissileRoom_EnterZone_Left_JDG,
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 600,
...
DECLARE_SCRIPT(M04_MissileRoom_EnterZone_Right_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 500,
               ...
               "") // this guys ID number is M04_CARGOHOLD_CONTROLLER_JDG 100558
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == 100) {
            ...
            {
                // cargo_conv1 = Commands->Create_Conversation( "M04_CargoHold_Conversation_01", 45,
                // 1000, true); Commands->Join_Conversation( guardOne, cargo_conv1, false, false,
                // false); Commands->Join_Conversation( guardTwo, cargo_conv1, false, false, false
                // ); Commands->Start_Conversation( cargo_conv1,  cargo_conv1 );
                // Commands->Monitor_Conversation(  obj, cargo_conv1);
            }

            GameObject* guardSix
                = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-14.44f, -40.82f, -9.00f));
            Commands->Attach_Script(guardSix, "M04_CargoHold_Blackhand_02_JDG",
                                    ""); // M01_Hunt_The_Player_JDG

            GameObject* missileRoomguardOne
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-13.38f, -53.56f, -15.00f));
            Commands->Attach_Script(missileRoomguardOne, "M04_MissileRoom_Guard_01_JDG", "");

            GameObject* missileRoomguardTwo
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(13.37f, -61.28f, -15.00f));
    ...
    /*void Action_Complete (GameObject *obj, int action_id, ActionCompleteReason complete_reason)
    {
            if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED)
            {
                    ...
                    {
                            GameObject *blackHand01 = Commands->Find_Object (
    M04_CARGO_BLACKHAND_01_JDG );

                            if (blackHand01 != nullptr)
                            {
                                    Commands->Debug_Message ( "**********************cargo conv 01
    is over--sending custom to blackhand guy\n" ); Commands->Send_Custom_Event( obj, blackHand01, 0,
    M01_START_ACTING_JDG, 0 );
                            }
                    }
            }
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    if (param
        == M01_START_ACTING_JDG) // player has entered area--back peddle towards the engine room
    {
...
{
    if (action_id
        == M01_WALKING_WAYPATH_01_JDG) // you've reached your final guard spot--goto stationary
    {
...
DECLARE_SCRIPT(M04_MissileRoom_Guard_01_JDG, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0,
                                    300, 0); // tell controller youre dead
    }
...
DECLARE_SCRIPT(M04_MissileRoom_Guard_02_JDG, "")
{
    ...
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0,
                                    300, 0); // tell controller you're dead
    }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (complete_reason == ACTION_COMPLETE_NORMAL) {
            if (action_id == M01_WALKING_WAYPATH_01_JDG) {
                ...
                if (guardOne != nullptr)
                {
                        cargo_conv2 = Commands->Create_Conversation(
                "M04_CargoHold_Conversation_02", 50, 1000, true); Commands->Join_Conversation( obj,
                cargo_conv2, false, false ); Commands->Join_Conversation( guardOne, cargo_conv2,
                false, false ); Commands->Start_Conversation( cargo_conv2,  cargo_conv2 );
            ...
            if (action_id == cargo_conv2) {
                ...
                if (guardOne != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, guardOne, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (guardTwo != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, guardTwo, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }

                if (guardThree != nullptr) {
                    float delayTimer = Commands->Get_Random(0, 1);
                    Commands->Send_Custom_Event(obj, guardThree, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                delayTimer);
                }
...
DECLARE_SCRIPT(M04_EngineRoom_EnterZone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 430,
...
DECLARE_SCRIPT(M04_EngineRoom_BuildingController_JDG,
               "") // M04_ENGINEROOM_BUILDING_CONTROLLER_JDG	150001
{
    ...
    {
        targetsDestroyed = 0;
        engineroom_sound01 = Commands->Create_Sound("SFX.Machine_Turbine_01",
                                                    Vector3(5.970f, -104.759f, -15.143f), obj);
        engineroom_sound02 = Commands->Create_Sound("SFX.Machine_Turbine_01_offset2",
                                                    Vector3(-6.021f, -104.445f, -15.157f), obj);
        engineroom_sound03 = Commands->Create_Sound("SFX.Ship_Amb_Engineroom",
                                                    Vector3(-0.942f, -74.017f, -11.840f), obj);
        engineroom_sound04 = Commands->Create_Sound("SFX.Steam_Med_Pressure_01_offset1",
                                                    Vector3(-9.838f, -76.426f, -13.498f), obj);
        engineroom_sound05
            = Commands->Create_Sound("Ship_Engine_01", Vector3(-10.846f, -94.205f, -13.432f), obj);
        engineroom_sound06
            = Commands->Create_Sound("Ship_Engine_01", Vector3(0.359f, -131.034f, 2.580f), obj);
        engineroom_sound07 = Commands->Create_Sound("Ship_Engine_01_offset1",
                                                    Vector3(9.045f, -96.538f, -13.366f), obj);
        engineroom_sound08
            = Commands->Create_Sound("Ship_Engine_02", Vector3(9.192f, -89.680f, -12.902f), obj);
        engineroom_sound09
            = Commands->Create_Sound("Ship_Engine_02", Vector3(3.033f, -92.739f, 16.208f), obj);
        engineroom_sound10
            = Commands->Create_Sound("Ship_Engine_03", Vector3(-5.870f, -84.200f, -13.423f), obj);
        engineroom_sound11
            = Commands->Create_Sound("Ship_Engine_03", Vector3(7.588f, -83.956f, -13.481f), obj);
        engineroom_sound12 = Commands->Create_Sound("Steam_Med_Pressure_01",
                                                    Vector3(9.726f, -78.736f, -14.079f), obj);
        engineroom_sound13 = Commands->Create_Sound("SFX.Machine_Turbine_01",
                                                    Vector3(-0.757f, -60.372f, -7.924f), obj);
        engineroom_sound14 = Commands->Create_Sound("Roomtone_Industrial_04_verb",
                                                    Vector3(8.568f, -67.182f, -6.454f), obj);
    }
        ...
        if (type == 0) {
            if (param == M01_IVE_BEEN_KILLED_JDG) {
                ...
                if (targetsDestroyed == 4) {
                    ...
                    engineroom_sound01 = Commands->Create_Sound(
                        "SFX.Klaxon_Alert_02", Vector3(-2.309f, -94.553f, -11.050f), obj);
                    engineroom_sound02 = Commands->Create_Sound(
                        "SFX.Klaxon_Alert_04", Vector3(-0.715f, -88.220f, -10.745f), obj);
                    engineroom_sound03 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_01", Vector3(9.731f, -95.172f, -11.028f), obj);
                    engineroom_sound04 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_01", Vector3(-2.976f, -91.511f, -12.275f), obj);
                    engineroom_sound05 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_02", Vector3(3.918f, -84.200f, -11.625f), obj);
                    engineroom_sound06 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_02", Vector3(-9.033f, -96.617f, -12.678f), obj);
                    engineroom_sound07 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_03", Vector3(2.750f, -93.408f, -12.047f), obj);
                    engineroom_sound08 = Commands->Create_Sound(
                        "SFX.Ship_Engine_Broken_03", Vector3(-7.275f, -83.744f, -12.941f), obj);
                    engineroom_sound09 = Commands->Create_Sound(
                        "Ship_Engine_01", Vector3(6.854f, -75.227f, -14.270f), obj);
                    engineroom_sound10 = Commands->Create_Sound(
                        "Ship_Engine_02", Vector3(-9.464f, -76.808f, -15.745f), obj);

                    Commands->Debug_Message("**********************all engine room targets "
                                            "destroyed--applying damage to engine room\n");
                    ...
                    GameObject* williams = Commands->Find_Object(
                        M04_ENGINEROOM_TECH_04_JDG); // M01_MODIFY_YOUR_ACTION_02_JDG

                    if (engineer != nullptr) {
                        float delayTimer = Commands->Get_Random(0, 0.5f);
                        Commands->Send_Custom_Event(obj, engineer, 0, M01_MODIFY_YOUR_ACTION_JDG,
                                                    delayTimer);
                    }

                    if (jimmy != nullptr) {
                        float delayTimer = Commands->Get_Random(0, 0.5f);
                        Commands->Send_Custom_Event(obj, jimmy, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                    delayTimer);
                    }

                    if (johnny != nullptr) {
                        float delayTimer = Commands->Get_Random(0, 0.5f);
                        Commands->Send_Custom_Event(obj, johnny, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                    delayTimer);
                    }

                    if (bobby != nullptr) {
                        float delayTimer = Commands->Get_Random(0, 0.5f);
                        Commands->Send_Custom_Event(obj, bobby, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                    delayTimer);
                    }

                    if (williams != nullptr) {
                        float delayTimer = Commands->Get_Random(0, 0.5f);
                        Commands->Send_Custom_Event(obj, williams, 0, M01_MODIFY_YOUR_ACTION_02_JDG,
                                                    delayTimer);
                    }
                    ...
                    GameObject* hunterController
                        = Commands->Find_Object(M04_ENGINEROOM_HUNTING_CONTROLLER_JDG);
                    if (hunterController != nullptr) {
                        Commands->Send_Custom_Event(obj, hunterController, 0, M01_START_ACTING_JDG,
                                                    0);
                    }
                }
            }
...
DECLARE_SCRIPT(M04_EngineRoom_ChiefEngineer_JDG, "") // M04_ENGINEROOM_CHIEF_ENGINEER_JDG 101762
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == 0) {
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_JDG) // someone's missing--look around then
                                                          // goto innate
            {
                params.Set_Basic(this, 100, M01_DOING_ANIMATION_01_JDG);
            ...
            if (action_id == M01_DOING_ANIMATION_01_JDG) {
                ...
                if (chiefs_location == GOING_TO_WILLIAMS_01) {
                    if (williams != nullptr && williams_is_dead == false) {
                        // int williams01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Williams_01_Conversation", 50, 50, true);
                    ...
                    if (bobby != nullptr && bobby_is_dead == false) {
                        // int bobby01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Bobby_01_Conversation", 50, 50, true);
                    ...
                    if (jimmy != nullptr && jimmy_is_dead == false) {
                        // int jimmy01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Jimmy_01_Conversation", 50, 50, true);
                    ...
                    if (johnny != nullptr && johnny_is_dead == false) {
                        // int johnny01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Tech04_01_Conversation", 50, 50, true);
                    ...
                    if (bobby != nullptr && bobby_is_dead == false) {
                        // int bobby01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Bobby_02_Conversation", 50, 50, true);
                        // Commands->Join_Conversation( obj, bobby01, false, true, true );
                        // Commands->Join_Conversation( bobby, bobby01, false, true, true );
                        // Commands->Start_Conversation( bobby01,  bobby01 );
                        // Commands->Monitor_Conversation(  obj, bobby01 );
                    ...
                    if (jimmy != nullptr && jimmy_is_dead == false) {
                        // int jimmy01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Jimmy_02_Conversation", 50, 50, true);
                        // Commands->Join_Conversation( obj, jimmy01, false, true, true );
                        // Commands->Join_Conversation( jimmy, jimmy01, false, true, true );
                        // Commands->Start_Conversation( jimmy01,  jimmy01 );
                        // Commands->Monitor_Conversation(  obj, jimmy01 );
                    ...
                    if (williams != nullptr && williams_is_dead == false) {
                        // int williams01 = Commands->Create_Conversation(
                        // "M04_EngineRoom_Williams_02_Conversation", 50, 50, true);
                        // Commands->Join_Conversation( obj, williams01, false, true, true );
                        // Commands->Join_Conversation( williams, williams01, false, true, true );
                        // Commands->Start_Conversation( williams01,  williams01 );
                        // Commands->Monitor_Conversation(  obj, williams01 );
...
DECLARE_SCRIPT(M04_EngineRoom_PrisonLift_EnterZone_JDG,
    ...
    if (enterer == STAR) { Vector3 spawnSpot(-0.512f, -95.434f, 0);
...
DECLARE_SCRIPT(M04_EngineRoom_Prison_Guard_01_JDG, "") // M04_ENGINEROOM_PRISONGUARD_01_JDG 101988
{
    ...
    {
        if (param == M01_START_ACTING_JDG
            && engineDestroyed == false) // controller is telling you to start acting
        {
            if (obj) {
                if (counter >= 3) {
                    counter = 0;
                ...
                if (obj && guard02 != nullptr) {
                    ...
                    haze_prisoner_conv
                        = Commands->Create_Conversation(conversations[counter], 65, 100, true);
                 ...
                 && engineDestroyed
                     == true) // controller is telling you to start acting--engines destroyed
        {
            Commands->Action_Reset(obj, 100);
        ...
        else if (param == M01_IVE_BEEN_KILLED_JDG) // guard two has been killed/injured
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_JDG) // the engine has been destroyed--enable
                                                      // foostep hearing
        {
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            if (action_id == haze_prisoner_conv) {
                if (obj) {
                    Commands->Send_Custom_Event(obj, obj, 0, M01_START_ACTING_JDG,
                                                1); // pick a new conversation
                }
            }
        } break;
        }
...
DECLARE_SCRIPT(M04_EngineRoom_Prisoner_01_JDG,
               "") // this guys ID number is M04_PRISON_PRISONER_01_JDG 100011
{
        ...
        if (obj) {
            if (damager == STAR) {
                ...
                if (firstTimeDamaged == true) {
                    Commands->Create_Sound("00-N066E", Vector3(0, 0, 0),
                                           obj); // you are firing on a friendly unit
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            if ((prison_guard_01_dead == true) && (prison_guard_02_dead == true)
                && freedYet == false && seenHavoc == false) {
                seenHavoc = true;
            ...
            its_gdi_conv
                = Commands->Create_Conversation("M04_Is_That_a_GDI_Soldier", 100, 100, false);
                 ...
                 && wave_counter < 100) // playre is in first talk zone--start conversation
        {
            ...
            medlab_conv = Commands->Create_Conversation(
                "M04_Prisoner_Guard_is_in_Medlab_Conversation", 100, 100, false);
            ...
            Commands->Monitor_Conversation(obj, medlab_conv);
                 ...
                 == M01_MODIFY_YOUR_ACTION_JDG) // you've been freed--cheer you ungrateful bastard
        {
            freedYet = true;
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id == 101
            && complete_reason == ACTION_COMPLETE_NORMAL) // prisoner one is at his hazing spot
        {
        ...
        else if (action_id == M01_MODIFY_YOUR_ACTION_03_JDG
                 && complete_reason == ACTION_COMPLETE_NORMAL) {
            params.Set_Basic(this, 100, M01_FACING_SPECIFIED_DIRECTION_01_JDG);
            params.Set_Attack(STAR, 0, 0, true);
            Commands->Action_Attack(obj, params);
        ...
        else if (action_id == its_gdi_conv
...
DECLARE_SCRIPT(M04_EngineRoom_Prisoner_02_JDG,
               "") // this guys ID number is M04_PRISON_PRISONER_02_JDG 101196
{
    bool firstTimeDamaged;
...
/*DECLARE_SCRIPT(M04_EngineRoom_Prisoner_02_JDG, "")//this guys ID number is
M04_PRISON_PRISONER_02_JDG 101196
{
        bool firstTimeDamaged;
        ...
        void Damaged( GameObject * obj, GameObject * damager, float amount )
        {
                if (obj && damager == STAR)
                {
                        ...
                        if (firstTimeDamaged == true)
                        {
                                Commands->Create_Sound ( "00-N066E", Vector3 (0,0,0), obj );//you
are firing on a friendly unit firstTimeDamaged = false; ActionParamsStruct params; params.Set_Basic(
this, 100, M01_DOING_ANIMATION_02_JDG ); params.Set_Animation( "H_A_J21C", false );
                                Commands->Action_Play_Animation (  obj, params );
                                Vector3 myPosition = Commands->Get_Position ( obj );
                                Commands->Create_Sound ( "M04 PanicGuy 01 Twiddler", myPosition, obj
);
        ...
        void Custom (GameObject* obj, int type, int param, GameObject* sender)
        {
                ...
                if (param == M01_MODIFY_YOUR_ACTION_JDG)//you've been freed--cheer you ungrateful
bastard
                {
                        char *animationName = M01_Choose_Cheer_Animation ( );
                        Commands->Action_Reset (  obj, 100 );
...
ACTION_COMPLETE_NORMAL)
                ...
                else if (action_id == M01_DOING_ANIMATION_02_JDG && complete_reason ==
ACTION_COMPLETE_NORMAL)
                {
                        firstTimeDamaged = true;
                }
...
DECLARE_SCRIPT(M04_EngineRoom_Prisoner_03_JDG,
               "") // this guys ID number is M04_PRISON_PRISONER_03_JDG 100013
{
    bool firstTimeDamaged;
    bool freedYet;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            if (freedYet == false) {
                int key_conv = Commands->Create_Conversation("M04_DoYouHaveTheKey_Conversation",
                                                             100, 1000, false);
...
DECLARE_SCRIPT(M04_Prison_CellDoor_Zone_JDG, "") { void Created(GameObject * obj) {
    Commands->Static_Anim_Phys_Goto_Frame(M04_PRISON_DOOR_JDG, 0,
                                          "SHP_DOORP01.SHP_DOORP01"); // 182085
}
...
void Entered(GameObject* obj, GameObject* enterer)
{
    if (enterer == STAR) {
        ...
        if (playerHasPrisonKey == true) {
            ...
            Commands->Static_Anim_Phys_Goto_Frame(M04_PRISON_DOOR_JDG, 6,
                                                  "SHP_DOORP01.SHP_DOORP01");
            ...
            GameObject* prisoner03 = Commands->Find_Object(M04_PRISON_PRISONER_03_JDG);
            if (prisoner03 != nullptr) {
                Commands->Send_Custom_Event(obj, prisoner03, 0, 3000,
                                            0); // tell prisoner 3 that Havoc is close by
            }
        }
    }
...
DECLARE_SCRIPT(M04_AftDeck_InnerSanctum_02_Entry_Zone_JDG,
               "") // player is almost to secondary bridge
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Create_Sound("00-n060e", Commands->Get_Position(obj), obj); // updating radar flags
...
DECLARE_SCRIPT(M04_AftDeck_02_Controller_JDG,
               "") // this guys number is M04_AFT_DECK_CONTROLLER_JDG 100624
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            GameObject* patrolGuy01
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-.90f, -127.01f, 3.00f));
            Commands->Attach_Script(patrolGuy01, "M04_AftDeck_02_PatrolGuy_01_JDG", "");

            GameObject* patrolGuy02
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(6.64f, -116.10f, 3.00f));
            Commands->Attach_Script(patrolGuy02, "M04_AftDeck_02_PatrolGuy_02_JDG", "");

            GameObject* pointGuard01
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-14.09f, -108.50f, 3.00f));
            Commands->Attach_Script(pointGuard01, "M04_AftDeck_02_Pointguard_JDG", "");

            GameObject* pointGuard02
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(13.83f, -108.00f, 3.00f));
            Commands->Attach_Script(pointGuard02, "M04_AftDeck_02_Pointguard_JDG", "");

            GameObject* BHpatrolGuy
                = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(8.51f, -108.05f, 6.00f));
            Commands->Attach_Script(BHpatrolGuy, "M04_AftDeck_02_Blackhand_PatrolGuy_JDG", "");

            GameObject* prisonGuard01
                = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(9.80f, -72.88f, 0));
            Commands->Attach_Script(prisonGuard01, "M04_PointGuard_JDG", "");

            GameObject* prisonGuard02
                = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-9.39f, -72.49f, 0));
        ...
        else if (param == 200) // someone's been killed
        {
            ...
            if ((number_of_guys_killed == 2)) {
                ...
                Commands->Send_Custom_Event(obj, obj, 0, 2000,
                                            2); // play second dialog line "call reinforcements"
            }
        ...
        else if (param == 2000) // play dialog line "call reinforcements"
        {
            ...
            // );
                 ...
                 && (prisoner_reinforcements
                     <= 5)) // prisoners have been rescued--release the hounds
        {
            prisoner_reinforcements++;
        ...
        {
            GameObject* lockerRoompatrolGuy01
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(2.53f, -76.81f, 6.00f));
            Commands->Attach_Script(lockerRoompatrolGuy01, "M04_Aft_LockerRoom_PatrolGuy01_JDG",
                                    "");

            GameObject* lockerRoompatrolGuy02
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-1.65f, -76.81f, 6.00f));
            Commands->Attach_Script(lockerRoompatrolGuy02, "M04_Aft_LockerRoom_PatrolGuy02_JDG",
                                    "");

            GameObject* leftBarracksTalkGuy01
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(11.01f, -103.69f, 6.00f));
            ...
            GameObject* leftBarracksTalkGuy02
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(9.25f, -100.55f, 6.00f));
            ...
            GameObject* leftBarracksTalkGuy03
                = Commands->Create_Object("Nod_MiniGunner_0", Vector3(9.33f, -103.77f, 6.00f));
        ...
        {
            GameObject* blackHandPointGuard02
                = Commands->Create_Object("Nod_FlameThrower_0", Vector3(9.13f, -86.51f, 9.00f));
            Commands->Set_Facing(blackHandPointGuard02, -90);

            GameObject* miniGunnerGuard01
                = Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(-9.25f, -76.39f, 9.00f));
            GameObject* miniGunnerGuard02
                = Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(0.46f, -75.99f, 9.00f));
            GameObject* miniGunnerGuard03
                = Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(11.11f, -76.49f, 9.00f));

            GameObject* blackHandMateGuard01
                = Commands->Create_Object("Nod_FlameThrower_0", Vector3(3.24f, -79.21f, 12.00f));
            Commands->Attach_Script(blackHandMateGuard01, "M04_Aft_FirstMateBodyguard_JDG", "");
            Commands->Set_Facing(blackHandMateGuard01, 0);

            GameObject* blackHandMateGuard02
                = Commands->Create_Object("Nod_FlameThrower_0", Vector3(3.85f, -85.44f, 12.00f));
...
DECLARE_SCRIPT(M04_SecondaryBridge_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_SHIPS_FIRST_MATE_JDG), 0, 100,
                                0); // tell first mate to start hearing stuff
// Commands->Send_Custom_Event( obj, Commands->Find_Object (M04_OBJECTIVE_CONTROLLER_JDG), 0, 1000,
// 0 );//tell objective controller to play battle music
...
GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-9.160f, -89.962f, 9.000f));
Commands->Attach_Script(sniperTarget01, "M04_Doorway_Enterer_JDG", "-0.091 -107.613 6");

GameObject* sniperTarget02
    = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(9.194f, -77.535f, 3));
Commands->Attach_Script(sniperTarget02, "M04_Doorway_Enterer_JDG", "14.657 -94.107 3");

GameObject* surpriseApache
    = Commands->Create_Object("Nod_Apache", Vector3(-50.075f, 8.732f, 5.534f));
...
DECLARE_SCRIPT(M04_Apache_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_APACHE_CONTROLLER_JDG), 0, 100,
                                0); // tell apache controller to place actors

GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-10.057f, 81.803f, -15));
...
DECLARE_SCRIPT(M04_ApacheRoom_Controller_JDG,
               "") // this guys ID number is M04_APACHE_CONTROLLER_JDG	200586
{
    int m04apache_ID;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            GameObject* m04apache
                = Commands->Create_Object("NOD_Apache", Vector3(1.469f, 50.814f, -14.00f));
            Commands->Attach_Script(m04apache, "M04_ApacheRoom_Apache_JDG", "");
            Commands->Set_Facing(m04apache, -125);

            GameObject* m04apacheSniper01 = Commands->Create_Object(
                "Nod_MiniGunner_2SF", Vector3(-13.728f, 63.244f, -9.003f));
            Commands->Attach_Script(m04apacheSniper01, "M04_ApacheRoom_Sniper01_JDG", "");

            GameObject* m04apacheSniper02
                = Commands->Create_Object("Nod_MiniGunner_2SF", Vector3(13.45f, 33.93f, -9.003f));
            ...
            if (tailgun01 != nullptr) {
                Commands->Send_Custom_Event(obj, tailgun01, M01_MODIFY_YOUR_ACTION_JDG,
                                            m04apache_ID, 0);
            }

            if (tailgun02 != nullptr) {
                Commands->Send_Custom_Event(obj, tailgun02, M01_MODIFY_YOUR_ACTION_JDG,
                                            m04apache_ID, 0);
            }
        }

        else if (param == 200) // recieved custom from trigger zone--tell apache to take off and
                               // attack player
        {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(m04apache_ID), 0,
...
DECLARE_SCRIPT(M04_ForeDeck_Initial_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 100,
...
DECLARE_SCRIPT(M04_MedLab_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_PRISON_WARDEN_JDG), 0, 100,
...
;
/*************************************************************************************************************
The following scripts are for the foredeck.  They include both the messhalls and the captain's
encounter.
*************************************************************************************************************/
DECLARE_SCRIPT(M04_ForeDeck_Controller_JDG,
               "") // this guys ID number is M04_FORE_DECK_CONTROLLER_JDG 100790
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (param == 100) // recieved custom from enter zones--here comes the player(s)
        {
            ...
            GameObject* torpedoRoomGuard
                = Commands->Create_Object("Nod_FlameThrower_0", Vector3(-.44f, 90.39f, -15.01f));
            Commands->Attach_Script(torpedoRoomGuard, "M04_ForeDeck_TorpedoRoom_Guard_JDG", "");

            GameObject* mapRoomGuard01 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                 Vector3(5.99f, 91.56f, -6.0f));
            Commands->Attach_Script(mapRoomGuard01, "M04_ForeDeck_MapRoom_Guard01_JDG", "");

            GameObject* mapRoomGuard02 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                 Vector3(-6.46f, 92.67f, -6.0f));
        ...
        {
            Commands->Create_Sound("00-c164e", Commands->Get_Position(obj),
                                   obj); // proceed with caution
        }
        ...
        else if (param == 500) // player is moving toward captain from grunt mess hall
        {
            ...
            GameObject* closetGuy01 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                              Vector3(-3.361f, 79.633f, 3.0f));
            ...
            GameObject* BH_messhall_guy01 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    Vector3(5.89f, 88.47f, 6.0f));
            Commands->Attach_Script(BH_messhall_guy01, "M04_BH_MessHall_Guy_JDG", "");
            Commands->Set_Facing(BH_messhall_guy01, -135);

            GameObject* BH_messhall_guy02 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    Vector3(5.30f, 87.52f, 6.0f));
            Commands->Attach_Script(BH_messhall_guy02, "M04_BH_MessHall_Guy_JDG", "");
            Commands->Set_Facing(BH_messhall_guy02, -155);

            GameObject* BH_messhall_guy03 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    Vector3(2.64f, 88.12f, 6.0f));
            Commands->Attach_Script(BH_messhall_guy03, "M04_BH_MessHall_Guy_JDG", "");
            Commands->Set_Facing(BH_messhall_guy03, -135);

            GameObject* BH_messhall_guy04 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    Vector3(2.08f, 87.44f, 6.0f));
            Commands->Attach_Script(BH_messhall_guy04, "M04_BH_MessHall_Guy_JDG", "");
            Commands->Set_Facing(BH_messhall_guy04, -140);

            GameObject* BH_messhall_guy05 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    Vector3(-0.38f, 87.29f, 6.0f));
        ...
        else if (param == 650) // received param from BH messhall enter zone--tell BH guys its okay
                               // to react now
        {
        ...
        {
            GameObject* captains_bodyguard_01 = Commands->Create_Object(
                "Nod_FlameThrower_1Off", Vector3(-17.79f, 85.49f, 13.13f));
...
void Killed(GameObject* obj, GameObject* killer)
{
    ...
    if ((reinforce_ka >= 0.5) && (reinforce_ka < 1.5)) {
        ...
        Commands->Attach_Script(captains_bodyguard_reinforceguy,
        ...
        Commands->Attach_Script(captains_bodyguard_reinforceguy,
                                "M04_Captains_Bodyguard_Reinforcement_JDG", "");
        Commands->Attach_Script(captains_bodyguard_reinforceguy02,
...
DECLARE_SCRIPT(M04_Captains_Bridge_Enter_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) {
    if (enterer == STAR) { Commands->Send_Custom_Event(
        obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 700,
...
DECLARE_SCRIPT(M04_BH_MessHall_Trigger_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 650,
...
DECLARE_SCRIPT(M04_ForeDeck_ClosetSurprise_Trigger_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 505,
                                0); // tell foredeck controller that player is leaving mess hall

GameObject* sniperTarget01
    = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(8.937f, 83.264f, 6.000f));
...
DECLARE_SCRIPT(M04_GruntMessHall_Exit_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 500,
                                0); // tell foredeck controller that player is leaving mess hall
...
DECLARE_SCRIPT(M04_GruntMessHall_Entry_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 300,
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && playerHasLevel3Keycard == true) {
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0, 100, 0);
        }
    }
};

DECLARE_SCRIPT(M04_Firefight_NodGuys, "") { void Killed(GameObject * obj, GameObject* killer) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0,
                                666, 0); // tell controller you've been killed
}
}
;
...
DECLARE_SCRIPT(M04_EnterCargoBay_BottomRight_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 100,
                                0);
...
DECLARE_SCRIPT(M04_RocketEmplacement_01_JDG, "") // 103461
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M01_MODIFY_YOUR_ACTION_JDG) {
            ...
            Commands->Debug_Message("***************************player has entered tailgun "
        ...
        if (type == 0 && deadYet == false) //
        {
            if (param == M01_START_ACTING_JDG) {
                ...
                if (myConsole != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "**********************startionary tech cannot find his console\n");
                }
            }
            ...
            else if (param == M01_IVE_BEEN_KILLED_JDG) // M04 PanicGuy 01 Twiddler
            {
                ...
                Commands->Action_Play_Animation(obj, params);
                     ...
                     == M01_MODIFY_YOUR_ACTION_04_JDG) // stand back up then start hunting player
            {
                Commands->Action_Reset(obj, 100);
...
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-14.594f, 27.717f, -9));
...
DECLARE_SCRIPT(M04_Catwalk_Enter_Zone_02_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    GameObject* sniperTarget01
    = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(12.913f, -27.628f, -9));
...
DECLARE_SCRIPT(M04_Hunter_Controller_JDG, "") // M04_ENGINEROOM_HUNTING_CONTROLLER_JDG
{
    ...
    void Created(GameObject * obj)
    {
        hunter_01_id = nullptr;
        hunter_02_id = nullptr;
        hunter_03_id = nullptr;
        messagePlayed = false;
    }
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                ...
                if (hunter_01 == nullptr) {
                    ...
                    GameObject* hunter_01 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    hunter01_spawnlocation);
                ...
                if (hunter_02 == nullptr) {
                    ...
                    GameObject* hunter_02 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    hunter02_spawnlocation);
                ...
                if (hunter_03 == nullptr) {
                    ...
                    GameObject* hunter_03 = Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle",
                                                                    hunter03_spawnlocation);
                ...
                if (messagePlayed == false) {
                    ...
                    int conv = Commands->Create_Conversation(
                        "M04_Eva_WarnsAboutHunters_Conversation", 30, 50, false);
                    Commands->Join_Conversation(nullptr, conv, false, false, false);
            ...
            else if (param == M01_MODIFY_YOUR_ACTION_02_JDG) // monitor how close you are to player
            {
                ...
                if (distanceFromStar <= 40) //******play eva warning conversation here*****
                {
                    ...
                    GameObject* hunterController
                        = Commands->Find_Object(M04_ENGINEROOM_HUNTING_CONTROLLER_JDG);
                    if (hunterController != nullptr) {
                        Commands->Send_Custom_Event(obj, hunterController, 0,
                                                    M01_MODIFY_YOUR_ACTION_JDG, 0);
                    }
                }
        ...
        void Custom( GameObject * obj, int type, int param, GameObject * sender )
        {
                if (type == 0)
                {
                        if (param == M01_MODIFY_YOUR_ACTION_JDG)
                        {
                                ...
                                Commands->Modify_Action ( obj, M01_WALKING_WAYPATH_01_JDG, params,
true, true );
                        }

                        else if (param == M01_MODIFY_YOUR_ACTION_02_JDG)//monitor how close you are
to player
                        {
                                Vector3 myPosition = Commands->Get_Position ( obj );
                                Vector3 playerPosition = Commands->Get_Position ( STAR );
                                float distanceFromStar = Commands->Get_Distance ( myPosition,
playerPosition );

                                if (distanceFromStar <= 40)//******play eva warning conversation
here*****
                                {
                                        int conv = Commands->Create_Conversation(
"M04_Eva_WarnsAboutHunters_Conversation", 100, 50, false); Commands->Join_Conversation( nullptr, conv,
false, false, false ); Commands->Start_Conversation( conv,  conv );
                                }

                                else
                                {
                                        Commands->Send_Custom_Event( obj, obj, 0,
M01_MODIFY_YOUR_ACTION_02_JDG, 5 );
                                }
                        }
                }
        }
        ...
        void Destroyed( GameObject * obj )
        {
                GameObject * myController = Commands->Find_Object (
M04_ENGINEROOM_HUNTING_CONTROLLER_JDG ); if (myController != nullptr)
                {
                        Commands->Send_Custom_Event( obj, myController, 0, M01_START_ACTING_JDG, 1
);
                }
               ...
               "") // this guys ID number is M04_TIBERIUM_HOLD_CONTROLLER_JDG 100572
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (enterer == STAR && (ok_to_clean_up == true)) {
            Commands->Send_Custom_Event(
                obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 6000,
                0); // tell aft deck controller to clean up any remaining soldiers
        }
        ...
        if (enterer == STAR && (entered == false)) {
            ...
            if (STAR != nullptr) {
                cargo_conv1 = Commands->Create_Conversation("M04_TiberiumHold_Entry_Conversation",
                                                            100, 1000, false);
                Commands->Join_Conversation(nullptr, cargo_conv1, false, false, false);
                // Commands->Join_Conversation( STAR, cargo_conv1, false, false, false );
                Commands->Start_Conversation(cargo_conv1, cargo_conv1);
...
/*DECLARE_SCRIPT(M11_MutantCrypt_Spawner03_Guy_JDG, "")
{
        ...
        void Killed( GameObject * obj, GameObject * killer )
        {
                ...
                GameObject * mutantController = Commands->Find_Object (
M11_MUTANT_CRYPT_SPAWNER_CONTROLLER_JDG ); if (mutantController != nullptr)
                {
                        Commands->Send_Custom_Event ( obj, mutantController, 0,
M01_SPAWNER_IS_DEAD_JDG, 0 );
        ...
        void Enemy_Seen( GameObject * obj, GameObject * enemy )
        {
                if (obj && enemy == STAR && myState == IDLE)//
                {
                        ...
                        Commands->Create_Logical_Sound (obj, M11_MUTANT_IS_NEARBY_JDG, myPosition,
50 );
                }
        }
...
DECLARE_SCRIPT(M04_TibHold_MutantChambers_Controller_JDG,
               "") // M04_TIBERIUM_CHAMBERCONTROLLER_JDG 104113
{
    ...
    void Created(GameObject * obj)
    {
        ...
        GameObject* mutantChamber01
            = Commands->Create_Object("Simple_Large_CryoChamber", mutantChamber01_Position);
        ...
        GameObject* mutantChamber02
            = Commands->Create_Object("Simple_Large_CryoChamber", mutantChamber02_Position);
        ...
        GameObject* mutantChamber03
            = Commands->Create_Object("Simple_Large_CryoChamber", mutantChamber03_Position);
        ...
        GameObject* mutantChamber04
            = Commands->Create_Object("Simple_Large_CryoChamber", mutantChamber04_Position);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            ...
            {
                Commands->Debug_Message("***************************Mutant chamber received custom "
                                        "that non-destroyed version has been killed\n");
                ...
                GameObject* destroyedVersion = Commands->Create_Object(
                    "Simple_Large_CryoChamber_Destroyed", chamberPosition);
...
DECLARE_SCRIPT(M04_TibHold_MutantChamber_NoThreat_JDG, "")
{
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        ...
        if (obj && switched == true) {
            ...
            if (myController != nullptr) {
                Commands->Debug_Message("***************************Mutant chamber sending custom "
                                        "that non-destroyed version has been killed\n");
...
DECLARE_SCRIPT(M04_TibHold_Mutant_NoThreat_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 0) {
            if (param
                == M01_IVE_BEEN_KILLED_JDG) // your chamber's been destroyed--do swap and whatnot
            {
...
int cargo_conv1
    = Commands->Create_Conversation("M04_TiberiumHold_Visceroid_Conversation", 100, 1000, false);
Commands->Join_Conversation(nullptr, cargo_conv1, false, false, false);
// Commands->Join_Conversation( STAR, cargo_conv1, false, false, false );
Commands->Start_Conversation(cargo_conv1, cargo_conv1);
}
        ...
        if (type == 0) {
            if (param == M01_START_ACTING_JDG) {
                ...
                if (obj && visceroidGuy02 != nullptr) {
                    spill_conv1 = Commands->Create_Conversation("M04_Tiberium_Tech_Conversation",
                                                                30, 20, true);
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
        ...
        // 0, 1001, 2 );//tell objective controller to go back to regular background music
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_TIBERIUM_HOLD_CONTROLLER_JDG), 0,
                                    2000, 0); // this custom tells the tib zone that its okay clean
                                              // up aft deck soldiers next time entered
...
DECLARE_SCRIPT(M04_Ships_FirstMate_JDG,
               "") // this guys ID number is M04_SHIPS_FIRST_MATE_JDG  100400
{ void Created(GameObject * obj) { Commands->Set_Innate_Is_Stationary(obj, true);
}
...
void Killed(GameObject* obj, GameObject* killer)
{
    ...
    GameObject* samRoomPatrolGuy
        = Commands->Create_Object("Nod_MiniGunner_0", Vector3(11.503f, -51.722f, 2.704f));
    Commands->Attach_Script(samRoomPatrolGuy, "M04_PostFirstMate_SamRoom_PatrolGuy_JDG", "");

    GameObject* missileRoomPatrolGuy
        = Commands->Create_Object("Nod_MiniGunner_0", Vector3(13.213f, -53.008f, -15.0f));
    Commands->Attach_Script(missileRoomPatrolGuy, "M04_PostFirstMate_MissileRoom_PatrolGuy_JDG",
                            "");

    GameObject* subBayPatrolGuy
        = Commands->Create_Object("Nod_MiniGunner_0", Vector3(12.527f, 19.447f, -15.0f));
    Commands->Attach_Script(subBayPatrolGuy, "M04_Front_ofThe_Boat_Population_JDG", "");

    GameObject* officerQuartersPatrolGuy
        = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(8.342f, 80.0f, 3.0f));
    Commands->Attach_Script(officerQuartersPatrolGuy,
                            "M04_PostFirstMate_OfficerQuarters_PatrolGuy_JDG", "");

    GameObject* foreDeckPatrolGuy01
        = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(0.345f, 106.479f, 3.001f));
    Commands->Attach_Script(foreDeckPatrolGuy01, "M04_PostFirstMate_FrontDeck_PatrolGuy01_JDG", "");

    GameObject* foreDeckPatrolGuy02
        = Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-13.320f, 71.885f, 0));
    ...
    if (param == 100) // warden has received custom to start acting
    {
        ...
        if (obj && medTech != nullptr) {
            int medlabConversation
                = Commands->Create_Conversation("M04_MedLab_Conversation", 80, 50, true);
...
DECLARE_SCRIPT(M04_Prisoners_Rescued_Controller_JDG,
               "") { void Custom(GameObject * obj, int type, int param,
                                 GameObject* sender) { if (type == 0) { if (param == 1) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0, 1,
...
DECLARE_SCRIPT(M04_MissileRoom_ObjectiveZone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 440,
...
DECLARE_SCRIPT(M04_Announce_Keycard_02_Objective_Zone_JDG,
               "") { void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 410,
                                5);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false && pokable == true) {
            if (STAR != nullptr) {
                ...
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 100, 0);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false && pokable == true) {
            if (STAR != nullptr) {
                ...
                Commands->Set_Animation(obj, "DSP_L4MISSRACK.DSP_L4MISSRACK", false);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 110, 0);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false && pokable == true) {
            if (STAR != nullptr) {
                ...
                Commands->Set_Animation(obj, "DSP_L4MISSRACK.DSP_L4MISSRACK", false);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 120, 0);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false && pokable == true) {
            if (STAR != nullptr) {
                ...
                Commands->Set_Animation(obj, "DSP_L4MISSRACK.DSP_L4MISSRACK", false);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 130, 0);
...
GameObject* engineBuildingController
    = Commands->Find_Object(M04_ENGINEROOM_BUILDING_CONTROLLER_JDG);
...
DECLARE_SCRIPT(M04_ApacheRoom_Apache_JDG, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (param == M01_MODIFY_YOUR_ACTION_JDG) // recieved custom from controller--take off and
                                                 // attack player
        {
        ...
        else if (param == M01_MODIFY_YOUR_ACTION_05_JDG) // player is in tailun 01--go fight him
        {
            ...
            Commands->Action_Attack(obj, params);
                 ...
                 == M01_MODIFY_YOUR_ACTION_06_JDG) // player is in blackhand area--go wait at hangar
        {
            Commands->Debug_Message(
                "***************************apache has received custom to go back to hangar\n");
        ...
        {
            Commands->Debug_Message("***************************apache has received custom that "
                                    "player is on top floor hangar\n");
            waitingInAmbush = false;
        ...
        {
            Commands->Debug_Message("***************************apache has received custom that "
                                    "player is on middle floor hangar\n");
            waitingInAmbush = false;
            fightingInHangar = true;
            params.Set_Basic(this, 100, M01_WALKING_WAYPATH_05_JDG);
            params.Set_Attack(STAR, 1000, 0, true);
        ...
        {
            Commands->Debug_Message("***************************apache has received custom that "
                                    "player is on bottom floor hangar\n");
            waitingInAmbush = false;
            fightingInHangar = true;
            params.Set_Basic(this, 100, M01_WALKING_WAYPATH_05_JDG);
            params.Set_Attack(STAR, 1000, 0, true);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        if (action_id == M01_WALKING_WAYPATH_01_JDG && complete_reason == ACTION_COMPLETE_NORMAL) {
            ...
            Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG, 0);
                 ...
                 && complete_reason
                     == ACTION_COMPLETE_NORMAL) { // you are now waiting above the hangar
            Commands->Debug_Message(
                "***************************apache should now be waiting over hangar\n");

            GameObject* zone01 = Commands->Find_Object(
                105011); // these are the enter zones for going back through the apache hangar
            GameObject* zone02 = Commands->Find_Object(105012);
            GameObject* zone03 = Commands->Find_Object(105081);
            GameObject* zone04 = Commands->Find_Object(105082);
            GameObject* zone05 = Commands->Find_Object(105083);
...
DECLARE_SCRIPT(M04_Firefight_Prisoner, "")
{
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        ...
        if (((myCurrentHealth / myMaxHealth) * 100) <= 50) {
            if (warningPlayed == false) {
                Commands->Set_HUD_Help_Text(IDS_M04DSGN_DSGN0204I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                warningPlayed = true;
                int medlabConversation = Commands->Create_Conversation(
                    "M04_POW_Health_Warning_Conversation", 100, 50, false);
                Commands->Join_Conversation(nullptr, medlabConversation, false, true);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (rallying == false && pokable == true) {
            Commands->Enable_HUD_Pokable_Indicator(obj, false);
            int medlabConversation = Commands->Create_Conversation(
                "M04_Firefight_POW_Poke_Conversation", 100, 50, false);
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0,
                                    10, 0); // tell controller you've been killed
    }
...
DECLARE_SCRIPT(M04_Firefight_Controller_JDG,
               "") // this guys ID number is M04_END_FIREFIGHT_CONTROLLER_JDG 100948
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        {
            Commands->Create_Sound("00-n100e", Commands->Get_Position(obj),
                                   obj); // your mission is a failure
        ...
        else if (param == 20) // tell POWs to gather at sub
        {
            ...
            int medlabConversation = Commands->Create_Conversation(
                "M04_Rally_Round_The_Sub_Boy_Conversation", 100, 50, false);
            Commands->Join_Conversation(nullptr, medlabConversation, false, true);
            // Commands->Join_Conversation( medTech, medlabConversation, false, true );
            Commands->Start_Conversation(medlabConversation, medlabConversation);
        }
                 ...
                 == 100) // player has picked up the level 3 key card...place actors and give alert
        {
            if (prisoners_rescued == true) {
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 470, 0);
                ...
                if (currentDifficulty == hard) {
                    ...
                    GameObject* prisonerOne = Commands->Create_Object(
                        "GDI_Prisoner_v0b", Vector3(-8.58f, 0.06f, -9.0f));
                    Commands->Attach_Script(prisonerOne, "M04_Firefight_Prisoner", "");

                    GameObject* prisonerTwo = Commands->Create_Object(
                        "GDI_Prisoner_v1b", Vector3(-14.70f, -9.84f, -9.0f));
                    Commands->Attach_Script(prisonerTwo, "M04_Firefight_Prisoner", "");

                    GameObject* prisonerThree = Commands->Create_Object(
                        "GDI_Prisoner_v2b", Vector3(8.99f, -1.80f, -9.0f));
                    Commands->Attach_Script(prisonerThree, "M04_Firefight_Prisoner", "");
                    Commands->Send_Custom_Event(obj, prisonerThree, 0, 1,
                                                0); // tell this guy he is pokable
                    ...
                    GameObject* prisonerThree = Commands->Create_Object(
                        "GDI_Prisoner_v2b", Vector3(-12.061f, -7.909f, -9.0f));
                    Commands->Attach_Script(prisonerThree, "M04_Firefight_Prisoner", "");
                ...
                Commands->Send_Custom_Event(obj, obj, 0, 20,
                                            delayTimer); // tell prisoners to gather at sub
                Commands->Send_Custom_Event(obj, obj, 0, 110, 1); // give verbal alert

                // the following 3 customs tell the end-mission zone what the prisoner's ID numbers
                // are
                ...
                if (rallyZone != nullptr) {
                    ...
                    Commands->Debug_Message(
                        "***************************firefight controller cannot find rally zone\n");
                }
        ...
        {
            // Commands->Create_Sound ( "00-d404e", Commands->Get_Position ( obj ), obj );//updating
            // radar flags..temp placeholder
        }
        ...
        else if (param == 666) // a nod attacker has been killed
        {
            ...
            if ((doko_ni_reinforceka >= 0.5) && (doko_ni_reinforceka < 1.5)
                && (spawned_nod_guys < 15)) {
                GameObject* nodGuy01 = Commands->Trigger_Spawner(100938);
                Commands->Attach_Script(nodGuy01, "M04_Firefight_NodGuys", "");
                Commands->Grant_Key(nodGuy01, 2, true);
            ...
            else if ((doko_ni_reinforceka >= 1.5) && (doko_ni_reinforceka < 2.5)
                     && (spawned_nod_guys < 15)) {
                GameObject* nodGuy02 = Commands->Trigger_Spawner(100952);
                Commands->Attach_Script(nodGuy02, "M04_Firefight_NodGuys", "");
                Commands->Grant_Key(nodGuy02, 2, true);
            ...
            else if ((doko_ni_reinforceka >= 2.5) && (doko_ni_reinforceka < 3.5)
                     && (spawned_nod_guys < 15)) {
                GameObject* nodGuy03 = Commands->Trigger_Spawner(100951);
                Commands->Attach_Script(nodGuy03, "M04_Firefight_NodGuys", "");
                Commands->Grant_Key(nodGuy03, 2, true);
...
DECLARE_SCRIPT(M04_Firefight_RallyZone, "") // this guys ID number is 101194
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (enterer == STAR) {
            ...
            //(M04_OBJECTIVE_CONTROLLER_JDG), 0, M01_DO_END_MISSION_CHECK_JDG, 0 );
            // }
        }
        ...
        if ((player_at_rallypoint == true) && (prisoner01_at_rallypoint == true)
            && (prisoner02_at_rallypoint == true) && (prisoner03_at_rallypoint == true)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0,
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false) {
            if (STAR != nullptr) {
                ...
                Commands->Set_Animation(obj, "DSP_L4TORPEDO.DSP_L4TORPEDO", false);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 200, 0);
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (poked_yet == false) {
            if (STAR != nullptr) {
                ...
                Commands->Set_Animation(obj, "DSP_L4TORPEDOR.DSP_L4TORPEDOR", false);
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 210, 0);
        ...
        if (type == M01_ADD_OBJECTIVE_POG_JDG) {
            if (param == 200) // add first pog for engine room
            {
                ...
                if (engineroom_target01 != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(200, 92, "POG_M04_2_01.tga",
                                                              IDS_POG_DESTROY, pogLocation);
                }
            ...
            else if (param == 300) // add first pog for missile room
            {
                if (missile_target01_poked == false) {
                    ...
                    if (missile_target01 != nullptr) {
                        ...
                        Commands->Set_Objective_HUD_Info_Position(300, 91, "POG_M04_1_03.tga",
                                                                  IDS_POG_SABOTAGE, pogLocation);
                    }
                }
            ...
            else if (param == 400) // add first pog for torpedo room
            {
                ...
                if (torpedo_target01 != nullptr) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(400, 91, "POG_M04_1_04.tga",
                                                              IDS_POG_SABOTAGE, pogLocation);
                }
            }
        }
            ...
            if (param == 200) // an engineroom target has been destroyed--change pog over
            {
                ...
                if (sender == engineroom_target01) {
                    if (engineroom_target01_active == true) {
                        engineroom_target01_active = false;
                        Commands->Set_Objective_HUD_Info(200, -1, "POG_M04_2_01.tga",
                                                         IDS_POG_DESTROY);
                    ...
                    if (engineroom_target04_active == true) {
                     ...
                     == 300) // missile room target has been poked--see who it is and take action
            {
                GameObject* missile_target01 = Commands->Find_Object(100421);
                GameObject* missile_target02 = Commands->Find_Object(100422);
                GameObject* missile_target03 = Commands->Find_Object(100423);
                ...
                if (missile_target01_poked == true
                    && missile_target01_active == true) // done with #1 light up next one
                {
                    ...
                    if (missile_target02_poked == false) {
                        ...
                        if (missile_target02 != nullptr) {
                            ...
                            Commands->Set_Objective_HUD_Info_Position(
                                300, 91, "POG_M04_1_03.tga", IDS_POG_SABOTAGE, pogLocation);
                        }
                    }
                ...
                else if (missile_target02_poked == true
                         && missile_target02_active == true) // done with #2 light up next one
                {
                    Commands->Set_Objective_HUD_Info(300, -1, "POG_M04_1_03.tga", IDS_POG_SABOTAGE);
                ...
                else if (missile_target03_poked == true
                         && missile_target03_active == true) // done with #3 light up next one
                {
                    Commands->Set_Objective_HUD_Info(300, -1, "POG_M04_1_03.tga", IDS_POG_SABOTAGE);
            ...
            else if (param == 400) // torpedo target has been poked--see who it is and take action
            {
                ...
                if (torpedo_target01_poked == true) {
                    ...
                    if (torpedo_target02 != nullptr && torpedo_target02_poked == false) {
                        ...
                        Vector3 pogLocation = Commands->Get_Position(torpedo_target02);
                        Commands->Set_Objective_HUD_Info_Position(400, -1, "POG_M04_1_04.tga",
                                                                  IDS_POG_SABOTAGE, pogLocation);
                    }
                }
            }
...
DECLARE_SCRIPT(M04_Start_TorpedoObjective_Zone_JDG, "") // 105238 105239
{
    ...
    {
        if (enterer == STAR
            && conversationPlaying == false) // M04_Add_Torpedo_Objective_Conversation
        {
            conversationPlaying = true;
            missionIntroConv = Commands->Create_Conversation(
                "M04_Add_Torpedo_Objective_Conversation", 100, 1000, false);
            Commands->Join_Conversation(nullptr, missionIntroConv, false, false);
            Commands->Start_Conversation(missionIntroConv, missionIntroConv);
            Commands->Monitor_Conversation(obj, missionIntroConv);
        }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        ...
        case ACTION_COMPLETE_CONVERSATION_ENDED: {
            ...
            {
                Commands->Send_Custom_Event(
                    obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 450, 0);

                GameObject* pogController = Commands->Find_Object(104693);
                if (pogController != nullptr) {
                    Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG, 400,
                                                0);
                }
...
{ void Entered(GameObject * obj, GameObject* enterer) { if (enterer == STAR) {
    int missionIntroConv
    = Commands->Create_Conversation("M04_Poke_The_Torpedos_Conversation", 100, 1000, false);
Commands->Join_Conversation(nullptr, missionIntroConv, false, false);
Commands->Start_Conversation(missionIntroConv, missionIntroConv);
...
DECLARE_SCRIPT(M04_BigSam_Script_JDG, "") // 104873
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == CUSTOM_EVENT_SOUND_ENDED) {
            if (param == civWarning) {
                Commands->Set_Animation(obj, "DSP_L4GIANTGUN.DSP_L4GIANTGUN", false, nullptr, 0, 119);
                ...
                Commands->Create_Explosion("Explosion_SAM_Site", explosion01_spot, nullptr);
                Commands->Set_Animation(obj, "DSP_L4GIANTGUN.DSP_L4GIANTGUN", false, nullptr, 120,
                                        200);
                Commands->Set_Health(obj, 0.25f);
            }
        }
            ...
            if (param == M01_START_ACTING_JDG) // missiles sabotaged/player entered room...start
...
Commands->Create_Sound(sound_name, speaker01_Position, nullptr);
Commands->Create_Sound(sound_name, speaker02_Position, nullptr);
Commands->Create_Sound(sound_name, speaker03_Position, nullptr);
...
DECLARE_SCRIPT(M04_Objective_Reminder_Controller_JDG, "") // 105760
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M01_ADD_OBJECTIVE_POG_JDG) {
            ...
            {
                if (missile_primaryActive == true
                    && commandClearance == true) { // M04_Add_MissileRoom_Objective_Conversation
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Add_MissileRoom_Objective_Conversation", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }

                else if (torpedo_primaryActive == true
                         && commandClearance == true) { // M04_Add_Torpedo_Objective_Conversation
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Add_Torpedo_Objective_Conversation", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }

                else if (l01keycard_primaryActive == true
                         && commandClearance == true) { // M04_Add_PrisonKey_Objective
                    int reminderConv = Commands->Create_Conversation("M04_Add_PrisonKey_Objective",
                                                                     10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }

                else if (prisoner_primaryActive == true
                         && commandClearance == true) { // M04_Mission_Start_Conversation
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Mission_Start_Conversation", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }
                         ...
                         && commandClearance
                             == true) { // M04_Add_Captains_Key_Objective_Conversation
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Add_Captains_Key_Objective_Conversation", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }

                else if (l02keycard_primaryActive == true
                         && commandClearance == true) { // M04_Add_FirstMate_Objective_JDG
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Add_FirstMate_Objective_JDG", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }

                else if (escape_primaryActive == true
                         && commandClearance == true) { // M04_Rally_Round_The_Sub_Boy_Conversation
                    int reminderConv = Commands->Create_Conversation(
                        "M04_Rally_Round_The_Sub_Boy_Conversation", 10, 1000, false);
                    Commands->Join_Conversation(nullptr, reminderConv, false, false);
                    Commands->Start_Conversation(reminderConv, reminderConv);
                }
