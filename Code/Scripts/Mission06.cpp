...
DECLARE_SCRIPT(M06_Objective_Controller, "") // 100018
{
    ...
    void Add_An_Objective(int id)
    {
        ...
        case 601: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    601, 90.0f, "POG_M06_1_03.tga", IDS_POG_HACK, Commands->Get_Position(object));
            }
        } break;
        // Rescue Scientists
        case 603: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    603, 90.0f, "POG_M06_1_04.tga", IDS_POG_RESCUE, Commands->Get_Position(object));
            }
        } break;
        // Eliminate Mendoza
        case 604: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(604, 90.0f, "POG_M06_1_01.tga",
                                                          IDS_POG_ELIMINATE,
        ...
        case 609: {
            ...
            if (star_greenhouse == (WWMath::Min(star_greenhouse, star_shower))) {
                ...
                if (object) {
                    ...
                    Commands->Set_Objective_HUD_Info_Position(609, 90.0f, "POG_M08_2_02.tga",
                                                              IDS_POG_DISABLE,
                                                              Commands->Get_Position(object));
                }
            }
        ...
        case 611: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    611, 90.0f, "POG_M06_1_05.tga", IDS_POG_ESCORT, Commands->Get_Position(object));
            }
        } break;
        }
    }
    ...
    {
        if (action_id == 300601
            && (reason == ACTION_COMPLETE_CONVERSATION_ENDED
...
DECLARE_SCRIPT(M06_WarRoom_Computer, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (Commands->Is_A_Star(poker) && (!already_poked)) {
            // Data decryption complete. Internal computer systems indicate Dr. Ignatio Mobius is
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300603
            && (reason == ACTION_COMPLETE_CONVERSATION_ENDED
                || reason == ACTION_COMPLETE_CONVERSATION_INTERRUPTED)) {
            // New Primary Mission Objective: Evacuate Doctors' Ignatio and Sydney Mobius. Basement,
            // NE section.  Requires level 2 security keycard.
...
DECLARE_SCRIPT(M06_Sydney_Mobius, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        ...
        case 2: {
            ...
            params.Set_Movement(Commands->Find_Object(Sydney_Move_Table[current_move_loc]), 1.0f,
                                3.0f);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_RELOCATE) {
            if (param == 0) {
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(108285), M06_CUSTOM_ACTIVATE,
                                            1, 0.0f);
            ...
            if (param == 1) {
                ...
                // Relocate Mendoza
                // Commands->Send_Custom_Event(obj, Commands->Find_Object(108275), M06_RELOCATE, 0,
                // 0.0f);
                ...
                //
                Commands->Create_Logical_Sound(obj, M06_CLEAR_FOR_MENDOZA,
                                               Commands->Get_Position(obj), 2500.0f);
            }
        }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if ((action_id == SYDNEY_MOVE_LOC) && (action_id != Commands->Get_Action_ID(obj))
            ...
            && (reason == ACTION_COMPLETE_LOW_PRIORITY)) {
            Commands->Start_Timer(obj, this, 4.0f, MOVE_LOC_LOW_PRIORITY);
        }
    }
...
Commands->Create_Explosion("Chateau_Explosions_Twiddler",
                           Commands->Get_Position(Commands->Find_Object(explode_loc[param])));
}
}
}
;
...
DECLARE_SCRIPT(M06_Activate_Midtro, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            //		Commands->Send_Custom_Event (obj, Commands->Find_Object(101010), 100, 100,
            //0.0f);
            ...
            GameObject* cinematic_obj
                = Commands->Create_Object("Invisible_Object", Vector3(0.0f, 0.0f, 0.0f));
...
DECLARE_SCRIPT(M06_Destruction_Stub, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == 100 && param == 100) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(104312), M06_CHATEAU_COLLAPSE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(105635), M06_CHATEAU_COLLAPSE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(105639), M06_CHATEAU_COLLAPSE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(105640), M06_CHATEAU_COLLAPSE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(105641), M06_CHATEAU_COLLAPSE, 1,
                                        0.0f);

            // Create destruction path blocks
            GameObject* crate1
                = Commands->Create_Object("X6_Rubble1", Vector3(23.453f, 16.340f, -2.000f));
            Commands->Set_Facing(crate1, -65.000f);

            GameObject* crate2
                = Commands->Create_Object("X6_Rubble2", Vector3(27.086f, 28.569f, -1.454f));
            Commands->Set_Facing(crate2, 0.000f);

            GameObject* crate3
                = Commands->Create_Object("X6_Rubble2", Vector3(25.614f, 33.324f, -0.043f));
            Commands->Set_Facing(crate3, 125.000f);

            GameObject* crate4
                = Commands->Create_Object("X6_Rubble3", Vector3(14.597f, -30.510f, -0.033f));
            Commands->Set_Facing(crate4, 140.000f);

            GameObject* crate5
                = Commands->Create_Object("X6_Rubble4", Vector3(25.079f, 28.012f, -2.007f));
            Commands->Set_Facing(crate5, -60.000f);

            GameObject* crate6
                = Commands->Create_Object("X6_Rubble4", Vector3(26.463f, 27.382f, -2.003f));
            Commands->Set_Facing(crate6, 0.000f);

            GameObject* crate7
                = Commands->Create_Object("X6_Rubble4", Vector3(38.426f, 2.889f, 2.574f));
            Commands->Set_Facing(crate7, -35.000f);

            GameObject* crate8
                = Commands->Create_Object("X6_Rubble4", Vector3(40.258f, 3.442f, 2.798f));
            Commands->Set_Facing(crate8, -180.000f);

            GameObject* crate9
                = Commands->Create_Object("X6_Rubble4", Vector3(9.832f, -35.126f, -0.014f));
            Commands->Set_Facing(crate9, 5.000f);

            GameObject* crate10
                = Commands->Create_Object("X6_Rubble4", Vector3(4.503f, -33.694f, 3.003f));
            Commands->Set_Facing(crate10, 150.000f);

            GameObject* crate11
                = Commands->Create_Object("X6_Rubble4", Vector3(1.179f, -33.281f, -0.042f));
            Commands->Set_Facing(crate11, -160.000f);

            GameObject* crate12
                = Commands->Create_Object("X6_Rubble4", Vector3(-5.442f, -28.292f, 0.003f));
            Commands->Set_Facing(crate12, -15.000f);

            GameObject* crate13
                = Commands->Create_Object("X6_Rubble4", Vector3(-5.423f, -12.960f, 0.000f));
            Commands->Set_Facing(crate13, 110.000f);

            GameObject* crate14
                = Commands->Create_Object("X6_Rubble5", Vector3(8.042f, 27.962f, -0.150f));
            Commands->Set_Facing(crate14, 150.000f);

            GameObject* crate15
                = Commands->Create_Object("X6_Rubble5", Vector3(9.271f, 28.300f, -0.001f));
            Commands->Set_Facing(crate15, -5.000f);

            GameObject* crate16
                = Commands->Create_Object("X6_Rubble5", Vector3(7.208f, 30.813f, 4.400f));
            Commands->Set_Facing(crate16, 142.684f);

            GameObject* crate17
                = Commands->Create_Object("X6_Rubble5", Vector3(5.628f, 29.865f, -0.025f));
            Commands->Set_Facing(crate17, 115.000f);

            GameObject* crate18
                = Commands->Create_Object("X6_Rubble5", Vector3(38.716f, 4.235f, 2.374f));
            Commands->Set_Facing(crate18, 50.000f);

            GameObject* crate19
                = Commands->Create_Object("X6_Rubble5", Vector3(13.124f, -30.323f, 0.000f));
            Commands->Set_Facing(crate19, 5.000f);

            GameObject* crate20
                = Commands->Create_Object("X6_Rubble5", Vector3(8.932f, -34.790f, -0.000f));
            Commands->Set_Facing(crate20, -0.000f);

            GameObject* crate21
                = Commands->Create_Object("X6_Rubble5", Vector3(6.464f, -33.466f, 2.978f));
            Commands->Set_Facing(crate21, 0.000f);

            GameObject* crate22
                = Commands->Create_Object("X6_Rubble5", Vector3(2.144f, -33.484f, 0.007f));
            Commands->Set_Facing(crate22, 0.000f);

            GameObject* crate23
                = Commands->Create_Object("X6_Rubble5", Vector3(-5.275f, -27.057f, 0.000f));
            Commands->Set_Facing(crate23, 70.000f);

            GameObject* crate24
                = Commands->Create_Object("X6_Rubble5", Vector3(-5.932f, -11.340f, 0.000f));
            Commands->Set_Facing(crate24, 25.000f);

            GameObject* crate25
                = Commands->Create_Object("X6_Rubble5", Vector3(-4.760f, -1.653f, 0.000f));
            Commands->Set_Facing(crate25, 110.000f);

            GameObject* crate26
                = Commands->Create_Object("X6_Rubble5", Vector3(-5.332f, -2.713f, 0.277f));
            Commands->Set_Facing(crate26, 0.000f);

            GameObject* crate27
                = Commands->Create_Object("X6_Rubble5", Vector3(5.699f, -32.438f, 2.563f));
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == SHAKE_TIMER) {
            ...
            Commands->Shake_Camera(Vector3(-12.0f, 40.0f, -9.0f), 1000.0f, camera_intensity,
                                   camera_duration);
        }
    }
};
...
DECLARE_SCRIPT(M06_Activate_Secret_Door, "Secret_Door_ID=0:int")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300608 && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            Commands->Static_Anim_Phys_Goto_Last_Frame(Get_Int_Parameter("Secret_Door_ID"),
                                                       "BK.BK");
...
DECLARE_SCRIPT(M06_Civ_Prisoner, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        //		Commands->Send_Custom_Event (obj, Commands->Find_Object(100018), 605, 2,
        //0.0f);
    }
};
...
DECLARE_SCRIPT(M06_Gate_Guards, "Soldier_ID=0:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(110908), M06_GATE_GUARD_WAYPATH, 1,
                                    0.0f);
    }
        ...
        if (timer_id == CONVERSATION) {
            ...
            case 1: {
                if (Commands->Find_Object(101021)) {
                    ...
                    int conv_id = Commands->Create_Conversation(
                        conv_name, INNATE_PRIORITY_ENEMY_SEEN - 5, 15.0f, false);
                    Commands->Join_Conversation(obj, conv_id, false, true);
                    Commands->Join_Conversation(Commands->Find_Object(110908), conv_id, false,
                                                true);
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (Commands->Find_Object(101037) && (!disable_tower_spawn)) // Officer in tower
        {
            /*	const char * conv_name[6];
                    conv_name[0] = ("M06_CON012");  // This is Tower, What's your situation
               brother?\n conv_name[1] = ("M06_CON013");  // This is Tower, please respond.\n
                    conv_name[2] = ("M06_CON014");  // This is Tower, I'm sending a recon to your
               position.\n conv_name[3] = ("M06_CON015");  // This is Tower. Hold position brother,
               reinforcements enroute.\n conv_name[4] = ("M06_CON016");  // This is Tower, report
               in.\n conv_name[5] = ("M06_CON017");  // This is Tower. We've a possible man down,
               Bravo patrol inspect.\n
        ...
        if (damager == STAR) {
            if (!attacking) {
                ...
                Commands->Attach_Script(obj, "M08_Mobile_Vehicle",
                                        "111422, 111423, 111424, 111425, 111426, 111427, 111428, "
                                        "111429, 111430, 111431");
            }
        }
    }
...
DECLARE_SCRIPT(M06_Alarm_Controller, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        Commands->Debug_Message("Custom received Alarm_Controller.  type %d param %d sender_id %d "
                                "sender_pos X %d, Y %d, Z %d.\n",
                                type, param, Commands->Get_ID(sender), sender_pos.X, sender_pos.Y,
                                sender_pos.Z);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if ((timer_id == STAND_DOWN)) // && (alarm_sounded) && (alarmed))
        {
            ...
            alarm_sounded = true;
            //			Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), 610,
            //1, 0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Alarm_Behavior, "Alarm_Enemy_Seen=0.0:float, Alarm_Damaged=0.0:float")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 10 && reason == ACTION_COMPLETE_NORMAL && !alarmed) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(closest_id), M06_CHECK_ALARM,
                                        Commands->Get_ID(obj), 0.0f);
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_ALARMED) // Custom returned from alarm controller for new spawns to set
                                 // alarmed status
        {
        ...
        if (type == M06_CHECK_ALARM && !alarmed) {
            ...
            if (param == 1) {
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), M06_SOUND_ALARM, 1,
                                            0.0f);
    ...
    void Sound_Heard(GameObject * obj, const CombatSound& sound)
    {
        ...
        if (sound.Type == M06_ATTACK_HAVOC_SOUND) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(havoc_id), M06_ATTACK_HAVOC, 1,
                                        0.0f);
        }
    ...
    {
        if (attacking_havoc) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(havoc_id),
                                        M06_DEAD_HAVOC_ATTACKER, 1, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M06_Alarm_Switch, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Debug_Message("Position of alarm switch %d: X: %d, Y: %d, Z:%d",
                                Commands->Get_ID(obj), alarm_pos.X, alarm_pos.Y, alarm_pos.Z);
...
DECLARE_SCRIPT(M06_Alarm_Terminal_DLS, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (Commands->Is_A_Star(poker)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), M06_STAND_DOWN, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Tower_Patrol, "Waypath_ID=0:int, Waypath_Loc:Vector3")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (Commands->Find_Object(101037) && (!disable_tower_spawn)
            && (!chateau_destruction)) // Officer in tower
        {
            const char* conv_name[6];
            ...
            conv_name[3]
                = ("M06_CON015"); // This is Tower. Hold position brother, reinforcements enroute.\n
            conv_name[4] = ("M06_CON016"); // This is Tower, report in.\n
            conv_name[5] = ("M06_CON017"); // This is Tower. We've a possible man down, Bravo patrol
                                           // inspect.\n
...
DECLARE_SCRIPT(M06_Interior_Patrol, "Waypath_ID=0:int, Waypath_Loc:Vector3")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101309), M06_DEAD_INTERIOR_PATROL, 1,
                                    0.0f);
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_DEAD_COURTYARD_EAGLE) {
            ...
            if (dead_courtyard_eagle == 3) {
                ...
                Commands->Create_Logical_Sound(obj, M06_DISABLE_COURTYARD_SPAWN, Vector3(0, 0, 0),
                                               2500.0f);

                // Create Search Apche in Courtyard
                //		GameObject * search_apache = Commands->Create_Object ( "Nod_Apache",
                //Vector3(-99.996f, -135.659f, 37.552f)); 		Commands->Attach_Script(search_apache,
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_DEAD_HEDGEMAZE_EAGLE) {
            ...
            if (dead_hedgemaze_eagle == 2) {
                ...
                Commands->Create_Logical_Sound(obj, M06_DISABLE_HEDGEMAZE_SPAWN, Vector3(0, 0, 0),
                                               2500.0f);
            }
        }
    }
...
DECLARE_SCRIPT(M06_Barracks_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        //	GameObject * chinook_obj = Commands->Create_Object ( "Invisible_Object",
        //Vector3(-37.824f, 30.975f, 1.605f)); 	Commands->Set_Facing(chinook_obj, 0.000f);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_DEAD_BARRACKS_EAGLE) {
            ...
            if (dead_barracks_eagle == 2) {
                ...
                Commands->Create_Logical_Sound(obj, M06_DISABLE_BARRACKS_SPAWN, Vector3(0, 0, 0),
                                               2500.0f);
            }
        }
    }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == M06_NEXT_EVAC) {
            GameObject* chinook_obj
                = Commands->Create_Object("Invisible_Object", Vector3(-37.824f, 30.975f, 1.605f));
...
DECLARE_SCRIPT(M06_Interior_Controller, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_DEAD_INTERIOR_PATROL) {
            ...
            case 4: {
                // Contact lost with patrols.  Reserve patrols to your assigned areas.  Chem units
                // to standby.\n
            ...
            default: {
                ...
                else if ((dead_loc.X < 12.0f) && (dead_loc.Y >= -22.0f) && (dead_loc.Y < 4.0f)
                         && (dead_loc.Z < 5.0f)) {
...
DECLARE_SCRIPT(M06_Enable_Hedgemaze, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101148), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101149), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Barracks, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101012), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101212), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Interior, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101304), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101305), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101306), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101307), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101308), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Greenhouse, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101509), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101356), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101357), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Shut down all greenhouse zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101350), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101351), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Alarm_Engineer, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 11 && reason == ACTION_COMPLETE_NORMAL) {
            ...
            if ((Commands->Get_Health(broken_alarm) / Commands->Get_Max_Health(broken_alarm))
                < 1.0f) {
                params.Set_Basic(this, INNATE_PRIORITY_ENEMY_SEEN - 5, 12);
...
DECLARE_SCRIPT(M06_Courtyard_Eagle, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101104), M06_DEAD_COURTYARD_EAGLE, 1,
                                    0.0f);
    }
};
...
void Killed(GameObject* obj, GameObject* killer)
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101147), M06_DEAD_HEDGEMAZE_EAGLE, 1,
                                0.0f);
}
}
;
...
void Killed(GameObject* obj, GameObject* killer)
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101204), M06_DEAD_BARRACKS_EAGLE, 1,
                                0.0f);
}
}
;
...
DECLARE_SCRIPT(M06_Havoc_DLS, "")
{
    ...
    {
        //		Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), 666, 666,
        //0.0f);
    }
    ...
    void Sound_Heard(GameObject * obj, const CombatSound& sound)
    {
        ...
        if (sound.Type == M06_SOUND_ALARM_ON) {
            if (!alarmed) {
                ...
                Commands->Create_Logical_Sound(obj, M06_ATTACK_HAVOC_SOUND, Vector3(0, 0, 0),
                                               55.0f);
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_ATTACK_HAVOC) {
            Commands->Debug_Message(
                "Soldier heard M06_ATTACK_HAVOC_SOUND, custom to attack Havoc.\n");
        ...
        if (type == M06_RELOCATE) {
            ...
            if (param == 1) {
                ...
                // Commands->Get_Position(Commands->Find_Object(108278)));
...
DECLARE_SCRIPT(M06_Assistance_Farmer_DLS, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == TALK_STAR && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101357), M06_START_CONVERSATION,
                                        1, 0.0f);
        }
...
DECLARE_SCRIPT(M06_Enable_Floor1_Library, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101358), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101360), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101360), M06_START_CONVERSATION,
                                        1, 0.0f);

            Commands->Send_Custom_Event(obj, Commands->Find_Object(101361), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101362), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Floor1_Bedroom, "")
{
    ...
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101363), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Floor2_Bedroom, "")
{
    ...
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101364), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Floor2_Library, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101365), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101366), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101365), M06_START_CONVERSATION,
                                        1, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M06_Enable_Floor2_Conference, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101369), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101370), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101369), M06_START_CONVERSATION,
                                        1, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M06_WarRoom_Officer_DLS, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_START_CONVERSATION) {
            // Do not patronize me, when are you going to move the scientists to the Research
            // Facility?\n
...
DECLARE_SCRIPT(M06_Enable_Warroom_DoorGuard, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101516), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M06_Enable_WarRoom, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101008), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101009), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            //	Commands->Send_Custom_Event(obj, Commands->Find_Object(101008),
            //M06_START_CONVERSATION, 1, 0.0f);
            ...
            GameObject* kane = Commands->Create_Object_At_Bone(
                holograph, "Nod_Kane_HologramHead_small", "O_ARROW");
...
DECLARE_SCRIPT(M06_Enable_Officers_Mess, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Activate innate on courtyard units
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101374), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101375), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101374), M06_START_CONVERSATION,
                                        1, 0.0f);
            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101376), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101377), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101378), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101379), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101380), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101381), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101382), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    ...
    if (type == M06_START_CONVERSATION) {
        if (Commands->Find_Object(101384) && Commands->Find_Object(101385)) {
            // Both of you have proven yourself loyal, and as such I feel you are prime candidates
...
DECLARE_SCRIPT(M06_Enable_Courtyard, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Activate innate on courtyard units
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101383), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101384), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101385), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101383), M06_START_CONVERSATION,
                                        1, 0.0f);
            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101386), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101387), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101388), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101389), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101390), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Bathroom, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101391), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101393), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101393), M06_START_CONVERSATION,
                                        1, 0.0f);
            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101394), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101395), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_Barracks_Mess, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Activate innate on north barracks units
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101502), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101503), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101502), M06_START_CONVERSATION,
                                        1, 0.0f);
            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101504), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101505), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101506), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101507), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101508), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_South_Barracks, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101399), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101400), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101403), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Send custom to activate conversation
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101400), M06_START_CONVERSATION,
                                        1, 0.0f);
            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101401), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101402), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Enable_North_Barracks, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Activate innate on barracks units
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101396), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101397), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101398), M06_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Disable zones
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101500), M06_DISABLE_ZONE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101501), M06_DISABLE_ZONE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M06_Courtyard_Apache, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id,
                         ActionCompleteReason reason) // this is called when the servant reaches the
...
DECLARE_SCRIPT(M06_Flyover_Controller, "") // 100018
{
    ...
    void Created(GameObject * obj)
    {
        last = 0;
        flyovers = true;
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), M06_FLYOVER_COMPLETE, 1,
                                    0.0f);
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M06_FLYOVER_COMPLETE && flyovers) {
            ...
            char* flyovers[11] = {
                ...
                "X6A_Apache_03.txt",       "X6A_Apache_04.txt",       "X6A_Apache_05.txt",
                "X6A_Apache_06.txt",       "X6A_Apache_07.txt",       "X6A_Apache_08.txt",
                "X6A_Apache_09.txt",
            ...
            case 3:
            case 10: {
                GameObject* controller = Commands->Create_Object(
                    "Invisible_Object", Vector3(-44.177f, 30.547f, 1.605f));
        ...
        if (type == M06_ACTIVATE_FLYOVERS) {
            if (param == 1 && !flyovers) {
                flyovers = true;
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100018),
                                            M06_FLYOVER_COMPLETE, 1, 0.0f);
            }
...
DECLARE_SCRIPT(M06_Activate_Flyovers, "Active=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), M06_ACTIVATE_FLYOVERS,
                                        active, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M06_Flyover, "Flyover_ID=0:int")
{
    ...
    void Destroyed(GameObject * obj)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100018), M06_FLYOVER_COMPLETE,
                                    flyover_id, 0.0f);
    }
};
...
DECLARE_SCRIPT(M06_Drop_Thunder_Squad, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is Nod Helo Delta 14.  We are hot dropping a squad of Black Hand at your
            // doorstep, be advised they are on the ground only long enough to re-equip, skip the
            ...
            GameObject* chinook_obj
                = Commands->Create_Object("Invisible_Object", Vector3(-55.305f, -87.235f, -0.767f));
               ...
               "Loc1_ID=0:int, Loc2_ID=0:int, Loc3_ID=0:int, Animation=S_A_HUMAN.H_A_A0F0:string")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == GO_FIRST_LOC && reason == ACTION_COMPLETE_NORMAL) {
            ...
            params.Set_Face_Location(
                Commands->Get_Position(Commands->Find_Object(Get_Int_Parameter("Loc1_ID"))), 1.5f);
            Commands->Action_Face_Location(obj, params);
        }
        ...
        if (action_id == GO_SECOND_LOC && reason == ACTION_COMPLETE_NORMAL) {
            ...
            params.Set_Face_Location(
                Commands->Get_Position(Commands->Find_Object(Get_Int_Parameter("Loc2_ID"))), 1.5f);
            Commands->Action_Face_Location(obj, params);
        }
        ...
        if (action_id == GO_THIRD_LOC && reason == ACTION_COMPLETE_NORMAL) {
            ...
            params.Set_Face_Location(
                Commands->Get_Position(Commands->Find_Object(Get_Int_Parameter("Loc3_ID"))), 1.5f);
            Commands->Action_Face_Location(obj, params);
        }
...
DECLARE_SCRIPT(M06_Move_Sydney, "Move_Loc=0:int") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) {
        if (Commands->Is_A_Star(enterer)) { int move_loc = Get_Int_Parameter("Move_Loc");
...
DECLARE_SCRIPT(M06_Activate_MidtroC, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* crate29
                = Commands->Create_Object("X6_Rubble2", Vector3(-50.727f, 0.514f, -0.020f));
            Commands->Set_Facing(crate29, 5.000f);

            GameObject* crate30
                = Commands->Create_Object("X6_Rubble1", Vector3(-11.987f, 8.771f, 0.000f));
            Commands->Set_Facing(crate30, 90.000f);

            GameObject* crate1
                = Commands->Create_Object("X6_Rubble5", Vector3(-6.280f, 9.196f, 0.000f));
            Commands->Set_Facing(crate1, 50.000f);

            GameObject* crate2
                = Commands->Create_Object("X6_Rubble5", Vector3(-5.988f, 7.571f, -0.010f));
            ...
            // Take key to the barracks away from Havoc so that Mendoza will not follow him in and
            // get stuck
