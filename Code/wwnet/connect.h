...
public:
    ...
    void Init_As_Server(USHORT server_port, int max_players, bool is_dedicated_server,
                        ULONG addr = 0);
    ...
    void Enable_Flow_Control(BOOL is_enabled)
    {
        IsFlowControlEnabled = is_enabled;
...
private:
    ...
    // Dynamic vector is ineffecient here but it doesn't matter since this is a debug testing only
    // kinda thing.
