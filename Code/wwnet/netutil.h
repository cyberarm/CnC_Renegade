...
// static int Get_Net_Stats_Sample_Time_Ms()					{return
// NETSTATS_SAMPLE_TIME_MS;} static int Get_Default_Multi_Sends()
// {return DefaultMultiSends;} static int Get_Default_Max_Resends()
// {return DefaultMaxResends;} static int Get_Default_Keepalive_Timeout_Ms()
// {return DefaultKeepaliveTimeoutMs;} static int Get_Desired_Send_Buffer_Size_Bytes()
// {return DesiredSendBufferSizeBytes;} static int Get_Desired_Receive_Buffer_Size_Bytes()
// {return DesiredReceiveBufferSizeBytes;} static int Get_Default_Server_Port()
// {return DefaultServerPort;} static int Get_Max_Receive_Time_Ms()
// {return MaxReceiveTimeMs;}

// static float Get_Priority_Tolerance_Downwards()			{return
// PriorityToleranceDownwards;} static float Get_Priority_Tolerance_Upwards()
// {return PriorityToleranceUpwards;} static float Get_Max_TP_Correction_Downwards()
// {return MaxTPCorrectionDownwards;} static float Get_Max_TP_Correction_Upwards()
// {return MaxTPCorrectionUpwards;} static float Get_Priority_Noise_Factor()
// {return PriorityNoiseFactor;} static float Get_Initial_Threshold_Priority()
// {return InitialThresholdPriority;} static float Get_Priority_Growth_Per_Second()
// {return PriorityGrowthPerSecond;}
...
// static int		Get_Default_Resend_Timeout_Lan_Ms()			{return
// RESEND_TIMEOUT_LAN_MS;} static int		Get_Default_Resend_Timeout_Internet_Ms()
// {return RESEND_TIMEOUT_INTERNET_MS;} static void		Onetime_Init();