...
public:
    ...
    void Set_Total_Resent_Packets_In_Queue(int resent_packets)
    {
        TotalResentPacketsInQueue = resent_packets;
    }
    ...
    static inline void Set_Allow_Extra_Modem_Bandwidth_Throttling(bool set)
    {
        AllowExtraModemBandwidthThrottling = set;
    }
