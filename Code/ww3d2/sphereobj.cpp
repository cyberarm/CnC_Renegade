    ...
    DynamicVBAccessClass vb(BUFFER_TYPE_DYNAMIC_SORTING, dynamic_fvf_type, mesh.Vertex_ct);
    {
        ...
        for (int i = 0; i < mesh.Vertex_ct; i++) {
            ...
            if (Flags & USE_ALPHA_VECTOR) {
                ...
                vb->diffuse = 0xFFFFFFFF; // TODO could combine the material color with this and
                                          // turn off lighting
            }
...
#else
    SortingRendererClass::Insert_Triangles(Get_Bounding_Sphere(), 0, mesh.face_ct, 0,
                                           mesh.Vertex_ct);
#endif
...
void SphereRenderObjClass::Render(RenderInfoClass& rinfo)
{
    ...
    if (WW3D::Are_Static_Sort_Lists_Enabled() && sort_level != SORT_LEVEL_NONE) {
        ...
        if (Flags & USE_CAMERA_ALIGN) {
            ...
            Matrix3D tm(0.0f, 1.0f, 0.0f, cpos.X, 0.0f, 0.0f, 1.0f, cpos.Y, 1.0f, 0.0f, 0.0f,
                        cpos.Z);
 ...
 *   3/07/00    jga : Created.                                                                 *
 *=============================================================================================*/
void SphereMeshClass::Set_Alpha_Vector(const AlphaVectorStruct& v, bool inverse, bool is_additive,
                                       bool force)
{
    //
