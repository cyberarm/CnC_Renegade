      ...
      TextColor(1.0f, 1.0f, 1.0f)
{
    ...
    //	Set_Coordinate_Ranges( Vector2( -320,240 ), Vector2( 320,-240 ), Vector2( -320,240 ),
    //Vector2( 320,-240 ) );
}
...
**
*/
void TextDrawClass::Set_Coordinate_Ranges(const Vector2& src_ul, const Vector2& src_lr,
...
**
*/
void TextDrawClass::Quad(float x0, float y0, float x1, float y1, float u0, float v0, float u1,
                         float v1)
{
...
{
    TextDrawClass::Quad(rect.Left, rect.Top, rect.Right, rect.Bottom, uv.Left, uv.Top, uv.Right,
                        uv.Bottom);
}
...
float TextDrawClass::Print(Font3DInstanceClass* font, char ch, float screen_x, float screen_y)
{
    ...
    */
    ...
    /*
    ** If asked to draw the space char (' '), don't add any triangles, just return the scaled
    *spacing
    */
    if (ch == ' ') {
        return spacing;
    ...
    ** Draw the quad
    */
    Quad(screen_x0, screen_y0, screen_x1, screen_y1, font_uv.Left, font_uv.Top, font_uv.Right,
         font_uv.Bottom);
 ...
 *                                                                                             *
 ***********************************************************************************************/
float TextDrawClass::Print(Font3DInstanceClass* font, const char* message, float screen_x,
                           float screen_y)
{
    /*
