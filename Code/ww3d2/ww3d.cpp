 ...
 *	  WW3D::Get_Render_Target_Resolution -- get the resolution and bitdepth of the current
 *target* WW3D::Get_Device_Resolution -- get the current resolution and bitdepth *
 ...
 *   3/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
WW3DErrorType WW3D::Set_Render_Device(const char* dev_name, int width, int height, int bits,
                                      int windowed, bool resize_window)
{
    bool success
        = DX8Wrapper::Set_Render_Device(dev_name, width, height, bits, windowed, resize_window);
    if (success) {
        return WW3D_ERROR_OK;
    }
    else {
 ...
 *   3/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
WW3DErrorType WW3D::Set_Render_Device(int dev, int width, int height, int bits, int windowed,
                                      bool resize_window)
{
 ...
 *									 mode.  Note:  Its called
 *'_Windowed' to be consistent with the	  * other references inside WW3D, a more descriptive name
 *would		  * be Toggle_Fullscreen.
 **
 *                                                                                             *
 * INPUT:                                                                                      *
 *                                                                                             *
 ...
 *   3/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
WW3DErrorType WW3D::Set_Device_Resolution(int width, int height, int bits, int windowed,
                                          bool resize_window)
{
 ...
 *   12/3/98    BMG : Created.                                                                 *
 *=============================================================================================*/
WW3DErrorType WW3D::Registry_Save_Render_Device(const char* sub_key, int device, int width,
                                                int height, int depth, bool windowed,
                                                int texture_depth)
{
    bool success = DX8Wrapper::Registry_Save_Render_Device(sub_key, device, width, height, depth,
...
bool WW3D::Registry_Load_Render_Device(const char* sub_key, char* device, int device_len,
                                       int& width, int& height, int& depth, int& windowed,
                                       int& texture_depth)
{
    return DX8Wrapper::Registry_Load_Render_Device(sub_key, device, device_len, width, height,
...
void WW3D::Start_Movie_Capture(const char* filename_base, float frame_rate)
{
    ...
    Movie
        = new FrameGrabClass(filename_base, FrameGrabClass::AVI, width, height, depth, frame_rate);
...
void WW3D::Render_And_Clear_Static_Sort_Lists(RenderInfoClass& rinfo)
{
    ...
    for (unsigned int sort_level = MaxStaticSortLevel; sort_level >= MinStaticSortLevel;
         sort_level--) {
        bool render = false;
...
void WW3D::Override_Current_Static_Sort_Lists(RefRenderObjListClass* sort_list,
                                              unsigned int min_sort, unsigned int max_sort)
{
