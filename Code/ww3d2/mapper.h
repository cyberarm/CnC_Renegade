...
public:
    ...
    {
        return NEW_REF(ScaleTextureMapperClass, (*this));
    }
...
{
public:
    LinearOffsetTextureMapperClass(const Vector2& offset_per_sec, const Vector2& scale,
                                   unsigned int stage);
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(LinearOffsetTextureMapperClass, (*this));
    }
...
public:
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(GridTextureMapperClass, (*this));
    }
...
public:
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(RotateTextureMapperClass, (*this));
    }
...
{
public:
    SineLinearOffsetTextureMapperClass(const Vector3& uafp, const Vector3& vafp,
                                       unsigned int stage);
    SineLinearOffsetTextureMapperClass(const INIClass& ini, const char* section,
                                       unsigned int stage);
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(SineLinearOffsetTextureMapperClass, (*this));
    }
...
{
public:
    StepLinearOffsetTextureMapperClass(const Vector2& step, float steps_per_sec,
                                       unsigned int stage);
    StepLinearOffsetTextureMapperClass(const INIClass& ini, const char* section,
                                       unsigned int stage);
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(StepLinearOffsetTextureMapperClass, (*this));
    }
...
public:
    ...
    ZigZagLinearOffsetTextureMapperClass(const INIClass& ini, const char* section,
                                         unsigned int stage);
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(ZigZagLinearOffsetTextureMapperClass, (*this));
    }
...
public:
    ...
    {
        return NEW_REF(ClassicEnvironmentMapperClass, (*this));
    }
    virtual void Apply(int uv_array_index);
...
{
public:
    WSClassicEnvironmentMapperClass(unsigned int stage)
        : TextureMapperClass(stage)
    {
    }
    ...
    virtual TextureMapperClass* Clone() const
    {
        return NEW_REF(WSClassicEnvironmentMapperClass, (*this));
    }
    virtual void Apply(int uv_array_index);
    virtual bool Needs_Normals(void) { return true; }
};
...
{
public:
    WSEnvironmentMapperClass(unsigned int stage)
        : TextureMapperClass(stage)
    {
    }
    WSEnvironmentMapperClass(const WSEnvironmentMapperClass& src)
        : TextureMapperClass(src)
    {
    }
...
public:
    ...
    virtual TextureMapperClass* Clone() const
    {
        return NEW_REF(GridClassicEnvironmentMapperClass, (*this));
    }
    virtual void Apply(int uv_array_index);
    virtual bool Needs_Normals(void) { return true; }
};
...
public:
    ...
    virtual TextureMapperClass* Clone() const
    {
        return NEW_REF(GridEnvironmentMapperClass, (*this));
    }
    virtual void Apply(int uv_array_index);
    virtual bool Needs_Normals(void) { return true; }
};
...
public:
    ...
    ScreenMapperClass(const LinearOffsetTextureMapperClass& src)
...
public:
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(RandomTextureMapperClass, (*this));
    }
...
public:
    ...
    virtual TextureMapperClass* Clone(void) const
    {
        return NEW_REF(BumpEnvTextureMapperClass, (*this));
    }
