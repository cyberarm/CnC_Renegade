...
static void Record_Texture_End()
{
    ...
    if (record_texture_mode == Debug_Statistics::RECORD_TEXTURE_DETAILS) {
        ...
        for (int a = 0; a < texture_count; ++a) {
            ...
            working_string.Format("%4.4d  %3.3d   %3.3d     %s ", id,
...
int Debug_Statistics::Get_Record_Texture_Size() // Return total textures used during latest frame,
                                                // in bytes
{
    return last_frame_texture_memory;
}

int Debug_Statistics::Get_Record_Texture_Count() // Return total textures used during latest frame,
                                                 // in bytes
{
...
int Debug_Statistics::Get_Record_Lightmap_Texture_Size() // Return total lightmap textures used
                                                         // during latest frame, in bytes
{
    return last_frame_lightmap_texture_memory;
}

int Debug_Statistics::Get_Record_Lightmap_Texture_Count() // Return total lightmap textures used
                                                          // during latest frame, in bytes
{
    return last_frame_lightmap_texture_count;
}

int Debug_Statistics::Get_Record_Procedural_Texture_Size() // Return total procedural textures used
                                                           // during latest frame, in bytes
{
    return last_frame_procedural_texture_memory;
}

int Debug_Statistics::Get_Record_Procedural_Texture_Count() // Return total procedural textures used
                                                            // during latest frame, in bytes
{
...
void Debug_Statistics::Record_DX8_Polys_And_Vertices(int pcount, int vcount,
