    ...
    if (Get_Flag(USE_DEPTH_GRADIENT)) {
        ...
        */
        TextureClass* grad_tex
            = WW3DAssetManager::Get_Instance()->Get_Texture("MultProjectorGradient.tga");
        if (grad_tex) {
 ...
 *   1/27/00    gth : Created.                                                                 *
 *=============================================================================================*/
void TexProjectClass::Set_Ortho_Projection(float xmin, float xmax, float ymin, float ymax,
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Perspective_Projection(RenderObjClass* model, const Vector3& lightpos,
                                                     float znear, float zfar)
{
    if (model == nullptr) {
...
bool TexProjectClass::Compute_Perspective_Projection(const AABoxClass& obj_box, const Matrix3D& tm,
                                                     const Vector3& lightpos, float user_znear,
                                                     float user_zfar)
{
    /*
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Ortho_Projection(RenderObjClass* model, const Vector3& lightdir,
                                               float znear, float zfar)
{
    if (model == nullptr) {
        WWDEBUG_SAY(("Attempting to generate projection for a nullptr model\r\n"));
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Ortho_Projection(const AABoxClass& obj_box, const Matrix3D& tm,
                                               const Vector3& lightdir, float user_znear,
                                               float user_zfar)
{
    /*
    ** Compute the center of the box in world-space
    ...
    */
    Set_Ortho_Projection(box.Center.X - box.Extent.X, box.Center.X + box.Extent.X,
                         box.Center.Y - box.Extent.Y, box.Center.Y + box.Extent.Y, znear, zfar);
    Set_Transform(texture_tm);
    return true;
}
