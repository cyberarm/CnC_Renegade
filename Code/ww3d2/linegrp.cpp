...
void LineGroupClass::Render(RenderInfoClass& rinfo)
{
    ...
    DynamicIBAccessClass iba(sort ? BUFFER_TYPE_DYNAMIC_SORTING : BUFFER_TYPE_DYNAMIC_DX8,
                             num_indices);
    ...
    DynamicVBAccessClass vba(sort ? BUFFER_TYPE_DYNAMIC_SORTING : BUFFER_TYPE_DYNAMIC_DX8,
                             dynamic_fvf_type, num_vertices);

    {
        ...
        Vector4 diffuse(DefaultLineColor.X, DefaultLineColor.Y, DefaultLineColor.Z,
                        DefaultLineAlpha);
