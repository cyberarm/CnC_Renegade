...
** This class wraps a DX8 vertex buffer.  Use the lock objects to modify or append to the vertex
*buffer.
*/
...
public:
    ...
    {
    public:
        AppendLockClass(VertexBufferClass* vertex_buffer, unsigned start_index,
...
public:
    ...
    void Copy(const Vector3* loc, const Vector3* norm, const Vector2* uv, unsigned first_vertex,
              unsigned count);
    void Copy(const Vector3* loc, const Vector3* norm, const Vector2* uv, const Vector4* diffuse,
              unsigned first_vertex, unsigned count);
    void Copy(const Vector3* loc, const Vector2* uv, const Vector4* diffuse, unsigned first_vertex,
              unsigned count);
