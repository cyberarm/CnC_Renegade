 ...
 *   6/19/98    GTH : Created.                                                                 *
 *=============================================================================================*/
void AABTreeBuilderClass::Build_AABTree(int polycount, TriIndex* polys, int vertcount,
                                        Vector3* verts)
{
 ...
 *   6/19/98    GTH : Created.                                                                 *
 *=============================================================================================*/
AABTreeBuilderClass::SplitChoiceStruct AABTreeBuilderClass::Select_Splitting_Plane(int polycount,
                                                                                   int* polyindices)
{
...
AABTreeBuilderClass::Compute_Plane_Score(int polycount, int* polyindices, const AAPlaneClass& plane)
{
    ...
    ** Compute the cost.
    */
    float back_cost = (sc.BMax.X - sc.BMin.X) * (sc.BMax.Y - sc.BMin.Y) * (sc.BMax.Z - sc.BMin.Z)
        * sc.BackCount;
    float front_cost = (sc.FMax.X - sc.FMin.X) * (sc.FMax.Y - sc.FMin.Y) * (sc.FMax.Z - sc.FMin.Z)
        * sc.FrontCount;
 ...
 *   6/19/98    GTH : Created.                                                                 *
 *=============================================================================================*/
AABTreeBuilderClass::OverlapType AABTreeBuilderClass::Which_Side(const AAPlaneClass& plane,
                                                                 int poly_index)
{
    /*
...
void AABTreeBuilderClass::Build_W3D_AABTree_Recursive(AABTreeBuilderClass::CullNodeStruct* node,
                                                      ...
                                                      uint32* poly_indices, int& cur_node,
                                                      int& cur_poly)
{
    /*
