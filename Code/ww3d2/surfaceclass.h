...
public:
    ...
    void Copy(unsigned int dstx, unsigned int dsty, unsigned int srcx, unsigned int srcy,
    ...
    void Stretch_Copy(unsigned int dstx, unsigned int dsty, unsigned int dstwidth,
                      unsigned int dstheight, unsigned int srcx, unsigned int srcy,
                      unsigned int srcwidth, unsigned int srcheight, const SurfaceClass* source);
    ...
    void DrawHLine(const unsigned int y, const unsigned int x1, const unsigned int x2,
                   unsigned int color);
    ...
    void Convert_Pixel(unsigned char* pixel, const SurfaceClass::SurfaceDescription& sd,
                       const Vector3& rgb);
