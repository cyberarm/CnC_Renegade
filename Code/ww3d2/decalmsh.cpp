            ...
            if (_DecalPoly0.Verts.Count() >= 3) {
                ...
                */
                ...
                for (j = 1; j < _DecalPoly0.Verts.Count() - 1; j++) {
                    ...
                    /*
                    ** Check if this triangle is degenerate (Sutherland-Hodgeman can sometimes
                                      ...
                                      const DynamicVectorClass<Vector3>* world_vertex_locs)
{
    ...
    */
    ...
    newdecal.VertexStartIndex
        = ParentVertexIndices.Count(); // start vertices at the end of the current array
    newdecal.VertexCount = 0; // init vertcount to zero
    ...
    */
    ...
    /*
    ** Set up the generator for the world coordinate system (the deformed vertices are in
    *worldspace)
    */
        ...
        for (int vi = 0; vi < 3; vi++) {
            ...
            */
            ...
            generator->Compute_Texture_Coordinate(
                (*world_vertex_locs)[ParentVertexIndices[ParentVertexIndices.Count() - 1]], &stq);
            TexCoords.Add(Vector2(stq.X, stq.Y));
        }
    }
