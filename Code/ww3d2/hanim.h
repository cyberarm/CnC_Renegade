...
/*
**	The NamedPivotMapClass allows us to create HAnimComboDataClass objects with pivot maps
*without *	having to have the HAnim available. Later, when an HAnim is retrieved from the asset
*manager,
...
/*
**	The HAnimComboDataClass is used by the new HAnimComboClass to allow for a mix of
*shared/unshared data *	which will allow us to have the anim combo refer to data whereever we wish
*to put it.
*/
...
public:
    ...
    HAnimComboClass(int num_animations); // allocates specified number of channels and sets then all
                                         // to not-shared
    ~HAnimComboClass(void);
