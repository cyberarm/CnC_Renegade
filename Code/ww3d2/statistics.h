...
namespace Debug_Statistics
{
    ...
    int
    Get_Record_Texture_Size(); // Return total size of textures used during latest frame, in bytes
    int Get_Record_Lightmap_Texture_Size(); // Return total size of lightmap textures used during
                                            // latest frame, in bytes
    int Get_Record_Procedural_Texture_Size(); // Return total size of procedural textures used
    ...
    int Get_Record_Lightmap_Texture_Count(); // Return total number of lightmap textures used during
                                             // latest frame
    int Get_Record_Procedural_Texture_Count(); // Return total number of procedutal textures used
                                               // during latest frame
...
#define DX8_RECORD_RENDER(polys, verts, shader)                                                    \
    Debug_Statistics::Record_DX8_Polys_And_Vertices(polys, verts, shader)
#define DX8_RECORD_SORTING_RENDER(polys, verts)                                                    \
    Debug_Statistics::Record_Sorting_Polys_And_Vertices(polys, verts)
#define DX8_RECORD_SKIN_RENDER(polys, verts)                                                       \
    Debug_Statistics::Record_DX8_Skin_Polys_And_Vertices(polys, verts)
