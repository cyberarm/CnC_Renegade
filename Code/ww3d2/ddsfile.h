...
public:
    // You can pass the name in .tga or .dds format, the class will automatically try and load .dds
    // file. Note that creating the object will only give you image info - call Load() to load the
    // surfaces.
    ...
    void Copy_Level_To_Surface(unsigned level, WW3DFormat dest_format, unsigned dest_width,
                               unsigned dest_height, unsigned char* dest_surface,
                               unsigned dest_pitch);
