...
public:
    ...
    */
    MeshBuilderClass(int pass_count = 1, int face_count_guess = 255,
    ...
    */
    ...
    public:
        ...
        int SharedSmGroup; // smooth bits that were on in all faces that contributed to this final
                           // vertex
    ...
    ** 3. Submit each face in the form of a FaceClass, set only the fields you need (leave others at
    *default)
    ** 4. Call Build_Mesh
    */
