...
inline bool CameraClass::Cull_Sphere_On_Frustum_Sides(const SphereClass& sphere) const
{
    ...
    for (int i = 1; i < 5; i++) {
        is_visible = is_visible
            && (CollisionMath::Overlap_Test(planes[i], sphere)
                & (CollisionMath::INSIDE | CollisionMath::BOTH));
    }
    return !is_visible;
}
 ...
 *		upper left 0, upper right 1, lower left 2, lower right 3. * The last four points lie
 *on the far clipping plane, numbered analogous fashion.             * upper left 4, upper right 5,
 *lower left 6, lower right 7.                                * (remember: the camera space has x
 *going to the right, y up and z backwards).                *
 *                                                                                             *
 * INPUT:                                                                                      *
 *                                                                                             *
 * OUTPUT:                                                                                     *
 ...
 *		upper left 0, upper right 1, lower left 2, lower right 3. * The last four points lie
 *on the far clipping plane, numbered analogous fashion.             * upper left 4, upper right 5,
 *lower left 6, lower right 7.                                * (remember: camera space has x going
 *to the right, y up and z backwards).                    *
 *                                                                                             *
 * INPUT:                                                                                      *
 *                                                                                             *
 * OUTPUT:                                                                                     *
