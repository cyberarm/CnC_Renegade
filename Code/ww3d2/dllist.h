...
// Destroy-list will call delete for all nodes when the list is destructed. Note that the class
// doesn't work with undeclared pointer types (destructor has to be known).
