...
protected:
    ...
    virtual WW3DErrorType Save_Subobject(ChunkSaveClass& chunk_save,
    ...
    Find_Subobject(RenderObjClass& model,
    ...
    virtual bool Is_Object_In_List(const char* passet_name,
