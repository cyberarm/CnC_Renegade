...
Bitmap2DObjClass::Bitmap2DObjClass(const char* filename, float screen_x, float screen_y,
                                   bool center, bool additive, bool colorizable, int usable_width,
...
Bitmap2DObjClass::Bitmap2DObjClass(TextureClass* texture, float screen_x, float screen_y,
                                   bool center, bool additive, bool colorizable, bool ignore_alpha)
    : DynamicScreenMeshClass(2, 4)
{
    int resw, resh, resbits;
    bool windowed;
