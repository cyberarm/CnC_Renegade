...
public:
    ...
    void Blend_Update(const Matrix3D& root, HAnimClass* motion0, float frame0, HAnimClass* motion1,
    ...
    void Control_Bone(int boneindex, const Matrix3D& relative_tm,
    ...
    //
    bool Simple_Evaluate_Pivot(HAnimClass* motion, int pivot_index, float frame,
    ...
    static HTreeClass* Create_Morphed(int num_morph_sources, const float morph_weights[],
