...
public:
    ...
    bool Save_Texture(const char* texturename, srTextureIFace::MultiRequest& mreq,
    ...
    // bool TextureFileCache::Load_Texture(const char *texturename, srTextureIFace::MultiRequest&
    // mreq);
