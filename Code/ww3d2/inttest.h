...
inline OBBoxIntersectionTestClass::OBBoxIntersectionTestClass(const OBBoxClass& box,
                                                              int collision_type)
    : IntersectionTestClass(collision_type),
      Box(box)
{
...
inline OBBoxIntersectionTestClass::OBBoxIntersectionTestClass(
    const OBBoxIntersectionTestClass& that, const Matrix3D& tm)
    : IntersectionTestClass(that)
{
...
inline OBBoxIntersectionTestClass::OBBoxIntersectionTestClass(
    const AABoxIntersectionTestClass& that, const Matrix3D& tm)
    : IntersectionTestClass(that)
{
