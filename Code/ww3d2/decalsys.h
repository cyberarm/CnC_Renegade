...
protected:
    ...
    */
    ...
    {
        return encode_decal_id(Generator_PoolID, Generator_SlotID);
    }
    ...
    {
        return (slot_id & 0xFFFF) | (pool_id << 16);
    }
    ...
    // A class to store the meshes to which the decal has been applied (so that they can be removed
    // when needed)
    class LogicalDecalClass
    {
    public:
