...
public:
    ...
    {
        return Vector3(m_Info.Velocity.X, m_Info.Velocity.Y, m_Info.Velocity.Z);
    }
    ...
    {
        W3dUtilityClass::Convert_Shader(m_InfoV2.Shader, &shader);
    }
    ...
    {
        return Vector2(m_LineProperties.UPerSec, m_LineProperties.VPerSec);
    }
...
protected:
    ...
    virtual void Initialize_Randomizer_Struct(const Vector3Randomizer& randomizer,
...
inline void ParticleEmitterDefClass::Set_Line_Texture_Mapping_Mode(int mode)
{
    ...
    m_LineProperties.Flags
        |= ((mode << W3D_ELINE_TEXTURE_MAP_MODE_OFFSET) & W3D_ELINE_TEXTURE_MAP_MODE_MASK);
}
