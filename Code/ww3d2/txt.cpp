...
bool TextTextureClass::Is_Texture_Valid(FontClass& font, const char* str, int fore, int back,
                                        ConvertClass& conv)
{
    ...
    // if all the parameters the texture was created with the last time are the same as the
    // parameters the texture was created with this time then the texture is fine!
    if (TextureString == str && Font == &font && Convert == &conv && ForegroundColor == fore
...
bool TextTextureClass::Build_Texture(FontClass& font, const char* str, int fore, int back,
                                     ConvertClass& conv)
{
