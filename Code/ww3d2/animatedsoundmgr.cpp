...
//////////////////////////////////////////////////////////////////////
HashTemplateClass<StringClass, AnimatedSoundMgrClass::ANIM_SOUND_LIST*>
    AnimatedSoundMgrClass::AnimationNameHash;
...
void AnimatedSoundMgrClass::Initialize(const char* ini_filename)
{
    ...
    if (ini_file != nullptr) {
        ...
        for (INISection* section = section_list.First(); section != nullptr && section->Is_Valid();
            ...
            for (int entry_index = 0; entry_index < entry_count; entry_index++) {
                ...
                if (param_count == 2) {
                    ...
                    DefinitionClass* definition
                        = DefinitionMgrClass::Find_Typed_Definition(definition_name, CLASSID_SOUND);
...
//
//////////////////////////////////////////////////////////////////////
float AnimatedSoundMgrClass::Trigger_Sound(HAnimClass* anim, float old_frame, float new_frame,
                                           const Matrix3D& tm)
{
    if (anim == nullptr) {
        return old_frame;
