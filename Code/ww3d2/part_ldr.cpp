...
//	Read_Color_Keyframe
//
bool ParticleEmitterDefClass::Read_Color_Keyframe(ChunkLoadClass& chunk_load, float* key_time,
                                                  Vector3* value)
{
    bool retval = false;
...
//
bool ParticleEmitterDefClass::Read_Opacity_Keyframe(ChunkLoadClass& chunk_load, float* key_time,
                                                    float* value)
{
    bool retval = false;
...
//	Read_Size_Keyframe
//
bool ParticleEmitterDefClass::Read_Size_Keyframe(ChunkLoadClass& chunk_load, float* key_time,
                                                 float* value)
{
    bool retval = false;
...
//
void ParticleEmitterDefClass::Get_Blur_Time_Keyframes(
    ParticlePropertyStruct<float>& blurtimeframes) const
{
