...
const char* ReportCategoryNames[AssetStatusClass::REPORT_COUNT]
    = { "LOAD_ON_DEMAND_ROBJ", "LOAD_ON_DEMAND_HANIM", "LOAD_ON_DEMAND_HTREE",
        "MISSING_ROBJ",        "MISSING_HANIM",        "MISSING_HTREE" };
...
void AssetStatusClass::Add_To_Report(int index, const char* name)
{
    ...
    // This is a bit slow - two accesses to the same member, but currently there's no better way to
    // do it.
