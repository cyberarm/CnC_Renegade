...
public:
    ...
    operator=(const PrimitiveAnimationChannelClass<T>& src);
...
//	Set_Key
/////////////////////////////////////////////////////////
template <class T> int PrimitiveAnimationChannelClass<T>::Get_Key_Count(void) const
{
    return m_Data.Count();
}
...
/////////////////////////////////////////////////////////
template <class T>
const PrimitiveAnimationChannelClass<T>::KeyClass&
