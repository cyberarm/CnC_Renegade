...
#define SC_OPAQUE                                                                                  \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO,  \
                FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,      \
...
#define SC_ADDITIVE                                                                                \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE,  \
                FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,      \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_BUMPENVMAP                                                                              \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE,  \
                FOG_DISABLE, GRADIENT_BUMPENVMAP, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,    \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_ADD, DETAILALPHA_DISABLE))
...
#define SC_ALPHA                                                                                   \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA,          \
                DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_MODULATE,                      \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, \
...
#define SC_MULTIPLICATIVE                                                                          \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO,               \
                DSTBLEND_SRC_COLOR, FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE,    \
                TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,        \
                DETAILALPHA_DISABLE))
...
#define SC_OP_2D                                                                                   \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, \
                FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,       \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_OP_SPRITE                                                                               \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, \
                FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,       \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ADD_2D                                                                                  \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE,  \
                FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE,       \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ALPHA_2D                                                                                \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA,          \
                DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,                       \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, \
                DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_OPAQUE_SOLID                                                                            \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO,  \
                FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE,     \
                ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ALPHA_SOLID                                                                             \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA,          \
                DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_MODULATE,                      \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE,                  \
...
#define SC_ATESTBLEND_2D                                                                           \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA,          \
                DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,                       \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE, CULL_MODE_ENABLE,  \
                DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ATESTBLEND_SPRITE                                                                       \
    (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA,           \
                DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, GRADIENT_DISABLE,                       \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE, CULL_MODE_ENABLE,  \
                DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_SCREEN_2D                                                                               \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE,                \
                DSTBLEND_ONE_MINUS_SRC_COLOR, FOG_DISABLE, GRADIENT_DISABLE,                       \
                SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, \
                DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_MUL_2D                                                                                  \
    (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO,               \
                DSTBLEND_SRC_COLOR, FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE,     \
                TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,        \
                DETAILALPHA_DISABLE))
...
void ShaderClass::Report_Unable_To_Fog(const char* source)
{
    ...
    // Limit the no. of warning messages to some practical maximum. Suppress all subsequent
    // warnings.
...
const Blend srcBlendLUT[ShaderClass::SRCBLEND_MAX]
    = { Blend(D3DBLEND_ZERO, false), Blend(D3DBLEND_ONE, false), Blend(D3DBLEND_SRCALPHA, true),
...
void ShaderClass::Apply()
{
    ...
    if (diff
        & (ShaderClass::MASK_COLORMASK | ShaderClass::MASK_SRCBLEND | ShaderClass::MASK_DSTBLEND
        ...
        if (Get_Alpha_Test() == ShaderClass::ALPHATEST_ENABLE) {
            unsigned char alphareference = 0x60; // Alpha reference value that produces best results
                                                 // with mip-mapped textures.
    ...
    DX8Wrapper::Set_DX8_Render_State(D3DRS_CULLMODE,
                                     Get_Cull_Mode() ? _PolygonCullMode : D3DCULL_NONE);
