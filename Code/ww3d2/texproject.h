...
public:
    ...
    */
    ...
    virtual void Set_Ortho_Projection(float xmin, float xmax, float ymin, float ymax, float znear,
                                      float zfar);
    ...
    ** First set up your projection parameters, give the projector a render target, then call
    *Compute_Texture
    */
    bool Compute_Perspective_Projection(RenderObjClass* obj, const Vector3& lightpos,
                                        float znear = -1.0f, float zfar = -1.0f);
    bool Compute_Perspective_Projection(const AABoxClass& obj_box, const Matrix3D& tm,
                                        const Vector3& lightpos, float znear = -1.0f,
                                        float zfar = -1.0f);

    bool Compute_Ortho_Projection(RenderObjClass* obj, const Vector3& lightdir, float znear = -1.0f,
                                  float zfar = -1.0f);
    bool Compute_Ortho_Projection(const AABoxClass& obj_box, const Matrix3D& tm,
                                  const Vector3& lightdir, float znear = -1.0f, float zfar = -1.0f);
