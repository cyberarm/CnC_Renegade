...
DX8PolygonRendererClass::DX8PolygonRendererClass(unsigned index_count_, MeshClass* mesh_,
                                                 ...
                                                 unsigned vertex_offset_, unsigned index_offset_,
                                                 bool strip_)
    : mesh(mesh_),
...
void DX8PolygonRendererClass::Log()
{
    ...
    work.Format("	%8d %8d %6d %6d %6d %s\n", index_count, index_count / 3, index_offset,
                min_vertex_index, vertex_index_range, mesh->Get_Name());

    /*	work.Format(
                    "		Index count: %d (%d polys) i_offset: %d min_vi: %d vi_range: %d
