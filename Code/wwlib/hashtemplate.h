...
template <class KeyType, class ValueType>
inline void HashTemplateClass<KeyType, ValueType>::Remove_All(void)
{
...
template <class KeyType, class ValueType>
inline void HashTemplateClass<KeyType, ValueType>::Remove(const KeyType& s)
{
    if (!Hash) {
        return;
    }
...
template <class KeyType, class ValueType>
inline bool HashTemplateClass<KeyType, ValueType>::Exists(const KeyType& s,
...
template <class KeyType, class ValueType>
inline unsigned int
HashTemplateClass<KeyType, ValueType>::Get_Hash_Val(const KeyType& s,
...
template <class KeyType, class ValueType>
inline HashTemplateClass<KeyType, ValueType>::HashTemplateClass()
    : Hash(0),
      Table(0),
      First(NIL),
      Size(0)
...
template <>
inline unsigned int HashTemplateKeyClass<StringClass>::Get_Hash_Value(const StringClass& s)
{
