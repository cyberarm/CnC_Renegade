...
/*
**	This is a simple store-into-buffer pipe terminator. Use it as the final link in a pipe
*process *	that needs to store the data into a memory buffer. This can only serve as the final
