...
public:
    ...
    */
    unsigned Enumerate_Entries(const char* section, const char* entry_prefix,
                               unsigned startnumber = 0, unsigned endnumber = (unsigned)-1);
    ...
    */
    ...
    int Get_String(char const* section, char const* entry, char const* defvalue, char* buffer,
                   int size) const;
    ...
    TRect<int> const Get_Rect(char const* section, char const* entry,
                              TRect<int> const& defvalue) const;
    TPoint3D<int> const Get_Point(char const* section, char const* entry,
                                  TPoint3D<int> const& defvalue) const;
    TPoint2D<int> const Get_Point(char const* section, char const* entry,
                                  TPoint2D<int> const& defvalue) const;
    TPoint3D<float> const Get_Point(char const* section, char const* entry,
                                    TPoint3D<float> const& defvalue) const;
    TPoint2D<float> const Get_Point(char const* section, char const* entry,
