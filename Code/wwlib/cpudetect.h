...
public:
    ...
    inline static ProcessorManufacturerType Get_Processor_Manufacturer()
    {
    ...
    // Call these functions after determining the manufacturer to find out which of the
    // manufacturers processors the system has.
    ...
    inline static __int64 Get_Processor_Ticks_Per_Second()
    {
        return ProcessorTicksPerSecond;
    } // Ticks per second
    ...
    {
        return L1InstructionCacheSetAssociative;
    }
    ...
    {
        return L1InstructionTraceCacheSetAssociative;
    }
    ...
    static bool CPUID(unsigned& u_eax_, unsigned& u_ebx_, unsigned& u_ecx_, unsigned& u_edx_,
                      unsigned cpuid_type);
