...
public:
    ...
    void Set_Keys(const Integer& pub_n, const Integer& pub_e, const Integer& priv_d,
...
void RSACrypt<PRECISION>::Set_Keys(const Integer& pub_n, const Integer& pub_e,
                                   const Integer& priv_d, const Integer& keygen_p,
...
// Get the private key
//
template <int PRECISION> void RSACrypt<PRECISION>::Get_Private_Key(Integer& priv_d) const
{
    priv_d = PrivateD;
}
