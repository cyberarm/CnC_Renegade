...
void Set_Palette(PaletteClass const& pal, int time, void (*callback)())
{
    ...
    while (timer) {
        ...
        */
        ...
        /*
        **	This loop ensures that the palette won't be set more than once per game tick.
        *Setting *	the palette more than once per game tick will have no effect since the
        *calculation will *	result in the same intermediate palette that was previously
        *calculated.
        */
 ...
 * Process_DD_Result -- Does a message box based on the result of a DD command                 *
 *                                                                                             *
 * INPUT:		HRESULT result				- the result returned from the
 *direct draw command		  * int     display_ok_msg	- should a message be displayed if
 *command ok			  * *
 *                                                                                             *
 * OUTPUT:		none
 **
...
void Process_DD_Result(HRESULT result, int display_ok_msg)
{
    ...
    static struct
    {
        ...
        { DDERR_BLTFASTCANTCLIP,
          "Return if a clipper object is attached to the source surface passed into a BltFast "
          "call." },
        ...
        { DDERR_CANTLOCKSURFACE,
          "Unable to lock surface because no driver exists which can supply a pointer to the "
          "surface." },
        { DDERR_CLIPPERISUSINGHWND,
          "An attempt was made to set a cliplist for a clipper object that is already monitoring "
          "an hwnd." },
        ...
        { DDERR_DIRECTDRAWALREADYCREATED,
          "A DirectDraw object representing this driver has already been created for this "
          "process." },
        { DDERR_EXCEPTION,
          "An exception was encountered while performing the requested operation." },
        { DDERR_EXCLUSIVEMODEALREADYSET,
          "An attempt was made to set the cooperative level when it was already set to "
          "exclusive." },
        { DDERR_GENERIC, "Generic failure." },
        { DDERR_HEIGHTALIGN, "Height of rectangle provided is not a multiple of reqd alignment." },
        { DDERR_HWNDALREADYSET,
          "The CooperativeLevel HWND has already been set. It can not be reset while the process "
          "has surfaces or palettes created." },
        { DDERR_HWNDSUBCLASSED,
          "HWND used by DirectDraw CooperativeLevel has been subclassed, this prevents DirectDraw "
        ...
        { DDERR_INVALIDPOSITION,
          "Returned when the position of the overlay on the destination is no longer legal for "
          "that destination." },
        { DDERR_INVALIDRECT, "Rectangle provided was invalid." },
        { DDERR_INVALIDSURFACETYPE,
          "The requested action could not be performed because the surface was of the wrong "
          "type." },
        { DDERR_LOCKEDSURFACES,
          "Operation could not be carried out because one or more surfaces are locked." },
        { DDERR_NO3D, "There is no 3D present." },
        { DDERR_NOALPHAHW,
          "Operation could not be carried out because there is no alpha accleration hardware "
          "present or available." },
        //		{DDERR_NOANTITEARHW, "Operation could not be carried out because there is no
        //hardware support for synchronizing blts to avoid tearing.	"},
        { DDERR_NOBLTHW, "No blter hardware present." },
        //		{DDERR_NOBLTQUEUEHW, "Operation could not be carried out because there is no
        //hardware support for asynchronous blting."},
        { DDERR_NOCLIPLIST, "No cliplist available." },
        { DDERR_NOCLIPPERATTACHED, "No clipper object attached to surface object." },
        { DDERR_NOCOLORCONVHW,
          "Operation could not be carried out because there is no color conversion hardware "
          "present or available." },
        { DDERR_NOCOLORKEY, "Surface doesn't currently have a color key" },
        { DDERR_NOCOLORKEYHW,
          "Operation could not be carried out because there is no hardware support of the "
        ...
        { DDERR_NODIRECTDRAWHW,
          "A hardware-only DirectDraw object creation was attempted but the driver did not support "
          "any hardware." },
        { DDERR_NODIRECTDRAWSUPPORT,
          "No DirectDraw support possible with current display driver." },
        { DDERR_NOEMULATION, "Software emulation not available." },
        { DDERR_NOEXCLUSIVEMODE,
          "Operation requires the application to have exclusive mode but the application does not "
          "have exclusive mode." },
        { DDERR_NOFLIPHW, "Flipping visible surfaces is not supported." },
        { DDERR_NOGDI, "There is no GDI present." },
        { DDERR_NOHWND,
          "Clipper notification requires an HWND or no HWND has previously been set as the "
          "CooperativeLevel HWND." },
        { DDERR_NOMIRRORHW,
          "Operation could not be carried out because there is no hardware present or available." },
        { DDERR_NOOVERLAYDEST,
          "Returned when GetOverlayPosition is called on an overlay that UpdateOverlay has never "
          "been called on to establish a destination." },
        { DDERR_NOOVERLAYHW,
          "Operation could not be carried out because there is no overlay hardware present or "
          "available." },
        ...
        { DDERR_NORASTEROPHW,
          "Operation could not be carried out because there is no appropriate raster op hardware "
          "present or available." },
        { DDERR_NOROTATIONHW,
          "Operation could not be carried out because there is no rotation hardware present or "
          "available." },
        { DDERR_NOSTRETCHHW,
          "Operation could not be carried out because there is no hardware support for "
          "stretching." },
        { DDERR_NOT4BITCOLOR,
          "DirectDrawSurface is not in 4 bit color palette and the requested operation requires 4 "
          "bit color palette." },
        { DDERR_NOT4BITCOLORINDEX,
          "DirectDrawSurface is not in 4 bit color index palette and the requested operation "
          "requires 4 bit color index palette." },
        { DDERR_NOT8BITCOLOR,
          "DirectDrawSurface is not in 8 bit color mode and the requested operation requires 8 bit "
          "color." },
        { DDERR_NOTAOVERLAYSURFACE,
          "Returned when an overlay member is called for a non-overlay surface." },
        { DDERR_NOTEXTUREHW,
          "Operation could not be carried out because there is no texture mapping hardware present "
          "or available." },
        ...
        { DDERR_NOTLOCKED,
          "Surface was not locked.  An attempt to unlock a surface that was not locked at all, or "
          "by this process, has been attempted." },
        { DDERR_NOTPALETTIZED, "The surface being used is not a palette-based surface." },
        { DDERR_NOVSYNCHW,
          "Operation could not be carried out because there is no hardware support for vertical "
          "blank synchronized operations." },
        { DDERR_NOZBUFFERHW,
          "Operation could not be carried out because there is no hardware support for zbuffer "
          "blting." },
        { DDERR_NOZOVERLAYHW,
          "Overlay surfaces could not be z layered based on their BltOrder because the hardware "
        ...
        { DDERR_PALETTEBUSY,
          "Access to this palette is being refused because the palette is already locked by "
          "another thread." },
        ...
        { DDERR_SURFACEBUSY,
          "Access to this surface is being refused because the surface is already locked by "
          "another thread." },
        { DDERR_SURFACEISOBSCURED, "Access to surface refused because the surface is obscured." },
        { DDERR_SURFACELOST,
          "Access to this surface is being refused because the surface memory is gone. The "
        ...
        { DDERR_WASSTILLDRAWING,
          "Informs DirectDraw that the previous Blt which is transfering information to or from "
 ...
 ** int height           - the height of the video mode in pixels                   * int
...
bool Set_Video_Mode(HWND, int w, int h, int bits_per_pixel)
{
    ...
    //
    // MessageBox(MainWindow, "In Set_Video_Mode. About to call call SetDisplayMode.","Note",
    // MB_ICONEXCLAMATION|MB_OK);
    ...
    //
    // MessageBox(MainWindow, "In Set_Video_Mode. About to call CreatePalette.","Note",
    // MB_ICONEXCLAMATION|MB_OK);
    result = DirectDrawObject->CreatePalette(DDPCAPS_8BIT | DDPCAPS_ALLOW256, &PaletteEntries[0],
                                             &PalettePtr, nullptr);
    Process_DD_Result(result, false);
    if (result != DD_OK) {
        return (false);
    ...
    // MessageBox(MainWindow, "In Set_Video_Mode. About to return success.","Note",
    // MB_ICONEXCLAMATION|MB_OK);
#if (0)
    /*
