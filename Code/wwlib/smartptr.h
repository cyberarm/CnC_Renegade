...
public:
    ...
    //		SmartPtr<T> operator ++ (int) {assert(Pointer != 0);SmartPtr<T> temp =
    //*this;++Pointer;return(temp);} 		SmartPtr<T> & operator ++ (void) {assert(Pointer !=
    //0);++Pointer;return(*this);} 		SmartPtr<T> operator -- (int) {assert(Pointer != 0);SmartPtr<T>
    //temp = *this;--Pointer;return(temp);} 		SmartPtr<T> & operator -- (void) {assert(Pointer !=
    //0);--Pointer;return(*this);}
