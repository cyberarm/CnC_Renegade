 ...
 *   02/07/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool DSurface::Blit_From(Rect const& destrect, Surface const& ssource, Rect const& sourcerect,
                         bool trans)
{
 ...
 *=============================================================================================*/
bool DSurface::Blit_From(Rect const& dcliprect, Rect const& destrect, Surface const& ssource,
...
{
    return (((red >> RedLeft) << RedRight) | ((green >> GreenLeft) << GreenRight)
    ...
    */
    for (int index = 0; index < 256; index++) {
        table[index] = (unsigned short)Build_Hicolor_Pixel(
            palette[index].Get_Red(), palette[index].Get_Green(), palette[index].Get_Blue());
    }
}
