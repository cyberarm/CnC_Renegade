...
**	characteristic and is faster to generate than the traditional CRC. This object is treated
*like *	a method class. If it is called as a function (using the function operator), it will return
...
//
#define CRC32(c, crc)                                                                              \
    (CRC::_Table[((unsigned long)(crc) ^ (c)) & 0xFFL] ^ (((crc) >> 8) & 0x00FFFFFFL))
class CRC
{
