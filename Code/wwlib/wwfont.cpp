 ...
 *=============================================================================================*/
WWFontClass::WWFontClass(void const* fontdata, bool isoutlined, int shadow, ConvertClass* convert,
                         unsigned char* remap)
 ...
 *=============================================================================================*/
Point2D WWFontClass::Print(char const* string, Surface& surface, Rect const& cliprect,
                           ...
                           unsigned char const* remap) const
{
    ...
    */
    ...
    static unsigned char const fontpalette[16]
    ...
    */
    ...
    if (buffer != nullptr) {
        ...
        unsigned short* fontheight
            = (unsigned short*)(((unsigned char*)FontData) + FontData->HeightOffset);
        unsigned short* fontoffset
            = (unsigned short*)(((unsigned char*)FontData) + FontData->OffsetBlockOffset);
            ...
            if (crect.Is_Valid()) {
                ...
                */
                if (FontData->FontCompress != (char)2) { // if the font is the old style
                    ...
                    void* drawbuff = (void*)(((char*)buffer)
                                             + ((ypos + firstrow) * surface.Stride()) + xpos * bbp);

                    for (int h = 0; h < dheight; h++) {

                        /*
                        **	If the current row to be drawn falls below the clipping rectangle,
                        *then *	no further drawing for this character is needed -- bail out.
                        */
                        ...
                        */
                        if (ypos + firstrow + h < crect.Y) {
                            ...
                            */
                            drawbuff
                                = (void*)((((char*)drawbuff) - (width * bbp)) + surface.Stride());
                        }
                    }
                }
                else {
