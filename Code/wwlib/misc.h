...
// extern bool				OverlappedVideoBlits;	// Can video driver blit overlapped
// regions?
...
// void * __cdecl Build_Fading_Table(void const *palette, void const *dest, long int color, long int
// frac);
