...
**	interface to perform their function. The philosphy behind this interface is that it
*represents *	a small but useful set of functions. Emphasis is placed on supporting those
*functions which are *	likely to have hardware assist.
*/
class Surface
{
public:
