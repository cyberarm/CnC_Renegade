...
bool MPEXPORT XMP_Sub_Int(digit* result, const digit* r1, unsigned short r2, bool borrow,
                          int precision);
...
// void MPEXPORT xmp_single_mul(unsigned short * prod, unsigned short * multiplicand, unsigned short
// multiplier, int precision);
...
void MPEXPORT XMP_Randomize_Bounded(digit* result, Straw& rng, digit const* min, digit const* max,
                                    int precision);
