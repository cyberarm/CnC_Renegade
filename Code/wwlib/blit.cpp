...
{
    return (
        Bit_Blit(dest, dest.Get_Rect(), destrect, source, source.Get_Rect(), sourcerect, blitter));
}
 ...
 *=============================================================================================*/
bool Bit_Blit(Surface& dest, Rect const& dcliprect, Rect const& ddrect, Surface const& source,
              Rect const& scliprect, Rect const& ssrect, Blitter const& blitter)
{
    Rect srect = ssrect;
    Rect drect = ddrect;
    ...
    */
    if (!XSurface::Prep_For_Blit(dest, dcliprect, drect, source, scliprect, srect, overlapped,
                                 dbuffer, sbuffer)) {
        return (false);
    }
...
{
    return (
        RLE_Blit(dest, dest.Get_Rect(), destrect, source, source.Get_Rect(), sourcerect, blitter));
}
 ...
 *=============================================================================================*/
bool RLE_Blit(Surface& dest, Rect const& dcliprect, Rect const& ddrect, Surface const& source,
              Rect const& scliprect, Rect const& ssrect, RLEBlitter const& blitter)
{
    Rect srect = ssrect; // Desired source rect.
    Rect drect = ddrect; // Desired destination rect.

    /*
    **	Adjust the desired draw rectangles to account for clipping. This is where the desired
    *rectangles *	get clipped to the bounding rectangles of the surfaces.
    */
