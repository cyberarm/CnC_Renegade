    ...
    */
    if (BBP == 1) {
        ...
        */
        ...
        RemapBlitter
            = new BlitTransZRemapXlat<unsigned char>(&RemapTable, (unsigned char const*)Translator);
        ShadowBlitter = new BlitTransRemapDest<unsigned char>(ShadowTable);
        Translucent1Blitter
            = new BlitTransRemapXlat<unsigned char>(ShadowTable, (unsigned char const*)Translator);
        Translucent2Blitter
            = new BlitTransRemapXlat<unsigned char>(ShadowTable, (unsigned char const*)Translator);
        Translucent3Blitter
            = new BlitTransRemapXlat<unsigned char>(ShadowTable, (unsigned char const*)Translator);
        ...
        */
        ...
        RLERemapBlitter = new RLEBlitTransZRemapXlat<unsigned char>(
            &RemapTable, (unsigned char const*)Translator);
        RLEShadowBlitter = new RLEBlitTransRemapDest<unsigned char>(ShadowTable);
        RLETranslucent1Blitter = new RLEBlitTransRemapXlat<unsigned char>(
            ShadowTable, (unsigned char const*)Translator);
        RLETranslucent2Blitter = new RLEBlitTransRemapXlat<unsigned char>(
            ShadowTable, (unsigned char const*)Translator);
        RLETranslucent3Blitter = new RLEBlitTransRemapXlat<unsigned char>(
            ShadowTable, (unsigned char const*)Translator);
    }
    else {
        ...
        */
        ...
        RemapBlitter = new BlitTransZRemapXlat<unsigned short>(&RemapTable,
                                                               (unsigned short const*)Translator);
        ShadowBlitter = new BlitTransDarken<unsigned short>((unsigned short)maskhalf);
        Translucent1Blitter = new BlitTransLucent75<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskquarter);
        Translucent2Blitter = new BlitTransLucent50<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskhalf);
        Translucent3Blitter = new BlitTransLucent25<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskquarter);
        ...
        */
        ...
        RLERemapBlitter = new RLEBlitTransZRemapXlat<unsigned short>(
            &RemapTable, (unsigned short const*)Translator);
        RLEShadowBlitter = new RLEBlitTransDarken<unsigned short>((unsigned short)maskhalf);
        RLETranslucent1Blitter = new RLEBlitTransLucent75<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskquarter);
        RLETranslucent2Blitter = new RLEBlitTransLucent50<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskhalf);
        RLETranslucent3Blitter = new RLEBlitTransLucent25<unsigned short>(
            (unsigned short const*)Translator, (unsigned short)maskquarter);
    }
}
