 ...
 * AuthName    - Name of the person who created image (nullptr terminated ASCII)
 * AuthComment - Comments of the author (nullptr terminated ASCII)
 * DateStamp   - Date the file was created. (See TGA2DateStamp)
 * TimeStamp   - Time the file was created. (See TGA2TimeStamp)
 * JobName     - Name of job image belongs to (nullptr terminated ASCII)
 * JobTime     - Elapsed time of the job.
 * SoftID      - ID of software used to create image (nullptr terminated ASCII)
