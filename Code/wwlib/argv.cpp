 ...
 *                                                                                             *
 * INPUT:                                                                                      *
 *			LPSTR lpCmdLine - A string of white space seperated strings.  Quotes force
 *spaces to  * be ignored.                                                         * char
 **fileprefix - A prefix on an arguement telling system to load postfix file name  * as command line
 *params.                                            *
 *                                                                                             *
 * OUTPUT:                                                                                     *
 *                                                                                             *
    ...
    if (fp) {
        while (Argc < MAX_ARGC) {
            ...
            if ((*string != '#') && (*string != ';')) {
                ...
                // If there is anyting in the string. (NAK: old code used to fail for 1 char
                // options)
                if (strlen(string)) {
 ...
 *                                                                                             *
 * INPUT:                                                                                      *
 *			attrib = cmd line attrib to add/replace * value = new value for attrib *
 *                                                                                             *
 * OUTPUT:                                                                                     *
 *                                                                                             *
 * WARNINGS:    Not Tested!                                                                    *
 ...
 *                                                                                             *
 * INPUT:                                                                                      *
 *			attrib = thing to add * value = new optional value *
 *                                                                                             *
 * OUTPUT:                                                                                     *
 *                                                                                             *
 * WARNINGS:                                                                                   *
