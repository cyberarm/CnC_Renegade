 ...
 *=============================================================================================*/
bool XSurface::Draw_Line(Rect const& xcliprect, Point2D const& startpoint, Point2D const& endpoint,
                         int color)
{
    /*
 ...
 *   02/07/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool XSurface::Blit_From(Rect const& destrect, Surface const& source, Rect const& sourcerect,
                         bool trans)
{
    return (
        XSurface::Blit_From(Get_Rect(), destrect, source, source.Get_Rect(), sourcerect, trans));
}
 ...
 *   05/27/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool XSurface::Blit_From(Rect const& dcliprect, Rect const& destrect, Surface const& source,
                         Rect const& scliprect, Rect const& sourcerect, bool trans)
{
    Rect drect = destrect;
...
bool Blit_Clip(Rect& drect, Rect const& dwindow, Rect& srect, Rect const& swindow)
{
    ...
    */
    if (drect.Width == srect.Width && drect.Height == srect.Height) {
        ...
        **	in such a case is merely a legality clip against the bounding rectangle. No
        *coordinated *	adjustments can occur. For best results, boundary clipping should be
        *performed prior to *	calling this routine.
        */
 ...
 *   05/19/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool XSurface::Prep_For_Blit(Surface& dest, Rect& drect, Surface const& source, Rect& srect,
                             bool& overlapped, void*& dbuffer, void*& sbuffer)
{
    return (XSurface::Prep_For_Blit(dest, dest.Get_Rect(), drect, source, source.Get_Rect(), srect,
...
bool XSurface::Prep_For_Blit(Surface& dest, Rect const& dcliprect, Rect& drect,
                             Surface const& source, Rect const& scliprect, Rect& srect,
                             bool& overlapped, void*& dbuffer, void*& sbuffer)
{
    overlapped = false;
    dbuffer = nullptr;
 ...
 *   05/19/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool XSurface::Blit_Plain(Surface& dest, Rect const& destrect, Surface const& source,
 ...
 *   05/19/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
bool XSurface::Blit_Trans(Surface& dest, Rect const& destrect, Surface const& source,
                          Rect const& sourcerect)
{
