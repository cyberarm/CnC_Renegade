...
public:
    ...
    {
        return (this != (GenericNode*)0 && NextNode != (GenericNode*)0
                && PrevNode != (GenericNode*)0);
    }
...
/*
        ...
        The ContextDataNode template class is an extension of the DataNode class and has an
   additional data value associated with it. Commonly used for tracking the owner of a DataNode.
                - EHC
*/
