...
DECLARE_SCRIPT(M05_Objective_Controller, "") // 100001
{
    ...
    void Created(GameObject * obj)
    {
        ...
        GameObject* chinook_obj1
            = Commands->Create_Object("Invisible_Object", Vector3(-555.290f, -89.967f, 31.411f));
    ...
    void Add_An_Objective(int id)
    {
        ...
        case 501: {
            ...
            if (object) {
                Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0175I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Radar_Blip_Object(501, object);
                Commands->Set_Objective_HUD_Info_Position(501, 90.0f, "POG_M05_1_04.tga",
                                                          IDS_POG_CONTACT,
        ...
        case 502: {
            ...
            if (object) {
                Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0177I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Radar_Blip_Object(502, object);
                Commands->Set_Objective_HUD_Info_Position(502, 90.0f, "POG_M05_1_05.tga",
                                                          IDS_POG_CONTACT,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 503: {
            ...
            if (object) {
                Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0173I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Radar_Blip_Object(503, object);
                Commands->Set_Objective_HUD_Info_Position(
                    503, 90.0f, "POG_M05_1_03.tga", IDS_POG_RESCUE, Commands->Get_Position(object));
            }
        } break;
        // Contact Patch
        case 504: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(504, 90.0f, "POG_M05_1_02.tga",
                                                          IDS_POG_CONTACT,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 506: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(506, 90.0f, "POG_M05_1_01.tga",
                                                          IDS_POG_ELIMINATE,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 507: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    507, 90.0f, "POG_M05_2_01.tga", IDS_POG_SECURE, Commands->Get_Position(object));
            }
        } break;
        // Escort Resistance
        case 508: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    508, 90.0f, "POG_M05_2_07.tga", IDS_POG_ESCORT, Commands->Get_Position(object));
            }
        } break;
        // Contact Escapee
        case 509: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(509, 90.0f, "POG_M05_2_03.tga",
                                                          IDS_POG_CONTACT,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 510: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(510, 90.0f, "POG_M05_2_06.tga",
                                                          IDS_POG_CONTACT,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 512: {
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(512, 90.0f, "POG_M05_2_04.tga",
                                                          IDS_POG_ELIMINATE,
                                                          Commands->Get_Position(object));
            }
        } break;
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == HOTWIRE) {
            // Hotwire here, I can't rendezvous at your position, I've got tons of armor pounding my
...
DECLARE_SCRIPT(M05_Activate_Objective_501, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is Gunner, I'm pinned down under heavy fire on the south side of the village,
            // requesting backup!\n
...
DECLARE_SCRIPT(M05_Activate_Objective_502, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is Deadeye - I'm held up in the Fancy Inn on the east side with some local
...
DECLARE_SCRIPT(M05_Activate_Objective_504, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Havoc, this is Patch.  I'm at the Cathedral. Nod's gathering for major bloodletting.
            // Get up here.\n
...
DECLARE_SCRIPT(M05_Activate_Objective_507, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Attention GDI forces, this is Resistance Radio. Nod is assaulting the Town Square, on
...
DECLARE_SCRIPT(M05_Activate_Objective_508, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is Nod supply helo Delta-12, possible rooftop sighting of terrorists in
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300501
            && (reason == ACTION_COMPLETE_CONVERSATION_ENDED
                || reason == ACTION_COMPLETE_CONVERSATION_INTERRUPTED)) {
            //			Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 508,
            //3, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M05_Activate_Nod_Apc, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100144), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M05_Activate_Objective_509, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // GDI forces, this is Resistance Radio. Communications indicate an escapee from the
            // Chateau is in our custody on the northern side of the village. He has valuable
            ...
            GameObject* controller1
                = Commands->Create_Object("Invisible_Object", Vector3(-495.497f, 40.504f, 22.714f));
            ...
            GameObject* controller2
                = Commands->Create_Object("Invisible_Object", Vector3(-401.111f, 43.222f, 20.018f));
...
DECLARE_SCRIPT(M05_Activate_Objective_510, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // How's this work? Okay... Attention, this is Resistance Radio. Rumours are true, our
...
DECLARE_SCRIPT(M05_DEAD6_Engineer2, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        float distance
            = Commands->Get_Distance(Commands->Get_Position(obj), Commands->Get_Position(STAR));
...
DECLARE_SCRIPT(M05_DEAD6_Rocket_Soldier, "") // first gunner
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (Commands->Is_A_Star(poker) && (!conversation)) {
            ...
            switch (poke_id) {
            case 1: {
                // I'm going to take this town if I have to vaporize every Nod reject in existence.
                // I assume you're assisting?\n
            ...
            case 3: {
                ...
                //false);
                //	Commands->Join_Conversation(Commands->Get_A_Star(Commands->Get_Position(obj)),
                //conv_id, false, true); 	Commands->Join_Conversation(obj, conv_id, false, true);
...
DECLARE_SCRIPT(M05_DEAD6_MiniGunner, "") // deadeye
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300004 && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            ...
            // Deadeye_Freed
            Commands->Send_Custom_Event(obj, Commands->Find_Object(112559), M05_DEADEYE_FREED, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100049), M05_DEADEYE_FREED, 1,
                                        0.0f);
            // Vaporize Fancy Inn objective
            //		Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 513,
            //3, 2.0f);
    ...
    void Sound_Heard(GameObject * obj, const CombatSound& sound)
    {
        ...
        if (sound.Type == SOUND_TYPE_DESIGNER07) {
            if (objective_513) {
                ...
                float nuke_radius
                    = Commands->Get_Distance(sound.Position, Commands->Get_Position(inn));
...
DECLARE_SCRIPT(M05_DEAD6_Grenadier, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300004
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100047), M05_PROTECT_HAVOC, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100006), M05_PROTECT_HAVOC, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100048), M05_PROTECT_HAVOC, 1,
                                        0.0f);
        }
...
DECLARE_SCRIPT(M05_Mendoza, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 15 && reason == ACTION_COMPLETE_NORMAL) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100010), M05_BLOW_BUILDING, 1,
                                        0.0f);
        }
        ...
        if ((Commands->Get_Health(obj)) < (Commands->Get_Max_Health(obj) * .23)) {
            ...
            if (!exiting) {
                ...
                int conv_id = Commands->Create_Conversation(
                    conv_name, INNATE_PRIORITY_ENEMY_SEEN + 5, 200.0f, false);
                Commands->Join_Conversation(obj, conv_id, false, true);
...
DECLARE_SCRIPT(M05_TownSquare_Tank, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100112), M05_TOWNSQUARE_REINFORCE, 3,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Enable_Overlook, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* chinook_obj = Commands->Create_Object(
                "Invisible_Object", Vector3(-298.246f, -48.874f, 14.633f));
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100127), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == DROP_SNIPER) {
            GameObject* chinook_obj = Commands->Create_Object(
                "Invisible_Object", Vector3(-335.883f, -82.737f, 24.550f));
...
DECLARE_SCRIPT(M05_Cache_Escort, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100162), M05_CACHE_CIV_KILLED, 1,
                                    0.0f);
    }
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        ...
        if (Commands->Is_A_Star(poker) && !conversation) {
            ...
            switch (poke_id) {
            case 1: {
                // Send custom to the remainder of the civ resist to turn off poke, and have them
                // follow
                ...
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-529.402f, 23.791f, 23.472f));
                Commands->Set_Facing(chinook_obj1, -95.000f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X5D_C130TroopDrop2.txt");

                // GDI, you've come to help? There's a crashed chopper with supplies all over
                // nearby. Come with us, we'll show you.\n
...
DECLARE_SCRIPT(M05_Chinook_Supply_Cache, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (((enterer == Commands->Find_Object(100033))
             || (enterer == Commands->Find_Object(100034)))
            && (!already_entered)) {
            already_entered = true;
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 508, 1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100162), M05_CIV_ARRIVED, 1,
                                        0.0f);
...
DECLARE_SCRIPT(M05_Escapee_Brother, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300509 && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            ...
            GameObject* window_shooter = Commands->Create_Object(
                "Nod_Gun_Emplacement_Dec", Vector3(-346.865f, 40.418f, 22.279f));
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100037), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M05_Activate_Babushka_Encounter, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100052), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
};
...
void Action_Complete(GameObject* obj, int action_id, ActionCompleteReason reason)
{
    ...
    if (action_id == 300000) {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100050), M05_CUSTOM_ACTIVATE, 1,
                                    0.0f);
    }
}
...
DECLARE_SCRIPT(M05_Park_Activate, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Attention GDI forces, this is Resistance Radio. Nod is completing construction of an
            // Obelisk in the Park, on the northwestern side. If anyone is near the area, eliminate
...
DECLARE_SCRIPT(M05_Park_Controller, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == PARK_ROCKET_SOLDIERS) {
            GameObject* chinook_obj1 = Commands->Create_Object(
                "Invisible_Object", Vector3(-446.924f, 103.269f, 17.665f));
...
DECLARE_SCRIPT(M05_ParkSniper, "")
{
    ...
    {
        if (Commands->Is_A_Star(enemy)) {
            Commands->Create_Logical_Sound(obj, M05_PARK_ALERT, Commands->Get_Position(obj),
                                           5000.0f);
        }
    }
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100632), M05_PARK_UNIT_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Park_Buggy, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100632), M05_PARK_VEHICLE_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_ParkEngineer, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100632), M05_PARK_ENGINEER_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Mendoza4, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == BOTH_TEAMS && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            GameObject* chinook_obj1 = Commands->Create_Object(
                "Invisible_Object", Vector3(-230.672f, -23.591f, 12.130f));
...
DECLARE_SCRIPT(M05_Civ_Warn, "")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 100097) {
            // Don't shoot, I am a friend! There are enemies shooting from the balcony. Can you
            // help?\n
...
DECLARE_SCRIPT(M05_Triangle_Unit, "Unit_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100105), M05_TRIANGLE_REINFORCE,
                                    unit_id, 0.0f);
    }
};
        ...
        if (type == M05_TRIANGLE_REINFORCE) {
            ...
            case 1: {
                ...
                if (unit_id1 < reinforce_cnt) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-521.328f, -68.988f, 17.960f));
            ...
            case 2: {
                ...
                if (unit_id2 < reinforce_cnt) {
                    ...
                    //Commands->Create_Object("Invisible_Object", Vector3(-485.633f,
            ...
            case 3: {
                ...
                if (unit_id3 < reinforce_cnt) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-518.077f, -96.536f, 17.114f));
            ...
            case 4: {
                ...
                if (unit_id4 % 2 == 0 && unit_id4 < reinforce_cnt * 2) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-493.674f, -63.951f, 14.002f));
        ...
        if (type == M05_TOWNSQUARE_REINFORCE) {
            ...
            case 1: {
                ...
                if ((unit_id1 % 2 == 0) && (unit_id1 < 5)) {
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-344.528f, -144.159f, 5.168f));
            ...
            case 2: {
                ...
                if ((unit_id2 % 2 == 0) && (unit_id2 < 5)) {
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-320.817f, -128.650f, 5.289f));
                    Commands->Set_Facing(chinook_obj1, -90.000f);
            ...
            if ((unit_id1 == 6) && (unit_id2 == 6) && (unit_id3 == 1) && (unit_id4 == 1)
                && (!townsquare_retaken)) {
...
DECLARE_SCRIPT(M05_TownSquare_Unit, "Unit_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100112), M05_TOWNSQUARE_REINFORCE,
                                    unit_id, 0.0f);
    }
};
...
Commands->Send_Custom_Event(obj, Commands->Find_Object(100112), M05_TOWNSQUARE_REINFORCE, unit_id,
                            0.0f);
}
}
;
...
DECLARE_SCRIPT(M05_Nod_Bridge_Gun_Emplacement, "")
{
    ...
    {
        GameObject* controller1
            = Commands->Create_Object("Invisible_Object", Vector3(-292.298f, -82.194f, 10.478f));
...
DECLARE_SCRIPT(M05_Overlook_Captives, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100136), M05_OVERLOOK_REINFORCE, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Free_Overlook_Captives, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100129),
                                        M05_FREE_OVERLOOK_CAPTIVES, 1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100130),
                                        M05_FREE_OVERLOOK_CAPTIVES, 1, 0.0f);
        }
    }
};
...
void Killed(GameObject* obj, GameObject* killer)
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(100136), M05_OVERLOOK_REINFORCE, 2,
                                0.0f);
}
}
;
            ...
            case 1: {
                ...
                if (unit_id1 % 2 == 0 && unit_id1 < 8) {
                    if (dist_drop_loc1 == least_dist) {
                        GameObject* controller = Commands->Create_Object(
                            "Invisible_Object", Vector3(-495.497f, 40.504f, 22.714f));
                        Commands->Set_Facing(controller, -5.000f);
                        Commands->Attach_Script(controller, "Test_Cinematic",
                                                "X5D_CHTroopdrop4.txt");
                    }
                    else {
                        GameObject* controller = Commands->Create_Object(
                            "Invisible_Object", Vector3(-401.111f, 43.222f, 20.018f));
...
DECLARE_SCRIPT(M05_Cache_Unit, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100162), M05_CACHE_REINFORCE, 1,
                                    0.0f);
    }
...
DECLARE_SCRIPT(M05_Free_Dump_Captives, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100167), M05_FREE_DUMP_CAPTIVES,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100168), M05_FREE_DUMP_CAPTIVES,
                                        1, 0.0f);
...
DECLARE_SCRIPT(M05_Dump_Captives, "")
{
    ...
    Vector3 Get_Circle_Position(GameObject * obj, GameObject * target, float radius,
                                float reverseprob)
    {
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100173), M05_DUMP_REINFORCE, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Dump_Unit, "Unit_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100173), M05_DUMP_REINFORCE, unit_id,
                                    0.0f);
    }
};
        ...
        if (type == M05_DUMP_REINFORCE) {
            ...
            case 2: {
                ...
                if (unit_id2 % 2 == 0 && unit_id2 < 7) {
                    GameObject* chinook_obj = Commands->Create_Object(
                        "Invisible_Object", Vector3(-275.241f, 12.450f, 16.044f));
            ...
            case 3: {
                ...
                if (unit_id3 < 3) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-283.920f, 21.640f, 20.110f));
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M05_INN_REINFORCE) {
            ...
            case 1: {
                ...
                if (unit_id1 % 2 == 0) {
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-50.117f, -62.048f, 4.001f));
                    Commands->Set_Facing(chinook_obj1, 95.000f);
            ...
            case 2: {
                ...
                if (unit_id2 % 2 == 0) {
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(-98.226f, -75.228f, 4.042f));
...
DECLARE_SCRIPT(M05_Activate_Surprise_Tank, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == EXPLODE_BLOCK) {
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(105382)));
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(101865)));
        ...
        /*			if(Commands->Find_Object(101239))
                                {
                                        ...
                                        params.Set_Attack (Commands->Find_Object(101239), 250.0f,
           0.0f, 1); Commands->Action_Attack (obj, params);
                                }
        */
    }
}
...
DECLARE_SCRIPT(M05_Activate_Entrapment_Civ, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(-158.668f, 53.528f, 28.338f));
            ...
            GameObject* chinook_obj2
                = Commands->Create_Object("Invisible_Object", Vector3(-126.819f, 76.467f, 34.683f));
            ...
            //		Commands->Attach_Script(chinook_obj3, "Test_Cinematic",
            //"X5D_C130TroopDrop5.txt");
        }
    }
};
...
DECLARE_SCRIPT(M05_Cathedral_Controller, "") // 100287
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M05_INITIATE_CATHEDRAL) {
            GameObject* apache1
                = Commands->Create_Object("Nod_Apache", Vector3(-182.814f, 226.598f, 65.317f));
            Commands->Attach_Script(apache1, "M05_Cathedral_Apache", "1");
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100287),
                                        M05_CATHEDRAL_VEHICLE_CREATED, 1, 0.0f);

            Commands->Start_Timer(obj, this, 3.0f, SECOND_APACHE);

            GameObject* chinook_obj1 = Commands->Create_Object(
                "Invisible_Object", Vector3(-237.069f, 182.809f, 30.381f));
            ...
            GameObject* chinook_obj2 = Commands->Create_Object(
                "Invisible_Object", Vector3(-120.930f, 108.820f, 29.828f));
            Commands->Set_Facing(chinook_obj2, -45.000f);
            Commands->Attach_Script(chinook_obj2, "Test_Cinematic", "M05_XG_VehicleDrop5.txt");

            GameObject* chinook_obj3 = Commands->Create_Object(
                "Invisible_Object", Vector3(-252.027f, 118.122f, 29.883f));
        ...
        if (type == M05_CATHEDRAL_REINFORCE && blackhand_cnt < 9) {
            ...
            case 7: {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-167.978f, 178.023f, 29.226f));
            ...
            case 8: {
                GameObject* chinook_obj2 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-179.221f, 110.382f, 28.744f));
            ...
            case 10: {
                GameObject* chinook_obj3 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-137.472f, 141.174f, 29.144f));
        ...
        if (m05_cathedral_vehicle_killed == 0 && blackhand_cnt > 7) {
            Commands->Create_Logical_Sound(obj, M05_CATHEDRAL_FREE, Commands->Get_Position(obj),
                                           5000.0f);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == SECOND_APACHE) {
            GameObject* apache2
                = Commands->Create_Object("Nod_Apache", Vector3(-116.199f, 300.494f, 54.718f));
...
DECLARE_SCRIPT(M05_Cathedral_Para_Unit, "Soldier_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (!cathedral_free) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100287), M05_CATHEDRAL_REINFORCE,
                                        soldier_id, 0.0f);
        }
    }
};
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* controller1 = Commands->Create_Object(
                "Invisible_Object", Vector3(-481.123f, -106.686f, 15.787f));
            Commands->Set_Facing(controller1, -90.000f);
            Commands->Attach_Script(controller1, "Test_Cinematic", "X5C_Wintroops06.txt");

            GameObject* controller2 = Commands->Create_Object(
                "Invisible_Object", Vector3(-486.106f, -93.892f, 18.440f));
...
DECLARE_SCRIPT(M05_Roadblock_Controller, "") // 100614
{
    ...
    void Created(GameObject * obj)
    {
        ...
        GameObject* controller1
            = Commands->Create_Object("Invisible_Object", Vector3(-484.498f, -130.355f, 14.680f));
        Commands->Set_Facing(controller1, -115.000f);
        Commands->Attach_Script(controller1, "Test_Cinematic", "X5C_Wintroops18.txt");

        GameObject* controller2
            = Commands->Create_Object("Invisible_Object", Vector3(-483.220f, -122.518f, 17.043f));
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M05_ROADBLOCK_REINFORCE) {
            ...
            case 1: {
                ...
                if (unit_id1 < 3) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-484.498f, -130.355f, 14.680f));
            ...
            case 2: {
                ...
                if (unit_id2 < 3) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-483.220f, -122.518f, 17.043f));
...
DECLARE_SCRIPT(M05_Roadblock_Unit, "Unit_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100614), M05_ROADBLOCK_REINFORCE,
                                    unit_id, 0.0f);
    }
};
...
DECLARE_SCRIPT(M05_Activate_Roadblock_Tank, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == EXPLODE_BLOCK) {
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(101858)));
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(101859)));
...
DECLARE_SCRIPT(M05_Building_Debris, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        GameObject* explode_debris
            = Commands->Create_Object("M05_X5A_AG_DExplode", Vector3(0, 0, 0));
        ...
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            case 1: {
                ...
                if (Commands->Find_Object(100003)) {
                    // I need help!  Where's the second insertion team?! Backup needed at the Town
                    // Square!\n
            ...
            case 4: {
                ...
                if (Commands->Find_Object(100002)) {
                    ...
                    // This is Hotwire, I can't hold this position! Requesting - oh great! <gunfire
                    // and static>\n
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        if (reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            if (action_id == 100003 || action_id == 100002 || action_id == 100652) {
                ...
                case 1: {
                    // hotwire killed.
                    Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0174I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 503, 2, 1.0f);
                } break;
                case 2: {
                    // gunner killed
                    Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0176I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 501, 2, 1.0f);
                } break;
                case 3: {
                    // deadeye killed
                    Commands->Set_HUD_Help_Text(IDS_M05DSGN_DSGN0178I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100001), 502, 2, 1.0f);
                } break;
                }
...
DECLARE_SCRIPT(M05_Activate_Artillery,
...
DECLARE_SCRIPT(M05_Activate_Triangle_Tank_Drop, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Drop tank
            GameObject* chinook_obj = Commands->Create_Object(
                "Invisible_Object", Commands->Get_Position(Commands->Find_Object(108970)));
...
DECLARE_SCRIPT(M05_Activate_Execution, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Execution players
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101239), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101240), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101241), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101242), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101243), M05_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            // Civ lead
            //			Commands->Send_Custom_Event(obj, Commands->Find_Object(100098),
            //M05_CUSTOM_ACTIVATE, 1, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M05_X5N_MIDTRO_B, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            already_entered = true;
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100002), M05_DESTROY_OBJECT, 0,
                                        0.0f);
...
DECLARE_SCRIPT(M05_Inn_APC, "")
{
        ...
        if (type == M05_REINFORCEMENT_KILLED) {
            ...
            if ((reinforcement % 2 == 0) && (reinforcement < 3)) { }
                ...
                if (obj == Commands->Find_Object(100247)) {
                    paradrop = true;
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100244),
                                                M05_INN_REINFORCE, 1, 0.0f);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100244),
                                                M05_INN_REINFORCE, 1, 0.5f);
                }
                else {
                    paradrop = true;
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100244),
                                                M05_INN_REINFORCE, 2, 0.0f);
                    Commands->Send_Custom_Event(obj, Commands->Find_Object(100244),
                                                M05_INN_REINFORCE, 2, 0.5f);
                }
            }
        }
    }
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if ((obj == Commands->Find_Object(100247)) && (!paradrop)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100244), M05_INN_REINFORCE, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100244), M05_INN_REINFORCE, 1,
                                        0.5f);
        }
        else if (!paradrop) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100244), M05_INN_REINFORCE, 2,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100244), M05_INN_REINFORCE, 2,
                                        0.5f);
        }
...
#define RESISTANCE_CONV_TABLE_SIZE                                                                 \
    (sizeof(Resistance_Conv_Table) / sizeof(Resistance_Conv_Table[0]))
const char* Resistance_Conv_Table[] = {
    "M05_CON044", "M05_CON045", "M05_CON046", "M05_CON047", "M05_CON048", "M05_CON049",
    "M05_CON050", "M05_CON051", "M05_CON052", "M05_CON053", "M05_CON054",
    "M05_CON055", // GCF1 11
    "M05_CON056", "M05_CON057", "M05_CON058", "M05_CON059", "M05_CON060", "M05_CON061",
    "M05_CON062", "M05_CON063", "M05_CON064",
    "M05_CON065", // GCM1 21
    "M05_CON066", "M05_CON067", "M05_CON068", "M05_CON069", "M05_CON070", "M05_CON071",
    "M05_CON072", "M05_CON073", "M05_CON074", "M05_CON075", "M05_CON076", "M05_CON077",
    "M05_CON078", "M05_CON079",
    "M05_CON080" // GCM2  36
...
DECLARE_SCRIPT(M05_Resistance_Poke_Conversation, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        ...
        if ((::strncmp("Civ_Resist_Female_v0a", preset_name, ::strlen("Civ_Resist_Female_v0a"))
             == 0)
            || (::strncmp("Civ_Resist_Female_v0b", preset_name, ::strlen("Civ_Resist_Female_v0b"))
                == 0)
            || (::strncmp("Civ_Resist_Female_v0c", preset_name, ::strlen("Civ_Resist_Female_v0c"))
                == 0)
            || (::strncmp("Civ_Resist_Female_v0d", preset_name, ::strlen("Civ_Resist_Female_v0d"))
                == 0))
        ...
        if ((::strncmp("Civ_Resist_Male_v0a", preset_name, ::strlen("Civ_Resist_Male_v0a")) == 0)
            ...
            || (::strncmp("Civ_Resist_Male_v0d", preset_name, ::strlen("Civ_Resist_Male_v0d"))
                == 0))
        ...
        if ((::strncmp("Civ_Resist_Male_v1a", preset_name, ::strlen("Civ_Resist_Male_v1a")) == 0)
            ...
            || (::strncmp("Civ_Resist_Male_v1d", preset_name, ::strlen("Civ_Resist_Male_v1d"))
                == 0))
