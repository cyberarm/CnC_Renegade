...
public:
    ...
    // These are meant to be a collection of small math utility functions to be optimized at some
    // point.
    ...
    static float __fastcall Inv_Sqrt(float a); // Some 30% faster inverse square root than regular
                                               // C++ compiled, from Intel's math library
