...
DECLARE_SCRIPT(M07_Objective_Controller, "") // 100657
{
    ...
    void Add_An_Objective(int id)
    {
        ...
        // Evacuate Sydney
        case 701: {
            Commands->Add_Objective(701, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M07_01, nullptr,
                                    IDS_Enc_Obj_Primary_M07_01);
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(701, 90.0f, "POG_M07_1_04.tga",
                                                          IDS_POG_EVACUATE,
        ...
        // Secure SAM Sites
        case 702: {
            Commands->Add_Objective(702, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M07_03, nullptr,
                                    IDS_Enc_Obj_Primary_M07_03);
            object = Commands->Find_Object(100673);
            if (object) {
                Commands->Set_HUD_Help_Text(IDS_M07DSGN_DSGN0089I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Radar_Blip_Object(702, object);
                Commands->Set_Objective_HUD_Info_Position(
                    702, 90.0f, "POG_M07_1_01.tga", IDS_POG_SECURE, Commands->Get_Position(object));
            }
        } break;
        // Destroy SSM Launchers
        case 703: {
            Commands->Add_Objective(703, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M07_04, nullptr,
                                    IDS_Enc_Obj_Primary_M07_04);
            object = Commands->Find_Object(100798);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(703, object);
                Commands->Set_Objective_HUD_Info_Position(703, 90.0f, "POG_M07_1_02.tga",
                                                          IDS_POG_DESTROY,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 704: {
            Commands->Add_Objective(704, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M07_01, nullptr,
                                    IDS_Enc_Obj_Secondary_M07_01);
            object = Commands->Find_Object(100721);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(704, object);
                Commands->Set_Objective_HUD_Info_Position(704, 90.0f, "POG_M07_2_07.tga",
                                                          IDS_POG_DESTROY,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 705: {
            Commands->Add_Objective(705, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M07_02, nullptr,
                                    IDS_Enc_Obj_Secondary_M07_02);
            object = Commands->Find_Object(115842);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(705, object);
                Commands->Set_Objective_HUD_Info_Position(
                    705, 90.0f, "POG_M07_2_04.tga", IDS_POG_RESCUE, Commands->Get_Position(object));
            }
        } break;
        // Destroy Napalm Stockpile
        case 706: {
            Commands->Add_Objective(706, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M07_03, nullptr,
                                    IDS_Enc_Obj_Secondary_M07_03);
            object = Commands->Find_Object(100781);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(706, object);
                Commands->Set_Objective_HUD_Info_Position(706, 90.0f, "POG_M07_2_06.tga",
                                                          IDS_POG_DESTROY,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 707: {
            Commands->Add_Objective(707, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M07_04, nullptr,
                                    IDS_Enc_Obj_Secondary_M07_04);
            object = Commands->Find_Object(100801);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(707, object);
                Commands->Set_Objective_HUD_Info_Position(707, 90.0f, "POG_M07_2_03.tga",
                                                          IDS_POG_DESTROY,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 708: {
            Commands->Add_Objective(708, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M07_05, nullptr,
                                    IDS_Enc_Obj_Secondary_M07_05);
            object = Commands->Find_Object(168926);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(708, object);
                Commands->Set_Objective_HUD_Info_Position(
                    708, 90.0f, "POG_M07_2_05.tga", IDS_POG_DEFEAT, Commands->Get_Position(object));
            }
        } break;
        // Protect Team Members
        case 709: {
            Commands->Add_Objective(709, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M07_05, nullptr,
                                    IDS_Enc_Obj_Primary_M07_05);
            object = Commands->Find_Object(100717);
            if (object) {
                Commands->Set_HUD_Help_Text(IDS_M07DSGN_DSGN0091I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Radar_Blip_Object(709, object);
                Commands->Set_Objective_HUD_Info_Position(709, 90.0f, "POG_M07_1_05.tga",
                                                          IDS_POG_PROTECT,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 710: {
            Commands->Add_Objective(710, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M07_02, nullptr,
                                    IDS_Enc_Obj_Primary_M07_02);
            object = Commands->Find_Object(100717);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(710, object);
                Commands->Set_Objective_HUD_Info_Position(
                    710, 90.0f, "POG_M07_1_03.tga", IDS_POG_ESCAPE, Commands->Get_Position(object));
            }
        } break;
        }
    }
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == 300701 && reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100663), M07_GO_EVAC_SITE, 1,
                                        0.0f);
...
DECLARE_SCRIPT(M07_Dead6_Grenadier2, "") // Patch2
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        if (action_id == WAYPATH) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(104496), M07_DEAD6_EVAC,
                                        dead6_id, 0.0f);
        }
    }
...
DECLARE_SCRIPT(M07_Dead6_Engineer, "") // Hotwire
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == ATTACK_SAM1 && !evac) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100674), M07_CHANGE_SAM_TEAM, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100679), M07_CHANGE_SAM_TEAM, 1,
                                        0.0f);
        ...
        if (timer_id == ATTACK_SAM2 && !evac) {
            // Custom to change SAMs playertype to GDI
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100673), M07_CHANGE_SAM_TEAM, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100680), M07_CHANGE_SAM_TEAM, 1,
                                        0.0f);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == ARRIVE_EVAC_SPOT && reason == ACTION_COMPLETE_MOVE_NO_PROGRESS_MADE
            && evac) {
            // This is a hack for the moment, need to have pathfinding around dec_phys vehicles at
            // inn
            int dead6_id = Commands->Get_ID(obj);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(104496), M07_DEAD6_EVAC,
                                        dead6_id, 0.0f);
...
DECLARE_SCRIPT(M07_Cathedral_Controller, "") // 100663
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == ONE) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100665),
                                        M07_DEACTIVATE_NUKE_BLAST, 1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100666),
                                        M07_DEACTIVATE_NUKE_BLAST, 1, 0.0f);
            // Boom!
            Commands->Create_Logical_Sound(obj, M07_NUKE_IMPACT, Commands->Get_Position(obj),
                                           2500.0f);
        ...
        if (timer_id == NUKEBITS) {
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(119890)));
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(119891)));
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(119892)));
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Commands->Get_Position(Commands->Find_Object(119893)));
            GameObject* nukebits
                = Commands->Create_Object("M07_Nukebits", Vector3(-128.295f, 71.892f, 26.754f));
...
DECLARE_SCRIPT(M07_In_Nuke_Blast, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (!star_in_blast && enterer == STAR) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100666), M07_NUKE_BLAST, 1,
                                        0.0f);
...
DECLARE_SCRIPT(M07_Out_Nuke_Blast, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (star_in_blast && enterer == STAR) {
            ...
            // Send custom to in blast script to let it know player is out of blast
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100665), M07_NUKE_BLAST, 1,
                                        0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M07_Nod_Gun_Emplacement, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100664),
                                    M07_EVAC_SITE_VEHICLE_KILLED, 1, 0.0f);
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (Commands->Find_Object(apc_id)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(apc_id),
                                        M07_REINFORCEMENT_KILLED, apc_id, 0.0f);
        }
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M07_SAM_CONVERTED) {
            ...
            if (m07_sam_converted == 1) {
                ...
                Commands->Send_Custom_Event(obj, Commands->Find_Object(104496), M07_EVAC_INN, 1,
                                            0.0f);
        ...
        if (type == M07_SAM_KILLED) {
            ...
            if (m07_sam_killed == 2) {
                // SAMs Killed
                Commands->Set_HUD_Help_Text(IDS_M07DSGN_DSGN0090I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
...
DECLARE_SCRIPT(M07_Activate_Objective_704, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            // Attention GDI, this is Resistance Radio. Nod's aerial reinforcements are coordinated
            // from mobile radar stations in the Town Square.  We need those radar dishes
            // destroyed.\n
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100746), M07_TOWNSQUARE_CHINOOK,
                                        1, 0.0f);
        }
    }
...
DECLARE_SCRIPT(M07_Activate_Objective_705, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            // This is Resistance Radio, I have reports of captured resistance fighters west of your
            // position.  Can anyone assist?\n
...
DECLARE_SCRIPT(M07_SAM_Site_Logic, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        //	GameObject * destroyedSam = Commands->Create_Object ( "M01_Destroyed_SAM",
        //my_position); 	Commands->Set_Facing ( destroyedSam, my_facing );
...
DECLARE_SCRIPT(M07_Mobile_Radar, "") {
    ...
    void Created(GameObject * obj) { Commands->Set_Animation(obj, "v_nod_radar.v_nod_radar", true);
}
        ...
        if (type == M07_TOWNSQUARE_CHINOOK) {
            if (param == 1) {
                ...
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-316.374f, -149.140f, 5.023f));
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == CHINOOK2 && chinooks_active) {
            GameObject* chinook_obj2 = Commands->Create_Object(
                "Invisible_Object", Vector3(-343.696f, -145.495f, 5.136f));
...
DECLARE_SCRIPT(M07_Captured_Civ_Resist, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        ...
        if ((Commands->Is_A_Star(poker)) && (!poked) && (!freed)) {
            Commands->Create_Logical_Sound(obj, M07_FREE_CIV_RESIST, Commands->Get_Position(obj),
                                           40.0f);
        }
    }
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101056), M07_SPAWN_TRIANGLE_CIV, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M07_Activate_Present, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            GameObject* chinook_obj1 = Commands->Create_Object(
                "Invisible_Object", Vector3(-446.944f, -25.105f, 14.134f));
...
DECLARE_SCRIPT(M07_Player_Vehicle, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101131), M07_PLAYER_VEHICLE_ID,
                                    vehicle_id);
    }
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100757), M07_PLAYER_VEHICLE_KILLED,
                                    1);
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M07_VEHICLE_DROP_ZONE) {
            ...
            if (param == 10 && m07_player_vehicle_killed < 7) {
                // Havoc!  Taking missile fire over the park.  Launcher is unseen.  Repeat, launcher
                // is unseen.\n
        ...
        if (type == M07_PLAYER_VEHICLE_KILLED) {
            ...
            if (m07_player_vehicle_killed < 4) {
                ...
                GameObject* chinook_obj1
                    = Commands->Create_Object("Invisible_Object", Commands->Get_Position(drop_loc));
                Commands->Set_Facing(chinook_obj1, drop_facing);
...
DECLARE_SCRIPT(M07_Vehicle_Drop_Zone, "Zone_ID=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100757), M07_VEHICLE_DROP_ZONE,
                                        zone_id);
        }
    }
};
...
DECLARE_SCRIPT(M07_Stockpile_Object, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == STILL_DAMAGED && damaged) {
            Commands->Create_Logical_Sound(obj, M07_ENGINEER_DAMAGED, Commands->Get_Position(obj),
                                           40.0f);
    ...
    void Damaged(GameObject * obj, GameObject * damager, float amount)
    {
        if (Commands->Get_Health(obj) < Commands->Get_Max_Health(obj)) {
            ...
            damaged = false;
            Commands->Create_Logical_Sound(obj, M07_ENGINEER_FIXED, Commands->Get_Position(obj),
                                           40.0f);
        }
    }
};
...
DECLARE_SCRIPT(M07_Park_SSM, "")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == STILL_DAMAGED) {
            if (Commands->Get_Health(obj) < Commands->Get_Max_Health(obj)) {
                Commands->Create_Logical_Sound(obj, M07_SSM_DAMAGED, Commands->Get_Position(obj),
                                               1000.0f);
                Commands->Start_Timer(obj, this, 10.0f, STILL_DAMAGED);
            }
            else {
                Commands->Create_Logical_Sound(obj, M07_SSM_FIXED, Commands->Get_Position(obj),
                                               1000.0f);
            }
        }
    }
...
DECLARE_SCRIPT(M07_Nod_Obelisk, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M07_PLAYERTYPE_CHANGE_OBELISK) {
            converted = true;
            Commands->Set_Player_Type(Commands->Find_Object(obelisk_weapon_id),
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (!converted) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100805), M07_OBELISK_KILLED, 1,
                                        0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M07_Nod_Obelisk_MCT, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if ((Commands->Is_A_Star(poker)) && (!poked)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(168926),
                                        M07_PLAYERTYPE_CHANGE_OBELISK, 1, 0.0f);
...
DECLARE_SCRIPT(M07_Park_Zone, "Zone=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer))) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100801), M07_MOVE_STEALTH_TANK,
                                        activate_zone);
        }
    }
};

DECLARE_SCRIPT(M07_Activate_Encounter,
...
DECLARE_SCRIPT(M07_Deactivate_Encounter, "Activate_Zone=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(activate_zone),
                                        M07_DEACTIVATE_ENCOUNTER, 1);
        }
    }
};

DECLARE_SCRIPT(M07_Encounter_Unit,
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == REINFORCEMENT_CHECK && encounter) {
            if (m07_v05_units < 3 && reinforce) {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(30.873f, -9.825f, 5.346f));
...
DECLARE_SCRIPT(M07_V05_Officer, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100899), M07_V05_OFFICER_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M07_V05_Unit, "Stationary=0:int") {
    ...
    void Created(GameObject * obj) { bool stationary
                                     = (Get_Int_Parameter("Stationary") == 1) ? true : false;
if (stationary) {
    Commands->Set_Innate_Is_Stationary(obj, true);
}

Commands->Send_Custom_Event(obj, Commands->Find_Object(100899), M07_REINFORCEMENT_UNIT_CREATED, 1,
                            2.0f);
}

void Killed(GameObject* obj, GameObject* killer)
{
    Commands->Send_Custom_Event(obj, Commands->Find_Object(100899), M07_REINFORCEMENT_UNIT_KILLED,
                                1, 2.0f);
}
}
;
    ...
    {
        {
            if (Commands->Is_A_Star(enterer) && !already_entered) {
                already_entered = true;
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100899),
                                            M07_ACTIVATE_ENCOUNTER, 1);
            }
        }
    }
};
...
DECLARE_SCRIPT(M07_Nod_Inn_Light_Tank_Dec, "APC_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(apc_id), M07_REINFORCEMENT_KILLED,
                                    apc_id, 0.0f);
    }
};
...
DECLARE_SCRIPT(M07_Deactivate_V01, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100953), M07_DEACTIVATE_V01, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M07_V01_Controller, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M07_ACTIVATE_V01 && !activated) {
            ...
            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(-193.706f, -82.114f, 4.987f));
        ...
        if (type == M07_V01_UNIT_KILLED && activated) {
            ...
            if (m07_v01_unit_killed % 2 == 0) {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-193.706f, -82.114f, 4.987f));
                Commands->Set_Facing(chinook_obj1, 20.000f);
                Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X7D_CHTroopdrop2.txt");
            }
        }
...
DECLARE_SCRIPT(M07_V01_Unit, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100953), M07_V01_UNIT_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M07_Relocate_Triangle_Apache, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        ...
        Commands->Create_Logical_Sound(obj, M07_RELOCATE_TRIANGLE_APACHE,
                                       Commands->Get_Position(obj), 100.0f);
}
}
}
;
...
DECLARE_SCRIPT(M07_Triangle_APC, "") {
    ...
    void Killed(GameObject * obj, GameObject* killer) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101056), M07_TRIANGLE_APC_KILLED, 1,
                                    0.0f);
}
}
;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M07_TRIANGLE_APC_KILLED) {
            ...
            if (m07_triangle_apc_killed == 2) {
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-531.675f, -87.333f, 13.908f));
...
DECLARE_SCRIPT(M07_Triangle_Unit, "") {
    ...
    void Killed(GameObject * obj, GameObject* killer) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101056), M07_TRIANGLE_UNIT_KILLED, 1,
                                    0.0f);
}
}
;
...
DECLARE_SCRIPT(M07_Activate_Hostage_Encounter, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) {
        if (Commands->Is_A_Star(enterer)) { // Hostage
...
DECLARE_SCRIPT(M07_Activate_Bridge_Civ, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) {
        if (Commands->Is_A_Star(enterer)) { // Bridge Civilians
...
DECLARE_SCRIPT(M07_Para_Drop_Zone, "Zone_ID=0:int") {
    ...
    void Entered(GameObject * obj,
                 GameObject* enterer) { int zone_id = Get_Int_Parameter("Zone_ID");
...
DECLARE_SCRIPT(M07_Para_Drop_Unit, "Unit_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101133), M07_PARADROP_UNIT_KILLED,
                                    unit_id);
    }
};
...
DECLARE_SCRIPT(M07_Activate_Para_Drop, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(-417.090f, 39.921f, 20.435f));
            Commands->Set_Facing(chinook_obj1, 0.000f);
            Commands->Attach_Script(chinook_obj1, "Test_Cinematic", "X7D_CHTroopdrop4.txt");

            GameObject* chinook_obj2
                = Commands->Create_Object("Invisible_Object", Vector3(-437.171f, 35.261f, 36.155f));
            ...
            GameObject* chinook_obj3
                = Commands->Create_Object("Invisible_Object", Vector3(-474.645f, 36.897f, 32.859f));
            Commands->Set_Facing(chinook_obj3, 0.000f);
            Commands->Attach_Script(chinook_obj3, "Test_Cinematic", "X7D_CHTroopdrop6.txt");

            GameObject* chinook_obj4
                = Commands->Create_Object("Invisible_Object", Vector3(-516.036f, 40.087f, 30.558f));
...
DECLARE_SCRIPT(M07_Deactivate_Para_Drop, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        if (Commands->Is_A_Star(enterer) && !already_entered) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(101133), M07_DEACTIVATE_PARADROP,
                                        1);
        }
    }
};
...
DECLARE_SCRIPT(M07_Player_Rocket_Emplacement, "") {
    ...
    void Damaged(GameObject * obj, GameObject* damager,
                 float amount) { if (damager == Commands->Find_Object(100905)) {
...
DECLARE_SCRIPT(M07_Inn_Evac, "") // 104496
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == M07_DEAD6_EVAC) // SAM sites captured, evac DEAD6 and Sydney
        {
            ...
            GameObject* troopBone
                = Commands->Create_Object("Saveable_Invisible_Object", evacPosition);
            ...
            dead6_cnt++;
            if (dead6_cnt == 4) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100658), M07_EVAC_INN, 1,
                                            0.0f);
            }
            if (dead6_cnt == 5) {
                // This is Resistance Radio.  Nod SSM deployment confirmed.  All available personnel
                // to the park.\n
        ...
        if (type == M07_EVAC_INN) // SAM sites captured, evac DEAD6 and Sydney
        {
            ...
            GameObject* evacChopper = Commands->Create_Object_At_Bone(
                evacWaypath, "GDI_Transport_Helicopter_Flyover", "BN_Trajectory");
...
DECLARE_SCRIPT(M07_Inn_Evac_Rope,
               "") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "XG_EV5_rope.XG_EV5_ropeA")
        == 0) { Commands->Set_Animation(obj, "XG_EV5_rope.XG_EV5_ropeL", true);
}
...
DECLARE_SCRIPT(M07_Inn_Evac_Trajectory,
               "") { void Animation_Complete(GameObject * obj, const char* anim) {
    if (stricmp(anim, "XG_EV5_Path.XG_EV5_PathA")
        == 0) { Commands->Set_Animation(obj, "XG_EV5_Path.XG_EV5_PathL", true);
}
...
DECLARE_SCRIPT(M07_Custom_Activate, "Object1_ID=0:int, Object2_ID=0:int, Object3_ID=0:int,")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            if (object1_id != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(object1_id),
                                            M07_CUSTOM_ACTIVATE, 1, 0.0f);
            }
            if (object2_id != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(object2_id),
                                            M07_CUSTOM_ACTIVATE, 1, 0.0f);
            }
            if (object3_id != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(object3_id),
                                            M07_CUSTOM_ACTIVATE, 1, 0.0f);
            }
        }
    }
...
DECLARE_SCRIPT(M07_SSM_Unit, "")
{
    ...
    void Sound_Heard(GameObject * obj, const CombatSound& sound)
    {
        ...
        if (sound.Type == M07_SSM_DAMAGED
            && (::strncmp("Nod_Engineer_0", preset_name, ::strlen("Nod_Engineer_0")) == 0)) {
            params.Set_Basic(this, INNATE_PRIORITY_ENEMY_SEEN + 5, 100);
...
{ void Custom(GameObject * obj, int type, int param, GameObject* sender) {
    if (type == CUSTOM_EVENT_POWERUP_GRANTED) { // Reveal Stealth Tank
...
{ void Custom(GameObject * obj, int type, int param, GameObject* sender) {
    if (type == CUSTOM_EVENT_POWERUP_GRANTED) { // Reveal Stealth Soldier
...
DECLARE_SCRIPT(M07_Hotwire_Dead, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Hotwire
            if (Commands->Find_Object(100658)) {
                // This is Hotwire, I can't hold this position! Requesting - oh great! <gunfire and
                // static>
