...
DECLARE_SCRIPT(M08_Objective_Controller, "") // 100002
{
    ...
    void Add_An_Objective(int id)
    {
        ...
        // Escape Prison
        case 801: {
            Commands->Add_Objective(801, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M08_01, nullptr,
                                    IDS_Enc_Obj_Primary_M08_01);
            ...
            if (object) {
                ...
                Commands->Set_Objective_HUD_Info_Position(
                    801, 90.0f, "POG_M08_1_02.tga", IDS_POG_ESCAPE, Commands->Get_Position(object));
            }
        } break;
        // Infiltrate Research Facility
        case 802: {
            Commands->Add_Objective(802, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M08_02, nullptr,
                                    IDS_Enc_Obj_Primary_M08_02);
            object = Commands->Find_Object(108361);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(802, object);
                Commands->Set_Objective_HUD_Info_Position(802, 90.0f, "POG_M08_1_03.tga",
                                                          IDS_POG_INFILTRATE,
        ...
        // Rescue Scientists
        case 803: {
            Commands->Add_Objective(803, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M08_03, nullptr,
                                    IDS_Enc_Obj_Primary_M08_03);
            // Now that Havoc is out of the prison area you must remove lock level 10 so that he
            // cannot open the mutant pens
            Commands->Grant_Key(STAR, 10, false);
            object = Commands->Find_Object(108818);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(803, object);
                Commands->Set_Objective_HUD_Info_Position(
                    803, 90.0f, "POG_M08_1_04.tga", IDS_POG_RESCUE, Commands->Get_Position(object));
            }
        } break;
        // Destroy Helipad
        case 804: {
            Commands->Add_Objective(804, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M08_01, nullptr,
                                    IDS_Enc_Obj_Secondary_M08_05);
            object = Commands->Find_Object(106339);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(804, object);
                Commands->Set_Objective_HUD_Info_Position(804, 90.0f, "POG_M08_2_01.tga",
                                                          IDS_POG_DESTROY,
                                                          Commands->Get_Position(object));
            }
        } break;
        // Eliminate Raveshaw
        case 805: {
            Commands->Add_Objective(805, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Primary_M08_04, nullptr,
                                    IDS_Enc_Obj_Primary_M08_04);
        ...
        case 806: {
            Commands->Add_Objective(806, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M08_02, nullptr,
                                    IDS_Enc_Obj_Secondary_M08_06);
            object = Commands->Find_Object(100016);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(806, object);
                Commands->Set_Objective_HUD_Info_Position(806, 90.0f, "POG_M08_2_02.tga",
                                                          IDS_POG_DISABLE,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 807: {
            Commands->Add_Objective(807, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                    IDS_Enc_ObjTitle_Secondary_M08_03, nullptr,
                                    IDS_Enc_Obj_Secondary_M08_07);
            object = Commands->Find_Object(100017);
            if (object) {
                Commands->Set_Objective_Radar_Blip_Object(807, object);
                Commands->Set_Objective_HUD_Info_Position(807, 90.0f, "POG_M08_2_03.tga",
                                                          IDS_POG_DISABLE,
                                                          Commands->Get_Position(object));
            }
        } break;
        ...
        case 808: {
            Commands->Add_Objective(808, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
                                    IDS_Enc_ObjTitle_Hidden_M08_01, nullptr,
                                    IDS_Enc_Obj_Hidden_M08_01);
        } break;
        // Destroy Tiberium cultivation center
        case 809: {
            Commands->Add_Objective(809, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN,
                                    IDS_Enc_ObjTitle_Hidden_M08_02, nullptr,
                                    IDS_Enc_Obj_Hidden_M08_02);
        } break;
        }
    }
...
void Custom(GameObject* obj, int type, int param, GameObject* sender)
{
    if (type == M08_RELOCATE) {
        ...
        //
        GameObject* raveshaw
            = Commands->Create_Object("Raveshaw", Vector3(-127.209F, 484.503F, -189.532F));
        if (raveshaw != nullptr) {
...
DECLARE_SCRIPT(M08_Activate_Objective_802, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Nick, Those scientists you've been digging for are being held in a Nod Research
            // Facility at the far end of the canyon. Figure'd you might want to know.\n
...
DECLARE_SCRIPT(M08_Activate_Objective_803, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Nick, we're going to lose contact when you head inside, there's no radio
            // communication possible due to jamming signals.\n
...
DECLARE_SCRIPT(M08_Activate_Objective_804, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Don't know if you care, hon, but there's a Nod Helipad in back of the Prison
            // Facility. Might help if you blow it up.\n
...
DECLARE_SCRIPT(M08_Raveshaw, "") {
    ...
    void Custom(GameObject * obj, int type, int param,
                GameObject* sender) { if (type == M08_RELOCATE) {
...
DECLARE_SCRIPT(M08_Initial_Prisoner, "Reinforcment_ID=0:int")
{
    ...
    void Enemy_Seen(GameObject * obj, GameObject * enemy)
    {
        ...
        if (!enemy_seen) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(enemy_id), M08_DONT_MOVE, 1,
                                        0.0f);
        }
    }
    ...
    {
        if (!enemy_seen) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(enemy_id),
                                        M08_PRISONER_ATTACKER_KILLED, 1, 0.0f);
        }
...
DECLARE_SCRIPT(M08_Nod_Prison_Unit, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(prisoner_attack_id),
                                    M08_NOD_ATTACKEE_KILLED, 1, 0.0f);
    }
};
...
DECLARE_SCRIPT(M08_Cell_Controller, "")
{
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        if (Commands->Is_A_Star(poker) && !poked) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100710), M08_FREE_PRISONER, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100713), M08_FREE_PRISONER, 1,
                                        0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100714), M08_FREE_PRISONER, 1,
                                        0.0f);
...
DECLARE_SCRIPT(M08_GDI_Free_Prison, "Soldier_ID=0:int") {
    ...
    void Killed(GameObject * obj,
                GameObject* killer) { int soldier_id = Get_Int_Parameter("Soldier_ID");
Commands->Send_Custom_Event(obj, Commands->Find_Object(100246), M08_GDI_FREE_PRISON_KILLED,
                            soldier_id, 0.0f);
}
}
;
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_GDI_FREE_PRISON_KILLED) {
            ...
            case 1: {
                ...
                if (gdi1 % 2 == 0) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-13.121f, 57.855f, -0.091f));
            ...
            case 2: {
                ...
                if (gdi2 % 2 == 0) {
                    GameObject* controller = Commands->Create_Object(
                        "Invisible_Object", Vector3(-43.266f, 110.230f, -0.238f));
                    Commands->Set_Facing(controller, 90.000f);
...
DECLARE_SCRIPT(M08_APC_Soldier, "APC_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        if (Commands->Find_Object(apc_id)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(apc_id),
                                        M08_REINFORCEMENT_KILLED, apc_id, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M08_Activate_PetraA21, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100262), M08_CUSTOM_ACTIVATE, 1,
                                        0.0f);
            // Custom to activate PetraA21_Buggy
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100289), M08_CUSTOM_ACTIVATE, 1,
                                        0.0f);

            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(109.901f, 170.915f, -7.315f));
...
DECLARE_SCRIPT(M08_Activate_Convoy, "Param=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100326), M08_CUSTOM_ACTIVATE,
                                        param, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100327), M08_CUSTOM_ACTIVATE,
                                        param, 0.5f);
        }
    }
};
...
DECLARE_SCRIPT(M08_Activate_Stealth_Trap, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Front
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Vector3(224.119f, 218.876f, -13.746f), obj);
            Commands->Create_Explosion("Ground Explosions Twiddler",
                                       Vector3(222.456f, 202.921f, -15.889f), obj);

            GameObject* crate1
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(224.119f, 218.876f, -13.746f));
            Commands->Set_Facing(crate1, 165.000f);
            crate1_id = Commands->Get_ID(crate1);

            GameObject* crate2
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(223.517f, 217.013f, -10.574f));
            Commands->Set_Facing(crate2, 165.000f);
            crate2_id = Commands->Get_ID(crate2);

            GameObject* crate3 = Commands->Create_Object("M08_Rubble_Stub_Destroyable",
                                                         Vector3(221.917f, 212.589f, -15.192f));
            Commands->Set_Facing(crate3, 0.000f);
            crate3_id = Commands->Get_ID(crate3);

            GameObject* crate4
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(222.138f, 207.974f, -12.258f));
            Commands->Set_Facing(crate4, 0.000f);
            crate4_id = Commands->Get_ID(crate4);

            GameObject* crate5
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(221.850f, 196.753f, -15.421f));
            Commands->Set_Facing(crate5, 0.000f);
            crate5_id = Commands->Get_ID(crate5);

            GameObject* crate6
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(221.944f, 198.134f, -12.500f));
            Commands->Set_Facing(crate6, 0.000f);
            crate6_id = Commands->Get_ID(crate6);

            GameObject* crate7
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(222.456f, 202.921f, -15.889f));
            Commands->Set_Facing(crate7, 0.000f);
            crate7_id = Commands->Get_ID(crate7);

            // Rear
            Commands->Create_Explosion("Generic Ground 01", Vector3(106.852f, 221.987f, -3.990f),
                                       obj);
            Commands->Create_Explosion("Generic Ground 01", Vector3(89.681f, 218.165f, -8.951f),
                                       obj);

            GameObject* crate8
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(106.852f, 221.987f, -3.990f));
            Commands->Set_Facing(crate8, 105.000f);

            GameObject* crate9
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(99.245f, 220.195f, -5.858f));
            Commands->Set_Facing(crate9, 105.000f);

            GameObject* crate10
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(97.595f, 219.985f, -9.097f));
            Commands->Set_Facing(crate10, -75.000f);

            GameObject* crate11
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(89.813f, 217.622f, -5.894f));
            Commands->Set_Facing(crate11, 105.000f);

            GameObject* crate12
                = Commands->Create_Object("M08_Rubble_Stub", Vector3(89.681f, 218.165f, -8.951f));
            Commands->Set_Facing(crate12, -80.000f);

            // Activate initial stealth tank
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100347), M08_CUSTOM_ACTIVATE, 1,
                                        0.0f);
...
DECLARE_SCRIPT(M08_Destroy_Stealth_Trap, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (Commands->Get_ID(enterer) == stealth_tank_id) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_CUSTOM_ACTIVATE, 1,
                                        0.0f);
        }
    }
...
DECLARE_SCRIPT(M08_Player_Stealth_Tank, "")
{
    ...
    void Created(GameObject * obj)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100360), M08_UNIT_ID,
...
DECLARE_SCRIPT(M08_Archaelogical_Site_Patrol,
               "Waypath_ID=0:int, Waypath_Loc:Vector3, Unit_ID=0:int")
{
    int waypath_id;
    Vector3 waypath_loc;
    int unit_id;
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100362), M08_ARCHAELOGICAL_KILLED,
                                    unit_id, 0.0f);
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_ARCHAELOGICAL_KILLED) {
            ...
            case 1: {
                ...
                if (unit1_killed % 2 == 0) {
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Vector3(280.143f, 256.055f, -18.745f));
            ...
            case 2: {
                unit2_killed++;
                if (unit2_killed % 2 == 0) {
                    GameObject* chinook_obj2 = Commands->Create_Object(
                        "Invisible_Object", Vector3(270.498f, 394.061f, -12.328f));
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_PETRAA25_KILLED) {
            ...
            case 1: {
                ...
                if (unit1_killed < 4) {
                    GameObject* chinook_obj2 = Commands->Create_Object(
                        "Invisible_Object", Vector3(161.429f, 419.470f, -11.413f));
                    Commands->Set_Facing(chinook_obj2, 60.000f);
                    Commands->Attach_Script(chinook_obj2, "Test_Cinematic",
                                            "M08_XG_VehicleDrop1.txt");
                }
            } break;
            case 2: {
                unit2_killed++;
...
DECLARE_SCRIPT(M08_PetraA25_Tank, "")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100436), M08_PETRAA25_KILLED, 1,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M08_Activate_Encounter,
               "Spawner_ID1=0:int, Spawner_ID2=0:int, Spawner_ID3=0:int, Spawner_ID4=0:int, "
...
DECLARE_SCRIPT(M08_Encounter_Unit,
               "Waypath_ID=0:int, Priority=0:int, Suicide=0:int, Stationary_at_End=0:int")
{
    int waypath_id;
    int priority;
    bool suicide;
...
DECLARE_SCRIPT(M08_Warden_Announcement1, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is the warden, we have a probable escape situation in solitary. Full lockdown,
            // all personnel initiate response protocols.\n
...
DECLARE_SCRIPT(M08_Warden_Announcement2, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // This is the warden, we have a confirmed prison break, repeat, confirmed prison break!
            // Assume all GDI as hostile, kill every last one of them!\n
               ...
               "Unit_ID1=0:int, Unit_ID2=0:int, Unit_ID3=0:int, Unit_ID4=0:int, Unit_ID5=0:int, ")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            if (unit_id1 != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(unit_id1), M08_INNATE_ON, 1,
                                            0.0f);
            }
            if (unit_id2 != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(unit_id2), M08_INNATE_ON, 1,
                                            0.0f);
            }
            if (unit_id3 != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(unit_id3), M08_INNATE_ON, 1,
                                            0.0f);
            }
            if (unit_id4 != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(unit_id4), M08_INNATE_ON, 1,
                                            0.0f);
            }
            if (unit_id5 != 0) {
                Commands->Send_Custom_Event(obj, Commands->Find_Object(unit_id5), M08_INNATE_ON, 1,
                                            0.0f);
            }
        }
    }
...
DECLARE_SCRIPT(M08_Basketball_Gun_Emp, "") { void Killed(GameObject * obj, GameObject* killer) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(100197), M08_BASKETBALL_GUN_EMP_KILLED,
                                1, 0.0f);
}
}
;
...
DECLARE_SCRIPT(M08_Petra_A_Controller, "") // 100346
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_PETRA_A_ACTIVATE && !petra_a_active) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_HELO_KILLED,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_HELO_KILLED,
                                        2, 1.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_HELO_KILLED,
        ...
        if ((type == M08_PETRA_A_KILLED || type == M08_PETRA_A_HELO_KILLED) && petra_a_active) {
            ...
            case 1: {
                if (m08_petra_a1_unit == 0) {
                    ...
                    GameObject* chinook_obj1 = Commands->Create_Object(
                        "Invisible_Object", Commands->Get_Position(drop_loc));
...
DECLARE_SCRIPT(M08_Petra_A_Unit, "Unit_ID=0:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_CREATED,
                                    unit_id, 0.0f);

        Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_UNIT_STATUS,
                                    unit_id, 0.0f);
    }
    ...
    {
        int unit_id = Get_Int_Parameter("Unit_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_KILLED, unit_id,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M08_Activate_Petra_A, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_ACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Deactivate_Petra_A, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100346), M08_PETRA_A_DEACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Petra_B_Controller, "") // 100346
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_PETRA_B_ACTIVATE && !petra_b_active) {
            ...
            // Custom to bring in helo troop drop
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_HELO_KILLED,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_HELO_KILLED,
                                        2, 1.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_HELO_KILLED,
            ...
            if (!Commands->Find_Object(109047) && !created_vehicle) {
                ...
                GameObject* player_vehicle = Commands->Create_Object(
                    "Nod_Stealth_Tank_Player", Vector3(145.898f, 269.404f, -14.918f));
                Commands->Set_Facing(player_vehicle, 150.000f);
                // Send the player vehicle id to Petra_C
                Commands->Send_Custom_Event(obj, Commands->Find_Object(100389),
                                            M08_PLAYER_VEHICLE_ID, Commands->Get_ID(player_vehicle),
                                            0.0f);
            }
        }
...
DECLARE_SCRIPT(M08_Petra_B_Unit, "Unit_ID=0:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        int unit_id = Get_Int_Parameter("Unit_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_CREATED,
                                    unit_id, 0.0f);

        Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_UNIT_STATUS,
                                    unit_id, 0.0f);
    }
    ...
    {
        int unit_id = Get_Int_Parameter("Unit_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_KILLED, unit_id,
                                    0.0f);
    }
};
...
Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_HELO_KILLED, unit_id,
                            0.0f);
}
}
;
...
DECLARE_SCRIPT(M08_Activate_Petra_B, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_ACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Deactivate_Petra_B, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100370), M08_PETRA_B_DEACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Petra_C_Controller, "") // 100389
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_PETRA_C_ACTIVATE && !petra_c_active) {
            ...
            // Custom to bring in helo troop drop
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_HELO_KILLED,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_HELO_KILLED,
                                        2, 1.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_HELO_KILLED,
...
DECLARE_SCRIPT(M08_Petra_C_Unit, "Unit_ID=0:int")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        int unit_id = Get_Int_Parameter("Unit_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_CREATED,
                                    unit_id, 0.0f);

        Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_UNIT_STATUS,
                                    unit_id, 0.0f);
    }
    ...
    {
        int unit_id = Get_Int_Parameter("Unit_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_KILLED, unit_id,
                                    0.0f);
    }
};
...
DECLARE_SCRIPT(M08_Petra_C_Helo, "Unit_ID=0:int") {
    ...
    void Killed(GameObject * obj, GameObject* killer) { int unit_id = Get_Int_Parameter("Unit_ID");
Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_HELO_KILLED, unit_id,
                            0.0f);
}
}
;
...
DECLARE_SCRIPT(M08_Activate_Petra_C, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(109626), M08_PETRA_C_ACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Deactivate_Petra_C, "") {
    ...
    void Entered(GameObject * obj, GameObject* enterer) { if (Commands->Is_A_Star(enterer)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100389), M08_PETRA_C_DEACTIVATE, 1,
                                    0.0f);
}
}
}
...
DECLARE_SCRIPT(M08_Patrol_Inactive, "Waypath_ID=0:int, Waypath_Loc:Vector3, Controller_ID=0:int")
{
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(controller_id), M08_PATROL_KILLED, 1,
                                    0.0f);
    }
};
...
{
    int controller_id = Get_Int_Parameter("Controller_ID");
    Commands->Send_Custom_Event(obj, Commands->Find_Object(controller_id), M08_SCIENTIST_KILLED, 1,
                                0.0f);
}
}
;
...
DECLARE_SCRIPT(M08_Activate_Cavern_Entrance_Truck, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(100516),
                                        M08_CAVERN_ENTRANCE_TRUCK, 1);
        }
    }
};
               ...
               "Point1_ID=0:int, Point2_ID=0:int, Point3_ID=0:int, Controller_ID=0:int")
{
    ...
    {
        int controller_id = Get_Int_Parameter("Controller_ID");
        Commands->Send_Custom_Event(obj, Commands->Find_Object(controller_id), M08_SCIENTIST_KILLED,
                                    1, 0.0f);
    }
};
...
DECLARE_SCRIPT(M08_Custom_Activate, "Controller_ID=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            int controller_id = Get_Int_Parameter("Controller_ID");
            // Custom to activate
            Commands->Send_Custom_Event(obj, Commands->Find_Object(controller_id),
                                        M08_CUSTOM_ACTIVATE, 1, 0.0f);
        }
    }
};
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        if (type == M08_REINFORCEMENT_KILLED) {
            ...
            if (reinforce % 2 == 0 && reinforce < 7) {
                ...
                Vector3 soldier_loc1 = pos + Vector3(a, b + .5f, 0.5f);
                GameObject* soldier1
                    = Commands->Create_Object("Nod_FlameThrower_2SF", soldier_loc1);
                Commands->Attach_Script(soldier1, "M08_APC_Soldier", param1);

                Vector3 soldier_loc2 = pos + Vector3(a, (b - .5f), 0.5f);
                GameObject* soldier2
                    = Commands->Create_Object("Nod_FlameThrower_2SF", soldier_loc2);
                Commands->Attach_Script(soldier2, "M08_APC_Soldier", param1);
            }
        }
    }
...
DECLARE_SCRIPT(M08_Unarmed_Prisoner, "Exit_Cell_ID=0:int, Weapon_Loc_ID=0:int")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (action_id == EXIT_CELL && reason == ACTION_COMPLETE_NORMAL) {
            ...
            params.Set_Movement(Commands->Find_Object(Get_Int_Parameter("Weapon_Loc_ID")), RUN,
                                1.0f);
            Commands->Action_Goto(obj, params);
        }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        if (timer_id == KEEP_TRYING) {
            ...
            params.Set_Movement(Commands->Find_Object(Get_Int_Parameter("Exit_Cell_ID")), RUN,
                                1.0f);
            Commands->Action_Goto(obj, params);
        }
    }
               ...
               "Prisoner1_ID=0:int, Prisoner2_ID=0:int, Prisoner3_ID=0:int, Prisoner4_ID=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(prisoner1_id), M08_FREE_PRISONER,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(prisoner2_id), M08_FREE_PRISONER,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(prisoner3_id), M08_FREE_PRISONER,
                                        1, 0.0f);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(prisoner4_id), M08_FREE_PRISONER,
                                        1, 0.0f);
        }
    }
};
...
DECLARE_SCRIPT(M08_Sakura, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(100356), M08_SAKURA_ID, sakura_id,
                                    0.0f);
...
DECLARE_SCRIPT(M08_Move_Sakura, "Movement_Loc=0:int")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(sakura_id), M08_MOVE_SAKURA,
                                        movement_loc, 0.0f);
        }
    }
...
DECLARE_SCRIPT(M08_Mobile_Vehicle,
               "CheckBlocked=1:int, Attack_Loc0=0:int, Attack_Loc1=0:int, Attack_Loc2=0:int, "
               ...
               "Attack_Loc7=0:int, Attack_Loc8=0:int, Attack_Loc9=0:int, Attack_Loc10=0:int")
{
    ...
    void Enemy_Seen(GameObject * obj, GameObject * enemy)
    {
        ...
        params.Set_Basic(this, INNATE_PRIORITY_ENEMY_SEEN + 5, 10);
        params.Set_Movement(Commands->Get_Position(Commands->Find_Object(attack_loc[loc])), 1.0f,
                            5.0f);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == GOTO_LOC) {
            ...
            for (int x = 0; x <= 10; x++) {
                if (attack_loc[x] != nullptr) {
                    float dist = Commands->Get_Distance(
                        star_loc, Commands->Get_Position(Commands->Find_Object(attack_loc[x])));
            ...
            ActionParamsStruct params;
            params.Set_Basic(this, INNATE_PRIORITY_ENEMY_SEEN + 5, 10);
            params.Set_Movement(Commands->Get_Position(Commands->Find_Object(attack_loc[loc])),
                                1.0f, 5.0f);
...
DECLARE_SCRIPT(M08_Activate_Excavation, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* chinook_obj1
                = Commands->Create_Object("Invisible_Object", Vector3(210.156f, 301.252f, -7.404f));
            ...
            GameObject* chinook_obj2
                = Commands->Create_Object("Invisible_Object", Vector3(202.507f, 308.211f, -6.972f));
               ...
               "Loc1_ID=0:int, Loc2_ID=0:int, Loc3_ID=0:int, Animation:string, Spawner_ID=0:int")
{
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
        ...
        if (reason != ACTION_COMPLETE_NORMAL && action_id != Commands->Get_Action_ID(obj)
            && !start_over) {
            start_over = true;
...
DECLARE_SCRIPT(M08_Apache_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        // apache_id[0] = Commands->Get_ID(Commands->Create_Object("Nod_Apache_No_Idle",
        // Vector3(-12.129f, -149.546f, 2.949f))); GameObject * apache =
        // Commands->Find_Object(apache_id[0]); Commands->Attach_Script(apache, "M10_Apache", "0");
        apache_id[1] = Commands->Get_ID(
            Commands->Create_Object("Nod_Apache", Vector3(-45.993f, -66.675f, 12.382f)));
...
DECLARE_SCRIPT(M08_Apache, "Area:int")
{
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        if (timer_id == 0) {
            ...
            pos.Z
                = WWMath::Max(pos.Z + 12.0f, Commands->Get_Safe_Flight_Height(pos.X, pos.Y) + 6.0f);
...
DECLARE_SCRIPT(M08_Activate_Midtro, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            // Commands->Set_Animation_Frame ( Commands->Find_Object (1450630),
            // "res_elev06.res_elev06", 51 );
        ...
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            if (Commands->Find_Object(orator_id)) {
                if (captive) {
                    ...
                    int conv_id = Commands->Create_Conversation(conv_name, 100.0f, 200.0f, false);
                    Commands->Join_Conversation(Commands->Find_Object(orator_id), conv_id, false,
                                                true);
...
DECLARE_SCRIPT(M08_Elevator_Movement_Zone, "Direction:int, Anim_num:int, Elev_obj_num:int") {
    void Entered(GameObject * obj, GameObject* enterer) { char * elevators[1] = {
...
const char* Prisoner_Conv_Table[] = {
    "M08_CON011", // GCP1
    "M08_CON012", "M08_CON013", "M08_CON014", "M08_CON015",
    "M08_CON016", "M08_CON017", "M08_CON018", "M08_CON019",
    "M08_CON020", // [9]
    "M08_CON021", // GCP2
    "M08_CON022", "M08_CON023", "M08_CON024", "M08_CON025",
    "M08_CON026", "M08_CON027", "M08_CON028", "M08_CON029",
    "M08_CON030", // [19]
    "M08_CON031", // GCP3
    "M08_CON032", "M08_CON033", "M08_CON034", "M08_CON035",
    "M08_CON036", "M08_CON037", "M08_CON038", "M08_CON039",
    "M08_CON040" // [29]
};
    ...
    void Poked(GameObject * obj, GameObject * poker)
    {
        ...
        if ((::strncmp("GDI_Prisoner_v0a", preset_name, ::strlen("GDI_Prisoner_v0a")) == 0)
            ...
            Play_Conversation(obj, 10, 19);
                 ...
                 || (::strncmp("GDI_Prisoner_v1b", preset_name, ::strlen("GDI_Prisoner_v1a"))
                     == 0)) {
            Play_Conversation(obj, 10, 19);
        }
        else if ((::strncmp("GDI_Prisoner_v2a", preset_name, ::strlen("GDI_Prisoner_v2a")) == 0)
                 || (::strncmp("GDI_Prisoner_v2b", preset_name, ::strlen("GDI_Prisoner_v2a"))
                     == 0)) {
...
DECLARE_SCRIPT(M08_Enable_KaneConversation, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if ((Commands->Is_A_Star(enterer)) && (!already_entered)) {
            ...
            GameObject* kane
                = Commands->Create_Object_At_Bone(holograph, "Nod_Kane_HologramHead", "O_ARROW");
