...
// MTU_Tutorial_Controller - This script handles all mission objectives and state switches for
// Tutorial.
...
DECLARE_SCRIPT(MTU_Tutorial_Controller, "")
{
    ...
    void Created(GameObject * obj)
    {
        ...
        Commands->Add_Radar_Marker(MTU_RADAR_MCT_01, Vector3(29.63f, 11.98f, -8.04f),
                                   RADAR_BLIP_SHAPE_STATIONARY, RADAR_BLIP_COLOR_GDI);
        Commands->Add_Radar_Marker(MTU_RADAR_MCT_02, Vector3(10.15f, -19.68f, -8.36f),
                                   RADAR_BLIP_SHAPE_STATIONARY, RADAR_BLIP_COLOR_GDI);
        Commands->Add_Radar_Marker(MTU_RADAR_MCT_03, Vector3(-43.23f, 25.66f, -6.32f),
                                   RADAR_BLIP_SHAPE_STATIONARY, RADAR_BLIP_COLOR_GDI);
        Commands->Add_Radar_Marker(MTU_RADAR_MCT_04, Vector3(-25.33f, 56.15f, -7.56f),
                                   RADAR_BLIP_SHAPE_STATIONARY, RADAR_BLIP_COLOR_GDI);
        Commands->Add_Radar_Marker(MTU_RADAR_MCT_05, Vector3(-7.89f, 15.57f, -8.75f),
                                   RADAR_BLIP_SHAPE_STATIONARY, RADAR_BLIP_COLOR_GDI);
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        case (MTU_TIMER_GUNNER_ION_AMMO): {
            GameObject* powerup
                = Commands->Create_Object("POW_IonCannonBeacon_Player", powerup_loc);
            if (powerup) {
        ...
        case (MTU_TIMER_FLYOVERS): {
            ...
            if (Get_Int_Random(0, 2)) {
                GameObject* flyover
                    = Commands->Create_Object(vehicle, Vector3(51.02f, 128.63f, 41.45f));
                if (flyover) {
                ...
                GameObject* flyover
                    = Commands->Create_Object(vehicle, Vector3(131.78f, -14.58f, 51.21f));
                if (flyover) {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case (MTU_TYPE_SYDNEY_CHECK_RESET): {
            if (sydney_restart) {
                ...
                if (sydney_zone) {
                    ...
                    Commands->Send_Custom_Event(obj, sydney_zone, MTU_TYPE_SYDNEY_IS_RESET,
                                                MTU_PARAM_DEFAULT);
                }
            }
            break;
        ...
        case (MTU_TYPE_RANGE_CHECK_TARGETS): {
            ...
            if (gunner) {
                if (found_targets) {
                    Commands->Send_Custom_Event(obj, gunner, MTU_TYPE_GUNNER,
        ...
        case (MTU_TYPE_RANGE_SETUP_SNIPER_RIFLE): {
            ...
            GameObject* range_target_four_obj
                = Commands->Create_Object("POW_SniperRifle_Player", powerup_loc);
            if (range_target_four_obj) {
                range_target_four = 0;
        ...
        case (MTU_TYPE_RANGE_SETUP_AUTORIFLE): {
            ...
            GameObject* range_target_four_obj
                = Commands->Create_Object("POW_AutoRifle_Player", powerup_loc);
            if (range_target_four_obj) {
                range_target_four = 0;
                range_powerup = Commands->Get_ID(range_target_four_obj);
        ...
        case (MTU_TYPE_RANGE_SETUP_GRENADE): {
            GameObject* range_target_one_obj
                = Commands->Create_Object("Nod_Buggy", Vector3(-34.853f, 54.844f, 2.641f));
            if (range_target_one_obj) {
                range_target_one = Commands->Get_ID(range_target_one_obj);
            ...
            GameObject* range_target_two_obj
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(-30.224f, 47.9f, 3.232f));
            if (range_target_two_obj) {
                range_target_two = Commands->Get_ID(range_target_two_obj);
                Commands->Set_Facing(range_target_two_obj, 90.0f);
                Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
        ...
        case (MTU_TYPE_RANGE_SETUP_CHAINGUN): {
            ...
            GameObject* range_target_four_obj
                = Commands->Create_Object("POW_Chaingun_Player", powerup_loc);
            if (range_target_four_obj) {
                range_target_four = 0;
                range_powerup = Commands->Get_ID(range_target_four_obj);
        ...
        case (MTU_TYPE_RANGE_SETUP_FLAMETHROWER): {
            ...
            GameObject* range_target_four_obj
                = Commands->Create_Object("POW_Flamethrower_Player", powerup_loc);
            if (range_target_four_obj) {
                range_target_four = 0;
                range_powerup = Commands->Get_ID(range_target_four_obj);
        ...
        case (MTU_TYPE_RANGE_SETUP_C4): {
            ...
            GameObject* range_target_four_obj
                = Commands->Create_Object("POW_MineRemote_Player", powerup_loc);
            if (range_target_four_obj) {
                range_target_four = 0;
                range_powerup = Commands->Get_ID(range_target_four_obj);
        ...
        case (MTU_TYPE_RANGE_SETUP_ION): {
            GameObject* range_target_one_obj
                = Commands->Create_Object("Nod_Light_Tank", Vector3(-34.556f, 52.912f, 1.841f));
            if (range_target_one_obj) {
                range_target_one = Commands->Get_ID(range_target_one_obj);
                Commands->Set_Facing(range_target_one_obj, 90.0f);
                Commands->Attach_Script(range_target_one_obj, "MTU_Range_Target", "1");
        ...
        case (MTU_TYPE_WEAP_ATTEMPT_RESET): {
            ...
            if (hotwire_state == -1) {
                hotwire_state = 0;
                Commands->Send_Custom_Event(obj, obj, MTU_TYPE_WEAP_FACTORY_CLEANUP,
                                            MTU_PARAM_DEFAULT);
                Commands->Send_Custom_Event(obj, obj, MTU_TYPE_RESET_CHECKPOINT_COUNT,
                                            MTU_PARAM_DEFAULT);
                GameObject* logan = Commands->Find_Object(MTU_LOGAN);
                if (logan) {
                    Commands->Send_Custom_Event(obj, logan, MTU_TYPE_LOGAN,
        ...
        case (MTU_TYPE_HOTWIRE_START): {
            ...
            if (hotwire_state > -1) {
                ...
                case (0): {
                    ...
                    if (hotwire) {
                        Commands->Send_Custom_Event(obj, hotwire, MTU_TYPE_HOTWIRE,
                ...
                case (1): {
                    ...
                    if (hotwire) {
                        if (checkpoint_count > 3) {
                            ...
                            Commands->Send_Custom_Event(obj, obj, MTU_TYPE_WEAP_FACTORY_CLEANUP,
                                                        MTU_PARAM_DEFAULT);
                            Commands->Send_Custom_Event(obj, obj, MTU_TYPE_WEAP_CREATE_MEDTANK,
                                                        MTU_PARAM_DEFAULT);
                            GameObject* action_zone = Commands->Find_Object(MTU_ZONE_CHECKPOINT_01);
                            if (action_zone) {
                                Commands->Send_Custom_Event(obj, action_zone,
        ...
        case (MTU_TYPE_WEAP_CREATE_HUMMVEE): {
            GameObject* vehicle
                = Commands->Create_Object("GDI_Humm-vee_Player", Vector3(-10.5f, -34.2f, 10.192f));
            if (vehicle) {
        ...
        case (MTU_TYPE_WEAP_CREATE_MEDTANK): {
            GameObject* vehicle = Commands->Create_Object("GDI_Medium_Tank_Player",
                                                          Vector3(-10.5f, -34.2f, 12.192f));
            if (vehicle) {
                Commands->Set_Facing(vehicle, -90.0f);
        ...
        case (MTU_TYPE_WEAP_CREATE_SQUISHIES): {
            GameObject* squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(-27.336f, -11.719f, 1.101f));
            if (squish_target) {
            ...
            squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(-28.596f, 21.970f, 1.365f));
            if (squish_target) {
            ...
            squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(10.713f, 35.423f, 0.691f));
            if (squish_target) {
            ...
            squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(50.947f, 25.583f, 0.899f));
            if (squish_target) {
            ...
            squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(41.174f, -12.436f, 0.947f));
            if (squish_target) {
            ...
            squish_target
                = Commands->Create_Object("Nod_Minigunner_0", Vector3(7.102f, -49.075f, 1.026f));
            if (squish_target) {
        ...
        case (MTU_TYPE_MOBIUS_CHECK_RESET): {
            if (mobius_restart) {
                ...
                if (mobius) {
                    Commands->Send_Custom_Event(obj, mobius, MTU_TYPE_MOBIUS,
        ...
        case (MTU_TYPE_PETROVA_CHECK_RESET): {
            if (petrova_restart) {
                ...
                if (petrova) {
                    Commands->Send_Custom_Event(obj, petrova, MTU_TYPE_PETROVA,
        ...
        case (MTU_TYPE_ACTIVATE_FINALE): {
            ...
            if (instructor) {
                Commands->Send_Custom_Event(obj, instructor, MTU_TYPE_WEAP_FORCE_RESET,
                                            MTU_PARAM_DEFAULT);
            }
            instructor = Commands->Create_Object("GDI_Female_Lieutenant",
                                                 Vector3(-43.724f, 37.967f, 2.0f));
            if (instructor) {
        ...
        case (MTU_TYPE_LIEUTENANT_START): {
            ...
            if (lieutenant) {
                Commands->Send_Custom_Event(obj, lieutenant, MTU_TYPE_LIEUTENANT,
        ...
        case (MTU_TYPE_MOCK_INVASION): {
            ...
            if (soldier) {
                Commands->Send_Custom_Event(obj, soldier, MTU_TYPE_GDI_SOLDIER_PATROL,
                                            MTU_PARAM_DEFAULT);
            }
            ...
            GameObject* officer
                = Commands->Create_Object("Nod_Minigunner_1Off", Vector3(51.793f, 23.554f, 1.135f));
            if (officer) {
            ...
            officer
                = Commands->Create_Object("Nod_Minigunner_1Off", Vector3(52.793f, 24.554f, 2.135f));
            if (officer) {
                Commands->Set_Obj_Radar_Blip_Shape(officer, RADAR_BLIP_SHAPE_OBJECTIVE);
                Commands->Set_Obj_Radar_Blip_Color(officer, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
                Commands->Attach_Script(officer, "MTU_Nod_Soldier", "2");
...
// MTU_Tutorial_Instructor - This script is used for all instructors throughout the tutorial
// mission.
...
DECLARE_SCRIPT(MTU_Tutorial_Instructor, "")
{
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        ...
        case (MTU_TYPE_LOGAN): {
            ...
            case (MTU_PARAM_SPEECH_JUMP): // Logan is told to give results of sneaking and start
                                          // jump speech.
            {
            ...
            case (MTU_PARAM_SPEECH_COURSE_DONE): // Logan is told to move to the commando and finish
                                                 // the obstacle course.
            {
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_DISABLE);
            ...
            case (MTU_PARAM_ACTION_KEYCARD_TRAIN): // The commando has arrived at the AGT, lock
                                                   // control, give keycard speech.
            {
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_DISABLE);
        ...
        case (MTU_TYPE_GUNNER): {
            ...
            case (MTU_PARAM_CHECK_TARGETS): {
                ...
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_CHECK_TARGETS,
                                                MTU_PARAM_DEFAULT);
                }
                break;
            }
            case (MTU_PARAM_TARGETS_ELIMINATED): {
                ...
                case (1): {
                    Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR,
                ...
                case (2): {
                    ...
                    Commands->Create_Object("POW_SniperRifle_Player",
                                            Vector3(-17.298f, 73.106f, 1.042f));
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(
                            obj, controller, MTU_TYPE_RANGE_SETUP_SNIPER_RIFLE, MTU_PARAM_DEFAULT);
                    }
                    break;
                }
                case (3): {
                    Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0392I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Say_Something(obj, MTU_SPEECH_GUNNER_AUTORIFLE);
                    Commands->Give_PowerUp(STAR, "POW_AutoRifle_Player", true);
                    Commands->Create_Object("POW_AutoRifle_Player",
                                            Vector3(-17.298f, 73.106f, 1.042f));
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_SETUP_AUTORIFLE,
                                                    MTU_PARAM_DEFAULT);
                    }
                    break;
                }
                case (4): {
                    Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0393I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Say_Something(obj, MTU_SPEECH_GUNNER_ROCKET);
                    Commands->Give_PowerUp(STAR, "POW_RocketLauncher_Player", true);
                    Commands->Create_Object("POW_RocketLauncher_Player",
                                            Vector3(-17.298f, 73.106f, 1.042f));
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_SETUP_ROCKET,
                                                    MTU_PARAM_DEFAULT);
                    }
                    break;
                }
                case (5): {
                    ...
                    Commands->Create_Object("POW_MineRemote_Player",
                                            Vector3(-17.298f, 73.106f, 1.042f));
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_SETUP_C4,
                                                    MTU_PARAM_DEFAULT);
                    }
                    break;
                }
                case (6): {
                    Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0394I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    Say_Something(obj, MTU_SPEECH_GUNNER_ION);
                    Commands->Give_PowerUp(STAR, "POW_IonCannonBeacon_Player", true);
                    Commands->Create_Object("POW_IonCannonBeacon_Player",
                                            Vector3(-17.298f, 73.106f, 1.042f));
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_SETUP_ION,
                                                    MTU_PARAM_DEFAULT);
                    }
                    break;
                }
    ...
    void Timer_Expired(GameObject * obj, int timer_id)
    {
        ...
        case (MTU_TIMER_LOGAN_WAIT_POWER_02): {
            ...
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_ACTIVATE_FINALE,
                                            MTU_PARAM_DEFAULT);
            }
            break;
        }
            ...
            if (logan_wait_infantry) {
                if (Get_Obj_Distance(obj, STAR) < 4.0f) {
                    if (!check_wait_infantry) {
                        Commands->Set_HUD_Help_Text(IDS_M00DSGN_DSGN1003I1DSGN_TXT,
                                                    TEXT_COLOR_OBJECTIVE_PRIMARY);
                        Move_Somewhere(obj, MTU_MOVE_LOGAN_WEAPONS, MTU_ACTION_DEFAULT);
        ...
        case (MTU_TIMER_ANOTHER_APACHE): {
            GameObject* apache
                = Commands->Create_Object("NOD_Apache", Vector3(-52.440f, 33.644f, -7.825f));
            if (apache) {
    ...
    void Say_Something(GameObject * obj, int speech_id)
    {
        ...
        case (MTU_SPEECH_SYDNEY_START): {
            Commands->Set_HUD_Help_Text(IDS_M00DSGN_DSGN1006I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
        ...
        case (MTU_SPEECH_GUNNER_ION): {
            Commands->Add_Radar_Marker(MTU_RADAR_GUNNER, Vector3(-34.91f, 61.62f, 2.60f),
        ...
        case (MTU_SPEECH_HOTWIRE_INTRO): {
            ...
            Commands->Add_Radar_Marker(MTU_RADAR_COURSE_01, Vector3(-32.12f, -48.05f, 1.37f),
                                       RADAR_BLIP_SHAPE_OBJECTIVE,
                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
            Commands->Add_Radar_Marker(MTU_RADAR_COURSE_02, Vector3(-26.36f, 34.21f, 2.0f),
                                       RADAR_BLIP_SHAPE_OBJECTIVE,
                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
            Commands->Add_Radar_Marker(MTU_RADAR_COURSE_03, Vector3(47.16f, 39.18f, 1.51f),
                                       RADAR_BLIP_SHAPE_OBJECTIVE,
                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
            Commands->Add_Radar_Marker(MTU_RADAR_COURSE_04, Vector3(30.77f, -26.61f, 2.75f),
                                       RADAR_BLIP_SHAPE_OBJECTIVE,
                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
        ...
        case (MTU_SPEECH_HOTWIRE_MEDTANK): {
            Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0395I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
            Commands->Add_Radar_Marker(MTU_RADAR_COURSE_01, Vector3(-32.12f, -48.05f, 1.37f),
                                       RADAR_BLIP_SHAPE_OBJECTIVE,
                                       RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
    ...
    void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason)
    {
        if ((complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED)
            ...
            {
                Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0515I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                GameObject* course_gate = Commands->Find_Object(MTU_GATE_01);
                if (course_gate) {
            ...
            case (MTU_SPEECH_LOGAN_CROUCH): // Logan finished introducing crouch and sneak. Turn on
                                            // commando and start test.
            {
            ...
            case (MTU_SPEECH_LOGAN_CROUCH_TEST): {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0382I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                break;
            }
            case (MTU_SPEECH_LOGAN_SNEAK_LOSE):
            case (MTU_SPEECH_LOGAN_SNEAK_WIN): // Logan gave results of sneak test, move to jump
                                               // test location.
            {
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_DISABLE);
                Move_Somewhere(obj, MTU_MOVE_LOGAN_JUMP_TRAINING, MTU_ACTION_LOGAN_JUMP_TEST);
            ...
            case (MTU_SPEECH_LOGAN_JUMP_TEST): // Logan finished giving jump test introduction,
                                               // enable commando and move to next spot.
            {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0383I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
            ...
            case (MTU_SPEECH_LOGAN_EVA): // Logan finished introducing EVA, turn on first objective
                                         // radar location.
            {
                ...
                Commands->Set_Objective_Radar_Blip(MTU_OBJECTIVE_01,
                                                   Vector3(-12.39f, 20.78f, 1.81f));
                Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_01, 99, "POG_M00_1_01.tga",
                                                          IDS_POG_LOCATE,
                                                          Vector3(-12.39f, 20.78f, 1.81f));
                Say_Something(obj, MTU_SPEECH_LOGAN_POKE);
                break;
            }
            case (MTU_SPEECH_LOGAN_POKE): // Logan finished explaining poke command, enable commando
                                          // control.
            {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0385I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Select_Weapon(STAR, "Weapon_Pistol_Player");
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                break;
            }
            case (MTU_SPEECH_LOGAN_COURSE_DONE): // Logan finished telling the commando about the
                                                 // course. Move to the AGT.
            {
                Commands->Set_HUD_Help_Text(IDS_M00DSGN_DSGN1003I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
            ...
            case (MTU_SPEECH_LOGAN_KEYCARDS): // Logan finished introducing keycards, give the
                                              // commando a green one and continue.
            {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0386I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (MTU_SPEECH_LOGAN_WHATSNEXT): // Logan gave the Whats Next dialog.
            {
                ...
                Commands->Set_Objective_Radar_Blip(MTU_OBJECTIVE_04,
                                                   Vector3(24.40f, 11.86f, 2.60f));
                Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_04, 99, "POG_M00_1_04.tga",
                                                          IDS_POG_LOCATE,
                                                          Vector3(24.40f, 11.86f, 2.60f));
                Move_Somewhere(obj, MTU_MOVE_LOGAN_REFINERY, MTU_ACTION_DEFAULT);
                break;
            ...
            case (MTU_SPEECH_LOGAN_PREPARE_POWER): // Logan is moving toward the power plant
            {
                ...
                Commands->Set_Objective_Radar_Blip(MTU_OBJECTIVE_05,
                                                   Vector3(-42.46f, 19.45f, 3.79f));
                Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_05, 99, "POG_M00_1_05.tga",
                                                          IDS_POG_LOCATE,
                                                          Vector3(-42.46f, 19.45f, 3.79f));
                Move_Somewhere(obj, MTU_MOVE_LOGAN_POWER, MTU_ACTION_DEFAULT);
                break;
            ...
            case (MTU_SPEECH_SYDNEY_HEALTH): // Sydney finished explaining about health loss. Create
                                             // a health powerup.
            {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0387I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                GameObject* health_pow = Commands->Create_Object(
                    "POW_Health_100", Vector3(-11.975f, 23.808f, -9.498f));
                if (health_pow) {
                    int pow_id = Commands->Get_ID(health_pow);
                    Commands->Attach_Script(health_pow, "MTU_PowerUp_Health", "");
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_HEALTH_POWERUP_ADD,
                                                    pow_id);
                    }
            ...
            case (MTU_SPEECH_SYDNEY_ARMOR): {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0388I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                GameObject* armor_pow
                    = Commands->Create_Object("POW_Armor_100", Vector3(-11.853f, 25.720f, -9.498f));
                if (armor_pow) {
                    int pow_id = Commands->Get_ID(armor_pow);
                    Commands->Attach_Script(armor_pow, "MTU_PowerUp_Armor", "");
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_ARMOR_POWERUP_ADD,
                                                    pow_id);
                    }
                    Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                }
            ...
            case (MTU_SPEECH_SYDNEY_RADAR): {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0389I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                Commands->Set_Objective_Status(MTU_OBJECTIVE_02, OBJECTIVE_STATUS_PENDING);
                Commands->Set_Objective_Radar_Blip(MTU_OBJECTIVE_02,
                                                   Vector3(-16.216f, 72.693f, 1.042f));
                Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_02, 99, "POG_M00_1_02.tga",
                                                          IDS_POG_LOCATE,
                                                          Vector3(-16.216f, 72.693f, 1.042f));
                GameObject* logan = Commands->Find_Object(MTU_LOGAN);
                if (logan) {
            ...
            case (MTU_SPEECH_GUNNER_START): {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0390I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_SETUP_HANDGUN,
                                                MTU_PARAM_DEFAULT);
                }
                break;
            }
            case (MTU_SPEECH_GUNNER_ENDING): {
                ...
                Commands->Set_Objective_Radar_Blip(MTU_OBJECTIVE_03,
                                                   Vector3(-0.687f, -18.630f, 0.100f));
                Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_03, 99, "POG_M00_1_03.tga",
                                                          IDS_POG_LOCATE,
                                                          Vector3(-0.687f, -18.630f, 0.100f));
                break;
            }
            ...
            case (MTU_SPEECH_HOTWIRE_INTRO): {
                ...
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_CREATE_HUMMVEE,
                                                MTU_PARAM_DEFAULT);
                }
            ...
            case (MTU_SPEECH_HOTWIRE_GO_OUT): {
                ...
                if (action_zone) {
                    Commands->Send_Custom_Event(obj, action_zone, MTU_TYPE_RESET_TRIGGER_ONCE,
                                                MTU_PARAM_DEFAULT);
                }
                ...
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RESET_CHECKPOINT_COUNT,
                                                MTU_PARAM_DEFAULT);
                }
                break;
            }
            ...
            case (MTU_SPEECH_PETROVA_POWER): {
                ...
                if (powerplant) {
                    Commands->Send_Custom_Event(obj, powerplant, MTU_TYPE_BUILDING_POWER_OFF,
                                                MTU_PARAM_DEFAULT);
                }
            ...
            case (MTU_SPEECH_PETROVA_POWER_END): {
                ...
                GameObject* powerplant = Commands->Find_Object(MTU_POWERPLANT);
                if (powerplant) {
                    Commands->Send_Custom_Event(obj, powerplant, MTU_TYPE_BUILDING_POWER_ON,
                                                MTU_PARAM_DEFAULT);
                }
                break;
            }
            ...
            case (MTU_SPEECH_LIEUTENANT_START): {
                ...
                GameObject* chinook_obj1 = Commands->Create_Object(
                    "Invisible_Object", Vector3(-16.836f, 36.188f, 1.341f));
                if (chinook_obj1) {
            ...
            case (MTU_SPEECH_LIEUTENANT_LETIN): {
                ...
                GameObject* engineer = Commands->Create_Object("GDI_Engineer_0",
                                                               Vector3(-24.003f, 56.286f, -8.596f));
                if (engineer) {
            ...
            case (MTU_SPEECH_LIEUTENANT_MCT): {
                ...
                if (barracks) {
                    Commands->Send_Custom_Event(obj, barracks, MTU_TYPE_BUILDING_DESTROY,
                                                MTU_PARAM_DEFAULT);
                }
                Commands->Send_Custom_Event(obj, STAR, MTU_TYPE_STAR, MTU_PARAM_CONTROL_ENABLE);
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_MOCK_INVASION,
                                                MTU_PARAM_DEFAULT);
                }
            ...
            case (MTU_SPEECH_LIEUTENANT_AFTER): {
                Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0398I1DSGN_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
                Commands->Set_Objective_Status(MTU_OBJECTIVE_06, OBJECTIVE_STATUS_PENDING);
                Commands->Set_Objective_HUD_Info(MTU_OBJECTIVE_06, 99, "POG_M00_1_06.tga",
                                                 IDS_POG_ELIMINATE);
                ActionParamsStruct params;
            ...
            switch (action_id) {
            case (MTU_ACTION_LOGAN_JUMP_TEST): // Logan finished moving to jump test location, give
                                               // speech.
            {
            ...
            case (MTU_ACTION_LOGAN_COURSE_DONE): // Logan reached the commando outside the course.
            ...
            case (MTU_ACTION_MOVE_LOGAN_EXIT): {
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_LIEUTENANT_START,
                                                MTU_PARAM_DEFAULT);
                }
...
DECLARE_SCRIPT(MTU_Trigger_Zone, "")
{
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        ...
        case (MTU_ZONE_JUMP_HUD_INFO): {
            Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0384I1DSGN_TXT,
                                        TEXT_COLOR_OBJECTIVE_PRIMARY);
            destroy_zone = true;
            break;
        }
        ...
        case (MTU_ZONE_RESET_SYDNEY): {
            if (!gave_elevator_help) {
                ...
                Commands->Set_HUD_Help_Text(IDS_M00DSGN_DSGN1013I1EVAG_TXT,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            }
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_REMOVE_OBJECTIVES,
                                            MTU_PARAM_DEFAULT);
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_ALL_POWERUPS_RESET,
                                            MTU_PARAM_DEFAULT);
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_SYDNEY_RESET,
                                            MTU_PARAM_DEFAULT);
            }
            GameObject* logan = Commands->Find_Object(MTU_LOGAN);
            if (logan) {
        ...
        case (MTU_ZONE_START_SYDNEY): {
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_SYDNEY_CHECK_RESET,
                                            MTU_PARAM_DEFAULT);
            }
            break;
        }
        ...
        case (MTU_ZONE_RESET_GUNNER): {
            ...
            if (green_key) {
                ...
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_REMOVE_OBJECTIVES,
                                                MTU_PARAM_DEFAULT);
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RANGE_CLEANUP_TARGETS,
                                                MTU_PARAM_DEFAULT);
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_FORCE_RESET,
                                                MTU_PARAM_DEFAULT);
                }
                GameObject* logan = Commands->Find_Object(MTU_LOGAN);
                if (logan) {
        ...
        case (MTU_ZONE_RESET_HOTWIRE_01): {
            ...
            if (green_key) {
                ...
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_REMOVE_OBJECTIVES,
                                                MTU_PARAM_DEFAULT);
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_ATTEMPT_RESET,
                                                MTU_PARAM_DEFAULT);
                }
            }
            break;
        ...
        case (MTU_ZONE_START_HOTWIRE): {
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_HOTWIRE_START,
                                            MTU_PARAM_DEFAULT);
            }
            break;
        }
        ...
        case (MTU_ZONE_CHECKPOINT_01): {
            if (!trigger_once) {
                ...
                GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                if (controller) {
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_ADD_CHECKPOINT,
                                                MTU_PARAM_DEFAULT);
                }
            }
            break;
        ...
        case (MTU_ZONE_RESET_IGNATIO): {
            ...
            if (green_key) {
                ...
                if (controller) {
                    ...
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_FORCE_RESET,
                                                MTU_PARAM_DEFAULT);
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_MOBIUS_RESET,
                                                MTU_PARAM_DEFAULT);
                }
                GameObject* logan = Commands->Find_Object(MTU_LOGAN);
                if (logan) {
        ...
        case (MTU_ZONE_START_IGNATIO): {
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_MOBIUS_CHECK_RESET,
                                            MTU_PARAM_DEFAULT);
            }
            GameObject* logan = Commands->Find_Object(MTU_LOGAN);
            if (logan) {
        ...
        case (MTU_ZONE_RESET_PETROVA): {
            ...
            if (green_key) {
                ...
                if (controller) {
                    ...
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_FORCE_RESET,
                                                MTU_PARAM_DEFAULT);
                    Commands->Send_Custom_Event(obj, controller, MTU_TYPE_RESET_PETROVA,
                                                MTU_PARAM_DEFAULT);
                }
                GameObject* logan = Commands->Find_Object(MTU_LOGAN);
                if (logan) {
        ...
        case (MTU_ZONE_START_PETROVA): {
            GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
            if (controller) {
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_PETROVA_CHECK_RESET,
                                            MTU_PARAM_DEFAULT);
            }
            GameObject* logan = Commands->Find_Object(MTU_LOGAN);
            if (logan) {
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == MTU_TYPE_SYDNEY_IS_RESET) {
            ...
            if (sydney) {
                Commands->Send_Custom_Event(obj, sydney, MTU_TYPE_SYDNEY,
...
DECLARE_SCRIPT(MTU_Range_Target, "Target_ID:int") { void Created(GameObject * obj) {
    ...
    void Killed(GameObject * obj, GameObject * killer)
    {
        ...
        if ((controller) && (killer != hotwire_obj)) {
            ...
            if (my_id == 1) {
                ...
                Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_CREATE_MEDTANK,
                                            MTU_PARAM_DEFAULT);
            }
        }
    }
    ...
    void Custom(GameObject * obj, int type, int param, GameObject* sender)
    {
        if (type == CUSTOM_EVENT_VEHICLE_ENTERED) {
            if (!entered_me) {
                ...
                switch (my_id) {
                case (1): {
                    Commands->Set_HUD_Help_Text(IDS_MTUDSGN_DSGN0396I1DSGN_TXT,
                                                TEXT_COLOR_OBJECTIVE_PRIMARY);
                    GameObject* hotwire = Commands->Find_Object(MTU_HOTWIRE);
                    if (hotwire) {
                        Commands->Send_Custom_Event(obj, hotwire, MTU_TYPE_HOTWIRE,
                ...
                case (2): {
                    ...
                    GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
                    if (controller) {
                        Commands->Send_Custom_Event(obj, controller, MTU_TYPE_WEAP_CREATE_SQUISHIES,
                                                    MTU_PARAM_DEFAULT);
                    }
...
DECLARE_SCRIPT(MTU_Nod_Soldier, "Soldier_ID:int") {
    void Created(GameObject * obj) { Commands->Grant_Key(obj, 1, true);
...
void Killed(GameObject* obj, GameObject* killer)
{
    ...
    if (!soldier_id) {
        GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
        if (controller) {
            Commands->Send_Custom_Event(obj, controller, MTU_TYPE_TRIGGER_SPAWNER,
                                        MTU_PARAM_DEFAULT);
        }
    }
        ...
        GameObject* controller = Commands->Find_Object(MTU_CONTROLLER);
        if (controller) {
            Commands->Send_Custom_Event(obj, controller, MTU_TYPE_COUNT_OFFICERS,
                                        MTU_PARAM_DEFAULT);
        }
    }
}
    ...
    void Entered(GameObject * obj, GameObject * enterer)
    {
        if (!was_entered) {
            ...
            case (300205): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_PowerPlant_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300206): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_TiberiumRefinery_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300207): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_InfantryBarracks_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300208): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_WeaponsFactory_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300209): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_AdvancedGuardTower_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300219): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_GDI_MCT_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300223): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_Nod_HandOfNod_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300224): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_Nod_Airstrip_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
            ...
            case (300225): {
                ...
                Commands->Set_HUD_Help_Text(IDS_Enc_Struct_Nod_Obelisk_Name,
                                            TEXT_COLOR_OBJECTIVE_PRIMARY);
