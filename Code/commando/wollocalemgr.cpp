...
static const int LOC_STRING_ARRAY[] = {
    IDS_LOCALE_UNKNOWN,     IDS_LOCALE_OTHER,     IDS_LOCALE_USA,          IDS_LOCALE_CANADA,
    IDS_LOCALE_UK,          IDS_LOCALE_GERMANY,   IDS_LOCALE_FRANCE,       IDS_LOCALE_SPAIN,
    IDS_LOCALE_NETHERLANDS, IDS_LOCALE_BELGIUM,   IDS_LOCALE_AUSTRIA,      IDS_LOCALE_SWITZERLAND,
    IDS_LOCALE_ITALY,       IDS_LOCALE_DENMARK,   IDS_LOCALE_SWEDEN,       IDS_LOCALE_NORWAY,
    IDS_LOCALE_FINLAND,     IDS_LOCALE_ISRAEL,    IDS_LOCALE_SOUTH_AFRICA, IDS_LOCALE_JAPAN,
    IDS_LOCALE_SOUTH_KOREA, IDS_LOCALE_CHINA,     IDS_LOCALE_SINGAPORE,    IDS_LOCALE_TAIWAN,
    IDS_LOCALE_MALAYSIA,    IDS_LOCALE_AUSTRALIA, IDS_LOCALE_NEW_ZEALAND,  IDS_LOCALE_BRAZIL,
    IDS_LOCALE_THAILAND,    IDS_LOCALE_ARGENTINA, IDS_LOCALE_PHILIPPINES,  IDS_LOCALE_GREECE,
    IDS_LOCALE_IRELAND,     IDS_LOCALE_POLAND,    IDS_LOCALE_PORTUGAL,     IDS_LOCALE_MEXICO,
    IDS_LOCALE_RUSSIA,      IDS_LOCALE_TURKEY
};
