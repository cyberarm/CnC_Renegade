...
//	Registry key names
////////////////////////////////////////////////////////////////////////////////////////////////
// static const char *QUICKMATCH_SUB_KEY	= APPLICATION_SUB_KEY_NAME_WOLSETTINGS
// "\\QuickMatch";
...
void MPSettingsMgrClass::Load_Settings(void)
{
    ...
    if (registry.Is_Valid()) {
        ...
        //
        registry.Get_String(REG_VALUE_LAST_LOGIN, LastLogin.Get_Buffer(MAX_PERSONA_LEN),
                            MAX_PERSONA_LEN, "");
        registry.Get_String(REG_VALUE_AUTOLOGIN, AutoLogin.Get_Buffer(MAX_PERSONA_LEN),
                            MAX_PERSONA_LEN, "");
        registry.Get_String(REG_VALUE_AUTOPASSWORD, AutoPassword.Get_Buffer(MAX_PERSONA_LEN),
                            MAX_PERSONA_LEN, "");
...
//
////////////////////////////////////////////////////////////////
const char* MPSettingsMgrClass::Get_Last_Login(void)
{
...
//
////////////////////////////////////////////////////////////////
const char* MPSettingsMgrClass::Get_Auto_Login(void)
{
...
//
////////////////////////////////////////////////////////////////
const char* MPSettingsMgrClass::Get_Auto_Password(void)
{
    ...
    if (AreSkinsUnlocked == false) {
        ...
        if (wol_session.IsValid()) {
            ...
            if (AreSkinsUnlocked == false) {
                ...
                //
                //	First, build a time structure representing when the skins are unlocked for
                //everybody
                //
