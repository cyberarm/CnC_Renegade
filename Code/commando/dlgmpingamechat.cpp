...
void MPChatChildDialogClass::Send_Message(WideStringClass& message, TextMessageEnum type,
                                          int recipientID)
{
    //
    //	Send the message
                    ...
                    if (user_name.Get_Length() > 0) {
                        ...
                        if (recipient) {
                            ...
                            WolGameModeClass* wolGame
                                = reinterpret_cast<WolGameModeClass*>(gameMode);
...
//
//////////////////////////////////////////////////////////////////////
void MPChatChildDialogClass::Complete_Player_Name(const WCHAR* typed_name,
                                                  WideStringClass& completed_name)
{
...
//
//////////////////////////////////////////////////////////////////////
bool MPChatChildDialogClass::Find_Current_Command(const WCHAR* message, int& start_index,
                                                  int& end_index)
{
    EditCtrlClass* edit_ctrl = (EditCtrlClass*)Get_Dlg_Item(IDC_MESSAGE_EDIT);
    if (edit_ctrl == nullptr) {
...
//
//////////////////////////////////////////////////////////////////////
bool MPChatChildDialogClass::On_EditCtrl_Key_Down(EditCtrlClass* edit_ctrl, uint32 key_id,
                                                  uint32 key_data)
{
    bool retval = false;
    TestForAutoCompletion = false;
