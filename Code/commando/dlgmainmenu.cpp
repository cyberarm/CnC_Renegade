...
void MainMenuDialogClass::On_Command(int ctrl_id, int message_id, DWORD param)
{
    ...
    case IDC_MENU_MP_LAN_GAME_BUTTON:
        ...
        if (cNicEnum::Get_Num_Nics() > 0) {
            ...
            DlgMsgBox::DoDialog(TRANSLATE(IDS_MP_UNABLE_INITIALIZE_LAN),
...
void MainMenuDialogClass::Update_Version_Number(void)
{
    ...
    version_string.Format(L"v%d.%.3d %s-%s %s", (version_major >> 16), (version_major & 0xFFFF),
                          build_initials, build_number, build_date);
