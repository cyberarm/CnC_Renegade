...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DSAPO_RESET - force all DSAPO's back to their initial state.";
    }
    virtual void Activate(const char* input)
    {
        ...
        if (COMBAT_SCENE) {
            ...
            for (it.First(); !it.Is_Done(); it.Next()) {
                ...
                if (it.Peek_Obj()->Get_Factory().Chunk_ID()
...
public:
    ...
    virtual void Activate(const char* input)
    {
        ...
        if (!stricmp("*", string)) {
            ...
            unsigned id[10];
            unsigned count = sscanf(input, "%d %d %d %d %d %d %d %d %d %d", &id[0], &id[1], &id[2],
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "FLASH_TEXTURE <ID> <0/1> - sets texture flashing";
    }
    virtual void Activate(const char* input)
    {
#ifdef WW3D_DX8
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "FOG_RANGE <start [0+]> <end [0+]> [ramptime [0+]] - Sets fog range.";
    }
    virtual void Activate(const char* input)
    {
...
class LightModeConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "LIGHT_MODE <0,1,2> - 0=none, 1=surrender, 2=cheap.";
    }
    virtual void Activate(const char* input)
    {
        int mode;
...
class LightDebugToggleConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "LIGHT_DEBUG - toggles lighting debugging on/off.";
    }
    virtual void Activate(const char* input)
    {
        COMBAT_SCENE->Enable_Lighting_Debug_Display(
...
class LightLODConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "LIGHT_LOD <intensity> - sets the LOD cutoff for lighting.";
    }
    virtual void Activate(const char* input)
    {
        float inten;
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "LIGHT_CALC - computes a static vertex lighting solve";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_SCENE) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "CAMERA <NAME> - switches to camera profile <name>.";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_CAMERA) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIS_GRID_DISPLAY <0,1,2,3> - 0=off, 1=boxes, 2=centers, 3=occupied.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIS_HIERARCHICAL - toggles hierarchical vis culling.";
    }
    virtual void Activate(const char* input)
    {

        PhysAABTreeCullClass::Enable_Hierarchical_Vis_Culling(
            !PhysAABTreeCullClass::Is_Hierarchical_Vis_Culling_Enabled());
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIS_LOCK_SAMPLE_POINT - locks/unlocks the current pvs.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIS_SECTOR_DISPLAY - toggles diplay of the current vis sector.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIS_SECTOR_HISTORY - toggles diplay of the previous 3 vis sectors.";
    }
    virtual void Activate(const char* input)
    {

        COMBAT_SCENE->Enable_Vis_Sector_History_Display(
            !COMBAT_SCENE->Is_Vis_Sector_History_Display_Enabled());
...
class ShadowPerPolyCullingConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "SHADOW_PER_POLY_CULLING - toggles per poly shadow culling.";
    }
    virtual void Activate(const char* input)
    {
        MaterialPassClass::Enable_Per_Polygon_Culling(
...
class ShadowResolutionConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "SHADOW_RESOLUTION <res> - sets the resolution of dynamic shadows (use a power of "
               "2!)";
    }
    virtual void Activate(const char* input)
    {
...
class ShadowCountConsoleFunctionClass : public ConsoleFunctionClass
{
    ...
    virtual const char* Get_Help(void)
    {
        return "SHADOW_COUNT <count> - sets the maximum simultaneous shadows";
    }
    virtual void Activate(const char* input)
    {
        PhysicsSceneClass* scene = PhysicsSceneClass::Get_Instance();
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PHYSICS_DEBUG - toggles physics debugging display.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PHYS3_NET <allowable_error> <pop_error> <corr_time> - sets the phys3 networking "
               "constants.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "rbody_net <corr_time> - sets the rigid body correction time.";
    }
    virtual void Activate(const char* input)
    {
        float corr_time;
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PROJECTOR_DEBUG - toggles projector debugging display.";
    }
    virtual void Activate(const char* input)
    {

        COMBAT_SCENE->Enable_Projector_Debug_Display(
            !COMBAT_SCENE->Is_Projector_Debug_Display_Enabled());
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DIRTY_CULL_DEBUG - toggles debugging of the dirty-cull-list.";
    }
    virtual void Activate(const char* input)
    {

        COMBAT_SCENE->Enable_Dirty_Cull_Debug_Display(
            !COMBAT_SCENE->Is_Dirty_Cull_Debug_Display_Enabled());
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "NEXT_RENDER - switches to the next render device.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "ONE_SHOT_KILLS - kill or destroy with one shot. Server only.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "OPEN [regedit|logfile|ini ininame] - open specified object.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "INVALIDATE_MESH_CACHE - invalidates all cached mesh data.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "EXPOSE_PRELIT - expose precalculated lighting on meshes.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PLAYER_POSITION - toggles the players world position display.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TOGGLE_RENDERING <static,dynamic,human,vehicles> - toggles rendering of various "
               "types.";
    }
    virtual void Activate(const char* input)
    {
        ...
        /*
        ** Note: I'm only comparing the first two characters so the user doesn't have to type the
        *whole thing
        */
        if (_strnicmp(input, "st", 2) == 0) {
            ...
            Print(DynamicPhysClass::Is_All_Rendering_Disabled()
                      ? "Dynamic object rendering DISABLED"
            ...
            Print(VehiclePhysClass::Is_All_Rendering_Disabled()
                      ? "Vehicle object rendering DISABLED"
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TOGGLE_SIMULATION <static,dynamic,human,vehicles> - toggles rendering of various "
               "types.";
    }
    virtual void Activate(const char* input)
    {
        ...
        */
        if (_strnicmp(input, "st", 2) == 0) {
            ...
            Print(StaticPhysClass::Is_All_Simulation_Disabled()
                      ? "Static object Simulation DISABLED"
                      : "Static object Simulation ENABLED");
        }
        else if (_strnicmp(input, "dy", 2) == 0) {

            DynamicPhysClass::Disable_All_Simulation(
                !DynamicPhysClass::Is_All_Simulation_Disabled());
            Print(DynamicPhysClass::Is_All_Simulation_Disabled()
                      ? "Dynamic object Simulation DISABLED"
            ...
            VehiclePhysClass::Disable_All_Simulation(
                !VehiclePhysClass::Is_All_Simulation_Disabled());
            Print(VehiclePhysClass::Is_All_Simulation_Disabled()
                      ? "Vehicle object Simulation DISABLED"
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TOM - Annoyance-reduction registry tweaks customized by Tom.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "RENDER_BOXES <mask> - enables rendering of boxes.  0=none 1=all 2=physical "
               "4=projectile.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "OBJECTIVES_DEBUG - toggles Mission Objectives debug mode.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "FREE_WEAPONS - toggle free_weapons flag (server only).";
    }
    virtual void Activate(const char* input)
    {
        if (!cNetwork::I_Am_Server()) {
            ...
            if (on) {
                ...
                for (objnode = GameObjManager::Get_Smart_Game_Obj_List()->Head(); objnode;
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "toggle_ghost_debug_display - Displays a box around soldiers that are in 'ghost' "
               "collision mode.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    // <rank>[enlisted|officer|special_forces|boss] ] - Purchases a team vehicle, a player powerup
    // or upgrades the player."; }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "CnC - Displays CnC player console (for gods only).";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "reveal_encyclopedia - Shows all entries in the encyclopedia.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "CHANGE_CHARACTER_CLASS <preset_name> - changes your character to the specified "
               "class.";
    }
    virtual void Activate(const char* input)
    {
        ...
        DefinitionClass* definition
            = DefinitionMgrClass::Find_Typed_Definition(input, CLASSID_GAME_OBJECT_DEF_SOLDIER);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "RENDER_MODE_EXTRA_PASS [0 disable | 1 lines | 2 zbuffered]";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_SCENE != nullptr) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "ENABLE_TRIANGLE_RENDER [none|opaque|sorting|all] - enable/disable triangle "
               "rendering.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "RENDER_BACKFACES - toggles debug rendering of backfaced polys.";
    }
    virtual void Activate(const char* input)
    {
        /*
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "AMMO <count> - sets the players weapon's ammo count.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SCRIPT_TRACE - toggles debug trace of all scipt events and commands.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DEBUG_TYPE [type|on|off] - toggles the debug display of type (info, warning, "
               "error, script)";
    }
    virtual void Activate(const char* input)
    {
        ...
        if (stricmp(input, "info") == 0) {
            ...
            sprintf(str, "Information Debug %s\n",
                    DebugManager::Is_Type_Enabled(DebugManager::DEBUG_TYPE_INFORMATION)
                        ? "Enabled"
                        : "Disabled");
        }
            ...
            sprintf(str, "Network Admin Debug %s\n",
                    DebugManager::Is_Type_Enabled(DebugManager::DEBUG_TYPE_NETWORK_ADMIN)
                        ? "Enabled"
                        : "Disabled");
        }
            ...
            sprintf(str, "Network Basic Debug %s\n",
                    DebugManager::Is_Type_Enabled(DebugManager::DEBUG_TYPE_NETWORK_BASIC)
                        ? "Enabled"
                        : "Disabled");
        }
            ...
            sprintf(str, "Network Prolific Debug %s\n",
                    DebugManager::Is_Type_Enabled(DebugManager::DEBUG_TYPE_NETWORK_PROLIFIC)
                        ? "Enabled"
                        : "Disabled");
        }
...
public:
        ...
        virtual	const char * Get_Help( void )	{ return "RADAR_ZOOM <factor> - Set radar zoom
factor."; } virtual	void Activate( const char * input ) { float zoom_factor = atof(input); if
(zoom_factor > WWMATH_EPSILON) {
...
public:
        ...
        virtual	const char * Get_Help( void )	{ return "RADAR_MAX - zoom out the radar to world
extents."; } virtual	void Activate( const char * input ) { float world_size =
The_Game()->Get_Maximum_World_Distance(); if (world_size > WWMATH_EPSILON) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DEFECT - switch to the opposite team (gods only).";
    }
    virtual void Activate(const char* input)
    {
...
public:
        ...
        virtual	const char * Get_Help( void )	{ return "RSH - Remote SHell command (server
only)."; } virtual	void Activate( const char * input ) { if (IS_SOLOPLAY ||
!cNetwork::I_Am_Server()) { Print("rsh is for server only.\n"); } else { Print("Sending command to
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "LRSH - Local and Remote SHell command (server only).";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "MAX_FACING_PENALTY - set the max facing penalty. Server only. Float. Use zero to "
               "disable.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "IRRELEVANCE_PENALTY - set the irrelevance penalty. Server only. Float. Use zero to "
               "disable.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "MISSION <success/failure> end mission with given status.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TOGGLE_SBBO - toggle cSbboManager (server only).";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "send_freqency <delay> - set delay between packet sends.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "packet_opt <state> - enable low level packet optimizations.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "latency <low,high> - set simulated latency on packets.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "bw_balance - toggle bandwidth balancer code enable.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_DESIRED_SLEEP <sleep_ms> - sleep this many ms per frame.";
    }
    virtual void Activate(const char* input)
    {
        WWASSERT(input != nullptr);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_PACKET_DUPLICATION <percentage> - simulate packet duplication at given "
               "percentage";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual void Activate(const char* input)
    {
        ...
        if (cMiscUtil::Is_String_Same(input, "isc")) {
            ...
            Print("     packet_simulation - turns off packet simulation (loss, duplication, "
                  "latency)\n");
        }
        else {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "CLIENT_HINT_FACTOR - set the client hint factor (worst:average). Client only. "
               "Float. Use zero to disable.";
    }
    virtual void Activate(const char* input)
    {
        WWASSERT(input != nullptr);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "BREAK - break execution. Do not use this just for fun.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "CRASH - crash execution. Do not use this just for fun.";
    }
    virtual void Activate(const char* input)
    {
        Print("Bang....\n");
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "GIVE_WEAPONS - give the commando all the weapons (single-player only)";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "IBELIEVEINGOD - toggle philosophical standpoint on this issue.\n";
    }
    ...
    virtual void Activate(const char* input)
    {
        ...
        if (believe) {
            ...
            if (cNetwork::I_Am_Server()) {
                ...
                //
                for (SLNode<cPlayer>* player_node
                     = cPlayerManager::Get_Player_Object_List()->Head();
                     player_node; player_node = player_node->Next()) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "WATCH <object> - show debug output of specified type.";
    }
    ...
    virtual void Activate(const char* input)
    {
        ...
        else if (cMiscUtil::Is_String_Same(input, "PacketsSentServer")
                 || cMiscUtil::Is_String_Same(input, "pss")) {
            cDevOptions::PacketsSentServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "PacketsSentClient")
                 || cMiscUtil::Is_String_Same(input, "psc")) {
            cDevOptions::PacketsSentClient.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "PacketsRecdServer")
                 || cMiscUtil::Is_String_Same(input, "prs")) {
            cDevOptions::PacketsRecdServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "PacketsRecdClient")
                 || cMiscUtil::Is_String_Same(input, "prc")) {
        ...
        else if (cMiscUtil::Is_String_Same(input, "BytesSentServer")
                 || cMiscUtil::Is_String_Same(input, "bss")) {
            cDevOptions::BytesSentServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "BytesSentClient")
                 || cMiscUtil::Is_String_Same(input, "bsc")) {
            cDevOptions::BytesSentClient.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "BytesRecdServer")
                 || cMiscUtil::Is_String_Same(input, "brs")) {
            cDevOptions::BytesRecdServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "BytesRecdClient")
                 || cMiscUtil::Is_String_Same(input, "brc")) {
            cDevOptions::BytesRecdClient.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetPacketsSentServer")
                 || cMiscUtil::Is_String_Same(input, "wpss")) {
            cDevOptions::WwnetPacketsSentServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetPacketsSentClient")
                 || cMiscUtil::Is_String_Same(input, "wpsc")) {
            cDevOptions::WwnetPacketsSentClient.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetPacketsRecdServer")
                 || cMiscUtil::Is_String_Same(input, "wprs")) {
            cDevOptions::WwnetPacketsRecdServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetPacketsRecdClient")
                 || cMiscUtil::Is_String_Same(input, "wprc")) {
        ...
        else if (cMiscUtil::Is_String_Same(input, "WwnetBytesSentServer")
                 || cMiscUtil::Is_String_Same(input, "wbss")) {
            cDevOptions::WwnetBytesSentServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetBytesSentClient")
                 || cMiscUtil::Is_String_Same(input, "wbsc")) {
            cDevOptions::WwnetBytesSentClient.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetBytesRecdServer")
                 || cMiscUtil::Is_String_Same(input, "wbrs")) {
            cDevOptions::WwnetBytesRecdServer.Toggle();
        }
        else if (cMiscUtil::Is_String_Same(input, "WwnetBytesRecdClient")
                 || cMiscUtil::Is_String_Same(input, "wbrc")) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SURFACE_PHYSICS_OVERRIDE <friction> <drag> - force friction and drag for all "
               "surfaces (0.0 disables).";
    }
    virtual void Activate(const char* input)
    {
        float friction, drag;
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SWAP_TEAMS - switch everyone to the opposite team (server only).";
    }
    virtual void Activate(const char* input)
    {
        if (cNetwork::I_Am_Server()) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_STAR_HEALTH <strength> - sets the strength of the star.";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_STAR) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_STAR_SKIN <type> - sets the type of the star's skin.";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_STAR) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_STAR_SHIELD_TYPE <type> - sets the type of the star's shield.";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_STAR) {
        ...
        if (strcmp(input, "")) {
            ...
            for (SLNode<BaseGameObj>* objnode = GameObjManager::Get_Game_Obj_List()->Head();
                ...
                if ((strstr(input, "vehicles") && p_object->As_VehicleGameObj() != nullptr)
                    ...
                    //					 (strstr(input, "commandos")	&&
                    //p_object->As_CommandoGameObj()	!= nullptr) ||
                    ...
                    || (strstr(input, "all")) || (strstr(input, "-9"))) {
            ...
            Print(Get_Help());
            Print("\n  Object types: vehicles, soldiers, commandos, powerups, c4s, armeds, smarts, "
                  "all\n");
        }
    }
};
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SKELETON_SLIDER_DEMO - toggles the Skeleton Slider Demo.";
    }
    virtual void Activate(const char* input)
    {
    ...
    virtual void Activate(const char* input)
    {
        ...
        for (int i = 0; i < 4; i++) {
            PhysicalGameObjDef* def
                = (PhysicalGameObjDef*)DefinitionMgrClass::Find_Typed_Definition(
                    "Commando", CLASSID_GAME_OBJECT_DEF_SOLDIER);
            WWASSERT(def);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "GROUP_CONTROLLER_TEST - tests group controller code.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "STAR_VISIBILITY - toggles the logical visibility of the star.";
    }
    virtual void Activate(const char* input)
    {
        if (COMBAT_STAR) {
...
public:
        ...
        virtual	const char * Get_Help( void )	{ return "STEALTH - toggle stealth ability on star
(client only)."; } virtual	void Activate( const char * input ) {
                //if (COMBAT_STAR != nullptr) {
                //	COMBAT_STAR->Toggle_Stealth();
                //	Print("Star %s stealth ability\n", COMBAT_STAR->Is_Stealth_Enabled() ? "has"
: "does NOT have");
                //}
      if (cNetwork::I_Am_Client()) {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PROFILE - send a profile command (on,off,up,<#>).";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_THE_STAR <id> - set the star to a different object.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PARTICLE_TOGGLE - toggles particle emission on and off.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TARGET_STEERING_TOGGLE - toggles vehicle targetsteering.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DAZZLE_RELOAD - reloads the dazzle ini file (DANGEROUS!).";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SCREEN_UV_BIAS - toggles the half pixel bias in screen text.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "SET_BW_BUDGET_OUT <bps> - set total bps budget out.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DEBUG_DEVICE [device|on|off] - toggles the debug device (screen, mono, dbwin32, "
               "log, windows)";
    }
    virtual void Activate(const char* input)
    {
        ...
        if (stricmp(input, "screen") == 0) {
            ...
            sprintf(str, "Screen Debug %s\n",
                    DebugManager::Is_Device_Enabled(DebugManager::DEBUG_DEVICE_SCREEN)
                        ? "Enabled"
                        : "Disabled");
        }
            ...
            sprintf(str, "Mono Debug %s\n",
                    DebugManager::Is_Device_Enabled(DebugManager::DEBUG_DEVICE_MONO) ? "Enabled"
                                                                                     : "Disabled");
        }
            ...
            sprintf(str, "DBWin32 Debug %s\n",
                    DebugManager::Is_Device_Enabled(DebugManager::DEBUG_DEVICE_DBWIN32)
                        ? "Enabled"
                        : "Disabled");
        }
            ...
            sprintf(str, "Log File Debug %s\n",
                    DebugManager::Is_Device_Enabled(DebugManager::DEBUG_DEVICE_LOG) ? "Enabled"
                                                                                    : "Disabled");
        }
            ...
            sprintf(str, "Windows Debug %s\n",
                    DebugManager::Is_Device_Enabled(DebugManager::DEBUG_DEVICE_WINDOWS)
                        ? "Enabled"
                        : "Disabled");
        }
        else if (stricmp(input, "on") == 0) {
...
public:
    ...
    {
        return "STATS "
               "<off|fps|dx8|star|sr_history|sr|gerd|collision|culling|physics|vehicle|ai|wol|"
               "profile|memory> - changes stats display.";
    }
...
public:
    ...
    virtual void Activate(const char* input)
    {
        ...
        if (sscanf(input, "%c", &sign) == 1 && (sign == '+' || sign == '-')) {
            ...
            WW3DErrorType error = WW3D::Set_Device_Resolution(resos[i].Width, resos[i].Height,
                                                              resos[i].BitDepth, -1, true);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "TOGGLE_SURFACE_EFFECTS - toggles surface effects.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DISPLAY_FINDPATH - Toggles the display of findpath lines.";
    }
...
public:
    ...
    {
        HelpText.Format(
            "DONATE <credits> <teammate> - donate money (minimum %d credits) to teammate.",
    ...
    virtual void Activate(const char* input)
    {
        ...
        if (p_me != nullptr && p_recipient != nullptr
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        if (!SlaveMaster.Am_I_Slave()) {
            ...
            return ("QUIT - End game and restart slave server.\nTo exit without restarting use "
                    "'QUIT_SLAVE' on master server\n");
        }
    }
    virtual void Activate(const char* input)
    {
        ...
        if (!IS_MISSION) {
            if (AutoRestart.Is_Active()) {
                ...
                if (cNetwork::I_Am_Server()) {
                    ...
                    /*
                    ** I_Am_Server may not report true if we just started up and we aren't a server
                    *yet.
                    */
                    if (ConsoleBox.Is_Exclusive()) {
                        AutoRestart.Set_Restart_Flag(false);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "GAME_INFO - Print info about a game in progress to console box";
    }
    virtual void Activate(const char*)
    {
                ...
                if (ok) {
                    ...
                    if (FileTimeToLocalFileTime(&creation, &local)) {
                        ...
                        if (FileTimeToSystemTime(&local, &time)) {
                            GetDateFormat(LOCALE_SYSTEM_DEFAULT, 0, &time, nullptr, upstring, 256);
                            GetTimeFormat(LOCALE_SYSTEM_DEFAULT, TIME_FORCE24HOURFORMAT, &time,
                                          nullptr, timestr, 256);
                            strcat(upstring, " - ");
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PLAYER_INFO - Print info about players in the game to the console box";
    }
    virtual void Activate(const char*)
    {
        ...
        if (cNetwork::I_Am_Server() && The_Game() && The_Game()->IsDedicated.Is_True()
            ...
            if (cNetwork::PServerConnection->Get_Num_RHosts() == 0) {
                ...
                ConsoleBox.Print("\rId  Name           Score Side\tPing\tAddress               "
                                 "Kbits/s Time\n\n");

                for (int i = cNetwork::PServerConnection->Get_Min_RHost();
                     i <= cNetwork::PServerConnection->Get_Max_RHost(); i++) {
                    ...
                    if (client) {
                        ...
                        if (playerptr) {
                            ...
                            bw += PacketManager.Get_Compressed_Bandwidth_Out(
                                &client->Get_Address());
                            ...
                            char buffer[256];
                            sprintf(
                                buffer, "%3d %s%- 6d %s\t%d\t%s%- 7d  %03d.%02d.%02d\n", i,
                                temp_name, (int)playerptr->Get_Score(),
                                (playerptr->Get_Player_Type() == PLAYERTYPE_NOD) ? "NOD" : "GDI",
                                (int)client->Get_Average_Internal_Pingtime_Ms(), local_addr_string,
                                (int)(PacketManager.Get_Compressed_Bandwidth_Out(
                                          &client->Get_Address())
                                      / 1024),
                                hours, minutes, seconds);
                ...
                ConsoleBox.Print(
                    "Total current bandwidth usage for players is %d kilobits per second\n",
                    bw / 1024);
            }
        }
        else {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "KICK [<Nickname>|<Id>] - Kick a user from the game.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "BAN [<Nickname>|<Id>] - Permanently ban a user from this server(GameSpy & WOL mode "
               "only).";
    }
    virtual void Activate(const char* input)
    {
        ...
        if ((cGameSpyAdmin::Is_Gamespy_Game() || is_wol) && cNetwork::I_Am_Server()) {
            ...
            for (SLNode<cPlayer>* player_node = cPlayerManager::Get_Player_Object_List()->Head();
                ...
                if (stricmp(StringClass(input), StringClass(player->Get_Name())) == 0) {
                    if (is_wol) {
                        ((WolGameModeClass*)wolgame)
                            ->Ban_Player(player->Get_Name(), player->Get_Ip_Address());
                    }
                    else {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "ALLOW [<Nickname>|<Id>] - Remove user channel ban from this server (WOL mode "
               "only).";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "PAGE Nickname Message - Page a Westwood Online user.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "LOG_MESH_STATS - log stats to debug window or file.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "LOG_TEXTURES - log texture statistics to debug window or file.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("TIME_OF_DAY <hours [0..23]> <minutes [0..59]> - sets the time of day for the "
                "background.");
    }
    virtual void Activate(const char* input)
    {
        ...
        if (COMBAT_SCENE != nullptr) {
            ...
            if (sscanf(input, "%d %d", &hours, &minutes) == 2) {
                if (BackgroundMgrClass::Set_Time_Of_Day(hours, minutes)) {
                    ...
                    BackgroundMgrClass::Set_Light_Source_Type(
                        BackgroundMgrClass::LIGHT_SOURCE_TYPE_SUN);
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("CLOUDS <cloudcover [0..1]> <gloominess [0..1]> [ramptime [0+]]");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("COPY_LOGS <on/off> - enable/disable error logging to network.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "INFO_DEBUG_TOGGLE - Toggles display of debug info on object info.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "MESH_RENDER_SNAPSHOT - Logs one frame of mesh render system.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "UMBRA_TOGGLE - toggles umbra culling (if compiled into this build).";
    }
    virtual void Activate(const char* input)
    {
#if (UMBRASUPPORT)
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "VIP <password> - Toggle VIP mode. Client only.\n";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "ALLOW_KILLING_HIBERNATING_SPAWN - Toggles the global ability for spawners to kill "
               "hibernating spawn.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "DISPLAY_HIBERNATING - Toggles displaying of objects begining and ending "
               "hibernation.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "HIDE_HUD_POINTS - Toggles displaying of points on the HUD.";
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("LIGHTNING <intensity [0..1]> [<start [0..1]> <end [0..1]> <heading [0..360]> "
                "<distribution [0..1]>] [ramptime [0+]] - Sets lightning.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("WARBLITZ <intensity [0..1]> [<start [0..1]> <end [0..1]> <heading [0..360]> "
                "<distribution [0..1]>] [ramptime [0+]] - Sets war blitz.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("WIND <heading [0..360]> <speed [0+]> <variability [0..1]> [ramptime [0+]] - Sets "
                "wind.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("RAIN <density [0+]> [ramptime [0+]] - Sets rain.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("SNOW <density [0+]> [ramptime [0+]] - Sets snow.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return "APP_PACKET_TYPES_RESET - reset app packet stats.";
    }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("ASH <density [0+]> [ramptime [0+]] - Sets ash.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("EDIT_VEHICLE - Edit the parameters of the currently driven vehicle.");
    }
    virtual void Activate(const char* input)
    {
        ...
        if (IS_SOLOPLAY || ((PTheGameData != nullptr) && (PTheGameData->Get_Max_Players() == 1))) {
            ...
            if ((vehicle != nullptr) && (vehicle->Peek_Vehicle_Phys() != nullptr)) {
                ...
                if (tv != nullptr) {
                    ...
                    TrackedVehicleDefClass* def
                        = (TrackedVehicleDefClass*)tv->Get_TrackedVehicleDef();

                    EditTrackedVehicleDialogClass* popup
                        = new EditTrackedVehicleDialogClass(def, wheel_radius);
                    popup->Start_Dialog();
                    popup->Release_Ref();
                }
                else if (wv != nullptr) {
                    ...
                    WheeledVehicleDefClass* def
                        = (WheeledVehicleDefClass*)wv->Get_WheeledVehicleDef();
                    EditWheeledVehicleDialogClass* popup
                        = new EditWheeledVehicleDialogClass(def, wheel_radius);
                    popup->Start_Dialog();
                    popup->Release_Ref();
                }
            }
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("TOGGLE_LATENCY_INTERPRET - Toggles Latency Interpret logic.");
    }
    virtual void Activate(const char* input)
    {
...
public:
    ...
    virtual const char* Get_Help(void)
    {
        return ("TOGGLE_HIT_RETICLE - Toggles the center reticle dot.");
    }
    virtual void Activate(const char* input)
    {
        ...
        for (int index = 0; index < FunctionList.Count(); index++) {
            ...
            if (floor(command_number / per_page) == page_number) {
                ...
                if (index == FunctionList.Count() - 1) { // if this is the last line,
                    ...
                    WatchConsoleFunctionClass::Get_Verbose_Help(watch_help_buffer,
                                                                sizeof(watch_help_buffer));
...
void ConsoleFunctionManager::Parse_Input(const char* string)
{
    if (!strnicmp(string, "help", 4)) {
        ...
        for (int index = 0; index < FunctionList.Count(); index++) {
            ...
            // it to match
            //
            if (function->Get_Alias() != nullptr && strlen(function->Get_Alias()) > 0) {
                char alias[100];
...
bool ConsoleFunctionManager::Get_Command_Suggestion(
    ...
    const char* cur_suggestion, // last suggestion we gave (move to next if not nullptr)
...
ConsoleFunctionManager::Find_Command_Suggestion(const char* input, // incomplete function name
