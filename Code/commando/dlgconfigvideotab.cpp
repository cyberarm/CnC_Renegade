...
void DlgConfigVideoTabClass::On_Init_Dialog(void)
{
    ...
    // To avoid partial (and incorrect) gamma updates, disable it until all values have been
    // correctly set.
    UpdateGamma = false;
...
//
////////////////////////////////////////////////////////////////
void DlgConfigVideoTabClass::On_SliderCtrl_Pos_Changed(SliderCtrlClass* slider_ctrl, int ctrl_id,
                                                       int new_pos)
{
