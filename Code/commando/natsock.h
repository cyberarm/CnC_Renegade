...
/*
** Length of our temporary receive buffer. Needs to be more that the max packet size which is about
*550 bytes.
*/
...
**
** Can't use the Renegade packet comms since the packet format is different - Mangler servers expect
*C&C packet format.
*/
...
private:
    ...
    */
    struct WinsockBufferType
    {
        ...
        unsigned short
            Port; // Override port. Send to this port if not 0. Save incoming port number.
