...
void CNCTeamInfoDialogClass::Configure_Icons(void)
{
    ...
    if (building != nullptr) {
        float life = building->Get_Defense_Object()->Get_Health()
            / building->Get_Defense_Object()->Get_Health_Max();
        ...
        if (player->Get_Player_Type() == team_id) {
            ...
            if (item_index >= 0) {
                ...
                if (game_obj != nullptr && game_obj->As_SoldierGameObj() != nullptr) {
                    ...
                    //::Strip_Path_From_Filename (tga_filename, game_obj->Get_Definition
                    //:().Get_Icon_Filename ());
                    ...
                    if (vehicle != nullptr) {
                        //::Strip_Path_From_Filename (tga_filename, vehicle->Get_Definition
                        //:().Get_Icon_Filename ());
                ...
                if (game_obj == COMBAT_STAR) {
                    ...
                    list_ctrl->Set_Entry_Color(item_index, COL_CHARACTER,
...
//
////////////////////////////////////////////////////////////////
int CALLBACK CNCTeamInfoDialogClass::ListSortCallback(ListCtrlClass* list_ctrl, int item_index1,
...
void CNCTeamInfoDialogClass::Build_Player_Display_Name(const cPlayer* player,
                                                       WideStringClass& outName)
{
