...
const unsigned short* cBandwidth::Get_Bandwidth_String_From_Type(BANDWIDTH_TYPE_ENUM bandwidth_type)
{
    ...
    */
    ...
    case BANDWIDTH_AUTO: {
        // sprintf(_bandwidth_auto_txt, "BANDWIDTH_AUTO (%s)",
        ...
        // wsprintf(_bandwidth_auto_txt, TRANSLATE(IDS_MP_CONNECTION_T1),
        // Get_Bandwidth_Bps_From_Type(bandwidth_type)); return ((const)_bandwidth_auto_txt);
        return (s);
    }
    default:
        DIE;
