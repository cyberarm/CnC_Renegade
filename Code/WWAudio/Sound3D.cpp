...
void Sound3DClass::Update_Miles_Transform(void)
{
    ...
    if (m_SoundHandle != nullptr) {
        ...
        ::AIL_set_3D_orientation(m_SoundHandle->Get_H3DSAMPLE(), -facing.Y, facing.Z, facing.X,
                                 -up.Y, up.Z, up.X);
    }
...
void Sound3DClass::Set_Velocity(const Vector3& velocity)
{
    ...
    if (m_SoundHandle != nullptr) {
        ...
        ::AIL_set_3D_velocity_vector(m_SoundHandle->Get_H3DSAMPLE(), -m_CurrentVelocity.Y,
                                     m_CurrentVelocity.Z, m_CurrentVelocity.X);
    }
