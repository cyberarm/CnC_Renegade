...
WWAudioClass::DRIVER_TYPE_2D WWAudioClass::Open_2D_Device(LPWAVEFORMAT format)
{
    ...
    // WWASSERT (success == AIL_NO_ERROR);		// This assert fires if there is no sound
    // card.
...
bool WWAudioClass::Free_Cache_Space(int bytes)
{
    ...
    for (int hash_index = 0; (hash_index < MAX_CACHE_HASH) && (bytes_freed < bytes); hash_index++) {
        ...
        for (int index = 0; (index < m_CachedBuffers[hash_index].Count()) && (bytes_freed < bytes);
             index++) {
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
SoundBufferClass* WWAudioClass::Create_Sound_Buffer(FileClass& file, const char* string_id,
                                                    bool is_3d)
{
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
Sound3DClass* WWAudioClass::Create_3D_Sound(FileClass& file, const char* string_id,
                                            int classid_hint)
{
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
Sound3DClass* WWAudioClass::Create_3D_Sound(const char* string_id, unsigned char* raw_wave_data,
                                            unsigned long bytes, int classid_hint)
{
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
AudibleSoundClass* WWAudioClass::Create_Sound(int definition_id, RefCountClass* user_obj,
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
AudibleSoundClass* WWAudioClass::Create_Sound(const char* def_name, RefCountClass* user_obj,
                                              uint32 user_data, int classid_hint)
{
    WWPROFILE("Create_Sound");
    AudibleSoundClass* sound = NULL;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
AudibleSoundClass* WWAudioClass::Create_Continuous_Sound(int definition_id, RefCountClass* user_obj,
                                                         uint32 user_data, int classid_hint)
{
    ...
    if (sound != NULL) {
        ...
        if (sound->Get_Loop_Count() != INFINITE_LOOPS) {
            WWDEBUG_SAY(
                ("Audio Error:  Creating a continuous sound with a finite loop count!\r\n"));
        }
    }
...
int WWAudioClass::Create_Instant_Sound(int definition_id, const Matrix3D& tm,
                                       RefCountClass* user_obj, uint32 user_data, int classid_hint)
{
    ...
    if (sound != NULL) {
        ...
        if (sound->Get_Loop_Count() == INFINITE_LOOPS) {
            WWDEBUG_SAY(
                ("Audio Error:  Creating an instant sound %s with an infinite loop count!\r\n",
...
AudibleSoundClass* WWAudioClass::Create_Continuous_Sound(const char* def_name,
                                                         RefCountClass* user_obj, uint32 user_data,
                                                         int classid_hint)
{
    WWPROFILE("Create_Continuous_Sound");
        ...
        for (int index = 0; index < m_CompletedSounds.Count(); index++) {
            ...
            if (sound_obj->Get_State() == AudibleSoundClass::STATE_STOPPED) {
                ...
                for (int page = 0; page < PAGE_COUNT && !found; page++) {
                    for (int play_index = 0; (play_index < m_Playlist[page].Count()) && !found;
                         play_index++) {
...
bool WWAudioClass::Add_To_Playlist(AudibleSoundClass* sound)
{
    ...
    if (sound != NULL) {
        ...
        for (int index = 0; (index < m_Playlist[m_CurrPage].Count()) && (already_added == false);
             index++) {
...
void WWAudioClass::Initialize(const char* registry_subkey_name)
{
    ...
    //
    ::AIL_set_file_callbacks(File_Open_Callback, File_Close_Callback, File_Seek_Callback,
                             File_Read_Callback);
    return;
}
...
bool WWAudioClass::Load_From_Registry(const char* subkey_name)
{
    ...
    if (Load_From_Registry(subkey_name, device_name, is_stereo, bits, hertz,
                           m_AreSoundEffectsEnabled, m_IsMusicEnabled, m_IsDialogEnabled,
                           m_IsCinematicSoundEnabled, m_SoundVolume, m_MusicVolume, m_DialogVolume,
...
//
////////////////////////////////////////////////////////////////////////////////////////////
bool WWAudioClass::Load_From_Registry(const char* subkey_name, StringClass& device_name,
                                      bool& is_stereo, int& bits, int& hertz, bool& sound_enabled,
                                      bool& music_enabled, bool& dialog_enabled,
                                      bool& cinematic_enabled, float& sound_volume,
                                      float& music_volume, float& dialog_volume,
                                      float& cinematic_volume, int& speaker_type)
{
    ...
    if (registry.Is_Valid()) {
        ...
        Load_Default_Volume(defaultmusicvolume, defaultsoundvolume, defaultdialogvolume,
        ...
        cinematic_volume
            = registry.Get_Int(VALUE_NAME_CINEMATIC_VOL, defaultcinematicvolume) / 100.0F;
...
bool WWAudioClass::Save_To_Registry(const char* subkey_name)
{
    ...
    //
    return Save_To_Registry(subkey_name, device_name, m_PlaybackStereo, m_PlaybackBits,
                            m_PlaybackRate, m_AreSoundEffectsEnabled, m_IsMusicEnabled,
                            m_IsDialogEnabled, m_IsCinematicSoundEnabled, m_SoundVolume,
                            m_MusicVolume, m_DialogVolume, m_CinematicVolume, m_SpeakerType);
}
...
//
////////////////////////////////////////////////////////////////////////////////////////////
bool WWAudioClass::Save_To_Registry(const char* subkey_name, const StringClass& device_name,
                                    bool is_stereo, int bits, int hertz, bool sound_enabled,
                                    bool music_enabled, bool dialog_enabled, bool cinematic_enabled,
                                    float sound_volume, float music_volume, float dialog_volume,
                                    float cinematic_volume, int speaker_type)
{
    bool retval = false;
...
//
////////////////////////////////////////////////////////////////////////////////////////////
void WWAudioClass::Load_Default_Volume(int& defaultmusicvolume, int& defaultsoundvolume,
                                       int& defaultdialogvolume, int& defaultcinematicvolume)
{
    ...
    defaultmusicvolume = MIN(
        maxsetting,
        MAX(minsetting, AudioIni->Get_Int(INI_DEFAULT_VOLUME_SECTION, INI_MUSIC_VOLUME_ENTRY, 31)));
    defaultsoundvolume = MIN(
        maxsetting,
        MAX(minsetting, AudioIni->Get_Int(INI_DEFAULT_VOLUME_SECTION, INI_SOUND_VOLUME_ENTRY, 43)));
    defaultdialogvolume
        = MIN(maxsetting,
              MAX(minsetting,
                  AudioIni->Get_Int(INI_DEFAULT_VOLUME_SECTION, INI_DIALOG_VOLUME_ENTRY, 50)));
    defaultcinematicvolume
        = MIN(maxsetting,
              MAX(minsetting,
                  AudioIni->Get_Int(INI_DEFAULT_VOLUME_SECTION, INI_CINEMATIC_VOLUME_ENTRY, 100)));
}
