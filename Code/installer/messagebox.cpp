 ...
 *=============================================================================================*/
MessageBoxClass* MessageBoxClass::Create_Dialog(const WCHAR* title, const WCHAR* text,
 ...
 *   08/22/01    IML : Created.                                                                *
 *=============================================================================================*/
void MessageBoxClass::Do_Dialog(const WCHAR* title, const WCHAR* text, MessageBoxTypeEnum type,
                                CallbackMenuDialogClass* callbackobject)
{
    MessageBoxClass* popup;
