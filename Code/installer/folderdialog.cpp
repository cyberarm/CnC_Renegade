...
void GameFolderDialogClass::On_Init_Dialog(void)
{
    ...
    if (_RegistryManager.Get_Target_Game_Folder(folder)) {
        ...
        Set_Dlg_Item_Text(
            IDC_FOLDER_EDIT,
            TxWideStringClass(IDS_DEFAULT_GAME_FOLDER, IDS_RESOURCE_DEFAULT_GAME_FOLDER));
    }
...
void WOLFolderDialogClass::On_Init_Dialog(void)
{
    ...
    if (_RegistryManager.Get_Target_WOL_Folder(RegistryManagerClass::WOLAPI_COMPONENT, folder)) {
        ...
        Set_Dlg_Item_Text(
            IDC_FOLDER_EDIT,
            TxWideStringClass(IDS_DEFAULT_WOL_FOLDER, IDS_RESOURCE_DEFAULT_WOL_FOLDER));
    }
 ...
 *   08/22/01    IML : Created.                                                                *
 *=============================================================================================*/
void FolderDialogClass::On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id, int old_index,
                                               int new_index)
{
    ...
    case IDOK: {
        ...
        if (!hasnonspacechar) {
            MessageBoxClass::Do_Dialog(TxWideStringClass(IDS_WARNING),
                                       TxWideStringClass(IDS_INVALID_FOLDER_NAME),
