...
#define USE_QA_SERIAL_NOS                                                                          \
    0 // Use a set of nos. for QA testing (as opposed to serial nos. for general release).
#define PERMIT_INSTALL_FROM_NETWORK                                                                \
    0 // Let users install from any drive (if -N is on command line).
