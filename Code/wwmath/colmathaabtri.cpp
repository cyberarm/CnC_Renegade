    ...
    */
    ...
    if (lp - leb0 <= 0.0f) {
        eps = COLLISION_EPSILON
            * CollisionContext.TestAxis.Length(); // trying to only compute epsilon if I have to
    }
 ...
 *   4/8/99     GTH : Created.                                                                 *
 *=============================================================================================*/
bool CollisionMath::Collide(const AABoxClass& box, const Vector3& move, const TriClass& tri,
                            CastResultStruct* result)
{
    ...
    */
    if (!CollisionContext.StartBad) {
        ...
        CollisionContext.TestAxis.Set(-CollisionContext.Move.Y, CollisionContext.Move.X,
                                      0); // A2 X Move
