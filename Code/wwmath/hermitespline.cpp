...
void HermiteSpline3DClass::Evaluate(float time, Vector3* set_val)
{
    ...
    set_val->X = h0 * Keys[i0].Point.X + h1 * Keys[i1].Point.X + h2 * Tangents[i0].OutTangent.X
        + h3 * Tangents[i1].InTangent.X;

    set_val->Y = h0 * Keys[i0].Point.Y + h1 * Keys[i1].Point.Y + h2 * Tangents[i0].OutTangent.Y
        + h3 * Tangents[i1].InTangent.Y;

    set_val->Z = h0 * Keys[i0].Point.Z + h1 * Keys[i1].Point.Z + h2 * Tangents[i0].OutTangent.Z
        + h3 * Tangents[i1].InTangent.Z;
}
...
void HermiteSpline1DClass::Evaluate(float time, float* set_val)
{
    ...
    *set_val = h0 * Keys[i0].Point + h1 * Keys[i1].Point + h2 * Tangents[i0].OutTangent
        + h3 * Tangents[i1].InTangent;
}
