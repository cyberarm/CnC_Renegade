...
public:
    ...
    */
    ...
    WWINLINE explicit Matrix4(const Vector4& v0, const Vector4& v1, const Vector4& v2,
                              const Vector4& v3);
    ...
    */
    WWINLINE void Init_Ortho(float left, float right, float bottom, float top, float znear,
                             float zfar);
    WWINLINE void Init_Perspective(float hfov, float vfov, float znear, float zfar);
    WWINLINE void Init_Perspective(float left, float right, float bottom, float top, float znear,
                                   float zfar);
 ...
 *   06/02/1997 GH  : Created.                                                                 *
 *=============================================================================================*/
WWINLINE Matrix4::Matrix4(const Vector4& r0, const Vector4& r1, const Vector4& r2,
                          const Vector4& r3)
{
    Init(r0, r1, r2, r3);
}
 ...
 *   11/5/99    gth : Created.                                                                 *
 *=============================================================================================*/
WWINLINE void Matrix4::Init(const Vector4& r0, const Vector4& r1, const Vector4& r2,
                            const Vector4& r3)
{
    Row[0] = r0;
    Row[1] = r1;
 ...
 *   11/5/99    gth : Created.                                                                 *
 *=============================================================================================*/
WWINLINE void Matrix4::Init_Ortho(float left, float right, float bottom, float top, float znear,
                                  float zfar)
{
    assert(znear >= 0.0f);
    assert(zfar > znear);
 ...
 *   11/5/99    gth : Created.                                                                 *
 *=============================================================================================*/
WWINLINE void Matrix4::Init_Perspective(float left, float right, float bottom, float top,
...
{
    return Matrix4(a.Row[0] + b.Row[0], a.Row[1] + b.Row[1], a.Row[2] + b.Row[2],
                   a.Row[3] + b.Row[3]);
}
