...
public:
    ...
    */
    ...
    WWINLINE explicit Matrix3(float m11, float m12, float m13, float m21, float m22, float m23,
    ...
    */
    ...
    WWINLINE void Set(float m11, float m12, float m13, float m21, float m22, float m23, float m31,
                      float m32, float m33);
    ...
    */
    ...
    static WWINLINE void Transpose_Rotate_Vector(const Matrix3& tm, const Vector3& in,
                                                 Vector3* out);
...
WWINLINE Matrix3::Matrix3(float m11, float m12, float m13, float m21, float m22, float m23,
                          float m31, float m32, float m33)
{
...
WWINLINE void Matrix3::Set(float m11, float m12, float m13, float m21, float m22, float m23,
                           float m31, float m32, float m33)
{
    Row[0].Set(m11, m12, m13);
    Row[1].Set(m21, m22, m23);
