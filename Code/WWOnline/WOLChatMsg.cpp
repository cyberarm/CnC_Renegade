...
namespace WWOnline
{
    ...
    ChatMessage::ChatMessage(const WOL::User* sender, const char* message, bool isPrivate,
                             bool isAction)
        : mMessage(message),
    ...
    ChatMessage::ChatMessage(const WOL::User* sender, const wchar_t* message, bool isPrivate,
                             bool isAction)
        : mMessage(message),
          mIsPrivate(isPrivate),
          mIsAction(isAction),
    ...
    ChatMessage::ChatMessage(const wchar_t* sender, const wchar_t* message, bool isPrivate,
                             bool isAction)
        : mSenderName(sender),
          mMessage(message),
          mIsPrivate(isPrivate),
