...
#define MAX_NICKNAMES 32
    ...
    RefPtr<LoginInfo> LoginInfo::Create(const wchar_t* nickname, const wchar_t* password,
                                        bool isEncrypted)
    {
    ...
    void LoginInfo::StoreLogin(const char* nickname, const char* password, bool isPasswordEncrypted,
                               WOL::Locale locale)
    {
        RefPtr<Session> session = Session::GetInstance(false);
