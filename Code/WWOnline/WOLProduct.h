...
namespace WWOnline
{
    ...
    public:
        ...
        {
        public:
            Initializer(const char* registryPath, int gameCode, const wchar_t* chanPass,
    ...
    private:
        ...
        static RefPtr<Product> Create(const char* registryPath, int gameCode,
                                      const wchar_t* chanPass, unsigned long ladderSKU);

        Product(const char* registryPath, int gameCode, const wchar_t* chanPass,
                unsigned long ladderSKU);
