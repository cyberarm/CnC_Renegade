...
namespace WWOnline
{
    ...
    //-----------------------------------------------------------------------------
    class ServerListWait : public SingleWait,
    ...
    //-----------------------------------------------------------------------------
    class DisconnectWait : public SingleWait,
                           public Observer<ServerError>,
    ...
    //-----------------------------------------------------------------------------
    class ConnectWait : public SingleWait,
                        public Observer<ServerError>,
                        public Observer<ConnectionStatus>
    {
    public:
        static RefPtr<ConnectWait> Create(const RefPtr<Session>& session,
                                          const RefPtr<ServerData>& server,
    ...
    public:
        ...
        static RefPtr<JoinChannelWait> Create(const RefPtr<Session>& session,
                                              const wchar_t* channelName, const wchar_t* password,
                                              int type);
    ...
    //-----------------------------------------------------------------------------
    class LocateUserWait : public SingleWait,
                           public Observer<ServerError>,
                           public Observer<UserEvent>
    {
    public:
        static RefPtr<LocateUserWait> Create(const RefPtr<Session>& session,
