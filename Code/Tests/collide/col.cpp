...
IntersectType Boxes_Intersect(const BoxClass& box0, const BoxClass& box1, float dt)
{
    ...
    rb = FABS(box1.Extent[0] * AB[0][0]) + FABS(box1.Extent[1] * AB[0][1])
        + FABS(box1.Extent[2] * AB[0][2]);
    rsum = ra + rb;
    ...
    rb = FABS(box1.Extent[0] * AB[1][0]) + FABS(box1.Extent[1] * AB[1][1])
        + FABS(box1.Extent[2] * AB[1][2]);
    rsum = ra + rb;
    ...
    rb = FABS(box1.Extent[0] * AB[2][0]) + FABS(box1.Extent[1] * AB[2][1])
        + FABS(box1.Extent[2] * AB[2][2]);
    rsum = ra + rb;
    ...
    /////////////////////////////////////////////////////////////////////////
    ra = FABS(box0.Extent[0] * AB[0][0]) + FABS(box0.Extent[1] * AB[1][0])
        + FABS(box0.Extent[2] * AB[2][0]);
    ...
    /////////////////////////////////////////////////////////////////////////
    ra = FABS(box0.Extent[0] * AB[0][1]) + FABS(box0.Extent[1] * AB[1][1])
        + FABS(box0.Extent[2] * AB[2][1]);
    ...
    /////////////////////////////////////////////////////////////////////////
    ra = FABS(box0.Extent[0] * AB[0][2]) + FABS(box0.Extent[1] * AB[1][2])
        + FABS(box0.Extent[2] * AB[2][2]);
