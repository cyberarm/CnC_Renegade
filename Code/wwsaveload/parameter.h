...
//	ParameterClass
//////////////////////////////////////////////////////////////////////////////////
inline ParameterClass::ParameterClass(const ParameterClass& src)
    : m_Name(nullptr),
      IsModified(false)
{
    (*this) = src;
...
//	Get_Name
//////////////////////////////////////////////////////////////////////////////////
inline const char* ParameterClass::Get_Name(void) const
{
    return m_Name;
}
...
//	Get_Units_Name
//////////////////////////////////////////////////////////////////////////////////
inline const char* ParameterClass::Get_Units_Name(void) const
{
    return m_UnitsName;
}
...
public:
    ...
    {
        return (type == TYPE_STRING) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_FILENAME) || StringParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_ENUM) || ParameterClass::Is_Type(type);
    }
...
protected:
    ...
    typedef struct _ENUM_VALUE
    {
        ...
        _ENUM_VALUE(const char* _name = nullptr, int _value = 0)
            : name(_name),
              value(_value)
        {
        }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_PHYSDEFINITIONID) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_MODELDEFINITIONID) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_GENERICDEFINITIONID) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_GAMEOBJDEFINITIONID) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_SOUNDDEFINITIONID) || ParameterClass::Is_Type(type);
    }
};
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_SCRIPT) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_DEFINITIONIDLIST) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_ZONE) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_FILENAMELIST) || ParameterClass::Is_Type(type);
    }
...
public:
    ...
    //	Public constructors/destructors
    //////////////////////////////////////////////////////////////////////////////
    ScriptListParameterClass(DynamicVectorClass<StringClass>* name_list,
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_SCRIPTLIST) || ParameterClass::Is_Type(type);
    }
...
protected:
    ...
    //	Protected members
    //////////////////////////////////////////////////////////////////////////////
    bool Are_Lists_Identical(DynamicVectorClass<StringClass>& list1,
...
public:
    ...
    virtual bool Is_Type(Type type) const
    {
        return (type == TYPE_SEPARATOR) || ParameterClass::Is_Type(type);
    }
