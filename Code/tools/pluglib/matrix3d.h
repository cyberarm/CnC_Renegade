...
public:
    ...
    explicit Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22, float m23,
                      float m24, float m31, float m32, float m33, float m34);

    explicit Matrix3D(const Vector3& x, // x-axis unit vector
                      const Vector3& y, // y-axis unit vector
                      const Vector3& z, // z-axis unit vector
                      const Vector3& pos // position
    );

    explicit Matrix3D(const Vector3& axis, float angle);

    explicit Matrix3D(const Vector3& axis, float sine, float cosine);

    explicit Matrix3D(const Matrix3& rotation, const Vector3& position);

    explicit Matrix3D(const Quaternion& rotation, const Vector3& position);
    ...
    void Set(const Vector3& x, // x-axis unit vector
             const Vector3& y, // y-axis unit vector
             const Vector3& z, // z-axis unit vector
             const Vector3& pos // position
    );
    ...
    void Transform_Min_Max_AABox(const Vector3& min, const Vector3& max, Vector3* set_min,
...
inline Matrix3D::Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22,
...
inline Matrix3D::Matrix3D(const Vector3& x, // x-axis unit vector
                          const Vector3& y, // y-axis unit vector
                          const Vector3& z, // z-axis unit vector
                          const Vector3& pos // position
)
 ...
 *   2/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
inline void Matrix3D::Set(float m11, float m12, float m13, float m14, float m21, float m22,
                          float m23, float m24, float m31, float m32, float m33, float m34)
{
    Row[0].Set(m11, m12, m13, m14);
    Row[1].Set(m21, m22, m23, m24);
