...
enum
{
    ...
    O_W3D_CHUNK_DAMAGE_MATERIALS, // (OBSOLETE) Damage materials simply wrapped with MATERIALS3 or
                                  // higher
    ...
    W3D_CHUNK_MATERIAL3_NAME, // Name of the material (array of chars, nullptr terminated)
...
// look like:
//
// W3D_CHUNK_MATERIALS3						<-- simply a wrapper around the
// array of mtls
//		W3D_CHUNK_MATERIAL3					<-- a wrapper around each
//material 			W3D_CHUNK_STRING			 		<-- name of the material
//			W3D_CHUNK_MATERIAL3_INFO		<-- standard material properties, a
//W3dMaterial3Struct 			W3D_CHUNK_MATERIAL3_DC_MAP		<-- a map, W3dMap3Struct 				W3D_CHUNK_STRING
//<-- filename of the map 				W3D_CHUNK_MAP_INFO			<-- map parameters
//			W3D_CHUNK_MATERIAL3_SC_MAP
//				W3D_CHUNK_STRING				<-- filename of the
//map 				W3D_CHUNK_MAP_INFO 		W3D_CHUNK_MATERIAL3 			W3D_CHUNK_MATERIAL3_NAME 			W3D_CHUNK_MATERIAL3_INFO
...
#define W3D_MESH_FLAG_COLLISION_BOX                                                                \
    0x00000001 // mesh is a collision box (should be 8 verts, should be hidden, etc)
...
struct W3dHModelHeaderStruct
{
    ...
    char HierarchyName[W3D_NAME_LEN]; // Name of hierarchy associated with these connections (nullptr
                                      // terminated)
