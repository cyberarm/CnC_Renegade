...
public:
    ...
    struct TriangleVertices
    {
        ...
        bool operator==(const TriangleVertices& t) { return ((Point == t.Point) && (UV == t.UV)); }
    };

    // Equality operator.
    bool operator==(const Triangle& t)
    {
        return ((Normal == t.Normal) && (Vertices[0] == t.Vertices[0])
                && (Vertices[1] == t.Vertices[1]) && (Vertices[2] == t.Vertices[2]));
    }
    ...
    TriangleVertices
        Vertices[VERTICES_COUNT]; // Location of triangle in object space and texture space.
