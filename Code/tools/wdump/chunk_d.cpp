...
void ChunkTableClass::NewType(int ID, const char* name,
                              void (*callback)(ChunkItem* item, CListCtrl* list), bool wrapper)
{
    ChunkType* chunktype = new ChunkType(name, callback, wrapper);
    Types.SetAt((void*)ID, (void*)chunktype);
}
void ChunkTableClass::AddItem(CListCtrl* List, int& Counter, const char* Name, const char* Value,
                              const char* Type)
{
...
void ChunkTableClass::AddItem(CListCtrl* List, int& Counter, const char* Name,
                              IOVector3Struct* Value)
{
    char buf[256];
...
void ChunkTableClass::AddItem(CListCtrl* List, int& Counter, const char* Name,
                              W3dTexCoordStruct* Value, int Count)
{
    CString temp;
    int counter = 0;
    while (counter < Count) {
...
{
    static char* _depth_compare[] = { "Pass Never",
                                      "Pass Less",
                                      "Pass Equal",
                                      "Pass Less or Equal",
                                      "Pass Greater",
    ...
    static char* _detailcolor[] = { "Disable", "Detail", "Scale", "InvScale",   "Add",
                                    "Sub",     "SubR",   "Blend", "DetailBlend" };
...
void ChunkTableClass::AddItem(CListCtrl* List, int& Counter, const char* name,
                              W3dPS2ShaderStruct* shader)
{
    static char* _depth_compare[]
        = { "Pass Never", "Pass Less", "Pass Always", "Pass Less or Equal" };
    static char* _depth_mask[] = { "Write Disable", "Write Enable" };
    static char* _color_mask[] = { "Write Disable", "Write Enable" };
...
void ChunkTableClass::List_W3D_CHUNK_MESH_HEADER(ChunkItem* Item, CListCtrl* List)
{
    ...
    char buf[64];
    sprintf(buf, "%d.%d", W3D_GET_MAJOR_VERSION(data->Version),
            W3D_GET_MINOR_VERSION(data->Version));
    AddItem(List, Counter, "Version", buf);
    AddItem(List, Counter, "MeshName", data->MeshName);
    AddItem(List, Counter, "Attributes", data->Attributes);
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_BOX) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_BOX");
    }
    if (data->Attributes & W3D_MESH_FLAG_SKIN) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_SKIN");
    }
    if (data->Attributes & W3D_MESH_FLAG_SHADOW) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_SHADOW");
    }
    if (data->Attributes & W3D_MESH_FLAG_ALIGNED) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_ALIGNED");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_PHYSICAL) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_PHYSICAL");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_PROJECTILE) {
...
void ChunkTableClass::List_W3D_CHUNK_MATERIAL3_INFO(ChunkItem* Item, CListCtrl* List)
{
    ...
    AddItem(List, Counter, "Attributes", data->Attributes);
    if (data->Attributes & W3DMATERIAL_USE_ALPHA) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_USE_ALPHA");
    }
    if (data->Attributes & W3DMATERIAL_USE_SORTING) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_USE_SORTING");
    }
    if (data->Attributes & W3DMATERIAL_HINT_DIT_OVER_DCT) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_HINT_DIT_OVER_DCT");
    }
    if (data->Attributes & W3DMATERIAL_HINT_SIT_OVER_SCT) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_HINT_SIT_OVER_SCT");
    }
    if (data->Attributes & W3DMATERIAL_HINT_DIT_OVER_DIG) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_HINT_DIT_OVER_DIG");
    }
    if (data->Attributes & W3DMATERIAL_HINT_SIT_OVER_SIG) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_HINT_SIT_OVER_SIG");
    }
    if (data->Attributes & W3DMATERIAL_HINT_FAST_SPECULAR_AFTER_ALPHA) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_HINT_FAST_SPECULAR_AFTER_ALPHA");
    }
    if (data->Attributes & W3DMATERIAL_PSX_TRANS_100) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_PSX_TRANS_100");
    }
    if (data->Attributes & W3DMATERIAL_PSX_TRANS_50) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_PSX_TRANS_50");
    }
    if (data->Attributes & W3DMATERIAL_PSX_TRANS_25) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_PSX_TRANS_25");
    }
    if (data->Attributes & W3DMATERIAL_PSX_TRANS_MINUS_100) {
        AddItem(List, Counter, "Attributes", "W3DMATERIAL_PSX_TRANS_MINUS_100");
    }
    if (data->Attributes & W3DMATERIAL_PSX_NO_RT_LIGHTING) {
...
void ChunkTableClass::List_W3D_CHUNK_MESH_HEADER3(ChunkItem* Item, CListCtrl* List)
{
    ...
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_PHYSICAL) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_PHYSICAL", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_PROJECTILE) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_PROJECTILE", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_VIS) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_VIS", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_CAMERA) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_CAMERA", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_COLLISION_TYPE_VEHICLE) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_COLLISION_TYPE_VEHICLE", "flag");
    }

    if (data->Attributes & W3D_MESH_FLAG_HIDDEN) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_HIDDEN", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_TWO_SIDED) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_TWO_SIDED", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_CAST_SHADOW) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_CAST_SHADOW");
    }
    if (data->Attributes & W3D_MESH_FLAG_SHATTERABLE) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_SHATTERABLE");
    }
    if (data->Attributes & W3D_MESH_FLAG_NPATCHABLE) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_NPATCHABLE");
    }

    if (data->Attributes & W3D_MESH_FLAG_PRELIT_UNLIT) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_PRELIT_UNLIT", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_PRELIT_VERTEX) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_PRELIT_VERTEX", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_PASS) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_PASS", "flag");
    }
    if (data->Attributes & W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_TEXTURE) {
        AddItem(List, Counter, "Attributes", "W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_TEXTURE", "flag");
    }
    ...
    if ((data->Attributes & W3D_MESH_FLAG_PRELIT_MASK) != 0x0) {
        if (data->PrelitVersion != 0) {
            sprintf(buf, "%d.%d", W3D_GET_MAJOR_VERSION(data->PrelitVersion),
                    W3D_GET_MINOR_VERSION(data->PrelitVersion));
        }
        else {
            sprintf(buf, "UNKNOWN");
        }
    ...
    if (data->VertexChannels & W3D_VERTEX_CHANNEL_LOCATION) {
        AddItem(List, Counter, "VertexChannels", "W3D_VERTEX_CHANNEL_LOCATION", "flag");
    }
    if (data->VertexChannels & W3D_VERTEX_CHANNEL_NORMAL) {
        AddItem(List, Counter, "VertexChannels", "W3D_VERTEX_CHANNEL_NORMAL", "flag");
    }
    if (data->VertexChannels & W3D_VERTEX_CHANNEL_TEXCOORD) {
        AddItem(List, Counter, "VertexChannels", "W3D_VERTEX_CHANNEL_TEXCOORD", "flag");
    }
    if (data->VertexChannels & W3D_VERTEX_CHANNEL_COLOR) {
        AddItem(List, Counter, "VertexChannels", "W3D_VERTEX_CHANNEL_COLOR", "flag");
    }
    if (data->VertexChannels & W3D_VERTEX_CHANNEL_BONEID) {
        AddItem(List, Counter, "VertexChannels", "W3D_VERTEX_CHANNEL_BONEID", "flag");
    }
    AddItem(List, Counter, "FaceChannels", data->FaceChannels);
    if (data->FaceChannels & W3D_FACE_CHANNEL_FACE) {
        AddItem(List, Counter, "FaceChannels", "W3D_FACE_CHANNEL_FACE", "flag");
    }
    AddItem(List, Counter, "Min", &data->Min);
    AddItem(List, Counter, "Max", &data->Max);
    AddItem(List, Counter, "SphCenter", &data->SphCenter);
...
void ChunkTableClass::List_W3D_CHUNK_VERTEX_MATERIAL_INFO(ChunkItem* Item, CListCtrl* List)
{
    ...
    if (data->Attributes & W3DVERTMAT_USE_DEPTH_CUE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_USE_DEPTH_CUE", "flag");
    }
    if (data->Attributes & W3DVERTMAT_ARGB_EMISSIVE_ONLY) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_ARGB_EMISSIVE_ONLY", "flag");
    }
    if (data->Attributes & W3DVERTMAT_COPY_SPECULAR_TO_DIFFUSE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_COPY_SPECULAR_TO_DIFFUSE",
                "flag");
    }
    if (data->Attributes & W3DVERTMAT_DEPTH_CUE_TO_ALPHA) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_DEPTH_CUE_TO_ALPHA", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_UV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_UV", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_CHEAP_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_CHEAP_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_SCREEN) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_SCREEN", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_LINEAR_OFFSET",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_SILHOUETTE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_SILHOUETTE",
                "flag");
    }

    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_SCALE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_SCALE", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_GRID) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_GRID", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_ROTATE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_ROTATE", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_SINE_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE0_MAPPING_SINE_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_STEP_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE0_MAPPING_STEP_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_ZIGZAG_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE0_MAPPING_ZIGZAG_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_WS_CLASSIC_ENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_WS_CLASSIC_ENV",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_WS_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_WS_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
        == W3DVERTMAT_STAGE0_MAPPING_GRID_CLASSIC_ENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_GRID_CLASSIC_ENV",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK)
    ...
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_RANDOM) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_RANDOM", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE0_MAPPING_MASK) == W3DVERTMAT_STAGE0_MAPPING_BUMPENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE0_MAPPING_BUMPENV", "flag");
    }

    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_UV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_UV", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_CHEAP_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_CHEAP_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_SCREEN) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_SCREEN", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_LINEAR_OFFSET",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_SILHOUETTE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_SILHOUETTE",
                "flag");
    }

    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_SCALE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_SCALE", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_GRID) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_GRID", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_ROTATE) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_ROTATE", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_SINE_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE1_MAPPING_SINE_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_STEP_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE1_MAPPING_STEP_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_ZIGZAG_LINEAR_OFFSET) {
        AddItem(List, Counter, "Material.Attributes",
                "W3DVERTMAT_STAGE1_MAPPING_ZIGZAG_LINEAR_OFFSET", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_WS_CLASSIC_ENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_WS_CLASSIC_ENV",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_WS_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_WS_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_GRID_CLASSIC_ENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_GRID_CLASSIC_ENV",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK)
        == W3DVERTMAT_STAGE1_MAPPING_GRID_ENVIRONMENT) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_GRID_ENVIRONMENT",
                "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_RANDOM) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_RANDOM", "flag");
    }
    if ((data->Attributes & W3DVERTMAT_STAGE1_MAPPING_MASK) == W3DVERTMAT_STAGE1_MAPPING_BUMPENV) {
        AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_STAGE1_MAPPING_BUMPENV", "flag");
    }
    ...
    if (data->Attributes & W3DVERTMAT_PSX_MASK) {
        if (data->Attributes & W3DVERTMAT_PSX_NO_RT_LIGHTING) {
            ...
            if ((data->Attributes & W3DVERTMAT_PSX_TRANS_MASK) == W3DVERTMAT_PSX_TRANS_NONE) {
                AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_PSX_TRANS_NONE", "flag");
            }
            if ((data->Attributes & W3DVERTMAT_PSX_TRANS_MASK) == W3DVERTMAT_PSX_TRANS_100) {
                AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_PSX_TRANS_100", "flag");
            }
            if ((data->Attributes & W3DVERTMAT_PSX_TRANS_MASK) == W3DVERTMAT_PSX_TRANS_50) {
                AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_PSX_TRANS_50", "flag");
            }
            if ((data->Attributes & W3DVERTMAT_PSX_TRANS_MASK) == W3DVERTMAT_PSX_TRANS_25) {
                AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_PSX_TRANS_25", "flag");
            }
            if ((data->Attributes & W3DVERTMAT_PSX_TRANS_MASK) == W3DVERTMAT_PSX_TRANS_MINUS_100) {
                AddItem(List, Counter, "Material.Attributes", "W3DVERTMAT_PSX_TRANS_MINUS_100",
                        "flag");
            }
        }
    }
...
void ChunkTableClass::List_W3D_CHUNK_TEXTURE_INFO(ChunkItem* Item, CListCtrl* List)
{
    ...
    if (data->Attributes & W3DTEXTURE_PUBLISH) {
        AddItem(List, Counter, "Attributes", "W3DTEXTURE_PUBLISH", "flag");
    }
    if (data->Attributes & W3DTEXTURE_NO_LOD) {
        AddItem(List, Counter, "Attributes", "W3DTEXTURE_NO_LOD", "flag");
    }
    if (data->Attributes & W3DTEXTURE_CLAMP_U) {
        AddItem(List, Counter, "Attributes", "W3DTEXTURE_CLAMP_U", "flag");
    }
    if (data->Attributes & W3DTEXTURE_CLAMP_V) {
        AddItem(List, Counter, "Attributes", "W3DTEXTURE_CLAMP_V", "flag");
    }
    if (data->Attributes & W3DTEXTURE_ALPHA_BITMAP) {
        AddItem(List, Counter, "Attributes", "W3DTEXTURE_ALPHA_BITMAP", "flag");
    }
...
{
    static char* _chntypes[] = { "X Translation", "Y Translation", "Z Translation", "X Rotation",
                                 "Y Rotation",    "Z Rotation",    "Quaternion" };
...
void ChunkTableClass::List_W3D_CHUNK_LIGHT_INFO(ChunkItem* Item, CListCtrl* List)
{
    ...
    if ((data->Attributes & W3D_LIGHT_ATTRIBUTE_TYPE_MASK) == W3D_LIGHT_ATTRIBUTE_POINT) {
        AddItem(List, counter, "Attributes", "W3D_LIGHT_ATTRIBUTE_POINT");
    }
    if ((data->Attributes & W3D_LIGHT_ATTRIBUTE_TYPE_MASK) == W3D_LIGHT_ATTRIBUTE_SPOT) {
        AddItem(List, counter, "Attributes", "W3D_LIGHT_ATTRIBUTE_SPOT");
    }
    if ((data->Attributes & W3D_LIGHT_ATTRIBUTE_TYPE_MASK) == W3D_LIGHT_ATTRIBUTE_DIRECTIONAL) {
        AddItem(List, counter, "Attributes", "W3D_LIGHT_ATTRIBUTE_DIRECTIONAL");
    }
    if (data->Attributes & W3D_LIGHT_ATTRIBUTE_CAST_SHADOWS) {
        AddItem(List, counter, "Attributes", "W3D_LIGHT_ATTRIBUTE_CAST_SHADOWS", "flag");
    }
...
void ChunkTableClass::List_W3D_CHUNK_EMITTER_ROTATION_KEYFRAMES(ChunkItem* Item, CListCtrl* List)
{
    ...
    W3dEmitterRotationKeyframeStruct* key
        = (W3dEmitterRotationKeyframeStruct*)((char*)Item->Data
...
void ChunkTableClass::List_W3D_CHUNK_EMITTER_FRAME_KEYFRAMES(ChunkItem* Item, CListCtrl* List)
{
    ...
    W3dEmitterFrameKeyframeStruct* key
        = (W3dEmitterFrameKeyframeStruct*)((char*)Item->Data + sizeof(W3dEmitterFrameHeaderStruct));
    char buf[256];
    for (unsigned int i = 0; i < header->KeyframeCount + 1; i++) {
        sprintf(buf, "Time[%d]", i);
        AddItem(List, counter, buf, key[i].Time);
...
void ChunkTableClass::List_W3D_CHUNK_EMITTER_BLUR_TIME_KEYFRAMES(ChunkItem* Item, CListCtrl* List)
{
    ...
    W3dEmitterBlurTimeKeyframeStruct* key
        = (W3dEmitterBlurTimeKeyframeStruct*)((char*)Item->Data
...
void ChunkTableClass::List_W3D_CHUNK_AGGREGATE_INFO(ChunkItem* Item, CListCtrl* List)
{
    ...
    char label[256];
    W3dAggregateSubobjectStruct* defs
        = (W3dAggregateSubobjectStruct*)((char*)Item->Data + sizeof(W3dAggregateInfoStruct));
...
ChunkTableClass::ChunkTableClass()
{
    ...
    NewType(W3D_CHUNK_SURRENDER_NORMALS, "W3D_CHUNK_SURRENDER_NORMALS",
            List_W3D_CHUNK_SURRENDER_NORMALS);
    ...
    NewType(O_W3D_CHUNK_SURRENDER_TRIANGLES, "O_W3D_CHUNK_SURRENDER_TRIANGLES",
            List_O_W3D_CHUNK_SURRENDER_TRIANGLES);
    NewType(O_W3D_CHUNK_POV_TRIANGLES, "O_W3D_CHUNK_POV_TRIANGLES", List_O_W3D_CHUNK_POV_TRIANGLES);
    NewType(O_W3D_CHUNK_POV_QUADRANGLES, "O_W3D_CHUNK_POV_QUADRANGLES",
            List_O_W3D_CHUNK_POV_QUADRANGLES);
    ...
    NewType(W3D_CHUNK_VERTEX_INFLUENCES, "W3D_CHUNK_VERTEX_INFLUENCES",
            List_W3D_CHUNK_VERTEX_INFLUENCES);
    ...
    NewType(W3D_CHUNK_MATERIAL3_DC_MAP, "W3D_CHUNK_MATERIAL3_DC_MAP",
            List_W3D_CHUNK_MATERIAL3_DC_MAP, true);
    NewType(W3D_CHUNK_MATERIAL3_DI_MAP, "W3D_CHUNK_MATERIAL3_DI_MAP",
            List_W3D_CHUNK_MATERIAL3_DI_MAP, true);
    NewType(W3D_CHUNK_MATERIAL3_SC_MAP, "W3D_CHUNK_MATERIAL3_SC_MAP",
            List_W3D_CHUNK_MATERIAL3_SC_MAP, true);
    NewType(W3D_CHUNK_MATERIAL3_SI_MAP, "W3D_CHUNK_MATERIAL3_SI_MAP",
            List_W3D_CHUNK_MATERIAL3_SI_MAP, true);
    ...
    NewType(W3D_CHUNK_PER_TRI_MATERIALS, "W3D_CHUNK_PER_TRI_MATERIALS",
            List_W3D_CHUNK_PER_TRI_MATERIALS);

    NewType(W3D_CHUNK_VERTEX_SHADE_INDICES, "W3D_CHUNK_VERTEX_SHADE_INDICES",
            List_W3D_CHUNK_VERTEX_SHADE_INDICES);
    ...
    NewType(W3D_CHUNK_VERTEX_MATERIALS, "W3D_CHUNK_VERTEX_MATERIALS",
            List_W3D_CHUNK_VERTEX_MATERIALS, true);
    NewType(W3D_CHUNK_VERTEX_MATERIAL, "W3D_CHUNK_VERTEX_MATERIAL", List_W3D_CHUNK_VERTEX_MATERIAL,
            true);
    NewType(W3D_CHUNK_VERTEX_MATERIAL_NAME, "W3D_CHUNK_VERTEX_MATERIAL_NAME",
            List_W3D_CHUNK_VERTEX_MATERIAL_NAME);
    NewType(W3D_CHUNK_VERTEX_MATERIAL_INFO, "W3D_CHUNK_VERTEX_MATERIAL_INFO",
            List_W3D_CHUNK_VERTEX_MATERIAL_INFO);
    NewType(W3D_CHUNK_VERTEX_MAPPER_ARGS0, "W3D_CHUNK_VERTEX_MAPPER_ARGS0",
            List_W3D_CHUNK_VERTEX_MAPPER_ARGS0);
    NewType(W3D_CHUNK_VERTEX_MAPPER_ARGS1, "W3D_CHUNK_VERTEX_MAPPER_ARGS1",
            List_W3D_CHUNK_VERTEX_MAPPER_ARGS1);
    ...
    NewType(W3D_CHUNK_VERTEX_MATERIAL_IDS, "W3D_CHUNK_VERTEX_MATERIAL_IDS",
            List_W3D_CHUNK_VERTEX_MATERIAL_IDS);
    ...
    NewType(W3D_CHUNK_PER_FACE_TEXCOORD_IDS, "W3D_CHUNK_PER_FACE_TEXCOORD_IDS",
            List_W3D_CHUNK_PER_FACE_TEXCOORD_IDS);
    ...
    NewType(W3D_CHUNK_AABTREE_POLYINDICES, "W3D_CHUNK_AABTREE_POLYINDICES",
            List_W3D_CHUNK_AABTREE_POLYINDICES);
    ...
    NewType(W3D_CHUNK_HIERARCHY_HEADER, "W3D_CHUNK_HIERARCHY_HEADER",
            List_W3D_CHUNK_HIERARCHY_HEADER);
    ...
    NewType(W3D_CHUNK_ANIMATION_HEADER, "W3D_CHUNK_ANIMATION_HEADER",
            List_W3D_CHUNK_ANIMATION_HEADER);
    NewType(W3D_CHUNK_ANIMATION_CHANNEL, "W3D_CHUNK_ANIMATION_CHANNEL",
            List_W3D_CHUNK_ANIMATION_CHANNEL);
    ...
    NewType(OBSOLETE_W3D_CHUNK_HMODEL_AUX_DATA, "W3D_CHUNK_HMODEL_AUX_DATA",
            List_W3D_CHUNK_HMODEL_AUX_DATA);
    NewType(OBSOLETE_W3D_CHUNK_SHADOW_NODE, "OBSOLETE_W3D_CHUNK_SHADOW_NODE",
            List_W3D_CHUNK_SHADOW_NODE);
    ...
    NewType(W3D_CHUNK_COLLECTION_HEADER, "W3D_CHUNK_COLLECTION_HEADER",
            List_W3D_CHUNK_COLLECTION_HEADER);
    NewType(W3D_CHUNK_COLLECTION_OBJ_NAME, "W3D_CHUNK_COLLECTION_OBJ_NAME",
            List_W3D_CHUNK_COLLECTION_OBJ_NAME);
    ...
    NewType(W3D_CHUNK_NEAR_ATTENUATION, "W3D_CHUNK_NEAR_ATTENUATION",
    ...
    NewType(W3D_CHUNK_EMITTER_USER_DATA, "W3D_CHUNK_EMITTER_USER_DATA",
            List_W3D_CHUNK_EMITTER_USER_DATA);
    ...
    NewType(OBSOLETE_W3D_CHUNK_EMITTER_COLOR_KEYFRAME, "OBSOLETE_W3D_CHUNK_EMITTER_COLOR_KEYFRAME",
            List_W3D_CHUNK_EMITTER_COLOR_KEYFRAME);
    NewType(OBSOLETE_W3D_CHUNK_EMITTER_OPACITY_KEYFRAME,
            "OBSOLETE_W3D_CHUNK_EMITTER_OPACITY_KEYFRAME", List_W3D_CHUNK_EMITTER_OPACITY_KEYFRAME);
    NewType(OBSOLETE_W3D_CHUNK_EMITTER_SIZE_KEYFRAME, "OBSOLETE_W3D_CHUNK_EMITTER_SIZE_KEYFRAME",
            List_W3D_CHUNK_EMITTER_SIZE_KEYFRAME);
    NewType(W3D_CHUNK_EMITTER_ROTATION_KEYFRAMES, "W3D_CHUNK_EMITTER_ROTATION_KEYFRAMES",
            List_W3D_CHUNK_EMITTER_ROTATION_KEYFRAMES);
    NewType(W3D_CHUNK_EMITTER_FRAME_KEYFRAMES, "W3D_CHUNK_EMITTER_FRAME_KEYFRAMES",
            List_W3D_CHUNK_EMITTER_FRAME_KEYFRAMES);
    NewType(W3D_CHUNK_EMITTER_BLUR_TIME_KEYFRAMES, "W3D_CHUNK_EMITTER_BLUR_TIME_KEYFRAMES",
            List_W3D_CHUNK_EMITTER_BLUR_TIME_KEYFRAMES);

    NewType(W3D_CHUNK_AGGREGATE, "W3D_CHUNK_AGGREGATE", List_W3D_CHUNK_AGGREGATE, true);
    NewType(W3D_CHUNK_AGGREGATE_HEADER, "W3D_CHUNK_AGGREGATE_HEADER",
            List_W3D_CHUNK_AGGREGATE_HEADER);
    NewType(W3D_CHUNK_AGGREGATE_INFO, "W3D_CHUNK_AGGREGATE_INFO", List_W3D_CHUNK_AGGREGATE_INFO);
    NewType(W3D_CHUNK_TEXTURE_REPLACER_INFO, "W3D_CHUNK_TEXTURE_REPLACER_INFO",
            List_W3D_CHUNK_TEXTURE_REPLACER_INFO);
    NewType(W3D_CHUNK_AGGREGATE_CLASS_INFO, "W3D_CHUNK_AGGREGATE_CLASS_INFO",
            List_W3D_CHUNK_AGGREGATE_CLASS_INFO);
    ...
    NewType(W3D_CHUNK_HLOD_LOD_ARRAY, "W3D_CHUNK_HLOD_LOD_ARRAY", List_W3D_CHUNK_HLOD_LOD_ARRAY,
            true);
    NewType(W3D_CHUNK_HLOD_SUB_OBJECT_ARRAY_HEADER, "W3D_CHUNK_HLOD_LOD_ARRAY_HEADER",
    ...
    NewType(W3D_CHUNK_HLOD_AGGREGATE_ARRAY, "W3D_CHUNK_HLOD_AGGREGATE_ARRAY",
            List_W3D_CHUNK_HLOD_LOD_ARRAY, true);
    NewType(W3D_CHUNK_HLOD_PROXY_ARRAY, "W3D_CHUNK_HLOD_PROXY_ARRAY", List_W3D_CHUNK_HLOD_LOD_ARRAY,
            true);
    ...
    NewType(W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_PASS, "W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_PASS",
    ...
    NewType(W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_TEXTURE, "W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_TEXTURE",
            List_W3D_CHUNK_PRELIT_LIGHTMAP_MULTI_TEXTURE, true);
    NewType(W3D_CHUNK_LIGHTSCAPE, "W3D_CHUNK_LIGHTSCAPE", List_W3D_CHUNK_LIGHTSCAPE, true);
    NewType(W3D_CHUNK_LIGHTSCAPE_LIGHT, "W3D_CHUNK_LIGHTSCAPE_LIGHT",
            List_W3D_CHUNK_LIGHTSCAPE_LIGHT, true);
...
ChunkItem::ChunkItem(ChunkLoadClass& cload)
{
    ...
    // if the chunktype indicates that it has member chunks then do not load this chunk's data. Have
    // the external caller do that.
