...
BOOL RingSizePropPageClass::OnInitDialog(void)
{
    ...
    for (int index = 1; index < m_OrigInnerScaleChannel.Get_Key_Count(); index++) {
        const LERPAnimationChannelClass<Vector2>::KeyClass& prev_value
            = m_OrigInnerScaleChannel.Get_Key(index - 1);
        const LERPAnimationChannelClass<Vector2>::KeyClass& curr_value
            = m_OrigInnerScaleChannel.Get_Key(index);
        ...
        if (index == (m_OrigInnerScaleChannel.Get_Key_Count() - 1)) {
            ...
            const LERPAnimationChannelClass<Vector2>::KeyClass& next_value
                = m_OrigInnerScaleChannel[index + 1];
    ...
    for (index = 1; index < m_OrigOuterScaleChannel.Get_Key_Count(); index++) {
        const LERPAnimationChannelClass<Vector2>::KeyClass& prev_value
            = m_OrigOuterScaleChannel.Get_Key(index - 1);
        const LERPAnimationChannelClass<Vector2>::KeyClass& curr_value
            = m_OrigOuterScaleChannel.Get_Key(index);
        ...
        if (index == (m_OrigOuterScaleChannel.Get_Key_Count() - 1)) {
            ...
            const LERPAnimationChannelClass<Vector2>::KeyClass& next_value
                = m_OrigOuterScaleChannel[index + 1];
