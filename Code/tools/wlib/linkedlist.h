...
template <class T> bit8 LinkedList<T>::add(IN T& node, sint32 pos, OUT T** newnodeptr)
{
    LNode<T>* temp;
    LNode<T>* item;
...
template <class T> bit8 LinkedList<T>::addHead(IN T& node, OUT T** newnodeptr)
{
    return (add(node, 0, newnodeptr));
}

// Append to the end of the list
template <class T> bit8 LinkedList<T>::addTail(IN T& node, OUT T** newnodeptr)
{
...
template <class T> bit8 LinkedList<T>::remove(OUT T& node, sint32 pos)
{
    ////////LNode<T> *temp;
    LNode<T>* item;
...
// Remove at the zero based index specified by 'pos'.  When removing from
// a slot, all others get shifted up by one.
template <class T> bit8 LinkedList<T>::remove(sint32 pos)
{
    T temp_node;
...
template <class T> bit8 LinkedList<T>::removeHead(OUT T& node)
{
    return (remove(node, 0));
}

// Remove the last node of the list
template <class T> bit8 LinkedList<T>::removeTail(OUT T& node)
{
    return (remove(node, Entries - 1));
}

template <class T> bit8 LinkedList<T>::get(OUT T& node, sint32 pos)
{
    T* objptr;
...
template <class T> bit8 LinkedList<T>::getPointer(OUT T** node, sint32 pos)
{
    if ((node == 0) || (Entries == 0)) {
        return (FALSE);
    }
...
// Remove the first node of the list
template <class T> bit8 LinkedList<T>::getHead(OUT T& node)
{
    return (get(node, 0));
}

// Remove the last node of the list
template <class T> bit8 LinkedList<T>::getTail(OUT T& node)
{
    return (get(node, Entries - 1));
}

template <class T> void LinkedList<T>::print(IN FILE* out)
{
    LNode<T>* temp;
...
template <class T> sint32 LinkedList<T>::length(void)
{
    return (Entries);
}
