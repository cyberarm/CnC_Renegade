...
BOOL AudioConfigDialogClass::OnInitDialog(void)
{
    ...
    SendDlgItemMessage(IDC_QUALITY_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_8_BIT, string));
    SendDlgItemMessage(IDC_QUALITY_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_16_BIT, string));
    ...
    SendDlgItemMessage(IDC_RATE_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_11_KHZ, string));
    SendDlgItemMessage(IDC_RATE_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_22_KHZ, string));
    SendDlgItemMessage(IDC_RATE_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_44_KHZ, string));
    ...
    SendDlgItemMessage(IDC_SPEAKER_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_2_SPEAKER, string));
    SendDlgItemMessage(IDC_SPEAKER_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_HEADPHONE, string));
    SendDlgItemMessage(IDC_SPEAKER_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_SURROUND_SOUND, string));
    SendDlgItemMessage(IDC_SPEAKER_COMBO, CB_ADDSTRING, 0,
                       (LPARAM)Locale_GetString(IDS_4_SPEAKER, string));
    ...
    WWAudioClass::Get_Instance()->Load_From_Registry(
        RENEGADE_SUB_KEY_NAME_AUDIO, device_name, is_stereo, bits, hertz, sound_on, music_on,
        dialog_on, cinematic_on, sound_vol, music_vol, dialog_vol, cinematic_vol, speaker_type);
...
void AudioConfigDialogClass::Apply_Changes(void)
{
    ...
    //
    WWAudioClass::Get_Instance()->Save_To_Registry(
        RENEGADE_SUB_KEY_NAME_AUDIO, device_name, is_stereo, bits, hertz, sound_on, music_on,
        dialog_on, cinematic_on, sound_vol, music_vol, dialog_vol, cinematic_vol, speaker_type);
    return;
}
