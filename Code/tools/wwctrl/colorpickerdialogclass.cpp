...
HWND Create_Color_Picker_Form(HWND parent, int red, int green, int blue)
{
    ...
    ColorPickerDialogClass* dialog
        = new ColorPickerDialogClass(red, green, blue, parent_wnd, IDD_COLOR_FORM);
...
//
/////////////////////////////////////////////////////////////////////////////
ColorPickerDialogClass::ColorPickerDialogClass(int red, int green, int blue, CWnd* pParent,
                                               UINT res_id)
    : m_OrigRed((float)red),
...
{
    Update_Color(m_OrigRed, m_OrigGreen, m_OrigBlue,
                 UPDATE_COLOR_BARS | UPDATE_WHITENESS | UPDATE_HUE_PICKER);
    return;
}
