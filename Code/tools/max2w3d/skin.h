...
public:
    ...
    */
    void DeleteThis()
    {
        OutputDebugString("Deleting SkinWSMObjectClass");
        delete this;
    }
    ...
    */
    ...
    /*
    ** From Reference Maker.  These three functions give access to the "virtual array" of
    *references.
    ...
    */
    BOOL SkinWSMObjectClass::Skeleton_Dialog_Proc(HWND hWnd, UINT message, WPARAM wParam,
                                                  LPARAM lParam);
    ...
    ** Friend functions
    */
    friend BOOL CALLBACK _skeleton_dialog_thunk(HWND hWnd, UINT message, WPARAM wParam,
                                                LPARAM lParam);
};
...
public:
    ...
    */
    virtual void NotifyInputChanged(Interval changeInt, PartID partID, RefMessage message,
                                    ModContext* mc)
    {
    }
    ...
    */
    ...
    int HitTest(TimeValue t, INode* inode, int type, int crossing, int flags, IPoint2* p,
...
public:
    ...
    */
    friend BOOL CALLBACK _bone_influence_dialog_thunk(HWND hWnd, UINT message, WPARAM wParam,
                                                      LPARAM lParam);
};
