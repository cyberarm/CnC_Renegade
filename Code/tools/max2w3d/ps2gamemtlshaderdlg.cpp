...
static char* _PS2ShaderBlendSettingPresetNames[NUM_PS2_SHADER_BLEND_PRESETS + 1]
    = { "Opaque",      "Additive",   "Source Subtracted",    "Destination Subtracted",
 ...
 *=============================================================================================*/
PS2GameMtlShaderDlg::PS2GameMtlShaderDlg(HWND parent, IMtlParams* imp, GameMtl* mtl, int pass)
...
void PS2GameMtlShaderDlg::ReloadDialog(void)
{
    ...
    SendDlgItemMessage(m_hWnd, IDC_A_COMBO, CB_SETCURSEL, TheMtl->Get_PS2_Shader_Param_A(PassIndex),
                       0);
    SendDlgItemMessage(m_hWnd, IDC_B_COMBO, CB_SETCURSEL, TheMtl->Get_PS2_Shader_Param_B(PassIndex),
                       0);
    SendDlgItemMessage(m_hWnd, IDC_C_COMBO, CB_SETCURSEL, TheMtl->Get_PS2_Shader_Param_C(PassIndex),
                       0);
    SendDlgItemMessage(m_hWnd, IDC_D_COMBO, CB_SETCURSEL, TheMtl->Get_PS2_Shader_Param_D(PassIndex),
                       0);
...
void PS2GameMtlShaderDlg::Apply_Preset(int preset_index)
{
    ...
    int depth_mask
        = preset.DepthMask ? W3DSHADER_DEPTHMASK_WRITE_ENABLE : W3DSHADER_DEPTHMASK_WRITE_DISABLE;
