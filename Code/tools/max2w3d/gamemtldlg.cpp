...
void GameMtlDlg::Build_Dialog(HWND hParent) // = nullptr
{
    ...
    HwndSurfaceType = IParams->AddRollupPage(
        AppInstance, MAKEINTRESOURCE(IDD_GAMEMTL_SURFACE_TYPE), SurfaceTypePanelDlgProc,
        Get_String(IDS_SURFACE_TYPE), (LPARAM)this,
        TheMtl->Get_Flag(GAMEMTL_SURFACE_ROLLUP_OPEN) ? 0 : APPENDROLL_CLOSED);
#ifdef WANT_DISPLACEMENT_MAPS
    HwndDisplacementMap = IParams->AddRollupPage(
        AppInstance, MAKEINTRESOURCE(IDD_GAMEMTL_DISPLACEMENT_MAP), DisplacementMapDlgProc,
        Get_String(IDS_DISPLACEMENT_MAP), (LPARAM)this,
        TheMtl->Get_Flag(GAMEMTL_DISPLACEMENT_ROLLUP_OPEN) ? 0 : APPENDROLL_CLOSED);
#endif // WANT_DISPLACEMENT_MAPS

    HwndPassCount = IParams->AddRollupPage(
        AppInstance, MAKEINTRESOURCE(IDD_GAMEMTL_PASS_COUNT), PassCountPanelDlgProc,
        Get_String(IDS_PASS_COUNT), (LPARAM)this,
