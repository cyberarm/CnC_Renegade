 ...
 *                                                                                             *
 * INPUT:                                                                                      *
 *	The contents of the given array is assumed to be as follows: * lod_count (int)
 *- the number of LOD models that will be created                  * lod_offset (float)		- X
 *offset to move the LODs by                                   * lod_clone (int)
 *- 1==copy 2==instance 3==reference                               * damage_count (int)		-
 *the number of damage models that will be created               * damage_offset (float)	- Y
 *offset to move the LODs by                                   * damage_clone (int)		-
