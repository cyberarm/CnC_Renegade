...
public:
    ...
    enum
    {
        IDD = IDD_PHYSICS_OBJECT_EDIT_CONTAINER
    };
...
public:
    ...
    ModelDefParameterClass* Get_PhysDef_Param(void) const
    {
        return m_ObjectEditForm.Get_PhysDef_Param();
    }
    void Set_PhysDef_Param(ModelDefParameterClass* param)
    {
        m_ObjectEditForm.Set_PhysDef_Param(param);
    }
