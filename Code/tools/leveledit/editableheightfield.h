...
public:
    ...
    void Create(const char* heightmap_filename, float width, float height, float meters_per_point,
                float scale);
    ...
    //	Height editing
    //
    void Deform_Heightfield(const Vector3& center, float amount, float inner_radius,
                            float outter_radius);
    void Smooth_Heightfield(const Vector3& center, float amount, float inner_radius,
                            float outter_radius);
    void Smooth_Foundation_Heightfield(const Vector3& center, float amount, float inner_radius,
                                       float outter_radius);
    void Paint_Heightfield(const Vector3& world_space_center, int texture_index, float amount,
