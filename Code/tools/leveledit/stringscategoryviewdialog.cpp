...
BOOL StringsCategoryViewDialogClass::OnInitDialog(void)
{
    ...
    //
    for (TDBObjClass* object = TranslateDBClass::Get_First_Object(CategoryID); object != nullptr;
...
int StringsCategoryViewDialogClass::Find_Entry(TDBObjClass* object)
{
    ...
    for (int index = 0; index < m_ListCtrl.GetItemCount(); index++) {
        ...
        //
        if (curr_object != nullptr && curr_object->Get_ID() == object->Get_ID()) {
            object_index = index;
            break;
        }
    }
...
void StringsCategoryViewDialogClass::OnDblclkStringList(NMHDR* pNMHDR, LRESULT* pResult)
{
    ...
    //
    StringTwiddlerClass* twiddler = nullptr;
    if (object != nullptr) {
    ...
    if (EditMode == EDIT_MODE_TWIDDLER && object == nullptr) {
        show_edit_string = false;
    }
    else if (twiddler != nullptr) {
        show_edit_string = false;
    }
...
void StringsCategoryViewDialogClass::Resize_Controls(void)
{
    ...
    //
    m_ListCtrl.SetWindowPos(nullptr, rect.left, rect.top, rect.Width(), rect.Height(),
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Cut(DynamicVectorClass<TDBObjClass*>& entry_list,
                                         bool sel_only)
{
