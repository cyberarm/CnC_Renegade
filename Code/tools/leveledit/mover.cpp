...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Position_Nodes_Along_Ray(NODE_LIST& list, const Vector3& tracking_pt,
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Position_Node_Along_Ray(NodeClass* node, const Vector3& start,
                                            const Vector3& end)
{
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_XY(float plane, const Vector3& ray_start,
                                          const Vector3& ray_end, Vector3& result)
{
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_XZ(float plane, const Vector3& ray_start,
                                          const Vector3& ray_end, Vector3& result)
{
    // Assume no intersection
    bool intersected = false;
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_YZ(float plane, const Vector3& ray_start,
                                          const Vector3& ray_end, Vector3& result)
{
    // Assume no intersection
    bool intersected = false;
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Calc_New_Position(const Matrix3D& coord_system,
                                      const Vector3& start_in_world_coords, LPPOINT mouse_pos)
{
    ...
    if ((::GetKeyState(VK_SHIFT) < 0)
        ...
        if (Calc_Ray_Intersection_XY(start_point.Z, ray_start, ray_end, result)) {
            ...
            else if (::Get_Current_Document()->Get_Axis_Restriction()
                     == CLevelEditDoc::RESTRICT_Y) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes(NODE_LIST& list, const Matrix3D& rotation_matrix,
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node_Z90(NodeClass* node, const Matrix3D& rotation_matrix,
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node_Freely(NodeClass* node, const Matrix3D& rotation_matrix,
                                    const Matrix3D& coord_system)
{
    if (node->Is_Locked() == false) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node(NodeClass* node, const Matrix3D& rotation_matrix,
                             const Matrix3D& coord_system)
{
    //
