...
void MouseMgrClass::Move_Node(NodeClass* node)
{
    ...
    ((MMObjectManipulateClass*)m_pModeObjects[MOUSE_MODE::MODE_OBJECT_MANIPULATE])
        ->Set_Move_Nodes_Mode();
    return;
}
...
void MMObjectManipulateClass::Move_Selection(CPoint point)
{
    if (m_ForceDropToGround
        ...
        m_CurrentMovePos
            = MoverClass::Position_Nodes_Along_Ray(list, tracking_pt, ray_start, ray_end);
    }
    else {
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_RButton_Down(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_RButton_Up(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_LButton_Down(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_LButton_Up(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_RButton_Down(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_RButton_Up(UINT flags, CPoint point)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::On_Mode_Set(void)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::On_Mode_Exit(void)
{
    return;
}
