...
//
UINT Message_Box(HWND hparentwnd, UINT message_id, UINT title_id,
                 UINT style = MB_ICONEXCLAMATION | MB_OK);
...
bool Get_File_Time(LPCTSTR path, LPFILETIME pcreation_time = nullptr, LPFILETIME paccess_time = nullptr,
...
typedef UINT (*MY_UITHREADPROC)(DWORD dwparam1, DWORD dwparam2, DWORD dwparam3, HRESULT* presult,
                                HWND* phmain_wnd);
...
public:
    ...
    FileAccessRightsClass(LPCTSTR filename, ACCESS_TYPE type = WANTS_WRITEABLE,
