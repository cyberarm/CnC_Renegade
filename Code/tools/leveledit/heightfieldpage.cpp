...
BOOL HeightfieldPageClass::OnInitDialog(void)
{
    ...
    //
    ::SetDlgItemFloat(m_hWnd, IDC_BRUSH_INNER_RADIUS_EDIT,
                      HeightfieldEditorClass::Get_Brush_Inner_Radius());
    ::SetDlgItemFloat(m_hWnd, IDC_BRUSH_OUTTER_RADIUS_EDIT,
                      HeightfieldEditorClass::Get_Brush_Outter_Radius());
...
void HeightfieldPageClass::Update_Material_Button(int index)
{
    ...
    if (button_wnd != nullptr) {
        ...
        if (material != nullptr) {
            ...
            //
            thumbnail = HeightfieldEditorClass::Create_Texture_Thumbnail(
                material->Get_Texture_Name(), 48, 48);
        }
