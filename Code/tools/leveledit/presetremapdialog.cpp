                ...
                if (item_index >= 0) {
                    ...
                    if (separator != nullptr) {
                        ...
                        if (candidate_preset != nullptr) {
                            ...
                            m_ListCtrl.SetItemText(item_index, COL_PRESET,
                                                   candidate_preset->Get_Name());
                        }
                    }
                }
            }
    ...
    if (item_index >= 0) {
        ...
        if (node != nullptr) {
            ...
            if (dialog.DoModal() == IDOK) {
                ...
                //
                if (MessageBox("Would you like to propagate this preset to all other nodes of the "
                               "same original preset?",
