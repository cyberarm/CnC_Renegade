...
{
public:
    TreeStateCaptureClass(CTreeCtrl& tree_ctrl, HTREEITEM* item_handle,
                          ConversationClass** conversation_ptr)
        : ConversationID(0),
...
void ConversationPageClass::OnItemexpandedConversationTree(NMHDR* pNMHDR, LRESULT* pResult)
{
    ...
    //
    if (m_TreeCtrl.GetItemData(pNMTreeView->itemNew.hItem) == nullptr) {
...
//
////////////////////////////////////////////////////////////////////////////
void ConversationPageClass::Reload_Tree(HTREEITEM* item_handle,
                                        ConversationClass** conversation_ptr)
{
