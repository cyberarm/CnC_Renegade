...
public:
    ...
    static void SetTypePrecision(EncoderType type, float min, float max, float resolution);

    // Set the type precision based on desired bit width.
    static void SetTypePrecision(EncoderType type, float min, float max, unsigned int bitPrecision);
