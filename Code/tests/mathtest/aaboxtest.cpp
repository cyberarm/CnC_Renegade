...
public:
    ...
    AABoxTriTestClass(const Vector3 c, // center of box
...
AABoxTriTestClass Test0(Vector3(0, 0, 0), // box starting at origing
...
AABoxTriTestClass Test1(Vector3(3, 0, 0), Vector3(1, 2, 1), Vector3(0, -2, 0), Vector3(1, -3, 0),
                        Vector3(2, -3, 5), Vector3(6, -3, 1), 0.5f, false);

AABoxTriTestClass Test2(Vector3(-3.5, -1.5, 0), // sweeping a 3x3 box along pos x and neg y
                        Vector3(1.5, 1.5, 1.5), Vector3(4, -4, 0),
...
AABoxTriTestClass Test3(
    ...
    Vector3(4, -4, 0), Vector3(-4, -4, -1), // into a polygon in y-z plane
    Vector3(-2, -4, 5), Vector3(0, -4, 1), 0.0f, false);

AABoxTriTestClass Test4(Vector3(-3.5f, -1.5f, 0), // Same as test 2
                        Vector3(1.5f, 1.5f, 1.5f), Vector3(4, -4, 0),
                        Vector3(-9, -4,
                                -1), // into a polygon in y-z plane *but* just barely not in the way
                        Vector3(-8, -4, 5), Vector3(-4.001f, -4, 0),
                        1.0f, // should move 100%
                        false);

AABoxTriTestClass Test5(Vector3(-3.5, -1.5, 0), // Same as test 3 with box brushing polygon vertex.
                        Vector3(1.5, 1.5, 1.5), Vector3(4, -4, 0),
                        Vector3(-9, -4,
...
AABoxTriTestClass Test6(Vector3(-3.5, -1.5, 0), // Same as test 3 with box brushing polygon vertex.
                        Vector3(1.5, 1.5, 1.5), Vector3(4, -4, 0),
                        Vector3(-9, -4,
                                -1), // into a polygon in y-z plane just touching path of box
                        Vector3(-8, -4, 5), Vector3(-4, -4, 0),
...
AABoxTriTestClass Test7(Vector3(0, 0, 0), // This is a case where the box starts out intersecting
                        Vector3(5, 5, 5), Vector3(4, 4, 0), Vector3(1, 4, -1), Vector3(2, 4, 5),
                        Vector3(5, 4, 0), 0.0f, true);

AABoxTriTestClass Test8(Vector3(-2.5, 2, 0), Vector3(1.5, 1, 1), Vector3(3, 0, 0), Vector3(1, 2, 0),
                        Vector3(3, 4, 5), Vector3(4, 5, -1), 0.66666667f, true);
