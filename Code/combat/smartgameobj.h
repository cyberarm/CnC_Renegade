...
public:
    ...
    void Set_Analog_Control(ControlClass::AnalogControl control, float value)
    {
        Control.Set_Analog(control, value);
    }
    ...
    // Is_Stealth_Enabled - is this object's cloaking device turned on?  (may not be cloaked yet
    // though) Is_Stealthed - is the object actually stealthed (takes some time to turn on and
    // off...) Get_Stealth_Fade_Distance - humans and vehicles fade in at different distances.
    //
