...
////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<AirStripGameObjDef, CHUNKID_GAME_OBJECT_DEF_AIRSTRIP>
    _AirStripGameObjDefPersistFactory;
SimplePersistFactoryClass<AirStripGameObj, CHUNKID_GAME_OBJECT_AIRSTRIP>
    _AirStripGameObjPersistFactory;
...
//
////////////////////////////////////////////////////////////////
uint32 AirStripGameObjDef::Get_Class_ID(void) const
{
...
bool AirStripGameObjDef::Save(ChunkSaveClass& csave)
{
    ...
    WRITE_MICRO_CHUNK(csave, MICROCHUNKID_DEF_CINEMATIC_LENGTH_TO_DROPOFF,
                      CinematicLengthToDropOff);
    ...
    WRITE_MICRO_CHUNK(csave, MICROCHUNKID_DEF_DISPLAY_VEHICLE_TIME,
...
void AirStripGameObjDef::Load_Variables(ChunkLoadClass& cload)
{
    while (cload.Open_Micro_Chunk()) {
        ...
        switch (cload.Cur_Micro_Chunk_ID()) {
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_CINEMATIC_LENGTH_TO_DROPOFF,
                             CinematicLengthToDropOff);
            ...
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_DISPLAY_VEHICLE_TIME,
                             CinematicLengthToVehicleDisplay);
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& AirStripGameObjDef::Get_Factory(void) const
{
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& AirStripGameObj::Get_Factory(void) const
{
