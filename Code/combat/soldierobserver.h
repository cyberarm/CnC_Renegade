...
public:
    ...
    virtual void Action_Complete(GameObject* obj, int action_id,
...
private:
    ...
    */
    ...
    void Action_Face_Location(SoldierGameObj* soldier, const Vector3& location,
                              SoldierAIState ai_state, bool crouched = false);
    void Action_Goto_Location(SoldierGameObj* soldier, const Vector3& location,
                              SoldierAIState ai_state, float speed = 1.0f, float distance = 1.0f,
                              bool crouched = false);
    void Action_Goto_Location_Facing(SoldierGameObj* soldier, const Vector3& location,
                                     SoldierAIState ai_state, const Vector3& facing_pos,
                                     float speed = 1.0f, float distance = 1.0f,
                                     bool crouched = false);
    void Action_Attack_Object(SoldierGameObj* soldier, PhysicalGameObj* enemy, float range,
    ...
    bool Take_Cover(SoldierGameObj* soldier, bool force_face = false,
                    const Vector3& face_pos = Vector3(0, 0, 0));
