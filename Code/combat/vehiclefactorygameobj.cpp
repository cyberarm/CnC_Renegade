...
DECLARE_DEFINITION_FACTORY(VehicleFactoryGameObjDef, CLASSID_GAME_OBJECT_DEF_VEHICLE_FACTORY,
                           "Vehicle Factory")
...
//
////////////////////////////////////////////////////////////////
uint32 VehicleFactoryGameObjDef::Get_Class_ID(void) const
{
...
int VehicleFactoryGameObj::Get_Team_Vehicle_Count(void) const
{
    ...
    for (smart_objnode = GameObjManager::Get_Smart_Game_Obj_List()->Head(); smart_objnode;
        ...
        if ((obj != nullptr) && (obj != harvy) && (obj->Peek_Physical_Object() != nullptr)
...
//
////////////////////////////////////////////////////////////////
bool VehicleFactoryGameObj::Request_Vehicle(int definition_id, float generation_time,
                                            SoldierGameObj* purchaser)
{
    bool retval = false;
...
void VehicleFactoryGameObj::Destroy_Blocking_Objects(void)
{
    ...
    PhysicsSceneClass::Get_Instance()->Collect_Objects(GeneratingRegion, false, true,
                                                       &objs_to_kill);
...
void VehicleFactoryGameObj::Deliver_Vehicle(void)
{
    ...
    if (pathfind != nullptr) {
        ...
        if (path != nullptr) {
            ...
            LastDeliveryPath
                = (LastDeliveryPath + 1) % pathfind->Count_Waypaths_Starting_In_Box(box);
