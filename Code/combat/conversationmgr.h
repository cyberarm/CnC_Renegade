...
public:
    ...
    static int Get_Conversation_Count(int category_index)
    {
        return ConversationList[category_index].Count();
    }
    ...
    //
    static ActiveConversationClass*
    Create_New_Conversation(ConversationClass* conversation,
    ...
    static ActiveConversationClass*
    Start_Conversation(PhysicalGameObj* orator, const char* conversation_name, bool force = false);
    static ActiveConversationClass* Start_Conversation(PhysicalGameObj* orator, int conversation_id,
                                                       bool force = false);
    static ActiveConversationClass* Start_Conversation(PhysicalGameObj* orator,
                                                       ConversationClass* conversation,
                                                       bool force = false);
    static ConversationClass*
    Pick_Conversation(PhysicalGameObj* initiator,
...
protected:
    ...
    //	Protected methods
    ////////////////////////////////////////////////////////////////
    static void Build_Buddy_List(PhysicalGameObj* orator,
                                 DynamicVectorClass<PhysicalGameObj*>& list, bool include_soldier);
    static bool Test_Conversation(PhysicalGameObj* initiator, ConversationClass* conversation,
                                  DynamicVectorClass<PhysicalGameObj*>& buddy_list,
                                  bool force = false);
    static bool Test_Orator(ConversationClass* conversation, OratorClass* orator,
