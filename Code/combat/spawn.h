...
public:
    ...
    const DynamicVectorClass<int>& Get_Spawn_Definition_ID_List(void) const
    {
        return SpawnDefinitionIDList;
    }
...
// int						SpawnNumber;				// These are
// used for sequenced spawns static int				GlobalSpawnNumber;
