...
public:
    ...
    virtual float Get_Damage_Factor(ArmedGameObj* p_armed_damager, PhysicalGameObj* p_phys_victim)
        = 0;
...
public:
    ...
    static void Set_Combat_Network_Handler(CombatNetworkHandlerClass* handler)
    {
    ...
    static void Toggle_Skeleton_Slider_Demo(void)
    {
        EnableSkeletonSliderDemo = !EnableSkeletonSliderDemo;
    }
    ...
    static void Show_Star_Damage_Direction(int direction)
    {
        StarDamageDirection |= 1 << (direction & 7);
    }
