...
public:
    ...
    */
    ...
    { // ONLY ADD TO THE END.....
        ...
        HITTER_TYPE_EJECT_CASING, // casings ejected from weapons (all are assumed to make the same
                                  // sounds)
    ...
    static void Update_Persistant_Sound(PersistantSurfaceSoundClass* effect, int surface_type,
    ...
    static void Update_Persistant_Emitter(PersistantSurfaceEmitterClass* effect, int surface_type,
                                          int hitter_type, const Matrix3D& tm);
