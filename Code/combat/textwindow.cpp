...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Set_Backdrop(const char* texture_name, const RectClass& screen_rect,
                                   const Vector2& texture_size, const RectClass& endcap_rect,
                                   const RectClass& fadeout_rect, const RectClass& textback_rect)
{
    Free_Backdrop();
    ...
    if (texture != nullptr) {
        ...
        if (percent > 0) {
            ...
            textback_screen_rect.Bottom
                = textback_screen_rect.Top + (textback_screen_rect.Height() * percent);
            fadeout_screen_rect1.Bottom
                = fadeout_screen_rect1.Top + (fadeout_screen_rect1.Height() * percent);
            fadeout_screen_rect2.Bottom
                = fadeout_screen_rect2.Top + (fadeout_screen_rect2.Height() * percent);
        ...
        if (percent > 0) {
            ...
            endcap_screen_rect1.Bottom
                = endcap_screen_rect1.Top + (endcap_screen_rect1.Height() * percent);
            endcap_screen_rect2.Bottom
                = endcap_screen_rect2.Top + (endcap_screen_rect2.Height() * percent);
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::On_Frame_Update(void)
{
    return;
}
...
//
////////////////////////////////////////////////////////////////
int TextWindowClass::Get_Item_Count(void) const
{
