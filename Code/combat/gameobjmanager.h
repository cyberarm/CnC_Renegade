...
**
** In the editor, building objects will be created and added to this manager.  In the game, they
*will
** be loaded.  After a level has been loaded, the 'Init_Level_Buildings' function should be called.
** This manager will be the entry point for any operations that need to happen on all existing
*buildings
