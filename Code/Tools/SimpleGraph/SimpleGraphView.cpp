...
//
/////////////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnDraw(CDC* dc)
{
...
//
/////////////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Repaint_Graph(void)
{
    CRect rect;
    Get_Graph_Rect(rect);
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Render_Axis(CDC* dc)
{
    CRect view_rect;
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Render_Graph(CDC* dc)
{
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Render_Points(CDC* dc)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Get_Visible_Points(int* left_pt, int* right_pt)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
...
//
///////////////////////////////////////////////////////////////////////
CSimpleGraphView::HITTYPE CSimpleGraphView::Hit_Test(const CPoint& point, int* hit_pt)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
    ...
    if ((point.x >= 0 && point.x < graph_area.left) || (point.y >= 0 && point.y < graph_area.top)) {
        retval = HIT_AXIS;
    }
        ...
        for (int index = 0; index < count; index++) {
            ...
            //
            if (::abs(graph_x - point.x) < 8 && ::abs(graph_y - point.y) < 8) {
                (*hit_pt) = index;
                retval = HIT_POINT;
                break;
            }
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnLButtonDown(UINT nFlags, CPoint point)
{
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnLButtonUp(UINT nFlags, CPoint point)
{
    if (m_DraggingPt >= 0) {
        ::ReleaseCapture();
        m_DraggingPt = -1;
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnMouseMove(UINT nFlags, CPoint point)
{
...
//
///////////////////////////////////////////////////////////////////////
int CSimpleGraphView::Add_New_Point(CPoint& point)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
...
//
///////////////////////////////////////////////////////////////////////
int CSimpleGraphView::Move_Value(int old_index, const Vector2& new_value)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Point_To_Value(const CPoint& point, Vector2* value)
{
    CRect graph_area;
    Get_Graph_Rect(graph_area);
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Value_To_Point(const Vector2& value, CPoint* point)
{
    CRect graph_area;
    Get_Graph_Rect(graph_area);
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Get_Graph_Rect(CRect& rect)
{
    CRect view_rect;
    GetClientRect(&view_rect);
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnInitialUpdate(void)
{
    HDC screen_dc = ::GetDC(NULL);
    m_Font = CreateFont(-::MulDiv(7, GetDeviceCaps(screen_dc, LOGPIXELSY), 72), 0, 0, 0, FW_REGULAR,
                        FALSE, FALSE, FALSE, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
                        DEFAULT_QUALITY, DEFAULT_PITCH, "Small Fonts");
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::Delete_Point(int index)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnDelete(void)
{
    if (m_SelPt != -1) {
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnUpdateDelete(CCmdUI* pCmdUI)
{
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnZoomExtents(void)
{
    Curve1DClass& spline = GetDocument()->Get_Spline();
    int count = spline.Key_Count();
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnRButtonDown(UINT nFlags, CPoint point)
{
...
//
///////////////////////////////////////////////////////////////////////
void CSimpleGraphView::OnRButtonUp(UINT nFlags, CPoint point)
{
    if (m_IsZooming) {
        m_IsZooming = false;
        ::ReleaseCapture();
