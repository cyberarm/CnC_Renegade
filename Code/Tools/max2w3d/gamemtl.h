...
#define GAMEMTL_CONVERTED_TO_NOLOD                                                                 \
    (1 << 0) // this material has been converted to use the NO_LOD flag on textures
...
#define GAMEMTL_ROLLUP_FLAGS                                                                       \
    (GAMEMTL_SURFACE_ROLLUP_OPEN | GAMEMTL_DISPLACEMENT_ROLLUP_OPEN                                \
     | GAMEMTL_PASSCOUNT_ROLLUP_OPEN | GAMEMTL_PASS0_ROLLUP_OPEN | GAMEMTL_PASS1_ROLLUP_OPEN       \
     | GAMEMTL_PASS2_ROLLUP_OPEN | GAMEMTL_PASS3_ROLLUP_OPEN)
...
public:
    ...
    int Get_Texture_No_Mipmap(int pass,
                              int stage); // NOTE: obsolete, replaced by Get_Texture_No_LOD
    ...
    void Set_Texture_Resize(int pass, int stage,
                            bool val); // NOTE: obsolete: replaced by Set_Texture_No_LOD
    void Set_Texture_No_Mipmap(int pass, int stage,
                               bool val); // NOTE: obsolete: replaced by Set_Texture_No_LOD
...
#endif
private:
    int texture_ref_index(int pass, int stage)
    {
        return REF_TEXTURE + pass * W3dMaterialClass::MAX_STAGES + stage;
    }
    ...
    Mtl* SubstituteMaterial; // IML: Temporary material used during game to standard material
