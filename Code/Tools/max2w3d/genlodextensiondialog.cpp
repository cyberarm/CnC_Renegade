...
bool GenLodExtensionDialogClass::Get_Options(OptionsStruct* options)
{
    ...
    BOOL result = DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD_GENERATE_LOD_EXTENSION_DIALOG),
...
bool GenLodExtensionDialogClass::Dialog_Proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM)
{
    ...
    case WM_INITDIALOG:
        ...
        LodIndexSpin = SetupIntSpinner(Hwnd, IDC_LOD_INDEX_SPIN, IDC_LOD_INDEX_EDIT, MIN_LOD_INDEX,
                                       MAX_LOD_INDEX, INITIAL_LOD_INDEX);
