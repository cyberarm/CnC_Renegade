...
public:
    ...
    {
        idLaunch,
        idSetMultiMaterialTabBySlot,
        idSetMaterialTabBySlot,
        idSetMultiMaterialBySlot,
        idSetMaterialBySlot
    };
};
...
public:
    ...
    VFN_3(IFPMatNav::idSetMultiMaterialTabBySlot, SetMultiMaterialTabBySlot, TYPE_INT, TYPE_INT,
          TYPE_INT);
