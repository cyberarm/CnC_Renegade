...
private:
    ...
    */
    ...
    SplitChoiceStruct Compute_Plane_Score(int polycont, int* polyindices,
                                          const AAPlaneClass& plane);
    void Split_Polys(int polycount, int* polyindices, const SplitChoiceStruct& sc,
    ...
    void Build_W3D_AABTree_Recursive(CullNodeStruct* node, W3dMeshAABTreeNode* w3dnodes,
