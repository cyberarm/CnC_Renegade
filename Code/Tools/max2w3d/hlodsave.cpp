...
// wrapper around the array of objects for each level of detail W3D_CHUNK_HLOD_LOD_ARRAY_HEADER,
...
name of the hierarchy tree to use (\0 if none)
};

struct W3dHLodArrayHeaderStruct
{
        uint32					ModelCount;
        float32					MaxScreenSize;		// if model is bigger than
this, switch to higher lod.
};
