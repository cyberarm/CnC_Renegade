...
W3DAppData2Struct* W3DAppData2Struct::Get_App_Data(INode* node, bool create_if_missing)
{
    /*
    ...
    */
    if (appdata) {
        ...
        */
        AppDataChunk* oldappdata
            = node->GetAppDataChunk(W3DUtilityClassID, UTILITY_CLASS_ID, W3D_APPDATA_0);
        if (oldappdata) {
        ...
        node->AddAppDataChunk(W3DUtilityClassID, UTILITY_CLASS_ID, 2, sizeof(W3DAppData2Struct),
                              wdata);
    ...
    */
    ...
    if (appdata) {
        ...
        */
        ...
        node->AddAppDataChunk(W3DUtilityClassID, UTILITY_CLASS_ID, W3D_DAZZLE_APPDATA,
                              sizeof(W3DDazzleAppDataStruct), dazzledata);
