...
enum
{
    ...
    = 0x00000004, // array of surrender normals (one per vertex as req. by surrender)
    ...
    W3D_CHUNK_DAMAGE
    = 0x0000000F, // Mesh damage, new set of materials, vertex positions, vertex colors
    W3D_CHUNK_DAMAGE_HEADER = 0x00000010, // Header for the damage data, tells what is coming
    W3D_CHUNK_DAMAGE_VERTICES
    = 0x00000011, // Array of modified vertices (W3dMeshDamageVertexStruct's)
    W3D_CHUNK_DAMAGE_COLORS
    = 0x00000012, // Array of modified vert colors (W3dMeshDamageColorStruct's)
    W3D_CHUNK_DAMAGE_MATERIALS = 0x00000013,

    O_W3D_CHUNK_MATERIALS2
    = 0x00000014, // array of version 2 materials (with animation frame counts)
