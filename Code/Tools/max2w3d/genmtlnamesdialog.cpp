...
static BOOL CALLBACK _gen_mtl_names_dialog_proc(HWND Hwnd, UINT message, WPARAM wParam,
                                                LPARAM lParam);
...
bool GenMtlNamesDialogClass::Get_Options(OptionsStruct* options)
{
    ...
    BOOL result = DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD_GENERATE_MTL_NAMES_DIALOG),
