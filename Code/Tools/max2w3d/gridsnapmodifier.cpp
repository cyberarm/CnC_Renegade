...
** This modifier will snap all vertices in the geometry being modified to a grid.  Its motivation is
*to
** try to help solve the problem of cracks between adjacent meshes in Renegade levels.  This will
*work
...
** This is the callback object used by GridSnapModifierClass to implement the actual geometry
*changes.  This
** architecture is required by the SimpleMod base-class.  This Deformer simply snaps vertex
*positions
...
** This object "links" the plugin into Max's plugin system.  It links the Class-ID to a virtual
*construction
...
static ParamBlockDesc2 _GridSnapParamBlockDesc(
    ...
    GSM_PARAMS, _T("GridSnap Parameters"), 0, &_GridSnapModifierDesc, P_AUTO_CONSTRUCT + P_AUTO_UI,
    SIMPMOD_PBLOCKREF,
    ...
    p_default, 0.001f, p_range, 0.0001f, 10.0f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT,
    IDC_GRIDDIM_EDIT, IDC_GRIDDIM_SPIN, 0.0001f, end,
...
Deformer& GridSnapModifierClass::GetDeformer(TimeValue t, ModContext& mc, Matrix3& mat,
                                             Matrix3& invmat)
{
