...
public:
    ...
    VoxelLayerClass(INodeListClass& objectlist, TimeValue time, Matrix3 parenttm, Point3 offset,
                    Point3 scale, float slicez, float sliceh, int bmwidth, int bmheight);
