...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK PresetExportOptionsDialogClass::Settings_Pane_Message_Proc(HWND wnd, UINT message,
                                                                         WPARAM wparam,
                                                                         LPARAM lparam)
{
    PresetExportOptionsDialogClass* dialog_obj = NULL;
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL PresetExportOptionsDialogClass::Pane_Message_Proc(UINT message, WPARAM wparam, LPARAM lparam)
{
    BOOL retval = FALSE;
        ...
        case IDC_WHT_BROWSE_BUTTON: {
            ...
            if (::GetOpenFileName(&ofn)) {
                ...
                Create_Relative_Path(Options->RelativeHierarchyFilename,
                                     W3dExportClass::CurrentExportPath, ofn.lpstrFile);
            }
        } break;
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL PresetExportOptionsDialogClass::Message_Proc(UINT message, WPARAM wparam, LPARAM lparam)
{
    BOOL retval = FALSE;
...
void PresetExportOptionsDialogClass::Create_Settings_Panes(void)
{
    ...
    PaneWnds[PANE_ANIM_HLOD]
        = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_ANIMATED_HLOD), Wnd,
                              Settings_Pane_Message_Proc, (LPARAM)this);

    PaneWnds[PANE_ANIM]
        = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_ANIMATION), Wnd,
                              Settings_Pane_Message_Proc, (LPARAM)this);

    PaneWnds[PANE_TERRAIN]
        = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_TERRAIN), Wnd,
                              Settings_Pane_Message_Proc, (LPARAM)this);

    PaneWnds[PANE_SKELETON]
        = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_SKELETON), Wnd,
                              Settings_Pane_Message_Proc, (LPARAM)this);
    ...
    for (int index = 0; index < PANE_MAX; index++) {
        ...
        if (skeleten_browse_btn != NULL) {
            ...
            if (Options->RelativeHierarchyFilename[0] != 0) {
                ...
                ::Create_Full_Path(Options->HierarchyFilename, W3dExportClass::CurrentExportPath,
