...
HWND FormClass::Create_Form(HWND parent_wnd, UINT template_id)
{
    ...
    m_hWnd = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(template_id), parent_wnd, fnFormProc,
                                 (LPARAM)this);
 ...
 *   11/6/98    GTH : Created.                                                                 *
 *=============================================================================================*/
BOOL WINAPI FormClass::fnFormProc(HWND dlg_wnd, UINT message, WPARAM wparam, LPARAM lparam)
{
