 ...
 *=============================================================================================*/
HierarchySaveClass::HierarchySaveClass(INode* root, TimeValue time, Progress_Meter_Class& treemeter,
                                       char* hname, int fixuptype, HierarchySaveClass* fixuptree)
...
HierarchySaveClass::HierarchySaveClass(INodeListClass* rootlist, TimeValue time,
                                       Progress_Meter_Class& treemeter, char* hname, int fixuptype,
                                       HierarchySaveClass* fixuptree, const Matrix3& origin_offset)
    : Node(DEFAULT_NODE_ARRAY_SIZE),
      CurNode(0),
      FixupType(fixuptype),
      FixupTree(fixuptree),
 ...
 *=============================================================================================*/
void HierarchySaveClass::Get_Export_Coordinate_System(INode* node, int* set_bone_index,
                                                      INode** set_bone_node, Matrix3* set_transform)
{
    /*
...
Matrix3 HierarchySaveClass::Get_Fixup_Transform(int node) const
{
    ...
    for (int j = 0; j < 4; j++) {
        m.SetRow(j,
                 Point3(Node[node].Fixup.TM[j][0], Node[node].Fixup.TM[j][1],
