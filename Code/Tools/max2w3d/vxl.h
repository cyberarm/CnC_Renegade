...
{
public:
    VoxelClass(INodeListClass& meshlist, int resolution, Matrix3 parenttm, TimeValue time,
...
private:
    ...
    void Quantize_Meshes(INodeListClass& meshlist, Progress_Meter_Class& meter);

    // set one layer of the voxel object
    void Set_Layer(VoxelLayerClass& layer, uint32 z);
