 ...
 *   07/24/1997 GH  : Created.                                                                 *
 *=============================================================================================*/
bool W3dOptionsDialogClass::Dialog_Proc(HWND hwnd, UINT message, WPARAM wParam, LPARAM)
{
    ...
    case WM_COMMAND:
        ...
        case IDOK:
            ...
            if (Dialog_Ok() == FALSE) {
                MessageBox(Hwnd, "You have not supplied a Base Pose hierarchy file!", "Error",
                           MB_OK);
                return 1;
            }
...
void W3dOptionsDialogClass::Dialog_Init()
{
    ...
    RangeLowSpin = SetupIntSpinner(Hwnd, IDC_RANGE_LOW_SPIN, IDC_RANGE_LOW_EDIT, startframe,
                                   endframe, Options->StartFrame);

    RangeHighSpin = SetupIntSpinner(Hwnd, IDC_RANGE_HIGH_SPIN, IDC_RANGE_HIGH_EDIT, startframe,
 ...
 *   07/24/1997 GH  : Created.                                                                 *
 *=============================================================================================*/
BOOL CALLBACK _options_dialog_proc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
