...
#define COLLISION_TYPE_PHYSICAL                                                                    \
    0x1000 // runtime engine performs physical collision against this mesh
...
#define DEFAULT_MESH_EXPORT_FLAGS                                                                  \
    (EXPORT_BONE_FLAG | EXPORT_GEOMETRY_FLAG | GEOMETRY_TYPE_NORMAL_MESH)
...
struct W3DAppData0Struct
{
    ...
    {
        return (ExportFlags & GEOMETRY_TYPE_MASK) == GEOMETRY_TYPE_NORMAL_MESH;
    }
    bool Is_Camera_Aligned_Mesh(void)
    {
        return (ExportFlags & GEOMETRY_TYPE_MASK) == GEOMETRY_TYPE_CAMERA_ALIGNED;
    }
    bool Is_Camera_Oriented_Mesh(void)
    {
        return (ExportFlags & GEOMETRY_TYPE_MASK) == GEOMETRY_TYPE_CAMERA_ORIENTED;
    }
    bool Is_Collision_AABox(void)
    {
        return (ExportFlags & GEOMETRY_TYPE_MASK) == GEOMETRY_TYPE_AABOX;
    }
    ...
    {
        return (ExportFlags & COLLISION_TYPE_PHYSICAL) == COLLISION_TYPE_PHYSICAL;
    }
    ...
    {
        return (ExportFlags & EXPORT_TWO_SIDED_FLAG) == EXPORT_TWO_SIDED_FLAG;
    }
    bool Is_Vertex_Alpha(void)
    {
        return (ExportFlags & EXPORT_VERTEX_ALPHA_FLAG) == EXPORT_VERTEX_ALPHA_FLAG;
    }
    bool Is_ZNormals(void) { return (ExportFlags & EXPORT_ZNORMALS_FLAG) == EXPORT_ZNORMALS_FLAG; }
    bool Is_Shadow(void)
    {
        return (ExportFlags & EXPORT_CAST_SHADOW_FLAG) == EXPORT_CAST_SHADOW_FLAG;
    }
...
struct W3DAppData2Struct
{
    ...
    */
    ...
    {
        return (GeometryFlags & GEOMETRY_FLAG_HIDDEN) == GEOMETRY_FLAG_HIDDEN;
    }
    bool Is_Two_Sided_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_TWO_SIDED) == GEOMETRY_FLAG_TWO_SIDED;
    }
    bool Is_Vertex_Alpha_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_VERTEX_ALPHA) == GEOMETRY_FLAG_VERTEX_ALPHA;
    }
    bool Is_ZNormals_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_ZNORMALS) == GEOMETRY_FLAG_ZNORMALS;
    }
    bool Is_Shadow_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_CAST_SHADOW) == GEOMETRY_FLAG_CAST_SHADOW;
    }
    bool Is_Shatterable_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_SHATTERABLE) == GEOMETRY_FLAG_SHATTERABLE;
    }
    bool Is_NPatchable_Enabled(void) const
    {
        return (GeometryFlags & GEOMETRY_FLAG_NPATCHABLE) == GEOMETRY_FLAG_NPATCHABLE;
    }

    bool Is_Physical_Collision_Enabled(void) const
    {
        return (CollisionFlags & COLLISION_FLAG_PHYSICAL) == COLLISION_FLAG_PHYSICAL;
    }
    bool Is_Projectile_Collision_Enabled(void) const
    {
        return (CollisionFlags & COLLISION_FLAG_PROJECTILE) == COLLISION_FLAG_PROJECTILE;
    }
    bool Is_Vis_Collision_Enabled(void) const
    {
        return (CollisionFlags & COLLISION_FLAG_VIS) == COLLISION_FLAG_VIS;
    }
    bool Is_Camera_Collision_Enabled(void) const
    {
        return (CollisionFlags & COLLISION_FLAG_CAMERA) == COLLISION_FLAG_CAMERA;
    }
    bool Is_Vehicle_Collision_Enabled(void) const
    {
        return (CollisionFlags & COLLISION_FLAG_VEHICLE) == COLLISION_FLAG_VEHICLE;
    }
