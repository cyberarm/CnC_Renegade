...
ChunkItem* CWDumpTreeView::FindChunkItem(ChunkItem* selectedchunkitem, ChunkItem* chunkitem,
                                         SearchStateEnum& searchstate)
{
    ...
    // Iterate over all chunks in the hierarchy. Return immediately if a match is found or if the
    // search has wrapped.
