...
BOOL SphereGeneralPropPageClass::OnInitDialog(void)
{
    ...
    CheckDlgButton(IDC_CAMERA_ALIGNED_CHECK,
                   (m_RenderObj->Get_Flags() & SphereRenderObjClass::USE_CAMERA_ALIGN) != 0);
    CheckDlgButton(IDC_LOOPING_CHECK,
                   (m_RenderObj->Get_Flags() & SphereRenderObjClass::USE_ANIMATION_LOOP) != 0);
...
BOOL SphereGeneralPropPageClass::OnApply(void)
{
    ...
    if (m_Name.GetLength() == 0) {
        ...
        m_RenderObj->Set_Flag(SphereRenderObjClass::USE_CAMERA_ALIGN,
                              IsDlgButtonChecked(IDC_CAMERA_ALIGNED_CHECK) != 0);
        m_RenderObj->Set_Flag(SphereRenderObjClass::USE_ANIMATION_LOOP,
