...
BOOL EmitterColorPropPageClass::OnInitDialog(void)
{
    ...
    m_ColorBar->Modify_Point(0, 0, m_OrigColors.Start.X * 255, m_OrigColors.Start.Y * 255,
                             m_OrigColors.Start.Z * 255);
    ...
    for (UINT index = 0; index < m_OrigColors.NumKeyFrames; index++) {
        m_ColorBar->Modify_Point(index + 1, m_OrigColors.KeyTimes[index] / m_Lifetime,
