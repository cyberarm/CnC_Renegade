...
void SpecSheetClass::Add_Parameter(ParameterClass* parameter)
{
    ...
    case ParameterClass::TYPE_FILENAME:
        ...
        ((FileParameterCtrlClass*)parameter_ctrl)
            ->Get_File_Picker()
            .Set_Asset_Tree_Only(m_AssetTreeOnly);
        break;
    ...
    case ParameterClass::TYPE_EXPLOSIONDEFINITIONID:
        parameter_ctrl
            = new ExplosionObjDefParameterCtrlClass((ExplosionObjDefParameterClass*)parameter);
        break;
    ...
    case ParameterClass::TYPE_STRINGSDB_ID:
        parameter_ctrl
            = new StringsDBEntryParameterCtrlClass((StringsDBEntryParameterClass*)parameter);
        break;
    }
...
//
/////////////////////////////////////////////////////////////////////////////
UINT SpecSheetClass::OnNcHitTest(CPoint point)
{
    return HTCLIENT;
}
