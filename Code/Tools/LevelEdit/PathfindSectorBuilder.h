 ...
 *                                                                                             *
 *                     $Archive:: /Commando/Code/Tools/LevelEdit/PathfindSectorBuilder.h $Modtime::
 *5/27/00 4:10p                                               $*
 *                                                                                             *
 *                    $Revision:: 25                                                          $*
 *                                                                                             *
...
protected:
    ...
    bool Try_Moving_Here(const Vector3& start_pos, const Vector3& expected_pos,
                         AABoxClass* real_pos);
    ...
    FloodfillBoxClass* Submit_Box(FloodfillBoxClass* from_obj, const AABoxClass& new_box,
                                  PATHFIND_DIR direction);

    PathfindSectorClass* Build_Sector(FloodfillBoxClass* upper_left_ptr, int cells_right,
                                      int cells_down);
    ...
    //
    TransitionInstanceClass* Find_Transition(TransitionDataClass::StyleType type,
