...
class SoundNodePersistFactoryClass
    : public SimplePersistFactoryClass<SoundNodeClass, CHUNKID_NODE_OLD_SOUND>
{
public:
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& SoundNodeClass::Get_Factory(void) const
{
