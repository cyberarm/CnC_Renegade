...
//
////////////////////////////////////////////////////////////////////////
TextureClass* EditorAssetMgrClass::Get_Texture(const char* tga_filename,
    ...
    */
    ...
    if (tex && texture_format != WW3D_FORMAT_UNKNOWN) {
        WWASSERT_PRINT(tex->Get_Texture_Format() == texture_format,
                       ("Texture %s has already been loaded witt different format",
    ...
    */
    if (!tex) {
        ...
        */
        tex = NEW_REF(
            TextureClass,
            (texture_name, real_location, mip_level_count, texture_format, allow_compression));
...
void EditorAssetMgrClass::Load_Resource_Texture(const char* filename)
{
    ...
    // real file.
    //
    ResourceFileClass res_texture(nullptr, filename);
...
//
////////////////////////////////////////////////////////////////////////
void EditorAssetMgrClass::Open_Texture_File_Cache(const char* /*prefix*/)
{
    return;
}
...
//
////////////////////////////////////////////////////////////////////////
void EditorAssetMgrClass::Close_Texture_File_Cache(void)
{
    return;
}
