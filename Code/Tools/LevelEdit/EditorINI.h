...
public:
    ...
    //	Read methods
    //
    Vector3 Get_Vector3(LPCTSTR section, LPCTSTR entry,
                        const Vector3& defvalue = Vector3(0, 0, 0)) const;
    Vector4 Get_Vector4(LPCTSTR section, LPCTSTR entry,
                        const Vector4& defvalue = Vector4(0, 0, 0, 0)) const;
    CString Get_CString(LPCTSTR section, LPCTSTR entry, LPCTSTR defvalue = "") const;
    Matrix3D Get_Matrix3D(LPCTSTR section, LPCTSTR entry_base,
                          Matrix3D& defvalue = Matrix3D(1)) const;
