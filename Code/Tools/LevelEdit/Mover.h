...
public:
    ...
    static Vector3 Position_Node_Along_Ray(NodeClass* node, const Vector3& start,
                                           const Vector3& end);
    static void Position_Nodes_Along_Ray(void);
    static void Position_Nodes_Along_Ray(const Vector3& start, const Vector3& end);
    static Vector3 Position_Nodes_Along_Ray(NODE_LIST& list, const Vector3& tracking_pt,
    ...
    static void Rotate_Nodes(NODE_LIST& list, const Matrix3D& rotation_matrix,
    ...
    //	These are called by the other functions once the rotatation or translation params are
    //calculated.
    //
    static void Rotate_Node(NodeClass* node, const Matrix3D& rotation_matrix,
                            const Matrix3D& coord_system);
    static void Rotate_Node_Freely(NodeClass* node, const Matrix3D& rotation_matrix,
                                   const Matrix3D& coord_system);
    static void Rotate_Node_Z90(NodeClass* node, const Matrix3D& rotation_matrix,
                                const Matrix3D& coord_system);
    ...
    static PhysClass* Cast_Ray(CastResultStruct& result, const Vector3& start, const Vector3& end,
                               ...
                               uint32 type = COLLISION_TYPE_PHYSICAL | COLLISION_TYPE_PROJECTILE
                                   | COLLISION_TYPE_6);
...
protected:
    ...
    //	Protected methods
    ////////////////////////////////////////////////////////////////////
    static bool Calc_Ray_Intersection_XY(float plane, const Vector3& start, const Vector3& end,
                                         Vector3& result);
    static bool Calc_Ray_Intersection_XZ(float plane, const Vector3& start, const Vector3& end,
                                         Vector3& result);
    static bool Calc_Ray_Intersection_YZ(float plane, const Vector3& start, const Vector3& end,
                                         Vector3& result);
...
//	Cast_Ray
////////////////////////////////////////////////////////////////////
inline PhysClass* MoverClass::Cast_Ray(CastResultStruct& result, const Vector3& start,
                                       const Vector3& end, uint32 group, uint32 type)
{
    bool retval = false;
...
//	Cast_Box
////////////////////////////////////////////////////////////////////
inline PhysClass* MoverClass::Cast_Box(CastResultStruct& result, const AABoxClass& box,
                                       const Vector3& move, uint32 group, uint32 type)
{
    bool retval = false;
