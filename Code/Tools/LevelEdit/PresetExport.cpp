...
void PresetExportClass::Import(const char* filename)
{
    ...
    if (file.Open()) {
        ...
        if (is_valid_file == false) {
            CString message;
            message.Format("%s does not appear to be a valid preset export text file or there was "
                           "an error parsing the data.\nDue to the severe side-effects of "
                           "improperly importing preset settings, all changes were ignored.",
                           filename);
...
//
///////////////////////////////////////////////////////////////////////
bool PresetExportClass::Read_Column_Headers(TextFileClass& file,
                                            DynamicVectorClass<StringClass>& column_headers)
{
    bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////
bool PresetExportClass::Validate_Columns(int class_id,
                                         DynamicVectorClass<StringClass>& column_headers)
{
    bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////
bool PresetExportClass::Import_Setting(PresetClass* preset, ParameterClass* parameter,
                                       const char* value)
{
    bool retval = true;
