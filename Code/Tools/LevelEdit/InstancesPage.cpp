...
void InstancesPageClass::Insert_Factory(LPCTSTR name, int class_id)
{
    ...
    if (index >= 0) {
        ...
        //
        // m_ListCtrl.SetItem (index, COLUMN_NAME, LVIF_TEXT | LVIF_IMAGE, name, FOLDER_ICON, 0, 0,
        // 0);
...
void InstancesPageClass::Insert_Node(NodeClass* node)
{
    ...
    if (index >= 0) {
        ...
        //	Set the text and the icon for this entry
        //
        // m_ListCtrl.SetItem (index, COLUMN_NAME, LVIF_TEXT | LVIF_IMAGE, node->Get_Name (),
        // node->Get_Icon_Index (), 0, 0, 0);
...
void InstancesPageClass::Insert_Navigator(void)
{
    ...
    if (index >= 0) {
        ...
        //	Set the text and the icon for this entry
        //
        // m_ListCtrl.SetItem (index, COLUMN_NAME, LVIF_TEXT | LVIF_IMAGE, "..", NAVIGATOR_ICON, 0,
        // 0, 0);
