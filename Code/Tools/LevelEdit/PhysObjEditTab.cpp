...
{
    DefinitionClass* default_definition
        = DefinitionMgrClass::Find_Definition(m_DefinitionID, false);
    ...
    for (factory = DefinitionFactoryMgrClass::Get_First(CLASSID_PHYSICS); factory != nullptr;
