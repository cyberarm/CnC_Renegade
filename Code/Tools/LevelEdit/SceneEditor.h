...
public:
    ...
    {
        Toggle_Selection(Find_Node_At_Point(point));
    }
    ...
    void Generate_Uniform_Sampled_Vis(float granularity, float sample_height, bool ignore_bias,
                                      bool selection_only, bool farm_mode = false,
                                      int farm_cpu_index = 1, int farm_cpu_total = 1);
    void Generate_Edge_Sampled_Vis(float granularity, bool ignore_bias, bool farm_mode = false,
                                   int farm_cpu_index = 1, int farm_cpu_total = 1);
    void Generate_Light_Vis(bool farm_mode = false, int farm_cpu_index = 1, int farm_cpu_total = 1);
    void Generate_Manual_Vis(bool farm_mode = false, int farm_cpu_index = 1,
