...
public:
    ...
    static PresetClass* Get_Next(PresetClass* current, uint32 class_id, ID_TYPE type,
                                 bool include_twiddlers = false);

    //
    // Tree building methods
    //
    static void Build_Preset_Tree(uint32 class_id, PRESET_TREE& tree,
                                  bool include_twiddlers = true);
...
protected:
    ...
    // Tree building methods
    static void Add_Children_To_Tree(uint32 parent_id, PRESET_TREE_LEAF* leaf,
                                     bool include_twiddlers);

    // Type checking
    static bool Is_One_Of(uint32 id_to_find, ID_TYPE type, bool include_twiddlers,
                          PresetClass* preset);
...
//	Get_First
/////////////////////////////////////////////////////////////////////
inline PresetClass* PresetMgrClass::Get_First(void)
{
