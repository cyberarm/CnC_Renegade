            ...
            if (render_obj != nullptr) {
                ...
                if (phys_obj != nullptr && phys_obj->As_DecorationPhysClass() == nullptr) {
                    ...
                    if (floor != nullptr) {
                        ...
                        /*Matrix3D tm;
                        tm.Look_At (Vector3 (0, -12, DROP_POS-drop_height+2), Vector3 (0, 0,
                        DROP_POS-drop_height), 0);
                        ...
                        //
                        m_Height = phys_obj->Get_Transform().Get_Translation().Z
                            - (DROP_POS - drop_height);
                        if (WWMath::Is_Valid_Float(m_Height) == false
                            || WWMath::Fabs(m_Height) > 4.0F) {
                            m_Height = 0.5F;
                        }
