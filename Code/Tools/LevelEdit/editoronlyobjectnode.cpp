...
//	Persist factory
//////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<EditorOnlyObjectNodeClass, CHUNKID_EDITOR_ONLY_OBJECTS>
    _EditorOnlyObjNodePersistFactory;
...
{
    EditorOnlyDefinitionClass* definition
        = static_cast<EditorOnlyDefinitionClass*>(m_Preset->Get_Definition());
