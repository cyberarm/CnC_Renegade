...
bool WaypathInfoPageClass::Apply_Changes(void)
{
    ...
    path->Set_Flag(WaypathClass::FLAG_GROUND_VEHICLE,
                   IsDlgButtonChecked(IDC_GROUND_VEHICLE_CHECK) == 1);
    path->Set_Flag(WaypathClass::FLAG_FLYING_VEHICLE,
                   IsDlgButtonChecked(IDC_AIR_VEHICLE_CHECK) == 1);
    path->Set_Flag(WaypathClass::FLAG_INNATE_PATHFIND,
                   IsDlgButtonChecked(IDC_INNATE_PATHFIND_CHECK) == 1);
    ...
    m_Waypoint->Set_Flag(WaypointNodeClass::FLAG_REQUIRES_JUMP,
                         IsDlgButtonChecked(IDC_JUMP_CHECK) == 1);
