...
void StringsMgrClass::Save_Translation_Database(const char* full_path)
{
    ...
    //	Create the file
    //
    HANDLE file = ::CreateFile(full_path, GENERIC_WRITE, 0, nullptr, CREATE_ALWAYS, 0L, nullptr);
...
void StringsMgrClass::Export_For_Translation(const char* filename, uint32 lang_id)
{
    ...
    if (ExcelClass::Initialize() == false) {
        ::MessageBox(
            ...
            "Cannot Initialize Excel, this feature requires Excel installed on the machine.",
            "Export Error", MB_ICONERROR | MB_OK);
        return;
    }
    ...
    for (int index = 0; index < count; index++) {
        ...
        if (object != nullptr && object->As_StringTwiddlerClass() == nullptr) {
            ...
            AudibleSoundDefinitionClass* sound_def
                = (AudibleSoundDefinitionClass*)DefinitionMgrClass::Find_Definition(sound_preset_id,
                                                                                    false);
            ...
            if (lang_id != TranslateDBClass::LANGID_ENGLISH
                && object->Contains_Translation(lang_id)) {
        ...
        if (string_id.Is_Empty()) {
            ...
            if (object != nullptr) {
                ...
                DefinitionClass* definition = DefinitionMgrClass::Find_Typed_Definition(
                    ascii_preset_name, CLASSID_SOUND, false);
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Apply_Characteristics(WideStringClass& english_string,
