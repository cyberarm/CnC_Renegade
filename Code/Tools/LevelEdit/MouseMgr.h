...
public:
    ...
    ///////////////////////////////////////////////////
    virtual void On_Mode_Set(void) {
    } //::Get_Camera_Mgr ()->Set_Camera_Mode (CameraMgr::MODE_WALK_THROUGH); }
};
...
public:
    ...
    void Handle_Mouse_Move(UINT flags, CPoint point)
    {
        m_pModeObjects[m_MouseMode]->Handle_Mouse_Move(flags, point);
    }
    ...
    CPoint Get_Last_Mouse_Point(void) const
    {
        return m_pModeObjects[m_MouseMode]->m_LastMousePoint;
    }
