...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& WaypathNodeClass::Get_Factory(void) const
{
        ...
        if (waypoint != nullptr) {
            ...
            if (index > 0) {
                ...
                for (int list_index = 0; list_index < list.Count(); list_index++) {
                    PathfindActionPortalClass* portal
                        = list[list_index]->As_PathfindActionPortalClass();
...
//
//////////////////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Get_Flag(int flag)
{
