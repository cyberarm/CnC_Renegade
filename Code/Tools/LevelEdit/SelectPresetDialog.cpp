        ...
        DefinitionFactoryMgrClass::Get_Next (factory, PRESET_CATEGORIES[index].clsid))
                {
                        ...
                        HTREEITEM child_item = m_TreeCtrl.InsertItem (factory->Get_Name (),
        FOLDER_ICON, FOLDER_ICON, tree_item); Generate_Tree (factory->Get_Class_ID (), child_item);
                }
