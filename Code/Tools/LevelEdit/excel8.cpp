                         ...
                         const VARIANT& TextVisualLayout)
{
    ...
    InvokeHelper(0x2ab, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Filename, &Origin, &StartRow,
                          ...
                          const VARIANT& Schedule)
{
    ...
    InvokeHelper(0x270, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &EarliestTime, Procedure,
                 &LatestTime, &Schedule);
}
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x115, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &SaveChanges, &Filename,
                 &RouteWorkbook);
}
                         ...
                         const VARIANT& PrintToFile, const VARIANT& Collate)
{
    static BYTE parms[]
        = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x389, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &From, &To, &Copies, &Preview,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x5aa, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &Password,
                       ...
                       const VARIANT& TextCodepage, const VARIANT& TextVisualLayout)
{
    ...
    InvokeHelper(0x11c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Filename, &FileFormat, &Password,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x3b3, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Recipients, &Subject,
                 &ReturnReceipt);
}
                                ...
                                const VARIANT& HeaderInfo)
{
    ...
    InvokeHelper(0x5be, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Address, &SubAddress, &NewWindow,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x11a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Password, &DrawingObjects,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x1f9, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &CustomDictionary, &IgnoreUppercase,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x403, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Format, &Link, &DisplayAsIcon,
                           ...
                           const VARIANT& Unique)
{
    ...
    InvokeHelper(0x36c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Action, &CriteriaRange,
                 &CopyToRange, &Unique);
}
                       ...
                       const VARIANT& OmitRow, long Order, const VARIANT& AppendLast)
{
    ...
    InvokeHelper(0x1b9, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Names, &IgnoreRelativeAbsolute,
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x319, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Field, &Criteria1, Operator,
                       ...
                       const VARIANT& Width)
{
    ...
    InvokeHelper(0x72, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Format, &Number, &Font, &Alignment,
                         ...
                         const VARIANT& Color)
{
    ...
    InvokeHelper(0x42b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &LineStyle, Weight, ColorIndex,
                 &Color);
}
                            ...
                            const VARIANT& ContainsVALU)
{
    ...
    InvokeHelper(0x1ca, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Edition, Appearance, &ContainsPICT,
                       ...
                       const VARIANT& Stop, const VARIANT& Trend)
{
    ...
    InvokeHelper(0x1d0, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Rowcol, Type, Date, &Step, &Stop,
                 &Trend);
}
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x0, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, &RowIndex, &ColumnIndex,
                 &newValue);
}
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0xaa, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, &RowIndex, &ColumnIndex,
                 &newValue);
}
...
{
    static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x408, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &TowardPrecedent, &ArrowNumber,
                 &LinkNumber);
}
                         ...
                         const VARIANT& Transpose)
{
    ...
    InvokeHelper(0x403, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Paste, Operation, &SkipBlanks,
                 &Transpose);
}
                 ...
                 const VARIANT& IgnoreDiacritics, const VARIANT& IgnoreKashida)
{
    ...
    InvokeHelper(0x370, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Key1, Order1, &Key2, &Type, Order2,
                        ...
                        long Orientation)
{
    ...
    InvokeHelper(0x371, DISPATCH_METHOD, VT_EMPTY, NULL, parms, SortMethod, &Key1, Order1, &Type,
                     ...
                     const VARIANT& PageBreaks, long SummaryBelowData)
{
    ...
    InvokeHelper(0x372, DISPATCH_METHOD, VT_EMPTY, NULL, parms, GroupBy, Function, &TotalList,
                          ...
                          const VARIANT& Other, const VARIANT& OtherChar, const VARIANT& FieldInfo)
{
    static BYTE parms[] = VTS_VARIANT VTS_I4 VTS_I4 VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT
        VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
    InvokeHelper(0x410, DISPATCH_METHOD, VT_EMPTY, NULL, parms, &Destination, DataType,
