...
bool MixFileDatabaseClass::Open_Database(LPCTSTR ini_filename, LPCTSTR username, LPCTSTR password)
{
    ...
    MainFileFactory.Add_FileFactory(
        new MixFileFactoryClass(always_dbs_path, &RenegadeDataFileFactory), "always.dat");
    MainFileFactory.Add_FileFactory(
        new MixFileFactoryClass(always_dat_path, &RenegadeDataFileFactory), "always.dbs");
    ...
    for (file_find = ::FindFirstFile(search_path, &find_info);
        ...
        MainFileFactory.Add_FileFactory(
            new MixFileFactoryClass(full_path, &RenegadeDataFileFactory), find_info.cFileName);
    }
...
//
//////////////////////////////////////////////////////////////////////////////////
void MixFileDatabaseClass::Find_Files(DynamicVectorClass<StringClass>& file_list,
                                      LPCTSTR search_mask)
{
    //
