...
{
    _ImmediateCheckInMode
        = (bool)(theApp.GetProfileInt(CONFIG_KEY, IMMEDIATE_CHECKIN_VALUE, 1) == 1);
    return;
}
...
void PresetMgrClass::Add_Preset(PresetClass* preset)
{
    ...
    //
    if ((preset->m_NextPreset == nullptr) && (preset->m_PrevPreset == nullptr)) {
        Link_Preset(preset);
    }
...
//
///////////////////////////////////////////////////////////////////////
uint32 PresetMgrClass::Chunk_ID(void) const
{
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Contains_Data(void) const
{
...
bool PresetMgrClass::Save_Embedded_Node_Data(ChunkSaveClass& csave)
{
    ...
    //
    for (PresetClass* preset = _PresetListHead; preset != nullptr; preset = preset->m_NextPreset) {
        //
...
//
///////////////////////////////////////////////////////////////////////
PresetClass* PresetMgrClass::Get_Next(PresetClass* preset)
{
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Is_One_Of(uint32 id_to_find, ID_TYPE type, bool include_twiddlers,
                               PresetClass* preset)
{
    bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////
PresetClass* PresetMgrClass::Get_Next(PresetClass* current, uint32 id, ID_TYPE type,
...
void PresetMgrClass::Validate_Version(void)
{
    ...
    if (::Get_File_Mgr()->Is_VSS_Read_Only() == false) {
        ...
        if (Check_Editor_Version() == false) {
            ...
            //	Warn the user
            //
            Message_Box(nullptr, IDS_VERSION_ERROR_MSG, IDS_VERSION_ERROR_TITLE,
...
bool PresetMgrClass::Check_Out_Database(LPCTSTR path, bool* should_undo_on_err)
{
    ...
    if (status == AssetDatabaseClass::NOT_CHECKED_OUT) {
        ...
        if (retval) {
            ...
            ::MessageBox(::AfxGetMainWnd()->m_hWnd, "Unable to check out the preset library.",
                         "VSS Error", MB_ICONERROR | MB_OK);
        }
    }
...
bool PresetMgrClass::Check_In_Database(LPCTSTR path)
{
    ...
    if (Is_Database_Checked_Out(full_path)) {
        ...
        if (retval == false) {
            ...
            ::MessageBox(::AfxGetMainWnd()->m_hWnd, message, "Database Error",
                         MB_ICONERROR | MB_OK);
        }
    }
...
void PresetMgrClass::Build_Preset_Tree(uint32 class_id, PRESET_TREE& tree, bool include_twiddlers)
{
    ...
    for (preset = Get_First(class_id, ID_CLASS, include_twiddlers); preset != nullptr;
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Add_Children_To_Tree(uint32 parent_id, PRESET_TREE_LEAF* leaf,
                                          bool include_twiddlers)
{
    //
...
void PresetMgrClass::Build_Factory_Tree(uint32 class_id, FACTORY_TREE& tree)
{
    ...
    if (class_id == 0) {
        ...
        for (int index = 0; index < PRESET_CATEGORY_COUNT; index++) {
            ...
            FACTORY_TREE_LEAF* leaf
                = tree.Add_Sorted(factory_class_id, PRESET_CATEGORIES[index].name);

            //
            //	Find all the sub-factories
            //
            if (DefinitionFactoryMgrClass::Find_Factory(PRESET_CATEGORIES[index].clsid) == nullptr) {
                for (DefinitionFactoryClass* factory
                     = DefinitionFactoryMgrClass::Get_First(factory_class_id);
                     factory != nullptr;
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Remove_Non_Matching_Presets(uint32 class_id, bool class_id_matters,
                                                 bool is_temp, PRESET_LIST& removed_preset_list)
{
    //
