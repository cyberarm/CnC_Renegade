...
public:
    ...
    bool Save_Presets(LPCTSTR path, uint32 class_id, bool temps_only = false,
                      bool class_id_matters = true);
    static bool Old_Load_Presets(void);
    static bool Load_Temp_Presets(void);
    static bool Load_Databases(void);
    void Build_DDB_File_List(DynamicVectorClass<CString>& file_list,
    ...
    void Build_File_Dependencies_For_Definition(DynamicVectorClass<StringClass>& file_list,
...
protected:
    ...
    void Save_Presets(HANDLE file, uint32 class_id, bool temps_only = false,
                      bool class_id_matters = true);
    ...
    void Compare_Derived_Parameters(PresetClass* curr_preset, DefinitionClass* base_def,
