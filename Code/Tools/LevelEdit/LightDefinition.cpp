...
LightDefinitionClass::LightDefinitionClass(void)
    : m_CastsShadows(false),
      ...
      DefinitionClass()
{
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_BOOL, m_CastsShadows,
                         "Casts Shadows");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_COLOR, m_AmbientColor,
                         "Ambient");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_COLOR, m_DiffuseColor,
                         "Diffuse");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_COLOR, m_SpecularColor,
                         "Specular");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_FLOAT, m_FarRadiusInner,
                         "Inner Radius");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_FLOAT, m_FarRadiusOuter,
                         "Outer Radius");
    ...
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_ANGLE, m_SpotAngle,
                         "Spot Angle");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_FLOAT, m_SpotExp,
                         "Spot Exponent");
    NAMED_EDITABLE_PARAM(LightDefinitionClass, ParameterClass::TYPE_VECTOR3, m_SpotDir,
                         "Spot Direction");
    return;
}
...
//
//////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass& LightDefinitionClass::Get_Factory(void) const
{
...
//
//////////////////////////////////////////////////////////////////////////////////
PersistClass* LightDefinitionClass::Create(void) const
{
