...
void VisMgrClass::Import_Remap_Data(ChunkLoadClass& cload)
{
    ...
    if (is_valid == false) {
        ::MessageBox(NULL,
                     "The static geometry in this level does not match the geometry of the level "
                     "in which vis was generated.  Unable to import vis data into this level.",
...
//
//////////////////////////////////////////////////////////////////////////////
void VisMgrClass::Render_Manual_Vis_Points(bool farm_mode, int processor_index,
                                           ...
                                           VIS_POINT_RENDERED_CALLBACK callback, DWORD param)
{
    ...
    for (int index = 0; index < point_list.Count(); index++) {
        ...
        VisSampleClass vis_sample
            = scene_editor->Update_Vis(sample_location, new_transform,
