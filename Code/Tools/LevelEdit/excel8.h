...
public:
    ...
    void OpenText(LPCTSTR Filename, const VARIANT& Origin, const VARIANT& StartRow,
                  const VARIANT& DataType, long TextQualifier, const VARIANT& ConsecutiveDelimiter,
...
public:
    ...
    LPDISPATCH Intersect(LPDISPATCH Arg1, LPDISPATCH Arg2, const VARIANT& Arg3, const VARIANT& Arg4,
    ...
    VARIANT Run(const VARIANT& Macro, const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3,
                ...
                const VARIANT& Arg29, const VARIANT& Arg30);
    VARIANT
    _Run2(const VARIANT& Macro, const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3,
          const VARIANT& Arg4, const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7,
    ...
    LPDISPATCH Union(LPDISPATCH Arg1, LPDISPATCH Arg2, const VARIANT& Arg3, const VARIANT& Arg4,
                     const VARIANT& Arg5, const VARIANT& Arg6, const VARIANT& Arg7,
                     const VARIANT& Arg8, const VARIANT& Arg9, const VARIANT& Arg10,
                     const VARIANT& Arg11, const VARIANT& Arg12, const VARIANT& Arg13,
                     const VARIANT& Arg14, const VARIANT& Arg15, const VARIANT& Arg16,
    ...
    BOOL CheckSpelling(LPCTSTR Word, const VARIANT& CustomDictionary,
    ...
    VARIANT ConvertFormula(const VARIANT& Formula, long FromReferenceStyle,
    ...
    VARIANT GetOpenFilename(const VARIANT& FileFilter, const VARIANT& FilterIndex,
                            const VARIANT& Title, const VARIANT& ButtonText,
                            const VARIANT& MultiSelect);
    VARIANT GetSaveAsFilename(const VARIANT& InitialFilename, const VARIANT& FileFilter,
    ...
    VARIANT InputBox(LPCTSTR Prompt, const VARIANT& Title, const VARIANT& Default,
    ...
    void MacroOptions(const VARIANT& Macro, const VARIANT& Description, const VARIANT& HasMenu,
                      const VARIANT& MenuText, const VARIANT& HasShortcutKey,
                      const VARIANT& ShortcutKey, const VARIANT& Category, const VARIANT& StatusBar,
    ...
    void OnTime(const VARIANT& EarliestTime, LPCTSTR Procedure, const VARIANT& LatestTime,
...
public:
    ...
    void PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies,
                  const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile,
    ...
    void ProtectSharing(const VARIANT& Filename, const VARIANT& Password,
    ...
    void SaveAs(const VARIANT& Filename, const VARIANT& FileFormat, const VARIANT& Password,
                const VARIANT& WriteResPassword, const VARIANT& ReadOnlyRecommended,
                const VARIANT& CreateBackup, long AccessMode, const VARIANT& ConflictResolution,
    ...
    void FollowHyperlink(LPCTSTR Address, const VARIANT& SubAddress, const VARIANT& NewWindow,
...
public:
    ...
    void SaveAs(LPCTSTR Filename, const VARIANT& FileFormat, const VARIANT& Password,
                const VARIANT& WriteResPassword, const VARIANT& ReadOnlyRecommended,
    ...
    void CheckSpelling(const VARIANT& CustomDictionary, const VARIANT& IgnoreUppercase,
    ...
    void PasteSpecial(const VARIANT& Format, const VARIANT& Link, const VARIANT& DisplayAsIcon,
                      const VARIANT& IconFileName, const VARIANT& IconIndex,
                      const VARIANT& IconLabel);
    LPDISPATCH PivotTables(const VARIANT& Index);
    LPDISPATCH PivotTableWizard(const VARIANT& SourceType, const VARIANT& SourceData,
...
public:
    ...
    CString GetAddress(const VARIANT& RowAbsolute, const VARIANT& ColumnAbsolute,
                       long ReferenceStyle, const VARIANT& External, const VARIANT& RelativeTo);
    CString GetAddressLocal(const VARIANT& RowAbsolute, const VARIANT& ColumnAbsolute,
                            long ReferenceStyle, const VARIANT& External,
                            const VARIANT& RelativeTo);
    void AdvancedFilter(long Action, const VARIANT& CriteriaRange, const VARIANT& CopyToRange,
                        const VARIANT& Unique);
    void ApplyNames(const VARIANT& Names, const VARIANT& IgnoreRelativeAbsolute,
    ...
    void AutoFilter(const VARIANT& Field, const VARIANT& Criteria1, long Operator,
                    const VARIANT& Criteria2, const VARIANT& VisibleDropDown);
    void AutoFit();
    void AutoFormat(long Format, const VARIANT& Number, const VARIANT& Font,
    ...
    void Consolidate(const VARIANT& Sources, const VARIANT& Function, const VARIANT& TopRow,
    ...
    long GetCount();
    void CreateNames(const VARIANT& Top, const VARIANT& Left, const VARIANT& Bottom,
                     const VARIANT& Right);
    ...
    void DataSeries(const VARIANT& Rowcol, long Type, long Date, const VARIANT& Step,
    ...
    VARIANT EditionOptions(long Type, long Option, const VARIANT& Name, const VARIANT& Reference,
    ...
    void FillRight();
    void FillUp();
    LPDISPATCH Find(const VARIANT& What, const VARIANT& After, const VARIANT& LookIn,
    ...
    VARIANT Group(const VARIANT& Start, const VARIANT& End, const VARIANT& By,
    ...
    void NavigateArrow(const VARIANT& TowardPrecedent, const VARIANT& ArrowNumber,
    ...
    void PasteSpecial(long Paste, long Operation, const VARIANT& SkipBlanks,
    ...
    LPDISPATCH GetRange(const VARIANT& Cell1, const VARIANT& Cell2);
    void RemoveSubtotal();
    BOOL Replace(const VARIANT& What, const VARIANT& Replacement, const VARIANT& LookAt,
    ...
    LPDISPATCH GetRows();
    VARIANT Run(const VARIANT& Arg1, const VARIANT& Arg2, const VARIANT& Arg3, const VARIANT& Arg4,
    ...
    void Sort(const VARIANT& Key1, long Order1, const VARIANT& Key2, const VARIANT& Type,
    ...
    void SortSpecial(long SortMethod, const VARIANT& Key1, long Order1, const VARIANT& Type,
    ...
    VARIANT GetText();
    void TextToColumns(const VARIANT& Destination, long DataType, long TextQualifier,
