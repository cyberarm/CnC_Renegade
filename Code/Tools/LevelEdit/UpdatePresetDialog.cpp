...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::OnBrowse(void)
{
    return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::OnChangeFilenameEdit(void)
{
    return;
}
...
void UpdatePresetDialogClass::OnOK(void)
{
    ...
    for (int index = 0; index < count; index++) {
        ...
        if (orig_filename.CompareNoCase(new_filename) == 0) {
            ...
            ParameterClass* parameter = m_ParamSheet->Get_Parameter(index);
            CString message;
            message.Format("Cannot update %s, new filename MUST match original filename.",
                           parameter->Get_Name());
