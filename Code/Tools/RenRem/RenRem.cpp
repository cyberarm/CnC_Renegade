...
int main(int argc, char** argv)
{
    ...
    */
    ...
    if (ServerControl.Start_Listening(local_port, password, &App_Request_Callback,
    ...
    */
    ...
    while (doit) {
        ...
        if (_kbhit()) {
            ...
            /*
            ** TAB key used to get command line suggestions in the game. Here we just print spaces,
            *so jump back to the start
