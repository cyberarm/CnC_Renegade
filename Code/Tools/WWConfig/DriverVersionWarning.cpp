...
static void Get_Driver_Version_Warning_String(StringClass& str, DX8Caps& caps)
{
    ...
    //	str.Format(
    //		"Your current video card driver version is known to cause problems with Renegade. If
    //you encounter problems while playing Renegade, please refer to the readme.txt for instructions
    //on how to update your video card driver.\n"
    //		"\n"
    //		"Driver: %s\n"
    ...
    str.Format(format_string, driver_name, caps.Get_Driver_Build_Version() / 100,
               caps.Get_Driver_Build_Version() % 100);
    ...
    case DX8Caps::VENDOR_3DFX:
        //			str += "There is no driver support for 3Dfx. Website www.x3dfx.com
        //has some unofficial drivers.\n";
...
void CheckDriverVersion()
{
    ...
    */
    render_registry.Set_Int("DriverVersionCheckDisabled",
                            87); // Disable checking if driver version is good
    GlobalExitValue = 0;
