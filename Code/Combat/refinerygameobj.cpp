...
////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<RefineryGameObjDef, CHUNKID_GAME_OBJECT_DEF_REFINERY>
    _RefineryGameObjDefPersistFactory;
SimplePersistFactoryClass<RefineryGameObj, CHUNKID_GAME_OBJECT_REFINERY>
    _RefineryGameObjPersistFactory;
...
//
////////////////////////////////////////////////////////////////
uint32 RefineryGameObjDef::Get_Class_ID(void) const
{
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& RefineryGameObjDef::Get_Factory(void) const
{
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& RefineryGameObj::Get_Factory(void) const
{
...
void RefineryGameObj::Manage_Money_Trickle_Sound(void)
{
    if (MoneyTrickleSound != NULL) {
        ...
        if (same_team) {
            ...
            bool play_sound
                = !IsDestroyed && (DefenseObject.Get_Health() > 0.0f) && IsHarvesterDocked;
