...
bool EncyclopediaMgrClass::Load(ChunkLoadClass& cload)
{
    ...
    while (cload.Open_Chunk()) {
        ...
        case CHUNKID_TYPE_DATA: {
            ...
            //
            const VectorClass<unsigned char>& bit_array
                = KnownObjectVector[type_index].Get_Bit_Array();
...
void EncyclopediaMgrClass::Load_Variables(ChunkLoadClass& cload)
{
    /*while (cload.Open_Micro_Chunk ()) {
            switch (cload.Cur_Micro_Chunk_ID ()) {
                    ...
                    //READ_MICRO_CHUNK (cload, VARID_CENTER_POINT,
    MapCenterPoint);
                    //READ_MICRO_CHUNK (cload, VARID_SCALE,
    MapScale); default: break;
            }
