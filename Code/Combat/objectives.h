...
public:
    ...
    static void Add_Objective(int id, int type, int status, int short_description_id,
    ...
    static void Set_Objective_HUD_Info(int id, float priority, const char* texture_name,
                                       int message_id);
    static void Set_Objective_HUD_Info(int id, float priority, const char* texture_name,
    ...
    static void Set_Num_Specified_Tertiary_Objectives(int count)
    {
        NumSpecifiedTertiaryObjectives = count;
    }
