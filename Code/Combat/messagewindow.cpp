...
void MessageWindowClass::Initialize(void)
{
    ...
    TextWindow->Set_Backdrop(
        "hud_6x4_Messages.tga", CurrentRect, settings->Get_Messages_Texture_Size(),
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Add_Message(const WideStringClass& message, const Vector3& color,
                                     SmartGameObj* game_obj, float decay_time)
{
    ...
    icon_rect += Render2DClass::Get_Screen_Resolution().Upper_Left () +
    settings->Get_Messages_Icon_Position ();*/
...
void MessageWindowClass::Update_Window_Rectangle(void)
{
    ...
    if (IsRectangleDirty || (total_height > (CurrentRect.Height() - vert_border))) {
        ...
        CurrentRect.Bottom
            = WWMath::Clamp(CurrentRect.Top + total_height + vert_border, 0, screen_rect.Bottom);
