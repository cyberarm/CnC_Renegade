...
DECLARE_DEFINITION_FACTORY(SpecialEffectsGameObjDef, CLASSID_GAME_OBJECT_DEF_SPECIAL_EFFECTS,
                           "Special Effects")
...
//
///////////////////////////////////////////////////////////////////////////
uint32 SpecialEffectsGameObjDef::Get_Class_ID(void) const
{
...
void SpecialEffectsGameObj::Do_Effect(void)
{
    ...
    if (model != NULL) {
        ...
        if (Get_Definition().SoundDefID > 0) {
            WWAudioClass::Get_Instance()->Create_Instant_Sound(Get_Definition().SoundDefID,
                                                               Get_Transform());
        }
    }
