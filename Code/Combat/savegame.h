...
public:
    ...
    // Utility functions
    static bool Smart_Peek_Description(const char* filename, WideStringClass& description,
                                       WideStringClass& mission_name);
    static bool Smart_Peek_Map_Name(const char* filename, StringClass& map_name);
    static bool Peek_Description(const char* filename, WideStringClass& description,
                                 WideStringClass& mission_name);
    ...
    static void Pre_Load_Game(const char* filename, StringClass& filename_to_load,
