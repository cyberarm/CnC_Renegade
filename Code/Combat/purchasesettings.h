...
public:
    ...
    //	Alternate support
    //
    int Get_Alt_Definition(int index, int alt_index)
    {
        return AlternateDefinitionList[index][alt_index];
    }
    const StringClass& Get_Alt_Texture(int index, int alt_index)
    {
        return AlternateTextureList[index][alt_index];
    }
