...
//
////////////////////////////////////////////////////////////////
void BaseControllerClass::Notify_Team(Notification event, BuildingType type)
{
    return;
}
...
//
////////////////////////////////////////////////////////////////
void BaseControllerClass::Think(void)
{
    return;
}
...
void BaseControllerClass::Distribute_Funds_To_Each_Teammate(int funds)
{
    ...
    for (node = list->Head(); node != nullptr; node = node->Next()) {
        ...
        //
        if (player != nullptr && (player->Get_Player_Type() == PlayerType)) {
            //
...
void BaseControllerClass::Enable_Radar(bool onoff)
{
    if (IsRadarEnabled != onoff) {
        ...
        //
        if (COMBAT_STAR != nullptr && (COMBAT_STAR->Get_Player_Type() == PlayerType)) {
            //
