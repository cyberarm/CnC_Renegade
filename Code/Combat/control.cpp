        ...
        case CHUNKID_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_PENDING_ONE_TIME_BOOL,
                                     PendingOneTimeBooleanBits);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_PENDING_CONTINUOUS_BOOL,
                                     PendingContinuousBooleanBits);
...
void ControlClass::Clear_Boolean(void)
{
    ...
    WWASSERT((8 * sizeof(ControlClass::ContinuousBooleanBits))
             >= ControlClass::NUM_BOOLEAN_CONTINUOUS);
