...
SimplePersistFactoryClass<CinematicGameObjDef, CHUNKID_GAME_OBJECT_DEF_CINEMATIC>
    _CinematicGameObjDefPersistFactory;
        ...
        case CHUNKID_DEF_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK_WWSTRING(cload, MICROCHUNKID_DEF_SOUND_BONE_NAME,
                                              SoundBoneName);
                    READ_MICRO_CHUNK_WWSTRING(cload, XXX_MICROCHUNKID_DEF_ANIMATION_NAME,
                                              AnimationName);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_AUTO_FIRE_WEAPON, AutoFireWeapon);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_DESTROY_AFTER_ANIMATION,
...
** CinematicGameObj
*/
SimplePersistFactoryClass<CinematicGameObj, CHUNKID_GAME_OBJECT_CINEMATIC>
    _CinematicGameObjPersistFactory;
...
void CinematicGameObj::Post_Think(void)
{
    ...
    if (Get_Definition().DestroyAfterAnimation) {
        ...
        if (pobj != nullptr) {
            ...
            if ((dpobj != nullptr) && (dpobj->Get_Animation_Manager().Peek_Animation() != nullptr)
