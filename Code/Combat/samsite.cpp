...
SimplePersistFactoryClass<SAMSiteGameObjDef, CHUNKID_GAME_OBJECT_DEF_SAMSITE>
    _SAMSiteGameObjDefPersistFactory;

DECLARE_DEFINITION_FACTORY(SAMSiteGameObjDef, CLASSID_GAME_OBJECT_DEF_SAMSITE, "SAMSite")
_SAMSiteGameObjDefDefFactory;
...
**
*/
SimplePersistFactoryClass<SAMSiteGameObj, CHUNKID_GAME_OBJECT_SAMSITE>
    _SAMSiteGameObjPersistFactory;
