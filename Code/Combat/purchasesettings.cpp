...
//	Factories
///////////////////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<PurchaseSettingsDefClass, CHUNKID_GLOBAL_SETTINGS_DEF_PURCHASE>
    _PurchaseDefPersistFactory;
DECLARE_DEFINITION_FACTORY(PurchaseSettingsDefClass, CLASSID_GLOBAL_SETTINGS_DEF_PURCHASE,
                           "Purchase Settings")
...
//
    ...
    for (int index = 0; index < MAX_ENTRIES; index++) {
        ...
        //
        NAMED_EDITABLE_PARAM(PurchaseSettingsDefClass, ParameterClass::TYPE_STRINGSDB_ID,
                             NameList[index], "Name");
        NAMED_EDITABLE_PARAM(PurchaseSettingsDefClass, ParameterClass::TYPE_INT, CostList[index],
                             "Cost");
        ...
        for (int alt_index = 0; alt_index < MAX_ALTERNATES; alt_index++) {
            ...
            GenericDefParameterClass* param
                = new GenericDefParameterClass(&(AlternateDefinitionList[index][alt_index]));
            param->Set_Class_ID(CLASSID_GAME_OBJECTS);
            param->Set_Name(name);
            GENERIC_EDITABLE_PARAM(PurchaseSettingsDefClass, param)
        }
...
//
///////////////////////////////////////////////////////////////////////////////////////////
uint32 PurchaseSettingsDefClass::Get_Class_ID(void) const
{
...
//
///////////////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass& PurchaseSettingsDefClass::Get_Factory(void) const
{
...
bool PurchaseSettingsDefClass::Save(ChunkSaveClass& csave)
{
    ...
    for (int index = 0; index < MAX_ENTRIES; index++) {
        ...
        for (int alt_index = 0; alt_index < MAX_ALTERNATES; alt_index++) {
            ...
            WRITE_MICRO_CHUNK_WWSTRING(csave, VARID_ALT_TEXTURE_NAME,
                                       AlternateTextureList[index][alt_index]);
            WRITE_MICRO_CHUNK(csave, VARID_ALT_DEFINITION,
                              AlternateDefinitionList[index][alt_index]);
        }
    }
...
void PurchaseSettingsDefClass::Load_Variables(ChunkLoadClass& cload)
{
    ...
    while (cload.Open_Micro_Chunk()) {
        ...
        case VARID_ALT_DEFINITION:
            if (entry_index >= 0 && entry_index < MAX_ENTRIES && alt_index >= 0
                && alt_index < MAX_ALTERNATES) {
