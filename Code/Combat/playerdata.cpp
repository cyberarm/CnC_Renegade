        ...
        case CHUNKID_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_STAT_VEHICLES_DESTROYED,
                                     StatVehiclesDestroyed);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_STAT_TIME_IN_VEHICLES, StatTimeInVehicles);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_STAT_KILLS_FROM_VEHICLES,
                                     StatKillsFromVehicles);
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_STAT_BUILDINGS_DESTROYED,
                                     StatBuildingsDestroyed);
...
//------------------------------------------------------------------------------------
bool PlayerDataClass::Get_Weapon_Fired(int index, unsigned long& weaponID,
                                       unsigned long& firedCount) const
{
