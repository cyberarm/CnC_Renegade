...
** This class is an editable definition for a building.  It contains all constant data needed to
*initialize
** a BuildingGameObj.
*/
...
public:
    ...
    */
    ...
    // virtual float
    // Compute_Object_Priority (int client_id, const Vector3 &client_pos); virtual	void
