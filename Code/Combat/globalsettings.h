...
public:
    ...
    const char* Get_Purchase_GDI_Characters_Texture(void) const
    {
        return PurchaseGDICharactersTexture;
    }
    const char* Get_Purchase_GDI_Vehicles_Texture(void) const { return PurchaseGDIVehiclesTexture; }
    const char* Get_Purchase_GDI_Equipment_Texture(void) const
    {
        return PurchaseGDIEquipmentTexture;
    }

    const char* Get_Purchase_NOD_Characters_Texture(void) const
    {
        return PurchaseNODCharactersTexture;
    }
    const char* Get_Purchase_NOD_Vehicles_Texture(void) const { return PurchaseNODVehiclesTexture; }
    const char* Get_Purchase_NOD_Equipment_Texture(void) const
    {
        return PurchaseNODEquipmentTexture;
    }

    const char* Get_Purchase_NOD_MUT_Characters_Texture(void) const
    {
        return PurchaseNODMUTCharactersTexture;
    }
    const char* Get_Purchase_NOD_MUT_Vehicles_Texture(void) const
    {
        return PurchaseNODMUTVehiclesTexture;
    }
    const char* Get_Purchase_NOD_MUT_Equipment_Texture(void) const
    {
        return PurchaseNODMUTEquipmentTexture;
    }

    const char* Get_Purchase_GDI_MUT_Characters_Texture(void) const
    {
        return PurchaseGDIMUTCharactersTexture;
    }
    const char* Get_Purchase_GDI_MUT_Vehicles_Texture(void) const
    {
        return PurchaseGDIMUTVehiclesTexture;
    }
    const char* Get_Purchase_GDI_MUT_Equipment_Texture(void) const
    {
        return PurchaseGDIMUTEquipmentTexture;
    }
