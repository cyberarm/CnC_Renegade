...
public:
    ...
    {
        return (Animation == nullptr) || ((Mode == ANIM_MODE_ONCE) && (Frame == NumFrames - 1))
...
public:
    ...
    virtual void Set_Animation(const char* name, float blendtime = 0.0f, float start_frame = 0.0f)
        = 0;
    virtual void Set_Animation(const HAnimClass* anim, float blendtime = 0.0f,
...
public:
    ...
    virtual void Set_Animation(const HAnimClass* anim, float blendtime = 0.0f,
                               float start_frame = 0.0f);
    virtual void Set_Animation(const char* name1, const char* name2, float ratio,
