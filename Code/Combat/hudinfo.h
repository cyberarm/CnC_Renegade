...
public:
    ...
    static DamageableGameObj* Get_Weapon_Target_Object(void)
    {
        return (DamageableGameObj*)WeaponTargetObject.Get_Ptr();
    }
    ...
    static DamageableGameObj* Get_Info_Object(void)
    {
        return (DamageableGameObj*)InfoObject.Get_Ptr();
    }
    ...
    static void Set_HUD_Help_Text(const WCHAR* string,
