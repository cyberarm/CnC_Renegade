...
//	Constants
//////////////////////////////////////////////////////////////////////////
static const AABoxClass BOSS_AREA_BOX01(Vector3(-19.2585F, 27.7224F, 0.434677F),
                                        Vector3(5.06771F, 15.6146F, 1.0F));
static const AABoxClass BOSS_AREA_BOX02(Vector3(-42.3353F, 32.8650F, 0.434677F),
                                        Vector3(18.1846F, 22.7105F, 1.0F));
static const AABoxClass BOSS_AREA_BOX03(Vector3(-64.4650F, 29.5306F, 0.434677F),
                                        Vector3(4.15638F, 18.2853F, 1.0F));
...
static const char* TAUNT_IDS[6]
    = { "IDS_SAKURA_BOSS_TAUNT1", "IDS_SAKURA_BOSS_TAUNT2", "IDS_SAKURA_BOSS_TAUNT3",
...
SimplePersistFactoryClass<MendozaBossGameObjClass, CHUNKID_GAME_OBJECT_MENDOZA_BOSS>
    _MendozaBossGameObjPersistFactory;
DECLARE_DEFINITION_FACTORY(MendozaBossGameObjDefClass, CLASSID_GAME_OBJECT_DEF_MENDOZA_BOSS,
                           "Mendoza Boss")
...
//
//////////////////////////////////////////////////////////////////////////
uint32 MendozaBossGameObjDefClass::Get_Class_ID(void) const
{
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjDefClass::Save_Variables(ChunkSaveClass& csave)
{
    return;
}
...
void MendozaBossGameObjDefClass::Load_Variables(ChunkLoadClass& cload)
{
    /*while (cload.Open_Micro_Chunk ()) {
            switch (cload.Cur_Micro_Chunk_ID ()) {
                    ...
                    default:
                            Debug_Say (("Unrecognized MendozaBossGameObjDefClass Variable chunkID
...
void MendozaBossGameObjClass::Load_Variables(ChunkLoadClass& cload)
{
    ...
    while (cload.Open_Micro_Chunk()) {
        switch (cload.Cur_Micro_Chunk_ID()) {
            ...
            READ_MICRO_CHUNK(cload, VARID_NEXT_KNOCKDOWN_AVAILABLE_TIME,
                             NextKnockdownAvailableTime);
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::On_MENDOZA_STATE_FALLING_Request_End(int /*new_state*/)
{
    return false;
}
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::On_MENDOZA_STATE_KIPPING_Request_End(int /*new_state*/)
{
    return false;
}
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::STATE_IMPL_REQUEST_END(MENDOZA_STATE_PACK_EXPLODING)(int state)
{
    return false;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_NORMAL_Begin(void)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_NONE_Begin(void)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_NONE_Think(void)
{
    return;
}
...
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_FIREBALL)(void)
{
    ...
    //
    Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_FIRE_PRIMARY,
                        turn_on_weapon && is_safe_to_fire);
    Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_FIRE_SECONDARY,
                        turn_on_weapon && !is_safe_to_fire);
...
bool MendozaBossGameObjClass::Apply_Bone_Collision_Damage(const char* bone_name)
{
    ...
    ((Animatable3DObjClass*)Peek_Model())
        ->Simple_Evaluate_Bone(bone_index, LastMeleeAnimFrame, &last_bone_tm);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_FIREBALL_ATTACK)(void)
{
    return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_WAITING)(void)
{
    return;
}
...
void MendozaBossGameObjClass::Spawn_Health_Powerups(void)
{
    ...
    for (int index = 0; index < POWERUP_COUNT; index++) {
        ...
        //
        Vector3 rand_pos;
        rand_pos.X = area_box->Center.X
            + WWMath::Random_Float(-area_box->Extent.X * 0.95F, area_box->Extent.X * 0.95F);
        rand_pos.Y = area_box->Center.Y
            + WWMath::Random_Float(-area_box->Extent.Y * 0.95F, area_box->Extent.Y * 0.95F);
        ...
        if (PathfindClass::Get_Instance()->Find_Random_Spot(rand_pos, 1.0F, &rand_pos)) {
            ...
            CastResultStruct result;
            PhysRayCollisionTestClass ray_test(ray_cast, &result, TERRAIN_ONLY_COLLISION_GROUP,
