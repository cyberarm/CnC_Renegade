...
//	Factories
///////////////////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<EvaSettingsDefClass, CHUNKID_GLOBAL_SETTINGS_DEF_EVA>
    _EvaSettingsDefPersistFactory;
      ...
      MessagesIconPos(DEF_MESSAGESICONPOS)
{
    ...
    NAMED_EDITABLE_PARAM(EvaSettingsDefClass, ParameterClass::TYPE_VECTOR2, MessagesTextureSize,
                         "Texture Size (pixels)");
    NAMED_EDITABLE_PARAM(EvaSettingsDefClass, ParameterClass::TYPE_RECT, MessagesEndcapUVRect,
                         "Endcap UV Rect (pixels)");
...
//
///////////////////////////////////////////////////////////////////////////////////////////
uint32 EvaSettingsDefClass::Get_Class_ID(void) const
{
...
//
///////////////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass& EvaSettingsDefClass::Get_Factory(void) const
{
        ...
        case CHUNKID_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, VARID_OBJECTIVESBACKGROUNDUVRECT,
                                     ObjectivesBackgroundUVRect);
                    ...
                    READ_MICRO_CHUNK(cload, VARID_MESSAGESBACKGROUNDUVRECT,
                                     MessagesBackgroundUVRect);
