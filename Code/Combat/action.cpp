...
{
    Display_Findpaths = !Display_Findpaths;
}
...
public:
    ...
    */
    ...
    virtual void Modify_Parameters(const SafeActionParamsStruct& parameters, bool modify_move,
                                   bool modify_attack)
    {
    }
...
public:
    ...
    {
        return _FollowInputActionCodeClassFactory;
    }
    ...
    */
    ...
    virtual ActResult Act(void)
    {
        ...
        if ((obj->As_SoldierGameObj() != NULL)
            ...
            amount = Input::Get_Amount(INPUT_FUNCTION_TURN_LEFT)
                - Input::Get_Amount(INPUT_FUNCTION_TURN_RIGHT);
        }
        obj->Set_Analog_Control(ControlClass::ANALOG_TURN_LEFT, amount);

        float forward_amount = Input::Get_Amount(INPUT_FUNCTION_MOVE_FORWARD)
            - Input::Get_Amount(INPUT_FUNCTION_MOVE_BACKWARD);
        float left_amount = Input::Get_Amount(INPUT_FUNCTION_MOVE_LEFT)
            - Input::Get_Amount(INPUT_FUNCTION_MOVE_RIGHT);
        float up_amount = Input::Get_Amount(INPUT_FUNCTION_MOVE_UP)
        ...
        if (obj->As_SoldierGameObj() && obj->As_SoldierGameObj()->Get_Vehicle()) {
            ...
            if (vehicle->Is_Aircraft()
                && (Input::Is_Button_Down(DIK_LCONTROL) || Input::Is_Button_Down(DIK_LMENU))) {
                left_amount = amount;
...
#else
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_WALK,
                                 Input::Get_State(INPUT_FUNCTION_WALK_MODE));
#endif
        ...
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_NEXT,
                                 Input::Get_State(INPUT_FUNCTION_NEXT_WEAPON));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_PREV,
                                 Input::Get_State(INPUT_FUNCTION_PREV_WEAPON));
        ...
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_USE,
                                 Input::Get_State(INPUT_FUNCTION_USE_WEAPON));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_RELOAD,
                                 Input::Get_State(INPUT_FUNCTION_RELOAD_WEAPON));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_DIVE_FORWARD,
                                 Input::Get_State(INPUT_FUNCTION_DIVE_FORWARD));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_DIVE_BACKWARD,
                                 Input::Get_State(INPUT_FUNCTION_DIVE_BACKWARD));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_DIVE_LEFT,
                                 Input::Get_State(INPUT_FUNCTION_DIVE_LEFT));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_DIVE_RIGHT,
                                 Input::Get_State(INPUT_FUNCTION_DIVE_RIGHT));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_CROUCH,
                                 Input::Get_State(INPUT_FUNCTION_CROUCH));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_ACTION,
                                 Input::Get_State(INPUT_FUNCTION_ACTION));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_DROP_FLAG,
                                 Input::Get_State(INPUT_FUNCTION_DROP_FLAG));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_NO_WEAPON,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_NO_WEAPON));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_0,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_0));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_1,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_1));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_2,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_2));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_3,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_3));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_4,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_4));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_5,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_5));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_6,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_6));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_7,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_7));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_8,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_8));
        obj->Set_Boolean_Control(ControlClass::BOOLEAN_SELECT_WEAPON_9,
                                 Input::Get_State(INPUT_FUNCTION_SELECT_WEAPON_9));
...
SimplePersistFactoryClass<StandActionCodeClass, CHUNKID_ACTION_CODE_STAND>
    _StandActionCodeClassFactory;
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _StandActionCodeClassFactory;
    }
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _PlayAnimationActionCodeClassFactory;
    }
    ...
    */
    ...
    bool Move_To_Absolute(const Vector3& abs_pos, bool ignore_arrived_dist = false)
    {
        ...
        if (!IsAttacking && !Action->Get_Parameters().ForceFacing
            && !Action->Get_Parameters().IgnoreFacing && soldier && !soldier->Is_On_Ladder()
            && (range > 0.1f)) {
...
SimplePersistFactoryClass<GotoActionCodeClass, CHUNKID_ACTION_CODE_GOTO>
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _GotoActionCodeClassFactory;
    }
    ...
    */
    ...
    virtual void Init(ActionClass* action)
    {
        ...
        if (soldier_obj && Action->Get_Parameters().LookDuration != 0) {
            soldier_obj->Look_At(Action->Get_Parameters().LookLocation,
    ...
    void Initialize_Waypath(void)
    {
        ...
        //	Initialize the path
        //
        Path->Set_Traversal_Type(Action->Get_Parameters().WaypathSplined ? PathClass::SPLINE
                                                                         : PathClass::LINEAR);
        Path->Initialize(waypath, Action->Get_Parameters().WaypointStartID,
                         Action->Get_Parameters().WaypointEndID);
        return;
    }
    ...
    void Release_Path(void)
    {
        ...
        // Reset the PathAction class too - otherwise it keeps the pointer we game it to Path. ST -
        // 9/6/2001 10:36AM
        PathAction.Reset();
        return;
    }
    ...
    void Update_Move_Location(void)
    {
        ...
        if (target == NULL) { // If the target is gone
            ...
            //Stop current Command	(this may get this deleted!)
    ...
    virtual ActResult Act()
    {
        ...
        if (soldier) {
            soldier->Set_Boolean_Control(ControlClass::BOOLEAN_CROUCH,
                                         Action->Get_Parameters().MoveCrouched);
        }
#endif
...
SimplePersistFactoryClass<EnterExitActionCodeClass, CHUNKID_ACTION_CODE_ENTER_EXIT>
    _EnterExitActionCodeClassFactory;
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _EnterExitActionCodeClassFactory;
    }
...
SimplePersistFactoryClass<DiveActionCodeClass, CHUNKID_ACTION_CODE_DIVE>
    _DiveActionCodeClassFactory;
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _DiveActionCodeClassFactory;
    }
    ...
    */
    ...
    virtual ActResult Act(void)
    {
        ...
        Vector3 rel_pos;
        Matrix3D::Inverse_Transform_Vector(obj->Get_Transform(),
                                           Action->Get_Parameters().MoveLocation, &rel_pos);
        ...
        if (WWMath::Fabs(rel_pos.X) > WWMath::Fabs(rel_pos.Y)) {
            ...
            obj->Set_Boolean_Control(rel_pos.Y > 0 ? ControlClass::BOOLEAN_DIVE_LEFT
                                                   : ControlClass::BOOLEAN_DIVE_RIGHT);
        }
...
SimplePersistFactoryClass<AttackActionCodeClass, CHUNKID_ACTION_CODE_ATTACK>
    _AttackActionCodeClassFactory;
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _AttackActionCodeClassFactory;
    }
            ...
            case CHUNKID_VARIABLES:
                while (cload.Open_Micro_Chunk()) {
                    switch (cload.Cur_Micro_Chunk_ID()) {
                        ...
                        READ_MICRO_CHUNK(cload, MICROCHUNKID_CHECK_BLOCKED_TIMER,
                                         CheckBlockedTimer);
                    default:
                        Debug_Say(("Unhandled Micro Chunk:%d File:%s Line:%d\r\n",
                                   cload.Cur_Micro_Chunk_ID(), __FILE__, __LINE__));
            ...
            if (CheckBlockedTimer <= 0) {
                ...
                if (hit_obj != NULL) {
                    if (UseAttackObject) {
                        ...
                        if (IsBlocked && target->As_SoldierGameObj()
                            && target->As_SoldierGameObj()->Get_Vehicle() == hit_obj) {
                            IsBlocked = false;
                        }
                    }
                    else {
...
#else
                soldier->Set_Boolean_Control(ControlClass::BOOLEAN_CROUCH,
                                             Action->Get_Parameters().AttackCrouched);
#endif
            }
        }
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _FaceLocationActionCodeClassFactory;
    }
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _ConversationActionCodeClassFactory;
    }
        ...
        if (obj != NULL) {
            ...
            if (soldier != NULL) {
                ...
                if (action->Get_Parameters().ActiveConversationID != 0) {
                    Conversation = ConversationMgrClass::Find_Active_Conversation(
                        action->Get_Parameters().ActiveConversationID);
                }
                else {
                    ...
                    //
                    Conversation = ConversationMgrClass::Start_Conversation(
                        soldier, action->Get_Parameters().SafeConversationName);
                }
...
SimplePersistFactoryClass<DockActionCodeClass, CHUNKID_ACTION_CODE_DOCK>
    _DockActionCodeClassFactory;
...
public:
    virtual const PersistFactoryClass& Get_Factory(void) const
    {
        return _DockActionCodeClassFactory;
    }
    ...
    virtual ActResult Arrived(void)
    {
        ...
        if (State == STATE_DRIVING_TO_ENTRANCE) {
            ...
            if (turn_radius == 0) {
                ...
                Vector3 side_pos
                    = params.DockLocation + (params.DockEntrance - params.DockLocation) * 0.8F;
            ...
            test_waypath->Add_Point(params.DockLocation
                                    + (params.DockEntrance - params.DockLocation) * 0.7F
                                    - (side_vector * turn_radius * 0.6F));
            test_waypath->Add_Point(params.DockLocation
                                    + (params.DockEntrance - params.DockLocation) * 0.3F);
            test_waypath->Add_Point(params.DockLocation);
        ...
        case CHUNKID_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_MOVE_ARRIVED_DISTANCE,
                                     MoveArrivedDistance);
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_SHUTDOWN_ENGINE_ON_ARRIVAL,
                                     ShutdownEngineOnArrival);
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_ATTACK_ERROR_OVERRIDE,
                                     AttackErrorOverride);
                    ...
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_ATTACK_WANDER_ALLOWED,
                                     AttackWanderAllowed);
                    ...
                    READ_MICRO_CHUNK_WWSTRING(cload, MICROCHUNKID_ANIMATION_NAME,
                                              SafeAnimationName);
                    ...
                    READ_MICRO_CHUNK_WWSTRING(cload, MICROCHUNKID_CONVERSATION_NAME,
                                              SafeConversationName);
                    READ_MICRO_CHUNK(cload, MICROCHUNKID_ACTIVE_CONVERSATION_ID,
