...
////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<BeaconGameObjDef, CHUNKID_GAME_OBJECT_DEF_BEACON>
    _BeaconGameObjDefPersistFactory;
SimplePersistFactoryClass<BeaconGameObj, CHUNKID_GAME_OBJECT_BEACON> _BeaconGameObjPersistFactory;
DECLARE_DEFINITION_FACTORY(BeaconGameObjDef, CLASSID_GAME_OBJECT_DEF_BEACON, "Beacon")
_BeaconGameObjDefDefFactory;
...
//
////////////////////////////////////////////////////////////////
uint32 BeaconGameObjDef::Get_Class_ID(void) const
{
...
bool BeaconGameObjDef::Save(ChunkSaveClass& csave)
{
    ...
    WRITE_MICRO_CHUNK(csave, MICROCHUNKID_DEF_PRE_DETONATE_CINEMATIC_DELAY,
                      PreDetonateCinematicDelay);
...
void BeaconGameObjDef::Load_Variables(ChunkLoadClass& cload)
{
    while (cload.Open_Micro_Chunk()) {
        switch (cload.Cur_Micro_Chunk_ID()) {
            READ_MICRO_CHUNK_WWSTRING(cload, MICROCHUNKID_DEF_ARMING_ANIM_NAME,
                                      ArmingAnimationName);
            ...
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_PRE_DETONATE_CINEMATIC_DELAY,
                             PreDetonateCinematicDelay);
            ...
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_DISARM_INTERRUPT_TEXTID,
                             DisarmingInterruptedTextID);
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_PRE_CINEMATIC_DEFID,
                             PreDetonateCinematicDefID);
            READ_MICRO_CHUNK(cload, MICROCHUNKID_DEF_POST_CINEMATIC_DEFID,
                             PostDetonateCinematicDefID);
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& BeaconGameObjDef::Get_Factory(void) const
{
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass& BeaconGameObj::Get_Factory(void) const
{
        ...
        if (IsArmed == false) {
            ...
            if (CombatManager::I_Am_Server()) {
                ...
                if (is_nuke) {
                    ...
                    BackgroundMgrClass::Override_Lightning(0.8f, 0.2f, 0.8f, 0, 1.0f,
                                                           DetonateTimer / 2);
                    WeatherMgrClass::Override_Precipitation(WeatherMgrClass::PRECIPITATION_RAIN,
                                                            2.0f, DetonateTimer / 2);
                }
            }
    ...
    if (soldier == NULL || soldier->Is_Dead()) {
        ...
        if (retval == false) {
            for (index = ControlClass::BOOLEAN_ONE_TIME_FIRST;
                 index <= ControlClass::BOOLEAN_DROP_FLAG; index++) {
                //
                //	Check this input to see if the soldier is moving
                //
                ...
                for (obj_node = GameObjManager::Get_Building_Game_Obj_List()->Head();
                    ...
                    if (building != NULL) {
                        ...
                        if (dist2 <= outter_radius2) {
                            ...
                            //
                            OffenseObjectClass offense(strength, explosion_def->DamageWarhead,
                                                       Get_Owner());
