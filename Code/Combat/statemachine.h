...
#define ADD_STATE_TO_MACHINE(machine, state)                                                       \
    machine.Add_State(On_##state##_Think, On_##state##_Request_End, On_##state##_Begin,            \
                      On_##state##_End);
...
#define DECLARE_STATE(state, begin, end, think, req_end)                                           \
    void On_##state##_Begin(void) begin void On_##state##_End(void)                                \
        end void On_##state##_Think(void) think bool On_##state##_Request_End(int state) req_end
...
public:
    ...
    //	Add_State
    ///////////////////////////////////////////////////////////////////
    void Add_State(STATE_OBJ::THINK_PTR think_ptr, STATE_OBJ::REQUEST_END_PTR request_ptr,
                   STATE_OBJ::BEGIN_PTR begin_ptr, STATE_OBJ::END_PTR end_ptr)
    {
        StateClass<T> state;
