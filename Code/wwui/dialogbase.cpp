...
void DialogBaseClass::Start_Dialog(void)
{
    ...
    for (int index = 0; index < control_list.Count(); index++) {
        ...
        if (control != NULL) {
            ...
            RectClass rect;
            rect.Left
                = int(Rect.Left + ((((float)info.x) / RES_SCREEN_WIDTH) * screen_rect.Width()));
            rect.Top
                = int(Rect.Top + ((((float)info.y) / RES_SCREEN_HEIGHT) * screen_rect.Height()));
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::Is_Active(void)
{
...
//
////////////////////////////////////////////////////////////////
DialogControlClass* DialogBaseClass::Find_Next_Group_Control(DialogControlClass* control,
                                                             int direction)
{
    //
    //	Build a complete list of controls
...
//
////////////////////////////////////////////////////////////////
int DialogBaseClass::Find_Control_Index(DialogControlClass* control)
{
