...
void ButtonCtrlClass::Create_Bitmap_Button(void)
{
    ...
    TextureClass::MIP_LEVELS_1); ButtonRenderers[0].Set_Texture (texture);
...
void ButtonCtrlClass::Create_Component_Button(void)
{
    ...
    TextureClass* texture = WW3DAssetManager::Get_Instance()->Get_Texture(
        "if_circle02.tga", TextureClass::MIP_LEVELS_1);
    ...
    ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Right - edge_width, Rect.Top),
                   Vector2(right - edge_width, top), Vector2(edge_width, height),
                   texture_dimensions);
    ...
    ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Left, Rect.Bottom - height),
                   Vector2(left, bottom - height), Vector2(edge_width, height), texture_dimensions);
    ...
    while (remaining_height > 0) {
            ...
            while (remaining_width > 0) {
                    ...
                    ::Blit_Section (ButtonRenderers[0], Vector2 (x_pos, y_pos), Vector2 ((right / 2)
    - 4, (bottom / 2) - 4), size, texture_dimensions);

                    ::Blit_Section (ButtonRenderers[1], Vector2 (x_pos, y_pos), Vector2 ((right / 2)
    - 4, dn_start + (bottom / 2) - 4), size, texture_dimensions);
...
void ButtonCtrlClass::Set_Bitmap(const char* texture_up_name, const char* texture_dn_name)
{
    ...
    //
    TextureClass* texture_up = WW3DAssetManager::Get_Instance()->Get_Texture(
        texture_up_name, TextureClass::MIP_LEVELS_1);
    ...
    if (texture_dn_name != nullptr && texture_dn_name[0] != 0) {
        TextureClass* texture_dn = WW3DAssetManager::Get_Instance()->Get_Texture(
            texture_dn_name, TextureClass::MIP_LEVELS_1);
