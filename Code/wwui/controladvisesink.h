...
public:
    ...
    //	Generic callbacks
    //
    virtual bool On_Command(DialogControlClass* control, int ctrl_id, int param1, int param2)
    {
        return false;
    }
    ...
    virtual void On_ListCtrl_Sel_Change(ListCtrlClass* list_ctrl, int ctrl_id, int old_index,
                                        int new_index)
    {
    }
    ...
    virtual void On_TreeCtrl_Sel_Change(TreeCtrlClass* list_ctrl, int ctrl_id,
                                        TreeItemClass* old_item, TreeItemClass* new_item)
    {
    }
    virtual void On_TreeCtrl_Needs_Children(TreeCtrlClass* list_ctrl, int ctrl_id,
    ...
    //
    virtual void On_ViewerCtrl_Model_Loaded(ViewerCtrlClass* viewer_ctrl, int ctrl_id,
    ...
    virtual bool On_EditCtrl_Key_Down(EditCtrlClass* edit_ctrl, uint32 key_id, uint32 key_data)
    {
        return false;
    }
    ...
    //
    virtual void On_ComboBoxCtrl_Sel_Change(ComboBoxCtrlClass* combo_ctrl, int ctrl_id, int old_sel,
                                            int new_sel)
    {
    }
