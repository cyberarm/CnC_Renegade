...
void ToolTipClass::Create_Background_Renderer(void)
{
    ...
    //
    RectClass rect = Rect;
    renderer.Add_Line(Vector2(rect.Left, rect.Bottom), Vector2(rect.Left, rect.Top - 1), 1,
                      hilight_color);
    renderer.Add_Line(Vector2(rect.Left, rect.Top), Vector2(rect.Right, rect.Top), 1,
                      hilight_color);
    renderer.Add_Line(Vector2(rect.Right, rect.Top), Vector2(rect.Right, rect.Bottom), 1,
                      shadow_color);
    renderer.Add_Line(Vector2(rect.Right, rect.Bottom), Vector2(rect.Left, rect.Bottom), 1,
                      shadow_color);
