...
//
////////////////////////////////////////////////////////////////
static void Blit_Section(Render2DClass& renderer, const Vector2& screen_pos,
                         const Vector2& texture_pos, const Vector2& pixels,
                         const Vector2& texture_dimensions, int color)
{
...
void HealthBarCtrlClass::Create_Control_Renderer(void)
{
    ...
    while (remaining_width > 0) {
        ...
        //	Draw this section
        //
        ::Blit_Section(ControlRenderer, Vector2(x_pos, Rect.Top), *texture_pos, *size, TEXTURE_SIZE,
                       color);
