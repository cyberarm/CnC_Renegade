...
void CheckBoxCtrlClass::Create_Control_Renderers(void)
{
    ...
    if (IsChecked) {
        ...
        renderer.Add_Line(Vector2(rect.Left - 1, rect.Top + 1),
                          Vector2(rect.Right - 2, rect.Bottom + 1), 2, shadow_color);
        renderer.Add_Line(Vector2(rect.Left - 1, rect.Bottom + 1),
                          Vector2(rect.Right - 2, rect.Top + 1), 2, shadow_color);

        renderer.Add_Line(Vector2(rect.Left, rect.Top), Vector2(rect.Right - 1, rect.Bottom), 2,
                          text_color);
        renderer.Add_Line(Vector2(rect.Left, rect.Bottom), Vector2(rect.Right - 1, rect.Top), 2,
                          text_color);
    }
