...
static const char* TEXTURE_NAME[MouseMgrClass::CURSOR_COUNT]
    = { "cursor_arrow.tga", "cursor_text.tga",   "cursor_action.tga",
        "cursor_busy.tga",  "cursor_pan_up.tga", "cursor_rotate.tga" };

static Vector2 HOTSPOTS[MouseMgrClass::CURSOR_COUNT]
    = { Vector2(0, 0),   Vector2(15, 15), Vector2(7, 1),
...
void MouseMgrClass::Initialize(void)
{
    ...
    for (int index = 0; index < CURSOR_COUNT; index++) {
        Textures[index] = WW3DAssetManager::Get_Instance()->Get_Texture(TEXTURE_NAME[index],
