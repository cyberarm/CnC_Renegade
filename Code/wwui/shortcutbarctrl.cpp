      ...
      PulseDirection(-1.0F)
{
    ...
    TextureClass* texture
        = WW3DAssetManager::Get_Instance()->Get_Texture("if_bar.tga", TextureClass::MIP_LEVELS_1);
    ...
    for (int index = 0; index < ShortcutList.Count(); index++) {
        ...
        if (index == CurrSel) {
            ...
            StyleMgrClass::Render_Text(text, &HilightRenderer, StyleMgrClass::Get_Tab_Text_Color(),
                                       StyleMgrClass::Get_Text_Shadow_Color(), text_rect, true,
                                       true, StyleMgrClass::CENTER_JUSTIFY);
