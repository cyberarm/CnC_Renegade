...
static const RectClass TopBtnUpUVs[2]
    = { RectClass(100, 212, 121, 234), RectClass(147, 228, 169, 241) };

static const RectClass TopBtnDnUVs[2]
    = { RectClass(76, 212, 98, 234), RectClass(147, 213, 169, 226) };

static const RectClass BottomBtnUpUVs[2]
    = { RectClass(52, 212, 74, 234), RectClass(123, 228, 145, 241) };

static const RectClass BottomBtnDnUVs[2]
    = { RectClass(28, 212, 50, 234), RectClass(123, 213, 145, 226) };

static const RectClass ThumbDnUVs[2]
    = { RectClass(233, 138, 254, 204), RectClass(171, 213, 193, 222) };

static const RectClass ThumbUpUVs[2]
    = { RectClass(233, 70, 254, 136), RectClass(171, 224, 193, 233) };
      ...
      IsSmallBMPMode(false)
{
    ...
    TextureClass* texture = WW3DAssetManager::Get_Instance()->Get_Texture(
        "IF_MENUPARTS9.TGA", TextureClass::MIP_LEVELS_1);
