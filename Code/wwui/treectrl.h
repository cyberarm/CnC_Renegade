...
typedef int(CALLBACK* TREECTRL_SORT_CALLBACK)(TreeCtrlClass* tree_ctrl, TreeItemClass* item1,
...
public:
    ...
    //	Content control
    //
    TreeItemClass* Insert_Item(const WCHAR* name, const char* icon_name,
    ...
    void Sort_Children(TreeItemClass* parent, TREECTRL_SORT_CALLBACK sort_callback,
                       uint32 user_param);
...
protected:
    ...
    static int CALLBACK Alphabetic_Sort_Callback(TreeCtrlClass* tree_ctrl, TreeItemClass* item1,
                                                 TreeItemClass* item2, uint32 user_param);
