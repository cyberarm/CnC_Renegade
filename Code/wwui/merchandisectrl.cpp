      ...
      Count(0)
{
    ...
    TextureClass* texture = WW3DAssetManager::Get_Instance()->Get_Texture(
        "hud_cnc_Button.tga", TextureClass::MIP_LEVELS_1);
...
void MerchandiseCtrlClass::Create_Text_Renderer(void)
{
    ...
    StyleMgrClass::Render_Text(Title, &NameTextRenderer, RGB_TO_INT32(255, 255, 255),
                               RGB_TO_INT32(0, 0, 0), TextRect, true, true,
                               StyleMgrClass::LEFT_JUSTIFY, true);
    StyleMgrClass::Render_Text(cost_text, &CostTextRenderer, RGB_TO_INT32(255, 255, 255),
                               RGB_TO_INT32(0, 0, 0), CostRect, true, true,
                               StyleMgrClass::LEFT_JUSTIFY, true);
    ...
    if (Count > 1) {
        ...
        StyleMgrClass::Render_Text(count_text, &CountTextRenderer, RGB_TO_INT32(255, 255, 255),
                                   RGB_TO_INT32(0, 0, 0), CountRect, true, true,
...
void MerchandiseCtrlClass::Create_Texture_Renderer(void)
{
    ...
    rect.Top		= int(TextureRect.Top + (TextureRect.Height () * 0.5F) - (smallest_dim *
    0.5F)); rect.Right	= int(rect.Left + smallest_dim); rect.Bottom	= int(rect.Top +
    smallest_dim);*/
