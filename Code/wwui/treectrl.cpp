      ...
      IsScrollBarDisplayed(false)
{
    ...
    TextureClass* texture
        = WW3DAssetManager::Get_Instance()->Get_Texture(PLUS_IMAGE, TextureClass::MIP_LEVELS_1);
    if (texture != NULL) {
...
//
////////////////////////////////////////////////////////////////
bool TreeCtrlClass::Render_Item(TreeItemClass* item, float x_pos, float& y_pos, int& row_index,
                                int level)
{
    bool retval = true;
    if (item == NULL) {
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Sort_Children(TreeItemClass* parent, TREECTRL_SORT_CALLBACK sort_callback,
                                  uint32 user_data)
{
...
//
////////////////////////////////////////////////////////////////
TreeItemClass* TreeCtrlClass::Insert_Item(const WCHAR* name, const char* icon_name,
                                          const char* selected_icon_name, TreeItemClass* parent)
{
    //
