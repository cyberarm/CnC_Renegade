...
//
///////////////////////////////////////////////////////////////////////
const PersistFactoryClass& TDBObjClass::Get_Factory(void) const
{
...
bool TDBObjClass::Load(ChunkLoadClass& cload)
{
    while (cload.Open_Chunk()) {
        ...
        case CHUNKID_TRANSLATED_STRING: {
            ...
            cload.Read(string.Get_Buffer((cload.Cur_Chunk_Length() + 1) / 2),
...
void TDBObjClass::Load_Variables(ChunkLoadClass& cload)
{
    while (cload.Open_Micro_Chunk()) {
        ...
        case VARID_STRING: {
            ...
            //
            WideStringClass string;
            cload.Read(string.Get_Buffer((cload.Cur_Micro_Chunk_Length() + 1) / 2),
