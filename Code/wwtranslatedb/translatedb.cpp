...
// Local prototypes
///////////////////////////////////////////////////////////////////////
static int Build_List_From_String(const char* buffer, const char* delimiter,
...
//
///////////////////////////////////////////////////////////////////////
bool TranslateDBClass::Contains_Data(void) const
{
    return true;
}
    ...
    if (file != INVALID_HANDLE_VALUE) {
        ...
        for (int index = 0; index < m_ObjectList.Count(); index++) {
            ...
            if (object != nullptr) {
                ...
                id_entry.Format("#define %s		%d", (const char*)object->Get_ID_Desc(),
                                object->Get_ID());
            ...
            while (found_end_block == false && file_obj.Read_Line(line)) {
                ...
                if (::strnicmp(line, "#define ", 8) == 0) {
                    ...
                    if (curr_break == 4) {
                        ...
                        char id_text[64] = { 0 };
                        ::strncpy(id_desc_text, line.Peek_Buffer() + word_breaks[0],
                                  word_breaks[1] - word_breaks[0]);
                        ::strncpy(id_text, line.Peek_Buffer() + word_breaks[2],
                                  word_breaks[3] - word_breaks[2]);
...
//
///////////////////////////////////////////////////////////////////////
int TranslateDBClass::Get_Object_Count(void)
{
...
//
//////////////////////////////////////////////////////////////
uint32 TranslateDBClass::Get_Version_Number(void)
{
...
//
///////////////////////////////////////////////////////////////////////
int TranslateDBClass::Get_Category_Count(void)
{
