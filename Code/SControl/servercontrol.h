...
public:
    ...
    ** Init, shutdown.
    */
    bool Start_Listening(unsigned short port, char* password,
                         const char* (*app_request_callback)(char*),
                         void (*app_response_callback)(char*), bool loopback = false,
                         unsigned long ip = 0);
...
private:
    ...
    */
    ...
    /*
    ** Are we allowed to listen for control messages from a remote admin (i.e. not LOOPBACK
    *address).
    */
