...
namespace WWOnline
{
    ...
    const wchar_t* GetChannelStatusDescription(ChannelStatus status)
    {
        static const char* _statusDesc[]
            = { "WOL_CHANNELERROR",   "WOL_CHANNELLEFT",     "WOL_CHANNELJOINED",
                "WOL_CHANNELCREATED", "WOL_CHANNELNOTFOUND", "WOL_CHANNELEXISTS",
                "WOL_BADPASSWORD",    "WOL_CHANNELFULL",     "WOL_CHANNELBANNED",
                "WOL_CHANNELKICKED",
