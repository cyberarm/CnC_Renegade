...
bool PhysicsSceneClass::Intersection_Test(PhysAABoxIntersectionTestClass& boxtest,
...
bool PhysicsSceneClass::Intersection_Test(PhysOBBoxIntersectionTestClass& boxtest,
                                          bool use_collision_region)
{
    if (use_collision_region) {
...
bool PhysicsSceneClass::Intersection_Test(PhysMeshIntersectionTestClass& meshtest,
                                          bool use_collision_region)
{
    if (use_collision_region) {
...
bool PhysicsSceneClass::Intersection_Test(const AABoxClass& box, int collision_group,
                                          int collision_type, bool use_collision_region)
{
...
bool PhysicsSceneClass::Intersection_Test(const OBBoxClass& box, int collision_group,
                                          int collision_type, bool use_collision_region)
{
    NonRefPhysListClass intersect_list;
...
void PhysicsSceneClass::Add_Collected_Objects_To_List(bool static_objs, bool dynamic_objs,
...
void PhysicsSceneClass::Add_Collected_Collideable_Objects_To_List(int colgroup, bool static_objs,
                                                                  bool dynamic_objs,
                                                                  NonRefPhysListClass* list)
{
    // link the static objects
...
void PhysicsSceneClass::Collect_Collideable_Objects(const AABoxClass& box, int colgroup,
...
void PhysicsSceneClass::Collect_Collideable_Objects(const OBBoxClass& box, int colgroup,
                                                    bool static_objs, bool dynamic_objs,
                                                    NonRefPhysListClass* list)
{
    WWASSERT(list != nullptr);
