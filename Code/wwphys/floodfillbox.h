...
inline PATHFIND_DIR Clockwise_Pathfind_Dir(PATHFIND_DIR dir)
{
...
public:
    ...
    //////////////////////////////////////////////////////////////////////
    bool Needs_Processing(void) const
    {
        return bool((m_Flags & NeedsProcessing) == NeedsProcessing);
    }
...
// Set_Neighbor
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Set_Neighbor(PATHFIND_DIR dir, FloodfillBoxClass* obj,
                                            bool traversible)
{
    m_Neighbors[dir] = obj;
