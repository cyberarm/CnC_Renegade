...
** or by calling them through a pointer to a physics object e.g.
*my_phys_obj->DEBUG_RENDER_POINT(...)
*/
#ifdef WWDEBUG
...
---------------------------------
  ...
  MoveableObjClass   RefCountClass  CollideableObjClass
         ...
         __________________|_________________________________________________________________
                  |                  |                 | | ProjectileClass     Phys4Class Phys6Class
TerrainPhysClass |              ___|_________________________________ |             | | |
...
public:
    ...
    */
    ...
    /*
    ** Certain physics objects expire when an internal timer runs out or they are crushed.  This
    *function
    ** is used to handle informing any observers and putting this object into the destroy list which
    *is
    ...
    */
    ...
    /*
    ** Culling, this function updates the culling box used by the object.  The default
    *implementation
    ...
    */
    ...
    /*
    ** Lighting system.  Each physics object caches its static lighting environment.  This cache
    *must be
    ** invalidated when the object moves or when static lights near it change state.  The simulation
    *code
    ** for each physics object will be responsible for invalidating the cache when the object moves.
    *The
    ** scene will be responsible for invalidating the caches of objects near lights that change
    *state.
    */
    ...
    */
    void Enable_Debug_Display(bool onoff)
    {
        (onoff ? Flags |= DEBUGDISPLAY : Flags &= ~DEBUGDISPLAY);
    }
    ...
    */
    ...
    bool Is_Force_Projection_Shadow_Enabled(void) const
    {
    ...
    */
    ...
    bool Is_Object_Simulating(void)
    {
...
protected:
    ...
    enum
    {
        ...
        FORCE_PROJECTION_SHADOW = 0x00002000, // When the shadow mode is BLOBS_PLUS, this object
                                              // still uses a "proper" shadow
        DONT_SAVE = 0x00004000, // Scene should never save this object (used for transient things
        ...
        IS_PRE_LIT
        = 0x00020000, // Is this a light-mapped object that doesn't need static lights applied.
        ...
        FRICTION_DISABLED = 0x00200000, // Friction is disabled for this object (vehicles disable
                                        // body-friction when their wheels are in contact)
    ...
    */
    ...
    /*
    ** Frame time at which the sun status was last updated. The sun status is cached and only
    *updated few times per second.
    */
