...
** of this are: elevators, doors, and "cinematic events".  StaticAnimPhysClass and
...
** the second parameter is the name of the member variable which is the animation manager (e.g.
*AnimManager).
*/
...
#define ANIMCOLLISIONMANAGERDEF_EDITABLE_PARAMS(class_name, member_name)                           \
    ...
    GENERIC_EDITABLE_PARAM(class_name, anim_param);                                                \
                                                                                                   \
    NAMED_EDITABLE_PARAM(class_name, ParameterClass::TYPE_STRING, member_name##.AnimationName,     \
                         "AnimationName");
