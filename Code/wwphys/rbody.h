...
struct RigidBodyStateStruct
{
    ...
    bool Is_Valid(void)
    {
        return (Position.Is_Valid() && Orientation.Is_Valid() && LMomentum.Is_Valid()
                && AMomentum.Is_Valid());
    }
...
public:
    ...
    */
    ...
    void Network_Latency_State_Update(const Vector3& new_pos, const Quaternion& new_orientation,
                                      const Vector3& new_vel, const Vector3& new_avel);
...
protected:
    ...
    */
    ...
    virtual int Compute_Derivatives(float t, StateVectorClass* test_state,
                                    StateVectorClass* set_derivs, int start_index);
...
inline void RigidBodyStateStruct::Lerp(const RigidBodyStateStruct& s0,
                                       const RigidBodyStateStruct& s1, float fraction,
                                       RigidBodyStateStruct* res)
{
