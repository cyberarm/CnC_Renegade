...
const float BACKFACE_OVERFLOW_FRACTION
    = 0.005f; // max percentage of backface before overflow (rejection)
 ...
 *   7/18/2000  gth : Created.                                                                 *
 *=============================================================================================*/
void VisRenderContextClass::Scan_Frame_Buffer(const Vector2& min, const Vector2& max,
 ...
 *   7/18/2000  gth : Created.                                                                 *
 *=============================================================================================*/
void VisRenderContextClass::Compute_2D_Bounds(const AABoxClass& wrld_bbox, Vector2* min_v,
                                              Vector2* max_v)
{
