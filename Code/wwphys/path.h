...
protected:
    ...
    void Clip_Spline_To_Pathfind_Data(DynamicVectorClass<PATH_NODE>& node_list,
                                      PathSolveClass& path_solve);

    void Add_Waypath_Data(DynamicVectorClass<PATH_NODE>& node_list, WaypathClass* waypath,
                          int start_index, int end_index);
    void Add_Waypoint_Info_To_Node_List(DynamicVectorClass<PATH_NODE>& node_list,
    ...
    void Clip_Control_Point(const Vector3& start_point, Vector3* point, BOX_LIST& sector_list,
