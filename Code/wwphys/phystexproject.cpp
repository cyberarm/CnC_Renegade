 ...
 *   3/30/2000  gth : Created.                                                                 *
 *=============================================================================================*/
bool PhysTexProjectClass::Compute_Perspective_Projection(PhysClass* obj, const Vector3& lightpos,
 ...
 *   3/30/2000  gth : Created.                                                                 *
 *=============================================================================================*/
bool PhysTexProjectClass::Compute_Ortho_Projection(PhysClass* obj, const Vector3& lightdir,
                                                   float nearz, float farz)
{
    RenderObjClass* model = obj->Peek_Model();
    if (model == nullptr) {
...
bool PhysTexProjectClass::Compute_Texture(PhysClass* obj, bool additive_projection)
{
    ...
    */
    ...
    SpecialRenderInfoClass* context
        = PhysicsSceneClass::Get_Instance()->Get_Shadow_Render_Context(tex_size, tex_size);
    if (context == nullptr) {
        return false;
    }
    ...
    */
    ...
    if (!additive_projection) {
        ...
        MaterialPassClass* shadow_mtl
            = PhysicsSceneClass::Get_Instance()->Get_Shadow_Material_Pass();
        if (shadow_mtl) {
            pushed_mtls = true;
            context->Push_Material_Pass(shadow_mtl);
            context->Push_Override_Flags((RenderInfoClass::RINFO_OVERRIDE_FLAGS)(
