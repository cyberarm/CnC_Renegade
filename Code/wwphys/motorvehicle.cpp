        ...
        case MOTO_CHUNK_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    READ_MICRO_CHUNK(cload, MOTO_VARIABLE_ENGINEANGULARVELOCITY,
...
*/
SimplePersistFactoryClass<MotorVehicleDefClass, PHYSICS_CHUNKID_MOTORVEHICLEDEF>
    _MotorVehicleDefFactory;
...
bool MotorVehicleDefClass::Save(ChunkSaveClass& csave)
{
    ...
    WRITE_MICRO_CHUNK_WWSTRING(csave, MOTORVEHICLEDEF_VARIABLE_ENGINETORQUECURVEFILENAME,
...
bool MotorVehicleDefClass::Load(ChunkLoadClass& cload)
{
    while (cload.Open_Chunk()) {
        ...
        case MOTORVEHICLEDEF_CHUNK_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    READ_MICRO_CHUNK(cload, MOTORVEHICLEDEF_VARIABLE_MAXENGINETORQUE,
                                     MaxEngineTorque);
                    ...
                    READ_MICRO_CHUNK(cload, MOTORVEHICLEDEF_VARIABLE_FINALDRIVEGEARRATIO,
                                     FinalDriveGearRatio);
                    ...
                    READ_MICRO_CHUNK(cload, MOTORVEHICLEDEF_VARIABLE_DRIVETRAININERTIA,
                                     DriveTrainInertia);
                }
                cload.Close_Micro_Chunk();
            }
