...
void PhysicsConstants::Set_Contact_Friction_Coefficient(int obj_type, int surface_type,
                                                        float friction)
{
        ...
        case PHYSCONSTANTS_CHUNK_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, PHYSCONSTANT_RESTINGCONTACTVELOCITY,
                                     RestingContactVelocity);
                    READ_MICRO_CHUNK(cload, PHYSCONSTANT_MINFRICTIONVELOCITY, MinFrictionVelocity);
                    READ_MICRO_CHUNK(cload, PHYSCONSTANT_DEFAULTCONTACTFRICTION,
                                     DefaultContactFriction);
                    READ_MICRO_CHUNK(cload, PHYSCONSTANT_MINFRICTIONVELOCITY2,
                                     MinFrictionVelocity2);
                }
