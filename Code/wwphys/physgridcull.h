...
protected:
    ...
    void collect_visible_objects_recursive(const VolumeStruct& vol, const FrustumClass& frustum,
                                           VisTableClass& vistable, int planes_passed);
    void collect_visible_objects_in_leaf(const FrustumClass& frustum, VisTableClass& pvs,
                                         int address);
