...
**  NOTES:
**
**  I need to abstract the differences between the stealth effect and things like texture
*projections
...
**  since shadows are re-attached every frame.  This also means that the wrapper needs an
*auto-remove
