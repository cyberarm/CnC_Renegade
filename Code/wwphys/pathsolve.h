...
protected:
    ...
    bool Does_Line_Go_Through_Portal(const Vector3& start, const Vector3& end,
...
//	Inlines
/////////////////////////////////////////////////////////////////////////
inline PathSolveClass::STATE_DESC PathSolveClass::Get_State(void) const
{
    return m_State;
}

inline const Vector3& PathSolveClass::Get_Start_Pos(void) const
{
    return m_StartPos;
}

inline const Vector3& PathSolveClass::Get_Dest_Pos(void) const
{
    return m_DestPos;
}
