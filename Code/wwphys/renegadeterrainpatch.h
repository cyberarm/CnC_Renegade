...
public:
    ...
    RenegadeTerrainMaterialPassClass* Peek_Material_Pass(int index)
    {
...
protected:
    ...
    bool Collide_Quad(const LineSegClass& line_seg, int cell_x, int cell_y,
...
//	Collide_Quad
//////////////////////////////////////////////////////////////////////
WWINLINE bool RenegadeTerrainPatchClass::Collide_Quad(const LineSegClass& line_seg, int cell_x,
                                                      int cell_y, CastResultStruct& result)
{
    bool retval = false;
