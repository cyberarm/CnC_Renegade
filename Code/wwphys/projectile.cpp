        ...
        */
        ...
        while ((remaining_time > 0.0f) && (bumps < MAX_BUMPS) && (BounceCount >= 0)) {
            ...
            */
            ...
            PhysRayCollisionTestClass raytest(ray, &res, Get_Collision_Group(),
...
*/
DECLARE_DEFINITION_FACTORY(ProjectileDefClass, CLASSID_PROJECTILEDEF, "Projectile")
_ProjectileDefDefFactory;
        ...
        case PROJECTILEDEF_CHUNK_VARIABLES:
            while (cload.Open_Micro_Chunk()) {
                switch (cload.Cur_Micro_Chunk_ID()) {
                    ...
                    READ_MICRO_CHUNK(cload, PROJECTILEDEF_VARIABLE_ORIENTATIONMODE,
                                     OrientationMode);
