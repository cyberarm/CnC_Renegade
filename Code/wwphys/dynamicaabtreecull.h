...
public:
    ...
    ** Note that if you pass in a pointer to your previous node_id, the lookup will be faster and
    *this
    ...
    */
    void Re_Partition(DynamicVectorClass<AABoxClass>* virtual_occludees, const Vector3& grid_min,
...
protected:
    ...
    */
    ...
    {
    public:
        VisObjCollectContextClass(const FrustumClass& frustum, VisTableClass& pvs,
                                  RefPhysListClass& visobjlist)
            : Frustum(frustum),
              PVS(pvs),
    ...
    ** Internal functions
    */
    void collect_visible_objects_recursive(AABTreeNodeClass* node,
                                           VisObjCollectContextClass& context);
    void collect_visible_objects_no_hvis_recursive(AABTreeNodeClass* node,
                                                   VisObjCollectContextClass& context);
    void render_visible_cells_recursive(AABTreeNodeClass* node, RenderInfoClass& rinfo,
                                        VisTableClass* pvs, DisplayModeType mode);
    void evaluate_non_occluder_visibility_recursive(AABTreeNodeClass* node,
    ...
    void prune_redundant_leaf_nodes_recursive(AABTreeNodeClass* node,
                                              VisOptimizationContextClass& context);
    void prune_child(AABTreeNodeClass* parent, AABTreeNodeClass* child,
                     VisOptimizationContextClass& context);
    ...
    */
    ...
    AABTreeIterator DebugIterator; // Used to walk the tree while debugging.  Render_Visible..
...
inline bool DynamicAABTreeCullClass::deflated_box_contains_point(const AABoxClass& box,
                                                                 const Vector3& point)
{
