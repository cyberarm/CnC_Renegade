...
bool PhysAABTreeCullClass::Cast_Ray_Recursive(AABTreeNodeClass* node,
...
bool PhysAABTreeCullClass::Cast_AABox_Recursive(AABTreeNodeClass* node,
...
bool PhysAABTreeCullClass::Cast_OBBox_Recursive(AABTreeNodeClass* node,
    ...
    */
    ...
    if (node->Object) {
        ...
        while (obj) {
            ...
            if (outside) { // CollisionMath::Overlap_Test(node->Box,obj->Get_Cull_Box()) !=
