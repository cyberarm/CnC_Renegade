...
public:
    ...
    /*
    ** Verify that the tree is valid, (all boxes contain their children, all objects contained in
    *their node)
    */
    ...
    */
    static void Enable_Hierarchical_Vis_Culling(bool onoff)
    {
        _HierarchicalVisCullingEnabled = onoff;
    }
