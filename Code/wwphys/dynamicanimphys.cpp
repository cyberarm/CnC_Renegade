...
*/
SimplePersistFactoryClass<DynamicAnimPhysClass, PHYSICS_CHUNKID_DYNAMICANIMPHYS>
    _DynamicAnimPhysFactory;
...
*/
SimplePersistFactoryClass<DynamicAnimPhysDefClass, PHYSICS_CHUNKID_DYNAMICANIMPHYSDEF>
    _DynamicAnimPhysDefFactory;
      ...
      ShadowFarZ(-1.0f)
{
    ...
    FLOAT_UNITS_PARAM(DynamicAnimPhysDefClass, ShadowNearZ, -1.0f, 1000.0f,
                      "meters (-1 for default)")
    FLOAT_UNITS_PARAM(DynamicAnimPhysDefClass, ShadowFarZ, -1.0f, 1000.0f,
                      "meters (-1 for default)")
}
