...
*/
SimplePersistFactoryClass<TimedDecorationPhysClass, PHYSICS_CHUNKID_TIMEDDECORATIONPHYS>
    _TimedDecoPhysFactory;
...
*/
SimplePersistFactoryClass<TimedDecorationPhysDefClass, PHYSICS_CHUNKID_TIMEDDECOPHYSDEF>
    _TimedDecorationPhysDefFactory;

/*
** Definition factory for TimedDecorationPhysDefClass.  This makes it show up in the editor
*/
DECLARE_DEFINITION_FACTORY(TimedDecorationPhysDefClass, CLASSID_TIMEDDECOPHYSDEF,
                           "TimedDecorationPhys")
