...
//
/////////////////////////////////////////////////////////////////////////
class PathNodeClass : public RefCountClass,
                      public HeapNodeClass<float>,
                      public AutoPoolClass<PathNodeClass, 512>
{
public:
    /////////////////////////////////////////////////////////////////////////
...
inline PathfindSectorClass* PathNodeClass::Peek_Sector(void)
{
    return m_Sector;
}

inline PathfindPortalClass* PathNodeClass::Peek_Portal(void)
{
    return m_Portal;
}

inline PathNodeClass* PathNodeClass::Peek_Parent_Node(void)
{
    return m_ParentNode;
}

inline void PathNodeClass::Set_Sector(PathfindSectorClass* sector)
{
    m_Sector = sector;
}

inline void PathNodeClass::Set_Portal(PathfindPortalClass* portal)
{
    m_Portal = portal;
}

inline void PathNodeClass::Set_Parent_Node(PathNodeClass* node)
{
    m_ParentNode = node;
}

inline float PathNodeClass::Get_Total_Cost(void) const
{
    return m_TotalCost;
}

inline float PathNodeClass::Get_Heuristic_Cost(void) const
{
...
inline float PathNodeClass::Get_Traversal_Cost(void) const
{
...
inline const Matrix3D& PathNodeClass::Get_Transform(void) const
{
    return m_Transform;
}

inline void PathNodeClass::Set_Transform(const Matrix3D& tm)
{
    m_Transform = tm;
}

inline Vector3 PathNodeClass::Get_Position(void) const
{
    return m_Transform.Get_Translation();
}

inline const Matrix3D& PathNodeClass::Get_Enter_Transform(void) const
{
    return m_EnterTransform;
}

inline void PathNodeClass::Set_Enter_Transform(const Matrix3D& tm)
{
    m_EnterTransform = tm;
}

inline void PathNodeClass::Eval_Total_Cost(void)
{
    m_TotalCost = m_HeuristicCost + m_TraversalCost;
}

inline bool PathNodeClass::Is_On_Final_Path(void) const
{
    return m_OnFinalPath;
}

inline void PathNodeClass::On_Final_Path(bool on_path)
{
    m_OnFinalPath = on_path;
}

inline uint32 PathNodeClass::Get_Heap_Location(void) const
{
...
inline float PathNodeClass::Heap_Key(void) const
{
    return m_TotalCost;
}

inline bool PathNodeClass::Is_In_Closed_List(void) const
{
