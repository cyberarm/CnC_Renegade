...
public:
    ...
    //
    void Initialize(const Vector3& box_extents, const Vector3& min_extents,
...
// Get_Collection_List
////////////////////////////////////////////////////////////////////
inline BODY_BOX_LIST& FloodfillGridClass::Get_Collection_List(void)
{
...
inline bool FloodfillGridClass::Remove_Box(FloodfillBoxClass* box)
{
    ...
    for (curr_box = m_Grid[index]; curr_box != nullptr && !found;
