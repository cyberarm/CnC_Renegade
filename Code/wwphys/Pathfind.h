...
public:
    ...
    int Add_Temporary_Portal(PathfindSectorClass* sector_from, PathfindSectorClass* sector_to,
    ...
    //
    void Find_Portals(const Vector3& p0, const Vector3& p1,
...
protected:
    ...
    void
    Add_Intersection_Portals_To_List(DynamicVectorClass<PathfindWaypathPortalClass*>& portal_list,
