...
void UmbraSupport::Init(void)
{
    ...
    */
    ...
    _TheCamera->setParameters(
        640, 480, Umbra::Camera::VIEWFRUSTUM_CULLING | Umbra::Camera::OCCLUSION_CULLING);
...
Umbra::Model* UmbraSupport::Create_Box_Model(const AABoxClass& inputbox)
{
    ...
    Umbra::Model* test_model = new Umbra::MeshModel(_umbra_box_verts, _umbra_box_faces,
                                                    _umbra_box_vert_count, _umbra_box_face_count);
...
void UmbraSupport::Collect_Visible_Objects(const CameraClass& camera,
                                           RefPhysListClass& visible_obj_list)
{
